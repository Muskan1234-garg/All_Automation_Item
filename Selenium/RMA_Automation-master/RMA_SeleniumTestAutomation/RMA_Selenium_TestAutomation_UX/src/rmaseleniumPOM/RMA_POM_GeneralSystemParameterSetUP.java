...
public class RMA_POM_GeneralSystemParameterSetUP {
	...
	//Revision				: 0.0 - ImteyazAhmad-06-21-2016                                 
	// ============================================================================================
	public static WebElement RMAApp_GenSysParaSetup_Img_Save(WebDriver driver)
	{
	...
	{
		Element = driver.findElement( By.xpath(".//*[@id='AutoNumberVeh']")); 
		return Element;
	}

	//============================================================================================
	//FunctionName 			: RMAApp_GenSysParaSetup_Chk_AutonumberPropertyID
	//Description  			: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which Autonumber Property ID CheckBox On RMA Application General System Parameter Setup Page Can Be Identified
	//Input Parameter 		: Driver Variable Of The Type WebDriver		 
	//Revision				: 0.0 - NikitaThani-02-19-2018                                 
	// ============================================================================================
	public static WebElement RMAApp_GenSysParaSetup_Chk_AutonumberPropertyID(WebDriver driver)
	{
		Element = driver.findElement( By.id("chkAutoPIN")); 
		return Element;
	}
