...
public static WebElement RMAApp_SMS_Btn_Refresh(WebDriver driver)
{
	 WebElement Element = null;
	 try{
		 Element = driver.findElement(By.id("btnIconRefresh")); //Unique id Of Refresh Button On SMS Module Access Permission Of RMA Application Security Management System Page Is Fetched
	 } catch (Exception|Error e) {	
	 }
	 return Element;
}
...
//============================================================================================
//FunctionName 			: RMAApp_SMSUser_Btn_EditDS
//Description  			: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Edit DS Permission Button On Data Source Of RMA Application Security Management System Page Can Be Identified
//Input Parameter 		: Driver Variable Of The Type WebDriver		 
//Revision				: 0.0 - RenuVerma-05-24-2017                               
//============================================================================================
public static WebElement RMAApp_SMSDS_Btn_EditDS(WebDriver driver)
{
	WebElement Element = null;
	 try{
	Element = driver.findElement(By.id("btn_edit_ds")); //Unique ID Of Edit DS Permission Button On Data Source Of RMA Application Security Management System Page Is Fetched
	 } catch (Exception|Error e) {	
	 }
	return Element;
}
