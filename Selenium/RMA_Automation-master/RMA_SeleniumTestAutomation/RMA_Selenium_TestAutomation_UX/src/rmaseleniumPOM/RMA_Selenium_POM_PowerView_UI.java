...
public class RMA_Selenium_POM_PowerView_UI {
	...
	//============================================================================================
	//FunctionName 			: RMAApp_PowerView_Btn_SavePowerView
	//Description  			: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which PowerView Name On PowerView Editor Page On RMA Application Power View Editor Page Can Be Identified
	//Input Parameter 		: Driver Variable Of The Type WebDriver		 
	//Revision				: 0.0 - ShrutiShruti-03-20-2018                                    
	//============================================================================================
	public static WebElement RMAApp_PowerView_NamePowerVIew(WebDriver driver,String Text )
	{
		Element = driver.findElement(By.linkText(Text)); //Unique Id Of PowerView Name On PowerView Editor Page On RMA Application PowerView Editor Page Is Fetched
		return Element;	
	}


	//============================================================================================
	//FunctionName 			: RMAApp_PowerView_Lbl_Property_PowerViewName
	//Description  			: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which PowerView Name On RMA Application Power View Editor Page Can Be Identified
	//Input Parameter 		: Driver Variable Of The Type WebDriver		 
	//Revision				: 0.0 - NikitaThani-03-16-2018                                    
	//============================================================================================
	public static WebElement RMAApp_PowerView_Lbl_Property_PowerViewName(WebDriver driver)
	{
		Element = driver.findElement(By.xpath(".//*[@id='grdPowerViewList_pViewTitle_3']/b/u")); //Unique Id Of PowerView Name On RMA Application PowerView Editor Page Is Fetched
		return Element;	
	}
}
