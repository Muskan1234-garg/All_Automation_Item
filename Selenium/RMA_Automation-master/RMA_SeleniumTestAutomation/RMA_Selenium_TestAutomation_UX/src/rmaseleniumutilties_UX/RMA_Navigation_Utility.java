...
public class RMA_Navigation_Utility extends rmaseleniumtestscripts.RMA_TC_BaseTest{
	...
	//Modified By		: 0.0 - RenuVerma-07-16-2018
	//==============================================================================================================================================================================================================================================
	public static void RMA_WebCheckBoxSelect_Utility(WebElement Element,String State, String ControlName, String PageDesc, int logval) throws Exception, Error
	{
		try {
			...
			case "check":
				...
				//System.out.println("class value"+RMA_Verification_Utility.RMA_AttributeFetch_Utility(Element, "class"));
				if(RMA_Verification_Utility.RMA_AttributeFetch_Utility(Element, "class").contains("ng-not-empty")||(AttributeValue!=null))//Updated condition logic for the UX screen
				...
				else if(RMA_Verification_Utility.RMA_AttributeFetch_Utility(Element, "class").contains("ng-empty")||(AttributeValue == null)){
					//if (AttributeValue == null){
			...
			case "uncheck":
				AttributeValue = RMA_Verification_Utility.RMA_AttributeFetch_Utility(Element, "checked");
				if(RMA_Verification_Utility.RMA_AttributeFetch_Utility(Element, "class").contains("ng-empty")||(AttributeValue == null)){//Updated condition logic for the UX screen
					//if (AttributeValue == null){
					if (logval == 0)
					{
				...
				//if (AttributeValue != null){
				else if(RMA_Verification_Utility.RMA_AttributeFetch_Utility(Element, "class").contains("ng-not-empty")||(AttributeValue!=null)){//Updated condition logic for the UX screen
					AttributeValue = RMA_Verification_Utility.RMA_AttributeFetch_Utility(Element, "disabled");
					if (AttributeValue == null){
						globalWait.until(ExpectedConditions.elementToBeClickable(Element));
						((JavascriptExecutor) driver).executeScript("arguments[0].click();", Element );
	...
	public static void RMA_WebLinkSelect(String LinkText, String ControlDesc, int logval) throws Exception, Error
	{
		try {
			...
			globalWait.until(ExpectedConditions.elementToBeClickable(driver.findElement(By.xpath(".//*[contains(text(),'"+LinkText+"') and contains(@ng-click,'grid.appScope.columnClick')]"))));
			driver.findElement(By.xpath(".//*[contains(text(),'"+LinkText+"') and contains(@ng-click,'grid.appScope.columnClick')]")).click();
	...
	public static void RMA_WebPartialLinkSelect(String PartialLinkText, String ControlDesc, int logval) throws Exception, Error
	{
		try {
			...
			globalWait.until(ExpectedConditions.elementToBeClickable(driver.findElement(By.xpath(".//*[contains(text(),'"+PartialLinkText+"') and contains(@ng-click,'grid.appScope.columnClick')]"))));
			Thread.sleep(5000);
			driver.findElement(By.xpath(".//*[contains(text(),'"+PartialLinkText+"') and contains(@ng-click,'grid.appScope.columnClick')]")).click();
			if (logval == 0)
			{
	...
	public static void RMA_ObjectClick(WebElement Element, String ControlDesc,int logval) throws Exception, Error
	{
		...
		try {
			...
			if (logval ==0)
			{
				parentlogger.log(LogStatus.FAIL,  ControlDescLabel + " " + color.RMA_ChangeColor_Utility("Is Not Successfully Clicked And The Error Message Is",1) + " " + color.RMA_ChangeColor_Utility(e.getMessage(),1));
			}
			else
			{
				logger.log(LogStatus.FAIL,  ControlDescLabel + " " + color.RMA_ChangeColor_Utility("Is Not Successfully Clicked And The Error Message Is",1) + " " + color.RMA_ChangeColor_Utility(e.getMessage(),1));
			}
			throw (e);
		}
	}
	...
	public static void RMA_ObjectDoubleClick(WebElement Element, String ControlDesc,int logval) throws Exception, Error
	{
		...
		try {
			...
			if (logval ==0)
			{
				parentlogger.log(LogStatus.FAIL,  ControlDescLabel + " " + "Is Not Successfully DoubleClicked And The Error Message Is" + " " + color.RMA_ChangeColor_Utility(e.getMessage(),1));
			}
			else
			{
				logger.log(LogStatus.FAIL,  ControlDescLabel + " " + "Is Not Successfully DoubleClicked And The Error Message Is" + " " + color.RMA_ChangeColor_Utility(e.getMessage(),1));
			}
			throw (e);
		}
	}
	...
	public static void RMA_ObjectJavaScriptClick(WebElement Element, String ControlDesc,int logval) throws Exception, Error
	{
		...
		try {
			if(Element.equals(null)){
				Assert.fail("Element Not Found To Click The Object");
			}
			Thread.sleep(2000);
			globalWait.until(ExpectedConditions.elementToBeClickable(Element));
			((JavascriptExecutor) driver).executeScript("arguments[0].click();", Element );
			...
			{ 
				...
				if (Element.size() > 0)				
				{
					...
					{	
						...
						{
							RMA_Navigation_Utility.RMA_ObjectActionsClick(Element.get(MenuOptionCount), MenuOptionName+" "+"Menu Option",Intlogval);
							Thread.sleep(1000);
							break;
						}}
				}
	...
	public static void RMA_ObjectDragAndDrop(WebElement ElementFrom, WebElement ElementTo,String ControlDesc,String ControlDesc1,String PageDesc,int logval) throws Exception, Error
	{
		...
		try {
			...
			if (logval ==0)
			{
				parentlogger.log(LogStatus.FAIL,  ControlDescLabel + " " + color.RMA_ChangeColor_Utility("Is Not Successfully Dragged And The Error Message Is",1) + " " + color.RMA_ChangeColor_Utility(e.getMessage(),1));
			}
			else
			{
				logger.log(LogStatus.FAIL,  ControlDescLabel + " " + color.RMA_ChangeColor_Utility("Is Not Successfully Dragged And The Error Message Is",1) + " " + color.RMA_ChangeColor_Utility(e.getMessage(),1));
			}
			throw (e);
		}
	}
	...
	//==================================================================================================================================================================================================================================================================================================
	//FunctionName             : RMA_ScrollIntoView
	//Description              : To scroll until the element is in view
	//Input Parameter          : Element To be Dragged: ElementFrom, Element Where It To Be Dropped: ElementDrop and Description Of Page : PageDesc
	//Revision                 : 0.0 - FaizaSheikh -04-23-2018                                 
	//==================================================================================================================================================================================================================================================================================================
	public static void RMA_ScrollIntoView(WebElement Element,String ControlDesc,int logval) throws Exception, Error
	{
		//globalWait.until(ExpectedConditions.elementToBeClickable(Element));
		RMA_GenericUsages_Utility.RMA_StaticWait(2, logval, "Wait Till Element Is Visible");
	...
	//==================================================================================================================================================================================================================================================================================================
	//FunctionName             : RMA_ScrollBottomOfPage
	//Description              : To scroll until the element is in view
	//Input Parameter          : Element To be Dragged: ElementFrom, Element Where It To Be Dropped: ElementDrop and Description Of Page : PageDesc
	//Revision                 : 0.0 - DebasmitaPati -09-11-2019                                 
	//==================================================================================================================================================================================================================================================================================================
	public static void RMA_ScrollBottomOfPage(int logval) throws Exception, Error
	{
		//driver.manage().window().maximize();
		RMA_GenericUsages_Utility.RMA_StaticWait(10, logval, "Wait Till Element Is Loaded");
	...
	//==============================================================================================================================================================================================================================================
	//FunctionName 		: RMA_ToggleSwitch_Utility
	//Description  		: To Toggle Switch
	//Input Parameter 	: State 
	//Revision			: 0.0 - DebasmitaPati-08-10-2020   
	//==============================================================================================================================================================================================================================================
	public static void RMA_ToggleSwitch_Utility(String ControlDesc, int logval) throws Exception, Error
	{
		try {
			ControlDesc = color.RMA_ChangeColor_Utility(ControlDesc, 4);
			driver.findElement(By.cssSelector("span.knob.ng-binding")).click();

			if (logval == 0)
			{
				parentlogger.log(LogStatus.INFO,  ControlDesc + " "  +"Is Successfully Clicked");							
			}
			else
			{
				logger.log(LogStatus.INFO,  ControlDesc + " "  +"Is Successfully Clicked");
			}

		} catch (Exception|Error e) {
			if (logval ==0)
			{
				parentlogger.log(LogStatus.FAIL,  ControlDesc + " " + color.RMA_ChangeColor_Utility("Is Not Successfully Clicked And The Error Message Is",1) + " " + color.RMA_ChangeColor_Utility(e.getMessage(),1));
			}
			else
			{
				logger.log(LogStatus.FAIL,  ControlDesc + " " + color.RMA_ChangeColor_Utility("Is Not Successfully Clicked And The Error Message Is",1) + " " + color.RMA_ChangeColor_Utility(e.getMessage(),1));
			}				
			throw (e);
		}
	}
