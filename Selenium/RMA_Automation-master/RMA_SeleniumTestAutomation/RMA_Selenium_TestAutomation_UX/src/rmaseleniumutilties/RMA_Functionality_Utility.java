...
public class RMA_Functionality_Utility extends rmaseleniumtestscripts.RMA_TC_BaseTest {
	...
	public static String RMA_NonOccupationalClaimCreation(String ClaimType, int EmployeeNumber, String Department, int Dateofevent, int TimeofEvent, int Dateofclaim, int Timeofclaim, String Jurisdiction,String PlanName, int DisabilitySrtDate, int logval) throws Exception,Error
	{
		...
		try{
			...
			RMA_MDIMenuClick_Utility("Document-Non-occupational", logval);
	...
	public static String RMA_PropertyClaimCreation(String ClaimType, String Department, int Dateofevent, int TimeofEvent, int Dateofclaim, int Timeofclaim, String PropertyID, int logval) throws Exception,Error
	{
		...
		try
		{
			...
			RMA_MDIMenuClick_Utility("Document-PropertyClaim", logval);
	...
	public static String RMA_ClaimEntityAddition_Utility(String Entity, String ClaimEntity, String Claim, String AdjSystemLogin, String Type, String Status, String Date, String Time, String User, String FinType, int logval) throws Exception, Error
	{
		...
		try {
			...
			case "Dated Text - Event": // Dated Text node under Event 				 
				...
				RMA_Input_Utility.RMA_ActionSetValueAndTabOut_Utility(RMA_Selenium_POM_Document_Event.RMAApp_DatedText_Btn_DatedTextMemo(driver), StrDatedText, "TextEditor On Event Dated Text Page", logval);
			...
			case "Dated Text - Adjuster": // Dated Text node under Adjuster		 
				...
				RMA_GenericUsages_Utility.RMA_WindowSwitching_Utility();
				driver.manage().window().maximize();
				RMA_Input_Utility.RMA_ActionSetValueAndTabOut_Utility(RMA_Selenium_POM_Document_Event.RMAApp_DatedText_Btn_DatedTextMemo(driver), StrDatedText, "TextEditor On Adjuster Dated Text Page", logval);
	...
	//====================================================================================================
	//FunctionName 		: RMA_MDIMenuClick_Utility
	...
	//====================================================================================================
	public static void RMA_MDIMenuClick_Utility(String MenuOption, int logval) throws Exception, Error
	{
		try {

			switch (MenuOption){
			case "Document-Event":
				rmaseleniumutilties.RMA_Navigation_Utility.RMA_MDIMenuClick("Document;Event", logval);
				break;

			case "Document-GeneralClaim":
				rmaseleniumutilties.RMA_Navigation_Utility.RMA_MDIMenuClick("Document;General Claim", logval);
				break;

			case "Document-Non-occupational":
				rmaseleniumutilties.RMA_Navigation_Utility.RMA_MDIMenuClick("Document;Non-occupational", logval);
				break;

			case "Document-PropertyClaim":
				rmaseleniumutilties.RMA_Navigation_Utility.RMA_MDIMenuClick("Document;Property Claim", logval);
				break;

			case "Document-VehicleAccident":
				rmaseleniumutilties.RMA_Navigation_Utility.RMA_MDIMenuClick("Document;Vehicle Accident", logval);
				break;

			case "Document-Workers’Comp.":
				rmaseleniumutilties.RMA_Navigation_Utility.RMA_MDIMenuClick("Document;Workers’ Comp.", logval);
				break;

			case "Diaries-DiaryList":
				rmaseleniumutilties.RMA_Navigation_Utility.RMA_MDIMenuClick("Diaries;Diary List", logval);
				break;

			case "Diaries-DiaryCalendar":
				rmaseleniumutilties.RMA_Navigation_Utility.RMA_MDIMenuClick("Diaries;Diary Calendar", logval);
				break;

			case "Funds-ApplyPaymentstoCoverages":
				rmaseleniumutilties.RMA_Navigation_Utility.RMA_MDIMenuClick("Funds;Apply Payments to Coverages", logval);
				break;

			case "Funds-SupervisoryApproval":
				rmaseleniumutilties.RMA_Navigation_Utility.RMA_MDIMenuClick("Funds;Supervisory Approval", logval);
				break;

			case "Funds-BankAccount":
				rmaseleniumutilties.RMA_Navigation_Utility.RMA_MDIMenuClick("Funds;Bank Account", logval);
				break;

			case "Funds-BulkCheckRelease":
				rmaseleniumutilties.RMA_Navigation_Utility.RMA_MDIMenuClick("Funds;Bulk Check Release", logval);
				break;

			case "Funds-CombinedPayment":
				rmaseleniumutilties.RMA_Navigation_Utility.RMA_MDIMenuClick("Funds;Combined Payment ", logval);
				break;
								
			case "Funds-CustomPaymentNotification":
				rmaseleniumutilties.RMA_Navigation_Utility.RMA_MDIMenuClick("Funds;Custom Payment Notification", logval);
				break;

			case "Funds-Deposit":
				rmaseleniumutilties.RMA_Navigation_Utility.RMA_MDIMenuClick("Funds;Deposit", logval);
				break;	

			case "Funds-ReCreateCheckFile":
				rmaseleniumutilties.RMA_Navigation_Utility.RMA_MDIMenuClick("Funds;Re-Create Check File", logval);
				break;
				
			case "Reports-ExeSummary-Configurations":
				rmaseleniumutilties.RMA_Navigation_Utility.RMA_MDIMenuClick("Reports;Exec. Summaries ;Configurations", logval);
				break;
				
			case "Funds-MarkChecksasCleared":
				rmaseleniumutilties.RMA_Navigation_Utility.RMA_MDIMenuClick("Funds;Mark Checks as Cleared", logval);
				break;
				
			case "Utilities-Managers-ExchangeRateSetup":
				rmaseleniumutilties_UX.RMA_Functionality_Utility.RMA_UtilityMenuNavigation("Exchange Rate Setup", logval);
				break;
				
			case "Funds-ResetPrintedCheck":
				rmaseleniumutilties.RMA_Navigation_Utility.RMA_MDIMenuClick("Funds;Reset Printed Check", logval);
				break;
							
			case "Funds-UnClearChecks":
				rmaseleniumutilties.RMA_Navigation_Utility.RMA_MDIMenuClick("Funds;Un-Clear Checks", logval);
				break;
				
			case "Funds-VoidChecks":
				rmaseleniumutilties.RMA_Navigation_Utility.RMA_MDIMenuClick("Funds;Void Checks", logval);
				break;
				
			case "Help-About":
				rmaseleniumutilties.RMA_Navigation_Utility.RMA_MDIMenuClick("Help;About", logval);
				break;

			case "Maintenance-AdminTracking":
				rmaseleniumutilties.RMA_Navigation_Utility.RMA_MDIMenuClick("Maintenance;Admin Tracking", logval);
				break;

			case "Maintenance-Catastrophe":
				rmaseleniumutilties.RMA_Navigation_Utility.RMA_MDIMenuClick("Maintenance;Catastrophe", logval);
				break;

			case "Maintenance-Driver":
				rmaseleniumutilties.RMA_Navigation_Utility.RMA_MDIMenuClick("Maintenance;Driver", logval);
				break;

			case "Maintenance-Employee":
				rmaseleniumutilties.RMA_Navigation_Utility.RMA_MDIMenuClick("Maintenance;Employee", logval);
				break;

			case "Maintenance-Entity":
				rmaseleniumutilties.RMA_Navigation_Utility.RMA_MDIMenuClick("Maintenance;Entity", logval);
				break;		

			case "Maintenance-MedicalStaff":
				rmaseleniumutilties.RMA_Navigation_Utility.RMA_MDIMenuClick("Maintenance;Medical Staff", logval);
				break;		

			case "Maintenance-PatientTracking":
				rmaseleniumutilties.RMA_Navigation_Utility.RMA_MDIMenuClick("Maintenance;Patient Tracking", logval);
				break;

			case "Maintenance-People":
				rmaseleniumutilties.RMA_Navigation_Utility.RMA_MDIMenuClick("Maintenance;People", logval);
				break;	

			case "Maintenance-Physician":
				rmaseleniumutilties.RMA_Navigation_Utility.RMA_MDIMenuClick("Maintenance;Physician", logval);
				break;

			case "Maintenance-PlanManagement":
				rmaseleniumutilties.RMA_Navigation_Utility.RMA_MDIMenuClick("Maintenance;Plan Management", logval);
				break;

			case "Maintenance-LeavePlanManagement":
				rmaseleniumutilties.RMA_Navigation_Utility.RMA_MDIMenuClick("Maintenance;Leave Plan Management ", logval);
				break;

			case "Maintenance-PolicyTracking":
				rmaseleniumutilties.RMA_Navigation_Utility.RMA_MDIMenuClick("Maintenance;Policy Tracking", logval);
				break;

			case "Maintenance-Property":
				rmaseleniumutilties.RMA_Navigation_Utility.RMA_MDIMenuClick("Maintenance;Property", logval);
				break;

			case "Maintenance-Vehicle":
				rmaseleniumutilties.RMA_Navigation_Utility.RMA_MDIMenuClick("Maintenance;Vehicle", logval);
				break;

			case "Maintenance-TableMaintenance":
				rmaseleniumutilties.RMA_Navigation_Utility.RMA_MDIMenuClick("Maintenance;Table Maintenance", logval);
				break;

			case "MyWork-WebLinks":
				rmaseleniumutilties.RMA_Navigation_Utility.RMA_MDIMenuClick("My Work;Web Links", logval);
				break;

			case "Reports-BI":
				rmaseleniumutilties.RMA_Navigation_Utility.RMA_MDIMenuClick("Reports;BI", logval);
				break;

			case "Search-Claim":
				rmaseleniumutilties.RMA_Navigation_Utility.RMA_MDIMenuClick("Search;Claim", logval);
				break;

			case "Search-Event":
				rmaseleniumutilties.RMA_Navigation_Utility.RMA_MDIMenuClick("Search;Event", logval);
				break;

			case "Search-Funds":
				rmaseleniumutilties.RMA_Navigation_Utility.RMA_MDIMenuClick("Search;Funds", logval);
				break;

			case "Security-UserPrivilegesSetup":
				rmaseleniumutilties.RMA_Navigation_Utility.RMA_MDIMenuClick("Security;User Privileges Setup", logval);
				break;

			case "Security-SecurityManagementSystem":
				rmaseleniumutilties.RMA_Navigation_Utility.RMA_MDIMenuClick("Security;Security Management System", logval);
				break;

			case "UserDocuments-DocumentList":
				rmaseleniumutilties.RMA_Navigation_Utility.RMA_MDIMenuClick("User Documents;Document List", logval);
				break;

			case "Utilities-Managers-FinancialkeySetup":
				rmaseleniumutilties_UX.RMA_Functionality_Utility.RMA_UtilityMenuNavigation("Financial key Setup", logval);
				break;

			case "Utilities-Managers-CodeRelationships":
				rmaseleniumutilties_UX.RMA_Functionality_Utility.RMA_UtilityMenuNavigation("Code Relationships", logval);
				break;

			case "Utilities-Managers-LossCodeMapping":
				rmaseleniumutilties_UX.RMA_Functionality_Utility.RMA_UtilityMenuNavigation("Loss Code Mapping", logval);
				break;

			case "Utilities-SystemParameters-GeneralSystemParameterSetup":
				rmaseleniumutilties_UX.RMA_Functionality_Utility.RMA_UtilityMenuNavigation("General System Parameter Setup", logval);
				break;

			case "Utilities-SystemParameters-LineOfBusinessParameterSetup":
				rmaseleniumutilties_UX.RMA_Functionality_Utility.RMA_UtilityMenuNavigation("Line Of Business Parameter Setup", logval);
				break;

			case "Utilities-SystemParameters-PaymentParameterSetup":
				rmaseleniumutilties_UX.RMA_Functionality_Utility.RMA_UtilityMenuNavigation("Payment Parameter Setup", logval);
				break;

			case "Utilities-ToolsandDesigners":
				rmaseleniumutilties_UX.RMA_Functionality_Utility.RMA_UtilityMenuNavigation("Tools and Designers", logval);
				break;

			case "Utilities-Technicians-XML Import-XMLImportTemplateGeneration":
				rmaseleniumutilties_UX.RMA_Functionality_Utility.RMA_UtilityMenuNavigation("XML Import Template Generation", logval);
					break;

			case "Utilities-ToolsandDesigners-AutoDiarySetup":
				rmaseleniumutilties_UX.RMA_Functionality_Utility.RMA_UtilityMenuNavigation("Auto Diary Setup", logval);
				break;

			case "Utilities-ToolsandDesigners-ScriptEditor":
				rmaseleniumutilties_UX.RMA_Functionality_Utility.RMA_UtilityMenuNavigation("Script Editor", logval);
				break;

			case "Utilities-ToolsandDesigners-QueryDesigner":
				rmaseleniumutilties_UX.RMA_Functionality_Utility.RMA_UtilityMenuNavigation("Query Designer", logval);
				break;

			case "Utilities-UIAdmins-Customization-PortalSettings":
				rmaseleniumutilties_UX.RMA_Functionality_Utility.RMA_UtilityMenuNavigation("Portal Settings", logval);
				break;

			case "Utilities-UIAdmins-PowerviewEditor":
				rmaseleniumutilties_UX.RMA_Functionality_Utility.RMA_UtilityMenuNavigation("Powerview Editor", logval);
				break;

			case "Utilities-UIAdmins-Customization-WebLinksSetup":
				rmaseleniumutilties_UX.RMA_Functionality_Utility.RMA_UtilityMenuNavigation("Web Links Setup", logval);
				break;

			case "Utilities-UIAdmins-Customization-NavigationTreeSettings":
				rmaseleniumutilties_UX.RMA_Functionality_Utility.RMA_UtilityMenuNavigation("Navigation Tree Settings", logval);
				break;
				
			case "Utilities-UIAdmins-SupplementalSetup-SupplementalFieldData":
				rmaseleniumutilties_UX.RMA_Functionality_Utility.RMA_UtilityMenuNavigation("Supplemental Field Data", logval);
				break;
				
			case "Utilities-ToolsandDesigners-TaskManager-ViewScheduledTasks":
				rmaseleniumutilties_UX.RMA_Functionality_Utility.RMA_UtilityMenuNavigation("View Scheduled Tasks", logval);
				break;
				
			case "Utilities-ToolsandDesigners-TaskManager-TMJobsView":
				rmaseleniumutilties_UX.RMA_Functionality_Utility.RMA_UtilityMenuNavigation("TM Jobs View", logval);
				break; 
			case "Utilities-Managers-TaxandOffsetMapping":
				rmaseleniumutilties_UX.RMA_Functionality_Utility.RMA_UtilityMenuNavigation("Tax and Offset Mapping", logval);
				break;	
			default:
	...
	//                  : 0.3 - NidhiJha-11-06-2017 Changed The screen Controls As screen Is Migrated To UX    
	//======================================================================================================================================================================================================================================================
	...
	{		
		...
		try
		{
			...
			RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_ScheduleCheck.RMAApp_FinancialReserve_Img_ScheduleCheck(driver), "ScheduleCheck Image On Financial Reserve Page", logval);
			RMA_GenericUsages_Utility.RMA_StaticWait(6, logval, "Wait Is As ScheduleCheck Page Is Loaded");
			CurrentFrameID=RMA_GenericUsages_Utility.RMA_GetCurrentFrameID();
			globalWait.until(ExpectedConditions.elementToBeClickable(RMA_Selenium_POM_ScheduleCheck.RMAApp_ScheduleCheck_Txt_PayInterval(driver)));
			RMA_Input_Utility.RMA_SetTextValueandTabOut_Utility(RMA_Selenium_POM_ScheduleCheck.RMAApp_ScheduleCheck_Txt_PayInterval(driver), "Pay Interval TextBox On Schedule Checks Page", PayInterval, logval);
			RMA_GenericUsages_Utility.RMA_StaticWait(6, logval, "Wait Is As Pay Interval Needs To Get Loaded");
			
			RMA_Input_Utility.RMA_SetValue_Utility(RMA_Selenium_POM_ScheduleCheck.RMAApp_ScheduleCheck_Txt_NumberOfPayments(driver), "# Of Payments Text Box On ScheduleCheck Page", String.valueOf(NumberOfPayment), logval);
			RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_ScheduleCheck.RMAApp_ScheduleCheck_Lst_BankAccount(driver),  "BankAccount List On ScheduleCheck Page", logval);
			RMA_GenericUsages_Utility.RMA_StaticWait(8, logval, "Wait Is As Number Of Payments Needs To Get Set");
			
			RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_ScheduleCheck.RMAApp_ScheduleCheck_Lst_BankAccount(driver),  "BankAccount List On ScheduleCheck Page", logval);
			RMA_Input_Utility.RMA_ElementWebListSelect_Utility(RMA_Selenium_POM_ScheduleCheck.RMAApp_ScheduleCheck_Lst_BankAccount(driver), BankAccount, "BankAccount", "ScheduleCheck Page", logval); 
			RMA_Input_Utility.RMA_SetTextValueandTabOut_Utility(RMA_Selenium_POM_ScheduleCheck.RMAApp_ScheduleCheck_Txt_DistributionType(driver), "Dist Type TextBox On Schedule Checks Page", DistributionType, logval);
			RMA_GenericUsages_Utility.RMA_StaticWait(6, logval, "Wait Is As Dist Type Needs To Get Set");
			RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_ScheduleCheck.RMAApp_ScheduleCheck_Lst_PayeeType(driver), "PayeeType On ScheduleCheck Page", logval);
			RMA_Input_Utility.RMA_ElementWebListSelect_Utility(RMA_Selenium_POM_ScheduleCheck.RMAApp_ScheduleCheck_Lst_PayeeType(driver), PayeeType, "PayeeType", "ScheduleCheck Page", logval);
			RMA_GenericUsages_Utility.RMA_StaticWait(5, logval, "Wait Is Payee Type Needs To Get Set");

			int WindowCount = driver.getWindowHandles().size();	
			if(!"C-Claimant".equalsIgnoreCase(PayeeType.trim())){// if claimant in not selected in the payee list
				RMA_Input_Utility.RMA_SetTextValueandTabOut_Utility(RMA_Selenium_POM_ScheduleCheck.RMAApp_ScheduleCheck_Txt_LastName(driver), "LastName TextBox On ScheduleCheck Page", LastName, logval);
				if(driver.getWindowHandles().size()>WindowCount){// If user want to add new Payee
					RMA_GenericUsages_Utility.RMA_WindowSwitchingBasedOnTitle("Quick Lookup Results");

					if((RMA_Selenium_POM_ScheduleCheck.RMAApp_ScheduleCheck_Btn_ChooseHighlighted(driver) != null))
					{ Thread.sleep(6000);

					RMA_Input_Utility.RMA_ElementWebListSelect_Utility(RMA_Selenium_POM_ScheduleCheck.RMAApp_ScheduleCheck_Txt_FirstRowSelectionInLookupPageOfLastName(driver), LastName, "First Row In Quick Lookup Result Page ", "Quick Lookup Result Page", logval);
					RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_ScheduleCheck.RMAApp_ScheduleCheck_Btn_ChooseHighlighted(driver), "Choose Highlighted Button Quick Lookup Result Page", logval);
					}

					else{
						RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_ScheduleCheck.RMAApp_ScheduleCheck_Btn_AddNew(driver), "Add New Button On Quick Lookup Result Page",logval);
						...
						RMA_GenericUsages_Utility.RMA_WindowSwitchingBasedOnTitle("null");
					...
					RMA_GenericUsages_Utility.RMA_WaitForDriverToClose(driver);
					RMA_GenericUsages_Utility.RMA_WindowSwitchingBasedOnTitle(StrClaimsWindowTitle);
					RMA_GenericUsages_Utility.RMA_DynamicFrameSwitching(CurrentFrameID);
					RMA_GenericUsages_Utility.RMA_DynamicFrameSwitching(RMA_Selenium_POM_VerificationMessage.ScheduleAutomaticCheck);
				}
			}

			Thread.sleep(6000); 
			RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_ScheduleCheck.RMAApp_ScheduleCheck_Tab_DetailedInformation(driver), "Detailed Information Tab On ScheduleCheck Page", logval);
			RMA_GenericUsages_Utility.RMA_StaticWait(2, logval, "Wait Is Added As Detailed Information Tab Is Clicked");
			RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_ScheduleCheck.RMAApp_ScheduleCheck_Img_PaymentGridNew(driver), "New Image For Transaction On ScheculeCheck Page", logval);

			RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_ScheduleCheck.RMAApp_ScheduleCheck_Btn_TransType(driver), "Transaction Type Button On Paymnet Details Page", logval);
			RMA_Navigation_Utility.RMA_WebLinkSelect(TransactionType, "Transaction Type Link On Payment Details Page", logval);

			RMA_GenericUsages_Utility.RMA_StaticWait(7, logval, "Wait Is Added As Transaction Type Is Set");

			Transtype = RMA_Selenium_POM_ScheduleCheck.RMAApp_ScheduleCheck_Lst_TransType(driver).getAttribute("value");
			Reservetype = RMA_Selenium_POM_ScheduleCheck.RMAApp_ScheduleCheckCreation_Lst_ReserveType(driver).getAttribute("value");
			String FReservetype[] = Reservetype.split(" ");
			String FRTranstype[] = Transtype.split(" ");

			RMA_Input_Utility.RMA_SetValue_Utility(RMA_Selenium_POM_ScheduleCheck.RMAApp_ScheduleCheckCreation_Txt_Amount(driver), "Amount TextBox On  Payment Detail Window", String.valueOf(Amount),logval);	


			RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_ScheduleCheck.RMAApp_PaymnetDetailEntry_Img_Save(driver), "Save Image On ScheduleCheck Page", logval);
			RMA_GenericUsages_Utility.RMA_StaticWait(6, logval, "Wait Is Added As ScheduleCheck Page IS Saved");
			RMA_NegativeVerification_Utility.RMA_ElementNotExist_Utility(RMA_Selenium_POM_Home.RMAApp_DefaultView_Err_StaticErrorText(driver), "RMA Application Static Error Message",logval);
			//RMA_Verification_Utility.RMA_RowColCountVerify_Utility(RMA_Selenium_POM_ScheduleCheck.RMAApp_ScheduleCheck_Tbl_PaymentInformationGrid(driver), 0, NumberOfPayment+2, true, false, "PaymentInformation Table On ScheduleCheck Page" , logval);

			RMA_Verification_Utility.RMA_VerifyUXRowColumnCount_Utility("row", NumberOfPayment+1, "Payment Information Grid", logval);
			if(AdditionParameter == true)
			{	
				int PaymentCount;
				for(PaymentCount=1;PaymentCount<=NumberOfPayment;PaymentCount++)//WebElement Element, String SearchText, int col1, String ExpVal1, String TableName, int logval
				{
					String []ExpectedColHeadersToBeVerified = {"Payment Number"};		
					String []ExpectedPartialValuesToBeVerified = {String.valueOf(PaymentCount)};
					RMA_Verification_Utility.RMA_VerifyUXGridPartially_Utility(String.valueOf(PaymentCount), "Payment Information Grid On Schedule Automatic Check Page", ExpectedColHeadersToBeVerified, ExpectedPartialValuesToBeVerified, logval);

				}

				RMA_Verification_Utility.RMA_VerifyUXGridSingleText_Utility(FRTranstype[1], "Transaction Details for Future Payments ", FRTranstype[1], 3, logval);
				RMA_Verification_Utility.RMA_VerifyUXGridSingleText_Utility(FRTranstype[1], "Transaction Details for Future Payments ", "$"+String.valueOf(Amount)+".00", 4, logval);
			}

			RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_ScheduleCheck.RMAApp_ScheduleCheck_Tab_ScheduleCheck(driver), "ScheduleCheck Tab On ScheduleCheck Page", logval);
			RMA_Functionality_Utility.RMA_GenericSave_Utility(CurrentFrameID, false, "NA",  "Schedule Check Page", logval);
			...
			if(logval == 0)
			{
				parentlogger.log(LogStatus.PASS, "Schedule Check Is Created Successfully With Auto Control Number:" + " " + color.RMA_ChangeColor_Utility(ReturnValue,2));
			}
			else
			{
...
public static void RMA_DiaryRecordsCheck_Utility(String SearchedText,int Col1,int Col2, int Col3, String ExpectedVal1,String ExpectedVal2,String ExpectedVal3,String ExpectedVal4, String ExpectedVal5,boolean ThirdVerify, int logval) throws Exception, Error
{
	...
	public static String RMA_WorkersCompClaimCreation_ACON(String ClaimType, int EmployeeNumber, String Department, Date Dateofevent, int TimeofEvent, Date Dateofclaim, int Timeofclaim, String Jurisdiction, String LOB,boolean Parameter,int logval) throws Exception,Error
	{
		...
		try{
			...
			RMA_MDIMenuClick_Utility("Document-Workers’Comp.", logval);
	...
	public static String RMA_GeneralClaimCreation_ACON(String ClaimType, String Department,	Date Dateofevent, int TimeofEvent,Date Dateofclaim, int Timeofclaim, String LOB, boolean AdditionalParameter,int logval) throws Exception, Error {
		...
		try
		{
			...
			RMA_Functionality_Utility.RMA_MDIMenuClick_Utility("Document-GeneralClaim", logval);
	...
	public static String RMA_PolicyTracking_Utility(String PolicyStatus, Date effDate,Date expDate,int PolicyTracking_PolicyPremium , String PrimaryPolicyState, String ClaimsMadeCoverageState, String InsurerLName, String Insured, String PolicyLOB,String UnitType,String UnitName,boolean AdditionalParameter,int logval) throws Exception, Error
	{
		...
		try {
			...
			RMA_Functionality_Utility.RMA_MDIMenuClick_Utility("Maintenance-PolicyTracking", logval);
	...
	public static String RMA_MaintenanceProperty_AddEdit_Utility(String Case, String  RMA_PropertyAddr1, String RMA_PropertyCity, int RMA_PropertyZipCode, String RMA_PropertyState, String RMA_PropertyYearofConstruction,int RMA_PropertySquareFootage,boolean AdditionalParameter,int logval) throws Exception, Error
	{
		...
		try {
			...
			case "Create":
			{
				RMA_Functionality_Utility.RMA_MDIMenuClick_Utility("Maintenance-Property", logval);
	...
	public static String RMA_MaintenancePlan_AddEdit_Utility(String Case, String StrPlanStatus, String  StrPlanEffectiveDate, String StrPlanExpirationDate,String StrPlanInsured, boolean AdditionalParameter,int logval) throws Exception, Error
	{
		...
		try {
			...
			case "Create":
			{
				RMA_Functionality_Utility.RMA_MDIMenuClick_Utility("Maintenance-PlanManagement", logval);
			...
			case "Edit":{
				...
				RMA_Input_Utility.RMA_ActionSendKeys_Utility(RMA_Selenium_POM_Maintenance_PlanManagement.RMAApp_MaintPlanManagement_Txt_Planname(driver), "Plan Name Text Box on Maintenance -> Plan Management Page", StrEditedPlanname, logval);
				RMA_Functionality_Utility.RMA_GenericSave_Utility("Plan Management", false, "NA", "Maintenance -> Plan Management Page", logval);
				ReturnValue=RMA_Selenium_POM_Maintenance_PlanManagement.RMAApp_MaintPlanManagement_Txt_Planname(driver).getAttribute("value");
	...
	public static String RMA_MaintenanceVehicle_AddEdit_Utility(String Case, String  StrVehicleMake, String StrVehicleModel, int IntVehicleYear, int IntLeaseAmount, String StrLicenseNumber,int IntLeaseNumber,int IntLeaseTerm,String StrLeaseExpiration,int IntOriginalCost,String StrUnitType,String StrDisposalDate, String StrLastServiceDate,boolean AdditionalParameter,int logval) throws Exception, Error
	{
		...
		try {
			...
			case "Create":
			{
				RMA_Functionality_Utility.RMA_MDIMenuClick_Utility("Maintenance-Vehicle", logval);
	...
	public static void RMA_TableMaintenanceCodeAddition_Utility(String Case ,String TableMaintLinkName, String CodeTableLinkName, String Code,String Description,String ParentCode, String EffStartDate,String EffEndDate,String LOB,int ColNoForVerification,String SearchTextOnTable,boolean AdditionalParameter,int logval) throws Exception, Error
	{
		...
		try {
			...
			case "Policy LOB":
			{			
				RMA_Functionality_Utility.RMA_MDIMenuClick_Utility("Maintenance-TableMaintenance", logval);
	...
	public static void RMA_CodeRelationshipAddition_Utility(String LstRelationshipType, String LstRelationshipSubType, String ClaimType,String LstAvailable,boolean AdditionalParameter,int logval) throws Exception, Error
	{
		...
		try {
			...
			RMA_Functionality_Utility.RMA_MDIMenuClick_Utility("Utilities-Managers-CodeRelationships", logval);
	...
	public static void RMA_LossCodeMapping_Utility(String LstPolicySystemNames, String PolicyLOB, String Coverage,String LossCode,boolean AdditionalParameter,int logval) throws Exception, Error
	{
		...
		try {
			...
			RMA_Functionality_Utility.RMA_MDIMenuClick_Utility("Utilities-Managers-LossCodeMapping", logval);
	...
	public static void RMA_FinancialKeySetup_Utility(String SelectLOB, String SelectPolicyLOB, String PolicyDetailOnTable,String PolicyLOB,boolean AdditionalParameter,int logval) throws Exception, Error
	{
		...
		try {
			...
			RMA_Functionality_Utility.RMA_MDIMenuClick_Utility("Utilities-Managers-FinancialkeySetup", logval);
	...
	public static void RMA_PrintPreview_Utility( String PDFPassword, String PdfSaveOpenOption, String VerificationText, boolean AdditionalParameter,int logval) throws Exception, Error
	{
		...
		CurrentTime=RMA_GenericUsages_Utility.RMA_CurrentTimeInfo_Utility("HH:mm");// For Uniquely Identification Of The Down-loaded File name 
		CurrentDate=RMA_GenericUsages_Utility.RMA_CurrentDateInfo_Utility("MM/dd/yyyy");// For Uniquely Identification Of The Down-loaded File name 
		String PhysicalPath=System.getProperty("user.dir")+"//RMATestInputFile//DownloadTestFile//Report"+CurrentDate+CurrentTime+".pdf";
		try {
			...
			{
				RMA_Verification_Utility.RMA_PartialTextVerification(String.valueOf(Text),StrPdfContents, Text+" Value Verification On PDF", logval);// Verification done for String and int Both values
			}
			...
			if(RMAApp_BrowserName.equalsIgnoreCase("IE"))
			{
				RMA_Navigation_Utility.RMA_SikuliObjectClick(RMA_Selenium_POM_Sikuli_Images.RMAApp_Screen_Img_Close(), "Close Image on View Downloads Popup", logval);// Close The View Download Popup
			}
	...
	public static void RMA_PrintSummary_Utility( String VerificationText, boolean AdditionalParameter,int logval) throws Exception, Error
	{
		...
		try {
			...
			if(RMAApp_BrowserName.equalsIgnoreCase("IE"))
			{
				RMA_Navigation_Utility.RMA_SikuliObjectClick(RMA_Selenium_POM_Sikuli_Images.RMAApp_Download_Btn_Open(), "Open Button on IE Downloads Notification Popup", logval);
				RMA_GenericUsages_Utility.RMA_StaticWait(4, logval, "Wait Is Added As PDF Is Getting Opened");
			}			
			String StrPdfContents =   RMA_GenericUsages_Utility.RMA_WebPageCopyPaste_Utility(logval);
			for(String Text: TextToBeVerified)// Check Every Value
			...
			RMA_Navigation_Utility.RMA_SikuliObjectClick(RMA_Selenium_POM_Sikuli_Images.RMAApp_Screen_Img_Close(), "Close Image on PDF Authentication Popup", logval);	
			RMA_GenericUsages_Utility.RMA_StaticWait(4, logval, "Wait Is Added As PDF Is Closed");
			if(logval == 0)
			{
	...
	public static String RMA_MaintAdminTrackingAddition_Utility(String TrackingType, int logval) throws Exception, Error
	{
		try {
			...
			switch (TrackingType){
			case "BondAbstract":
				RMA_MDIMenuClick_Utility("Maintenance-AdminTracking", logval);
