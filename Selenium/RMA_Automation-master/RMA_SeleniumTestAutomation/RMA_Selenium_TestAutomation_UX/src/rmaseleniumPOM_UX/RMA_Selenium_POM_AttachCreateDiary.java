...
public class RMA_Selenium_POM_AttachCreateDiary {
	...
	{
		Element = null;
		Element = driver.findElement(By.name("Cancel")); //Unique Name Of Close Button On RMA Attach/Create Diary Is Fetched
		return Element;
	}
	...
	//============================================================================================
	//FunctionName 			: RMAApp_AttachCreate_Diary_Chk_NotifyByEmail
	//Description  			: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which Automatic Notification By Email CheckBox On RMA Attach/Create Diary Page Can Be Identified
	//Input Parameter 		: Driver Variable Of The Type WebDriver		 
	//Revision				: 0.0 - NikitaThani-11-14-2018         
	//============================================================================================
	public static WebElement RMAApp_AttachCreate_Diary_Chk_NotifyByEmail(WebDriver driver)
	{
		Element = null;
		Element = driver.findElement(By.id("emailNotify")); 
		return Element;
	}

	//============================================================================================
	//FunctionName 			: RMAApp_AttachCreate_Diary_Btn_AttachTo
	//Description  			: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which Assign Diary To Button On RMA Attach/Create Diary Page Can Be Identified
	//Input Parameter 		: Driver Variable Of The Type WebDriver		 
	//Revision				: 0.0 - NikitaThani-09-05-2019                 
	//============================================================================================
	public static WebElement RMAApp_AttachCreate_Diary_Btn_AttachTo(WebDriver driver)
	{
		Element = null;
		Element = driver.findElement(By.id("btn_attachRecordid")); 
		return Element;
	}
}
