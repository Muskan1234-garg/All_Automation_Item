...
public class RMA_Selenium_POM_Physician {
	...
	//Revision				: 0.0 - KumudNaithani-07-21-2017                                 
	//================================================================================================================================================================================================
	public static WebElement RMAApp_MaintenancePhysician_Txt_LastName(WebDriver driver)
	{
		Element = null;
	...
	//Revision				: 0.0 - KumudNaithani-07-21-2017                                 
	//================================================================================================================================================================================================
	public static WebElement RMAApp_PIPhysician_Txt_LastName(WebDriver driver)
	{
		Element = null;
		Element = driver.findElement(By.id("lookup_lastname")); //Unique Id Of Last Name TextBox On Physician Page Is Fetched
		return Element;
	}
	//=================================================================================================================================================================================================
	...
	//===============================================================================================================================================================================================================================================================
	public static WebElement RMAApp_Physician_Tab_Physician(WebDriver driver)
	{
		Element = null;
		Element = driver.findElement(By.xpath(".//*[contains(@class,'ng-scope panel-heading tabFocusWd ng-binding') and text()='Physician ']")); //Unique x-path Of Physician Tab On RMA Application Physician Creation Page Is Fetched
		return Element;
	}
	...
	//=================================================================================================================================================================================================
	//FunctionName 			: RMAApp_Physician_Privileges_Btn_Category 
	//Description  			: To Fetch Unique Property (Such As Id, X-path, Name ) On The Basis Of Which Category Button On Privileges Page Can Be Identified
	//Input Parameter 		: Entity Variable Of The Type WebEntity		 
	//Revision				: 0.0 - ShrutiShruti-03-20-2018                                 
	//================================================================================================================================================================================================
	public static WebElement RMAApp_Physician_Privileges_Btn_Category(WebDriver driver)
	{
		Element = null;
		Element = driver.findElement(By.id("btn_categorycode_openlookup")); //Unique Id Of Category Button On Privileges Page Is Fetched
		return Element;
	}

	//=================================================================================================================================================================================================
	//FunctionName 			: RMAApp_Physician_Privileges_Img_Save 
	//Description  			: To Fetch Unique Property (Such As Id, X-path, Name ) On The Basis Of Which Save Image Button On Privileges Page Can Be Identified
	//Input Parameter 		: Entity Variable Of The Type WebEntity		 
	//Revision				: 0.0 - ShrutiShruti-03-20-2018                                 
	//================================================================================================================================================================================================
	public static WebElement RMAApp_Physician_Privileges_Img_Save(WebDriver driver)
	{
		Element = null;
		Element = driver.findElement(By.xpath(".//*[@class='material-icons material-icons-clr' and contains(text(),'save')]//ancestor::a[1]")); //Unique Id Of Save Image Button On Privileges Page Is Fetched
		return Element;
	}

	//=================================================================================================================================================================================================
	//FunctionName 			: RMAApp_Physician_Certifications_Btn_Name 
	//Description  			: To Fetch Unique Property (Such As Id, X-path, Name ) On The Basis Of Which Name Lookup Button On Certifications Page Can Be Identified
	//Input Parameter 		: Entity Variable Of The Type WebEntity		 
	//Revision				: 0.0 - NidhiJha-12-01-2017                                 
	//================================================================================================================================================================================================
	public static WebElement RMAApp_Physician_Certifications_Btn_Name(WebDriver Entity)
	{
		Element = null;
		Element = Entity.findElement(By.id("btn_namecode_openlookup")); //Unique Id Of Name Lookup Button  On Certifications Page Is Fetched
		return Element;
	}

	//=================================================================================================================================================================================================
	//FunctionName 			: RMAApp_Physician_Education_Btn_Type 
	//Description  			: To Fetch Unique Property (Such As Id, X-path, Name ) On The Basis Of Which Type Lookup button On Education Page Can Be Identified
	//Input Parameter 		: Entity Variable Of The Type WebEntity		 
	//Revision				: 0.0 - NidhiJha-15-01-2017                                 
	//================================================================================================================================================================================================
	public static WebElement RMAApp_Physician_Education_Btn_Type(WebDriver Entity)
	{
		Element = null;
		Element = Entity.findElement(By.id("btn_eductypecode_openlookup")); //Unique Id Of  Type Button On Education Page Is Fetched
		return Element;
	}

	//=================================================================================================================================================================================================
	//FunctionName 			: RMAApp_Physician_Education_Txt_Institution 
	//Description  			: To Fetch Unique Property (Such As Id, X-path, Name ) On The Basis Of Which Institution TextBox On Education Page Can Be Identified
	//Input Parameter 		: Entity Variable Of The Type WebEntity		 
	//Revision				: 0.0 - NidhiJha-15-01-2017                                 
	//================================================================================================================================================================================================
	public static WebElement RMAApp_Physician_Education_Txt_Institution(WebDriver Entity)
	{
		Element = null;
		Element = Entity.findElement(By.id("lookup_institutioneid")); //Unique Id Of Institution TextBox On Education Page Is Fetched
		return Element;
	}

	//=================================================================================================================================================================================================
	//FunctionName 			: RMAApp_Physician_PrevHospital_Txt_Hospital 
	//Description  			: To Fetch Unique Property (Such As Id, X-path, Name ) On The Basis Of Which Hospital TextBox On Education Page Can Be Identified
	//Input Parameter 		: Entity Variable Of The Type WebEntity		 
	//Revision				: 0.0 - NidhiJha-15-01-2017                                 
	//================================================================================================================================================================================================
	public static WebElement RMAApp_Physician_PrevHospital_Txt_Hospital(WebDriver Entity)
	{
		Element = null;
		Element = Entity.findElement(By.id("lookup_hospitaleid")); //Unique Id Of Hospital TextBox On Education Page Is Fetched
		return Element;
	}

	//=================================================================================================================================================================================================
	//FunctionName 			: RMAApp_Physician_PrevHospital_Btn_Status 
	//Description  			: To Fetch Unique Property (Such As Id, X-path, Name ) On The Basis Of Which Status Lookup button On Education Page Can Be Identified
	//Input Parameter 		: Entity Variable Of The Type WebEntity		 
	//Revision				: 0.0 - NidhiJha-15-01-2017                                 
	//================================================================================================================================================================================================
	public static WebElement RMAApp_Physician_PrevHospital_Btn_Status(WebDriver Entity)
	{
		Element = null;
		Element = Entity.findElement(By.id("btn_statuscode_openlookup")); //Unique Id Of  Status Button On Education Page Is Fetched
		return Element;
	}

	//=================================================================================================================================================================================================
	//FunctionName                    : RMAApp_Physician_PreviousHospital_Btn_Privilege 
	//Description                     : To Fetch Unique Property (Such As Id, X-path, Name ) On The Basis Of Which Privilege Button On Previous Hospital Page Can Be Identified
	//Input Parameter          : Entity Variable Of The Type WebEntity       
	//Revision                        : 0.0 - FaizaSheikh-03-22-2018                                 
	//================================================================================================================================================================================================
	public static WebElement RMAApp_Physician_PreviousHospital_Btn_Privilege(WebDriver driver)
	{
		Element = null;
		Element = driver.findElement(By.id("btn_privcode_openlookup")); //Unique Id Of Privilege Button On Previous Hospital Page Is Fetched
		return Element;
	}

	//=================================================================================================================================================================================================
	//FunctionName                    : RMAApp_Physician_PreviousHospital_Btn_Status 
	//Description                     : To Fetch Unique Property (Such As Id, X-path, Name ) On The Basis Of Which Status Button On Previous Hospital Page Can Be Identified
	//Input Parameter          : Entity Variable Of The Type WebEntity       
	//Revision                        : 0.0 - FaizaSheikh-03-22-2018                                 
	//================================================================================================================================================================================================
	public static WebElement RMAApp_Physician_PreviousHospital_Btn_Status(WebDriver driver)
	{
		Element = null;
		Element = driver.findElement(By.id("btn_statuscode_openlookup")); //Unique Id Of Status Button On Previous Hospital Page Is Fetched
		return Element;
	}
	//============================================================================================
	//FunctionName 			: RMAApp_Physician_Lookup_Txt_LastName
	//Description  			: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which LastName TextBox On Physician Lookup Page On RMA Application Can Be Identified 	
	//Input Parameter 		: Driver Variable Of The Type WebDriver		 
	//Revision				: 0.0 - NikitaThani-03-26-2018                                
	//============================================================================================

	public static WebElement RMAApp_Physician_Lookup_Txt_LastName(WebDriver driver)
	{
		{
			Element = null;
			Element = driver.findElement(By.xpath(".//*[@class='ui-grid-filter-container ng-scope']/div[@class='ng-scope']/input")); //Unique Id Of LastName TextBox On Physician Lookup Page Is Fetched
			return Element;
		}
	}
	...
	//============================================================================================
	//FunctionName 			: RMAApp_Physician_Lookup_Txt_LastName
	//Description  			: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which SSN TextBox On Physician Lookup Page On RMA Application Can Be Identified 	
	//Input Parameter 		: Driver Variable Of The Type WebDriver		 
	//Revision				: 0.0 - NikitaThani-03-26-2018                                
	//============================================================================================

	public static WebElement RMAApp_Physician_Txt_SSN(WebDriver driver)
	{
		{
			Element = null;
			try{
				Element = driver.findElement(By.id("taxid")); //Unique Id Of SSN TextBox On Physician Lookup Page Is Fetched
	...
	//============================================================================================
	//FunctionName 			: RMAApp_Physician_RightPanel_Txt_BankingInformtion
	//Description  			: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which Banking Information On Right Panel Of Physician Page On RMA Application Can Be Identified 	
	//Input Parameter 		: Driver Variable Of The Type WebDriver		 
	//Revision				: 0.0 - NikitaThani-03-27-2018                                
	//============================================================================================

	public static WebElement RMAApp_Physician_RightPanel_Txt_BankingInformtion(WebDriver driver)
	{
		{
			Element = null;
			try{
				Element = driver.findElement(By.xpath(".//*[@class='RightRecentlyViewed ng-binding' and contains(text(),'Banking Information')]")); //Unique Id Of Banking Information On Right Panel Of Physician Page Is Fetched
			}catch(Exception|Error e){
			}return Element;
	...
	//============================================================================================
	//FunctionName 			: RMAApp_Physician_Txt_EffectiveDate
	//Description  			: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which Effective Date On Physician Page On RMA Application Can Be Identified 	
	//Input Parameter 		: Driver Variable Of The Type WebDriver		 
	//Revision				: 0.0 - NikitaThani-04-09-2018                                
	//============================================================================================

	public static WebElement RMAApp_Physician_Txt_EffectiveDate(WebDriver driver)
	{
		{
			Element = null;
			try{
				Element = driver.findElement(By.xpath(".//*[@id='effectivedate' and @type='text']")); //Unique Id Of Effective Date Physician Page Is Fetched
			}catch(Exception|Error e){
			}return Element;
	...
	//============================================================================================
	//FunctionName 			: RMAApp_Physician_Txt_ExpirationDate
	//Description  			: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which Expiration Date On Physician Page On RMA Application Can Be Identified 	
	//Input Parameter 		: Driver Variable Of The Type WebDriver		 
	//Revision				: 0.0 - NikitaThani-04-09-2018                                
	//============================================================================================

	public static WebElement RMAApp_Physician_Txt_ExpirationDate(WebDriver driver)
	{
		{
			Element = null;
			try{
				Element = driver.findElement(By.xpath(".//*[@id='expirationdate' and @type='text']")); //Unique Id Of Expiration Date Physician Page Is Fetched
			}catch(Exception|Error e){
			}return Element;
	...
	//============================================================================================
	//FunctionName 			: RMAApp_Physician_Txt_LicenseExpireDate
	//Description  			: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which License Expire Date On Physician Page On RMA Application Can Be Identified 	
	//Input Parameter 		: Driver Variable Of The Type WebDriver		 
	//Revision				: 0.0 - NikitaThani-04-09-2018                                
	//============================================================================================

	public static WebElement RMAApp_Physician_Txt_LicenseExpireDate(WebDriver driver)
	{
		{
			Element = null;
			try{
				Element = driver.findElement(By.xpath(".//*[@id='licenceexpirydate' and @type='text']")); //Unique Id Of License Expire Date Physician Page Is Fetched
			}catch(Exception|Error e){
			}return Element;
	...
	//============================================================================================
	//FunctionName 			: RMAApp_Physician_Txt_LicenseIssueDate
	//Description  			: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which License Issue Date On Physician Page On RMA Application Can Be Identified 	
	//Input Parameter 		: Driver Variable Of The Type WebDriver		 
	//Revision				: 0.0 - NikitaThani-04-09-2018                                
	//============================================================================================

	public static WebElement RMAApp_Physician_Txt_LicenseIssueDate(WebDriver driver)
	{
		{
			Element = null;
			try{
				Element = driver.findElement(By.xpath(".//*[@id='licenceissuedate' and @type='text']")); //Unique Id Of License Issue Date Physician Page Is Fetched
			}catch(Exception|Error e){
			}return Element;
	...
	//============================================================================================
	//FunctionName 			: RMAApp_Physician_Txt_LicenseNumber
	//Description  			: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which License Number TextBox On Physician Page On RMA Application Can Be Identified 	
	//Input Parameter 		: Driver Variable Of The Type WebDriver		 
	//Revision				: 0.0 - NikitaThani-04-09-2018                                
	//============================================================================================

	public static WebElement RMAApp_Physician_Txt_LicenseNumber(WebDriver driver)
	{
		{
			Element = null;
			try{
				Element = driver.findElement(By.id("licencenumber")); //Unique Id Of License Number TextBox Physician Page Is Fetched
			}catch(Exception|Error e){
			}return Element;
	...
	//============================================================================================
	//FunctionName 			: RMAApp_Physician_Previliges_Lnk_PhysicianRightHandTree
	...
	//Input Parameter 		: Driver Variable Of The Type WebDriver		 
	//Revision				: 0.0 - Jannathhussain-04-06-2018                                
	//============================================================================================
	public static WebElement RMAApp_Physician_Previliges_Lnk_PhysicianRightHandTree(WebDriver driver, String PrevgCategry)
	{
		Element = null;
		try{
			Element = driver.findElement(By.xpath("//a[@ng-click='listVM.select(list, listVM.view.child)' and @class='rightPanel-alink ng-binding' and contains(text(),'"+PrevgCategry+"')]")); //Unique X-path Of Vehicle Accidents Information Link On RMA Application Vehicle Page Is Fetched
		}catch(Exception|Error e){
		}
		return Element;
	}
	//============================================================================================
	//FunctionName 			: RMAApp_Physician_Certification_Lnk_PhysicianRightHandTree
	//Description  			: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which Vehicle Accidents Information Link On RMA Application Vehicle Page Can Be Identified
	//Input Parameter 		: Driver Variable Of The Type WebDriver		 
	//Revision				: 0.0 - Jannathhussain-04-17-2018                                
	//============================================================================================
	public static WebElement RMAApp_Physician_Certification_Lnk_PhysicianRightHandTree(WebDriver driver, String CertificationName)
	{
		Element = null;
		try{
			Element = driver.findElement(By.xpath("//a[@ng-click='listVM.select(list, listVM.view.child)' and contains(text(),'"+CertificationName+"')]")); //Unique X-path Of Vehicle Accidents Information Link On RMA Application Vehicle Page Is Fetched
		}catch(Exception|Error e){
		}
		return Element;
	}
	...
	//=================================================================================================================================================================================================
	//FunctionName 			: RMAApp_PI_Txt_Sex
	//Description  			: To Fetch Unique Property (Such As Id, X-path, Name ) On The Basis Of Which Sex TextBox On Person Involved Page Can Be Identified
	//Input Parameter 		: Driver Variable Of The Type WebDriver		 
	//Revision				: 0.0 - DebasmitaPati-15-10-2019                                 
	//================================================================================================================================================================================================
	public static WebElement RMAApp_PI_Txt_Sex(WebDriver driver)
	{
		Element = null;
		Element = driver.findElement(By.id("lookup_sexcode")); //Unique Id Of Sex TextBox On Person Involved Page Is Fetched
		return Element;
	}

	//=================================================================================================================================================================================================
	//FunctionName 			: RMAApp_PI_Btn_Sex
	//Description  			: To Fetch Unique Property (Such As Id, X-path, Name ) On The Basis Of Which Sex Lookup Button On Person Involved Page Can Be Identified
	//Input Parameter 		: Driver Variable Of The Type WebDriver		 
	//Revision				: 0.0 - DebasmitaPati-15-10-2019                                 
	//================================================================================================================================================================================================
	public static WebElement RMAApp_PI_Btn_Sex(WebDriver driver)
	{
		Element = null;
		Element = driver.findElement(By.id("btn_sexcode_openlookup")); //Unique Id Of Sex Lookup Button On Person Involved Page Is Fetched
		return Element;
	}

	//=================================================================================================================================================================================================
	//FunctionName 			: RMAApp_PI_Txt_MaritalStatus
	//Description  			: To Fetch Unique Property (Such As Id, X-path, Name ) On The Basis Of Which Marital Status TextBox On Person Involved Page Can Be Identified
	//Input Parameter 		: Driver Variable Of The Type WebDriver		 
	//Revision				: 0.0 - DebasmitaPati-15-10-2019                                 
	//================================================================================================================================================================================================
	public static WebElement RMAApp_PI_Txt_MaritalStatus(WebDriver driver)
	{
		Element = null;
		Element = driver.findElement(By.id("lookup_maritalstatcode")); //Unique Id Of Marital Status TextBox On Person Involved Page Is Fetched
		return Element;
	}

	//=================================================================================================================================================================================================
	//FunctionName 			: RMAApp_PI_Btn_MaritalStatus
	//Description  			: To Fetch Unique Property (Such As Id, X-path, Name ) On The Basis Of Which Marital Status Lookup Button On Person Involved Page Can Be Identified
	//Input Parameter 		: Driver Variable Of The Type WebDriver		 
	//Revision				: 0.0 - ShrutiShruti-12-17-2019                                 
	//================================================================================================================================================================================================
	public static WebElement RMAApp_PI_Btn_MaritalStatus(WebDriver driver)
	{
		Element = null;
		Element = driver.findElement(By.id("btn_maritalstatcode_openlookup")); //Unique Id Of Marital Status Lookup Button On Person Involved Page Is Fetched
		return Element;
	}
}