...
public class RMA_Selenium_POM_Employee {
	...
	{
		Element = null;
		Element = driver.findElement(By.id("lookup_lastname")); //Unique Id Of Last Name TextBox On Employee Page Is Fetched
		return Element;
	}
	...
	//Revision				: 0.0 - KumudNaithani-07-21-2017                                 
	//================================================================================================================================================================================================
	public static WebElement RMAApp_EmployeeMaintenance_Txt_LastName(WebDriver driver)
	{
		Element = null;
	...
	{
		Element = null;
		Element = driver.findElement(By.id("btn_country_openlookup")); //Unique Id  Of Country LookUp Button On RMA Application Maintenance-->Employee Creation Page Is Fetched
		return Element;
	}
	...
	{
		Element = null;
		Element = driver.findElement(By.id("btn_countrycode_openlookup")); //Unique Id Of Country LookUp Button On RMA Application Employee Creation Page Is Fetched
		return Element;
	}
	...
	{
		Element = driver.findElement(By.id("btn_state_openlookup")); //Unique Id Of State Button On RMA Application Maintenance-->Employee Page Is Fetched
		return Element;
	}
	...
	{
		Element = driver.findElement(By.id("btn_stateid_openlookup")); //Unique Id Of State Button On RMA Application Employee Page Is Fetched
		return Element;
	}
	...
	{
		Element = driver.findElement(By.xpath(".//*[@id='btn_driverslictypecode_openlookup']")); //Unique Id Of License Type Button On RMA Application Employee Page Is Fetched
		return Element;
	}
	...
	{
		Element = driver.findElement(By.xpath(".//*[@id='btn_drivlicrstrctcode_openlookup']")); //Unique Id Of Restrictions Button On RMA Application Employee Page Is Fetched
		return Element;
	}
	...
	{
		Element = driver.findElement(By.xpath(".//*[@id='btn_emailtypecode_openlookup']")); //Unique Id Of Email Type Button On RMA Application Employee Page Is Fetched
		return Element;
	}
	...
	{
		Element = driver.findElement(By.xpath(".//*[@id='btn_costcentercode_openlookup']")); //Unique Id Of Cost Center Button On RMA Application Employee Page Is Fetched
		return Element;
	}
	...
	{
		Element = driver.findElement(By.xpath(".//*[@id='btn_positioncode_openlookup']")); //Unique Id Of Position Code Button On RMA Application Employee Page Is Fetched
		return Element;
	}
	...
	{
		Element = driver.findElement(By.xpath(".//*[@id='btn_supervisoreid_openlookup']")); //Unique Id Of Supervisor Button On RMA Application Employee Page Is Fetched
		return Element;
	}
	...
	{
		Element = driver.findElement(By.xpath(".//*[@id='btn_paytypecode_openlookup']")); //Unique Id Of Pay Type Button On RMA Application Employee Page Is Fetched
		return Element;
	}
	...
	{
		Element = driver.findElement(By.xpath(".//*[@class='material-icons material-icons-clr' and contains(text(),'save')]//ancestor::span[1]")); //Unique Id Save Image Button On RMA Application Employee Page Is Fetched
		return Element;
	}
	...
	{
		Element = driver.findElement(By.id("btn_sexcode_openlookup")); //Unique Id Of Sex Button On RMA Application Maintenance-->Employee Page Is Fetched
		return Element;
	}
	...
	{
		Element = driver.findElement(By.id("btn_maritalstatcode_openlookup")); //Unique Id Of Marital Status Button On RMA Application Maintenance-->Employee Page Is Fetched
		return Element;
	}
	...
	{
		Element = driver.findElement(By.id("btn_paytypecode_openlookup")); //Unique Id Of Pay Type Button On RMA Application Maintenance-->Employee Page Is Fetched
		return Element;
	}
	...
	//=================================================================================================================================================================================================
	//FunctionName 			: RMAApp_MaintEmployee_Txt_LookupEmployeeNumber
	//Description  			: To Fetch Unique Property (Such As Id, X-path, Name ) On The Basis Of Which EmployeeNumber TextBox On Lookup On Maintenance -->Employee Page Can Be Identified
	//Input Parameter 		: Driver Variable Of The Type WebDriver		 
	//Revision				: 0.0 - ShrutiShruti-04-10-2018                                  
	//================================================================================================================================================================================================
	public static WebElement RMAApp_MaintEmployee_Txt_LookupEmployeeNumber(WebDriver driver)
	{
		Element = null;
		Element = driver.findElement(By.xpath(".//*[@class='ui-grid-filter-container ng-scope']/div[@class='ng-scope']/input ")); //Unique Id Of EmployeeNumber TextBox On Lookup Window TextBox On Maintenance -->Employee Page Is Fetched
		return Element;
	}

	//=================================================================================================================================================================================================
	//FunctionName 			: RMAApp_MaintEmployee_Btn_LookupLastPage
	//Description  			: To Fetch Unique Property (Such As Id, X-path, Name ) On The Basis Of Which Last Page Button On Lookup Page On Maintenance -->Employee Page Can Be Identified
	//Input Parameter 		: Driver Variable Of The Type WebDriver		 
	//Revision				: 0.0 - ShrutiShruti-04-10-2018                                  
	//================================================================================================================================================================================================
	public static WebElement RMAApp_MaintEmployee_Btn_LookupLastPage(WebDriver driver)
	{
		Element = null;
		Element = driver.findElement(By.xpath(".//*[@class='ui-grid-pager-last']")); //Unique Id Of Last Page Button On Lookup Page On Maintenance -->Employee Page Is Fetched
		return Element;
	}


	//============================================================================================
	//FunctionName 			: RMAApp_MaintEmployee_Btn_EmploymentCountry
	//Description  			: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which Employment Country LookUp Button On RMA Application Maintenance-->Employee Creation Page Can Be Identified
	//Input Parameter 		: Driver Variable Of The Type WebDriver		 
	//Revision				: 0.0 - NikitaThani-07-23-2019                                
	//============================================================================================
	public static WebElement RMAApp_MaintEmployee_Btn_EmploymentCountry(WebDriver driver)
	{
		Element = null;
		Element = driver.findElement(By.xpath(".//*[@id='btn_employementcountry_openlookup']")); //Unique Id  Of Country LookUp Button On RMA Application Maintenance-->Employee Creation Page Is Fetched
		return Element;
	}

	//============================================================================================
	//FunctionName 			: RMAApp_MaintEmployee_Chk_Resident
	//Description  			: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which Resident CheckBox On RMA Application Claim Creation Page Can Be Identified
	//Input Parameter 		: Driver Variable Of The Type WebDriver		 
	//Revision				: 0.0 - NikitaThani-07-23-2019                                 
	// ============================================================================================
	public static WebElement RMAApp_MaintEmployee_Chk_Resident(WebDriver driver)
	{
		Element = null;
		Element = driver.findElement(By.id("resident")); //Unique Id  Of  Resident CheckBox  On RMA Application Claim Creation Page Is Fetched
		return Element;
	}


	//============================================================================================
	//FunctionName 			: RMAApp_MaintEmployee_Chk_TaxFreeThresholdClaimed
	//Description  			: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which Tax Free Threshold Claimed CheckBox On RMA Application Claim Creation Page Can Be Identified
	//Input Parameter 		: Driver Variable Of The Type WebDriver		 
	//Revision				: 0.0 - NikitaThani-07-23-2019                                 
	// ============================================================================================
	public static WebElement RMAApp_MaintEmployee_Chk_TaxFreeThresholdClaimed(WebDriver driver)
	{
		Element = null;
		Element = driver.findElement(By.id("thresholdclaimed")); //Unique Id  Of Tax Free Threshold Claimed CheckBox  On RMA Application Claim Creation Page Is Fetched
		return Element;
	}

	//============================================================================================
	//FunctionName 			: RMAApp_MaintEmployee_Chk_HELP_SSL_TSLApplicable
	//Description  			: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which HELP/SSL/TSL Applicable? CheckBox On RMA Application Claim Creation Page Can Be Identified
	//Input Parameter 		: Driver Variable Of The Type WebDriver		 
	//Revision				: 0.0 - NikitaThani-07-23-2019                                 
	// ============================================================================================
	public static WebElement RMAApp_MaintEmployee_Chk_HELP_SSL_TSLApplicable(WebDriver driver)
	{
		Element = null;
		Element = driver.findElement(By.id("helpsslapplicable")); //Unique Id  Of HELP/SSL/TSL Applicable? CheckBox  On RMA Application Claim Creation Page Is Fetched
		return Element;
	}

	//============================================================================================
	//FunctionName 			: RMAApp_MaintEmployee_Chk_SFSS_Applicable
	//Description  			: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which SFSS Applicable? CheckBox On RMA Application Claim Creation Page Can Be Identified
	//Input Parameter 		: Driver Variable Of The Type WebDriver		 
	//Revision				: 0.0 - NikitaThani-07-23-2019                                 
	// ============================================================================================
	public static WebElement RMAApp_MaintEmployee_Chk_SFSS_Applicable(WebDriver driver)
	{
		Element = null;
		Element = driver.findElement(By.id("sfssapplicable")); //Unique Id  Of SFSS Applicable? CheckBox  On RMA Application Claim Creation Page Is Fetched
		return Element;
	}

	//============================================================================================
	//FunctionName 			: RMAApp_MaintEmployee_Txt_MedicareLevyExemption
	//Description  			: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which Medicare Levy Exemption TextBox On RMA Application Claim Creation Page Can Be Identified
	//Input Parameter 		: Driver Variable Of The Type WebDriver		 
	//Revision				: 0.0 - NikitaThani-07-23-2019                                 
	// ============================================================================================
	public static WebElement RMAApp_MaintEmployee_Txt_MedicareLevyExemption(WebDriver driver)
	{
		Element = null;
		Element = driver.findElement(By.id("lookup_medicallevy")); //Unique Id  Of Medicare Levy Exemption TextBox On RMA Application Claim Creation Page Is Fetched
		return Element;
	}

	//============================================================================================
	//FunctionName 			: RMAApp_MaintEmployee_Btn_MedicareLevyExemption
	//Description  			: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which Medicare Levy Exemption Button On RMA Application Claim Creation Page Can Be Identified
	//Input Parameter 		: Driver Variable Of The Type WebDriver		 
	//Revision				: 0.0 - NikitaThani-07-23-2019                                 
	// ============================================================================================
	public static WebElement RMAApp_MaintEmployee_Btn_MedicareLevyExemption(WebDriver driver)
	{
		Element = null;
		Element = driver.findElement(By.id("btn_medicallevy_openlookup")); //Unique Id  Of Medicare Levy Exemption Button On RMA Application Claim Creation Page Is Fetched
		return Element;
	}

	//============================================================================================
	//FunctionName 			: RMAApp_MaintEmployee_Chk_SundayFlag
	//Description  			: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which Sunday CheckBox On RMA Application Employee Creation Page Can Be Identified
	//Input Parameter 		: Driver Variable Of The Type WebDriver		 
	//Revision				: 0.0 - NikitaThani-07-23-2019                                 
	// ============================================================================================
	public static WebElement RMAApp_MaintEmployee_Chk_SundayFlag(WebDriver driver)
	{
		Element = null;
		Element = driver.findElement(By.id("worksunflag")); //Unique Id  Of Sunday CheckBox On RMA Application Employee Creation Page Is Fetched
		return Element;
	}

	//============================================================================================
	//FunctionName 			: RMAApp_MaintEmployee_Chk_MondayFlag
	//Description  			: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which Monday CheckBox On RMA Application Employee Creation Page Can Be Identified
	//Input Parameter 		: Driver Variable Of The Type WebDriver		 
	//Revision				: 0.0 - NikitaThani-07-23-2019                                 
	// ============================================================================================
	public static WebElement RMAApp_MaintEmployee_Chk_MondayFlag(WebDriver driver)
	{
		Element = null;
		Element = driver.findElement(By.id("workmonflag")); //Unique Id  Of Monday CheckBox On RMA Application Employee Creation Page Is Fetched
		return Element;
	}

	//============================================================================================
	//FunctionName 			: RMAApp_MaintEmployee_Chk_TuesdayFlag
	//Description  			: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which Tuesday CheckBox On RMA Application Employee Creation Page Can Be Identified
	//Input Parameter 		: Driver Variable Of The Type WebDriver		 
	//Revision				: 0.0 - NikitaThani-07-23-2019                                 
	// ============================================================================================
	public static WebElement RMAApp_MaintEmployee_Chk_TuesdayFlag(WebDriver driver)
	{
		Element = null;
		Element = driver.findElement(By.id("worktueflag")); //Unique Id  Of Tuesday CheckBox On RMA Application Employee Creation Page Is Fetched
		return Element;
	}

	//============================================================================================
	//FunctionName 			: RMAApp_MaintEmployee_Chk_WednesdayFlag
	//Description  			: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which Wednesday CheckBox On RMA Application Employee Creation Page Can Be Identified
	//Input Parameter 		: Driver Variable Of The Type WebDriver		 
	//Revision				: 0.0 - NikitaThani-07-23-2019                                 
	// ============================================================================================
	public static WebElement RMAApp_MaintEmployee_Chk_WednesdayFlag(WebDriver driver)
	{
		Element = null;
		Element = driver.findElement(By.id("workwedflag")); //Unique Id  Of Wednesday CheckBox On RMA Application Employee Creation Page Is Fetched
		return Element;
	}

	//============================================================================================
	//FunctionName 			: RMAApp_MaintEmployee_Chk_ThursdayFlag
	//Description  			: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which Thursday CheckBox On RMA Application Employee Creation Page Can Be Identified
	//Input Parameter 		: Driver Variable Of The Type WebDriver		 
	//Revision				: 0.0 - NikitaThani-07-23-2019                                 
	// ============================================================================================
	public static WebElement RMAApp_MaintEmployee_Chk_ThursdayFlag(WebDriver driver)
	{
		Element = null;
		Element = driver.findElement(By.id("workthuflag")); //Unique Id  Of Thursday CheckBox On RMA Application Employee Creation Page Is Fetched
		return Element;
	}

	//============================================================================================
	//FunctionName 			: RMAApp_MaintEmployee_Chk_FridayFlag
	//Description  			: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which Friday CheckBox On RMA Application Employee Creation Page Can Be Identified
	//Input Parameter 		: Driver Variable Of The Type WebDriver		 
	//Revision				: 0.0 - NikitaThani-07-23-2019                                 
	// ============================================================================================
	public static WebElement RMAApp_MaintEmployee_Chk_FridayFlag(WebDriver driver)
	{
		Element = null;
		Element = driver.findElement(By.id("workfriflag")); //Unique Id  Of Friday CheckBox On RMA Application Employee Creation Page Is Fetched
		return Element;
	}

	//============================================================================================
	//FunctionName 			: RMAApp_MaintEmployee_Chk_SaturdayFlag
	//Description  			: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which Saturday CheckBox On RMA Application Employee Creation Page Can Be Identified
	//Input Parameter 		: Driver Variable Of The Type WebDriver		 
	//Revision				: 0.0 - NikitaThani-07-23-2019                                 
	// ============================================================================================
	public static WebElement RMAApp_MaintEmployee_Chk_SaturdayFlag(WebDriver driver)
	{
		Element = null;
		Element = driver.findElement(By.id("worksatflag")); //Unique Id  Of Saturday CheckBox On RMA Application Employee Creation Page Is Fetched
		return Element;
	}

	//============================================================================================
	//FunctionName 			: RMAApp_MaintEmployee_Btn_SuperFundsProvider
	//Description  			: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which Super Funds Provider Button On RMA Application Employee Creation Page Can Be Identified
	//Input Parameter 		: Driver Variable Of The Type WebDriver		 
	//Revision				: 0.0 - NikitaThani-07-23-2019                                 
	// ============================================================================================
	public static WebElement RMAApp_MaintEmployee_Btn_SuperFundsProvider(WebDriver driver)
	{
		Element = null;
		Element = driver.findElement(By.xpath(".//*[@id='Super Funds Provider']/i")); //Unique Id  Of Super Funds Provider Button On RMA Application Employee Creation Page Is Fetched
		return Element;
	}

	//============================================================================================
	//FunctionName 			: RMAApp_MaintEmployee_Txt_SPIN
	//Description  			: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which SPIN TextBox On RMA Application Employee Creation Page Can Be Identified
	//Input Parameter 		: Driver Variable Of The Type WebDriver		 
	//Revision				: 0.0 - NikitaThani-07-23-2019                                 
	// ============================================================================================
	public static WebElement RMAApp_MaintEmployee_Txt_SPIN(WebDriver driver)
	{
		Element = null;
		Element = driver.findElement(By.id("superidentificationnumber")); //Unique Id  Of SPIN TextBox On RMA Application Employee Creation Page Is Fetched
		return Element;
	}

	//============================================================================================
	//FunctionName 			: RMAApp_MaintEmployee_Txt_MembershipNumber
	//Description  			: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which Membership Number TextBox On RMA Application Employee Creation Page Can Be Identified
	//Input Parameter 		: Driver Variable Of The Type WebDriver		 
	//Revision				: 0.0 - NikitaThani-07-23-2019                                 
	// ============================================================================================
	public static WebElement RMAApp_MaintEmployee_Txt_MembershipNumber(WebDriver driver)
	{
		Element = null;
		Element = driver.findElement(By.id("membershipnumber")); //Unique Id  Of  Membership Number TextBox On RMA Application Employee Creation Page Is Fetched
		return Element;
	}

	//============================================================================================
	//FunctionName 			: RMAApp_MaintEmployee_Txt_SuperFundsProvider
	//Description  			: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which Super Funds Provider TextBox On RMA Application Employee Creation Page Can Be Identified
	//Input Parameter 		: Driver Variable Of The Type WebDriver		 
	//Revision				: 0.0 - NikitaThani-07-23-2019                                 
	// ============================================================================================
	public static WebElement RMAApp_MaintEmployee_Txt_SuperFundsProvider(WebDriver driver)
	{
		Element = null;
		Element = driver.findElement(By.id("lookup_superfundprovider")); //Unique Id  Of Super Funds Provider TextBox On RMA Application Employee Creation Page Is Fetched
		return Element;
	}

	//============================================================================================
	//FunctionName 			: RMAApp_MaintEmployee_Chk_TFNProvidedToFund
	//Description  			: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which TFN Provided To Fund CheckBox On RMA Application Employee Creation Page Can Be Identified
	//Input Parameter 		: Driver Variable Of The Type WebDriver		 
	//Revision				: 0.0 - NikitaThani-07-23-2019                                 
	// ============================================================================================
	public static WebElement RMAApp_MaintEmployee_Chk_TFNProvidedToFund(WebDriver driver)
	{
		Element = null;
		Element = driver.findElement(By.id("tfnprovidedtofund")); //Unique Id  Of TFN Provided To Fund CheckBox On RMA Application Employee Creation Page Is Fetched
		return Element;
	}
	...
	//Revision				: 0.0 - NikitaThani-07-23-2019                                 
	// ============================================================================================
	public static WebElement RMAApp_MaintEmployee_Txt_Super(WebDriver driver)
	{
		Element = null;
		Element = driver.findElement(By.id("lookup_superfundprovider")); //Unique Id  Of Super Funds Provider TextBox On RMA Application Employee Creation Page Is Fetched
		return Element;
