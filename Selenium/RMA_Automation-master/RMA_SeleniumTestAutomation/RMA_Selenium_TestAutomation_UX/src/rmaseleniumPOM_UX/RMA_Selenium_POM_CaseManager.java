...
public class RMA_Selenium_POM_CaseManager {
	...
	{
		Element = null;
		Element = driver.findElement(By.xpath(".//*[@id='btn_reftype_openlookup']")); //Unique Id  Of  Referral Type Lookup Button On RMA Application Case Manager Creation Page Is Fetched
		return Element;
	}
	...
	{
		Element = null;
		Element = driver.findElement(By.xpath(".//*[@id='btn_refreasoncode_openlookup']")); //Unique Id  Of  Referral Reason Lookup Button On RMA Application Case Manager Creation Page Is Fetched
		return Element;
	}
	...
	{
		Element = null;
		Element = driver.findElement(By.xpath(".//*[@id='btn_casestatustype_openlookup']")); //Unique Id  Of  Case Status Lookup button On RMA Application Case Manager Creation Page Is Fetched
		return Element;
	}
	...
	//============================================================================================
	//FunctionName 			: RMAApp_CaseManager_Btn_CaseManagerLookup
	//Description  			: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which Primary Case Manager CheckBox On RMA Application Case Manager Creation Page Can Be Identified
	//Input Parameter 		: Driver Variable Of The Type WebDriver		 
	//Revision				: 0.0 - ShrutiShruti-01-04-2018                                 
	// ============================================================================================
	public static WebElement RMAApp_CaseManager_Btn_CaseManagerLookup(WebDriver driver)
	{
		Element = null;
		Element = driver.findElement(By.xpath(".//*[@id='btn_casemanagerlist']")); //Unique Id  Of Primary Case Manager CheckBox On RMA Application Case Manager Creation Page Is Fetched
		return Element;
	}

	//============================================================================================
	//FunctionName 			: RMAApp_CaseManager_Txt_LookupLastName
	//Description  			: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which Primary Case Manager CheckBox On RMA Application Case Manager Creation Page Can Be Identified
	//Input Parameter 		: Driver Variable Of The Type WebDriver		 
	//Revision				: 0.0 - ShrutiShruti-01-04-2018                                 
	// ============================================================================================
	public static WebElement RMAApp_CaseManager_Txt_LookupLastName(WebDriver driver)
	{
		Element = null;
		Element = driver.findElement(By.xpath(".//*[@id='FLD20000']")); //Unique Id  Of Primary Case Manager CheckBox On RMA Application Case Manager Creation Page Is Fetched
		return Element;
	}

	//============================================================================================
	//FunctionName 			: RMAApp_CaseManager_Btn_SubmitQuery
	//Description  			: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which Primary Case Manager CheckBox On RMA Application Case Manager Creation Page Can Be Identified
	//Input Parameter 		: Driver Variable Of The Type WebDriver		 
	//Revision				: 0.0 - ShrutiShruti-01-04-2018                                 
	// ============================================================================================
	public static WebElement RMAApp_CaseManager_Btn_SubmitQuery(WebDriver driver)
	{
		Element = null;
