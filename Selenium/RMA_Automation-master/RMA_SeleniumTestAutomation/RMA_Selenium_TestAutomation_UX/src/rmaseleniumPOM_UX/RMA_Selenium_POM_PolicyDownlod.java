...
public class RMA_Selenium_POM_PolicyDownlod {
	...
	//============================================================================================
	//FunctionName 			: RMAApp_PolicyDownload_Img_PolicyDownloadWC
	//Description  			: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which Next Checkboxes On RMA Application Policy Download Popup Can Be Identified
	//Input Parameter 		: Driver Variable Of The Type WebDriver		 
	//Revision				: 0.0 - NidhiJha-08-08-2017                                  
	// ============================================================================================
	public static WebElement RMAApp_PolicyDownload_Img_PolicyDownloadWC(WebDriver driver)
	{
		Element = null;
	...
	//============================================================================================
	//FunctionName 			: RMAApp_PolicyDownload_Txt_InterestCoverageList
	//Description  			: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which Interest/Coverage List Tab On RMA Application Policy Download Popup Can Be Identified
	//Input Parameter 		: Driver Variable Of The Type WebDriver		 
	//Revision				: 0.0 - AnubhutiVyas-30-10-2017                                  
	// ============================================================================================
	public static WebElement RMAApp_PolicyDownload_Txt_InterestCoverageList(WebDriver driver)
	{
		Element = null;
		Element = driver.findElement(By.xpath(".//*[contains(text(),'Interest_Coverage List')]"));
		return Element;
	}
	...
	public static WebElement RMAApp_PolicyDownload_Tbl_UnitListTable(WebDriver driver)
	{
		...
		Element = driver.findElement(By.xpath(".//*[contains(text(),'Unit Number')]/ancestor::*[@class = 'table filterPadd']"));
		//Element = driver.findElement(By.xpath(".//*[@id='tab_default_6']/following::*[@class='table filterPadd']"));
		return Element;
	}
	...
	//============================================================================================
	//FunctionName 			: RMAApp_PolicyDownLoad_Chk_CoverageDetails
	//Description  			: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which Coverage Details Checkbox On RMA Application Policy Download Page Can Be Identified
	//Input Parameter 		: Driver Variable Of The Type WebDriver		 
	//Revision				: 0.0 - AnubhutiVyas-08-08-2017                                  
	// ============================================================================================
	public static WebElement RMAApp_PolicyDownLoad_Chk_CoverageDetails(WebDriver driver)
	{
		Element = null;
		Element = driver.findElement(By.xpath(".//*[@id='032']"));
		return Element;
	}
	//============================================================================================
	//FunctionName 			: RMAApp_PolicyDownLoad_Chk_Int_Cov_List
	//Description  			: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which Interest/Coverage Checkbox On RMA Application Policy Download Page Can Be Identified
	//Input Parameter 		: Driver Variable Of The Type WebDriver		 
	//Revision				: 0.0 - AnubhutiVyas-08-08-2017                                  
	// ============================================================================================
	public static WebElement RMAApp_PolicyDownLoad_Chk_Int_Cov_List(WebDriver driver)
	{
		Element = null;
		Element = driver.findElement(By.xpath(".//*[@id='00001']"));
		return Element;
	}
	//============================================================================================
	...
	//============================================================================================
	//FunctionName 			: RMAApp_PolicyDownload_Txt_DateOfLoss
	//Description  			: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which Date Of Loss TextBox On RMA Application Policy Download Page Can Be Identified
	//Input Parameter 		: Driver Variable Of The Type WebDriver		 
	//Revision				: 0.0 - RenuVerma-05-29-2017                                  
	// ============================================================================================
	public static WebElement RMAApp_PolicyDownload_Txt_DateOfLoss(WebDriver driver)
	{
		Element = null;
		Element = driver.findElement(By.id("dtLoss")); //Unique x-path  Of DateOfLoss TextBox On RMA Application  Policy Download  Page Is Fetched
		return Element;
	}	

	//============================================================================================
	//FunctionName 			: RMAApp_PolicyDownload_Tabs
	//Description  			: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which Tabs On RMA Application Policy Download Page Can Be Identified
	//Input Parameter 		: Driver Variable Of The Type WebDriver		 
	//Revision				: 0.0 - DebasmitaPati-03-29-2019                                  
	// ============================================================================================
	public static WebElement RMAApp_PolicyDownload_Tabs(WebDriver driver, String TabName)
	{
		Element = null;
		try {
			Element = driver.findElement(By.xpath(".//*[contains(text(),'"+TabName+"')]//ancestor::li[@class='active']")); //Unique x-path Of Tabs On RMA Application Policy Download Page Is Fetched			
		} catch (Exception e) {
		}
		return Element;
	}
	...
	//============================================================================================
	//FunctionName 			: RMAApp_PolicyDownload_Btn_DownloadEntitiesNextBtn
	//Description  			: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which Next Button On Download Entities Tab On RMA Application Policy Download Page Can Be Identified
	//Input Parameter 		: Driver Variable Of The Type WebDriver		 
	//Revision				: 0.0 - DebasmitaPati-03-29-2019                                  
	// ============================================================================================
	public static WebElement RMAApp_PolicyDownload_Btn_DownloadEntitiesNextBtn(WebDriver driver)
	{
		Element = null;
		Element = driver.findElement(By.xpath(".//*[@id='Button1']")); //Unique x-path Of Next Button On Download Entities Tab On RMA Application  Policy Download  Page Is Fetched
		return Element;
	}

	//============================================================================================
	//FunctionName 			: RMAApp_PolicyDownload_Tab_DownloadDrivers
	//Description  			: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which Download Drivers Tab On RMA Application Policy Download Page Can Be Identified
	//Input Parameter 		: Driver Variable Of The Type WebDriver		 
	//Revision				: 0.0 - DebasmitaPati-03-29-2019                                  
	// ============================================================================================
	public static WebElement RMAApp_PolicyDownload_Tab_DownloadDrivers(WebDriver driver)
	{
		Element = null;
		Element = driver.findElement(By.xpath(".//*[contains(text(),'Download Drivers')]//ancestor::li[1]")); //Unique x-path  Of Download Drivers Tab On RMA Application  Policy Download  Page Is Fetched
		return Element;
	}

	//============================================================================================
	//FunctionName 			: RMAApp_PolicyDownload_Btn_DownloadDriversNextBtn
	//Description  			: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which Next Button On Download Drivers Tab On RMA Application Policy Download Page Can Be Identified
	//Input Parameter 		: Driver Variable Of The Type WebDriver		 
	//Revision				: 0.0 - DebasmitaPati-03-29-2019                                  
	// ============================================================================================
	public static WebElement RMAApp_PolicyDownload_Btn_DownloadDriversNextBtn(WebDriver driver)
	{
		Element = null;
		Element = driver.findElement(By.xpath(".//*[@id='Button2']")); //Unique x-path Of Next Button On Download Drivers Tab On RMA Application  Policy Download  Page Is Fetched
		return Element;
	}

	//============================================================================================
	//FunctionName 			: RMAApp_PolicyDownload_ChkBox_SelectUnit
	//Description  			: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which Next Button On Download Drivers Tab On RMA Application Policy Download Page Can Be Identified
	//Input Parameter 		: Driver Variable Of The Type WebDriver		 
	//Revision				: 0.0 - DebasmitaPati-03-29-2019                                  
	// ============================================================================================
	public static WebElement RMAApp_PolicyDownload_ChkBox_SelectUnit(WebDriver driver, String UnitNum)
	{
		Element = null;
		Element = driver.findElement(By.xpath(".//*[contains(text(),'Unit Number')]/ancestor::*[@class = 'table filterPadd']//tr/td[contains(text(),'"+UnitNum+"')]//ancestor::tr[1]/td[1]/input")); //Unique x-path Of CheckBox Corresponding To Given UnitNumber On Download Drivers Tab On RMA Application  Policy Download  Page Is Fetched
		return Element;
	}

	//============================================================================================
	//FunctionName 			: RMAApp_PolicyDownLoad_Btn_Int_Cov_List
	//Description  			: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which Next Button On Download Drivers Tab On RMA Application Policy Download Page Can Be Identified
	//Input Parameter 		: Driver Variable Of The Type WebDriver		 
	//Revision				: 0.0 - DebasmitaPati-03-29-2019                                  
	// ============================================================================================
	public static WebElement RMAApp_PolicyDownLoad_Btn_Int_Cov_List(WebDriver driver, String UnitNum)
	{
		Element = null;
		Element = driver.findElement(By.xpath(".//*[contains(text(),'Unit Number')]/ancestor::*[@class = 'table filterPadd']//tr/td[contains(text(),'"+UnitNum+"')]//ancestor::tr[1]/td[2]/button")); //Unique x-path Of Interest_Coverage List Button Corresponding To Given UnitNumber On Download Drivers Tab On RMA Application  Policy Download  Page Is Fetched
		return Element;
	}
}
