...
public class RMA_Selenium_POM_Accommodations {
	...
	{
		Element = null;
		Element = driver.findElement(By.xpath(".//*[@id='btn_accommstatus_openlookup']")); //Unique Id  Of  Accomm. Status Lookup Button On RMA Application Accommodations Creation Page Is Fetched
		return Element;
	}
	...
	{
		Element = null;
		Element = driver.findElement(By.xpath(".//*[@id='btn_accommscope_openlookup']")); //Unique Id  Of  Accomm. Scope Lookup Button On RMA Application Accommodations Creation Page Is Fetched
		return Element;
	}
	...
	{
		Element = null;
		Element = driver.findElement(By.xpath(".//*[@id='btn_accommtype_openlookup']")); //Unique Id  Of  Accomm. Type Lookup Button On RMA Application Accommodations Creation Page Is Fetched
		return Element;
	}
	...
	{
		Element = null;
		Element = driver.findElement(By.xpath(".//*[@id='btn_accommposition_openlookup']")); //Unique Id  Of  Position Lookup Button On RMA Application Accommodations Creation Page Is Fetched
		return Element;
	}
	...
	{
		Element = null;
		Element = driver.findElement(By.xpath(".//*[@id='btn_jobclasscode_openlookup		']")); //Unique Id  Of Job Classification Lookup Button On RMA Application Accommodations Creation Page Is Fetched
		return Element;
	}
