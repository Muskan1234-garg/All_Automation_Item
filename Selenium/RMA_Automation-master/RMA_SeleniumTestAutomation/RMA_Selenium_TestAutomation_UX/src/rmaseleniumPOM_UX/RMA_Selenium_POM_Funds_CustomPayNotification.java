...
public class RMA_Selenium_POM_Funds_CustomPayNotification 
{
	...
	//============================================================================================
	//FunctionName 			: RMAApp_CustomPayNotification_Rdb_ShowPaymntsDueBy
	//Description  			: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which Show Payments Due By Radio Button On Custom Payment Notification Page Can Be Identified
	//Input Parameter 		: Driver Variable Of The Type WebDriver		 
	//Revision				: 0.0 - ShrutiShruti-05-21-2018                            
	//============================================================================================
	public static WebElement RMAApp_CustomPayNotification_Rdb_ShowPaymntsDueBy(WebDriver driver)
	{
		Element = driver.findElement(By.xpath(".//*[@id='paymentType']/div[1]/label/input")); 
		return Element;
	}
	...
	//Revision				: 0.0 - ShrutiShruti-05-21-2018                            
	//============================================================================================
	public static WebElement RMAApp_CustomPayNotification_Rdb_EndOfMonth(WebDriver driver)
	{
		Element = driver.findElement(By.xpath(".//*[@id='spanType']/div[2]/label/input")); 
		return Element;
	}

	//============================================================================================
	//FunctionName 			: RMAApp_CustomPayNotification_Btn_Refresh
	//Description  			: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which Refresh Button On Custom Payment Notification Page Can Be Identified
	//Input Parameter 		: Driver Variable Of The Type WebDriver		 
	//Revision				: 0.0 - ShrutiShruti-05-21-2018                            
	//============================================================================================
	public static WebElement RMAApp_CustomPayNotification_Btn_Refresh(WebDriver driver)
	{
		Element = driver.findElement(By.id("refreshIcon")); 
		return Element;
	}

	//============================================================================================
	//FunctionName 			: RMAApp_CustomPayNotification_Btn_Print
	//Description  			: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which Refresh Button On Custom Payment Notification Page Can Be Identified
	//Input Parameter 		: Driver Variable Of The Type WebDriver		 
	//Revision				: 0.0 - ShrutiShruti-05-21-2018                            
	//============================================================================================
	public static WebElement RMAApp_CustomPayNotification_Btn_Print(WebDriver driver)
	{
