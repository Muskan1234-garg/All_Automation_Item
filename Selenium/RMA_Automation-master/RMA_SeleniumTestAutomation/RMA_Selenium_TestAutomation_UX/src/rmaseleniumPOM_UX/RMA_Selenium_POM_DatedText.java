...
public class RMA_Selenium_POM_DatedText {
	...
	{
		Element = null;
		Element = driver.findElement(By.xpath(".//*[@id='btn_texttypecode_openlookup']")); //Unique Id Of Dated Text Type Lookup Button On RMA Application Dated Text On Adjuster Page Is Fetched
		return Element;
	}
}
