...
public class RMA_Selenium_POM_Search {
	...
	//Revision				: 0.0 - KumudNaithani-06-23-2017
	// ============================================================================================
	...
	//============================================================================================
	//FunctionName 			: RMAApp_SearchCriteria_Btn_SubmitQuery
	...
	//Input Parameter 		: Driver Variable Of The Type WebDriver		 
	//Revision				: 0.0 - NidhiJha-08-03-2017                                
	// ============================================================================================
	public static WebElement RMAApp_SearchCriteria_Btn_SubmitQuery(WebDriver driver)
	{   Element = null;
	Element = driver.findElement(By.xpath(".//*[@id='submitquery']")); //Unique Id Of Submit Query Button on Search-->Claim Criteria Page Is Fetched
	return Element;
	}

	//============================================================================================
	//FunctionName 			: RMAApp_SearchClaims_Txt_ClaimNumber
	//Description  			: To Fetch Unique Property (Such As Id, X-path, Name ) On The Basis Of Which Claim Number Text Box on Search-->Claim Criteria Page Can Be Identified
	//Input Parameter 		: Driver Variable Of The Type WebDriver		 
	...
	//============================================================================================
	//FunctionName 			: RMAApp_SearchMedStaffs_Txt_LastName
	//Description  			: To Fetch Unique Property (Such As Id, X-path, Name ) On The Basis Of Which Claim Number Text Box on Search-->Claim Criteria Page Can Be Identified
	//Input Parameter 		: Driver Variable Of The Type WebDriver		 
	//Revision				: 0.0 - KumudNaithani-05-03-2016                                
	// ============================================================================================
	public static WebElement RMAApp_SearchMedStaffs_Txt_LastName(WebDriver driver)
	{
		Element = driver.findElement(By.id("FLD53000")); //Unique Id Of Claim Number Text Box on Search-->Claim Criteria Page Is Fetched
		return Element;
	}
	...
	public static WebElement RMAApp_SearchPatient_Txt_PatientLastName(WebDriver driver)
	{
		...
		Element = driver.findElement(By.xpath(".//*[@id='FLD20000' or @id='FLD50150']"));
		return Element;
	}
	...
	//============================================================================================
	//FunctionName 			: RMAApp_SearchAddress_Txt_Address1
	//Description  			: To Fetch Unique Property (Such As Id, X-path, Name ) On The Basis Of Which Address Text Box on Address Search Page Can Be Identified
	//Input Parameter 		: Driver Variable Of The Type WebDriver		 
	//Revision				: 0.0 - AnubhutiVyas-06-13-2018                                
	// ============================================================================================
	public static WebElement RMAApp_SearchAddress_Txt_Address1(WebDriver driver)
	{
		Element = driver.findElement(By.id("FLD70549")); 
		return Element;
	}
	...
	//Input Parameter 		: Driver Variable Of The Type WebDriver		 
	//Revision				: 0.0 - RenuVerma-08-13-2018                                 
	// ============================================================================================
	...
	//============================================================================================
	//FunctionName 			: RMAApp_SearchDisabilityPlan_Txt_PlanName
	//Description  			: To Fetch Unique Property (Such As Id, X-path, Name ) On The Basis Of Which Plan Name TextBox On RMA Application Disability Plan Management Search Page Can Be Identified
	//Input Parameter 		: Driver Variable Of The Type WebDriver		 
	//Revision				: 0.0 - DebasmitaPati-08-06-2018                            
	//============================================================================================
	public static WebElement RMAApp_SearchDisabilityPlan_Txt_PlanName(WebDriver driver)
	{
		Element = driver.findElement(By.name("Plan Name")); //Unique Id  Plan Name TextBox On RMA Application Disability Plan Management Search Page Is Fetched
		return Element;
	}
	//============================================================================================
