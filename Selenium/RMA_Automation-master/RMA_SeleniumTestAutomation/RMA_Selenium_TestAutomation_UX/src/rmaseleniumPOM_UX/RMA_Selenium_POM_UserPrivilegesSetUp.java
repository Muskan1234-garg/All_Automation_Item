...
public class RMA_Selenium_POM_UserPrivilegesSetUp {
	...
	//Revision			: 0.0 - RenuVerma-07-12-2018                                      
	//============================================================================================
	public static WebElement RMAApp_UserPrev_Lst_LOB(WebDriver driver)
	{
		Element = driver.findElement(By.id("ddllob")); //Unique Id  Of Line Of Business List On RMA Application User Privileges SetUp Page Is Fetched
		return Element;
	}


	//============================================================================================
	//FunctionName 		: RMAApp_UserPrev_Lst_AdditionalLOB
	//Description  		: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which Line Of Business List On RMA Application User Privileges SetUp Page Can Be Identified
	//Input Parameter 	: Driver Variable Of The Type WebDriver		 
	//Revision			: 0.0 - RenuVerma-07-12-2018                                      
	//============================================================================================
	public static WebElement RMAApp_UserPrev_Lst_AdditionalLOB(WebDriver driver)
	{
		Element = driver.findElement(By.id("ddlob")); //Unique Id  Of Line Of Business List On RMA Application User Privileges SetUp Page Is Fetched
		return Element;
	}

	//============================================================================================
	//FunctionName 		: RMAApp_UserPrev_Txt_UserName
	//Description  		: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which User Name textbox On RMA Application User Privileges SetUp Page Can Be Identified
	//Input Parameter 	: Driver Variable Of The Type WebDriver		 
	//Revision			: 0.0 - RenuVerma-11-28-2018                                      
	//============================================================================================
	public static WebElement RMAApp_UserPrev_Txt_UserName(WebDriver driver)
	{
		Element = driver.findElement(By.id("lookup_usergroups")); //Unique Id  Of User Name textbox On RMA Application User Privileges SetUp Page Is Fetched
		return Element;
	}
	...
	//============================================================================================
	//FunctionName 		: RMAApp_UserPrevResPymntLimit_Chk_EnbLmt
	...
	//Revision			: 0.0 - RenuVerma-07-12-2018                                 
	//============================================================================================
	public static WebElement RMAApp_UserPrevLimit_Chk_EnbLmt(WebDriver driver)
	{
		Element = driver.findElement(By.xpath(".//*[@type='checkbox' and @ng-change='vm.EnableLimits()']")); //Unique Id  Of Enable Payment Limits CheckBox On RMA Application User Privilege SetUp Page's Payment Limits Tab Is Fetched
		return Element;
	}
	//============================================================================================
	...
	//============================================================================================
	//FunctionName 		: RMAApp_UserPrevPaymentLimit_Rdb_PaymentLimitsGridRadioButton
	//Description  		: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which Payment Limits Grid Radio Button  On RMA Application User Privileges SetUp Page's Payment Limits Tab Can Be Identified
	//Input Parameter 	: Driver Variable Of The Type WebDriver		 
	//Revision			: 0.0 - AnubhutiVyas-09-15-2017                                 
	//============================================================================================
	public static WebElement RMAApp_UserPrevPaymentLimit_Rdb_PaymentLimitsGridRadioButton(WebDriver driver)
	{
		Element = driver.findElement(By.xpath(".//*[@id='MyRadioButton']")); //Unique Xpath  Of Payment Limits Grid Radio Button  On RMA Application User Privilege SetUp Page's Payment Limits Tab Is Fetched
		return Element;
	}
	...
	//============================================================================================
	//FunctionName 		: RMAApp_UserPrev_Lst_LimitType
	//Description  		: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which Limit Type List On RMA Application User Privileges SetUp Page's Reserve Limits Can Be Identified
	//Input Parameter 	: Driver Variable Of The Type WebDriver		 
	//Revision			: 0.0 - RenuVerma-06-29-2018                                 
	//============================================================================================
	public static WebElement RMAApp_UserPrev_Lst_LimitType(WebDriver driver)
	{
		Element = driver.findElement(By.id("ddllimits")); //Unique Id  Of Limit Type On RMA Application User Privileges SetUp Page Is Fetched
		return Element;
	}
	//============================================================================================
	//FunctionName 			: RMAApp_UserPrev_Img_SelectUser
	//Description  			: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which Select User Image of User Prev Reserve On User Privileges SetUp Page Is Fetched
	//Input Parameter 		: Driver Variable Of The Type WebDriver		 
	//Revision				: 0.0 - RenuVerma-06-29-2017                                   
	//============================================================================================
	public static WebElement RMAApp_UserPrev_Img_SelectUser(WebDriver driver)
	{
		Element = null;
		Element = driver.findElement(By.id("btn_usergroups"));//Unique id Of Select User Image of User Prev Reserve On ser Privileges SetUp Page Is Fetched
		return Element;
	}
	//============================================================================================
	...
	//ModifyBy			: 0.0 - RenuVerma-07-03-2018        
	//============================================================================================
	public static WebElement RMAApp_UserPrevPayDetailLimit_Btn_Add(WebDriver driver)
	{
		Element = driver.findElement(By.id("Buttonadd"));
		return Element;
	}

	//============================================================================================
	//FunctionName 		: RMAApp_UserPrevResPymntLimit_Txt_MaxAmt
	...
	//ModifyBy			: 0.0 - RenuVerma-07-03-2018        
	//============================================================================================
	public static WebElement RMAApp_UserPrevResPymntLimit_Txt_MaxAmt(WebDriver driver)
	{
		Element = driver.findElement(By.id("txtmaxamount")); //Unique Id  Of Max Amount TextBox On RMA Application User Privilege SetUp Page's Payment Limits Tab Is Fetched
		return Element;
	}
	...
	{
		Element = driver.findElement(By.id("Buttonadd")); //Unique Id  Of Add Button On RMA Application User Privilege SetUp Page's Payment Limits Tab Is Fetched
		return Element;
	}
	//============================================================================================
	...
	{
		Element = driver.findElement(By.xpath(".//*[@type='checkbox' and @ng-change='vm.RestrictUsers()']")); //Unique Id  Of Restrict Unspecified Users CheckBox On RMA Application User Privilege SetUp Page's Payment Limits Tab Is Fetched
		return Element;
	}
	//============================================================================================
	//FunctionName 		: RMAApp_UserPrevResPymntLimit_Txt_MaxAmt
	//Description  		: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which Allow Create/Update Checkbox On RMA Application User Privileges SetUp Page's Payment Limits Tab Can Be Identified
	//Input Parameter 	: Driver Variable Of The Type WebDriver		 
	//ModifyBy			: 0.0 - RenuVerma-07-03-2018        
	//============================================================================================
	public static WebElement RMAApp_UserPrevClaimLimit_Chk_AllowCreate_Update(WebDriver driver)
	{
		Element = driver.findElement(By.xpath(".//*[@type='checkbox' and @ng-model='vm.allowCreate']")); //Unique xpath  Of Allow Create/Update Checkbox On RMA Application User Privilege SetUp Page's Payment Limits Tab Is Fetched
		return Element;
	}

	//============================================================================================
	//FunctionName 		: RMAApp_UserPrevResPymntLimit_Txt_MaxAmt
	//Description  		: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which Allow Access Checkbox On RMA Application User Privileges SetUp Page's Payment Limits Tab Can Be Identified
	//Input Parameter 	: Driver Variable Of The Type WebDriver		 
	//ModifyBy			: 0.0 - RenuVerma-07-03-2018        
	//============================================================================================
	public static WebElement RMAApp_UserPrevClaimLimit_Chk_AllowAccess(WebDriver driver)
	{
		Element = driver.findElement(By.xpath(".//*[@type='checkbox' and @ng-model='vm.allowAccess']")); //Unique xpath  Allow Access Checkbox On RMA Application User Privilege SetUp Page's Payment Limits Tab Is Fetched
		return Element;
	}
	//============================================================================================
	//FunctionName 		: RMAApp_UserPrev_Txt_ClaimType
	//Description  		: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which ClaimType Textbox On RMA Application User Privileges SetUp Page's Payment Limits Tab Can Be Identified
	//Input Parameter 	: Driver Variable Of The Type WebDriver		 
	//ModifyBy			: 0.0 - RenuVerma-09-26-2018        
	//============================================================================================
	public static WebElement RMAApp_UserPrev_Txt_ClaimType(WebDriver driver)
	{
		Element = driver.findElement(By.id("lookup_claimtypecode")); //Unique id of ClaimType Textbox On RMA Application User Privilege SetUp Page's Payment Limits Tab Is Fetched
		return Element;
	}
	//============================================================================================
	//FunctionName 		: RMAApp_UserPrev_Txt_ClaimStatus
	//Description  		: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which Claim Status TextBox On RMA Application User Privileges SetUp Page's Payment Limits Tab Can Be Identified
	//Input Parameter 	: Driver Variable Of The Type WebDriver		 
	//ModifyBy			: 0.0 - RenuVerma-09-26-2018       
	//============================================================================================
	public static WebElement RMAApp_UserPrev_Txt_ClaimStatus(WebDriver driver)
	{
		Element = driver.findElement(By.id("lookup_claimstatuscode")); //Unique id Claim Status TextBox On RMA Application User Privilege SetUp Page's Payment Limits Tab Is Fetched
		return Element;
	}
	...
	//ModifyBy			: 0.0 - RenuVerma-09-26-2018       
	//============================================================================================
	public static WebElement RMAApp_UserPrev_Img_DeleteLimit(WebDriver driver)
	{
		Element=null;
		try {
			Element = driver.findElement(By.xpath("(.//*[@id='I4'])[1]")); //Unique id Claim Status TextBox On RMA Application User Privilege SetUp Page's Payment Limits Tab Is Fetched
		} catch (Exception e) {
	...
	//============================================================================================
	//FunctionName 		: RMAApp_UserPrev_Txt_EventType
	//Description  		: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which ClaimType Textbox On RMA Application User Privileges SetUp Page's Payment Limits Tab Can Be Identified
	//Input Parameter 	: Driver Variable Of The Type WebDriver		 
	//ModifyBy			: 0.0 - RenuVerma-09-26-2018        
	//============================================================================================
	public static WebElement RMAApp_UserPrev_Txt_EventType(WebDriver driver)
	{
		Element = driver.findElement(By.id("lookup_eventtypecode")); //Unique id of ClaimType Textbox On RMA Application User Privilege SetUp Page's Payment Limits Tab Is Fetched
		return Element;
	}
	//============================================================================================
	...
	//Input Parameter 		: Driver Variable Of The Type WebDriver		 
	//Revision				: 0.0 - RenuVerma-10-15-2018                                  
	//============================================================================================
	public static WebElement RMAApp_UserPrev_Btn_EventTypeLookUp(WebDriver driver)
	{
		Element = null;
	...
	//============================================================================================
	//FunctionName 			: RMAApp_UserPrev_Btn_AdditionalSetting
	//Description  			: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which Additional Settings Button On RMA Application Event Creation Page Can Be Identified
	//Input Parameter 		: Driver Variable Of The Type WebDriver		 
	//Revision				: 0.0 - RenuVerma-10-15-2018                                  
	//============================================================================================
	public static WebElement RMAApp_UserPrev_Btn_AdditionalSetting(WebDriver driver)
	{
		Element = null;
		Element = driver.findElement(By.id("BtnadditionalSettings")); //Unique Id  Of Additional Settings Button On RMA Application Event Creation Page Is Fetched
		return Element;
	}

	//============================================================================================
	//FunctionName 		: RMAApp_UserPrev_Img_DeletePerClaimPayLimit
	//Description  		: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which Claim Status TextBox On RMA Application User Privileges SetUp Page's Payment Limits Tab Can Be Identified
	//Input Parameter 	: Driver Variable Of The Type WebDriver		 
	//ModifyBy			: 0.0 - ShrutiShruti-09-26-2018       
	//============================================================================================
	public static WebElement RMAApp_UserPrev_Img_DeletePerClaimPayLimit(WebDriver driver,String Name)
	{
		Element=null;
		try {
			Element = driver.findElement(By.xpath(".//*[contains(text(),'"+Name+"')]//ancestor::tr[1]/td[1]/i")); //Unique id Claim Status TextBox On RMA Application User Privilege SetUp Page's Payment Limits Tab Is Fetched
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
	...
	//Input Parameter 	: Driver Variable Of The Type WebDriver		 
	//Revision			: 0.0 - ShrutiShruti-10-123-2018                                      
	//============================================================================================
	public static WebElement RMAApp_UserPrev_Lst_ReserVeType(WebDriver driver)
	{
		Element = driver.findElement(By.id("ddlreservetype")); //Unique Id  Of Reserve Type List On RMA Application User Privileges SetUp Page Is Fetched
		return Element;
	}

	//============================================================================================
	//FunctionName 		: RMAApp_UserPrev_Txt_PerClaimPayClaimType
	//Description  		: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which Claim Type TextBox On RMA Application User Privileges SetUp Page Can Be Identified
	//Input Parameter 	: Driver Variable Of The Type WebDriver		 
	//Revision			: 0.0 - ShrutiShruti-10-123-2018                                      
	//============================================================================================
	public static WebElement RMAApp_UserPrev_Txt_PerClaimPayClaimType(WebDriver driver)
	{
		Element = driver.findElement(By.id("lookup_claimtypecode")); //Unique Id  Of Claim Type TextBox On RMA Application User Privileges SetUp Page Is Fetched
		return Element;
	}
	//============================================================================================
	//FunctionName 		: RMAApp_UserPrevLimit_Chk_PrevPaymentAboveLimit
	//Description  		: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which Enable Payment Limits CheckBox On RMA Application User Privileges SetUp Page's Payment Limits Tab Can Be Identified
	//Input Parameter 	: Driver Variable Of The Type WebDriver		 
	//Revision			: 0.0 - ShrutiShruti-10-29-2018                                 
	//============================================================================================
	public static WebElement RMAApp_UserPrevLimit_Chk_PrevPaymentAboveLimit(WebDriver driver)
	{
		Element = driver.findElement(By.xpath(".//*[contains(text(),'Prevent Payments Above Limits')]//ancestor::div[1]/div[1]/div/input")); //Unique Id  Of Enable Payment Limits CheckBox On RMA Application User Privilege SetUp Page's Payment Limits Tab Is Fetched
		return Element;
	}
	//============================================================================================
	//FunctionName 		: RMAApp_UserPrevLimit_Chk_OverRideAuthority
	//Description  		: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which Enable Payment Limits CheckBox On RMA Application User Privileges SetUp Page's Payment Limits Tab Can Be Identified
	//Input Parameter 	: Driver Variable Of The Type WebDriver		 
	//Revision			: 0.0 - ShrutiShruti-10-29-2018                                 
	//============================================================================================
	public static WebElement RMAApp_UserPrevLimit_Chk_OverRideAuthority(WebDriver driver)
	{
		Element = driver.findElement(By.xpath(".//*[contains(text(),'Has OverRide Authority')]//ancestor::div[1]/div[1]/div/input")); //Unique Id  Of Enable Payment Limits CheckBox On RMA Application User Privilege SetUp Page's Payment Limits Tab Is Fetched
		return Element;
	}
	//============================================================================================
	//FunctionName 		: RMAApp_UserPrevLimitAdditionalSett_Txt_ReserveMax
	//Description  		: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which Reserve Max TextBox On RMA Application User Privileges SetUp Page's Payment Limits Tab Can Be Identified
	//Input Parameter 	: Driver Variable Of The Type WebDriver		 
	//Revision			: 0.0 -RenuVerma-11-19-2018                                 
	//============================================================================================
	public static WebElement RMAApp_UserPrevLimitAdditionalSett_Txt_ReserveMax(WebDriver driver)
	{
		Element = driver.findElement(By.id("txtreservemax1")); //Unique Id  Of Reserve Max TextBox On RMA Application User Privilege SetUp Page's Payment Limits Tab Is Fetched
		return Element;
	}
	//============================================================================================
	//FunctionName 		: RMAApp_UserPrevLimitAdditionalSett_Txt_PaymentMax
	//Description  		: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which Payment Max TextBox On RMA Application User Privileges SetUp Page's Payment Limits Tab Can Be Identified
	//Input Parameter 	: Driver Variable Of The Type WebDriver		 
	//Revision			: 0.0 -RenuVerma-11-19-2018                                 
	//============================================================================================
	public static WebElement RMAApp_UserPrevLimitAdditionalSett_Txt_PaymentMax(WebDriver driver)
	{
		Element = driver.findElement(By.id("txtpaymentmax1")); //Unique Id  Of Payment Max TextBox On RMA Application User Privilege SetUp Page's Payment Limits Tab Is Fetched
		return Element;
	}
	//============================================================================================
	//FunctionName 		: RMAApp_UserPrevLimitAdditionalSett_Txt_ClaimIncurredMax
	//Description  		: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which Claim Incurred Max TextBox On RMA Application User Privileges SetUp Page's Payment Limits Tab Can Be Identified
	//Input Parameter 	: Driver Variable Of The Type WebDriver		 
	//Revision			: 0.0 -RenuVerma-11-19-2018                                  
	//============================================================================================
	public static WebElement RMAApp_UserPrevLimitAdditionalSett_Txt_ClaimIncurredMax(WebDriver driver)
	{
		Element = driver.findElement(By.id("txtclaimincurredmax1")); //Unique Id  Of Claim Incurred Max TextBox On RMA Application User Privilege SetUp Page's Payment Limits Tab Is Fetched
		return Element;
	}

	//============================================================================================
	//FunctionName 		: RMAApp_UserPrev_Btn_ClaimStatus
	//Description  		: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which Claim Status Lookup Button On RMA Application User Privileges SetUp Page's Can Be Identified
	//Input Parameter 	: Driver Variable Of The Type WebDriver		 
	//ModifyBy			: 0.0 - DebasmitaPati-06-13-2019       
	//============================================================================================
	public static WebElement RMAApp_UserPrev_Btn_ClaimStatus(WebDriver driver)
	{
		Element = driver.findElement(By.id("btn_claimstatuscode_openlookup")); //Unique id Claim Status Lookup Button On RMA Application User Privilege SetUp Page's Is Fetched
		return Element;
	}
