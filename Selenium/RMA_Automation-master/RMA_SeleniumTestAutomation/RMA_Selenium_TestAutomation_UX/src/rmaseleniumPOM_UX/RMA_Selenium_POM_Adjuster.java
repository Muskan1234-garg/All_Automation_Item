...
{
	Element = null;
	Element = driver.findElement(By.xpath(".//*[@id='lookup_adjlastname']")); //Unique Id  Of  Adjuster Last Name On RMA Application Adjuster Creation Page Is Fetched
	return Element;
}
...
//============================================================================================
//FunctionName 			: RMAApp_Adjuster_Chk_CurAdj
//Description  			: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which Current Adjuster Check Box On RMA Application Adjuster Creation Page Can Be Identified
//Input Parameter 		: Driver Variable Of The Type WebDriver		 
//Revision				: 0.0 - RenuVerma-07-06-2018                                 
//============================================================================================
public static WebElement RMAApp_Adjuster_Chk_CurAdj(WebDriver driver)
{
	Element = null;
	Element = driver.findElement(By.id("currentadjflag")); //Unique Id  Of Current Adjuster Check Box On RMA Application Adjuster Creation Page Is Fetched
	return Element;
}
//============================================================================================
//FunctionName 			: RMAApp_Adjuster_Btn_RiskMasterLogin
//Description  			: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which RiskMaster Login Button On RMA Application Adjuster Creation Page Can Be Identified
//Input Parameter 		: Driver Variable Of The Type WebDriver		 
//Revision				: 0.0 - RenuVerma-07-06-2018                                 
//============================================================================================
...
{
	Element = null;
	Element = driver.findElement(By.id("btn_rmUserId")); //Unique Id  Of RiskMaster Login Button On RMA Application Adjuster Creation Page Is Fetched
	return Element;
}
//============================================================================================
//FunctionName 			: RMAApp_Adjuster_Txt_RiskMasterLogin
//Description  			: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which RiskMaster Login Button On RMA Application Adjuster Creation Page Can Be Identified
//Input Parameter 		: Driver Variable Of The Type WebDriver		 
//Revision				: 0.0 - RenuVerma-07-06-2018                                 
//============================================================================================
public static WebElement RMAApp_Adjuster_Txt_RiskMasterLogin(WebDriver driver)
{
	Element = null;
	Element = driver.findElement(By.id("lookup_rmUserId")); //Unique Id  Of RiskMaster Login Button On RMA Application Adjuster Creation Page Is Fetched
	return Element;
}
}
