...
public class RMA_Selenium_POM_LeavePlanManagement {
	...
	{
		Element = null;
		Element = driver.findElement(By.xpath(".//*[@id='btn_planstatus_openlookup']")); //Unique Id  Of Plan Status Image Lookup Button On RMA Application Leave Plan Management Creation Page Is Fetched
		return Element;
	}
}
