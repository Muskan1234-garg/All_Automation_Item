...
public class RMA_Selenium_POM_Dependents {
	...
	{
		Element =null;
		Element = driver.findElement(By.xpath(".//*[@id='lookup_depnstateid_openlookup']")); //Unique Id Of State TextBox On RMA Application Dependents Page Is Fetched
		return Element;
	}
	...
	{
		Element =null;
		Element = driver.findElement(By.xpath(".//*[@id='btn_depnstateid_openlookup']")); //Unique Id Of State Button On RMA Application Dependents Page Is Fetched
		return Element;
	}
	...
	{
		Element =null;
		Element = driver.findElement(By.xpath(".//*[@id='btn_depncountrycode_openlookup']")); //Unique Id Of Country Button On RMA Application Dependents Page Is Fetched
		return Element;
	}
	...
	{
		Element =null;
		Element = driver.findElement(By.xpath(".//*[@id='btn_depnsexcode_openlookup']")); //Unique Id Of Sex Button On RMA Application Dependents Page Is Fetched
		return Element;
	}
