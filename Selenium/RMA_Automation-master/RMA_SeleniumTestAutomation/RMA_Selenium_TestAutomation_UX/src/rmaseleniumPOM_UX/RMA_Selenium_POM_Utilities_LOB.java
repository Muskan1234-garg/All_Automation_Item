...
public class RMA_Selenium_POM_Utilities_LOB {
	...
	//============================================================================================
	//FunctionName 			: RMAApp_LOB_Lst_ReserveTypeMultiCode
	//Description  			: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which ReserveType  List On Line Of Business Parameter Set Up Page Can Be Identified
	//Input Parameter 		: Driver Variable Of The Type WebDriver		 
	//Revision				: 0.0 - AnubhhtiVyas-08-31-2017                               
	//============================================================================================
	public static WebElement RMAApp_LOB_Lst_ReserveTypeMultiCode(WebDriver driver)
	{
		Element = driver.findElement(By.id("lstReserveTypes_multicode")); 
		return Element;
	}
	//============================================================================================
	//FunctionName 			: RMAApp_LOB_Lst_ReserveTypeMultiCodedel
	//Description  			: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which Delete ReserveType Button On Line Of Business Parameter Set Up Page Can Be Identified
	//Input Parameter 		: Driver Variable Of The Type WebDriver		 
	//Revision				: 0.0 - AnubhhtiVyas-08-31-2017                               
	//============================================================================================
	public static WebElement RMAApp_LOB_Lst_ReserveTypeMultiCodedel(WebDriver driver)
	{
		Element = driver.findElement(By.id("lstReserveTypes_multicodebtndel")); 
		return Element;
	}

	//============================================================================================
	//FunctionName 			: RMAApp_LOB_Chk_UseMultipleDisabilityClass
	//Description  			: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which ClaimType Check Box On Line Of Business Parameter Set Up Page Can Be Identified
	//Input Parameter 		: Driver Variable Of The Type WebDriver		 
	//Revision				: 0.0 - ShrutiShruti-07-26-2018                                 
	//============================================================================================
	public static WebElement RMAApp_LOB_Chk_UseMultipleDisabilityClass(WebDriver driver)
	{
		Element = driver.findElement(By.id("chkMultipleClasses")); //Unique Id  Of  ClaimType Check Box On Line Of Business Parameter Set Up Page Is Fetched
		return Element;
	}

	//============================================================================================
	//FunctionName 			: RMAApp_LOB_Tab_AutoCloseOptions
	//Description  			: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which Auto Close Options Tab On Line Of Business Parameter Set Up Page Can Be Identified
	//Input Parameter 		: Driver Variable Of The Type WebDriver		 
	//Revision				: 0.0 - ShrutiShruti-08-26-2019                                 
	//============================================================================================
	public static WebElement RMAApp_LOB_Tab_AutoCloseOptions(WebDriver driver)
	{
		Element = driver.findElement(By.id("LINKTABSAutoCloseOptions")); //Unique Id  Of Auto Close Options Tab On Line Of Business Parameter Set Up Page Is Fetched
		return Element;
	}

	//============================================================================================
	//FunctionName 			: RMAApp_LOB_Btn_AutoCloseLookupButton
	//Description  			: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which Auto Close Lookup Button On Line Of Business Parameter Set Up Page Can Be Identified
	//Input Parameter 		: Driver Variable Of The Type WebDriver		 
	//Revision				: 0.0 - ShrutiShruti-08-26-2019                                 
	//============================================================================================
	public static WebElement RMAApp_LOB_Btn_AutoCloseLookupButton(WebDriver driver)
	{
		Element = driver.findElement(By.id("lstAutoClose_multicodebtn")); //Unique Id  Of Auto Close Lookup Button On Line Of Business Parameter Set Up Page Is Fetched
		return Element;
	}

	//============================================================================================
	//FunctionName 			: RMAApp_LOB_Txt_TransactionTypes
	//Description  			: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which Auto Close Transaction Types Text Box On Line Of Business Parameter Set Up Page Can Be Identified
	//Input Parameter 		: Driver Variable Of The Type WebDriver		 
	//Revision				: 0.0 - ShrutiShruti-08-26-2019                                 
	//============================================================================================
	public static WebElement RMAApp_LOB_Txt_TransactionTypes(WebDriver driver)
	{
		Element = driver.findElement(By.id("lstAutoClose_multicode")); //Unique Id  Of Auto Transaction Types Text Box On Line Of Business Parameter Set Up Page Is Fetched
		return Element;
	}

	//============================================================================================
	//FunctionName 			: RMAApp_LOB_Btn_AutoCloseOptionDelete
	//Description  			: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which Auto Close Options Delete Button On Line Of Business Parameter Set Up Page Can Be Identified
	//Input Parameter 		: Driver Variable Of The Type WebDriver		 
	//Revision				: 0.0 - ShrutiShruti-08-26-2019                                 
	//============================================================================================
	public static WebElement RMAApp_LOB_Btn_AutoCloseOptionDelete(WebDriver driver)
	{
		Element = driver.findElement(By.id("lstAutoClose_multicodebtndel")); //Unique Id Of Auto Close Options Delete Button On Line Of Business Parameter Set Up Page Is Fetched
		return Element;
	}

	//============================================================================================
	//FunctionName 			: RMAApp_LOB_Chk_DisplayReserveAllocation
	//Description  			: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which Display Reserve Allocation On Summary Screen On Line Of Business Parameter Set Up Page Can Be Identified
	//Input Parameter 		: Driver Variable Of The Type WebDriver		 
	//Revision				: 0.0 - ShrutiShruti-07-26-2018                                 
	//============================================================================================
	public static WebElement RMAApp_LOB_Chk_DisplayReserveAllocation(WebDriver driver)
	{	Element = null;
	try {
		...
		e.printStackTrace();
	} //Unique Id  Of Display Reserve Allocation On Summary Screen On Line Of Business Parameter Set Up Page Is Fetched
	return Element;
	}

	//================================================================================================================================================================================================================
	//FunctionName 			: RMAApp_LOB_Chk_AllocateReservesForAutoCheck
	...
	public static WebElement RMAApp_LOB_Chk_AllocateReservesForAutoCheck(WebDriver driver)
	{
		Element = null;
	...
	//================================================================================================================================================================================================================
	//FunctionName 			: RMAApp_LOB_Chk_DoNotAllowNegativeReserveAdjustments
	...
	public static WebElement RMAApp_LOB_Chk_DoNotAllowNegativeReserveAdjustments(WebDriver driver)
	{
		Element = null;
	...
	//================================================================================================================================================================================================================
	//FunctionName 			: RMAApp_LOB_Chk_CheckforInsufficientReserveAutoCheck
	...
	public static WebElement RMAApp_LOB_Chk_CheckforInsufficientReserveAutoCheck(WebDriver driver)
	{
		Element = null;
	...
	//============================================================================================
	//FunctionName 			: RMAApp_LOB_Chk_DiaryForInsufficientReserveFnd
	//Description  			: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which Enable Diary notification for Insufficient Reserve Funds CheckBox On Line Of Business Parameter Set Up Page Can Be Identified
	//Input Parameter 		: Driver Variable Of The Type WebDriver		 
	//Revision				: 0.0 - DebasmitaPati-10-18-2019                            
	//============================================================================================
	public static WebElement RMAApp_LOB_Chk_DiaryForInsufficientReserveFnd(WebDriver driver)
	{
		Element = driver.findElement(By.id("chkEnableDiary")); 
		return Element;
	}

	//============================================================================================
	//FunctionName 			: RMAApp_LOB_Chk_DiaryForInsufficientReserveAutoCheck
	//Description  			: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which Enable Diary notification for Insufficient Auto Checks On Line Of Business Parameter Set Up Page Can Be Identified
	//Input Parameter 		: Driver Variable Of The Type WebDriver		 
	//Revision				: 0.0 - DebasmitaPati-10-18-2019                            
	//============================================================================================
	public static WebElement RMAApp_LOB_Chk_DiaryForInsufficientReserveAutoCheck(WebDriver driver)
	{
		Element = driver.findElement(By.id("chkEnableDiaryForAutoChecks")); 
		return Element;
	}

	//============================================================================================
	//FunctionName 			: RMAApp_LOB_Btn_AutoAdjustReserveTypeLookup
	//Description  			: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which Auto Adjust ReserveType  Button On Line Of Business Parameter Set Up Page Can Be Identified
	//Input Parameter 		: Driver Variable Of The Type WebDriver		 
	//Revision				: 0.0 - DebasmitaPati-08-17-2020                                
	//============================================================================================
	public static WebElement RMAApp_LOB_Btn_AutoAdjustReserveTypeLookup(WebDriver driver)
	{
		Element = driver.findElement(By.id("lstAutoAdj_multicodebtn")); 
		return Element;
	}

	//============================================================================================
	//FunctionName 			: RMAApp_LOB_Chk_AutoCloseIncludeScheduledCheck
	//Description  			: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which Check for Include Scheduled Check CheckBox On Auto Close Tab On Line Of Business Parameter Set Up Page Can Be Identified
	//Input Parameter 		: Driver Variable Of The Type WebDriver		 
	//Revision				: 0.0 - DebasmitaPati-08-17-2020                               
	//============================================================================================
	public static WebElement RMAApp_LOB_Chk_AutoCloseIncludeScheduledCheck(WebDriver driver)
	{
		Element = driver.findElement(By.id("chkIncludeScheduledChecks")); 
		return Element;
	}
