...
public class RMA_Selenium_POM_PaymentParameterSetUp {
	...
	//============================================================================================
	//FunctionName 			: RMAApp_PmntSetUpSprVsr_Lst_MappedDistriTypeFileOptions
	//Description  			: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which Include Suffix On Payments CheckBox On RMA Application Payment Parameter SetUp Page Can Be Identified
	//Input Parameter 		: Driver Variable Of The Type WebDriver		 
	//Revision				: 0.0 - ShrutiShruti-09-06-2018                                 
	//============================================================================================
	public static WebElement RMAApp_PmntSetUpSprVsr_Lst_MappedDistriTypeFileOptions(WebDriver driver)
	{
		Element = driver.findElement(By.id("lstPrintDistribution")); 
		return Element;
	}

	//============================================================================================
	//FunctionName 			: RMAApp_PmntSetUpSprVsr_Btn_DeleteMapping
	//Description  			: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which Include Suffix On Payments CheckBox On RMA Application Payment Parameter SetUp Page Can Be Identified
	//Input Parameter 		: Driver Variable Of The Type WebDriver		 
	//Revision				: 0.0 - ShrutiShruti-09-06-2018                                 
	//============================================================================================
	public static WebElement RMAApp_PmntSetUpSprVsr_Btn_DeleteMapping(WebDriver driver)
	{
		Element = driver.findElement(By.id("btnDeleteMapping")); 
		return Element;
	}

	//============================================================================================
	//FunctionName 			: RMAApp_PmntSetUpSprVsr_Btn_AddMapping
	//Description  			: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which Include Suffix On Payments CheckBox On RMA Application Payment Parameter SetUp Page Can Be Identified
	//Input Parameter 		: Driver Variable Of The Type WebDriver		 
	//Revision				: 0.0 - ShrutiShruti-09-06-2018                                 
	//============================================================================================
	public static WebElement RMAApp_PmntSetUpSprVsr_Btn_AddMapping(WebDriver driver)
	{
		Element = driver.findElement(By.id("btnAddMapping")); 
		return Element;
	}

	//============================================================================================
	//FunctionName 			: RMAApp_PmntSetUpSprVsr_Lst_DistributionType
	//Description  			: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which Include Suffix On Payments CheckBox On RMA Application Payment Parameter SetUp Page Can Be Identified
	//Input Parameter 		: Driver Variable Of The Type WebDriver		 
	//Revision				: 0.0 - ShrutiShruti-09-06-2018                                 
	//============================================================================================
	public static WebElement RMAApp_PmntSetUpSprVsr_Lst_DistributionType(WebDriver driver)
	{
		Element = driver.findElement(By.id("lstDistributionType")); 
		return Element;
	}

	//============================================================================================
	//FunctionName 			: RMAApp_PmntSetUpSprVsr_Lst_FileOptions
	//Description  			: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which Include Suffix On Payments CheckBox On RMA Application Payment Parameter SetUp Page Can Be Identified
	//Input Parameter 		: Driver Variable Of The Type WebDriver		 
	//Revision				: 0.0 - ShrutiShruti-09-06-2018                                 
	//============================================================================================
	public static WebElement RMAApp_PmntSetUpSprVsr_Lst_FileOptions(WebDriver driver)
	{
		Element = driver.findElement(By.id("ddlPrintOptions")); 
		return Element;
	}
	...
	//============================================================================================
	//FunctionName 			: RMAApp_PmntSetUpSprVsr_Chk_TransactionTypeCodeSelection
	//Description  			: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which Print Payee EOB Checks CheckBox On RMA Application Payment Parameter SetUp Page Can Be Identified
	//Input Parameter 		: Driver Variable Of The Type WebDriver		 
	//Revision				: 0.0 - ShrutiShruti-11-19-2018                                 
	//============================================================================================
	public static WebElement RMAApp_PmntSetUpSprVsr_Chk_TransactionTypeCodeSelection(WebDriver driver,String CodeName)
	{
		Element = driver.findElement(By.xpath(".//*[contains(text(),'"+CodeName+"')]//ancestor::tr[1]/td[1]/input[1]")); 
		return Element;
	}

	//============================================================================================
	//FunctionName 			: RMAApp_PmntSetUpSprVsr_Btn_TransactionTypeCodeSelectionOK
	//Description  			: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which Print Payee EOB Checks CheckBox On RMA Application Payment Parameter SetUp Page Can Be Identified
	//Input Parameter 		: Driver Variable Of The Type WebDriver		 
	//Revision				: 0.0 - ShrutiShruti-11-19-2018                                 
	//============================================================================================
	public static WebElement RMAApp_PmntSetUpSprVsr_Btn_TransactionTypeCodeSelectionOK(WebDriver driver)
	{
	...
	//============================================================================================
	//FunctionName 			: RMAApp_PaymentParameterOptions_Chk_IncludePrefix
	//Description  			: To Fetch Unique Property (Such As Id, X-path, Name ) On The Basis Of Include Prefix On Payments Check Box On Payment Parameter Options  On RMA Application Payment Parameter SetUp Page Can Be Identified
	//Input Parameter 		: Driver Variable Of The Type WebDriver		 
	//Revision				: 0.0 - DebasmitaPati-06-15-2020                              
	//============================================================================================
	public static WebElement RMAApp_PaymentParameterOptions_Chk_IncludePrefix(WebDriver driver)
	{
		Element = null;
		Element = driver.findElement(By.xpath(".//*[@id='IncludePrefix']")); 
		return Element;
	}

	//============================================================================================
	//FunctionName 			: RMAApp_PaymentParameterOptions_Chk_IncludeSuffix
	//Description  			: To Fetch Unique Property (Such As Id, X-path, Name ) On The Basis Of Include Suffix On Payments Check Box On Payment Parameter Options  On RMA Application Payment Parameter SetUp Page Can Be Identified
	//Input Parameter 		: Driver Variable Of The Type WebDriver		 
	//Revision				: 0.0 - DebasmitaPati-06-15-2020                              
	//============================================================================================
	public static WebElement RMAApp_PaymentParameterOptions_Chk_IncludeSuffix(WebDriver driver)
	{
		Element = null;
		Element = driver.findElement(By.xpath(".//*[@id='IncludeSuffix']")); 
		return Element;
	}
	...
	//Input Parameter 		: Driver Variable Of The Type WebDriver		 
	//Revision				: 0.0 - ShrutiShruti-07-14-2020                              
	// ============================================================================================
	public static WebElement RMAApp_PaymentParSetup_Chk_EnableVoidReasonComment(WebDriver driver)
	{
		Element = driver.findElement(By.id("EnableVoidReasonComment")); 
		return Element;
	}

	//============================================================================================
	//FunctionName 			: RMAApp_PaymentParSetup_Lst_DefLevelOnPreCheckReg
	//Description  			: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which Default Level To Display On PreCheck Register On RMA Application General System Parameter Setup Page Can Be Identified
	//Input Parameter 		: Driver Variable Of The Type WebDriver		 
	//Revision				: 0.0 - ShrutiShruti-08-04-2020                              
	// ============================================================================================
	public static WebElement RMAApp_PaymentParSetup_Lst_DefLevelOnPreCheckReg(WebDriver driver)
	{
		Element = driver.findElement(By.id("PreCheckOrgLvl")); 
		return Element;
	}
	
	//============================================================================================
	//FunctionName 			: RMAApp_PaymentParSetup_Txt_DefDistributionType
	//Description  			: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which Default Level To Display On Distribution Type On RMA Application General System Parameter Setup Page Can Be Identified
	//Input Parameter 		: Driver Variable Of The Type WebDriver		 
	//Revision				: 0.0 - AnubhutiVyas-08-26-2020                              
	// ============================================================================================
	public static WebElement RMAApp_PaymentParSetup_Txt_DefDistributionType(WebDriver driver)
	{
		Element = driver.findElement(By.name("DefaultDistributionType$codelookup")); 
		return Element;
	}
	
	//============================================================================================
	//FunctionName 			: RMAApp_PaymentParameterOptions_Chk_PrintClaimantEOB
	//Description  			: To Fetch Unique Property (Such As Id, X-path, Name ) On The Basis Of Print Claimant EOB On Payments Check Box On Payment Parameter Options  On RMA Application Payment Parameter SetUp Page Can Be Identified
	//Input Parameter 		: Driver Variable Of The Type WebDriver		 
	//Revision				: 0.0 - ShrutiShruti-12-02-2020                              
	//============================================================================================
	public static WebElement RMAApp_PaymentParameterOptions_Chk_PrintClaimantEOB(WebDriver driver)
	{
		Element = null;
		Element = driver.findElement(By.id("PrintClmtEOB")); 
		return Element;
	}
	
	//============================================================================================
	//FunctionName 			: RMAApp_PaymentParameterOptions_Chk_AttachEOBOnClaim
	//Description  			: To Fetch Unique Property (Such As Id, X-path, Name ) On The Basis Of Attach EOB On Claim On Payments Check Box On Payment Parameter Options  On RMA Application Payment Parameter SetUp Page Can Be Identified
	//Input Parameter 		: Driver Variable Of The Type WebDriver		 
	//Revision				: 0.0 - ShrutiShruti-12-02-2020                              
	//============================================================================================
	public static WebElement RMAApp_PaymentParameterOptions_Chk_AttachEOBOnClaim(WebDriver driver)
	{
		Element = null;
		Element = driver.findElement(By.id("AttachEOBClaim")); 
		return Element;
	}
	
	//============================================================================================
	//FunctionName 			: RMAApp_PaymentParameterOptions_Chk_PrintCheckStubDetail
	//Description  			: To Fetch Unique Property (Such As Id, X-path, Name ) On The Basis Of Attach EOB On Claim On Payments Check Box On Payment Parameter Options  On RMA Application Payment Parameter SetUp Page Can Be Identified
	//Input Parameter 		: Driver Variable Of The Type WebDriver		 
	//Revision				: 0.0 - ShrutiShruti-12-02-2020                              
	//============================================================================================
	public static WebElement RMAApp_PaymentParameterOptions_Chk_PrintCheckStubDetail(WebDriver driver)
	{
		Element = null;
		Element = driver.findElement(By.id("PrntCheckStubEOB")); 
		return Element;
	}
}