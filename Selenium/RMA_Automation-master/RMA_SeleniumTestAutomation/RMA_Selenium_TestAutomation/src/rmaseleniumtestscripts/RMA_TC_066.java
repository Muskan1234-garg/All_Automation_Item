...
//Dependent On TC: TC_064 & TC_065
//Revision       : 0.0 - ImteyazAhmad-02-04-2016
//=================================================================================================
public class RMA_TC_066 extends rmaseleniumtestscripts.RMA_TC_BaseTest {
	static String ExceptionRecorded;
	static String []ErrorMessage;
	static String FinalErrorMessage;
	static String ErrorMessageType;
	public static String StrClaimNumber_RMA_TC_066;
	public static String StrControlNumber_RMA_TC_066;
	public static String StrControlNumber_RMA_TC_066_01;
	static String StrScreenShotTCName;

	@Test 
	public void RMA_TC_066_Test () throws Exception, Error 
	{
		try {
			parentlogger = reports.startTest("TC_066_Payments Go On Hold Because Of Exceeded Payment Limits", "Verify Payment Can Be Created And Is Going On Hold Because Of Exceeded Payment Limits");
			String StrAccept;
			...
			String StrClaimAdjustor_RMA_TC_066;
			...
			StrClaimAdjustor_RMA_TC_066 = "ClaimAdjustor_TC_066_";
			StrClaimAdjustor_RMA_TC_066 = RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(4,StrClaimAdjustor_RMA_TC_066);
			...
			RMAApp_Login_Txt_UserName = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_066", 1, 6); //UserName Fetched From DataSheet RMA_TC_066
			RMAApp_Login_Txt_Password = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_066", 1, 7); //Password Fetched From DataSheet RMA_TC_066
			RMAApp_Payment_Lst_BankAccount = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_066", 1, 0); //Bank Account Is Fetched From DataSheet RMA_TC_066
			RMAApp_Payment_Lst_PayeeType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_066", 1, 1); // Payee Type Is Fetched From DataSheet RMA_TC_066
			RMAApp_FundsSplitDetails_Lst_TransactionType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_066", 1, 2); //Transaction Type Is Fetched From DataSheet RMA_TC_066
			RMAApp_FundsSplitDetails_Txt_Amount = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_TC_066", 1, 3); //Amount Is Fetched From DataSheet RMA_TC_066
			RMAApp_FundsSplitDetails_Txt_Amount_1 = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_TC_066", 1, 5); //Amount For Second Payment Is Fetched From DataSheet RMA_TC_066
			RMAApp_Payment_Txt_LastName = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_066", 1, 4); //LastName Is Fetched From DataSheet RMA_TC_066
			RMAApp_Payment_Txt_DistributionType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_066", 1, 8); //Distribution Type Is Fetched From DataSheet RMA_TC_066
			...
			StrClaimNumber_RMA_TC_066 = generalClaim.GeneralClaimCreation(); //Claim Number Is Fetched And Stored In Variable StrClaimNumber
			parentlogger.log(LogStatus.INFO, "New Claim Is Created With Claim Number::"+ " " + color.RMA_ChangeColor_Utility(StrClaimNumber_RMA_TC_066, 2));
			...
			E = RMA_Selenium_POM_Home.RMAApp_LeftHandNavTree_Lnk_Adjuster(driver);
			...
			RMA_Input_Utility.RMA_SetTextValueandTabOut_Utility(RMA_POM_Adjuster.RMAApp_Adjuster_Txt_LastName(driver), "Adjuster LastName TextBox On Created General Claim's Adjuster Page", StrClaimAdjustor_RMA_TC_066,0); 
			...
			parentlogger.log(LogStatus.INFO, "Following Function Is Called To Create A Payment Of $2000 :: RMA_PaymentAddition_Utility");		
			testcall3 = true;
			StrControlNumber_RMA_TC_066 = RMA_Functionality_Utility.RMA_PaymentAddition_Utility(RMAApp_Payment_Lst_BankAccount, RMAApp_Payment_Lst_PayeeType, RMAApp_FundsSplitDetails_Lst_TransactionType, RMAApp_FundsSplitDetails_Txt_Amount, RMAApp_Payment_Txt_LastName,RMAApp_Payment_Txt_DistributionType,1);
			parentlogger.log(LogStatus.INFO, "New Payment Is Created With Control Number::"+ " " + color.RMA_ChangeColor_Utility(StrControlNumber_RMA_TC_066, 2));
			...
			RMA_GenericUsages_Utility.RMA_StaticWait(5, 0, "Wait Is Added As Back To Financials Image Is Clicked");

			parentlogger.log(LogStatus.INFO, "Following Function Is Called To Create A Payment Of $2500 :: RMA_PaymentAddition_Utility");
			testcall4 = true;
			StrControlNumber_RMA_TC_066_01 = RMA_Functionality_Utility.RMA_PaymentAddition_Utility(RMAApp_Payment_Lst_BankAccount, RMAApp_Payment_Lst_PayeeType, RMAApp_FundsSplitDetails_Lst_TransactionType, RMAApp_FundsSplitDetails_Txt_Amount_1, RMAApp_Payment_Txt_LastName,RMAApp_Payment_Txt_DistributionType,1);
			parentlogger.log(LogStatus.INFO, "New Payment Is Created With Control Number ::"+ " " + color.RMA_ChangeColor_Utility(StrControlNumber_RMA_TC_066_01, 2));
			...
			{
				logger.log(LogStatus.FAIL,"Following Error Occurred  ::" + " "+  color.RMA_ChangeColor_Utility(FinalErrorMessage,1)+ " " + "While Calling A Function To Create A Payemnt Of $2000" +" :: "+ "RMA_PaymentAddition_Utility" + " " +  "And Hence The Function Call Is A Fail");
				parentlogger.appendChild(logger);
			}
			else if ((testcall4 == true) && (loggerval4.equalsIgnoreCase("NotInitialized")))
			{
				logger.log(LogStatus.FAIL,"Following Error Occurred  ::" + " "+  color.RMA_ChangeColor_Utility(FinalErrorMessage,1)+ " " + "While Calling A Function To Create A Payemnt Of $2500 " +" ::"+ "RMA_PaymentAddition_Utility" + " " +  "And Hence The Function Call Is A Fail");
				parentlogger.appendChild(logger);
			}
			throw (e);
		}	
