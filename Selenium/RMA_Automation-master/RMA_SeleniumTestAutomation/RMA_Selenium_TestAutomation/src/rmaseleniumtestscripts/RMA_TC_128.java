...
//================================================================================================
//TestCaseID     : RMA_TC_128
//Description    : TC_128_Verify Adding,Editing And Deleting Of New Medical Staff As Person Involved In Litigation For General Claim
//Depends On TC  : RMA_TC_126
//Revision       : 0.0 - KumudNaithani-06-28-2016 
//=================================================================================================

public class RMA_TC_128 extends RMA_TC_BaseTest {
	...
	@Test
	public void RMA_TC_128_Test() throws Exception,Error {

		try{
			parentlogger = reports.startTest("TC_128_Adding, Editing And Deleting Of New Medical Staff", "Verify Adding,Editing And Deleting Of New Medical Staff As Person Involved In Litigation For General Claim");
			parentlogger.assignAuthor("Kumud Naithani");

			String StrMedicalLastName_128;
			String StrMedicalLastNameActual_128;
			String StrMedicalLastNameChanged;

			StrScreenShotTCName = "TC_128";
			testcall1 = false;	
			testcall2 = false;	
			...
			RMA_Functionality_Utility.RMA_StandardSearch_Screen(RMA_POM_Search.RMAApp_SearchClaims_Txt_ClaimNumber(driver), "Claim Search Page ", "Claim Number TextBox", RMA_TC_126.StrClaimNumber_RMA_TC_126, RMA_TC_126.StrClaimNumber_RMA_TC_126, "claimgc", "num", 2, 0);
			...
			testcall1 = true;
			StrMedicalLastName_128 = RMA_Functionality_Utility.RMA_PIAddNewEntity_Utility("Medical Staff", logval1);
			parentlogger.log(LogStatus.INFO, "New Medical Staff Is Created Successfully With Medical Staff Last Name::"+ " " + color.RMA_ChangeColor_Utility(StrMedicalLastName_128, 2));
			parentlogger.log(LogStatus.INFO, parentlogger.addScreenCapture(RMA_ScreenCapture_Utility.RMA_ScreenShotCapture_Utility(driver, "Creation Of New Medical Staff Is Successfull", StrScreenShotTCName)));
			loggerval1 = logger.toString();
			parentlogger.appendChild(logger);
			//===============================================Steps To Create A New Medical Staff Completed======================================================================================================================================================================================================================================
			
			/*===============================================Editing Of New Medical Staff Is Started Here=========================================================================================================================================================================================================================================*/
			StrMedicalLastNameChanged = RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(4, "Medical_TC_128_");
			...
			StrMedicalLastNameActual_128 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Maintenance.RMAApp_MaintMedStaff_Txt_LstName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrMedicalLastNameChanged, StrMedicalLastNameActual_128 , "Medical StaffLast Name", logval);
