...
//================================================================================================
//TestCaseID     : RMA_TC_223
//Description    : TC_223_Verify Adding,Editing And Deleting Of new Employee As Person Involved  For Workers Comp Claim
//Depends On TC  : RMA_TC_222
//Revision       : 0.0 - ImteyazAhmad-07-21-2016 
//=================================================================================================

public class RMA_TC_223 extends RMA_TC_BaseTest {
	...
	@Test
	public void RMA_TC_223_Test() throws Exception,Error {

		try{
			parentlogger = reports.startTest("TC_223_Adding, Editing And Deleting Of New Employee", "Verify Adding,Editing And Deleting Of New Employee As Person Involved For Workers Comp Claim");
			parentlogger.assignAuthor("Imteyaz Ahmad");

			String StrEmployeeNumber_223;
			String StrEmployeeLastNameActual_223;
			String StrEmployeeNameChanged_223;
			String StrClaimNaumberActual;
			//Local Variable Declaration Completed Here
			
			StrScreenShotTCName = "TC_223";
			testcall1 = false;	
			testcall2 = false;	
			...
			RMA_Navigation_Utility.RMA_ObjectRightClick(RMA_Selenium_POM_Home.RMAApp_LeftHandNavTree_Lnk_Claim_PI(driver,RMA_TC_222.StrClaimNumber_222), "Person Involved Link On Left Hand Navigation Tree", logval);
			parentlogger.log(LogStatus.INFO, "The Functional Utility :" +" " +"RMA_PIAddNewEntity_Utility Is Called To Create An Employee ");
			testcall1 = true;
			StrEmployeeNumber_223 = RMA_Functionality_Utility.RMA_PIAddNewEntity_Utility("Employee", logval1);
			parentlogger.log(LogStatus.INFO, "New Employee Is Created Successfully With Employee Number::"+ " " + color.RMA_ChangeColor_Utility(StrEmployeeNumber_223, 2));
			...
			StrEmployeeNameChanged_223 = RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(4, "EmpName_223_");
			RMA_Input_Utility.RMA_SetValue_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "LastName TextBox On PI Employee Page ", StrEmployeeNameChanged_223, logval);
			RMA_Functionality_Utility.RMA_GenericSave_Utility("piemployee", false, "NA","Persons Involved-->Employee Page", logval);
			StrEmployeeLastNameActual_223 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrEmployeeNameChanged_223, StrEmployeeLastNameActual_223 , "EmployeeLast Name", logval);
			...
			parentlogger.log(LogStatus.INFO, "The Functional Utility :" +" " +"RMA_GenericDelete_Utility Is Called To Delete An Employee : " +" "+ color.RMA_ChangeColor_Utility(StrEmployeeNameChanged_223, 2));
			testcall2 = true;
			RMA_Functionality_Utility.RMA_GenericDelete_Utility("PI Employee Page", logval1);
			parentlogger.log(LogStatus.INFO, "Employee Is Deleted Successfully ::"+ " " + color.RMA_ChangeColor_Utility(StrEmployeeNameChanged_223, 2));
