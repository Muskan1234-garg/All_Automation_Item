...
//================================================================================================
//TestCaseID     : RMA_TC_114
//Description    : TC_114_Verify Adding,Editing And Deleting Of Existing Other Person As Person Involved In Litigation For Non Occupational Claim
//Depends On TC  : RMA_TC_110
//Revision       : 0.0 - ImteyazAhmad-05-24-2016 
//=================================================================================================

public class RMA_TC_114 extends RMA_TC_BaseTest {
	...
	@Test
	public void RMA_TC_114_Test() throws Exception,Error {

		try{
			parentlogger = reports.startTest("TC_114_Adding, Editing And Deleting Of An Existing Other Person", "Verify Adding,Editing And Deleting Of An Existing Other Person As Person Involved In Litigation For Non Occupational Claim");
			parentlogger.assignAuthor("Imteyaz Ahmad");

			String StrOtherPersonLastName_114;
			String StrPrimaryWindowHandle;
			String StrOtherPersonLastNameActual_114;
			String OtherPersonLastNameChanged;

			//Local Variable Declaration Completed Here

			
			StrScreenShotTCName = "TC_114";
			testcall1 = false;	
			testcall2 = false;	
			...
			testcall1 = true;
			StrOtherPersonLastName_114 = RMA_Functionality_Utility.RMA_MaintEntityAddition_Utility("OtherPeople", logval1);
			parentlogger.log(LogStatus.INFO, "Other Person Is Created Successfully With Name::"+ " " + color.RMA_ChangeColor_Utility(StrOtherPersonLastName_114, 2));
			...
			RMA_Input_Utility.RMA_SetValue_Utility(RMA_POM_Search.RMAApp_SearchEntity_Txt_LastName(driver), "Last Name TextBox On Standard Entity Search Page", StrOtherPersonLastName_114, logval);
			...
			driver.switchTo().frame(RMA_GenericUsages_Utility.RMA_FrameNavigation("piother"));
			RMA_GenericUsages_Utility.RMA_StaticWait(2, logval, "Wait Is Added As Switch To Frame Containing Persons Involved-->Other Person Screen Controls Is Done");
			StrOtherPersonLastNameActual_114 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrOtherPersonLastName_114, StrOtherPersonLastNameActual_114 , "Other Person Last Name", logval);
			...
			RMA_GenericUsages_Utility.RMA_StaticWait(2, logval, "Wait Is Added As Switch To Frame Containing Persons Involved-->Other Person Screen Controls Is Done");
			StrOtherPersonLastNameActual_114 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(OtherPersonLastNameChanged, StrOtherPersonLastNameActual_114 , "Other Person Last Name", logval);
