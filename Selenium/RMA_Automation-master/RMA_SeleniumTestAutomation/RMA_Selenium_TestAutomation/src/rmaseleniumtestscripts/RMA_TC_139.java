...
//================================================================================================
//TestCaseID     : RMA_TC_139
//Description    : TC_139_Verify Adding,Editing And Deleting Of New Patient As Person Involved In Litigation For Workers Comp Claim
//Depends On TC  : RMA_TC_134
//Revision       : 0.0 - ImteyazAhmad-06-29-2016 
//=================================================================================================

public class RMA_TC_139 extends RMA_TC_BaseTest {
	...
	@Test
	public void RMA_TC_139_Test() throws Exception,Error {

		try{
			parentlogger = reports.startTest("TC_139_Adding, Editing And Deleting Of New Patient", "Verify Adding,Editing And Deleting Of New Patient As Person Involved In Litigation For Workers Comp Claim");
			parentlogger.assignAuthor("Imteyaz Ahmad");

			String StrPatientLastName_139;
			String StrPatientLastNameActual_139;
			String StrPatientLastNameChanged;

			StrScreenShotTCName = "TC_139";
			testcall1 = false;	
			testcall2 = false;	
			...
			testcall1 = true;
			StrPatientLastName_139 = RMA_Functionality_Utility.RMA_PIAddNewEntity_Utility("Patient", logval1);
			parentlogger.log(LogStatus.INFO, "New Patient Is Created Successfully With Patient Last Name::"+ " " + color.RMA_ChangeColor_Utility(StrPatientLastName_139, 2));
			loggerval1 = logger.toString();
			parentlogger.appendChild(logger);
			//===============================================Steps To Create A New Patient Completed============================================================================================================================================
			
			/*===============================================Editing Of New Patient Is Started Here=======================================================================*/
			StrPatientLastNameChanged = RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(4, "Patient_TC_139_");
			...
			StrPatientLastNameActual_139 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrPatientLastNameChanged, StrPatientLastNameActual_139 , "Patient Last Name", logval);
