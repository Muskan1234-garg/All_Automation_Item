...
//================================================================================================
//TestCaseID     : RMA_TC_179
//Description    : TC_179_Verify Adding,Editing And Deleting Of Existing Patient As Person Involved For WC Claim
//Depends On TC  : RMA_TC_174
//Revision       : 0.0 - ImteyazAhmad-07-14-2016 
//=================================================================================================

public class RMA_TC_179 extends RMA_TC_BaseTest {
	...
	@Test
	public void RMA_TC_179_Test() throws Exception,Error {

		try{
			parentlogger = reports.startTest("TC_179_Adding, Editing And Deleting Of An Existing Patient", "Verify Adding,Editing And Deleting Of An Existing Patient As Person Involved For Workers Comp Claim");
			parentlogger.assignAuthor("Imteyaz Ahmad");

			String StrPatientLastName_179;
			String StrPrimaryWindowHandle;
			String StrPatientLastNameActual_179;
			...
			testcall1 = true;
			StrPatientLastName_179 = RMA_Functionality_Utility.RMA_MaintEntityAddition_Utility("PatientTracking", logval1);
			parentlogger.log(LogStatus.INFO, "New Patient Is Created Successfully With Name::"+ " " + color.RMA_ChangeColor_Utility(StrPatientLastName_179, 2));
			...
			RMA_Functionality_Utility.RMA_StandardSearch_Window(RMA_POM_Search.RMAApp_SearchPatient_Txt_PatientLastName(driver), "Standard Patient Search Page", "Patient Last Name TextBox", StrPatientLastName_179, StrPatientLastName_179, "pipatient", StrPrimaryWindowHandle, logval);
			RMA_Functionality_Utility.RMA_GenericSave_Utility("pipatient", false, "NA", "Save Image On PI Patient Page", logval);
			StrPatientLastNameActual_179 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrPatientLastName_179, StrPatientLastNameActual_179 , "Driver Last Name", logval);
			...
			RMA_Functionality_Utility.RMA_GenericSave_Utility("pipatient", false, "NA", "Save Image On PI Patient Page", logval);
			StrPatientLastNameActual_179 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrPatientNameChanged, StrPatientLastNameActual_179 , "Patient Last Name", logval);
