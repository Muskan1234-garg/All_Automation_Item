...
//================================================================================================
//TestCaseID     : RMA_TC_097
//Description    : TC_097_Verify Adding,Editing And Deleting Of Existing Driver As Person Involved In Litigation For WC Claim
//Depends On TC  : RMA_TC_094
//Revision       : 0.0 - ImteyazAhmad-05-05-2016 
//=================================================================================================

public class RMA_TC_097 extends RMA_TC_BaseTest {
	...
	@Test
	public void RMA_TC_097_Test() throws Exception,Error {

		try{
			parentlogger = reports.startTest("TC_097_Adding, Editing And Deleting Of An Existing Driver", "Verify Adding,Editing And Deleting Of An Existing Driver As Person Involved In Litigation For Workers Comp Claim");
			parentlogger.assignAuthor("Imteyaz Ahmad");

			String StrDriverLastName_097;
			String StrPrimaryWindowHandle;
			String StrDriverLastNameActual_097;
			...
			testcall1 = true;
			StrDriverLastName_097 = RMA_Functionality_Utility.RMA_MaintEntityAddition_Utility("Driver", logval1);
			parentlogger.log(LogStatus.INFO, "New Driver Is Created Successfully With Name::"+ " " + color.RMA_ChangeColor_Utility(StrDriverLastName_097, 2));
			...
			RMA_Input_Utility.RMA_SetValue_Utility(RMA_POM_Search.RMAApp_SearchDriver_Txt_DriverLastName(driver), "Driver Last Name TextBox On Standard Driver Search Page", StrDriverLastName_097, logval);
			...
			RMA_Navigation_Utility.RMA_WebPartialLinkSelect(StrDriverLastName_097, "Search Page Specific To Searched Driver Criteria" , logval);
			...
			StrDriverLastNameActual_097 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrDriverLastName_097, StrDriverLastNameActual_097 , "Driver Last Name", logval);
			...
			StrEntityNameChanged = RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(4, "Drive_");
			RMA_Input_Utility.RMA_SetValue_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "LastName TextBox On PI Driver Page ", StrEntityNameChanged, logval);
			RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_Home.RMAApp_Generic_Img_Save(driver), "Save Image On PI Driver Page", logval);
			RMA_GenericUsages_Utility.RMA_StaticWait(5, logval, "Wait Is Added As PI Driver Page Is Saved");
			RMA_NegativeVerification_Utility.RMA_ElementNotExist_Utility(RMA_Selenium_POM_Home.RMAApp_DefaultView_Err_StaticErrorText(driver), "RMA Application Static Error Message",logval);
			StrDriverLastNameActual_097 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrEntityNameChanged, StrDriverLastNameActual_097 , "Driver Last Name", logval);
			...
			parentlogger.log(LogStatus.INFO, "The Functional Utility :" +" " +"RMA_GenericDelete_Utility Is Called To Delete A Driver :" +" "+ color.RMA_ChangeColor_Utility(StrEntityNameChanged, 2));
			testcall2 = true;
			RMA_Functionality_Utility.RMA_GenericDelete_Utility("PI Driver Page", logval1);
			parentlogger.log(LogStatus.INFO, "Driver Is Deleted Successfully With Name::"+ " " + color.RMA_ChangeColor_Utility(StrEntityNameChanged, 2));
