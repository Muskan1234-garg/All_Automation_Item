...
//================================================================================================
//TestCaseID     : RMA_TC_275
//Description    : TC_275_Verify Adding,Editing And Deleting Of Existing Witness As Person Involved For Workers' Comp Claim At Policy level
//Revision       : 0.0 - RenuVerma-08-25-2016 
//=================================================================================================

public class RMA_TC_275 extends rmaseleniumtestscripts.RMA_TC_BaseTest {
	...
	@Test 
	public void RMA_TC_275_Test () throws Exception, Error
	{
		parentlogger = reports.startTest("TC_275_Verify Adding,Editing And Deleting Of Existing Witness As Person Involved For Workers' Comp Claim At Policy level", "Verify Adding,Editing And Deleting Of Existing Witness As Person Involved For Workers' Comp Claim At Policy level");
		parentlogger.assignAuthor("Renu Verma");
		try {
			String StrPrimaryWindowHandle;
		    String StrEditedWitLastNameActual_275;
			String StrEditedWitLastName275;
			String StrWitLastNameActual_275;
			...
			//===============================================Addition Of Witness On Workers' comp Created in TC_268 Is Started Here=====================================================================================================
			...
			RMA_Functionality_Utility.RMA_StandardSearch_Window(RMA_POM_Search.RMAApp_SearchEntity_Txt_LastName(driver), "Standard Entity Search page","Last Name Text Box",RMA_TC_268.StrWitnessLastName_268,"Witness","piwitness",StrPrimaryWindowHandle, logval);
			RMA_Functionality_Utility.RMA_GenericSave_Utility("piwitness",false,"NA","Witness Involved-->Witness Page", logval);
			StrWitLastNameActual_275 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(RMA_TC_268.StrWitnessLastName_268, StrWitLastNameActual_275, "Witness Name", logval);
			...
			StrEditedWitLastName275 = RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(4, "Witness_275_");
			RMA_Input_Utility.RMA_SetValue_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "LastName TextBox On Persons Involved-->Witness Page", StrEditedWitLastName275, logval);
			RMA_Functionality_Utility.RMA_GenericSave_Utility("piwitness",false,"NA","Persons Involved-->Witness Page", logval);
			StrEditedWitLastNameActual_275 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrEditedWitLastName275, StrEditedWitLastNameActual_275 , "Witness Last Name Value",logval);
			...
			parentlogger.log(LogStatus.INFO, "Following Utility :" +" " +"RMA_GenericDelete_Utility Is Called To Delete The Witness"+ " "+ color.RMA_ChangeColor_Utility(StrEditedWitLastNameActual_275, 2) +" " +"Added As Persons Involved");
			testcall2 = true;
			RMA_Functionality_Utility.RMA_GenericDelete_Utility("Persons Involved-->Witness Page", logval1);
			parentlogger.log(LogStatus.INFO, "Witness Added As Persons Involved Is Deleted Successfully::"+ " " + color.RMA_ChangeColor_Utility(StrEditedWitLastNameActual_275, 2));
