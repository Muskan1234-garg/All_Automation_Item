...
//================================================================================================
//TestCaseID     : RMA_TC_274
//Description    : TC_274_Verify Adding,Editing And Deleting Of Existing Physician As Person Involved For Workers' Comp Claim At Policy level
//Depends On TC  : RMA_TC_268
//Revision       : 0.0 - RenuVerma-09-08-2016  
//=================================================================================================

public class RMA_TC_274 extends rmaseleniumtestscripts.RMA_TC_BaseTest {
	...
	{
		parentlogger = reports.startTest("TC_274_Verify Adding,Editing And Deleting Of Existing Physician As Person Involved For Workers' Comp Claim At Policy level", "Verify Adding,Editing And Deleting Of Existing Physician As Person Involved For Workers' Comp Claim At Policy level");
		parentlogger.assignAuthor("Renu Verma");
		try {
			String StrPhysicianLastName_274;
			String StrPrimaryWindowHandle;
			String StrEditedPhysicianLastName_Actual_274;
			String StrEditedPhysicianLastName_274;
			String StrPhysicianLastName_Actual_274;
			...
			testcall1 = true;
			StrPhysicianLastName_274 = RMA_Functionality_Utility.RMA_MaintEntityAddition_Utility("Physician", logval1);
			parentlogger.log(LogStatus.INFO, "New Physician Is Created With Physician Name::"+ " " + color.RMA_ChangeColor_Utility(StrPhysicianLastName_274, 2));
			...
			//===============================================Addition Of Physician On Workers' Comp Claim Policy Created in TC_268 Is Started Here=====================================================================================================
			...
			RMA_Functionality_Utility.RMA_StandardSearch_Window(RMA_POM_Search.RMAApp_SearchPhysician_Txt_LastName(driver), "Standard Entity Search page","Last Name Text Box",StrPhysicianLastName_274,StrPhysicianLastName_274, "piphysician",StrPrimaryWindowHandle, logval);
			RMA_Functionality_Utility.RMA_GenericSave_Utility("piphysician",false,"NA","Persons Involved-->Physician Page", logval);
			StrPhysicianLastName_Actual_274 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrPhysicianLastName_274, StrPhysicianLastName_Actual_274, "Physician Name", logval);
			...
			//===============================================Addition Of Physician On Workers' comp Created in TC_268 Is Completed Here =================================================================================================================================================
			
			//===============================================Steps To Edit The Physician Added As Persons Involved Started ======================================================================================================================================================
			StrEditedPhysicianLastName_274 = RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(4, "Physician_274_");
			RMA_Input_Utility.RMA_SetValue_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "LastName TextBox On Persons Involved-->Physician Page", StrEditedPhysicianLastName_274, logval);
			RMA_Functionality_Utility.RMA_GenericSave_Utility("piphysician",false,"NA","Persons Involved-->Physician Page", logval);
			StrEditedPhysicianLastName_Actual_274 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrEditedPhysicianLastName_274, StrEditedPhysicianLastName_Actual_274 , "Physician Last Name Value",logval);
			...
			parentlogger.log(LogStatus.INFO, "Following Utility :" +" " +"RMA_GenericDelete_Utility Is Called To Delete The Physician"+ " "+ color.RMA_ChangeColor_Utility(StrEditedPhysicianLastName_Actual_274, 2) +" " +"Added As Persons Involved");
			testcall2 = true;
			RMA_Functionality_Utility.RMA_GenericDelete_Utility("Persons Involved-->Physician Page", logval1);
			parentlogger.log(LogStatus.INFO, "Physician Added As Persons Involved Is Deleted Successfully::"+ " " + color.RMA_ChangeColor_Utility(StrEditedPhysicianLastName_Actual_274, 2));
