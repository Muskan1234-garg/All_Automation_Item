...
//================================================================================================
//TestCaseID     : RMA_TC_213
//Description    : TC_213_Verify Add,Edit And Delete Of New Witness As Person Involved on Property Claim
//Depends On TC  : RMA_TC_206
//Revision       : 0.0 - RenuVerma-07-15-2016 
//=================================================================================================

public class RMA_TC_213 extends rmaseleniumtestscripts.RMA_TC_BaseTest {
	...
	@Test 
	public void RMA_TC_213_Test () throws Exception, Error
	{
		parentlogger = reports.startTest("TC_213_Adding, Editing And Deleting Of New Witness As Person Involved", "Verify Add,Edit And Delete Of New Witness As Person Involved on Property Claim");
		parentlogger.assignAuthor("Renu Verma");
		try {
			
		    String StrEditedWitLastNameActual_213;
			String StrEditedWitLastName213;
			String StrWitLastName_213;
			...
			testcall1 = true;
			StrWitLastName_213 = RMA_Functionality_Utility.RMA_PIAddNewEntity_Utility("Witness", logval1);
			parentlogger.log(LogStatus.INFO, "New Witness Is Created Successfully With Witness Name::"+ " " + color.RMA_ChangeColor_Utility(StrWitLastName_213, 2));
			...
			StrEditedWitLastName213 = RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(4, "Witness_RMA_TC_213_");
			RMA_Input_Utility.RMA_SetValue_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "LastName TextBox On Persons Involved-->Witness Page", StrEditedWitLastName213, logval);
			RMA_Functionality_Utility.RMA_GenericSave_Utility("piwitness",false,"NA","Persons Involved-->Witness Page", logval);
			StrEditedWitLastNameActual_213 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrEditedWitLastName213, StrEditedWitLastNameActual_213 , "Witness Last Name Value",logval);
			...
			parentlogger.log(LogStatus.INFO, "Following Utility :" +" " +"RMA_GenericDelete_Utility Is Called To Delete The Witness"+ " "+ color.RMA_ChangeColor_Utility(StrEditedWitLastNameActual_213, 2) +" " +"Added As Persons Involved");
			testcall2 = true;
			RMA_Functionality_Utility.RMA_GenericDelete_Utility("Persons Involved-->Witness Page", logval1);
			parentlogger.log(LogStatus.INFO, "Witness Added As Persons Involved Is Deleted Successfully::"+ " " + color.RMA_ChangeColor_Utility(StrEditedWitLastNameActual_213, 2));
