...
//======================================================================================================================================
//TestCaseID     : RMA_TC_335_VehicleAccClaim
//Description    : Successful Creation, Edit And Deletion Of Enhanced Notes For An Already Created Vehicle Accident Claim Is Validated
//Depends On TC  : None
//Revision       : 0.0 - KumudNaithani-02-27-2017
//======================================================================================================================================

public class RMA_TC_335_VehicleAccClaim extends RMA_TC_BaseTest {	
...
@Test 
public void RMA_TC_335_VehicleAccClaim_Test() throws Exception, Error
{
...
try
	{
	 parentlogger = reports.startTest("RMA_TC_335_Creation, Edit And Deletion Of Enhanced Notes For Vehicle Accident Claim", "Creation, Edit And Deletion Of Enhanced Notes For An Already Created Vehicle Accident Claim");
	 ...
	 StrScreenShotTCName = "RMA_TC_335_VehicleAccClaim";
	 Edit = true;
	 //Variable Initialization Completed
	 
	//===========================================================New Vehicle Accident Claim Creation Is Started Here=====================================================================================================================================================================================================================================================================================================================================
	 parentlogger.log(LogStatus.INFO, "Following Test Is Called To Create A VehicleAccident Claim:: "+RMA_GenericUsages_Utility.RMA_LoggerHyperlink("RMASmokeTC002Veh", "RMA_Smoke_TC_002_Veh",0));
     testcall1 = true;
     RMA_Smoke_TC_002_Veh VehicleAccidentClaim = new RMA_Smoke_TC_002_Veh();
     StrClaimNumber_335 = VehicleAccidentClaim.RMA_Smoke_TC_002_Veh_Test();  //Created VehicleAccident Claim Number Is Stored In Variable StrClaimNumber_335
     loggerval1 = logger.toString();
     parentlogger.log(LogStatus.INFO, "A New VehicleAccident Claim Is Created With Claim Number:: "+ color.RMA_ChangeColor_Utility(StrClaimNumber_335, 2));
     parentlogger.appendChild(logger);
 	//===========================================================New Vehicle Accident Claim Creation Is Completed Here==================================================================================================================================================================================================================================================================================================================================
	
	//===========================================================Steps To Create And Edit Progress Notes Started Here==================================================================================================================================================================================================================================================================================================================================================
	StrPrimaryWindowHandle = driver.getWindowHandle();
	RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_Home.RMAApp_Generic_Img_EnhancedNotes(driver), "Enhanced Notes Image On Vehicle Accident Claim :"+" "+StrClaimNumber_335, logval); //Claim ID Is Same For All Line Of Business
	...
	//===========================================================Steps To Delete Progress Notes Completed Here============================================================================================================================================================================================================================================================
	 ...
	 {
	 logger.log(LogStatus.FAIL, "Following Error Occurred  ::" + " "+  color.RMA_ChangeColor_Utility(FinalErrorMessage,1)+ " " + "While Executing Child Test Case" +" "+ "RMA_Smoke_TC_002_Veh" + " " +  "For Vehicle Accident Claim Creation And Hence The Test Case Is A Fail");
	 parentlogger.appendChild(logger);
	 }
