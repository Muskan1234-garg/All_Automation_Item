...
//================================================================================================
//TestCaseID     : RMA_TC_251
//Description    : TC_251_Verify Add,Edit And Delete Of Existing Patient As Person Involved on Event
//Depends On TC  : RMA_TC_246
//Revision       : 0.0 - RenuVerma-08-02-2016  
//=================================================================================================

public class RMA_TC_251 extends rmaseleniumtestscripts.RMA_TC_BaseTest {
	...
	@Test 
	public void RMA_TC_251_Test () throws Exception, Error
	{
		parentlogger = reports.startTest("TC_251_Adding,Editing And Deleting Of Existing Patient As Person Involved", "Verify Add,Edit And Delete Of Existing Patient As Person Involved on Event");
		parentlogger.assignAuthor("Renu Verma");
		try {
			String StrPrimaryWindowHandle;
			String StrPatientLastName_251;
			String StrEditedPatientLastName_Actual_251;
			String StrEditedPatientLastName_251;
			String StrPatientLastName_Actual_251;
			...
			testcall1 = true;
			StrPatientLastName_251 = RMA_Functionality_Utility.RMA_MaintEntityAddition_Utility("PatientTracking", logval1);
			parentlogger.log(LogStatus.INFO, "New Patient Is Created With Patient Name::"+ " " + color.RMA_ChangeColor_Utility(StrPatientLastName_251, 2));
			...
			//===============================================Addition Of Patient On Event Created in TC_246 Is Started Here=====================================================================================================
			...
			RMA_Functionality_Utility.RMA_StandardSearch_Window(RMA_POM_Search.RMAApp_SearchPatient_Txt_PatientLastName(driver), "Standard Entity Search page","Last Name Text Box",StrPatientLastName_251,StrPatientLastName_251, "pipatient",StrPrimaryWindowHandle, logval);
			RMA_Functionality_Utility.RMA_GenericSave_Utility("pipatient",false,"NA","Persons Involved-->Patient Page", logval);
			StrPatientLastName_Actual_251 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrPatientLastName_251, StrPatientLastName_Actual_251, "Patient Name", logval);
			...
			//===============================================Addition Of Patient On Event Created in TC_246 Is Completed =================================================================================================================================================
			
			
			//===============================================Steps To Edit The Patient Added As Persons Involved Started ======================================================================================================================================================
			StrEditedPatientLastName_251 = RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(4, "Patient_251_");
			RMA_Input_Utility.RMA_SetValue_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "LastName TextBox On Persons Involved-->Patient Page", StrEditedPatientLastName_251, logval);
			RMA_Functionality_Utility.RMA_GenericSave_Utility("pipatient",false,"NA","Persons Involved-->Patient Page", logval);
			StrEditedPatientLastName_Actual_251 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrEditedPatientLastName_251, StrEditedPatientLastName_Actual_251 , "Patient Last Name Value",logval);
			...
			parentlogger.log(LogStatus.INFO, "Following Utility :" +" " +"RMA_GenericDelete_Utility Is Called To Delete The Patient"+ " "+ color.RMA_ChangeColor_Utility(StrEditedPatientLastName_Actual_251, 2) +" " +"Added As Persons Involved");
			testcall2 = true;
			RMA_Functionality_Utility.RMA_GenericDelete_Utility("Persons Involved-->Patient Page", logval1);
			parentlogger.log(LogStatus.INFO, "Patient Added As Persons Involved Is Deleted Successfully::"+ " " + color.RMA_ChangeColor_Utility(StrEditedPatientLastName_Actual_251, 2));
