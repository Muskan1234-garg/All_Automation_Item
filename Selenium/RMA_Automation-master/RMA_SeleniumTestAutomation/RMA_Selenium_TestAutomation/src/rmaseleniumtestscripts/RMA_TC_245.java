...
//================================================================================================
//TestCaseID     : RMA_TC_245
//Description    : TC_245_Verify Add,Edit And Delete Of New Witness As Person Involved on Vehicle Accident Claims
//Depends On TC  : RMA_TC_238
//Revision       : 0.0 - RenuVerma-07-28-2016 
//=================================================================================================

public class RMA_TC_245 extends rmaseleniumtestscripts.RMA_TC_BaseTest {
	...
	@Test 
	public void RMA_TC_245_Test () throws Exception, Error
	{
		parentlogger = reports.startTest("TC_245_Adding, Editing And Deleting Of New Witness As Person Involved", "Verify Add,Edit And Delete Of New Witness As Person Involved on Vehicle Accident Claim");
		parentlogger.assignAuthor("Renu Verma");
		try {
			
		    String StrEditedWitLastNameActual_245;
			String StrEditedWitLastName245;
			String StrWitLastName_245;
			...
			//===============================================Addition Of Witness On Claim Created in TC_238 Is Started Here=====================================================================================================
			...
			testcall1 = true;
			StrWitLastName_245 = RMA_Functionality_Utility.RMA_PIAddNewEntity_Utility("Witness", logval1);
			parentlogger.log(LogStatus.INFO, "New Witness Is Created Successfully With Witness Name::"+ " " + color.RMA_ChangeColor_Utility(StrWitLastName_245, 2));
			...
			//===============================================Addition Of Witness On Claim Created in TC_238 Is Completed =================================================================================================================================================
			
			//===============================================Steps To Edit The Witness Added As Persons Involved Started ======================================================================================================================================================
			StrEditedWitLastName245 = RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(4, "Witness_RMA_TC_245_");
			RMA_Input_Utility.RMA_SetValue_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "LastName TextBox On Persons Involved-->Witness Page", StrEditedWitLastName245, logval);
			RMA_Functionality_Utility.RMA_GenericSave_Utility("piwitness",false,"NA","Persons Involved-->Witness Page", logval);
			StrEditedWitLastNameActual_245 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrEditedWitLastName245, StrEditedWitLastNameActual_245 , "Witness Last Name Value",logval);
			...
			parentlogger.log(LogStatus.INFO, "Following Utility :" +" " +"RMA_GenericDelete_Utility Is Called To Delete The Witness"+ " "+ color.RMA_ChangeColor_Utility(StrEditedWitLastNameActual_245, 2) +" " +"Added As Persons Involved");
			testcall2 = true;
			RMA_Functionality_Utility.RMA_GenericDelete_Utility("Persons Involved-->Witness Page", logval1);
			parentlogger.log(LogStatus.INFO, "Witness Added As Persons Involved Is Deleted Successfully::"+ " " + color.RMA_ChangeColor_Utility(StrEditedWitLastNameActual_245, 2));
