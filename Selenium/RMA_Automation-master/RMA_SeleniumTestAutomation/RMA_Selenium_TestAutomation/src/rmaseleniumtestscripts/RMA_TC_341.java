...
//=============================================================================================================================
//TestCaseID     : RMA_TC_341
//Description    : Creation, Addition And Deletion Of Enhanced Notes For An Arbitration Associated With A Claim
//Depends On TC  : RMA_TC_335
//Revision       : 0.0 - KumudNaithani-02-28-2017
//==============================================================================================================================

public class RMA_TC_341 extends RMA_TC_BaseTest {
...
@Test	
public void RMA_TC_341_Test() throws Exception, Error
{   
	try {	 	 
	 String StrArbitration;
	 ...
	 parentlogger = reports.startTest("RMA_TC_341_Creation, Addition And Deletion Of Enhanced Notes For An Arbitration", "Creation, Addition And Deletion Of Enhanced Notes For An Arbitration Associated With A Claim");
	 ...
	 StrScreenShotTCName = "RMA_TC_341";
	 Edit = true;
	...
	//Fetch Of Data From Excel Completed
	//===========================================================New Arbitration Creation Associated With Claim Is Started Here=====================================================================================================================================================================================================================================================================================================================================
	parentlogger.log(LogStatus.INFO, "The Functional Utility :" +" " +RMA_GenericUsages_Utility.RMA_LoggerHyperlink("ClaimEntity", "Claim Entity Addition",0)+ " "+ "Is Called To Add Arbitration To Claim" + " "+color.RMA_ChangeColor_Utility(StrClaimNumber_335, 2));// Claim ID Is Same For All Line Of Business
	testcall1 = true;
	StrArbitration = RMA_Functionality_Utility.RMA_ClaimEntityAddition_Utility("Arbitration", "Arbitration (0)", StrClaimNumber_335, "Not Required", RMAApp_ArbitrationCreation_Txt_Type, "Not Required", "Not Required", "Not Required", "Not Required", RMAApp_ArbitrationCreation_Txt_FinType, logval1);
	parentlogger.log(LogStatus.INFO, "Following New Arbitration Is Created Successfully::"+ " " + color.RMA_ChangeColor_Utility(StrArbitration, 2));
	loggerval1 = logger.toString();
	parentlogger.appendChild(logger);
	parentlogger.log(LogStatus.INFO, parentlogger.addScreenCapture(RMA_ScreenCapture_Utility.RMA_ScreenShotCapture_Utility(driver, "Successful Arbitration Creation", StrScreenShotTCName)));
	//=========================================================== New Arbitration Creation Associated With Claim Is Completed Here=======================================================================================================================================================================================================================================================================================================================================
	
	//===========================================================Steps To Create And Edit Progress Notes Started Here==================================================================================================================================================================================================================================================================================================================================================
    StrPrimaryWindowHandle = driver.getWindowHandle();
	RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_Home.RMAApp_Generic_Img_EnhancedNotes(driver), "Enhanced Notes Image For Arbitration"+ " " + color.RMA_ChangeColor_Utility(StrArbitration, 2) + " " +" Associated With Claim:"+" "+color.RMA_ChangeColor_Utility(StrClaimNumber_335, 2), logval); // Claim ID Is Same For All Line Of Business
	...
	//===========================================================Steps To Delete Progress Notes Completed Here============================================================================================================================================================================================================================================================
		 ...
		 {
		 logger.log(LogStatus.FAIL, "Following Error Occurred  ::" + " "+  color.RMA_ChangeColor_Utility(FinalErrorMessage,1)+ " " + "While Executing Function Utility" +" "+ "RMA_ClaimEntityAddition_Utility" + " For New Arbitration Creation Associated With A Claim And Hence The Test Case Is A Fail");
		 parentlogger.appendChild(logger);
		 }
