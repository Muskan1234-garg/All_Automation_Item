...
//================================================================================================
//TestCaseID     : RMA_Smoke_TC_087
//Description    : Successfully Set All The Requirements For Internal Policy Tracking Under General Claim For Carrier Client Is Validated
//Depends On TC  : None
//Revision       : 0.0 - RenuVerma-01-04-2017
//=================================================================================================

public class RMA_Smoke_TC_087_GC extends RMA_TC_BaseTest {
	...
	public static String StrPolicyName_Smoke_TC_087_GC;
	public static String StrPolicyNum_Smoke_TC_087_GC;
	public static String StrPolicyCode_Smoke_TC_087_GC;
	public static String StrUnitName_Smoke_TC_087_GC;
	public static String CoverageType_Smoke_TC_087_GC;
	public static String LstRMALossCode_Smoke_TC_087_GC;
	public static String PolicyDetailOnMaintTable_Smoke_TC_087_GC;
	public static String PolicyDescription_Smoke_TC_087_GC;

	@Test
	public void RMA_Smoke_TC_087_GC_Test() throws Exception,Error {

		try{
			parentlogger = reports.startTest("Smoke_TC_087_Set All The Requirements For Internal Policy Tracking Under General Claim For Carrier Client", "Successfully Set All The Requirements For Internal Policy Tracking Under General Claim For Carrier Client Is Validated");
			...
			PolicyLOB = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_087_GC", 1, 0); // Policy LOB Lookup Code Value Is Fetched From DataSheet RMA_Smoke_TC_087_GC
			PolicyParentCode=ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_087_GC", 1, 1); // Policy Parent Code Value Is Fetched From DataSheet RMA_Smoke_TC_087_GC
			...
			StrPolicyCode_Smoke_TC_087_GC=RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(4, "PolicyLOB_");
			PolicyDescription_Smoke_TC_087_GC="Verify - "+StrPolicyCode_Smoke_TC_087_GC;

			// Test Data for Financial screen
			SelectLOB=ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_087_GC", 17, 0); // Select Policy LOB List Value Is Fetched From DataSheet RMA_Smoke_TC_087_GC
			SelectPolicyLOB=StrPolicyCode_Smoke_TC_087_GC+"- "+PolicyDescription_Smoke_TC_087_GC;
			PolicyDetailOnMaintTable_Smoke_TC_087_GC=StrPolicyCode_Smoke_TC_087_GC+" - "+PolicyDescription_Smoke_TC_087_GC;

			// Test Data for Code Relationship screen
			LstRelationshipType=ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_087_GC", 5, 0); // Relationship Type Is Fetched From DataSheet RMA_Smoke_TC_087_GC
			LstRelationshipSubType	=ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_087_GC", 5, 1); // Relationship Sub Type Is Fetched From DataSheet RMA_Smoke_TC_087_GC
			LstAvailable_GC=ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_087_GC", 5, 2); //Available List Value Is Fetched From DataSheet RMA_Smoke_TC_087_GC

			// Test Data for Loss Code Mapping screen
			LstPolicySystemNames	=ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_087_GC", 9, 0); // Policy System Names Is Fetched From DataSheet RMA_Smoke_TC_087_GC
			LstRMALossCode_Smoke_TC_087_GC=ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_087_GC", 9, 1); //RMA Loss Code Is Fetched From DataSheet RMA_Smoke_TC_087_GC

			// Test Data for Policy Tracking screen
			PolicyTracking_Status = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_087_GC", 13, 0); //Policy Status Is Fetched From DataSheet RMA_TC_087
			PolicyTracking_PriPolicyState = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_087_GC", 13, 1); //Primary Policy State Is Fetched From DataSheet RMA_TC_087
			PolicyTracking_CMCState = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_087_GC", 13, 2); //CMC State Is Fetched From DataSheet RMA_TC_087
			PolicyTracking_InsurerLName =ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_087_GC", 13, 3); //Insurer Last Name Is Fetched From DataSheet RMA_TC_087
			PolicyTracking_Insured = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_087_GC", 13, 4); // Insured Is Fetched From DataSheet RMA_TC_087
			PolicyTracking_Premium = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_TC_087_GC", 13, 5); // Premium Is Fetched From DataSheet RMA_TC_087	
			UnitType=ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_087_GC", 13, 7); // Vehicle Type Is Fetched From DataSheet RMA_TC_087
			StrUnitName_Smoke_TC_087_GC=ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_087_GC", 13, 6); // Vehicle ID Is Fetched From DataSheet RMA_TC_087
			...
			CoverageType= ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_087_GC", 13, 8); // Coverage Type Is Fetched From DataSheet RMA_TC_087
			PolicyTracking_PolicyLimit=ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_TC_087_GC", 13, 9); // Policy Limit Is Fetched From DataSheet RMA_TC_087
			...
			testcall1 = true;		
			RMA_Functionality_Utility.RMA_TableMaintenanceCodeAddition_Utility("Policy LOB","P", "Policy LOB", StrPolicyCode_Smoke_TC_087_GC, PolicyDescription_Smoke_TC_087_GC, PolicyParentCode, EffStartDate, EffEndDate, PolicyLOB,1,StrPolicyCode_Smoke_TC_087_GC+"-"+PolicyLOB, false, logval1);
			loggerval1 = logger.toString();
			parentlogger.appendChild(logger);
			parentlogger.log(LogStatus.INFO, "New Code For Policy"+ " " + color.RMA_ChangeColor_Utility(StrPolicyCode_Smoke_TC_087_GC, 3)+ " "+ "Is Created On Maintenance Table");		
			driver.switchTo().parentFrame();
			...
			testcall2 = true;		
			RMA_Functionality_Utility.RMA_FinancialKeySetup_Utility(SelectLOB, SelectPolicyLOB, PolicyDetailOnMaintTable_Smoke_TC_087_GC, PolicyLOB, false,logval1);
			...
			testcall3 = true;		
			RMA_Functionality_Utility.RMA_CodeRelationshipAddition_Utility(LstRelationshipType, LstRelationshipSubType, PolicyDetailOnMaintTable_Smoke_TC_087_GC, LstAvailable_GC, false,logval1);
			...
			testcall4 = true;		
			RMA_Functionality_Utility.RMA_LossCodeMapping_Utility(LstPolicySystemNames, PolicyDetailOnMaintTable_Smoke_TC_087_GC, LstAvailable_GC,LstRMALossCode_Smoke_TC_087_GC , false, logval1);
			loggerval4 = logger.toString();
			parentlogger.appendChild(logger);
			parentlogger.log(LogStatus.INFO, "Done Loss Code Mapping For Loss Code:"+ " " + color.RMA_ChangeColor_Utility(LstRMALossCode_Smoke_TC_087_GC, 3));		
			driver.switchTo().parentFrame();
			...
			testcall5 = true;		
			StrPolicyName_Smoke_TC_087_GC= RMA_Functionality_Utility.RMA_PolicyTracking_Utility(PolicyTracking_Status,PolicyTracking_EffDate ,PolicyTracking_ExpDate,PolicyTracking_Premium, PolicyTracking_PriPolicyState, PolicyTracking_CMCState, PolicyTracking_InsurerLName, PolicyTracking_Insured, StrPolicyCode_Smoke_TC_087_GC,UnitType,StrUnitName_Smoke_TC_087_GC,true, logval1);	
			loggerval5 = logger.toString();
			parentlogger.appendChild(logger);
			StrPolicyNum_Smoke_TC_087_GC=RMA_Selenium_POM_PolicyTracking.RMAApp_PolicyTracking_Txt_PolicyNumber(driver).getAttribute("value");
			parentlogger.log(LogStatus.INFO, "New PolicyTracking With Policy Name::"+ " " + color.RMA_ChangeColor_Utility(StrPolicyName_Smoke_TC_087_GC, 3)+ " And Policy Number :"+color.RMA_ChangeColor_Utility(StrPolicyName_Smoke_TC_087_GC, 3)+ " Is Created");		
			...
			RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_Home.RMAApp_Generic_RMAAppLink(driver, "Unit Information"), " Unit Information Tab On Policy Tracking Page", logval);
			RMA_Input_Utility.RMA_ElementWebListSelect_Utility(RMA_Selenium_POM_PolicyTracking.RMAApp_PolicyTracking_Lst_UnitName(driver), "Vehicle Unit: "+StrUnitName_Smoke_TC_087_GC, "Unit Name List", "Policy Tracking Page", PolicyTracking_Premium);
			...
			testcall6 = true;
			CoverageType_Smoke_TC_087_GC=RMA_Functionality_Utility.RMA_PolicyCoverage_Utility(CoverageType, PolicyTracking_PolicyLimit,false, logval1);
			parentlogger.log(LogStatus.INFO, "First Policy Coverage Is Added Successfully With Coverage Type::"+ " " + color.RMA_ChangeColor_Utility(CoverageType_Smoke_TC_087_GC, 3));
