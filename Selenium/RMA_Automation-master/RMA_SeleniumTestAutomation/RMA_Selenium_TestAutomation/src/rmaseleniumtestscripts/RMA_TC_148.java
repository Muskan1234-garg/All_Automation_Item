...
//================================================================================================
//TestCaseID     : RMA_TC_148
//Description    : TC_148_Verify Adding,Editing And Deleting Of new Other Person As Person Involved In Litigation For Property Claim
//Depends On TC  : RMA_TC_141
//Revision       : 0.0 - RenuVerma-06-27-2016 
//=================================================================================================

public class RMA_TC_148 extends RMA_TC_BaseTest {
	...
	@Test
	public void RMA_TC_148_Test() throws Exception,Error {

		try{
			parentlogger = reports.startTest("TC_148_Adding, Editing And Deleting Of New Other Person", "Verify Adding,Editing And Deleting Of New Other Person As Person Involved In Litigation For Property Claim");
			parentlogger.assignAuthor("Renu Verma");

			String StrOtherPersonNumber_148;
			String StrOtherPersonLastNameActual_148;
			String StrOtherPersonNameChanged;

			//Local Variable Declaration Completed Here

			
			StrScreenShotTCName = "TC_148";
			testcall1 = false;	
			testcall2 = false;	
			...
			testcall1 = true;
			StrOtherPersonNumber_148 = RMA_Functionality_Utility.RMA_PIAddNewEntity_Utility("Other Person", logval1);
			parentlogger.log(LogStatus.INFO, "New Other Person Is Created Successfully With Other Person Number::"+ " " + color.RMA_ChangeColor_Utility(StrOtherPersonNumber_148, 2));
		...
		/*===============================================Editing Of New Other Person Is Started Here================================*/
			StrOtherPersonNameChanged = RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(4, "OthPeople_");
			...
			RMA_GenericUsages_Utility.RMA_StaticWait(5, logval, "Wait Is Added As PI Other Person Is Saved");
			...
			StrOtherPersonLastNameActual_148 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrOtherPersonNameChanged, StrOtherPersonLastNameActual_148 , "OtherPersonLast Name", logval);
			parentlogger.log(LogStatus.INFO, parentlogger.addScreenCapture(RMA_ScreenCapture_Utility.RMA_ScreenShotCapture_Utility(driver, "New OtherPerson Is Edited", StrScreenShotTCName)));

			/*=================================================Editing Of New Other Person Is Completed Here=============================================*/

			/*===========================================================Deletion Of New Other Person Is Started Here================================================*/

			parentlogger.log(LogStatus.INFO, "The Functional Utility :" +" " +"RMA_GenericDelete_Utility Is Called To Delete An Other Person : " +" "+ color.RMA_ChangeColor_Utility(StrOtherPersonNameChanged, 2));
			testcall2 = true;
