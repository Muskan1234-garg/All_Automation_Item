...
//================================================================================================
//TestCaseID     : RMA_TC_089
//Description    : TC_089_Verify Add,Edit And Delete Of Existing Driver As Person Involved In Litigation For General Claims
//Depends On TC  : RMA_TC_086
//Revision       : 0.0 - KumudNaithani-05-09-2016 
//=================================================================================================

public class RMA_TC_089 extends rmaseleniumtestscripts.RMA_TC_BaseTest {
	...
	@Test 
	public void RMA_TC_089_Test () throws Exception, Error
	{
		parentlogger = reports.startTest("TC_089_Existing Driver As Person Involved", "Verify Add,Edit And Delete Of Existing Driver As Person Involved In Litigation For General Claims");
		parentlogger.assignAuthor("Kumud Naithani");
		try {
			String StrDriverLastName_RMA_TC_089;
			String StrPrimaryWindowHandle;
		    String StrEditedDriverLastNameActual_RMA_TC_089;
			String StrEditedDriverLastName;
			String StrDriverLastNameActual_RMA_TC_089;
			
			loggerval1 = "NotInitialized";
			testcall1 = false;
			loggerval2 = "NotInitialized";
			testcall2 = false;
			StrScreenShotTCName = "TC_089";
			RMA_GenericUsages_Utility.RMA_WebPageRefresh_Utility(0);
			
			//===============================================Creation Of Driver Entity Is Started=====================================================================================================
			parentlogger.log(LogStatus.INFO, "Following Function Is Called :: RMA_MaintEntityAddition_Utility To Create A New Driver");
			testcall1 = true;
			StrDriverLastName_RMA_TC_089 = RMA_Functionality_Utility.RMA_MaintEntityAddition_Utility("Driver", 1);
			parentlogger.log(LogStatus.INFO, "New Driver Is Created With Driver Name::"+ " " + color.RMA_ChangeColor_Utility(StrDriverLastName_RMA_TC_089, 2));
			...
			((JavascriptExecutor) driver).executeScript("arguments[0].click();", RMA_Selenium_POM_Home.RMAApp_LeftHandTreeRightClick_Lnk_EntName(driver, "Driver"));
			...
			RMA_Input_Utility.RMA_SetValue_Utility(RMA_POM_Search.RMAApp_SearchDriver_Txt_DriverLastName(driver), "Driver Last Name TextBox On Search Window", StrDriverLastName_RMA_TC_089, 0);
			RMA_Navigation_Utility.RMA_WebCheckBoxSelect_Utility(RMA_POM_Search.RMAApp_Search_Chk_Soundex(driver), "uncheck", "Soundex CheckBox", " Driver Search Page", 0);
			RMA_Navigation_Utility.RMA_ObjectClick(RMA_POM_Search.RMAApp_Search_Btn_Submit(driver), "Submit Button On Driver Search Page", 0);
			RMA_GenericUsages_Utility.RMA_StaticWait(5, 0, "Wait is Added As Search Page Specific To Searched Driver Crietria Is Loaded");
			RMA_Navigation_Utility.RMA_WebPartialLinkSelect(StrDriverLastName_RMA_TC_089, "Search Page Specific To Searched Driver Criteria" , 0);
			RMA_GenericUsages_Utility.RMA_StaticWait(5, 0, "Wait is Added As Driver Page is Loaded");
			...
			RMA_GenericUsages_Utility.RMA_StaticWait(2, 0, "Wait Is Added As Switch To Frame Containing Persons Involved-->Driver Screen Controls Is Done");
			RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_Home.RMAApp_Generic_Img_Save(driver), "Save Image On Persons Involved-->Driver Page", 0);
			RMA_GenericUsages_Utility.RMA_StaticWait(5, 0, "Wait Is Added As Driver On Persons Involved Page Is Saved");
			StrDriverLastNameActual_RMA_TC_089 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			...
			driver.switchTo().parentFrame();
			RMA_Verification_Utility.RMA_UnsavedChangeVerification_Utility("Persons Involved-->Driver Page" , 0);
			RMA_Verification_Utility.RMA_TextCompare(StrDriverLastName_RMA_TC_089, StrDriverLastNameActual_RMA_TC_089, "Driver Name", 0);
			...
			StrEditedDriverLastName = RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(4, "Driver_RMA_TC_089_");
			driver.switchTo().frame(RMA_GenericUsages_Utility.RMA_FrameNavigation("pidriver"));
			RMA_GenericUsages_Utility.RMA_StaticWait(2, 0, "Wait Is Added As Switch To Frame Containing Persons Involved-->Driver Screen Controls Is Done");
			RMA_Input_Utility.RMA_SetValue_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "LastName TextBox On Persons Involved-->Driver Page", StrEditedDriverLastName, 0);
			RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_Home.RMAApp_Generic_Img_Save(driver), "Save Image On Persons Involved-->Driver Page", 0);
			RMA_GenericUsages_Utility.RMA_StaticWait(5, 0, "Wait Is Added As Persons Involved-->Driver Page Is Saved");
			RMA_NegativeVerification_Utility.RMA_ElementNotExist_Utility(RMA_Selenium_POM_Home.RMAApp_DefaultView_Err_StaticErrorText(driver), "RMA Application Static Error Message",0);
			StrEditedDriverLastNameActual_RMA_TC_089 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			driver.switchTo().parentFrame();
			RMA_Verification_Utility.RMA_UnsavedChangeVerification_Utility("Persons Involved-->Driver Page" , 0);
			RMA_Verification_Utility.RMA_TextCompare(StrEditedDriverLastName, StrEditedDriverLastNameActual_RMA_TC_089 , "Driver Last Name Value",0);
			...
			parentlogger.log(LogStatus.INFO, "Following Utility :" +" " +"RMA_GenericDelete_Utility Is Called To Delete The Driver"+ " "+ color.RMA_ChangeColor_Utility(StrEditedDriverLastNameActual_RMA_TC_089, 2) +" " +"Added As Persons Involved");
			testcall2 = true;
			RMA_Functionality_Utility.RMA_GenericDelete_Utility("Persons Involved-->Driver Page", 1);
			parentlogger.log(LogStatus.INFO, "Driver Added As Persons Involved Is Deleted Successfully::"+ " " + color.RMA_ChangeColor_Utility(StrEditedDriverLastNameActual_RMA_TC_089, 2));
