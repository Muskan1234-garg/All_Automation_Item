...
//================================================================================================
//TestCaseID     : RMA_TC_217
//Description    : TC_217_Verify Adding,Editing And Deleting Of New Driver As Person Involved on General Claim
//Depends On TC  : RMA_TC_214
//Revision       : 0.0 - RenuVerma-07-22-2016 
//=================================================================================================

public class RMA_TC_217 extends RMA_TC_BaseTest {
	...
	@Test
	public void RMA_TC_217_Test() throws Exception,Error {

		try{
			parentlogger = reports.startTest("TC_217_Adding, Editing And Deleting Of New Driver On General Claim", "Verify Adding,Editing And Deleting Of New Driver As Person Involved On General Claim");
			parentlogger.assignAuthor("Renu Verma");

			String StrDriverLastName_217;
			String StrDriverLastNameChanged_217;
			String StrDriverLastNameChanged_Actual_217;
			String StrClaimNaumberActual;
			//Local Variable Declaration Completed Here

			
			StrScreenShotTCName = "TC_217";
			testcall1 = false;	
			testcall2 = false;	
			...
			//===============================================Addition Of New Driver On Claim Created in TC_214 Is Started Here=====================================================================================================
			...
			testcall1 = true;
			StrDriverLastName_217 = RMA_Functionality_Utility.RMA_PIAddNewEntity_Utility("Driver", logval1);
			parentlogger.log(LogStatus.INFO, "New Driver Is Created Successfully With Driver Name::"+ " " + color.RMA_ChangeColor_Utility(StrDriverLastName_217, 2));
			...
			/*====================================================Addition Of New Driver On Claim Created in TC_214 Is Completed Here=======================================*/

			/*===============================================Editing Of An Existing Driver Is Started Here================================*/
			StrDriverLastNameChanged_217 = RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(4, "Driver_217_");
			RMA_Input_Utility.RMA_SetValue_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "LastName TextBox On PI Driver Page ", StrDriverLastNameChanged_217, logval);
			RMA_Functionality_Utility.RMA_GenericSave_Utility("pidriver",false,"NA","Persons Involved-->Driver Page", logval);
			StrDriverLastNameChanged_Actual_217 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrDriverLastNameChanged_217, StrDriverLastNameChanged_Actual_217 , "Driver Last Name", logval);
			...
			parentlogger.log(LogStatus.INFO, "The Functional Utility :" +" " +"RMA_GenericDelete_Utility Is Called To Delete A Driver :" +" "+ color.RMA_ChangeColor_Utility(StrDriverLastNameChanged_217, 2));
			testcall2 = true;
			RMA_Functionality_Utility.RMA_GenericDelete_Utility("PI Driver Page", logval1);
			parentlogger.log(LogStatus.INFO, "Driver Is Deleted Successfully With Name::"+ " " + color.RMA_ChangeColor_Utility(StrDriverLastNameChanged_217, 2));
