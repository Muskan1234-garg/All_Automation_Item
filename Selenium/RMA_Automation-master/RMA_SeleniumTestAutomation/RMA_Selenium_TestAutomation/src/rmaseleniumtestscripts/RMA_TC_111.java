...
//================================================================================================
//TestCaseID     : RMA_TC_111
//Description    : TC_111_Verify Adding,Editing And Deleting Of Existing Employee As Person Involved In Litigation For Non Occupational Claim
//Depends On TC  : RMA_TC_110
//Revision       : 0.0 - ImteyazAhmad-05-12-2016 
//=================================================================================================

public class RMA_TC_111 extends RMA_TC_BaseTest {
	...
	@Test
	public void RMA_TC_111_Test() throws Exception,Error {

		try{
			parentlogger = reports.startTest("TC_111_Adding, Editing And Deleting Of Existing Employee", "Verify Adding,Editing And Deleting Of Existing Employee As Person Involved In Litigation For Non Occupational Claim");
			parentlogger.assignAuthor("Imteyaz Ahmad");

			String StrEmployeeNumber_111;
			String StrEmployeeNumberActual_111;
			String StrPrimaryWindowHandle;
			String StrEmployeeLastNameActual_111;
			String StrEmployeeNameChanged;

			//Local Variable Declaration Completed Here

			
			StrScreenShotTCName = "TC_111";
			testcall1 = false;	
			testcall2 = false;	
			...
			testcall1 = true;
			StrEmployeeNumber_111 = RMA_Functionality_Utility.RMA_MaintEntityAddition_Utility("Employee", logval1);
			parentlogger.log(LogStatus.INFO, "New Employee Is Created Successfully With Employee Number::"+ " " + color.RMA_ChangeColor_Utility(StrEmployeeNumber_111, 2));
			...
			RMA_Input_Utility.RMA_SetValue_Utility(RMA_POM_Search.RMAApp_SearchEmployee_Txt_EmployeeNumber(driver), "EmployeeNumber TextBox On Employee Search Page", StrEmployeeNumber_111, logval);
			...
			RMA_Navigation_Utility.RMA_WebPartialLinkSelect(StrEmployeeNumber_111, "Search Page Specific To Searched Employee Criteria" , logval);
			...
			driver.switchTo().frame(RMA_GenericUsages_Utility.RMA_FrameNavigation("piemployee"));
			RMA_GenericUsages_Utility.RMA_StaticWait(2, logval, "Wait Is Added As Switch To PI Employee Frame Is Done");				
			StrEmployeeNumberActual_111 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_PersonInvolved.RMAApp_PIEmp_Txt_EmpNumber(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrEmployeeNumber_111, StrEmployeeNumberActual_111 , "EmployeeNumber", logval);
			...
			driver.switchTo().frame(RMA_GenericUsages_Utility.RMA_FrameNavigation("piemployee"));
			RMA_GenericUsages_Utility.RMA_StaticWait(2, logval, "Wait Is Added As Switch To PI Employee Frame Is Done");		
			StrEmployeeLastNameActual_111 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrEmployeeNameChanged, StrEmployeeLastNameActual_111 , "EmployeeLast Name", logval);
