...
//================================================================================================
//TestCaseID     : RMA_TC_099
//Description    : TC_099_Verify Adding,Editing And Deleting Of Existing Patient As Person Involved In Litigation For WC Claim
//Depends On TC  : RMA_TC_094
//Revision       : 0.0 - ImteyazAhmad-05-06-2016 
//=================================================================================================

public class RMA_TC_099 extends RMA_TC_BaseTest {
	...
	@Test
	public void RMA_TC_099_Test() throws Exception,Error {

		try{
			parentlogger = reports.startTest("TC_099_Adding, Editing And Deleting Of An Existing Patient", "Verify Adding,Editing And Deleting Of An Existing Patient As Person Involved In Litigation For Workers Comp Claim");
			parentlogger.assignAuthor("Imteyaz Ahmad");

			String StrPatientLastName_099;
			String StrPrimaryWindowHandle;
			String StrPatientLastNameActual_099;
			...
			testcall1 = true;
			StrPatientLastName_099 = RMA_Functionality_Utility.RMA_MaintEntityAddition_Utility("PatientTracking", logval1);
			parentlogger.log(LogStatus.INFO, "New Patient Is Created Successfully With Name::"+ " " + color.RMA_ChangeColor_Utility(StrPatientLastName_099, 2));
			...
			RMA_Input_Utility.RMA_SetValue_Utility(RMA_POM_Search.RMAApp_SearchPatient_Txt_PatientLastName(driver), "Patient Last Name TextBox On Standard Patient Search Page", StrPatientLastName_099, logval);
			...
			RMA_Navigation_Utility.RMA_WebPartialLinkSelect(StrPatientLastName_099, "Search Page Specific To Searched Patient Criteria" , logval);
			...
			driver.switchTo().frame(RMA_GenericUsages_Utility.RMA_FrameNavigation("pipatient"));
			RMA_GenericUsages_Utility.RMA_StaticWait(2, logval, "Wait Is Added As Switch To Frame Containing Persons Involved-->Patient Screen Controls Is Done");
			StrPatientLastNameActual_099 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrPatientLastName_099, StrPatientLastNameActual_099 , "Driver Last Name", logval);
			...
			StrEntityNameChanged = RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(4, "Patient_");
			RMA_Input_Utility.RMA_SetValue_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "LastName TextBox On PI Patient Page ", StrEntityNameChanged, logval);
			RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_Home.RMAApp_Generic_Img_Save(driver), "Save Image On PI Patient Page", logval);
			RMA_GenericUsages_Utility.RMA_StaticWait(5, logval, "Wait Is Added As PI Patient Page Is Saved");
			RMA_NegativeVerification_Utility.RMA_ElementNotExist_Utility(RMA_Selenium_POM_Home.RMAApp_DefaultView_Err_StaticErrorText(driver), "RMA Application Static Error Message",logval);
			driver.switchTo().parentFrame();
			...
			RMA_GenericUsages_Utility.RMA_StaticWait(2, logval, "Wait Is Added As Switch To Frame Containing Persons Involved-->Patient Screen Controls Is Done");
			StrPatientLastNameActual_099 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrEntityNameChanged, StrPatientLastNameActual_099 , "Patient Last Name", logval);
			...
			parentlogger.log(LogStatus.INFO, "The Functional Utility :" +" " +"RMA_GenericDelete_Utility Is Called To Delete A Patient :" +" "+ color.RMA_ChangeColor_Utility(StrEntityNameChanged, 2));
			testcall2 = true;
			RMA_Functionality_Utility.RMA_GenericDelete_Utility("PI Patient Page", logval1);
			parentlogger.log(LogStatus.INFO, "Patient Is Deleted Successfully::"+ " " + color.RMA_ChangeColor_Utility(StrEntityNameChanged, 2));
