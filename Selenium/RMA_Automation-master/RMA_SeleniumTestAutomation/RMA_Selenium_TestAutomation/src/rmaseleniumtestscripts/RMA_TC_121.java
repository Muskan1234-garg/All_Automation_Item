...
//================================================================================================
//TestCaseID     : RMA_TC_121
//Description    : TC_121_Verify Adding,Editing And Deleting Of Existing Driver As Person Involved In Litigation For Property Claim
//Depends On TC  : RMA_TC_118
//Revision       : 0.0 - ImteyazAhmad-06-21-2016 
//=================================================================================================

public class RMA_TC_121 extends RMA_TC_BaseTest {
	...
	@Test
	public void RMA_TC_121_Test() throws Exception,Error {

		try{
			parentlogger = reports.startTest("TC_121_Adding, Editing And Deleting Of An Existing Driver", "Verify Adding,Editing And Deleting Of An Existing Driver As Person Involved In Litigation For Property Claim");
			parentlogger.assignAuthor("Imteyaz Ahmad");

			String StrDriverLastName_121;
			String StrPrimaryWindowHandle;
			String StrDriverLastNameActual_121;
			String StrDriverLastNameChanged;

			//Local Variable Declaration Completed Here

			
			StrScreenShotTCName = "TC_121";
			testcall1 = false;	
			testcall2 = false;	
			...
			testcall1 = true;
			StrDriverLastName_121 = RMA_Functionality_Utility.RMA_MaintEntityAddition_Utility("Driver", logval1);
			parentlogger.log(LogStatus.INFO, "New Driver Is Created Successfully With Name::"+ " " + color.RMA_ChangeColor_Utility(StrDriverLastName_121, 2));
			...
			RMA_Input_Utility.RMA_SetValue_Utility(RMA_POM_Search.RMAApp_SearchDriver_Txt_DriverLastName(driver), "Driver Last Name TextBox On Standard Driver Search Page", StrDriverLastName_121, logval);
			...
			RMA_Navigation_Utility.RMA_WebPartialLinkSelect(StrDriverLastName_121, "Search Page Specific To Searched Driver Criteria" , logval);
			...
			StrDriverLastNameActual_121 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrDriverLastName_121, StrDriverLastNameActual_121 , "Driver Last Name", logval);
			...
			RMA_GenericUsages_Utility.RMA_StaticWait(2, logval, "Wait Is Added As Switch To PI Driver Frame Is Done");				
			StrDriverLastNameActual_121 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrDriverLastNameChanged, StrDriverLastNameActual_121 , "Driver Last Name", logval);
