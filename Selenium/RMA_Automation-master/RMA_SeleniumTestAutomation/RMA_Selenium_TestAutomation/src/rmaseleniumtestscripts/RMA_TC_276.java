...
//================================================================================================
//TestCaseID     : RMA_TC_276
//Description    : TC_276_Verify To Create A General Claim And DownLoad A Policy 
//Depends On TC  : None
//Revision       : 0.0 - RenuVerma-08-26-2016 
//=================================================================================================

public class RMA_TC_276 extends RMA_TC_BaseTest {
	...
	public static String StrClaimNumber_276;
	public static String StrPolicyName_276;
	public static String RMAApp_GeneralClaim_Txt_PolicyNo;
	
	@Test
	public void RMA_TC_276_Test() throws Exception,Error {

		try{
			parentlogger = reports.startTest("TC_276_Verify To Create A General Claim And DownLoad A Policy ", "Verify  To Create A General Claim And DownLoad A Policy");
			...
			String StrPolicyNo_276;		
		
			//Local Variable Declaration Completed Here
			
			StrScreenShotTCName = "TC_276";
			testcall1 = false;
			...
			RMAApp_GeneralClaim_Txt_ClaimType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_276", 1, 0); // Claim Type Is Fetched From DataSheet RMA_TC_276
			RMAApp_GeneralClaim_Txt_Department = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_276", 1, 5); // Department Is Fetched From DataSheet RMA_TC_276
			RMAApp_GeneralClaim_Txt_DateOfEvent = ExcelData.RMA_ExcelDateDataRead_Utility("RMA_TC_276", 1, 1);//DateOfEvent Is Fetched From DataSheet RMA_TC_276
			RMAApp_GeneralClaim_Txt_TimeOfEvent = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_TC_276", 1, 2);//TimeOfEvent Is Fetched From DataSheet RMA_TC_276
			RMAApp_GeneralClaim_Txt_DateOfClaim = ExcelData.RMA_ExcelDateDataRead_Utility("RMA_TC_276", 1, 3);//DateOfClaim Is Fetched From DataSheet RMA_TC_276
			RMAApp_GeneralClaim_Txt_TimeOfClaim = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_TC_276", 1, 4);//TimeOfClaim Is Fetched From DataSheet RMA_TC_276
			RMAApp_GeneralClaim_Txt_PolicyLOB = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_276", 1, 6); // PolicyLOB  Is Fetched From DataSheet RMA_TC_276
			RMAApp_GeneralClaim_Txt_PolicySystemName = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_276", 1, 7); // PolicySystemName Is Fetched From DataSheet RMA_TC_276
			RMAApp_GeneralClaim_Txt_PolicyNo = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_276", 1, 8); // PolicyNo Is Fetched From DataSheet RMA_TC_276
			...
			StrPolicyName_276=RMA_Functionality_Utility.RMA_PolicyDownload_Utility(RMAApp_GeneralClaim_Txt_PolicySystemName,RMAApp_GeneralClaim_Txt_DateOfEvent,RMAApp_GeneralClaim_Txt_PolicyLOB , RMAApp_GeneralClaim_Txt_PolicyNo, "Status:Verified",StrClaimNumber_276 ,"Yes","Download Policy",logval1);
			String StrPolicyName[]=StrPolicyName_276.split(" "); // Split The Policy No from the Policy Name
			StrPolicyNo_276=StrPolicyName[1];// Filter Box Value// Fetch the Policy No Which Is On The First Index(e.g.APV 0381852 03)
			loggerval1 = logger.toString();
			parentlogger.appendChild(logger);
			parentlogger.log(LogStatus.INFO, "A General Claim With Claim Number:: "+ color.RMA_ChangeColor_Utility(StrClaimNumber_276, 3)+ " Is Successfully Download Policy With Policy Number:: "+color.RMA_ChangeColor_Utility(StrPolicyNo_276, 2));
			...
			driver.switchTo().parentFrame();
			RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_Home.RMAApp_LeftHandNavTree_Img_ExpandCollapse(driver, "Policy ("+StrPolicyName_276), "Expand Image For The Created Policy On Left Hand Navigation Tree",logval);
			RMA_GenericUsages_Utility.RMA_StaticWait(3, logval, "Wait Is Added As Expand Image Corresponding To Policy "+" "+StrPolicyName_276 +" Is Clicked");
			RMA_Verification_Utility.RMA_ElementExist_Utility(RMA_Selenium_POM_Home.RMAApp_LeftHandNavTree_Lnk_Policy_PI(driver, StrPolicyName_276), "Person Involved Link On Left Hand Navigation Tree Of General Claim -->Policy", logval);
		...
		}catch(Exception|Error e)
		{
			...
			{
				logger.log(LogStatus.FAIL, "Following Error Occurred  ::" + " "+  color.RMA_ChangeColor_Utility(FinalErrorMessage,1)+ " " + "While Executing Functional Utility" +" "+ "RMA_GeneralClaimCreation_ACON_OFF" + " " +  "And Hence The Test Case Is A Fail");
				parentlogger.appendChild(logger);
			}
