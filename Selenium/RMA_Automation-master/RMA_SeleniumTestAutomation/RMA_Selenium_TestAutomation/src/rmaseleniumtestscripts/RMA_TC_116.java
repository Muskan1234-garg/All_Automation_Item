...
//================================================================================================
//TestCaseID     : RMA_TC_116
//Description    : TC_115_Verify Adding,Editing And Deleting Of Existing Physician As Person Involved In Litigation For Non Occupational Claim
//Depends On TC  : RMA_TC_110
//Revision       : 0.0 - ImteyazAhmad-06-14-2016 
//=================================================================================================

public class RMA_TC_116 extends RMA_TC_BaseTest {
	...
	@Test
	public void RMA_TC_116_Test() throws Exception,Error {

		try{
			parentlogger = reports.startTest("TC_116_Adding, Editing And Deleting Of An Existing Patient", "Verify Adding,Editing And Deleting Of An Existing Patient As Person Involved In Litigation For Non Occupational Claim");
			parentlogger.assignAuthor("Imteyaz Ahmad");

			String StrPhysicianLastName_116;
			String StrPrimaryWindowHandle;
			String StrPhysicianLastNameActual_116;
			String StrPhysicianLastNameChanged;

			//Local Variable Declaration Completed Here


			StrScreenShotTCName = "TC_116";
			testcall1 = false;	
			testcall2 = false;	
			...
			testcall1 = true;
			StrPhysicianLastName_116 = RMA_Functionality_Utility.RMA_MaintEntityAddition_Utility("Physician", logval1);
			parentlogger.log(LogStatus.INFO, "New Physician Is Created Successfully With Name::"+ " " + color.RMA_ChangeColor_Utility(StrPhysicianLastName_116, 2));
			...
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_Home.RMAApp_LeftHandTreeRightClick_Lnk_EntName(driver, "Physician"), "Physician Under Add Existing On Person Involved Submenu", logval);
			...
			RMA_Input_Utility.RMA_SetValue_Utility(RMA_POM_Search.RMAApp_SearchPhysician_Txt_LastName(driver), "Physician Last Name TextBox On Standard Physician Search Page", StrPhysicianLastName_116, logval);
			...
			RMA_Navigation_Utility.RMA_WebPartialLinkSelect(StrPhysicianLastName_116, "Search Page Specific To Searched Physician Criteria" , logval);
			...
			driver.switchTo().frame(RMA_GenericUsages_Utility.RMA_FrameNavigation("piphysician"));
			RMA_GenericUsages_Utility.RMA_StaticWait(2, logval, "Wait Is Added As Switch To Frame Containing Persons Involved-->Physician Screen Controls Is Done");
			StrPhysicianLastNameActual_116 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrPhysicianLastName_116, StrPhysicianLastNameActual_116 , "Physician Last Name", logval);
			...
			RMA_GenericUsages_Utility.RMA_StaticWait(2, logval, "Wait Is Added As Switch To Frame Containing Persons Involved-->Physician Screen Controls Is Done");
			StrPhysicianLastNameActual_116 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrPhysicianLastNameChanged, StrPhysicianLastNameActual_116 , "Physician Last Name", logval);
