...
//=============================================================================================================================
//TestCaseID     : RMA_TC_337
//Description    : Creation, Edit And Deletion Of Enhanced Notes For A Defendant Associated With A Claim
//Depends On TC  : RMA_TC_335
//Revision       : 0.0 - KumudNaithani-02-28-2017
//==============================================================================================================================

public class RMA_TC_337 extends RMA_TC_BaseTest {
...
@Test	
public void RMA_TC_337_Test() throws Exception, Error
{   
	try {	 	 
	 ...
	 parentlogger = reports.startTest("RMA_TC_337_Creation, Edit And Deletion Of Enhanced Notes For A Defendant", "Creation, Edit And Deletion Of Enhanced Notes For A Defendant Associated With A Claim");
	 ...
	 StrScreenShotTCName = "RMA_TC_337";
	 Edit = true;
	 //Variable Initialization Completed
     
	//===========================================================New Defendant Creation Associated With Claim Is Started Here=====================================================================================================================================================================================================================================================================================================================================
	 parentlogger.log(LogStatus.INFO, "The Functional Utility :" +" " +RMA_GenericUsages_Utility.RMA_LoggerHyperlink("ClaimEntity", "Claim Entity Addition",0)+ " "+ "Is Called To Add Defendant To Claim" + " "+color.RMA_ChangeColor_Utility(StrClaimNumber_335, 2));
	 testcall1 = true;
	 StrDefendantLastname = RMA_Functionality_Utility.RMA_ClaimEntityAddition_Utility("Defendant", "Defendant (0)", StrClaimNumber_335, "csc", "Not Required", "Not Required", "Not Required", "Not Required", "Not Required", "Not Required", logval1);
	 parentlogger.log(LogStatus.INFO, "New Defendant Is Added Successfully With Last Name::"+ " " + color.RMA_ChangeColor_Utility(StrDefendantLastname, 2) + " " +"To Claim Number::" + color.RMA_ChangeColor_Utility(StrClaimNumber_335, 2));
	 loggerval1 = logger.toString();
	 parentlogger.appendChild(logger);
	 parentlogger.log(LogStatus.INFO, parentlogger.addScreenCapture(RMA_ScreenCapture_Utility.RMA_ScreenShotCapture_Utility(driver, "Successful Defendant Creation", StrScreenShotTCName)));
	//=========================================================== New Defendant Creation Associated With Claim Is Completed Here=======================================================================================================================================================================================================================================================================================================================================
	
	//===========================================================Steps To Create And Edit Progress Notes Started Here==================================================================================================================================================================================================================================================================================================================================================
    StrPrimaryWindowHandle = driver.getWindowHandle();
	RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_Home.RMAApp_Generic_Img_EnhancedNotes(driver), "Enhanced Notes Image For Defendant"+ " " + color.RMA_ChangeColor_Utility(StrDefendantLastname, 2) + " " +"Associated With Claim:"+" "+color.RMA_ChangeColor_Utility(StrClaimNumber_335, 2), logval); // Claim ID Is Same For All Line Of Business
	...
	RMA_GenericUsages_Utility.RMA_DynamicFrameSwitching(StrDefendantLastname);
	//===========================================================Steps To Delete Progress Notes Completed Here============================================================================================================================================================================================================================================================
		 ...
		 {
		 logger.log(LogStatus.FAIL, "Following Error Occurred  ::" + " "+  color.RMA_ChangeColor_Utility(FinalErrorMessage,1)+ " " + "While Executing Function Utility" +" "+ "RMA_ClaimEntityAddition_Utility" + " For New Defendant Creation Associated With A Claim And Hence The Test Case Is A Fail");
		 parentlogger.appendChild(logger);
		 }
