...
//================================================================================================
//TestCaseID     : RMA_TC_138
//Description    : TC_138_Verify Adding,Editing And Deleting Of New Other Person As Person Involved In Litigation For Workers Comp Claim
//Depends On TC  : RMA_TC_134
//Revision       : 0.0 - ImteyazAhmad-06-28-2016 
//=================================================================================================

public class RMA_TC_138 extends RMA_TC_BaseTest {
	...
	@Test
	public void RMA_TC_138_Test() throws Exception,Error {

		try{
			parentlogger = reports.startTest("TC_138_Adding, Editing And Deleting Of New Other Person", "Verify Adding,Editing And Deleting Of New Other Person As Person Involved In Litigation For Workers Comp Claim");
			parentlogger.assignAuthor("Imteyaz Ahmad");

			String StrOtherPersonLastName_138;
			String StrOtherPersonLastNameActual_138;
			String StrOtherPersonLastNameChanged;

			StrScreenShotTCName = "TC_138";
			testcall1 = false;	
			testcall2 = false;	
			...
			testcall1 = true;
			StrOtherPersonLastName_138 = RMA_Functionality_Utility.RMA_PIAddNewEntity_Utility("Other Person", logval1);
			parentlogger.log(LogStatus.INFO, "New Other Person Is Created Successfully With Other Person Last Name::"+ " " + color.RMA_ChangeColor_Utility(StrOtherPersonLastName_138, 2));
			loggerval1 = logger.toString();
			parentlogger.appendChild(logger);
			//===============================================Steps To Create A New Other Person Completed============================================================================================================================================
			
			/*===============================================Editing Of New Other Person Is Started Here=======================================================================*/
			StrOtherPersonLastNameChanged = RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(4, "Other Person_TC_138_");
			...
			StrOtherPersonLastNameActual_138 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Maintenance.RMAApp_MaintPeople_Txt_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrOtherPersonLastNameChanged, StrOtherPersonLastNameActual_138 , "Other Person Last Name", logval);
