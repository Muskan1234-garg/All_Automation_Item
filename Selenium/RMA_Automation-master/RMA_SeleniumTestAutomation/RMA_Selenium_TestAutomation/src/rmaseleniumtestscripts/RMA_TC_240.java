...
//================================================================================================
//TestCaseID     : RMA_TC_240
//Description    : TC_240_Verify Adding,Editing And Deleting Of New Medical Staff As Person Involved For Vehicle Accident Claim
//Depends On TC  : RMA_TC_238
//Revision       : 0.0 - RenuVerma-07-26-2016 
//=================================================================================================

public class RMA_TC_240 extends RMA_TC_BaseTest {
	...
	@Test
	public void RMA_TC_240_Test() throws Exception,Error {

		try{
			parentlogger = reports.startTest("TC_240_Adding,Editing And Deleting Of New Medical Staff On Vehicle Accident Claim", "Verify Adding,Editing And Deleting Of New Medical Staff As Person Involved For Vehicle Accident Claim");
			parentlogger.assignAuthor("Renu Verma");

			String StrMedicalStaff_240;
			String StrMedicalStaffLastNameChanged_240;
			String StrMedicalLastNameChangedActual_240;			
			String StrClaimNaumberActual;
			//Local Variable Declaration Completed Here

			StrScreenShotTCName = "TC_240";
			testcall1 = false;	
			testcall2 = false;	
			...
			//===============================================Addition Of New Medical Staff On Claim Created in TC_238 Is Started Here=====================================================================================================
			...
			testcall1 = true;
			StrMedicalStaff_240 = RMA_Functionality_Utility.RMA_PIAddNewEntity_Utility("Medical Staff", logval1);
			parentlogger.log(LogStatus.INFO, "New Medical Staff Is Created Successfully With Medical Staff Name::"+ " " + color.RMA_ChangeColor_Utility(StrMedicalStaff_240, 2));
			...
			/*====================================================Addition Of New Medical Staff On Claim Created in TC_238 Is Completed Here=======================================*/

			/*===============================================Editing Of An Existing Medical Staff Is Started Here================================*/
			StrMedicalStaffLastNameChanged_240 = RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(4, "MedicalStaff_240_");
			RMA_Input_Utility.RMA_SetValue_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "LastName TextBox On PI Medical Staff Page ", StrMedicalStaffLastNameChanged_240, logval);
			RMA_Functionality_Utility.RMA_GenericSave_Utility("pimedstaff", false,"NA","Persons Involved-->MedicalStaff Page", logval);
			StrMedicalLastNameChangedActual_240 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrMedicalStaffLastNameChanged_240, StrMedicalLastNameChangedActual_240 , "Medical Staff Last Name", logval);
			...
			parentlogger.log(LogStatus.INFO, "The Functional Utility :" +" " +"RMA_GenericDelete_Utility Is Called To Delete A Medical Staff : " +" " + color.RMA_ChangeColor_Utility(StrMedicalStaffLastNameChanged_240, 2));
			testcall2 = true;
			RMA_Functionality_Utility.RMA_GenericDelete_Utility("PI Medical Staff Page", logval1);
			parentlogger.log(LogStatus.INFO, "Medical Staff Is Deleted Successfully::"+ " " + color.RMA_ChangeColor_Utility(StrMedicalStaffLastNameChanged_240, 2));
