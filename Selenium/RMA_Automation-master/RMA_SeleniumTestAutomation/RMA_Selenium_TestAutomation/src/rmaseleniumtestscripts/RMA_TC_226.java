...
//================================================================================================
//TestCaseID     : RMA_TC_226
//Description    : TC_226_Verify Adding,Editing And Deleting Of New Other Person As Person Involved on Workers Comp Claim
//Depends On TC  : RMA_TC_222
//Revision       : 0.0 -ImteyazAhmad-07-25-2016 
//=================================================================================================

public class RMA_TC_226 extends RMA_TC_BaseTest {
	...
	@Test
	public void RMA_TC_226_Test() throws Exception,Error {

		try{
			parentlogger = reports.startTest("TC_226_Adding, Editing And Deleting Of An New Other Person", "Verify Adding,Editing And Deleting Of An New Other Person As Person Involved on Workers Comp Claim");
			parentlogger.assignAuthor("Imteyaz Ahmad");

			String StrOtherPersonLastName_226;
			String OtherPersonLastNameChanged_226;
			String OtherPersonLastNameChanged_Actual_226;
			String StrClaimNaumberActual;
			//Local Variable Declaration Completed Here

			StrScreenShotTCName = "TC_226";
			testcall1 = false;	
			testcall2 = false;	
			...
			testcall1 = true;
			StrOtherPersonLastName_226 = RMA_Functionality_Utility.RMA_PIAddNewEntity_Utility("Other Person", logval1);
			parentlogger.log(LogStatus.INFO, "New Other Person Is Created Successfully With Other Person Name::"+ " " + color.RMA_ChangeColor_Utility(StrOtherPersonLastName_226, 2));
			...
			OtherPersonLastNameChanged_226 = RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(4, "OtherPerson_TC_226");
			RMA_Input_Utility.RMA_SetValue_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "LastName TextBox On PI Other Person Page ", OtherPersonLastNameChanged_226, logval);
			RMA_Functionality_Utility.RMA_GenericSave_Utility("piother",false,"NA", "Persons Involved-->Other Person Page", logval);
			OtherPersonLastNameChanged_Actual_226 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(OtherPersonLastNameChanged_226, OtherPersonLastNameChanged_Actual_226 , "Other Person Last Name", logval);
			...
			parentlogger.log(LogStatus.INFO, "The Functional Utility :" +" " +"RMA_GenericDelete_Utility Is Called To Delete A Other Person :" +" "+ color.RMA_ChangeColor_Utility(OtherPersonLastNameChanged_226, 2));
			testcall2 = true;
			RMA_Functionality_Utility.RMA_GenericDelete_Utility("PI Other Person Page", logval1);
			parentlogger.log(LogStatus.INFO, "Other Person Is Deleted Successfully::"+ " " + color.RMA_ChangeColor_Utility(OtherPersonLastNameChanged_226, 2));
