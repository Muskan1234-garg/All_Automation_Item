...
//Claim History Works Correctly On Defendant Screen Is Validated
{
	try {
		...
		String StrDefendant_RMA_Smoke_TC_018;
		String StrClaimType;
		...
		parentlogger = reports.startTest("RMA_Smoke_TC_018_Correct Working Of Claim History", "Claim History Works Correctly On Defendant Screen Is Validated.");
		...
		testcall1 = true;
		StrDefendant_RMA_Smoke_TC_018 = RMA_Functionality_Utility.RMA_ClaimEntityAddition_Utility("Defendant", "Defendant (0)", StrClaimNumber_002, "Not Required", "Not Required", "Not Required", "Not Required", "Not Required", "Not Required", "Not Required", logval1);
		parentlogger.log(LogStatus.INFO, "New Defendant Is Created Successfully With Last Name::"+ " " + color.RMA_ChangeColor_Utility(StrDefendant_RMA_Smoke_TC_018, 2));
		loggerval1 = logger.toString();
		parentlogger.appendChild(logger);
		//===========================================================New Defendant Creation Is Completed Here================================================================================================================================================================================================================================================================================
		
		//===========================================================Defendant History Verification Is Started Here==============================================================================================================================================================================================================================================================================
		RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_Defendant.RMAApp_Defendant_Btn_DefendantHistory(driver), "Defendant History Button On Defendant Page",logval);
		StrPrimaryWindowHandle = driver.getWindowHandle();
		RMA_GenericUsages_Utility.RMA_WindowSwitching_Utility();
		RMA_Verification_Utility.RMA_TableVerifyText_Utility(RMA_Selenium_POM_Defendant.RMAApp_Defendant_Tbl_DefendantHistory(driver), StrClaimNumber_002, 4,StrClaimStatus , 3, StrClaimType, "Claimant Involvement History Table On Defendant Involvement History Page", logval);
		RMA_Verification_Utility.RMA_TableSingleTextVerify_Utility(RMA_Selenium_POM_Defendant.RMAApp_Defendant_Tbl_DefendantHistory(driver), StrClaimNumber_002, 1, DateOfClaim, "Claimant Involvement History Table On Defendant Involvement History Page", logval);
		driver.close();
		...
		parentlogger.log(LogStatus.INFO, "The Functional Utility :" +RMA_GenericUsages_Utility.RMA_LoggerHyperlink("DeleteLink", "RMA_GenericDelete_Utility",0)+" Is Called To Delete An Defendant : " +" "+ color.RMA_ChangeColor_Utility(StrDefendant_RMA_Smoke_TC_018, 2));
		testcall2 = true;
		RMA_Functionality_Utility.RMA_GenericDelete_Utility("Defendant Page", logval1);
		parentlogger.log(LogStatus.INFO, "Defendant Is Deleted Successfully ::"+ " " + color.RMA_ChangeColor_Utility(StrDefendant_RMA_Smoke_TC_018, 2));
