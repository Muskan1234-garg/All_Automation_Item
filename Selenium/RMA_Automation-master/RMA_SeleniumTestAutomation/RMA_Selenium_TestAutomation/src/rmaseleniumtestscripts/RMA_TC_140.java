...
//================================================================================================
//TestCaseID     : RMA_TC_140
//Description    : TC_140_Verify Adding,Editing And Deleting Of New Physician As Person Involved In Litigation For Workers Comp Claim
//Depends On TC  : RMA_TC_134
//Revision       : 0.0 - ImteyazAhmad-06-29-2016 
//=================================================================================================

public class RMA_TC_140 extends RMA_TC_BaseTest {
	...
	@Test
	public void RMA_TC_140_Test() throws Exception,Error {

		try{
			parentlogger = reports.startTest("TC_140_Adding, Editing And Deleting Of New Physician", "Verify Adding,Editing And Deleting Of New Physician As Person Involved In Litigation For Workers Comp Claim");
			parentlogger.assignAuthor("Imteyaz Ahmad");

			String StrPhysicianLastName_140;
			String StrPhysicianLastNameActual_140;
			String StrPhysicianLastNameChanged;

			StrScreenShotTCName = "TC_140";
			testcall1 = false;	
			testcall2 = false;	
			...
			testcall1 = true;
			StrPhysicianLastName_140 = RMA_Functionality_Utility.RMA_PIAddNewEntity_Utility("Physician", logval1);
			parentlogger.log(LogStatus.INFO, "New Physician Is Created Successfully With Physician Last Name::"+ " " + color.RMA_ChangeColor_Utility(StrPhysicianLastName_140, 2));
			loggerval1 = logger.toString();
			parentlogger.appendChild(logger);
			//===============================================Steps To Create A New Physician Completed============================================================================================================================================
			
			/*===============================================Editing Of New Physician Is Started Here=======================================================================*/
			StrPhysicianLastNameChanged = RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(4, "Physician_TC_140_");
			...
			StrPhysicianLastNameActual_140 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Maintenance.RMAApp_MaintPhysician_Txt_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrPhysicianLastNameChanged, StrPhysicianLastNameActual_140 , "Physician Last Name", logval);
