...
//================================================================================================
//TestCaseID     : RMA_TC_271
//Description    : TC_271_Verify Adding,Editing And Deleting Of Existing Driver As Person Involved For Workers' Comp Claim At Policy level
//Depends On TC  : RMA_TC_268
//Revision       : 0.0 - RenuVerma-09-07-2016
//=================================================================================================

public class RMA_TC_271 extends RMA_TC_BaseTest {
	...
	@Test
	public void RMA_TC_271_Test() throws Exception,Error {

		try{
			parentlogger = reports.startTest("TC_271_Verify Adding,Editing And Deleting Of Existing Driver As Person Involved For Workers' Comp Claim At Policy level", "Verify Adding,Editing And Deleting Of Existing Driver As Person Involved For Workers' Comp Claim At Policy level");
			parentlogger.assignAuthor("Renu Verma");

			String StrDriverLastName_271;
			String StrPrimaryWindowHandle;
			String StrDriverLastNameActual_271;
			String StrDriverLastNameChanged_271;
			String StrDriverLastNameChanged_Actual_271;
			String StrClaimNumberActual;
			//Local Variable Declaration Completed Here
			
			StrScreenShotTCName = "TC_271";
			testcall1 = false;	
			testcall2 = false;	
			...
			testcall1 = true;
			StrDriverLastName_271 = RMA_Functionality_Utility.RMA_MaintEntityAddition_Utility("Driver", logval1);
			parentlogger.log(LogStatus.INFO, "New Driver Is Created Successfully With Name::"+ " " + color.RMA_ChangeColor_Utility(StrDriverLastName_271, 2));
			...
			//===============================================Addition Of Driver Employee On Claim Created in TC_268 Is Started Here=====================================================================================================
			...
			RMA_Functionality_Utility.RMA_StandardSearch_Window(RMA_POM_Search.RMAApp_SearchDriver_Txt_DriverLastName(driver), " Standard Entity Search page","Last Name Text Box",StrDriverLastName_271,StrDriverLastName_271, "pidriver",StrPrimaryWindowHandle, logval);
			RMA_Functionality_Utility.RMA_GenericSave_Utility("pidriver",false,"NA","Persons Involved-->Driver Page", logval);
			StrDriverLastNameActual_271 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrDriverLastName_271, StrDriverLastNameActual_271 , "Driver Last Name", logval);
			...
			/*====================================================Addition Of Existing Driver On Claim Created in TC_268 Is Completed Here=======================================*/

			/*===============================================Editing Of An Existing Driver Is Started Here================================*/
			StrDriverLastNameChanged_271 = RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(4, "Driver_271_");
			RMA_Input_Utility.RMA_SetValue_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "LastName TextBox On PI Driver Page ", StrDriverLastNameChanged_271, logval);
			RMA_Functionality_Utility.RMA_GenericSave_Utility("pidriver",false,"NA","Persons Involved-->Driver Page", logval);
			StrDriverLastNameChanged_Actual_271 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrDriverLastNameChanged_271, StrDriverLastNameChanged_Actual_271 , "Driver Last Name", logval);
			...
			parentlogger.log(LogStatus.INFO, "The Functional Utility :" +" " +"RMA_GenericDelete_Utility Is Called To Delete A Driver :" +" "+ color.RMA_ChangeColor_Utility(StrDriverLastNameChanged_271, 2));
			testcall2 = true;
			RMA_Functionality_Utility.RMA_GenericDelete_Utility("PI Driver Page", logval1);
			parentlogger.log(LogStatus.INFO, "Driver Is Deleted Successfully With Name::"+ " " + color.RMA_ChangeColor_Utility(StrDriverLastNameChanged_271, 2));
