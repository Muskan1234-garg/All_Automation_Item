...
//================================================================================================
//TestCaseID     : RMA_TC_150
//Description    : TC_150_Verify That Litigation Can Be Added To A Vehicle Accident Claim
//Depends On TC  : None
//Revision       : 0.0 - KumudNaithani-07-04-2016 
//=================================================================================================

public class RMA_TC_150 extends rmaseleniumtestscripts.RMA_TC_BaseTest {
	...
	public static String StrClaimNumber_RMA_TC_150;
	public static String StrLitigation_RMA_TC_150;
	
	@Test 
	public void RMA_TC_150_Test () throws Exception, Error
	{
		parentlogger = reports.startTest("TC_150_Litigation Addition To Vehicle Accident Claim", "Verify That Litigation Can Be Added To A Vehicle Accident Claim");
		...
		try {
			...
			RMAApp_VehAccClaim_Txt_ClaimType   =   ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_150", 1, 0); // Claim Type Is Fetched From DataSheet RMA_TC_150
			RMAApp_VehAccClaim_Txt_Department  =  ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_150", 1, 1); // Department Is Fetched From DataSheet RMA_TC_150
			RMAApp_VehAccClaim_Txt_DateOfEvent = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_TC_150", 1, 2);//DateOfEvent Is Fetched From DataSheet RMA_TC_150
			RMAApp_VehAccClaim_Txt_TimeOfEvent = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_TC_150", 1, 3);//TimeOfEvent Is Fetched From DataSheet RMA_TC_150
			RMAApp_VehAccClaim_Txt_DateOfClaim = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_TC_150", 1, 4);//DateOfClaim Is Fetched From DataSheet RMA_TC_150
			RMAApp_VehAccClaim_Txt_TimeOfClaim = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_TC_150", 1, 5);//TimeOfClaim Is Fetched From DataSheet RMA_TC_150
			...
			testcall1 = true;
			StrClaimNumber_RMA_TC_150 = RMA_Functionality_Utility.RMA_VehicleAccClaimCreation(RMAApp_VehAccClaim_Txt_ClaimType, RMAApp_VehAccClaim_Txt_Department, RMAApp_VehAccClaim_Txt_DateOfEvent, RMAApp_VehAccClaim_Txt_TimeOfEvent, RMAApp_VehAccClaim_Txt_DateOfClaim, RMAApp_VehAccClaim_Txt_TimeOfClaim, logval1); //Claim Number Is Fetched And Stored In Variable StrClaimNumber_RMA_TC_150
			parentlogger.log(LogStatus.INFO, "New Vehicle Accident Claim Is Created With Claim Number::"+ " " + color.RMA_ChangeColor_Utility(StrClaimNumber_RMA_TC_150, 2));
			...
			StrLitigation_RMA_TC_150 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Litigation.RMAApp_Litigation_Txt_DocketNumber(driver), "value");
			...
			RMA_Verification_Utility.RMA_TextCompare(DocketNumber, StrLitigation_RMA_TC_150 , "Litigation Docket Number Value", logval);
