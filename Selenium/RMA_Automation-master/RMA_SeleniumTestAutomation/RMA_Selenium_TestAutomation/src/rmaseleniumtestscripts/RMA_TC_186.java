...
//================================================================================================
//TestCaseID     : RMA_TC_186
//Description    : TC_186_Verify Adding,Editing And Deleting Of Existing Other Person As Person Involved  For General Claim
//Depends On TC  : RMA_TC_182
//Revision       : 0.0 - KumudNaithani-07-15-2016 
//=================================================================================================

public class RMA_TC_186 extends RMA_TC_BaseTest {
	...
	@Test
	public void RMA_TC_186_Test() throws Exception,Error {

		try{
			parentlogger = reports.startTest("TC_186_Adding, Editing And Deleting Of An Existing Other Person", "Verify Adding,Editing And Deleting Of An Existing Other Person As Person Involved For General Claim");
			parentlogger.assignAuthor("Kumud Naithani");

			String StrOtherPersonLastName_186;
			String StrPrimaryWindowHandle;
			String StrOtherPersonLastNameActual_186;
			String StrOtherPersonNameChanged;
			String StrClaimNaumberActual;

			//Local Variable Declaration Completed Here

			StrScreenShotTCName = "TC_186";
			testcall1 = false;	
			testcall2 = false;	
			...
			testcall1 = true;
			StrOtherPersonLastName_186 = RMA_Functionality_Utility.RMA_MaintEntityAddition_Utility("OtherPeople", logval1);
			parentlogger.log(LogStatus.INFO, "Other Person Is Created Successfully With Name::"+ " " + color.RMA_ChangeColor_Utility(StrOtherPersonLastName_186, 2));
			...
			RMA_Functionality_Utility.RMA_StandardSearch_Window(RMA_POM_Search.RMAApp_SearchEntity_Txt_LastName(driver), "Standard Entity Search Page", "Last Name TextBox", StrOtherPersonLastName_186, "Other People", "piother", StrPrimaryWindowHandle, logval);
			...
			StrOtherPersonLastNameActual_186 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrOtherPersonLastName_186, StrOtherPersonLastNameActual_186 , "Other Person Last Name", logval);
			...
			RMA_GenericUsages_Utility.RMA_DynamicFrameSwitching("piother");	
			StrOtherPersonLastNameActual_186 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrOtherPersonNameChanged, StrOtherPersonLastNameActual_186 , "Other Person Last Name", logval);
