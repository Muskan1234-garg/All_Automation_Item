...
//Description    : TC_019 Diary Is Sent To Current Adjuster Of Claim
//Depends On TC  : TC_011, TC_012, TC_013, TC_016, TC_017, TC_018
...
//TC_019 Diary/Email Is Sent To Current Adjuster Of Claim
{
	try {
		parentlogger = reports.startTest("TC_019_Diary To Current Claim Adjustor", "Verify Diary Is Sent To Current Adjuster Of Claim");
		String StrAccept;
		...
		RMAApp_Login_Txt_UserName = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_019", 1, 0); //UserName Fetched From DataSheet RMA_TC_019
		RMAApp_Login_Txt_Password = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_019", 1, 1); //Password Fetched From DataSheet RMA_TC_019
		...
		//===============================================Existence Of Payment (Created In TC_013) Approval Diary In Diaries Page Validation Is Started======================================================================================================================================================================================================================================================================================================================
		...
		//================================================Existence Of Payment (Created In TC_013) Approval Diary In Diaries Page Validation Is Completed=======================================================================================================================================================================================================================================================================================================================
		...
		RMA_Functionality_Utility.RMA_StandardSearch_Screen(RMA_POM_Search.RMAApp_SearchFunds_Txt_ControlNumber(driver), "Search_Funds", "Check Control Number Text Box", RMA_TC_013.StrControlNumber_RMA_TC_013, RMA_TC_013.StrControlNumber_RMA_TC_013, "Transaction", "num", 2, logval);
