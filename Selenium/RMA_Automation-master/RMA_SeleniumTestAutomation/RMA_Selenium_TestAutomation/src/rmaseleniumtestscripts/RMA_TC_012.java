...
//================================================================================================
//TestCaseID     : RMA_TC_012
//Description    : Chain Of Current Adjuster With Notify Immediate User Functionality Setting In Payment Parameter Set-Up Is Validated
//Depends On TC  : None
...
//=================================================================================================
public class RMA_TC_012 extends rmaseleniumtestscripts.RMA_TC_BaseTest {
...
@Test 
public void RMA_TC_012_Test () throws Exception, Error 
//Verify That Chain Of Current Adjuster With Notify Immediate User Functionality Can Be  Chosen In Payment Parameter Set-Up
{
	try {
		logger = reports.startTest("TC_012_CurrAdjuster Chain With Notify Immediate User Setting", "Chain Of Current Adjuster With Notify Immediate User Functionality Setting In Payment Parameter Set-Up Is Validated");
