...
//================================================================================================
//TestCaseID     : RMA_TC_193
//Description    : TC_193_Verify Adding,Editing And Deleting Of Existing Driver As Person Involved For Non Occupational Claim
//Depends On TC  : RMA_TC_190
//Revision       : 0.0 - ImteyazAhmad-07-19-2016 
//=================================================================================================

public class RMA_TC_193 extends RMA_TC_BaseTest {
	...
	@Test
	public void RMA_TC_193_Test() throws Exception,Error {

		try{
			parentlogger = reports.startTest("TC_193_Adding, Editing And Deleting Of An Existing Driver", "Verify Adding,Editing And Deleting Of An Existing Driver As Person Involved For Non Occupational Claim");
			parentlogger.assignAuthor("Imteyaz Ahmad");

			String StrDriverLastName_193;
			String StrPrimaryWindowHandle;
			String StrDriverLastNameActual_193;
			...
			testcall1 = true;
			StrDriverLastName_193 = RMA_Functionality_Utility.RMA_MaintEntityAddition_Utility("Driver", logval1);
			parentlogger.log(LogStatus.INFO, "New Driver Is Created Successfully With Name::"+ " " + color.RMA_ChangeColor_Utility(StrDriverLastName_193, 2));
			...
			RMA_Functionality_Utility.RMA_StandardSearch_Window(RMA_POM_Search.RMAApp_SearchDriver_Txt_DriverLastName(driver), "Standard Driver Search Page", "Driver Last Name TextBox", StrDriverLastName_193, StrDriverLastName_193, "pidriver", StrPrimaryWindowHandle, logval);
			RMA_Functionality_Utility.RMA_GenericSave_Utility("pidriver", false, "NA", "Persons Involved-->Driver Page", logval);
			StrDriverLastNameActual_193 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrDriverLastName_193, StrDriverLastNameActual_193 , "Driver Last Name", logval);
			...
			RMA_Functionality_Utility.RMA_GenericSave_Utility("pidriver", false, "NA", "Persons Involved-->Driver Page", logval);
			StrDriverLastNameActual_193 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrDriverNameChanged, StrDriverLastNameActual_193 , "Driver Last Name", logval);
