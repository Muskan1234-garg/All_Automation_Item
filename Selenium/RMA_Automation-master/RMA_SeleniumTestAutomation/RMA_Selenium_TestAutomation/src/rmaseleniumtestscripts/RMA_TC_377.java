...
//=======================================================================================================================================================
//TestCaseID     : RMA_TC_377
//Description    : Creation, Edit And Deletion Of Enhanced Notes For Case Manager (Case Management System) Associated With A Claim
//Depends On TC  : RMA_TC_335
//Revision       : 0.0 - KumudNaithani-03-20-2017
//==============================================================================================================================================================
public class RMA_TC_377 extends RMA_TC_BaseTest {
...
@Test	
public void RMA_TC_377_Test() throws Exception, Error
{   
	try {	 	 
	 ...
	 parentlogger = reports.startTest("RMA_TC_377_Creation, Edit And Deletion Of Enhanced Notes For Case Manager (Case Management System) For Created Claim", "Creation, Edit And Deletion Of Enhanced Notes For Case Manager (Case Management System) Associated With A Claim");
	 ...
	 StrScreenShotTCName = "RMA_TC_377";
	 Edit = true;
	 //Variable Initialization Completed
     
	//===========================================================New Case Manager (Case Management System) Creation Associated With Claim Is Started Here=====================================================================================================================================================================================================================================================================================================================================
	 parentlogger.log(LogStatus.INFO, "The Functional Utility :" +" " +RMA_GenericUsages_Utility.RMA_LoggerHyperlink("ClaimEntity", "Claim Entity Addition",0)+ " "+ "Is Called To Add Case Manager To Claim" + " "+color.RMA_ChangeColor_Utility(StrClaimNumber_335, 2));
	 testcall1 = true;
	 StrCaseManager = RMA_Functionality_Utility.RMA_ClaimEntityAddition_Utility("CaseManagers", "Case Managers (0)", StrClaimNumber_335, "Not Required", "Larson", "Not Required", "Not Required", "Not Required", "Not Required", "Larson, Darla", logval1);
	 parentlogger.log(LogStatus.INFO, "New Case Manager Is Added Successfully With Last Name::"+ " " + color.RMA_ChangeColor_Utility(StrCaseManager, 2) + " " +"To Claim Number::" + color.RMA_ChangeColor_Utility(StrClaimNumber_335, 2));
	 loggerval1 = logger.toString();
	 parentlogger.appendChild(logger);
	 parentlogger.log(LogStatus.INFO, parentlogger.addScreenCapture(RMA_ScreenCapture_Utility.RMA_ScreenShotCapture_Utility(driver, "SuccessfulCase Manager Creation", StrScreenShotTCName)));
	//=========================================================== New Case Manager Creation (Case Management System) Associated With Claim Is Completed Here=======================================================================================================================================================================================================================================================================================================================================
	
	//===========================================================Steps To Create And Edit Progress Notes Started Here==================================================================================================================================================================================================================================================================================================================================================
	StrPrimaryWindowHandle = driver.getWindowHandle();
	RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_Home.RMAApp_Generic_Img_EnhancedNotes(driver), "Enhanced Notes Image For Case Manager"+ " "+ color.RMA_ChangeColor_Utility(StrCaseManager, 2)+ " "+"Added To Claim" + " "+color.RMA_ChangeColor_Utility(StrClaimNumber_335, 2),logval1); // Claim ID Is Same For All Line Of Business
	...
	//===========================================================Steps To Delete Progress Notes Completed Here===============================================================================================================================================================================================================================================================================================================================================================
		 ...
		 {
		 logger.log(LogStatus.FAIL, "Following Error Occurred  ::" + " "+  color.RMA_ChangeColor_Utility(FinalErrorMessage,1)+ " " + "While Executing Function Utility" +" "+ "RMA_ClaimEntityAddition_Utility" + " For New Case Manager (Case Management System) Creation Associated With A Claim And Hence The Test Case Is A Fail");
		 parentlogger.appendChild(logger);
		 }
		 ...
		 System.out.println("Following Error Occurred In AfterMethod Code Block Of Test Case :" +" " +StrScreenShotTCName +" :" +" " +e.getMessage() );
		 ...
		 finally
		    {
			 try {
				 ...
				 RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_Home.RMAApp_DefaultView_Btn_Close(driver), "Close Button On Right Side Of Case Manager Page",logval);
					RMA_GenericUsages_Utility.RMA_StaticWait(2, logval, "Wait Is Added As Case Manager Page Is Closed");
			} catch (Exception|Error e) {
