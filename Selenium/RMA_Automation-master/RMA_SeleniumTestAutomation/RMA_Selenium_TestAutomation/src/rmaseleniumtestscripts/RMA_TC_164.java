...
//================================================================================================
//TestCaseID     : RMA_TC_164
//Description    : TC_164_Verify Adding,Editing And Deleting Of New Physician As Person Involved In Litigation For Workers Comp Claim
//Depends On TC  : RMA_TC_158
//Revision       : 0.0 - ImteyazAhmad-07-06-2016 
//=================================================================================================

public class RMA_TC_164 extends RMA_TC_BaseTest {
	...
	@Test
	public void RMA_TC_164_Test() throws Exception,Error {

		try{
			parentlogger = reports.startTest("TC_164_Adding, Editing And Deleting Of New Physician", "Verify Adding,Editing And Deleting Of New Physician As Person Involved In Litigation For Workers Comp Claim");
			parentlogger.assignAuthor("Imteyaz Ahmad");

			String StrPhysicianLastName_164;
			String StrPhysicianLastNameActual_164;
			String StrPhysicianLastNameChanged;
			String StrClaimNaumberActual;

			StrScreenShotTCName = "TC_164";
			testcall1 = false;	
			testcall2 = false;	
			...
			testcall1 = true;
			StrPhysicianLastName_164 = RMA_Functionality_Utility.RMA_PIAddNewEntity_Utility("Physician", logval1);
			parentlogger.log(LogStatus.INFO, "New Physician Is Created Successfully With Physician Last Name::"+ " " + color.RMA_ChangeColor_Utility(StrPhysicianLastName_164, 2));
			loggerval1 = logger.toString();
			parentlogger.appendChild(logger);
			parentlogger.log(LogStatus.INFO, parentlogger.addScreenCapture(RMA_ScreenCapture_Utility.RMA_ScreenShotCapture_Utility(driver, "New Physician Creation Is Successfull", StrScreenShotTCName)));
			//===============================================Steps To Create A New Physician Completed============================================================================================================================================
			
			/*===============================================Editing Of New Physician Is Started Here=======================================================================*/
			StrPhysicianLastNameChanged = RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(4, "Physician_TC_164_");
			...
			StrPhysicianLastNameActual_164 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Maintenance.RMAApp_MaintPhysician_Txt_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrPhysicianLastNameChanged, StrPhysicianLastNameActual_164 , "Physician Last Name", logval);
