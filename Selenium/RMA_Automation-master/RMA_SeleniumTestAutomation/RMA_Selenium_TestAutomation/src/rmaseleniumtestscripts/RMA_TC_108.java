...
//================================================================================================
//TestCaseID     : RMA_TC_108
//Description    : TC_108_Verify Add,Edit And Delete Of Existing Physician As Person Involved In Litigation For Vehicle Accident Claims
//Depends On TC  : RMA_TC_102
//Revision       : 0.0 - KumudNaithani-05-16-2016 
//=================================================================================================

public class RMA_TC_108 extends rmaseleniumtestscripts.RMA_TC_BaseTest {
	...
	@Test 
	public void RMA_TC_108_Test () throws Exception, Error
	{
		parentlogger = reports.startTest("TC_108_Existing Physician As Person Involved", "Verify Add,Edit And Delete Of Existing Physician As Person Involved In Litigation For Vehicle Accident Claims");
		...
		try {
			...
			RMA_GenericUsages_Utility.RMA_StaticWait(5,logval, "Wait Is Added As Expand Image Corresponding To Vehicle Claim Link On Left Hand Navigation Tree Is Clicked ");
			...
			StrEditedPhysicianLastName = RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(4, "Physician_RMA_TC_108_");
			driver.switchTo().frame(RMA_GenericUsages_Utility.RMA_FrameNavigation("piphysician"));
			RMA_GenericUsages_Utility.RMA_StaticWait(2, logval, "Wait Is Added As Switch To Frame Containing Persons Involved-->Physician Screen Controls Is Done");
