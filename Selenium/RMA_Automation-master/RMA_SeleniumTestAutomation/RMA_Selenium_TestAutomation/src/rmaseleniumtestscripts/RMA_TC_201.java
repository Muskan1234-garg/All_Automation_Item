...
//==========================================================================================================================
//TestCaseID     : RMA_TC_201
//Description    : TC_201_Verify Adding,Editing And Deleting Of Existing Driver As Person Involved For Vehicle Claim
//Depends On TC  : RMA_TC_198
//Revision       : 0.0 - KumudNaithani-07-19-2016 
//=============================================================================================================================

public class RMA_TC_201 extends RMA_TC_BaseTest {
	...
	@Test
	public void RMA_TC_201_Test() throws Exception,Error {

		try{
			parentlogger = reports.startTest("TC_201_Adding, Editing And Deleting Of An Existing Driver", "Verify Adding,Editing And Deleting Of An Existing Driver As Person Involved For Vehicle Claim");
			parentlogger.assignAuthor("Kumud Naithani");

			String StrDriverLastName_201;
			String StrPrimaryWindowHandle;
			String StrDriverLastNameActual_201;
			String StrDriverNameChanged;
			String StrClaimNaumberActual;
			//Local Variable Declaration Completed Here

			
			StrScreenShotTCName = "TC_201";
			testcall1 = false;	
			testcall2 = false;	
			...
			testcall1 = true;
			StrDriverLastName_201 = RMA_Functionality_Utility.RMA_MaintEntityAddition_Utility("Driver", logval1);
			parentlogger.log(LogStatus.INFO, "New Driver Is Created Successfully With Name::"+ " " + color.RMA_ChangeColor_Utility(StrDriverLastName_201, 2));
			...
			RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_Home.RMAApp_LeftHandNavTree_Img_ExpandCollapse(driver, RMA_TC_198.StrClaimNumber_198), "Expand Image Corresponding To Vehicle Link On Left Navigation Tree", logval);
			RMA_GenericUsages_Utility.RMA_StaticWait(3, logval, "Wait Is Added As Expand Image Corresponding To Vehicle Link On Left Navigation Tree Is Clicked ");
			...
			RMA_Functionality_Utility.RMA_StandardSearch_Window(RMA_POM_Search.RMAApp_SearchDriver_Txt_DriverLastName(driver), "Standard Driver Search Page", "Driver Last Name TextBox", StrDriverLastName_201, StrDriverLastName_201, "pidriver", StrPrimaryWindowHandle, logval);
			RMA_Functionality_Utility.RMA_GenericSave_Utility("pidriver", false, "NA", "Persons Involved-->Driver Page", logval);
			StrDriverLastNameActual_201 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrDriverLastName_201, StrDriverLastNameActual_201 , "Driver Last Name", logval);
			...
			RMA_Functionality_Utility.RMA_GenericSave_Utility("pidriver", false, "NA", "Persons Involved-->Driver Page", logval);
			StrDriverLastNameActual_201 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrDriverNameChanged, StrDriverLastNameActual_201 , "Driver Last Name", logval);
