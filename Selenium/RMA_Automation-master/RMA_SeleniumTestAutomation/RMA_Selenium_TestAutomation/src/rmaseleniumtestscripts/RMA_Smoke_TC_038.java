...
//Description    : RMA_Smoke_TC_038_Verify That Enhanced Notes Can Be Created,Edited And Deleted Successfully From Collection Page
...
public class RMA_Smoke_TC_038 extends RMA_TC_BaseTest {
	...
	public void RMA_TC_038_Test() throws Exception,Error {
		...
		try{
			parentlogger = reports.startTest("RMA_Smoke_TC_038_Enhanced Notes Create, Edit And Delete", "Verify That Enhanced Notes Can Be Created,Edited And Deleted Successfully From Collection Page");
			...
			RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_Home.RMAApp_Generic_Img_EnhancedNotes(driver), "Enhanced Notes Image On Collection :"+" "+RMA_Smoke_TC_036.StrControlNumber_RMA_Smoke_TC_036, logval); // Claim/Event ID Is Same For All Line Of Business
			...
			{
			logger.log(LogStatus.FAIL,"Following Error Occurred  ::" + " "+  color.RMA_ChangeColor_Utility(FinalErrorMessage,1)+ " " + "While Executing Function" +" "+ "RMA_EnhancedNotesCreateEditDelete_Utility" + " " +  "And Hence The Test Case Is A Fail");
			parentlogger.appendChild(logger);
			}
