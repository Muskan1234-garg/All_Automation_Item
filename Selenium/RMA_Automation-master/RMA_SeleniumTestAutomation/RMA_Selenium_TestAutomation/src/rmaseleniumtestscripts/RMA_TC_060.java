...
//================================================================================================
//TestCaseID     : RMA_TC_060
//Description    : Transaction Created In RMA_TC_052 Is Listed In LOB Manager's List And On Approval Goes To Top Level Manager Is Validated
//Depends On TC  : TC_064, TC_051, TC_052, TC_057, TC_058, TC_059
//Revision       : 0.0 - KumudNaithani-02-08-2016 
//=================================================================================================
...
public class RMA_TC_060 extends rmaseleniumtestscripts.RMA_TC_BaseTest {
	static String ExceptionRecorded;
	static String []ErrorMessage;
	static String FinalErrorMessage;
	static String ErrorMessageType;
	static String StrScreenShotTCName;
	static String Strlogstatement;

	@Test 
	public void RMA_TC_060_Test () throws Exception, Error
	//Verify That Transaction Created In RMA_TC_052 Is Listed In LOB Manager's List And On Approval Goes To Top Level Manager
	{
		try {
			parentlogger = reports.startTest("TC_060_Transaction Is Listed In LOB Manager's List", "Transaction Created In RMA_TC_052 Is Listed In LOB Manager's List And On Approval Goes To Top Level Manager Is Validated");
			String StrAccept;
			...
			testcall1 = false;
			StrErrorMessageExpected = "A hold requiring supervisory approval has been placed because";
			...
			RMAApp_Login_Txt_UserName = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_060", 1, 0); //UserName Fetched From DataSheet RMA_TC_060
			RMAApp_Login_Txt_Password = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_060", 1, 1); //Password Fetched From DataSheet RMA_TC_060
			...
			if (RMA_Selenium_POM_Funds_SprApproval.RMAApp_SprApproval_PaymntNoRecordsAvailable(driver).isDisplayed() )
			{
				...
				Strlogstatement  = "Record With Control Number" + " " + RMA_TC_052.StrControlNumber_RMA_TC_052 + " " + "Does Not Exist In Payment UXGrid On Supervisory Approval Page";
				parentlogger.log(LogStatus.PASS, Strlogstatement);
				parentlogger.log(LogStatus.INFO, logger.addScreenCapture(RMA_ScreenCapture_Utility.RMA_ScreenShotCapture_Utility(driver, "Payment $2000 Does Not Exist", StrScreenShotTCName)));
			...
			else
			{
				...
				RMA_GenericUsages_Utility.RMA_StaticWait(7, logval, "Wait Is Added As Control Number Value Is Set In Filter TextBox In Payment Tab On Supervisory Approval Page");
				RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_Funds_SprApproval.RMAApp_SprApproval_Txt_UXPymntGridFilterTxtBox(driver, 2, "Fund Date", 2), "Fund Date Filter TextBox On Payment Tab On Supervisory Approval Page", logval);
				RMA_Verification_Utility.RMA_VerifyRecordNotExistInUXGrid_Utility(RMA_TC_052.StrControlNumber_RMA_TC_052, "Payment UXGrid On Supervisory Approval Page", logval);
			}
	
//			globalWait.until(ExpectedConditions.elementToBeClickable(RMA_Selenium_POM_Funds_SprApproval.RMAApp_SprApproval_Txt_UXRsvPymntGridFilterTxtBox(driver, 4)));
...
//			RMA_GenericUsages_Utility.RMA_StaticWait(10, logval, "Wait Is Added As Control Number Value Is Set In Filter TextBox In Payment Tab On Supervisory Approval Page");
//			Strlogstatement = "The Control Number :"+" "+RMA_TC_052.StrControlNumber_RMA_TC_052;
//			RMA_NegativeVerification_Utility.RMA_ElementNotExist_Utility(RMA_Selenium_POM_Funds_SprApproval.RMAApp_SprApproval_UXGrd_RowElement(driver), Strlogstatement , 0);
//			parentlogger.log(LogStatus.INFO, logger.addScreenCapture(RMA_ScreenCapture_Utility.RMA_ScreenShotCapture_Utility(driver, "Non Existence Of Control Number" + " " + RMA_TC_052.StrControlNumber_RMA_TC_052 + " " + "In Payment Approval Table", StrScreenShotTCName)));
...
//			globalWait.until(ExpectedConditions.elementToBeClickable(RMA_Selenium_POM_Funds_SprApproval.RMAApp_SprApproval_Txt_UXRsvPymntGridFilterTxtBox(driver, 4)));
//			RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_Funds_SprApproval.RMAApp_SprApproval_Txt_UXRsvPymntGridFilterTxtBox(driver, 4), "Control Number Filter TextBox On Payment Tab  On Supervisory Approval Page", logval);
//			RMA_Input_Utility.RMA_ActionSetValue_Utility(RMA_Selenium_POM_Funds_SprApproval.RMAApp_SprApproval_Txt_UXRsvPymntGridFilterTxtBox(driver, 4), "Control Number Filter TextBox On Payment Tab On Supervisory Approval Page", RMA_TC_052.StrControlNumber_RMA_TC_01_052, logval);
//			RMA_GenericUsages_Utility.RMA_StaticWait(10, logval, "Wait Is Added As Control Number Value Is Set In Filter TextBox In Payment Tab On Supervisory Approval Page");
			...
			parentlogger.log(LogStatus.INFO, logger.addScreenCapture(RMA_ScreenCapture_Utility.RMA_ScreenShotCapture_Utility(driver, "Error Message On Payment $2500 Approval By LobMgr Verification", StrScreenShotTCName)));
			...
			RMA_Functionality_Utility.RMA_StandardSearch_Screen(RMA_POM_Search.RMAApp_SearchFunds_Txt_ControlNumber(driver), "Search_Funds", "Check Control Number Text Box", RMA_TC_052.StrControlNumber_RMA_TC_052, RMA_TC_052.StrControlNumber_RMA_TC_052, "Transaction", "num", 2, logval);
