...
//================================================================================================================
//TestCaseID     : RMA_TC_320
//Description    : RMA_TC_320_Attachment Add, Edit & Delete On Maintenance -> Leave Plan  Management  screen
//Depends On TC  : NA
//Revision       : 0.0 - MahendraPSingh-02-24-2017
//=================================================================================================================

public class RMA_TC_320 extends RMA_TC_BaseTest {
...
@Test	
public void RMA_TC_320_Test() throws Exception, Error
  {   
	try {
		...
		parentlogger = reports.startTest("RMA_TC_320_Attachment Add, Edit & Delete On "+ " "+ color.RMA_ChangeColor_Utility("Maintenance -> Plan  Management ", 3) +" " +"Screen", "Verifying Attachment Add, Edit & Delete On Maintenance -> Plan  Management  screen");
	    ...
	    StrScreenShotTCName = "RMA_TC_320";
		...
		//++++++++++++++++++++++++++++++++++++++++ Step Maintenance -> Leave Plan Management  Addition Started Here ++++++++++++++++++++++++++++++++++++++++++++++++	
		  
	    parentlogger.log(LogStatus.INFO, "The Functional Utility :" +" " +"RMA_MaintEntityAddition_Utility Is Called To Create A Leave Plan Management  ");
		testcall1 = true;
		StrPlanCode = RMA_Functionality_Utility.RMA_MaintEntityAddition_Utility("LeavePlanManagement", logval1);
		parentlogger.log(LogStatus.INFO, "New Leave Plan Management - Plan Code  Is Created Successfully With Plan Code::"+ " " + color.RMA_ChangeColor_Utility(StrPlanCode, 2));
		loggerval1 = logger.toString();
		parentlogger.appendChild(logger);
		parentlogger.log(LogStatus.INFO, parentlogger.addScreenCapture(RMA_ScreenCapture_Utility.RMA_ScreenShotCapture_Utility(driver, "New Leave Plan Management  Is Added From Maintenance", StrScreenShotTCName)));
		//++++++++++++++++++++++++++++++++++++++++  Step Maintenance -> Leave Plan Management  Addition Finished Here ++++++++++++++++++++++++++++++++++++++++++++++++	
		
		driver.switchTo().frame(RMA_GenericUsages_Utility.RMA_FrameNavigation("Leave Plan Management"));
	
		
		//++++++++++++++++++++++++++++++++++++++++ Attachment Add & Edit functionality on Maintenance -> Leave Plan  Management  screen is started here ++++++++++++++++++++++++++++++++++++++++++++++++	
	    ...
	    //++++++++++++++++++++++++++++++++++++++++ Attachment Add & Edit functionality on Maintenance -> Leave Plan  Management  screen is finished here ++++++++++++++++++++++++++++++++++++++++++++++++	
		 
		//++++++++++++++++++++++++++++++++++++++++ Attachment Delete functionality on Maintenance -> Leave  Plan  Management  screen is started here ++++++++++++++++++++++++++++++++++++++++++++++++	
	   ...
	   //++++++++++++++++++++++++++++++++++++++++++ Attachment Delete functionality on Maintenance -> Leave Plan  Management  screen is finished here ++++++++++++++++++++++++++++++++++++++++++++++++	
