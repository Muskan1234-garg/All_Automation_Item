...
//================================================================================================
//TestCaseID     : RMA_TC_063
//Description    : TC_063 Diary/Email Is Sent To Current Adjuster Of Claim When Payment Is Approved By Top Level Manager Is Validated.
//Depends On TC  : TC_064, TC_051, TC_052, TC_057, TC_058, TC_059, TC_060, TC_062
//Revision       : 0.0 - KumudNaithani-01-10-2016
//Revision       : 0.1 - ImteyazAhmad-08-12-2016
//=================================================================================================
//Note: User4 and User 5 Should Not Have Any Manager
public class RMA_TC_063 extends rmaseleniumtestscripts.RMA_TC_BaseTest {
	...
	@Test 
	public void RMA_TC_063_Test () throws Exception, Error
	//Verify That Diary/Email Is Sent To Current Adjuster Of Claim When Payment Is Approved By Top Level Manager
	{
		try {
			parentlogger = reports.startTest("TC_063_Diary/Email To Current Claim Adjustor", "Diary/Email Is Sent To Current Adjuster Of Claim When Payment Is Approved By Top Level Manager Is Validated");
			String StrAccept;
			...
			StrAccept = "Yes";
			StrScreenShotTCName = "TC_063";
			AttachedRecord = "FUNDS:"+" "+RMA_TC_052.StrControlNumber_RMA_TC_01_052;
			TaskName = "Check Approved";
			TaskNameVal = "Payments:"+" "+ RMA_TC_052.StrControlNumber_RMA_TC_01_052;
			...
			RMAApp_Login_Txt_UserName = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_063", 1, 0); //UserName Fetched From DataSheet RMA_TC_063
			RMAApp_Login_Txt_Password = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_063", 1, 1); //Password Fetched From DataSheet RMA_TC_063
