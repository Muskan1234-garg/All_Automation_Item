...
//================================================================================================
//TestCaseID     : RMA_TC_281
//Description    : TC_281_Verify Add,Edit And Delete Of New Patient As Person Involved For General Claim At Policy Level
//Depends On TC  : RMA_TC_246
//Revision       : 0.0 - RenuVerma-07-27-2016 
//=================================================================================================

public class RMA_TC_281 extends rmaseleniumtestscripts.RMA_TC_BaseTest {
	...
	@Test 
	public void RMA_TC_281_Test () throws Exception, Error
	{
		parentlogger = reports.startTest("TC_281_Verify Adding,Editing And Deleting Of New Patient As Person Involved For General Claim At Policy Level", "Verify Add,Edit And Delete Of New Patient As Person Involved For General Claim At Policy Level");
		parentlogger.assignAuthor("Renu Verma");
		try {
			String StrPatientLastName_281;
			String StrEditedPatientLastName_Actual_281;
			String StrEditedPatientLastName_281;
			...
			//===============================================Addition Of Patient On General Claim Policy Created in TC_246 Is Started Here=====================================================================================================
			...
			testcall1 = true;
			StrPatientLastName_281 = RMA_Functionality_Utility.RMA_PIAddNewEntity_Utility("Patient", logval1);
			parentlogger.log(LogStatus.INFO, "New Patient Is Created Successfully With Patient Name::"+ " " + color.RMA_ChangeColor_Utility(StrPatientLastName_281, 2));
			...
			//===============================================Addition Of Patient On General Claim Policy Created in TC_246 Is Completed =================================================================================================================================================
			
			//===============================================Steps To Edit The Patient Added As Persons Involved Started ======================================================================================================================================================
			StrEditedPatientLastName_281 = RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(4, "Patient_281_");
			RMA_Input_Utility.RMA_SetValue_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "LastName TextBox On Persons Involved-->Patient Page", StrEditedPatientLastName_281, logval);
			RMA_Functionality_Utility.RMA_GenericSave_Utility("pipatient",false,"NA","Persons Involved-->Patient Page", logval);
			StrEditedPatientLastName_Actual_281 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrEditedPatientLastName_281, StrEditedPatientLastName_Actual_281 , "Patient Last Name Value",logval);
			...
			parentlogger.log(LogStatus.INFO, "Following Utility :" +" " +"RMA_GenericDelete_Utility Is Called To Delete The Patient"+ " "+ color.RMA_ChangeColor_Utility(StrEditedPatientLastName_Actual_281, 2) +" " +"Added As Persons Involved");
			testcall2 = true;
			RMA_Functionality_Utility.RMA_GenericDelete_Utility("Persons Involved-->Patient Page", logval1);
			parentlogger.log(LogStatus.INFO, "Patient Added As Persons Involved Is Deleted Successfully::"+ " " + color.RMA_ChangeColor_Utility(StrEditedPatientLastName_Actual_281, 2));
