...
//================================================================================================
//TestCaseID     : RMA_TC_171
//Description    : TC_171_Verify Add,Edit And Delete Of Existing Patient As Person Involved on Property Claims
//Depends On TC  : RMA_TC_166
//Revision       : 0.0 - RenuVerma-07-05-2016 
//=================================================================================================

public class RMA_TC_171 extends rmaseleniumtestscripts.RMA_TC_BaseTest {
	...
	@Test 
	public void RMA_TC_171_Test () throws Exception, Error
	{
		parentlogger = reports.startTest("TC_171_Adding,Editing And Deleting Of Existing Patient As Person Involved", "Verify Add,Edit And Delete Of Existing Patient As Person Involved on Property Claims");
		parentlogger.assignAuthor("Renu Verma");
		try {
			String StrPrimaryWindowHandle;
			String StrPatientLastName_171;
			String StrEditedPatientLastName_Actual_171;
			String StrEditedPatientLastName_171;
			String StrPatientLastName_Actual_171;
			...
			testcall1 = true;
			StrPatientLastName_171 = RMA_Functionality_Utility.RMA_MaintEntityAddition_Utility("PatientTracking", logval1);
			parentlogger.log(LogStatus.INFO, "New Patient Is Created With Patient Name::"+ " " + color.RMA_ChangeColor_Utility(StrPatientLastName_171, 2));
			...
			//===============================================Addition Of Patient On Claim Created in TC_166 Is Started Here=====================================================================================================
			...
			RMA_Functionality_Utility.RMA_StandardSearch_Window(RMA_POM_Search.RMAApp_SearchPatient_Txt_PatientLastName(driver), "Claim-->PI-->Search-->Existing Patient Criteria Page","Patient Last Name Text Box",StrPatientLastName_171,StrPatientLastName_171, "pipatient",StrPrimaryWindowHandle, logval);
			RMA_Functionality_Utility.RMA_GenericSave_Utility("pipatient",false,"NA","Persons Involved-->Patient Page", logval);
			StrPatientLastName_Actual_171 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrPatientLastName_171, StrPatientLastName_Actual_171, "Patient Name", logval);
			...
			//===============================================Addition Of Patient On Claim Created in TC_166 Is Completed =================================================================================================================================================
			
			
			//===============================================Steps To Edit The Patient Added As Persons Involved Started ======================================================================================================================================================
			StrEditedPatientLastName_171 = RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(4, "Patient_171_");
			RMA_Input_Utility.RMA_SetValue_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "LastName TextBox On Persons Involved-->Patient Page", StrEditedPatientLastName_171, logval);
			RMA_Functionality_Utility.RMA_GenericSave_Utility("pipatient",false,"NA","Persons Involved-->Patient Page", logval);
			StrEditedPatientLastName_Actual_171 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrEditedPatientLastName_171, StrEditedPatientLastName_Actual_171 , "Patient Last Name Value",logval);
			...
			parentlogger.log(LogStatus.INFO, "Following Utility :" +" " +"RMA_GenericDelete_Utility Is Called To Delete The Patient"+ " "+ color.RMA_ChangeColor_Utility(StrEditedPatientLastName_Actual_171, 2) +" " +"Added As Persons Involved");
			testcall2 = true;
			RMA_Functionality_Utility.RMA_GenericDelete_Utility("Persons Involved-->Patient Page", logval1);
			parentlogger.log(LogStatus.INFO, "Patient Added As Persons Involved Is Deleted Successfully::"+ " " + color.RMA_ChangeColor_Utility(StrEditedPatientLastName_Actual_171, 2));
