...
//=======================================================================================================================================
//TestCaseID     : RMA_TC_204
//Description    : TC_204_Verify Adding,Editing And Deleting Of Existing Physician As Person Involved For Vehicle Accident Claim
//Depends On TC  : RMA_TC_198
//Revision       : 0.0 - KumudNaithani-07-14-2016
//==========================================================================================================================================

public class RMA_TC_204 extends RMA_TC_BaseTest {
	...
	@Test
	public void RMA_TC_204_Test() throws Exception,Error {

		try{
			parentlogger = reports.startTest("TC_204_Adding, Editing And Deleting Of An Existing Physician", "Verify Adding,Editing And Deleting Of An Existing Physician As Person Involved For Vehicle Accident Claim");
			parentlogger.assignAuthor("Kumud Naithani");

			String StrPhysicianLastName_204;
			String StrPrimaryWindowHandle;
			String StrPhysicianLastNameActual_204;
			...
			testcall1 = true;
			StrPhysicianLastName_204 = RMA_Functionality_Utility.RMA_MaintEntityAddition_Utility("Physician", logval1);
			parentlogger.log(LogStatus.INFO, "New Physician Is Created Successfully With Name::"+ " " + color.RMA_ChangeColor_Utility(StrPhysicianLastName_204, 2));
			...
			RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_Home.RMAApp_LeftHandNavTree_Img_ExpandCollapse(driver, "Vehicle Accident"), "Expand Image Corresponding To Vehicle Accident Link On Left Navigation Tree", logval);
			...
			RMA_Functionality_Utility.RMA_StandardSearch_Window(RMA_POM_Search.RMAApp_SearchPhysician_Txt_LastName(driver), "Standard Physician Search Page", "Physician Last Name TextBox", StrPhysicianLastName_204, StrPhysicianLastName_204, "piphysician", StrPrimaryWindowHandle, logval);
			RMA_Functionality_Utility.RMA_GenericSave_Utility("piphysician", false, "NA", "Save Image On PI Physician Page", logval);
			StrPhysicianLastNameActual_204 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrPhysicianLastName_204, StrPhysicianLastNameActual_204 , "Physician Last Name", logval);
			...
			RMA_Functionality_Utility.RMA_GenericSave_Utility("piphysician", false, "NA", "Save Image On PI Physician Page", logval);
			StrPhysicianLastNameActual_204 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrPhysicianLastNameChanged, StrPhysicianLastNameActual_204 , "Physician Last Name", logval);
