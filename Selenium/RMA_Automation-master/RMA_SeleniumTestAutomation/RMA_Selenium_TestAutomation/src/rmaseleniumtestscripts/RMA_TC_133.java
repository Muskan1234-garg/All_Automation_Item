...
//=====================================================================================================================================
//TestCaseID     : RMA_TC_133
//Description    : TC_133_Verify Adding,Editing And Deleting Of new Witness As Person Involved In Litigation For General Claim
//Depends On TC  : RMA_TC_126
//Revision       : 0.0 - KumudNaithani-06-30-2016 
//=========================================================================================================================================

public class RMA_TC_133 extends RMA_TC_BaseTest {
	...
	@Test
	public void RMA_TC_133_Test() throws Exception,Error {

		try{
			parentlogger = reports.startTest("TC_133_Adding, Editing And Deleting Of New Witness", "Verify Adding,Editing And Deleting Of New Witness As Person Involved In Litigation For General Claim");
			parentlogger.assignAuthor("Kumud Naithani");

			String StrWitnessNumber_133;
			String StrWitnessLastNameActual_133;
			String StrWitnessNameChanged;

			//Local Variable Declaration Completed Here

			
			StrScreenShotTCName = "TC_133";
			testcall1 = false;	
			testcall2 = false;	
			...
			//===============================================Search Of The Claim Created In TC_126 Is Started==================================================================================================================================================================================================================
			...
			RMA_Functionality_Utility.RMA_StandardSearch_Screen(RMA_POM_Search.RMAApp_SearchClaims_Txt_ClaimNumber(driver),"Search-->Claim Criteria Page","Claim Number Text Box On Search-->Claim Criteria Page",RMA_TC_126.StrClaimNumber_RMA_TC_126,RMA_TC_126.StrClaimNumber_RMA_TC_126,"claimgc","num",2, logval);
			
			//===============================================Search Of The Claim Created In TC_126 Is Completed======================================================================================================================================================================================================================
			...
			driver.switchTo().parentFrame();
			RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_Home.RMAApp_LeftHandNavTree_Img_ExpandCollapse(driver, "Litigation ("+RMA_TC_126.StrLitigation_RMA_TC_126+")"), "Expand/Collapse Image For The Created Litigation On Left Hand Navigation Tree",logval);
			RMA_GenericUsages_Utility.RMA_StaticWait(5, logval, "Wait Is Added As Expand Image Corresponding To Litigation "+" "+RMA_TC_126.StrLitigation_RMA_TC_126 +"Is Clicked");
			...
			testcall1 = true;
			StrWitnessNumber_133 = RMA_Functionality_Utility.RMA_PIAddNewEntity_Utility("Witness", logval1);
			parentlogger.log(LogStatus.INFO, "New Witness Is Created Successfully With Witness Number::"+ " " + color.RMA_ChangeColor_Utility(StrWitnessNumber_133, 2));
			...
			StrWitnessLastNameActual_133 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrWitnessNameChanged, StrWitnessLastNameActual_133 , "WitnessLast Name", logval);
