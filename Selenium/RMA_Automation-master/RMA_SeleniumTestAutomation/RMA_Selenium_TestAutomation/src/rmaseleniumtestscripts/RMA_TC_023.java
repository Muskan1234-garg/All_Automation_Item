...
public class RMA_TC_023 extends RMA_TC_BaseTest{
	...
	//Verify transaction is listed in my pending transactions and in submitted to column, listed user should be the one in current adjuster's hierarchy having  sufficient limits to approve. 
	{
		try{
			String StrExpSubmittedVal_023;
			StrExpSubmittedVal_023 = "CurrAdjMgr2";
			//Local Variable Declaration

			logger = reports.startTest("TC_023_Listing Of Transactions In Submitted Pending Transactions","Verify transaction is listed in my pending transactions and in submitted to column, listed user should be the one in current adjuster's hierarchy having  sufficient limits to approve.");
			...
			RMA_Input_Utility.RMA_SetValue_Utility(RMA_Selenium_POM_Funds_SprApproval.RMAApp_SprApproval_Txt_UXPymntGridFilterTxtBox(driver,2,"Control Number",2), "Control Number Filter TextBox On Payment Tab  On Supervisory Approval Page", RMA_TC_022.StrControlNum_022, logval1);
			...
			RMA_Verification_Utility.RMA_VerifyUXGridSingleText_Utility(RMA_TC_022.StrControlNum_022, "Pending Payments Grid In Supervisory Approval Page", StrExpSubmittedVal_023, 7, logval1);
