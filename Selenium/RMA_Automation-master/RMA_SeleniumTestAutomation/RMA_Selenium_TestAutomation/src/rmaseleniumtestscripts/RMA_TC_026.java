...
//Description    : TC_026_Verify that hold transaction is  listed in current adjuster's manager's manager list and user should also have received a diary and an email.
//Depends On TC  : TC_011, TC_021 & TC_022
...
{
	try {
		parentlogger = reports.startTest("TC_026_Transaction Is Listed In Current Adjuster Manager's Manager List", "Verify that hold transaction is  listed in current adjuster's manager's manager list and user should also have received a diary and an email.");
		String StrAccept;
		...
		RMAApp_Login_Txt_UserName = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_026", 1, 0); //UserName Fetched From DataSheet RMA_TC_026
		RMAApp_Login_Txt_Password = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_026", 1, 1); //Password Fetched From DataSheet RMA_TC_026
	
		//==============================================='CurrAdjMgr2' Logging In Is Started====================================================================================================================================================================================================================================================================================================================
		...
		//==============================================='CurrAdjMgr2' Logging In Is Started====================================================================================================================================================================================================================================================================================================================	
		//===============================================Existence Of Payment Created In TC_022 In Diaries Page Validation Is Started==========================================================================================================================================================================================================================================================================
		...
		//===============================================Existence Of Payment Created In TC_022 In Diaries Page Validation Is Completed==========================================================================================================================================================================================================================================================================		
		//==============================================Payment Created In TC_022 Approval Is Completed==========================================================================================================================================================================================================================================================================================================	
		...
		RMA_GenericUsages_Utility.RMA_StaticWait(5, logval, "Wait Is Added Payments View Is Loaded On Supervisory Approval Page");
		...
		RMA_Input_Utility.RMA_SetValue_Utility(RMA_Selenium_POM_Funds_SprApproval.RMAApp_SprApproval_Txt_UXPymntGridFilterTxtBox(driver,2,"Control Number",2), "Control Number Filter TextBox On Payment Tab  On Supervisory Approval Page", RMA_TC_022.StrControlNum_022, logval);
		...
		StrMessage = RMA_Selenium_POM_Home.RMAApp_Generic_ToastMessage(driver).getText();
		StrMessageExpected = "Payment(s) approved successfully";
		RMA_Verification_Utility.RMA_PartialTextVerification(StrMessageExpected, StrMessage, "Correct Approval Message Display",0);
		RMA_GenericUsages_Utility.RMA_StaticWait(4, logval, "Wait Is Added As Payment Is Approved");
		
		if (RMA_Selenium_POM_Funds_SprApproval.RMAApp_SprApproval_PaymntNoRecordsAvailable(driver).isDisplayed() )
		{
			Strlogstatement  = "Payment with Control Number" + " " + RMA_TC_022.StrControlNum_022 + " " + "Does Not Exist In Payment UXGrid On Supervisory Approval Page";
		...
		else
		{
			...
			RMA_Verification_Utility.RMA_VerifyRecordNotExistInUXGrid_Utility(RMA_TC_022.StrControlNum_022, "Payment UXGrid On Supervisory Page", logval);
		}
