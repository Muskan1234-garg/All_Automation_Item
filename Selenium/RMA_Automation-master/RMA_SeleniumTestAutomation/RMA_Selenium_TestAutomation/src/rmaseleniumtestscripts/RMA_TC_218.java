...
//================================================================================================
//TestCaseID     : RMA_TC_218
//Description    : TC_218_Verify Adding,Editing And Deleting Of New Other Person As Person Involved on General Claim
//Depends On TC  : RMA_TC_214
//Revision       : 0.0 -RenuVerma-07-22-2016 
//=================================================================================================

public class RMA_TC_218 extends RMA_TC_BaseTest {
	...
	@Test
	public void RMA_TC_218_Test() throws Exception,Error {

		try{
			parentlogger = reports.startTest("TC_218_Adding, Editing And Deleting Of New Other Person On General Claim", "Verify Adding,Editing And Deleting Of New Other Person As Person Involved on General Claim");
			parentlogger.assignAuthor("Renu Verma");

			String StrOtherPersonLastName_218;
			String OtherPersonLastNameChanged_218;
			String OtherPersonLastNameChanged_Actual_218;
			String StrClaimNaumberActual;
			//Local Variable Declaration Completed Here

			StrScreenShotTCName = "TC_218";
			testcall1 = false;	
			testcall2 = false;	
			...
			//===============================================Addition Of Other Person On Claim Created in TC_214 Is Started Here=====================================================================================================
			...
			testcall1 = true;
			StrOtherPersonLastName_218 = RMA_Functionality_Utility.RMA_PIAddNewEntity_Utility("Other Person", logval1);
			parentlogger.log(LogStatus.INFO, "New Other Person Is Created Successfully With Other Person Name::"+ " " + color.RMA_ChangeColor_Utility(StrOtherPersonLastName_218, 2));
			...
			OtherPersonLastNameChanged_218 = RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(4, "OtherPerson_218_");
			RMA_Input_Utility.RMA_SetValue_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "LastName TextBox On PI Other Person Page ", OtherPersonLastNameChanged_218, logval);
			...
			OtherPersonLastNameChanged_Actual_218 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(OtherPersonLastNameChanged_218, OtherPersonLastNameChanged_Actual_218 , "Other Person Last Name", logval);
			...
			parentlogger.log(LogStatus.INFO, "The Functional Utility :" +" " +"RMA_GenericDelete_Utility Is Called To Delete A Other Person :" +" "+ color.RMA_ChangeColor_Utility(OtherPersonLastNameChanged_218, 2));
			testcall2 = true;
			RMA_Functionality_Utility.RMA_GenericDelete_Utility("PI Other Person Page", logval1);
			parentlogger.log(LogStatus.INFO, "Other Person Is Deleted Successfully::"+ " " + color.RMA_ChangeColor_Utility(OtherPersonLastNameChanged_218, 2));
