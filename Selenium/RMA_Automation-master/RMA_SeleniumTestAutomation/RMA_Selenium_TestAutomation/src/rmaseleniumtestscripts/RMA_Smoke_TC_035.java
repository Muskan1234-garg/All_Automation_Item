...
//Description    : Send Mail Functionality For A Payment Is Validated
...
//Send Mail Functionality For A Claim Is Validated
{
	try {
		...
		parentlogger = reports.startTest("RMA_Smoke_TC_035_Send Mail Verification", "Send Mail Functionality For A Payment Is Validated");
		...
		RMAApp_SendMail_Txt_To = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_Smoke_TC_035", 1, 1); //To Email ID Is Fetched From DataSheet RMA_Smoke_TC_035
		RMAApp_SendMail_Txt_CC = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_Smoke_TC_035", 1, 2); //CC Email ID  Is Fetched From DataSheet RMA_Smoke_TC_035
		RMAApp_SendMail_Txt_Body = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_Smoke_TC_035", 1, 0); //Mail Body Is Fetched From DataSheet RMA_Smoke_TC_035
