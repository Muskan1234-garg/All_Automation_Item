...
//================================================================================================
//TestCaseID     : RMA_Smoke_TC_092_WC_C
//Description    : Successfully Reverted All The Setting Of Internal Policy Tracking For Workers' Comp Claim Is Validated
//Depends On TC  : RMA_Smoke_TC_087_WC, RMA_Smoke_TC_088_WC
//Revision       : 0.0 - RenuVerma-01-12-2017
//=================================================================================================

public class RMA_Smoke_TC_092_WC_C extends RMA_TC_BaseTest {
	...
	@Test
	public void RMA_Smoke_TC_092_WC_C_Test() throws Exception,Error {

		try{
			parentlogger = reports.startTest("Smoke_TC_092_WC_C_ Revert All The Setting Of Internal Policy Tracking For Workers' Comp Claim", "Successfully Reverted All The Setting Of Internal Policy Tracking For Workers' Comp Claim Is Validated");
			...
			StrScreenShotTCName = "RMA_Smoke_TC_092_WC_C";
			testcall1 = false;
			...
			RMA_Functionality_Utility.RMA_StandardSearch_Screen(RMA_POM_Search.RMAApp_SearchClaims_Txt_ClaimNumber(driver)," Search-->Claim Criteria Page","Claim Number Text Box",RMA_Smoke_TC_088_WC.StrClaimNumber_Smoke_088_WC, RMA_Smoke_TC_088_WC.StrClaimNumber_Smoke_088_WC, RMA_Smoke_TC_088_WC.StrClaimNumber_Smoke_088_WC,"num",2, logval);
			StrClaimNumberActual = RMA_Selenium_POM_WorkersComp.RMAApp_WorkersComp_Txt_ClaimNumber(driver).getAttribute("value");
			RMA_Verification_Utility.RMA_TextCompare(RMA_Smoke_TC_088_WC.StrClaimNumber_Smoke_088_WC, StrClaimNumberActual, "Workers' comp Claim Number", logval);
			parentlogger.log(LogStatus.INFO, "The Functional Utility :" +RMA_GenericUsages_Utility.RMA_LoggerHyperlink("DeleteLink", "RMA_GenericDelete_Utility",0)+" Is Called To Delete A Claim :" +" "+ color.RMA_ChangeColor_Utility(RMA_Smoke_TC_088_WC.StrClaimNumber_Smoke_088_WC, 2));
			testcall1= true;
			RMA_Functionality_Utility.RMA_GenericDelete_Utility("Claim Page", logval1);
			parentlogger.log(LogStatus.INFO, "Claim Is Deleted Successfully With Claim No. ::"+ " " + color.RMA_ChangeColor_Utility(RMA_Smoke_TC_088_WC.StrClaimNumber_Smoke_088_WC, 2));
			...
			RMA_Navigation_Utility.RMA_SelectWTObjectByValue_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_Table_Lookup(driver), RMA_Smoke_TC_087_WC.StrPolicyName_Smoke_TC_087_WC, "LINK", logval);
			driver.switchTo().window(PrimaryWindowHandle);
			RMA_GenericUsages_Utility.RMA_DynamicFrameSwitching(ParentFrame);
			RMA_GenericUsages_Utility.RMA_DynamicFrameSwitching("Policy Tracking");
			CurrentFrameId=RMA_GenericUsages_Utility.RMA_GetCurrentFrameID();
			parentlogger.log(LogStatus.INFO, "The Functional Utility :" +RMA_GenericUsages_Utility.RMA_LoggerHyperlink("DeleteLink", "RMA_GenericDelete_Utility",1)+" Is Called To Delete A Policy :" +" "+ color.RMA_ChangeColor_Utility(RMA_Smoke_TC_087_WC.StrPolicyName_Smoke_TC_087_WC, 3));
			testcall2 = true;
			...
			RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_Home.RMAApp_Generic_Img_Lookup(driver), "Lookup Image On Policy Tracking Page", logval);
			RMA_GenericUsages_Utility.RMA_WindowSwitching_Utility();
			RMA_NegativeVerification_Utility.RMA_ElementNotExist_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_RMAAppLink(driver,String.valueOf(RMA_Smoke_TC_087_WC.StrPolicyNum_Smoke_TC_087_WC)), String.valueOf(RMA_Smoke_TC_087_WC.StrPolicyName_Smoke_TC_087_WC) + " Policy Link", logval);
			...
			RMA_Navigation_Utility.RMA_SelectWTObjectByValue_Utility(RMA_Selenium_POM_Utilities_Managers.RMAApp_ManagersFinanKey_Tbl_FinancialKeyGrid(driver),RMA_Smoke_TC_087_WC.PolicyDetailOnMaintTable_Smoke_TC_087_WC , "RADIOBUTTON", logval);
			...
			RMA_NegativeVerification_Utility.RMA_ElementNotExist_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_RMAAppText(driver, RMA_Smoke_TC_087_WC.PolicyDetailOnMaintTable_Smoke_TC_087_WC), RMA_Selenium_POM_Home.RMAApp_Generic_RMAAppText(driver, RMA_Smoke_TC_087_WC.PolicyDetailOnMaintTable_Smoke_TC_087_WC)+"Policy Description", logval);
			parentlogger.log(LogStatus.INFO, "Financial Key Setting Is Deleted Successfully For Policy  ::"+ " " + color.RMA_ChangeColor_Utility(RMA_Smoke_TC_087_WC.PolicyDetailOnMaintTable_Smoke_TC_087_WC, 3));
			driver.switchTo().parentFrame();
			...
			RMA_Navigation_Utility.RMA_SelectWTObjectByValue_Utility(RMA_Selenium_POM_Maintenance_TableMaintenance.RMAApp_MaintTableMaintenance_Tbl_CodeMaint(driver),RMA_Smoke_TC_087_WC.PolicyDescription_Smoke_TC_087_WC , "RADIOBUTTON", logval);
			...
			globalWait.until(ExpectedConditions.attributeContains(RMA_Selenium_POM_Maintenance_TableMaintenance.RMAApp_MaintTableMaintenance_Txt_Code(driver), "value",RMA_Smoke_TC_087_WC.StrPolicyCode_Smoke_TC_087_WC));
			...
			RMA_NegativeVerification_Utility.RMA_ElementNotExist_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_RMAAppText(driver, RMA_Smoke_TC_087_WC.PolicyDescription_Smoke_TC_087_WC), "Policy Description", logval);
			driver.switchTo().parentFrame();
			driver.switchTo().parentFrame();
