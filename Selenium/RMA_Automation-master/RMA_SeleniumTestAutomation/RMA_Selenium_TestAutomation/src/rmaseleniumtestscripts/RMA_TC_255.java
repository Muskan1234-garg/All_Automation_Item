...
//================================================================================================
//TestCaseID     : RMA_TC_255
//Description    : TC_255_Verify Adding,Editing And Deleting Of New Medical Staff As Person Involved For Event
//Depends On TC  : RMA_TC_246
//Revision       : 0.0 - RenuVerma-07-26-2016 
//=================================================================================================

public class RMA_TC_255 extends RMA_TC_BaseTest {
	...
	@Test
	public void RMA_TC_255_Test() throws Exception,Error {

		try{
			parentlogger = reports.startTest("TC_255_Adding,Editing And Deleting Of New Medical Staff As Person Involved", "Verify Adding,Editing And Deleting Of New Medical Staff As Person Involved For Event");
			parentlogger.assignAuthor("Renu Verma");

			String StrMedicalStaff_255;
			String StrMedicalStaffLastNameChanged_255;
			String StrMedicalLastNameChangedActual_255;			
			String StrEventNaumberActual;
			//Local Variable Declaration Completed Here

			StrScreenShotTCName = "TC_255";
			testcall1 = false;	
			testcall2 = false;	
			...
			//===============================================Addition Of New Medical Staff On Event Created in TC_246 Is Started Here=====================================================================================================
			...
			testcall1 = true;
			StrMedicalStaff_255 = RMA_Functionality_Utility.RMA_PIAddNewEntity_Utility("Medical Staff", logval1);
			parentlogger.log(LogStatus.INFO, "New Medical Staff Is Created Successfully With Medical Staff Name::"+ " " + color.RMA_ChangeColor_Utility(StrMedicalStaff_255, 2));
			...
			/*====================================================Addition Of New Medical Staff On Event Created in TC_246 Is Completed Here=======================================*/

			/*===============================================Editing Of An Existing Medical Staff Is Started Here================================*/
			StrMedicalStaffLastNameChanged_255 = RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(4, "MedicalStaff_255_");
			RMA_Input_Utility.RMA_SetValue_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "LastName TextBox On PI Medical Staff Page ", StrMedicalStaffLastNameChanged_255, logval);
			RMA_Functionality_Utility.RMA_GenericSave_Utility("pimedstaff", false,"NA","Persons Involved-->MedicalStaff Page", logval);
			StrMedicalLastNameChangedActual_255 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrMedicalStaffLastNameChanged_255, StrMedicalLastNameChangedActual_255 , "Medical Staff Last Name", logval);
			...
			parentlogger.log(LogStatus.INFO, "The Functional Utility :" +" " +"RMA_GenericDelete_Utility Is Called To Delete A Medical Staff : " +" " + color.RMA_ChangeColor_Utility(StrMedicalStaffLastNameChanged_255, 2));
			testcall2 = true;
			RMA_Functionality_Utility.RMA_GenericDelete_Utility("PI Medical Staff Page", logval1);
			parentlogger.log(LogStatus.INFO, "Medical Staff Is Deleted Successfully::"+ " " + color.RMA_ChangeColor_Utility(StrMedicalStaffLastNameChanged_255, 2));
