...
//================================================================================================
//TestCaseID     : RMA_TC_210
//Description    : TC_210_Verify Adding,Editing And Deleting Of New Other Person As Person Involved on Property Claim
//Depends On TC  : RMA_TC_206
//Revision       : 0.0 -RenuVerma-07-15-2016 
//=================================================================================================

public class RMA_TC_210 extends RMA_TC_BaseTest {
	...
	@Test
	public void RMA_TC_210_Test() throws Exception,Error {

		try{
			parentlogger = reports.startTest("TC_210_Adding, Editing And Deleting Of New Other Person On Property Claim", "Verify Adding,Editing And Deleting Of New Other Person As Person Involved on Property Claim");
			parentlogger.assignAuthor("Renu Verma");

			String StrOtherPersonLastName_210;
			String OtherPersonLastNameChanged_210;
			String OtherPersonLastNameChanged_Actual_210;
			String StrClaimNaumberActual;
			//Local Variable Declaration Completed Here

			StrScreenShotTCName = "TC_210";
			testcall1 = false;	
			testcall2 = false;	
			...
			//===============================================Addition Of Other Person On Claim Created in TC_206 Is Started Here=====================================================================================================
			...
			testcall1 = true;
			StrOtherPersonLastName_210 = RMA_Functionality_Utility.RMA_PIAddNewEntity_Utility("Other Person", logval1);
			parentlogger.log(LogStatus.INFO, "New Other Person Is Created Successfully With Other Person Name::"+ " " + color.RMA_ChangeColor_Utility(StrOtherPersonLastName_210, 2));
			...
			OtherPersonLastNameChanged_210 = RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(4, "OtherPerson_210");
			RMA_Input_Utility.RMA_SetValue_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "LastName TextBox On PI Other Person Page ", OtherPersonLastNameChanged_210, logval);
			...
			OtherPersonLastNameChanged_Actual_210 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(OtherPersonLastNameChanged_210, OtherPersonLastNameChanged_Actual_210 , "Other Person Last Name", logval);
			parentlogger.log(LogStatus.INFO, parentlogger.addScreenCapture(RMA_ScreenCapture_Utility.RMA_ScreenShotCapture_Utility(driver, "Other Person Name Is Edited ", StrScreenShotTCName)));

			/*=================================================Editing Of New Other Person Is Completed Here=============================================*/

			/*===========================================================Deletion Of New Other Person Is Started Here================================================*/

			parentlogger.log(LogStatus.INFO, "The Functional Utility :" +" " +"RMA_GenericDelete_Utility Is Called To Delete A Other Person :" +" "+ color.RMA_ChangeColor_Utility(OtherPersonLastNameChanged_210, 2));
			testcall2 = true;
			RMA_Functionality_Utility.RMA_GenericDelete_Utility("PI Other Person Page", logval1);
			parentlogger.log(LogStatus.INFO, "Other Person Is Deleted Successfully::"+ " " + color.RMA_ChangeColor_Utility(OtherPersonLastNameChanged_210, 2));
