...
//================================================================================================
//TestCaseID     : RMA_TC_289
//Description    : TC_289_Verify Adding,Editing And Deleting Of New Patient As Person Involved For Workers' Comp Claim At Policy level
//Depends On TC  : RMA_TC_284
//Revision       : 0.0 - RenuVerma-09-14-2016  
//=================================================================================================

public class RMA_TC_289 extends rmaseleniumtestscripts.RMA_TC_BaseTest {
	...
	@Test 
	public void RMA_TC_289_Test () throws Exception, Error
	{
		parentlogger = reports.startTest("TC_289_Verify Adding,Editing And Deleting Of New Patient As Person Involved For Workers' Comp Claim At Policy level", "Verify Adding,Editing And Deleting Of New Patient As Person Involved For Workers' Comp Claim At Policy level");
		parentlogger.assignAuthor("Renu Verma");
		try {
			String StrPatientLastName_289;
			String StrEditedPatientLastName_Actual_289;
			String StrEditedPatientLastName_289;
			...
			//===============================================Addition Of Patient On Workers' comp Created in TC_284 Is Started Here=====================================================================================================
			driver.switchTo().parentFrame();
			RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_Home.RMAApp_LeftHandNavTree_Img_ExpandCollapse(driver, RMA_TC_284.StrClaimNumber_284), "Expand Image Corresponding To General Link On Left Navigation Tree", logval);
			...
			testcall1 = true;
			StrPatientLastName_289 = RMA_Functionality_Utility.RMA_PIAddNewEntity_Utility("Patient", logval1);
			parentlogger.log(LogStatus.INFO, "New Patient Is Created Successfully With Patient Name::"+ " " + color.RMA_ChangeColor_Utility(StrPatientLastName_289, 2));
		...
		//===============================================Addition Of Patient On Workers' comp Created in TC_284 Is Completed =================================================================================================================================================
			
			
			//===============================================Steps To Edit The Patient Added As Persons Involved Started ======================================================================================================================================================
			StrEditedPatientLastName_289 = RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(4, "Patient_289_");
			RMA_Input_Utility.RMA_SetValue_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "LastName TextBox On Persons Involved-->Patient Page", StrEditedPatientLastName_289, logval);
			RMA_Functionality_Utility.RMA_GenericSave_Utility("pipatient",false,"NA","Persons Involved-->Patient Page", logval);
			StrEditedPatientLastName_Actual_289 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrEditedPatientLastName_289, StrEditedPatientLastName_Actual_289 , "Patient Last Name Value",logval);
			...
			parentlogger.log(LogStatus.INFO, "Following Utility :" +" " +"RMA_GenericDelete_Utility Is Called To Delete The Patient"+ " "+ color.RMA_ChangeColor_Utility(StrEditedPatientLastName_Actual_289, 2) +" " +"Added As Persons Involved");
			testcall2 = true;
			RMA_Functionality_Utility.RMA_GenericDelete_Utility("Persons Involved-->Patient Page", logval1);
			parentlogger.log(LogStatus.INFO, "Patient Added As Persons Involved Is Deleted Successfully::"+ " " + color.RMA_ChangeColor_Utility(StrEditedPatientLastName_Actual_289, 2));
