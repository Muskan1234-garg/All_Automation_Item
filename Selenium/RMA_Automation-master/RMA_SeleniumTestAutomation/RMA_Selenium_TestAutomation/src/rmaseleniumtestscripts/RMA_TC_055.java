...
//================================================================================================
//TestCaseID     : RMA_TC_055
//Description    : Hold Transaction Created In RMA_TC_052 Is Not Listed In Top Level Manager's List Is Validated
//Depends On TC  : TC_064, TC_051, TC_052
//Revision       : 0.0 - KumudNaithani-02-03-2016 
//Revision       : 0.0 - ImteyazAhmad-08-10-2016
//=================================================================================================

public class RMA_TC_055 extends rmaseleniumtestscripts.RMA_TC_BaseTest {
	...
	@Test 
	public void RMA_TC_055_Test () throws Exception, Error
	//Verify That Hold Transaction Is Not Listed In Top Level Managers List List
	{
		try {
			parentlogger = reports.startTest("TC_055_Hold Transaction Not Listed In Top Level Managers List", "Hold Transaction Created In RMA_TC_052 Is Not Listed In Top Level Managers List Is Validated");
			String StrAccept;
			...
			RMAApp_Login_Txt_UserName = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_055", 1, 0); //UserName Fetched From DataSheet RMA_TC_055
			RMAApp_Login_Txt_Password = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_055", 1, 1); //Password Fetched From DataSheet RMA_TC_055
			...
			//===============================================Non Existence Of Payment Created In TC_052 In SuperVisory Approval Page Validation Is Started==========================================================================================================================================================================================================================================================================
			...
			if (RMA_Selenium_POM_Funds_SprApproval.RMAApp_SprApproval_PaymntNoRecordsAvailable(driver).isDisplayed() )
			{
				...
				Strlogstatement  = "Record With Control Number" + " " + RMA_TC_052.StrControlNumber_RMA_TC_01_052 + " " + "Does Not Exist In Payment UXGrid On Supervisory Approval Page";
				parentlogger.log(LogStatus.PASS, Strlogstatement);
				parentlogger.log(LogStatus.INFO, logger.addScreenCapture(RMA_ScreenCapture_Utility.RMA_ScreenShotCapture_Utility(driver, "Payment $2500 Not Listed For Top Level Manager' List Verification", StrScreenShotTCName)));
				...
				parentlogger.log(LogStatus.PASS, Strlogstatement);
				parentlogger.log(LogStatus.INFO, logger.addScreenCapture(RMA_ScreenCapture_Utility.RMA_ScreenShotCapture_Utility(driver, "Payment $2000 Not Listed For Top Level Manager' List Verification Verification", StrScreenShotTCName)));
			...
			else
			{
				...
				RMA_Verification_Utility.RMA_VerifyRecordNotExistInUXGrid_Utility(RMA_TC_052.StrControlNumber_RMA_TC_01_052, "Payment UXGrid On Supervisory Approval Page", logval);
			...
			//===============================================Non Existence Of Payment Created In TC_052 In SuperVisory Approval Page Validation Is Completed=========================================================================================================================================================================================================================================================================
