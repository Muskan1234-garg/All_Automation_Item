...
//================================================================================================
//TestCaseID     : RMA_TC_239
//Description    : TC_239_Verify Adding,Editing And Deleting Of new Employee As Person Involved For Vehicle Accident Claim
//Depends On TC  : RMA_TC_238
//Revision       : 0.0 - RenuVerma-07-26-2016 
//=================================================================================================

public class RMA_TC_239 extends RMA_TC_BaseTest {
	...
	@Test
	public void RMA_TC_239_Test() throws Exception,Error {

		try{
			parentlogger = reports.startTest("TC_239_Adding, Editing And Deleting Of New Employee On Vehicle Accident Claim", "Verify Adding,Editing And Deleting Of New Employee As Person Involved For Vehicle Accident Claim");
			parentlogger.assignAuthor("Renu Verma");

			String StrEmployeeNumber_239;
			String StrEmployeeLastNameActual_239;
			String StrEmployeeNameChanged_239;
			String StrClaimNaumberActual;
			//Local Variable Declaration Completed Here
			
			StrScreenShotTCName = "TC_239";
			testcall1 = false;	
			testcall2 = false;	
			...
			testcall1 = true;
			StrEmployeeNumber_239 = RMA_Functionality_Utility.RMA_PIAddNewEntity_Utility("Employee", logval1);
			parentlogger.log(LogStatus.INFO, "New Employee Is Created Successfully With Employee Number::"+ " " + color.RMA_ChangeColor_Utility(StrEmployeeNumber_239, 2));
			...
			StrEmployeeNameChanged_239 = RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(4, "EmpName_239_");
			RMA_Input_Utility.RMA_SetValue_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "LastName TextBox On PI Employee Page ", StrEmployeeNameChanged_239, logval);
			RMA_Functionality_Utility.RMA_GenericSave_Utility("piemployee", false, "NA","Persons Involved-->Employee Page", logval);
			StrEmployeeLastNameActual_239 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrEmployeeNameChanged_239, StrEmployeeLastNameActual_239 , "EmployeeLast Name", logval);
			...
			parentlogger.log(LogStatus.INFO, "The Functional Utility :" +" " +"RMA_GenericDelete_Utility Is Called To Delete An Employee : " +" "+ color.RMA_ChangeColor_Utility(StrEmployeeNameChanged_239, 2));
			testcall2 = true;
			RMA_Functionality_Utility.RMA_GenericDelete_Utility("PI Employee Page", logval1);
			parentlogger.log(LogStatus.INFO, "Employee Is Deleted Successfully ::"+ " " + color.RMA_ChangeColor_Utility(StrEmployeeNameChanged_239, 2));
