...
public class RMA_Verification_Utility extends rmaseleniumtestscripts.RMA_TC_BaseTest{
 ...
 static RMA_GenericUsages_Utility color = new RMA_GenericUsages_Utility();
	...
	//====================================================================================================
	public static void RMA_UnsavedChangeVerification_Utility(String ObjPageDesc, int logval) throws Exception, Error
	{
		try {
			String Expmsg;
			String ExpBoolVal = Boolean.toString(true);
			Expmsg = "This screen has unsaved data!";
			RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_Home.RMAApp_DefaultView_Img_Reload(driver), "Reload Image On" + " "+ObjPageDesc+ " ", logval);
			//RMA_GenericUsages_Utility.RMA_StaticWait(3, logval, "Wait Is Added As Reload Image Is Clicked");
			...
			boolvalue = RMA_GenericUsages_Utility.RMA_WindMsgHandlerAndTextVerify_Utility("Yes", "Partial", Expmsg, "Message To Verify Unsaved Data Existence For" + " "+ ObjPageDesc, logval);
			if(ExpBoolVal == Boolean.toString(boolvalue)){
				if (logval == 0)
				{
					parentlogger.log(LogStatus.PASS, "Expected Value" + " "+ color.RMA_ChangeColor_Utility(ExpBoolVal, 3) + " " + "And Actual Value" + " " + color.RMA_ChangeColor_Utility(Boolean.toString(boolvalue), 2) + " "  + "Are Same And Hence" + " " + "No Alert Message Related To Unsaved Data Is Present On" + " "+color.RMA_ChangeColor_Utility(ObjPageDesc, 4));
				}
				else
				{

					logger.log(LogStatus.PASS, "Expected Value" + " "+ color.RMA_ChangeColor_Utility(ExpBoolVal, 3) + " " + "And Actual Value" + " " + color.RMA_ChangeColor_Utility(Boolean.toString(boolvalue), 2) + " "  + "Are Same And Hence" + " " + "No Alert Message Related To Unsaved Data Is Present On" + " "+color.RMA_ChangeColor_Utility(ObjPageDesc, 4));
				}
			}
			...
			else
			{
				if (logval == 0)
				{
					parentlogger.log(LogStatus.FAIL, "Expected Value" + " "+ color.RMA_ChangeColor_Utility(ExpBoolVal, 3) + " " + "And Actual Value" + " " + color.RMA_ChangeColor_Utility(Boolean.toString(boolvalue), 2) + " "  + "Are Not Same And Hence" + " " + "Alert Message Related To Unsaved Data Is Present On" + " "+color.RMA_ChangeColor_Utility(ObjPageDesc, 4));
				}
				else
				{

					logger.log(LogStatus.FAIL, "Expected Value" + " "+ color.RMA_ChangeColor_Utility(ExpBoolVal, 3) + " " + "And Actual Value" + " " + color.RMA_ChangeColor_Utility(Boolean.toString(boolvalue), 2) + " "  + "Are Not Same And Hence" + " " + "Alert Message Related To Unsaved Data Is Present On" + " "+color.RMA_ChangeColor_Utility(ObjPageDesc, 4));
				}	
			}
	...
	//====================================================================================================
	public static void RMA_VerifyUXGrid_Utility(String SearchedText, String UXGridDescription, String ExpectedValue1, int ExpectedCol1,String ExpectedValue2, int ExpectedCol2, int logval ) throws Exception,Error		
	{
		try
		{	
			...
			//WebElement ElementUXGrid = driver.findElement(By.xpath(".//*[@class='ui-grid-canvas']"));
			List<WebElement> UX_row = driver.findElements(By.xpath(".//*[@class='ui-grid-row ng-scope']"));
			System.out.println("Row Count Is : "+UX_row.size());
			outerloop:
				for(int i = 0; i< UX_row.size(); i++)
				{
					...
					//System.out.println("Col Count Is : "+UX_column.size());
					for(int j=0; j< UX_column.size(); j++)
					{
						SearchedTextActual = UX_column.get(j).getText().trim();
						//System.out.println("Text Is : "+SearchedTextActual);
			...
			if (Found == true)
			{
				...
				ActualText2 = UX_column.get(ExpectedCol2-1).getText().trim();
				if (ActualText1.equalsIgnoreCase(ExpectedValue1.trim()) && ActualText2.equalsIgnoreCase(ExpectedValue2.trim()))
				{
					if (logval == 0)
					{
						parentlogger.log(LogStatus.PASS, "Expected Values : " +" " +color.RMA_ChangeColor_Utility(ExpectedValue1,3) +" "+" And " +" " + color.RMA_ChangeColor_Utility(ExpectedValue2,3)+" "+" Are Matched With Actual Values :"+" " +color.RMA_ChangeColor_Utility(ActualText1,2) +" "+"And " +" " +color.RMA_ChangeColor_Utility(ActualText2,2) +" " +",In Column :" +" " +ExpectedCol1 +" " +"And " +" " +ExpectedCol2 +" " +"Respectively ,Corresponding To Indentifier SearchedText :" +" "  +color.RMA_ChangeColor_Utility(SearchedText,2) +", In"+" " +color.RMA_ChangeColor_Utility(UXGridDescription,4) +" "+", And Hence Verification Is Successfull");
				...
				else
				{
					if (logval == 0)
					{
						parentlogger.log(LogStatus.FAIL, "Expected Values : " +" " +color.RMA_ChangeColor_Utility(ExpectedValue1,3) +" "+" And " +" " + color.RMA_ChangeColor_Utility(ExpectedValue2,3)+" Are Not Matched With Actual Values :"+" " +color.RMA_ChangeColor_Utility(ActualText1,2) +" "+"And " +" " +color.RMA_ChangeColor_Utility(ActualText2,2) +" " +",In Column :" +" " +ExpectedCol1 +" " +"And " +" " +ExpectedCol2 +" " +"Respectively ,Corresponding To Indentifier SearchedText :" +" "  +color.RMA_ChangeColor_Utility(SearchedText,2) +", In"+" " +color.RMA_ChangeColor_Utility(UXGridDescription,4) +" "+color.RMA_ChangeColor_Utility(", And Hence Verification Is Not Successfull",1));
					}
					else
					{ 
						logger.log(LogStatus.FAIL, "Expected Values : " +" " +color.RMA_ChangeColor_Utility(ExpectedValue1,3) +" "+" And " +" " + color.RMA_ChangeColor_Utility(ExpectedValue2,3)+" Are Not Matched With Actual Values :"+" " +color.RMA_ChangeColor_Utility(ActualText1,2) +" "+"And " +" " +color.RMA_ChangeColor_Utility(ActualText2,2) +" " +",In Column :" +" " +ExpectedCol1 +" " +"And " +" " +ExpectedCol2 +" " +"Respectively ,Corresponding To Indentifier SearchedText :" +" "  +color.RMA_ChangeColor_Utility(SearchedText,2) +", In"+" " +color.RMA_ChangeColor_Utility(UXGridDescription,4) +" "+color.RMA_ChangeColor_Utility(", And Hence Verification Is Not Successfull",1));
					}
					Assert.fail();
				}	
			}
	...
	//Revision			: 0.0 - ImteyazAhmad-06-22-2016                               
	//====================================================================================================
	public static void RMA_VerifyUXGridPartially_Utility(String SearchedText, String UXGridDescription, String ExpectedValue1, int ExpectedCol1,String ExpectedValue2, int ExpectedCol2, int logval ) throws Exception,Error		
	{
		try
		{	
			String ActualText1 = null;
			...
			//WebElement ElementUXGrid = driver.findElement(By.xpath(".//*[@class='ui-grid-canvas']"));
			ExpectedValue1 = ExpectedValue1.toUpperCase().trim();
			ExpectedValue2 = ExpectedValue2.toUpperCase().trim();
			List<WebElement> UX_row = driver.findElements(By.xpath(".//*[@class='ui-grid-row ng-scope']"));
			System.out.println("Row Count Is : "+UX_row.size());
			outerloop:
				for(int i = 0; i< UX_row.size(); i++)
				{
					...
					for(int j=0; j< UX_column.size(); j++)
					{
						SearchedTextActual = UX_column.get(j).getText();
						//System.out.println("Text Is : "+SearchedTextActual);
						if (SearchedTextActual.equalsIgnoreCase(SearchedText))
						{
							//System.out.println("ActualSearchedText Is : "+SearchedTextActual);
							FoundRow = i;
							Found = true;
							break outerloop;
						}
			...
			if (Found == true)
			{
				WebElement Element =UX_row.get(FoundRow).findElement(By.xpath(".//*[@class='ng-isolate-scope']"));
				List<WebElement> UX_column = Element.findElements(By.cssSelector("div[class^='ui-grid-cell ng-scope ui-grid-coluiGrid']"));
				ActualText1 = UX_column.get(ExpectedCol1-1).getText();
				ActualText1 = ActualText1.toUpperCase().trim(); 
				ActualText2 = UX_column.get(ExpectedCol2-1).getText();
				ActualText2 = ActualText2.toUpperCase().trim();
				if (ActualText1.contains(ExpectedValue1) && ActualText2.contains(ExpectedValue2))
				{
					if (logval == 0)
					{
						parentlogger.log(LogStatus.PASS, "Expected Values : " +" " +color.RMA_ChangeColor_Utility(ExpectedValue1,3) +" "+" And " +" " + color.RMA_ChangeColor_Utility(ExpectedValue2,3)+" "+" Are Contained In Actual Values :"+" " +color.RMA_ChangeColor_Utility(ActualText1,2) +" "+"And " +" " +color.RMA_ChangeColor_Utility(ActualText2,2) +" " +",In Column :" +" " +ExpectedCol1 +" " +"And " +" " +ExpectedCol2 +" " +"Respectively ,Corresponding To Indentifier SearchedText :" +" "  +color.RMA_ChangeColor_Utility(SearchedText,2) +", In"+" " +color.RMA_ChangeColor_Utility(UXGridDescription,4) +" "+", And Hence Verification Is Successfull");
						parentlogger.log(LogStatus.INFO, parentlogger.addScreenCapture(RMA_ScreenCapture_Utility.RMA_ScreenShotCapture_Utility(driver, "UX Grid Verfication", UXGridDescription)));
					}
					else
					{
				...
				else
				{
					if (logval == 0)
					{
						parentlogger.log(LogStatus.FAIL, "Expected Values : " +" " +color.RMA_ChangeColor_Utility(ExpectedValue1,3) +" "+" And " +" " + color.RMA_ChangeColor_Utility(ExpectedValue2,3)+" Are Not Contained In Actual Values :"+" " +color.RMA_ChangeColor_Utility(ActualText1,2) +" "+"And " +" " +color.RMA_ChangeColor_Utility(ActualText2,2) +" " +",In Column :" +" " +ExpectedCol1 +" " +"And " +" " +ExpectedCol2 +" " +"Respectively ,Corresponding To Indentifier SearchedText :" +" "  +color.RMA_ChangeColor_Utility(SearchedText,2) +", In"+" " +color.RMA_ChangeColor_Utility(UXGridDescription,4) +" "+color.RMA_ChangeColor_Utility(", And Hence Verification Is Not Successfull",1));
					}
					else
					{ 
						logger.log(LogStatus.FAIL, "Expected Values : " +" " +color.RMA_ChangeColor_Utility(ExpectedValue1,3) +" "+" And " +" " + color.RMA_ChangeColor_Utility(ExpectedValue2,3)+" Are Not Contained In Actual Values :"+" " +color.RMA_ChangeColor_Utility(ActualText1,2) +" "+"And " +" " +color.RMA_ChangeColor_Utility(ActualText2,2) +" " +",In Column :" +" " +ExpectedCol1 +" " +"And " +" " +ExpectedCol2 +" " +"Respectively ,Corresponding To Indentifier SearchedText :" +" "  +color.RMA_ChangeColor_Utility(SearchedText,2) +", In"+" " +color.RMA_ChangeColor_Utility(UXGridDescription,4) +" "+color.RMA_ChangeColor_Utility(", And Hence Verification Is Not Successfull",1));
					}
					Assert.fail();
				}	
			}
	...
	//============================================================================================
	public static void RMA_SikuliPatternExist_Utility(Pattern pattern, String ObjectDescription, int logval) throws Exception, Error
	{
		try {
			if (pattern != null)
			{
	...
	//============================================================================================
		...
		public static void RMA_VerifyUXSpinnerDisappered( int logval) throws Exception, Error
		{
			...
			try {
				...
				if (logval ==0)
				{
					parentlogger.log(LogStatus.PASS, "UX Spinner Is Getting Dissappeared From Application Screen, Hence We Can Continue With Testing");
				}
				else
				{
					logger.log(LogStatus.PASS, "UX Spinner Is Getting Dissappeared From Application Screen, Hence We Can Continue With Testing");
				}
			} catch (Exception|Error e) {
				if (logval ==0)
				{
		...
		public static void RMA_VerifyUXErrorMessage( String Message,boolean IsCloseRequired,String ObjPageDescription, int logval) throws Exception, Error
		{
			//String CurrentFrameId;
			try {
				RMA_Verification_Utility.RMA_ElementExist_Utility(RMA_Selenium_POM_Home.RMAApp_Genereic_UX_ToastMessage(driver, Message ), Message+ " Message On " + ObjPageDescription, logval);
				if(IsCloseRequired)
				RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_Home.RMAApp_Genereic_UX_ToastCloseButton(driver), "Error Toast Close Button On "+ ObjPageDescription, logval);			
			} catch (Exception|Error e) {
					throw (e);
			}
		}
...
System.out.println("toolTipText: "+ ActualToolTipText);
			...
			outerloop:
				for(int i = 0; i< UX_row.size(); i++) // run the loop to which DOM row matching with the given expected SearchedText
				{
					...
					for(int j=0; j< UX_column.size(); j++)// run the loop to which DOM column to the corresponding row matching with the given expected SearchedText
					{
						...
						{
							System.out.println("Text Is : "+SearchedText+"SearchedTextActual Is : "+SearchedTextActual );
