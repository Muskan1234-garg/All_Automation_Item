...
//================================================================================================
//TestCaseID     : RMA_TC_016
//Description    : RMA_TC_016_ Successful Creation Of A Diary From Event Is Validated
//Depends On TC  : RMA_Smoke_TC_001
//Revision       : 0.0 - RenuVerma-03-06-2017
//=================================================================================================

public class RMA_TC_016 extends rmaseleniumtestscripts.RMA_TC_BaseTest {
	...
	@Test
	public void RMA_TC_016_Test() throws Exception,Error {

		try{
			parentlogger = reports.startTest("RMA_TC_016_ Attach A Diary From Event", "Successful Creation Of A Diary From Event Is Validated");
			...
			ActivityList = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_016", 1, 0); // Activity List Is Fetched From DataSheet RMA_TC_016
			testcall1 = false;			
			loggerval1 = "NotInitialized";
			StrScreenShotTCName = "RMA_TC_016";
			...
			RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_Home.RMAApp_Generic_Img_Diary(driver), "Diary Image On  Event Page",logval);
			DiaryTaskName = RMA_Functionality_Utility.RMA_AttachCreateEdit_Diary("Attach","NA", ActivityList,"NA","NA", "NA", logval);
			parentlogger.log(LogStatus.INFO, "Diary Is Created Successfully With TaskName :"+" "+color.RMA_ChangeColor_Utility(DiaryTaskName, 3)+" "+"On Event Page");							
			RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_Home.RMAApp_Generic_Img_ViewRecordDiaries(driver), "View Record Diaries Image On  Event Page", logval);
