...
//Description    : RMA_TC_012_ Successful Creation Of A Diary From Litigation Is Validated
...
public class RMA_TC_012 extends rmaseleniumtestscripts.RMA_TC_BaseTest {
	...
	public void RMA_TC_012_Test() throws Exception,Error {
		...
		try{
			parentlogger = reports.startTest("RMA_TC_012_ Attach A Diary From Litigation", "Successful Creation Of A Diary From Litigation Is Validated");
			...
			ActivityList = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_012", 1, 0); // Activity List Is Fetched From DataSheet RMA_TC_012
			testcall1 = false;			
			...
			testcall1 = true;
			StrLitigation = RMA_Functionality_Utility.RMA_ClaimEntityAddition_Utility("Litigation", "Litigation (0)", StrClaimNumber_002, "Not Required", "Not Required", "Not Required", "Not Required", "Not Required", "Not Required", "Not Required", logval1);
			parentlogger.log(LogStatus.INFO, "New Litigation Is Created Successfully With Last Name::"+ " " + color.RMA_ChangeColor_Utility(StrLitigation, 3));
