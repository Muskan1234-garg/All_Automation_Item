...
<xsl:template name="summary">
	...
	<table align="center" class="details" border="0" cellpadding="5" cellspacing="2" width="95%">
		...
		<tr valign="top">
			...
			<xsl:variable name="allTotalTimeinsec" select="$allTotalTime div 1000" />
			...
			<xsl:variable name="allThroughput" select="$allCount div $allTotalTimeinsec" />
...
<xsl:template name="pagelist">
	...
	<table align="center" class="details" border="0" cellpadding="5" cellspacing="2" width="95%">
		<tr valign="top">
			<th>URL</th>
			<th>Initial Users In Transaction</th>
			<th>Failures</th>
			<th>Successful Users In Transaction</th>
			<th>Success Rate</th>
			<th>Min Time</th>
			<th>Average Time</th>
			<th>Max Time</th>
		...
		<xsl:for-each select="/testResults/*[not(@lb = preceding::*/@lb)]">
			...
			<xsl:variable name="users" select="$count - $failureCount" />
...
<xsl:template name="display-time">
	<xsl:param name="value" />
	<xsl:value-of select="format-number(($value div 1000),'0.00 s')" />
</xsl:template>
