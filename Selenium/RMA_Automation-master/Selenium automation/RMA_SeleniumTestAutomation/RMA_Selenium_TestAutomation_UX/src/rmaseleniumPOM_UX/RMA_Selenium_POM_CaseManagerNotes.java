...
public class RMA_Selenium_POM_CaseManagerNotes {
	...
	{
		Element = null;
		Element = driver.findElement(By.xpath(".//*[@id='btn_notestypecode']")); //Unique Id  Of Dated Notes Type Lookup Button On RMA Application Case Manager Notes Creation Page Is Fetched
		return Element;
	}
