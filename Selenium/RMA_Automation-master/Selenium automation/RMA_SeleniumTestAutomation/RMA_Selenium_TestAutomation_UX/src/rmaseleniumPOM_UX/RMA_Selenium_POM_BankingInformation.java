...
public class RMA_Selenium_POM_BankingInformation {
	...
	{
		Element =null;
		Element = driver.findElement(By.xpath(".//*[@id='btn_bankingstatus']")); //Unique Id Of Banking Status Button On RMA Application Banking Information Page Is Fetched
		return Element;
	}
	...
	{
		Element =null;
		Element = driver.findElement(By.xpath(".//*[@id='btn_accttypecode']")); //Unique Id Of Account Type Button On RMA Application Banking Information Page Is Fetched
		return Element;
	}
