...
public class RMA_Selenium_POM_Generic_Claims {
	...
	{
		Element = null;
		Element = driver.findElement(By.id("btn_jurisdiction")); //Unique x-path Of Jurisdiction Button On RMA Application Claim Page Is Fetched
		return Element;
	}
	...
	{
		Element = null;
		Element = driver.findElement(By.xpath(".//*[@id='ev_depteid']/p/input")); //Unique x-path Of DepartmentId Text Box On RMA Application Claim Page Is Fetched
		return Element;
	}
	...
	{
		Element = null;
		Element = driver.findElement(By.id("btn_filingstateid")); //Unique Id  Of Jurisdiction Search Button On RMA Application Worker Comp Claim Page Is Fetched
		return Element;
	}
	...
	{
		Element = null;
		Element = driver.findElement(By.id("lookup_ev_stateid")); //Unique Id  Of State TextBox On RMA Application Claim Page Is Fetched
		return Element;
	}
	//============================================================================================
	...
	{
		Element = null;
		Element = driver.findElement(By.xpath(".//*[@id='claimtypecode']/p/input")); //Unique ID Of Claim Type Text Box On RMA Application Claim Page Is Fetched
		return Element;
	}
	...
	{
		Element = null;
		Element = driver.findElement(By.id("btn_methodclosedcode")); //Unique Id  Of Close Method Look Up Button On RMA Application Claim Page Is Fetched
		return Element;
	}
	...
	{
		Element = null;
		Element = driver.findElement(By.xpath(".//*[@id='claimstatuscode']/p/input")); //Unique Id  Of Claim Status Text Box On RMA Application Claim Page Is Fetched
		return Element;
	}
	...
	{
		Element = null;
		Element = driver.findElement(By.xpath(".//*[@id='btn_policyLOBCode']")); 
		return Element;
	}
	...
	//Revision				: 0.0 - AbhishekRai-10-30-2017                                  
	//============================================================================================
	public static WebElement RMAApp_WorkersComp_Btn_QuickSummary(WebDriver driver)
	{
		Element = null;
	...
	{
		Element = null;
		Element = driver.findElement(By.xpath(".//*[@id='btn_pi_stateid']")); //Unique Id  Of  EventNumber TextBox On RMA Application Claim Page Is Fetched
		return Element;
	}
