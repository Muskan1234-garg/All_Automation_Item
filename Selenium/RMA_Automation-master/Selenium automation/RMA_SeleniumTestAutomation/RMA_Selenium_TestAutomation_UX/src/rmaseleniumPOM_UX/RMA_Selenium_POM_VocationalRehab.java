...
public class RMA_Selenium_POM_VocationalRehab {
	...
	{
		Element = null;
		Element = driver.findElement(By.xpath(".//*[@id='btn_rehabtype']")); //Unique Id  Of  Rehabilitation Type Lookup Button On RMA Application Case Management Creation Page Is Fetched
		return Element;
	}
	...
	{
		Element = null;
		Element = driver.findElement(By.xpath(".//*[@id='btn_rehabstatus']")); //Unique Id  Of  Rehabilitation Status Lookup Button On RMA Application Case Management Creation Page Is Fetched
		return Element;
	}
	...
	{
		Element = null;
		Element = driver.findElement(By.xpath(".//*[@id='btn_outcomes']")); //Unique Id  Of Outcomes Lookup Button On RMA Application Case Management Creation Page Is Fetched
		return Element;
	}
