...
public class RMA_Selenium_POM_Inspections {
	...
	{
		Element = null;
		Element = driver.findElement(By.xpath("//*[@class='material-icons material-icons-clr' and contains(text(),'save')]//ancestor::a[1]")); //Unique Id Of Save Image On Inspection Page Is Fetched
		return Element;
	}
}
