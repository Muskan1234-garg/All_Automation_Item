...
{
	Element = null;
	Element = driver.findElement(By.xpath(".//*[@id='subtypecode']/p/input")); //Unique Id Of Type Text Box On RMA Application Claim's Subrogation Page Is Fetched
	return Element;
}
...
{
	Element = null;
	Element = driver.findElement(By.xpath(".//*[@id='substatuscode']/p/input")); //Unique Id Of Status Text Box On RMA Application Claim's Subrogation Page Is Fetched
	return Element;
}
