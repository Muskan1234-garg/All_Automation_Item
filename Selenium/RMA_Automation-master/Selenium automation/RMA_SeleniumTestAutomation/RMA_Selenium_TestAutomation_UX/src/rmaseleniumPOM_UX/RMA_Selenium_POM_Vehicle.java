...
public class RMA_Selenium_POM_Vehicle {
	...
	{
		Element = null;
		Element = driver.findElement(By.xpath(".//*[@id='btnclose']/i")); //Unique Id Of Record Summary Cancel Button On Vehicle Page Is Fetched
		return Element;
	}
	...
	public static WebElement RMAApp_Vehicle_Accidents_Lnk_VehicleRightHandTree(WebDriver driver, String VehAcdText)
	{
		Element = null;
		try{
			Element = driver.findElement(By.xpath(".//*[contains(text(),'"+VehAcdText+"')and @class='rightPanel-alink ng-binding']")); //Unique X-path Of Vehicle Accidents Information Link On RMA Application Vehicle Page Is Fetched
		}catch(Exception|Error e){
		}
		return Element;
	}
