...
public class RMA_Selenium_POM_OrgHierarchy 
{
	...
	{
		Element = driver.findElement(By.id("addr1")); //Unique Id Of Address 1 TextBox On RMA Application Maintenance Org Hierarchy Page Is Fetched
		return Element;
	}
	//============================================================================================
	...
	{
		Element = driver.findElement(By.id("lookup_state")); //Unique Id Of State TextBox On RMA Application Maintenance Org Hierarchy Page Is Fetched
		return Element;
	}
	//============================================================================================
	...
	{
		Element = driver.findElement(By.id("btn_state")); //Unique Id Of State Button On RMA Application Maintenance Org Hierarchy Page Is Fetched
		return Element;
	}
	//============================================================================================
	...
	{
		Element = driver.findElement(By.id("btn_country")); //Unique Id Of Country Button On RMA Application Maintenance Org Hierarchy Page Is Fetched
		return Element;
	}
	/*============================================================================================
	...
	{
		Element = driver.findElement(By.id("zipCode")); //Unique Id  Of Entity Zip Code TextBox On RMA Application Maintenance Org Hierarchy Page Is Fetched
		return Element;
	}
	/*============================================================================================
	...
	{
		Element = driver.findElement(By.id("lookup_country")); //Unique Id Of Country TextBox On RMA Application Maintenance Org Hierarchy Page Is Fetched
		return Element;
	}
	//============================================================================================
