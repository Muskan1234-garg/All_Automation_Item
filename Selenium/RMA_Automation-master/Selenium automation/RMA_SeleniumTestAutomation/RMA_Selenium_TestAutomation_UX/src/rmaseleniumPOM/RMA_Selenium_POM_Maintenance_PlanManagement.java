...
//============================================================================================
//FunctionName 			: RMAApp_MaintPlanManagement_Btn_PlanStatus
//Description  			: To Fetch Unique PlanManagement (Such As Id, Xpath, Name ) On The Basis Of Which Plan Status Button On RMA Application's Maintenance-->PlanManagement Page Can Be Identified
//Input Parameter 		: Driver Variable Of The Type WebDriver		 
//Revision				: 0.0 - RenuVerma-11-10-2016                                  
//============================================================================================
public static WebElement RMAApp_MaintPlanManagement_Btn_PlanStatus(WebDriver driver)
{
	Element = driver.findElement(By.id("planstatuscode_codelookupbtn")); //Unique Id  Of Plan Status Button On RMA Application's Maintenance-->PlanManagement Page Is Fetched
	return Element;
}
