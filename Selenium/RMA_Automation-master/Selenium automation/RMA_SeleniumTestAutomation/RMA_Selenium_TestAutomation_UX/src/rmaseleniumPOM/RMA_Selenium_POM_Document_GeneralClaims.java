...
public class RMA_Selenium_POM_Document_GeneralClaims {
public static WebElement Element = null;

//============================================================================================
//FunctionName 			: RMAApp_GeneralClaim_Txt_EventNumber
...
// ============================================================================================
public static WebElement RMAApp_GeneralClaim_Txt_EventNumber(WebDriver driver)
{
...
// ============================================================================================
public static WebElement RMAApp_GeneralClaim_Txt_ClaimNumber(WebDriver driver)
{
...
//============================================================================================
//FunctionName 			: RMAApp_GeneralClaim_Txt_DateOfEvent
...
//Revision				: 0.0 - KumudNaithani-10-21-2015                                 
// ============================================================================================
public static WebElement RMAApp_GeneralClaim_Txt_DateOfEvent(WebDriver driver)
{
...
//============================================================================================
//FunctionName 			: RMAApp_GeneralClaim_Txt_TimeOfEvent
...
//Revision				: 0.0 - KumudNaithani-10-21-2015                                 
// ============================================================================================
public static WebElement RMAApp_GeneralClaim_Txt_TimeOfEvent(WebDriver driver)
{
...
//============================================================================================
//FunctionName 			: RMAApp_GeneralClaim_Txt_DateOfClaim
...
//Revision				: 0.0 - KumudNaithani-10-21-2015                                 
// ============================================================================================
public static WebElement RMAApp_GeneralClaim_Txt_DateOfClaim(WebDriver driver)
{
...
//============================================================================================
//FunctionName 			: RMAApp_GeneralClaim_Txt_TimeOfClaim
...
//Revision				: 0.0 - KumudNaithani-10-21-2015                                 
// ============================================================================================
public static WebElement RMAApp_GeneralClaim_Txt_TimeOfClaim(WebDriver driver)
{
...
//============================================================================================
//FunctionName 			: RMAApp_GeneralClaim_Txt_ClaimType
...
//Revision				: 0.0 - KumudNaithani-10-21-2015                                 
// ============================================================================================
public static WebElement RMAApp_GeneralClaim_Txt_ClaimType(WebDriver driver)
{
...
//============================================================================================
//FunctionName 			: RMAApp_GeneralClaim_Txt_Dept_Id
...
//Revision				: 0.0 - KumudNaithani-10-21-2015                                 
// ============================================================================================
public static WebElement RMAApp_GeneralClaim_Txt_Dept_Id(WebDriver driver)
{
...
{
	Element = driver.findElement(By.id("Document-2-1claimgcGeneral ClaimGeneral Claim (New)False")); //Unique Id  Of General Claim Frame On RMA Application Default View Page Is Fetched
	return Element;
}

//============================================================================================
//FunctionName 			: RMAApp_GeneralClaim_Txt_ClaimStatus
//Description  			: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which ClaimType TextBox On RMA Application General Claim Page Can Be Identified
//Input Parameter 		: Driver Variable Of The Type WebDriver		 
//Revision				: 0.0 - KumudNaithani-10-21-2015                                 
// ============================================================================================
public static WebElement RMAApp_GeneralClaim_Txt_ClaimStatus(WebDriver driver)
{
...
//============================================================================================
//FunctionName 			: RMAApp_GeneralClaim_Btn_Save
//Description  			: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which ClaimType TextBox On RMA Application General Claim Page Can Be Identified
//Input Parameter 		: Driver Variable Of The Type WebDriver		 
//Revision				: 0.0 - KumudNaithani-10-21-2015                                 
// ============================================================================================
public static WebElement RMAApp_GeneralClaim_Btn_Save(WebDriver driver)
{
...
//============================================================================================
//FunctionName 			: RMAApp_GeneralClaim_Txt_PolicyLOB
...
//Revision				: 0.0 - KumudNaithani-10-21-2015                                 
//============================================================================================
public static WebElement RMAApp_GeneralClaim_Txt_PolicyLOB(WebDriver driver)
{
...
//============================================================================================
//FunctionName 			: RMAApp_GeneralClaim_Img_ClaimStatusSrchBtn
...
//============================================================================================
public static WebElement RMAApp_GeneralClaim_Img_ClaimStatusSrchBtn(WebDriver driver)
{
...
//============================================================================================
//FunctionName 			: RMAApp_GeneralClaim_Lnk_Open
...
//Revision				: 0.0 - KumudNaithani-12-21-2015                                 
//============================================================================================
public static WebElement RMAApp_GeneralClaim_Lnk_Open(WebDriver driver)
{
...
//Description  			: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which Execution Summary Image On RMA Application General Claim Page Can Be Identified
//Input Parameter 		: Driver Variable Of The Type WebDriver		 
//Revision				: 0.0 - KumudNaithani-12-21-2015                                 
//============================================================================================
public static WebElement RMAApp_GeneralClaim_Img_ExecSummary(WebDriver driver)
{
	Element = driver.findElement(By.id("esumm")); //Unique Id Of Execution Summary Image On RMA Application General Claim Page Is Fetched
	return Element;
}
...
//Description  			: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which EnhancedNotes Image On RMA Application General Claim Page Can Be Identified
//Input Parameter 		: Driver Variable Of The Type WebDriver		 
//Revision				: 0.0 - KumudNaithani-07-26-2016                                
//============================================================================================
public static WebElement RMAApp_GeneralClaim_Img_EnhancedNotes(WebDriver driver)
{
	Element = driver.findElement(By.id("enhancednotes")); //Unique Id Of EnhancedNotes Image On RMA Application General Claim Page Is Fetched
	return Element;
}
//============================================================================================
//FunctionName 			: RMAApp_GeneralClaim_codelookup_policyLOBCode
//Description  			: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which Policy LOB code Lookup On RMA Application General Claim Page Can Be Identified
//Input Parameter 		: Driver Variable Of The Type WebDriver		 
//Revision				: 0.0 - RenuVerma-08-22-2016                                
//============================================================================================
public static WebElement RMAApp_GeneralClaim_codelookup_policyLOBCode(WebDriver driver)
{
	Element = driver.findElement(By.id("policyLOBCode_codelookup"));  //Unique Id Of EnhancedNotes Image On RMA Application General Claim Page Is Fetched
	return Element;
}

//============================================================================================
//FunctionName 			: RMAApp_GeneralClaim_Txt_CurrencyType
//Description  			: To Fetch Unique Property (Such As Id, Xpath, Name ) On The Basis Of Which Currency Type TextBox On RMA Application General Claim Page Can Be Identified
//Input Parameter 		: Driver Variable Of The Type WebDriver		 
//Revision				: 0.0 - RenuVerma-01-05-2017                                
//============================================================================================
public static WebElement RMAApp_GeneralClaim_Txt_CurrencyType(WebDriver driver)
{
	Element = driver.findElement(By.id("currencytypetext_codelookup"));  //Unique Id Of EnhancedNotes Image On RMA Application General Claim Page Is Fetched
	return Element;
}
