...
public class RMA_Selenium_POM_Sikuli_Images {
	...
	{
		pattern= new Pattern(System.getProperty("user.dir")+"\\RMASeleniumTestImages\\Cancel.jpeg");//Unique Images Of Open Button On RMA Application Download/Save Notification PopUp Is Fetched
		return pattern;
	}
