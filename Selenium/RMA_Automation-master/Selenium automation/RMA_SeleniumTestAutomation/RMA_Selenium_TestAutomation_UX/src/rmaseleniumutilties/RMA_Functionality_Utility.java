	...
	public static String RMA_ClaimEntityAddition_Utility(String Entity, String ClaimEntity, String Claim, String AdjSystemLogin, String Type, String Status, String Date, String Time, String User, String FinType, int logval) throws Exception, Error
	{
		...
		try {
			...
			case "Dated Text - Event": // Dated Text node under Event 				 
				...
				RMA_Input_Utility.RMA_ActionSetValue_Utility(StrDatedText, "TextEditor On Event Dated Text Page", logval);
			...
			case "Dated Text - Adjuster": // Dated Text node under Adjuster		 
				...
				RMA_GenericUsages_Utility.RMA_WindowSwitching_Utility();
				driver.manage().window().maximize();
				RMA_Input_Utility.RMA_ActionSetValue_Utility(StrDatedText, "TextEditor On Adjuster Dated Text Page", logval);
	...
	public static void RMA_MDIMenuClick_Utility(String MenuOption, int logval) throws Exception, Error
	{
		try {
			...
			case "Utilities-Managers-FinancialkeySetup":
				rmaseleniumutilties.RMA_Navigation_Utility.RMA_MDIMenuClick("Utilities;Managers;Financial key Setup", logval);
				break;

			case "Utilities-Managers-CodeRelationships":
				rmaseleniumutilties.RMA_Navigation_Utility.RMA_MDIMenuClick("Utilities;Managers;Code Relationships", logval);
				break;

			case "Utilities-Managers-LossCodeMapping":
				rmaseleniumutilties.RMA_Navigation_Utility.RMA_MDIMenuClick("Utilities;Managers;Loss Code Mapping", logval);
				break;

			case "Utilities-SystemParameters-GeneralSystemParameterSetup":
				rmaseleniumutilties.RMA_Navigation_Utility.RMA_MDIMenuClick("Utilities;System Parameters;General System Parameter Setup", logval);
				break;

			case "Utilities-SystemParameters-LineOfBusinessParameterSetup":
				rmaseleniumutilties.RMA_Navigation_Utility.RMA_MDIMenuClick("Utilities;System Parameters;Line Of Business Parameter Setup", logval);
				break;

			case "Utilities-SystemParameters-PaymentParameterSetup":
				rmaseleniumutilties.RMA_Navigation_Utility.RMA_MDIMenuClick("Utilities;System Parameters;Payment Parameter Setup", logval);
				break;

			case "Utilities-ToolsandDesigners":
				rmaseleniumutilties.RMA_Navigation_Utility.RMA_MDIMenuClick("Utilities;Tools and Designers", logval);
				break;

			case "Utilities-Technicians-XML Import-XMLImportTemplateGeneration":
				rmaseleniumutilties.RMA_Navigation_Utility.RMA_MDIMenuClick("Utilities;Technicians;XML Import;XML Import Template Generation", logval);
				break;

			case "Utilities-ToolsandDesigners-AutoDiarySetup":
				rmaseleniumutilties.RMA_Navigation_Utility.RMA_MDIMenuClick("Utilities;Tools and Designers;Auto Diary Setup", logval);
				break;

			case "Utilities-ToolsandDesigners-ScriptEditor":
				rmaseleniumutilties.RMA_Navigation_Utility.RMA_MDIMenuClick("Utilities;Tools and Designers;Script Editor", logval);
				break;

			case "Utilities-ToolsandDesigners-QueryDesigner":
				rmaseleniumutilties.RMA_Navigation_Utility.RMA_MDIMenuClick("Utilities;Tools and Designers;Query Designer", logval);
				break;

			case "Utilities-UIAdmins-Customization-PortalSettings":
				rmaseleniumutilties.RMA_Navigation_Utility.RMA_MDIMenuClick("Utilities;UI Admins;Customization;Portal Settings", logval);
				break;

			case "Utilities-UIAdmins-PowerviewEditor":
				rmaseleniumutilties.RMA_Navigation_Utility.RMA_MDIMenuClick("Utilities;UI Admins;Powerview Editor", logval);
				break;

			case "Utilities-UIAdmins-Customization-WebLinksSetup":
				rmaseleniumutilties.RMA_Navigation_Utility.RMA_MDIMenuClick("Utilities;UI Admins;Customization;Web Links Setup", logval);
				break;

			case "Utilities-UIAdmins-Customization-NavigationTreeSettings":
				rmaseleniumutilties.RMA_Navigation_Utility.RMA_MDIMenuClick("Utilities;UI Admins;Customization;Navigation Tree Settings", logval);
				break;
