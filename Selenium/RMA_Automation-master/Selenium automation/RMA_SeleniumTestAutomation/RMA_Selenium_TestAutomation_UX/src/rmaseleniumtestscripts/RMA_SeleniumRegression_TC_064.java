...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_SeleniumRegression_TC_064
//Description    : Create,Edit and Delete Of Enhanced Note On A Subrogation Is Validated
//Depends On TC  : RMA_SeleniumRegression_TC_058
//Revision       : 0.0 - ShrutiShruti-12-12-2017 
//======================================================================================================================================================================================================================================================================================


public class RMA_SeleniumRegression_TC_064 extends RMA_TC_BaseTest{
	@Test
	public void RMA_SeleniumRegression_TC_064_Test() throws Exception,Error{
		try{
			parentlogger = reports.startTest("RMA_SeleniumRegression_TC_064_Create, Edit And Delete Of Enhanced Notes On Subrogation Screen", "Create,Edit and Delete Of Enhanced Note On A Subrogation Screen Is Validated");
			parentlogger.assignAuthor("Shruti Shruti");

			StrScreenShotTCName = "RMA_SeleniumRegression_TC_064";
			testcall1 = false;	
