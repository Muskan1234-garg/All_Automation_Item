...
//=====================================================================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_QTPRegression_TC_099
//Description    : System checks for insufficient reserves when checkbox 'Check for insufficient reserve funds' is checked Is Validated 
//Depends On TC  : None
//Revision       : 0.0 - NidhiJha-12-15-2017
//===================================================================================================================================================================================================================================================================================================================================

public class RMA_QTPRegression_TC_099 extends RMA_TC_BaseTest {
	@Test
	public void RMA_QTPRegression_TC_099_Test() throws Exception,Error {
		...
		StrScreenShotTCName = "RMA_QTPRegression_TC_099";
		...
		try{
			...
			parentlogger = reports.startTest("RMA_QTPRegression_TC_099_ System_checks_for_insufficient_reserves_Validation", "System checks for insufficient reserves when checkbox 'Check for insufficient reserve funds' is checked Is Validated ");
			...
			GenClaimCreation_Txt_ClaimType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_099", 1, 0); //Claim Type Is Fetched From DataSheet RMA_QTPRegression_TC_099
			GenClaimCreation_Txt_ClaimStatus =  ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_099", 1,1 ); //Claim Status Is Fetched From DataSheet RMA_QTPRegression_TC_099
			GenClaimCreation_Txt_Department = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_099", 1,2 ); //Department Is Fetched From DataSheet RMA_QTPRegression_TC_099
			//General claim Data Fetch From Excel WorkBook Is Completed Here

			ReserveCreation_Lst_Status = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_099", 1, 3); //Status Is Fetched From DataSheet RMA_QTPRegression_TC_099
			ReserveCreation_Lst_ReserveType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_099", 1, 4); //Reserve Type Is Fetched From DataSheet RMA_QTPRegression_TC_099
			ReserveCreation_Txt_ReserveAmount =  ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_QTPRegression_TC_099", 1, 5);// Amount Is Fetched From DataSheet RMA_QTPRegression_TC_099
			//Reserve Data Fetch From Excel WorkBook Is Completed Here

			Payment_Lst_BankAccount = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_099", 1, 6); //Bank Account Is Fetched From DataSheet RMA_QTPRegression_TC_099
			Payment_Lst_PayeeType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_099", 1, 7); // Payee Type Is Fetched From DataSheet RMA_QTPRegression_TC_099
			FundsSplitDetails_Lst_TransactionType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_099", 1, 8); //Transaction Type Is Fetched From DataSheet RMA_QTPRegression_TC_099
			FundsSplitDetails_Txt_Amount = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_QTPRegression_TC_099", 1, 9); //Amount Is Fetched From DataSheet RMA_QTPRegression_TC_099
			Payment_Txt_LastName = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_099", 1, 10); //LastName Is Fetched From DataSheet RMA_QTPRegression_TC_099
			Payment_Txt_DisType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_099", 1, 11); //Distribution Type Is Fetched From DataSheet RMA_QTPRegression_TC_099
			FundsSplitDetails_Lst_ReserveType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_099", 1, 12); // Reserve Type Is Fetched From DataSheet RMA_QTPRegression_TC_099
			//Payment Data Fetch From Excel WorkBook Is Completed Here

			ReserveCreation_Lst_ReserveType_1 = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_099", 1, 13); //Reserve Type Is Fetched From DataSheet RMA_QTPRegression_TC_099
			FundsSplitDetails_Lst_TransactionType_1 =ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_099", 1, 14); //Transaction Type Is Fetched From DataSheet RMA_QTPRegression_TC_099
			//Reserve Data Fetch From Excel WorkBook Is Completed Here
			...
			testcall1 = true;
			RMA_Functionality_Utility.RMA_Suite28_Utility("RMA_QTPRegression_TC_099_Check", logval1);
			...
			testcall4 = true;
			StrControlNumber = RMA_Functionality_Utility.RMA_ConditionalPaymentCorpAddition_Utility(Payment_Lst_BankAccount, Payment_Lst_PayeeType,FundsSplitDetails_Lst_ReserveType, FundsSplitDetails_Lst_TransactionType,FundsSplitDetails_Txt_Amount, Payment_Txt_LastName, Payment_Txt_DisType, "RMA_QTPRegression_TC_099", "NA", logval1);
			...
			//========================================Steps To Create Second Reserve On The Created General Claim Is Started Here===========================================================================================================================================================================================================================================================
			parentlogger.log(LogStatus.INFO,"The Functional Utility :" +RMA_GenericUsages_Utility.RMA_LoggerHyperlink("ReserveCorpAddition","RMA_ReserveCorpAddition_Utility",0)+" Is Called To Create A Reserve");
			testcall5 = true;
			RMA_Functionality_Utility.RMA_ReserveCorpAddition_Utility(ReserveCreation_Txt_ReserveAmount, ReserveCreation_Lst_Status, ReserveCreation_Lst_ReserveType_1, "No", GenClaimNumber, logval1);
			parentlogger.log(LogStatus.INFO, "New Reserve Is Created With Type::" + " " + color.RMA_ChangeColor_Utility(ReserveCreation_Lst_ReserveType_1, 2) + " " + "And Amount::"+ " "+ color.RMA_ChangeColor_Utility(String.valueOf(ReserveCreation_Txt_ReserveAmount), 2));
			loggerval5 = logger.toString();
			parentlogger.appendChild(logger);
			//========================================Steps To Create Second Reserve On The Created General Claim Is Completed Here===========================================================================================================================================================================================================================================================

			//======================================Steps To Add Second Payment For Created General Claim Is Started Here===========================================================================================================================================================================================================================================================================
			parentlogger.log(LogStatus.INFO, "Following Function Is Called :: "+RMA_GenericUsages_Utility.RMA_LoggerHyperlink("PaymentAddition","RMA_ConditionalPaymentCorpAddition_Utility",0)+" To Create New Payment");
			testcall6 = true;
			StrControlNumber = RMA_Functionality_Utility.RMA_ConditionalPaymentCorpAddition_Utility(Payment_Lst_BankAccount, Payment_Lst_PayeeType,FundsSplitDetails_Lst_ReserveType, FundsSplitDetails_Lst_TransactionType_1,FundsSplitDetails_Txt_Amount, Payment_Txt_LastName, Payment_Txt_DisType, "RMA_QTPRegression_TC_099_Cancel", "NA", logval1);
			parentlogger.log(LogStatus.INFO, "New Payment With Control Number::"+ " " + color.RMA_ChangeColor_Utility(StrControlNumber, 2)+ " "+ "Is Done");
			...
			//=========================================Steps To Revert Line Of Business Parameter Settings Is Started Here===========================================================================================================================================================================================================================================================
			parentlogger.log(LogStatus.INFO, "Following Function Is Called :: "+RMA_GenericUsages_Utility.RMA_LoggerHyperlink("Suite28ParaSetupSettings","RMA_Suite28_Utility",0)+"General System Parameter Settings Are Done");
			testcall7 = true;
			RMA_Functionality_Utility.RMA_Suite28_Utility("RMA_QTPRegression_TC_099_uncheck", logval1);
			parentlogger.log(LogStatus.INFO, "UI Settings Successfully Completed");
			loggerval7 = logger.toString();
			parentlogger.appendChild(logger);
			//=========================================Steps To Revert Line Of Business Parameter Settings Is Completed Here===========================================================================================================================================================================================================================================================
			...
			{
				logger.log(LogStatus.FAIL, "Following Error Occurred  ::" + " "+  color.RMA_ChangeColor_Utility(FinalErrorMessage,1)+ " " + "While Executing Function Utility" +" "+ "RMA_UnsuccessfulReserveCorpAddition_Utility" + " " +  "To Create An Unsuccessful Reserve On The Created Claim And Hence The Test Case Is A Fail");
				parentlogger.appendChild(logger);
				reports.endTest(logger);	
			}
			if (testcall5 == true && loggerval5.equalsIgnoreCase("NotInitialized"))								
			{
				logger.log(LogStatus.FAIL, "Following Error Occurred  ::" + " "+  color.RMA_ChangeColor_Utility(FinalErrorMessage,1)+ " " + "While Executing Function Utility" +" "+ "RMA_Suite28_Utility" + " " +  "To Do More Settings On General System Parameter Page And Hence The Test Case Is A Fail");
				parentlogger.appendChild(logger);
				reports.endTest(logger);	
			}
			...
			{
				logger.log(LogStatus.FAIL, "Following Error Occurred  ::" + " "+  color.RMA_ChangeColor_Utility(FinalErrorMessage,1)+ " " + "While Executing Function Utility" +" "+ "RMA_Suite28_Utility" + " " +  "To Revert All Settings On General System Parameter Page And Hence The Test Case Is A Fail");
				parentlogger.appendChild(logger);
				reports.endTest(logger);	
			}
