...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_SeleniumRegression_TC_088
...
public class RMA_SeleniumRegression_TC_088 extends RMA_TC_BaseTest{ 
	@Test
	public void RMA_SeleniumRegression_TC_088_Test() throws Exception,Error{
		try{
			testcall1=false;
			...
			StrScreenShotTCName = "SeleniumRegression_TC_088";
			...
			parentlogger = reports.startTest("RMA_SeleniumRegression_TC_088_Create, Edit and Delete of Enhanced Notes On Injury/Illness Page", "Create, Edit and Delete of Enhanced Notes On Injury/illness Page Is Validated");
			...
			testcall2 = true;
			Injury=RMA_Functionality_Utility.RMA_InjuryIllnessCreateEditDelete_Utility("Caught Between", "Injuries","AB", StrDriverLastName, InjuryCreation_Txt_DateOfFileClosing, InjuryCreation_Txt_DisabilityDate, logval);
