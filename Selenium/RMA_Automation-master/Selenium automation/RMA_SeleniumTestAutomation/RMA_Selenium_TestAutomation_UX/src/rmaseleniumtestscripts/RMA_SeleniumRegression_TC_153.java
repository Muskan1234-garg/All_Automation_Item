...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_SeleniumRegression_TC_153
//Description    : Create,Edit And Delete Of Attachments On Admin Tracking On Maintenance Screen
//Depends On TC  : RMA_Smoke_TC_041_I
//Revision       : 0.0 - ShrutiShruti-01-11-2018 
//======================================================================================================================================================================================================================================================================================

public class RMA_SeleniumRegression_TC_153 extends RMA_TC_BaseTest{
	@Test
	public void RMA_SeleniumRegression_TC_153_Test() throws Exception,Error{
		try{
			parentlogger = reports.startTest("RMA_SeleniumRegression_TC_153_Create, Edit and Delete of Attachmments On Admin Tracking Page On Maintenance Screen", "Create, Edit and Delete of Attachments On Admin Tracking Page on Maintenance Screen Is Validated");
			...
			StrScreenShotTCName = "RMA_SeleniumRegression_TC_153";
			ErrorMessage = null;
			CurrentFrameID=null;
			//Global Variables Declaration Completed here
			
			String StrAdminTrackingType;
			String FileName;
			String FileSize;
			...
			//===========================================================New Admin Tracking Creation Is Started Here================================================================================================================================================================================================================================================================
			...
			testcall1 = true;
			StrAdminTrackingType=RMA_Maintenance_Functionality_Utility.RMA_MaintenanceAddNewEntity_Utility("AdminTrackingList", "Bid Bond","NA", logval1);
			loggerval1 = logger.toString();
			parentlogger.appendChild(logger);
			parentlogger.log(LogStatus.INFO, "New Admin Tracking Is Created With Bond Type::"+ " " + color.RMA_ChangeColor_Utility(StrAdminTrackingType, 2));
			CurrentFrameID = RMA_GenericUsages_Utility.RMA_GetCurrentFrameID();
			// New Property From Maintenance Screen Is Successfully Created
			//============================================================New Admin Tracking Creation Is Completed Here================================================================================================================================================================================================================================================================
			...
			//=================================================Steps To Delete Admin Tracking Started Here=================================================================================================================================================================================================
			RMA_Functionality_Utility.RMA_GenericDelete_Utility("Maintenance-->Admin Trackinh", false, logval);
			RMA_Functionality_Utility.RMA_GenericDelete_Utility("Maintenance-->Admin Tracking", true, logval);
			//=================================================Steps To Delete Admin Tracking Completed Here=============================================================================================================================================================================================================================
			driver.switchTo().parentFrame();
		}
