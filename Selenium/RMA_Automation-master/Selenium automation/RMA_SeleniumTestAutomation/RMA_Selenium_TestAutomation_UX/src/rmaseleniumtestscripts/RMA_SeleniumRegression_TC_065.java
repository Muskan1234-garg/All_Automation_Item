...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_SeleniumRegression_TC_065
//Description    : Create,Edit and Delete Of Enhanced Note On A Litigation Is Validated
//Depends On TC  : RMA_SeleniumRegression_TC_058
//Revision       : 0.0 - ShrutiShruti-12-12-2017 
//======================================================================================================================================================================================================================================================================================


public class RMA_SeleniumRegression_TC_065 extends RMA_TC_BaseTest{
	@Test
	public void RMA_SeleniumRegression_TC_065_Test() throws Exception,Error{
		try{

			parentlogger = reports.startTest("RMA_SeleniumRegression_TC_065_Create, Edit And Delete Of Enhanced Notes On Litigation Screen", "Create,Edit and Delete Of Enhanced Note On A Litigation Is Validated");
			parentlogger.assignAuthor("Shruti Shruti");

			StrScreenShotTCName = "RMA_SeleniumRegression_TC_065";
			testcall1 = false;	
