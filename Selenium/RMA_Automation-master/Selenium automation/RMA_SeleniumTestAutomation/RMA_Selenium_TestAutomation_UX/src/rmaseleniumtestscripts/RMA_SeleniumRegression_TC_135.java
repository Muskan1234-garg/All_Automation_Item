...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_SeleniumRegression_TC_135
//Description    : Create, Edit and Delete of Attachments For A Patient(PI) On A Litigation Page Is Validated
//Depends On TC  : RMA_SeleniumRegression_TC_024(For the Litigation Creation)
//Revision       : 0.0 - ShrutiShruti-01-12-2018
//======================================================================================================================================================================================================================================================================================

public class RMA_SeleniumRegression_TC_135 extends RMA_TC_BaseTest{
	@Test
	public void RMA_SeleniumRegression_TC_135_Test() throws Exception,Error{
		try{
			parentlogger = reports.startTest("RMA_SeleniumRegression_TC_135_Create, Edit And Delete Of Attachments On Person Involved(Patient) On A Litigation Screen", "Create,Edit and Delete Of Attachments On A Person Involved(Patient) On A Litigation Is Validated");
			parentlogger.assignAuthor("Shruti Shruti");

			StrScreenShotTCName = "RMA_SeleniumRegression_TC_135";
			testcall1 = false;	
