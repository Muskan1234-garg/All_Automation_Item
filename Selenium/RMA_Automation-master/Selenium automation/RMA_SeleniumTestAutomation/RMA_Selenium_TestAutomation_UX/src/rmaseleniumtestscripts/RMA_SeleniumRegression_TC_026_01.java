...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_SeleniumRegression_TC_026_01
...
//======================================================================================================================================================================================================================================================================================
public class RMA_SeleniumRegression_TC_026_01 extends RMA_TC_BaseTest {

	@Test
	public void RMA_SeleniumRegression_TC_026_01_Test() throws Exception,Error {

		try{
			parentlogger = reports.startTest("RMA_SeleniumRegression_TC_026_01_Existence Of Person Involved Entity Option For Saved Carrier Workers Compensation Claim", "Person Involved Entity Option Existence On Created Carrier Workers Compensation Claim's Right Hand Navigation Tree Is Validated");
			...
			StrScreenShotTCName = "RMA_SeleniumRegression_TC_026_01";
			ErrorMessage = null;
			CurrentFrameID=null;
			//Global Variable Initialization Completed 
			
			WorkersClaim_Txt_ClaimNumber = "WCLT2017000678";
