...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_SeleniumRegression_TC_107
//Description    : Create, Edit and Delete of Attachments For A Defendant Is Validated
//Depends On TC  : None
//Revision       : 0.0 - ShrutiShruti-01-10-2018
//======================================================================================================================================================================================================================================================================================

public class RMA_SeleniumRegression_TC_107 extends RMA_TC_BaseTest{
	@Test
	public void RMA_SeleniumRegression_TC_107_Test() throws Exception,Error{
		try{
			parentlogger = reports.startTest("RMA_SeleniumRegression_TC_107_Create, Edit And Delete An Attachment on Defendant Screen", "Create,Edit And Delete of Attachment On The Defendant Screen Is Validated");
			...
			StrScreenShotTCName = "RMA_SeleniumRegression_TC_107";
			ErrorMessage = null;
			CurrentFrameID=null;
			...
			RMA_Functionality_Utility.RMA_GenericDelete_Utility("Defendant Creation Page", false, logval);
			RMA_Functionality_Utility.RMA_GenericDelete_Utility("Defendant Creation Page", true, logval);
