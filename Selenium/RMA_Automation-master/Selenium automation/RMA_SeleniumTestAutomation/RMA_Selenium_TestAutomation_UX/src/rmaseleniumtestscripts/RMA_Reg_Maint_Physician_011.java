...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     :  RMA_Reg_Maint_Physician_011
//Description    : Verify That Sequence Of ToolBar Buttons Are Getting Changed Via UX Power View On Physician Page
//Depends On TC  : None
//Revision       : 0.0 - AnubhutiVyas-03-07-2018 
//======================================================================================================================================================================================================================================================================================

public class RMA_Reg_Maint_Physician_011 extends RMA_TC_BaseTest{
	@Test
	public void RMA_Reg_Maint_Physician_011_Test() throws Exception,Error{
		try{
			parentlogger = reports.startTest("RMA_Reg_Maint_Physician_011_Verify Sequence Of ToolBar Button Is Changed According To The User For Physician", "User Changes The Sequence Of ToolBar Buttons Then The Same Is Updated In UX On Physician Page Is Validated");
			...
			StrScreenShotTCName = "RMA_Reg_Maint_Physician_011";
			ErrorMessage = null;
			...
			String [] expected={"Attach Documents","Diary","Save","Delete Record","Mail Merge"};
			...
			RMA_GenericUsages_Utility.RMA_StaticWait(4, logval, "Wait Is Added As Physician Maintenance Info Page Is Getting Opened");
			...
			String [] expectedVerify={"Attach Documents","Diary","Delete Record","Save","Mail Merge"};
