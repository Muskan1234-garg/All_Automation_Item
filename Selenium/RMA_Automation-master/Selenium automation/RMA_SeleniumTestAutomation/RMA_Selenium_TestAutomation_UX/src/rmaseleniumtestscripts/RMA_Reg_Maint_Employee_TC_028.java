...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_Reg_Maint_Employee_TC_028
//Description    : Verify That Sequence Of ToolBar Buttons Are Getting Changed Via UX Power View On Employee Maintenance Page
//Depends On TC  : None
//Revision       : 0.0 - ShrutiShruti-03-09-2018 
//======================================================================================================================================================================================================================================================================================

public class RMA_Reg_Maint_Employee_TC_028 extends RMA_TC_BaseTest{
	@Test
	public void RMA_Reg_Maint_Employee_TC_028_Test() throws Exception,Error{
		try{
			parentlogger = reports.startTest("RMA_Reg_Maint_Employee_TC_028_Verify Sequence Of ToolBar Button Is Changed According To The User For Employee Page", "User Changes The Sequence Of ToolBar Buttons Then The Same Is Updated In UX On Employee Page Is Validated");
			...
			StrScreenShotTCName = "RMA_Reg_Maint_Employee_TC_033";
			ErrorMessage = null;
			...
			String [] expected={"Save","Delete Record","Attach Documents","Diary","Comments","Mail Merge","Record Summary","Withholding","Lookup"};
			...
			//Function To Verify Sequence Of ToolBar Buttons Started Here=====================================================================================
			String [] expectedVerify={"Delete Record","Attach Documents","Diary","Save","Comments","Mail Merge","Record Summary","Withholding","Lookup"};
			...
			RMA_Navigation_Utility.RMA_ObjectDragAndDrop(RMA_Selenium_POM_PowerView.RMAApp_PowerView_Lbl_ToolBarField(driver, "Attach Documents"), RMA_Selenium_POM_PowerView.RMAApp_PowerView_Area_ToolBarField(driver), "Attach Documents Field", "ToolBar DropDown Area", "Power View Editor Page", logval);
			RMA_Navigation_Utility.RMA_ObjectDragAndDrop(RMA_Selenium_POM_PowerView.RMAApp_PowerView_Lbl_ToolBarField(driver, "Diary"), RMA_Selenium_POM_PowerView.RMAApp_PowerView_Area_ToolBarField(driver), "Diary Field", "ToolBar DropDown Area", "Power View Editor Page", logval);
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_PowerView.RMAApp_PowerView_Btn_Save(driver), "Save Image Button On Power View Editor Page", logval);
