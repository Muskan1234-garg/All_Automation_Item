...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_Reg_Maint_Employee_TC_017
//Description    : Verify That Correct Validation Message Is Displayed When User Enters Work Permit Date Less Than Date Of Birth
//Depends On TC  : None
//Revision       : 0.0 - DebasmitaPati-02-09-2018
//======================================================================================================================================================================================================================================================================================
public class RMA_Reg_Maint_Employee_TC_017 extends RMA_TC_BaseTest {
		
	@Test
		public void RMA_Reg_Maint_Employee_TC_017_Test() throws Exception,Error {

		try{
			parentlogger = reports.startTest("RMA_Reg_Maint_Employee_TC_017_Verify That Correct Validation Message Is Displayed When User Enters Work Permit Date Less Than Date Of Birth","Validation Message Is Verified Successfully When User Enters Work Permit Date Less Than Date Of Birth");
			...
			StrScreenShotTCName = "RMA_Reg_Maint_Employee_TC_017";
			ErrorMessage = null;
			CurrentFrameID=null;
			...
			String Date_Birth;
			String Workpermit_Date;
            //Local Variable Declaration Completed
			
			Date_Birth = RMA_GenericUsages_Utility.RMA_PastFutureDateInfo_Utility(0,-1,0,"MM/dd/yyyy");
			Workpermit_Date = RMA_GenericUsages_Utility.RMA_PastFutureDateInfo_Utility(0,-1,-1,"MM/dd/yyyy");
			...
			RMA_Input_Utility.RMA_SetTextValueandTabOut_Utility(RMA_Selenium_POM_Employee.RMAApp_Employee_Txt_WorkPermitDate(driver), "Work Permit Date TextBox On Maintenance-->Employee Page",Workpermit_Date, logval);
			CurrentFrameID = RMA_GenericUsages_Utility.RMA_GetCurrentFrameID();
			RMA_Functionality_Utility.RMA_GenericSave_Utility(CurrentFrameID, true, "Work Permit Date must be greater than or equal to Date of Birth",  "Maintenance-->Employee Page", logval);
			parentlogger.log(LogStatus.PASS, color.RMA_ChangeColor_Utility("Work Permit Date must be greater than or equal to Date of Birth", 2)+ " Validation Message Is Verified Successfully");
