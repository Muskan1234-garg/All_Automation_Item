...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_SeleniumRegression_TC_111
//Description    : Create, Edit and Delete of Attachments For A MedicalStaff(PI) Is Validated
//Depends On TC  : None
//Revision       : 0.0 - ShrutiShruti-01-11-2018
//======================================================================================================================================================================================================================================================================================

public class RMA_SeleniumRegression_TC_111 extends RMA_TC_BaseTest{
	@Test
	public void RMA_SeleniumRegression_TC_111_Test() throws Exception,Error{
		try{
			parentlogger = reports.startTest("RMA_SeleniumRegression_TC_111_Create, Edit And Delete Of Attachments On Person Involved(Medical Staff) Screen", "Create,Edit and Delete Of Attachments On A Person Involved(Medical Staff) Is Validated");
			parentlogger.assignAuthor("Shruti Shruti");

			StrScreenShotTCName = "RMA_SeleniumRegression_TC_111";
			testcall1 = false;	
