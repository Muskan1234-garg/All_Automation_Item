...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_Reg_Maint_Employee_TC_005
//Description    : Verify That Correct Validation Message Is Displayed When User Enters Date Last Verified Greater Than Todays Date
//Depends On TC  : None
//Revision       : 0.0 - DebasmitaPati-02-09-2018
//======================================================================================================================================================================================================================================================================================
public class RMA_Reg_Maint_Employee_TC_005 extends RMA_TC_BaseTest {
		
	@Test
		public void RMA_Reg_Maint_Employee_TC_005_Test() throws Exception,Error {

		try{
			parentlogger = reports.startTest("RMA_Reg_Maint_Employee_TC_005_Verify That Correct Validation Message Is Displayed When User Enters Date Last Verified Greater Than Todays Date","Validation Message Is Verified Successfully When User Enters Date Last Verified Greater Than Todays Date");
			...
			StrScreenShotTCName = "RMA_Reg_Maint_Employee_TC_005";
			ErrorMessage = null;
			CurrentFrameID=null;
			...
			String Todays_Date;
			String LastVerified_Date;
			//Local Variable Declaration Completed
			
			Todays_Date = RMA_GenericUsages_Utility.RMA_PastFutureDateInfo_Utility(0,0,0,"MM/dd/yyyy");
			LastVerified_Date = RMA_GenericUsages_Utility.RMA_PastFutureDateInfo_Utility(0,1,0,"MM/dd/yyyy");
			...
			RMA_Input_Utility.RMA_SetTextValueandTabOut_Utility(RMA_Selenium_POM_Employee.RMAApp_Employee_Txt_DateLastVerified(driver), "LastVerified Date TextBox On Maintenance-->Employee Page",LastVerified_Date, logval);
			CurrentFrameID = RMA_GenericUsages_Utility.RMA_GetCurrentFrameID();
			RMA_Functionality_Utility.RMA_GenericSave_Utility(CurrentFrameID, true, "Date Last Verified Must be less than or equal to Today's Date:"+Todays_Date,  "Maintenance-->Employee Page", logval);
			parentlogger.log(LogStatus.PASS, color.RMA_ChangeColor_Utility("Date Last Verified Must be less than or equal to Today's Date: "+Todays_Date, 2)+ " Validation Message Is Verified Successfully");
