...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_SeleniumRegression_TC_144
//Description    : Create,Edit And Delete Of Attachments On Driver On Maintenance Screen
//Depends On TC  : RMA_Smoke_TC_041_I
//Revision       : 0.0 - ShrutiShruti-01-12-2018 
//======================================================================================================================================================================================================================================================================================

public class RMA_SeleniumRegression_TC_144 extends RMA_TC_BaseTest{
	@Test
	public void RMA_SeleniumRegression_TC_144_Test() throws Exception,Error{
		try{
			parentlogger = reports.startTest("RMA_SeleniumRegression_TC_144_Create, Edit and Delete of Attachmments On Driver Maintenance Page On Maintenance Screen", "Create, Edit and Delete of Attachments On Driver Maintenance Page on Maintenance Screen Is Validated");
			...
			StrScreenShotTCName = "RMA_SeleniumRegression_TC_144";
			ErrorMessage = null;
			CurrentFrameID=null;
			...
			testcall1 = true;
			StrDriverName=RMA_Maintenance_Functionality_Utility.RMA_MaintenanceAddNewEntity_Utility("Driver", "Commercial", "NA",logval1);
			loggerval1 = logger.toString();
			parentlogger.appendChild(logger);
			parentlogger.log(LogStatus.INFO, "New Driver Is Created With Driver Name::"+ " " + color.RMA_ChangeColor_Utility(StrDriverName, 2));
			...
			//=================================================Steps To Delete Driver Started Here=================================================================================================================================================================================================
			RMA_Functionality_Utility.RMA_GenericDelete_Utility("Maintenance-->Driver", false, logval);
			RMA_Functionality_Utility.RMA_GenericDelete_Utility("Maintenance-->Driver", true, logval);
			//=================================================Steps To Delete Driver Completed Here=============================================================================================================================================================================================================================
			driver.switchTo().parentFrame();
		}
