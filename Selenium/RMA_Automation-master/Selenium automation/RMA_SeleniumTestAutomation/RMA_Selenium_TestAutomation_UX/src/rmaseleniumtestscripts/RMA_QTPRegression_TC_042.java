...
//=====================================================================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_QTPRegression_TC_042
//Description    : Reserve And Incurred Balance Calculations With Selection Of  'Calculate Collections In Reserve Balance Per Reserve' And 'Calculate Collections In Incurred Balance Per Reserve' Checkbox Is Validated
//Depends On TC  : None
//Revision       : 0.0 - AbhishekRai-09-15-2017
//===================================================================================================================================================================================================================================================================================================================================

public class RMA_QTPRegression_TC_042 extends RMA_TC_BaseTest {	
	@Test
	public void RMA_QTPRegression_TC_042_Test() throws Exception,Error {
		try{
			parentlogger = reports.startTest("RMA_QTPRegression_TC_042_Calculate Collections in Reserve Balance Per Reserve and Incurred Balance Per Reserve", "Reserve And Incurred Balance Calculations With Selection Of  'Calculate Collections In Reserve Balance Per Reserve' And 'Calculate Collections In Incurred Balance Per Reserve' Checkbox Is Validated");
			parentlogger.assignAuthor("Abhishek Rai");		
			
			//Region =====================================================Global Variable Initialization Is Started Here=====================================================================================================
			StrScreenShotTCName = null;
			StrScreenShotTCName = "RMA_QTPRegression_TC_042";
			testcall1 = false;	
			...
			GenClaimCreation_Txt_ClaimType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_042", 1, 1); //Claim Type Is Fetched From DataSheet RMA_QTPRegression_TC_042			
			GenClaimCreation_Txt_Department = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_042", 1, 2); //Department Is Fetched From DataSheet RMA_QTPRegression_TC_042
			GenClaimCreation_Txt_ClaimStatus =  ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_042", 1, 3); //Claim Status Is Fetched From DataSheet RMA_QTPRegression_TC_042
			ReserveCreation_Lst_ReserveStatus = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_042", 1, 4); // Reserve Status Is Fetched From DataSheet RMA_QTPRegression_TC_042
			ReserveCreation_Lst_ReserveType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_042", 1, 5); // Reserve Type Is Fetched From DataSheet RMA_QTPRegression_TC_042
			ReserveCreation_Txt_ReserveAmount = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_QTPRegression_TC_042", 1, 6);  //Reserve Amount Is Fetched From DataSheet RMA_QTPRegression_TC_042
			ReserveCreation_Lst_ReserveType_1 = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_042", 1, 7); // Reserve Type_1 Is Fetched From DataSheet RMA_QTPRegression_TC_042
			ReserveCreation_Txt_ReserveAmount_1 = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_QTPRegression_TC_042", 1, 8);  //Reserve Amount_1 Is Fetched From DataSheet RMA_QTPRegression_TC_042
			ReserveCreation_Lst_ReserveType_2 = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_042", 1, 9); // Reserve Type_2 Is Fetched From DataSheet RMA_QTPRegression_TC_042
			ReserveCreation_Txt_ReserveAmount_2 = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_QTPRegression_TC_042", 1, 10);  //Reserve Amount_2 Is Fetched From DataSheet RMA_QTPRegression_TC_042
			PaymentCreation_Lst_BankAccount = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_042", 1, 11); //Bank Account Is Fetched From DataSheet RMA_QTPRegression_TC_042
			PaymentCreation_Lst_PayeeType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_042", 1, 12); // Payee Type Is Fetched From DataSheet RMA_QTPRegression_TC_042
			PaymentCreation_Txt_LastName = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_042", 1, 13); //LastName Is Fetched From DataSheet RMA_QTPRegression_TC_042			
			PaymentCreation_Txt_DisType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_042", 1, 14); //Distribution Type Is Fetched From DataSheet RMA_QTPRegression_TC_011
			FundsSplitDetails_Txt_Amount = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_QTPRegression_TC_042", 1, 15); //Amount Is Fetched From DataSheet RMA_QTPRegression_TC_042
			FundsSplitDetails_Lst_TransactionType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_042", 1, 16); //Transaction Type Is Fetched From DataSheet RMA_QTPRegression_TC_042						
			...
			if (testcall5== true && loggerval4.equalsIgnoreCase("NotInitialized"))								
			{
				logger.log(LogStatus.FAIL, "Following Error Occurred  ::" + " "+  color.RMA_ChangeColor_Utility(FinalErrorMessage,1)+ " " + "While Executing Function Utility" +" "+ "RMA_ConditionalPaymentCorpAddition_Utility" + " " +  "To Create New Payment And Hence The Test Case Is A Fail");
				parentlogger.appendChild(logger);
				reports.endTest(logger);	
			}
			if (testcall6== true && loggerval4.equalsIgnoreCase("NotInitialized"))								
			{
				logger.log(LogStatus.FAIL, "Following Error Occurred  ::" + " "+  color.RMA_ChangeColor_Utility(FinalErrorMessage,1)+ " " + "While Executing Function Utility" +" "+ "RMA_ConditionalCollectionCorpAddition_Utility" + " " +  "To Create New Collection And Hence The Test Case Is A Fail");
				parentlogger.appendChild(logger);
				reports.endTest(logger);	
			}
