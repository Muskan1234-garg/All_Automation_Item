...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_SeleniumRegression_TC_113
//Description    : Create, Edit and Delete of Attachments For A Patient(PI) Is Validated
//Depends On TC  : None
//Revision       : 0.0 - ShrutiShruti-01-11-2018
//======================================================================================================================================================================================================================================================================================

public class RMA_SeleniumRegression_TC_113 extends RMA_TC_BaseTest{
	@Test
	public void RMA_SeleniumRegression_TC_113_Test() throws Exception,Error{
		try{
			parentlogger = reports.startTest("RMA_SeleniumRegression_TC_113_Create, Edit And Delete Of Attachments On Person Involved(Patient) Screen", "Create,Edit and Delete Of Attachments On A Person Involved(Patient) Is Validated");
			parentlogger.assignAuthor("Shruti Shruti");

			StrScreenShotTCName = "RMA_SeleniumRegression_TC_113";
			testcall1 = false;	
