...
//==================================================================================================================================================================================
//TestCaseID   	 : RMA_QTPRegression_TC_067
//Description    : To Mark A Collection As Printed Is Validated
//Depends On TC  : None
//Revision       : 0.0 - AnubhutiVyas-08-25-2017 
//========================================================================================================================================================================================
public class RMA_QTPRegression_TC_067 extends RMA_TC_BaseTest{

	@Test 
	public void RMA_QTPRegression_TC_067_Test() throws Exception, Error
	{
		testcall1 = false;	
		...
		StrScreenShotTCName = "RMA_QTPRegression_TC_067";
		...
		try {
			parentlogger = reports.startTest("RMA_QTPRegression_TC_067_Mark A Collection As Printed", "To Mark A Collection As Printed Is Validated");
			...
			GenClaimCreation_Txt_ClaimType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_067", 1, 0); //Claim Type Is Fetched From DataSheet RMA_QTPRegression_TC_067
			GenClaimCreation_Txt_ClaimStatus =  ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_067", 1,1 ); //Claim Status Is Fetched From DataSheet RMA_QTPRegression_TC_067
			GenClaimCreation_Txt_Department = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_067", 1,2 ); //Department Is Fetched From DataSheet RMA_QTPRegression_TC_067
			//Claim Data Fetch From Excel WorkBook Is Completed Here
			
			Collection_Txt_BankAccount = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_067", 1, 3); // Bank account Is Fetched From DataSheet RMA_QTPRegression_TC_067
			Collection_Lst_PayeeType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_067", 1, 4); // Payee Type Is Fetched From DataSheet RMA_QTPRegression_TC_067
			FundsSplitDetails_Lst_TransactionType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_067", 1, 5); //Transaction Type For Medical Reserve Payment Is Fetched From DataSheet RMA_QTPRegression_TC_067
			FundsSplitDetails_Txt_Amount = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_QTPRegression_TC_067", 1, 6); //Medical Amount Is Fetched From DataSheet RMA_QTPRegression_TC_067
			Collection_Txt_LastName = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_067", 1, 7); //LastName Is Fetched From DataSheet RMA_QTPRegression_TC_067
			Collection_Txt_DisType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_067", 1, 8); //Distribution Type Is Fetched From DataSheet RMA_QTPRegression_TC_067
			ReserveCreation_Lst_ReserveType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_067", 1, 9); // Medical Reserve Type Is Fetched From DataSheet RMA_QTPRegression_TC_067
			...
			parentlogger.log(LogStatus.INFO, logger.addScreenCapture(RMA_ScreenCapture_Utility.RMA_ScreenShotCapture_Utility(driver, "Successful Printed Collection Verification", "Collection Is Printed Successfully")));
