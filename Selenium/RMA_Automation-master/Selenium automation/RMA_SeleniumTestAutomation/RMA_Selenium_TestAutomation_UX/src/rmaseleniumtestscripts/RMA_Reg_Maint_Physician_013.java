...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     :  RMA_Reg_Maint_Physician_013
//Description    : Verify That User Gets Validation When User Tries To Remove Any Required Field In Power View UX(Physician)
//Depends On TC  : None
//Revision       : 0.0 - AnubhutiVyas-03-20-2018 
//======================================================================================================================================================================================================================================================================================

public class RMA_Reg_Maint_Physician_013 extends RMA_TC_BaseTest{
	@Test
	public void RMA_Reg_Maint_Physician_013_Test() throws Exception,Error{
		try{
			parentlogger = reports.startTest("RMA_Reg_Maint_Physician_013_Verify That User Gets Validation When User Tries To Remove Any Required Field On Physician On Power View UX", "Correct Validation When User Tries To Remove Any Required Field On Physician Screen On Power View UX Is Validated");
			...
			StrScreenShotTCName = "RMA_Reg_Maint_Physician_013";
			ErrorMessage = null;
			...
			RMA_Verification_Utility.RMA_VerifyUXSpinnerDisappered(logval);
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_PowerView.RMAApp_PowerView_Btn_FieldDelete(driver, "Last Name"), "Physician's Last Name Field Delete Button On Power View Editor Page", logval);
			...
			RMA_Verification_Utility.RMA_VerifyUXErrorMessage("Last Name is a system required field can not be removed from the Powerview.", false, "Validation Error Message on Power View Editor Page", logval);
