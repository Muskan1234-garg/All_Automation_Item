...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_Reg_Maint_Employee_TC_089
//Description    : Verify The Validation Message For Date Hired Filed And Termination Date Is Displayed As Read Only After Making Date Hired Field Required And Termination Date Field Read Only In Employee Maintenance Powerview
//Depends On TC  : None
//Revision       : 0.0 - dpati-02-23-2018 
//======================================================================================================================================================================================================================================================================================

public class RMA_Reg_Maint_Employee_TC_089 extends RMA_TC_BaseTest{
	@Test
	public void RMA_Reg_Maint_Employee_TC_089_Test() throws Exception,Error{
		try{
			parentlogger = reports.startTest("RMA_Reg_Maint_Employee_TC_089_Verify Employee MAintenance Screen Is Displayed", "Validation Message For Date Hired Filed And Termination Date Is Displayed As Read Only Is Validated After Making Date Hired Field Required And Termination Date Field Read Only In Employee Maintenance Powerview");
			...
			StrScreenShotTCName = "RMA_Reg_Maint_Employee_TC_089";
			ErrorMessage = null;
			CurrentFrameID=null;
			...
			Date_Hired = RMA_GenericUsages_Utility.RMA_PastFutureDateInfo_Utility(0,0,0,"MM/dd/yyyy");
			...
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_PowerView.RMAApp_EmployeePowerview_Tab_EmploymentInfo(driver), "Employment Info Tab On -->Employee PowerView Editor Page", logval);
			RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_PowerView.RMAApp_EmployeePowerview_Lbl_DateHired(driver), "Date Hired Field On Employee Info Tab On -->Employee PowerView Editor Page", logval);
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_PowerView.RMAApp_PowerView_ToggleBtn_RequiredField(driver), "Make Date Hired As Required Field On Employment Info Tab On -->Employee PowerView Editor Page", logval);
			RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_PowerView.RMAApp_EmployeePowerview_Lbl_TerminationDate(driver), "Termination Date Field On Employee Info Tab On -->Employee PowerView Editor Page", logval);
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_PowerView.RMAApp_PowerView_ToggleBtn_ReadOnlyField(driver), "Make Termination Date As Read Only Field On Employment Info Tab On -->Employee PowerView Editor Page", logval);
			...
			//===========================================================Verifying Termination Date Is Read Only Field On Employee Screen==========================================================================================================================================
			...
			RMA_Verification_Utility.RMA_EnbDisbStateVerify_Utility(RMA_Selenium_POM_Employee.RMAApp_Employee_Txt_TerminationDate(driver), "disable", "Termination Date Field On Employment Info Tab On -->Employee Maintenance Page ", logval);
			...
			//===========================================================Verifying Date Hired Is Required Field On Employee Page==========================================================================================================================================
			...
			Thread.sleep(3000);
			RMA_Input_Utility.RMA_SetTextValueandTabOut_Utility(RMA_Selenium_POM_Employee.RMAApp_Employee_Txt_HiredDate(driver), "Date Hired TextBox On Maintenance-->Employee Page",Date_Hired, logval);
			...
			parentlogger.log(LogStatus.PASS, color.RMA_ChangeColor_Utility("Date Entered in Date Hired Field And Employee Screen Saved Successfully", 2)+ "Date Hired Is A Required Field Verified Successfully");
			//============================================================Verification Completed===================================================================================================================================================================
			//===========================================================Utilities Screen Navigation Is Started Here================================================================================================================================================================================================================================================================
