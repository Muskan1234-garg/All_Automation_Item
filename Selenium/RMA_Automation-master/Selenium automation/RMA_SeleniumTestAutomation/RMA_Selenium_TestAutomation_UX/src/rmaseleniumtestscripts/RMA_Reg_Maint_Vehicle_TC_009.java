...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_Reg_Maint_Vehicle_TC_009
//Description    : Check The Functionality Of Accident Child Menu From Vehicle Maintenance Is Validated
//Depends On TC  : None
//Revision       : 0.0 - JannathHussain-02-19-2018 
//======================================================================================================================================================================================================================================================================================
public class RMA_Reg_Maint_Vehicle_TC_009 extends rmaseleniumtestscripts.RMA_TC_BaseTest{
	@Test
	public void RMA_Maint_Vehicle_TC009_Test() throws Exception,Error{
		try{
			parentlogger = reports.startTest("RMA_Reg_Maint_Vehicle_TC_009_ Check The Functionality Of Accident Child Menu From Vehicle Maintenance", "  Check The Functionality Of Accident Child Menu From Vehicle Maintenance Is Validated");
			...
			StrScreenShotTCName = "RMA_Maint_Vehicle_TC009";
			ErrorMessage = null;
			CurrentFrameID=null;
			...
			VehicleClaim_Txt_ClaimType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_Reg_Maint_Vehicle_TC_009", 1, 0); // Claim Type Is Fetched From DataSheet RMA_Reg_Maint_Vehicle_TC_009
			VehicleClaim_Txt_Department = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_Reg_Maint_Vehicle_TC_009", 1, 1); // Department Is Fetched From DataSheet RMA_Reg_Maint_Vehicle_TC_009
			...
			RMA_GenericUsages_Utility.RMA_StaticWait(3, logval, "Wait Is Added To Get The Unit Details From Vehicle Accident");
			...
			//===========================================================Verification Vehicle Accident Started Here===============================================================================================================================================================================================================
			...
			RMA_GenericUsages_Utility.RMA_StaticWait(4, logval, "Wait Is Added To Load The Accident On Vehicle Accident");
			RMA_Verification_Utility.RMA_ObjectDisplayVerify_Utility(RMA_Selenium_POM_Vehicle.RMAApp_Vehicle_Accidents_Lnk_VehicleRightHandTree(driver, StrClaimNumber), "displayed", "Accident Record is available", logval);			
			RMA_GenericUsages_Utility.RMA_WebPageRefresh_Utility_UX(logval);
			driver.close();
			//===========================================================Verification Vehicle Accident Completed Here===============================================================================================================================================================================================================
