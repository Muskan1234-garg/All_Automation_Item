...
//==================================================================================================================================================================================
//TestCaseID   	 : RMA_QTPRegression_TC_050
//Description    :LOB Parameter Settings 'Auto Adjust Negative Reserves To Zero(Open Claims)' To View Reserve Balances For Open Claims Is Validated
//Depends On TC  : None
//Revision       : 0.0 - AnubhutiVyas-08-03-2017 
//========================================================================================================================================================================================
public class RMA_QTPRegression_TC_050 extends RMA_TC_BaseTest{

	@Test 
	public void RMA_QTPRegression_TC_050_Test() throws Exception, Error
	{
		testcall1 = false;	
		...
		StrScreenShotTCName = "RMA_QTPRegression_TC_050";
		...
		try {
			parentlogger = reports.startTest("RMA_QTPRegression_TC_050_Auto Adjust Negative Reserves To Zero(Open Claims) On Corporate Claim", "LOB Parameter Settings 'Auto Adjust Negative Reserves To Zero(Open Claims)' To View Reserve Balances For Open Claims Is Validated");
			...
			GenClaimCreation_Txt_ClaimType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_050", 1, 16); //Claim Type Is Fetched From DataSheet RMA_QTPRegression_TC_050
			GenClaimCreation_Txt_ClaimStatus =  ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_050", 1,17 ); //Claim Status Is Fetched From DataSheet RMA_QTPRegression_TC_050
			GenClaimCreation_Txt_Department = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_050", 1,18); //Department Is Fetched From DataSheet RMA_QTPRegression_TC_050
			//Claim Data Fetch From Excel WorkBook Is Completed Here
		 
			ReserveCreation_Txt_ReserveAmount = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_QTPRegression_TC_050", 1, 0); //Reserve Amount Is Fetched From DataSheet RMA_QTPRegression_TC_050
			ReserveCreation_Lst_Status = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_050", 1, 1); // Reserve Status Is Fetched From DataSheet RMA_QTPRegression_TC_050
			ReserveCreation_Lst_ReserveType_Medical = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_050", 1, 2); // Medical Reserve Type Is Fetched From DataSheet RMA_QTPRegression_TC_050
			ReserveCreation_Lst_ReserveType_Expense = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_050", 1, 3); // Expense Reserve Type Is Fetched From DataSheet RMA_QTPRegression_TC_050
			ReserveCreation_Lst_ReserveType_Litigation = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_050", 1, 4); // Litigation Reserve Type Is Fetched From DataSheet RMA_QTPRegression_TC_050
			//Reserve Data Fetch From Excel WorkBook Is Completed Here
			
			PaymentCreation_Txt_BankAccount = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_050", 1, 5); //Bank Account Is Fetched From DataSheet RMA_QTPRegression_TC_050
			PaymentCreation_Lst_PayeeType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_050", 1, 6); // Payee Type Is Fetched From DataSheet RMA_QTPRegression_TC_050
			FundsSplitDetails_Lst_TransactionType_Medical = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_050", 1, 7); //Transaction Type For Medical Reserve Payment Is Fetched From DataSheet RMA_QTPRegression_TC_050
			FundsSplitDetails_Lst_TransactionType_Expense = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_050", 1,12 ); //Transaction Type For Expense Reserve Payment Is Fetched From DataSheet RMA_QTPRegression_TC_050
			FundsSplitDetails_Lst_TransactionType_Litigation = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_050",1,13 ); //Transaction Type For Litigation Reserve Payment Is Fetched From DataSheet RMA_QTPRegression_TC_050
			FundsSplitDetails_Txt_Amount_Medical = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_QTPRegression_TC_050", 1, 8); //Medical Amount Is Fetched From DataSheet RMA_QTPRegression_TC_050
			FundsSplitDetails_Txt_Amount_Expense = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_QTPRegression_TC_050", 1,14 ); //Expense Amount Is Fetched From DataSheet RMA_QTPRegression_TC_050
			FundsSplitDetails_Txt_Amount_Litigation = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_QTPRegression_TC_050", 1,15 ); //Litigation Amount Is Fetched From DataSheet RMA_QTPRegression_TC_050
			PaymentCreation_Txt_LastName = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_050", 1, 9); //LastName Is Fetched From DataSheet RMA_QTPRegression_TC_050
			PaymentCreation_Txt_DisType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_050", 1, 10); //Distribution Type Is Fetched From DataSheet RMA_QTPRegression_TC_050
			...
			String []ExpectedValuesToBeVerified_Litigation={"$0.00", "$"+FundsSplitDetails_Txt_Amount_Litigation+".00", "$0.00", "$"+FundsSplitDetails_Txt_Amount_Litigation+".00", "O - Open"};
		
			RMA_GenericUsages_Utility.RMA_Non_UXNavigation();
			RMA_Functionality_Utility.RMA_Suite24_Utility("RMA_QTPRegression_TC_050", logval);//General System Parameter & LOB Parameter Setting Is Done
