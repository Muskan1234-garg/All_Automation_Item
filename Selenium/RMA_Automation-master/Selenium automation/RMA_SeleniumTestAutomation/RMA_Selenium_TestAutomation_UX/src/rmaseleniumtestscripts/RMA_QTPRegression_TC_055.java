...
//==================================================================================================================================================================================
//TestCaseID   	 : RMA_QTPRegression_TC_055
//Description    : Verification Of Payments Are Not Rolled Up For Print Check To File Options : 'TO PRINTER ONLY' For The Same Payee When 'Roll Up Checks To The Same Payee' Is Not Checked
//Depends On TC  : None
//Revision       : 0.0 - AnubhutiVyas-09-01-2017 
//========================================================================================================================================================================================
public class RMA_QTPRegression_TC_055 extends RMA_TC_BaseTest{

	@Test 
	public void RMA_QTPRegression_TC_055_Test() throws Exception, Error
	{
		testcall1 = false;	
		...
		StrScreenShotTCName = "RMA_QTPRegression_TC_055";
		...
		try {
			parentlogger = reports.startTest("RMA_QTPRegression_TC_055_Payments Are Not Rolled Up For Option 'TO PRINTER ONLY' When 'Roll Up Checks To The Same Payee' Is Not Checked", "Verification Of Payments Are Not Rolled Up For Print Check To File Options : 'TO PRINTER ONLY' For The Same Payee When 'Roll Up Checks To The Same Payee' Is Not Checked");
			...
			GenClaimCreation_Txt_ClaimType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_055", 1, 7); //Claim Type Is Fetched From DataSheet RMA_QTPRegression_TC_055
			GenClaimCreation_Txt_ClaimStatus =  ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_055", 1,8 ); //Claim Status Is Fetched From DataSheet RMA_QTPRegression_TC_055
			GenClaimCreation_Txt_Department = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_055", 1,9); //Department Is Fetched From DataSheet RMA_QTPRegression_TC_055
			//Claim Data Fetch From Excel WorkBook Is Completed Here
			
			PaymentCreation_Lst_PayeeType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_055", 1, 1); // Payee Type Is Fetched From DataSheet RMA_QTPRegression_TC_055
			FundsSplitDetails_Lst_TransactionType= ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_055", 1,2); //Transaction Type For Medical Reserve Payment Is Fetched From DataSheet RMA_QTPRegression_TC_055
			FundsSplitDetails_Txt_Amount = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_QTPRegression_TC_055", 1, 3); //Medical Amount Is Fetched From DataSheet RMA_QTPRegression_TC_055
			PaymentCreation_Txt_LastName = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_055", 1, 4); //LastName Is Fetched From DataSheet RMA_QTPRegression_TC_055
			PaymentCreation_Txt_DisType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_055", 1, 5); //Distribution Type Is Fetched From DataSheet RMA_QTPRegression_TC_055
			PaymentCreation_Lst_ReserveType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_055", 1, 6); // Medical Reserve Type Is Fetched From DataSheet RMA_QTPRegression_TC_055
			...
			testcall1 = true;
			RMA_Functionality_Utility.RMA_Suite07_Utility("RMA_QTPRegression_TC_055", logval1);//General System Parameter & Payment Parameter Settings Are Done
			...
			testcall8 = true;
			RMA_Functionality_Utility.RMA_Suite07_PrintCheckUtility("RMA_QTPRegression_TC_055",RMA_QTPRegression_TC_052_I.BankAccount_Txt_AccountName,PaymentCreation_Txt_DisType,ContentToBeVerified, logval);//Print Checks Utility
