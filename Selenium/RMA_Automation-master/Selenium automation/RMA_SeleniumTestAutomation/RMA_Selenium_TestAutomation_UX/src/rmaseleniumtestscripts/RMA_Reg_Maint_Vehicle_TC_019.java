...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_Reg_Maint_Vehicle_TC_019
//Description    : Attachments SMS Permission From Vehicle Maintenance Is Validated
//Depends On TC  : None
//Revision       : 0.0 - JannathHussain-03-01-2018 
//======================================================================================================================================================================================================================================================================================

public class RMA_Reg_Maint_Vehicle_TC_019  extends rmaseleniumtestscripts.RMA_TC_BaseTest  {
	@Test	
	public void RMA_Reg_Maint_Vehicle_TC_019_Test() throws Exception, Error
	{   
		try {	 	 
			...
			parentlogger = reports.startTest("RMA_Reg_Maint_Vehicle_TC_019_Attachments SMS Permission Setting For Vehicle Is Validation", "Functionality of Attachments For Vehicle Permission Setting On Security Management System Is Validated");
			parentlogger.assignAuthor("Jannath Hussain");
			StrScreenShotTCName = "RMA_Reg_Maint_Vehicle_TC_019";
			...
			RMAApp_SMS_Lnk_DataSourceName = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_Reg_Maint_Vehicle_TC_019", 4, 0); //Data Source Name Is Fetched From DataSheet RMA_Reg_Maint_Vehicle_TC_019
			RMAApp_Login_Txt_UserName = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_Reg_Maint_Vehicle_TC_019", 1, 1); //UserName Fetched From DataSheet RMA_Reg_Maint_Vehicle_TC_019
			RMAApp_Login_Txt_Password = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_Reg_Maint_Vehicle_TC_019", 1, 2); //Password Fetched From DataSheet RMA_Reg_Maint_Vehicle_TC_019
         	RMAApp_SMS_Lnk_ModuleSecurityGroup = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_Reg_Maint_Vehicle_TC_019", 1, 3); //Module Security Group Name Is Fetched From DataSheet RMA_Reg_Maint_Vehicle_TC_019
			RMAApp_SMS_Lnk_ModuleAccessPermission = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_Reg_Maint_Vehicle_TC_019", 1, 4); //Module Access Permission Name Is Fetched From DataSheet RMA_Reg_Maint_Vehicle_TC_019	
			...
			//=================================================Revoke Attachments Permission Started Here====================================================================
			...
			RMA_Navigation_Utility.RMA_ObjectClick(rmaseleniumPOM_UX.RMA_Selenium_POM_Vehicle.RMAApp_Vehicle_SMS_Attachments(driver, "Attachments"),"Click On Attachments From Module Access Permission On Security Management System Page",logval);
			...
			RMA_Verification_Utility.RMA_VerifyUXSpinnerDisappered(logval);
			//==================================================Revoke Attachments Permission Completed Here=================================================================================
			...
			RMA_GenericUsages_Utility.RMA_StaticWait(3, logval, "Wait Is Added To Click On Attachments Button From Vehicle");
			RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_Home.RMAApp_Generic_Img_Attach(driver), "Attach Documents Image On Vehicle Maintenance", logval);
			
			//===========================================================Verification Of Forbidden Message Is Started Here==================================================================================================================================================================================================================================================================================================================================================================================================
			RMA_GenericUsages_Utility.RMA_DynamicFrameSwitching(RMA_Selenium_POM_VerificationMessage.AttchmentFrame );
			String Title=rmaseleniumPOM_UX.RMA_Selenium_POM_Attachment.RMAApp_Attachments_Header(driver).getText();
			RMA_Verification_Utility.RMA_PartialTextVerification("Forbidden", Title, "Create Permission", logval);
			RMA_GenericUsages_Utility.RMA_WebPageRefresh_Utility_UX(logval);
			//===========================================================Verification Of Forbidden Message Is Completed Here=================================================================================================================================================================================================================================================================================================================================================================================================

			//===========================================================Revert Attachments Permission Is Started Here==============================================================================================================================================================================================================================================================================================================================================================================================================================================================
			driver.switchTo().window(StrRMAWindowHandle);
			RMA_GenericUsages_Utility.RMA_WindowSwitchingBasedOnTitle("CSC Riskmaster Accelerator");
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_Login_DSNSelect_Frames.RMAApp_Dashboard_Lbl_SMS(driver), "Security Management System Navigation Option Label On RiskMaster Application's Dashboard Page",logval);
			RMA_GenericUsages_Utility.RMA_WindowSwitchingBasedOnTitle("Riskmaster Security");
			...
			RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_SMS.RMAApp_SMSModuleAccPerm_Img_ExpandCollapse(driver, RMAApp_SMS_Lnk_ModuleAccessPermission),"Expand Image Of Following Module Access Permission" + " "+ color.RMA_ChangeColor_Utility(RMAApp_SMS_Lnk_ModuleAccessPermission,3)+ " " + "For Module Security Group:"+ " "+color.RMA_ChangeColor_Utility(RMAApp_SMS_Lnk_ModuleSecurityGroup,3)+  " " +"On Left Navigation Menu Tree Of Security Management System Page",logval);
			RMA_Verification_Utility.RMA_VerifyUXSpinnerDisappered(logval);
			RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_SMS.RMAApp_SMSModuleAccPerm_Img_ExpandCollapse(driver, "Vehicle Maintenance"),"Expand Image Of Vehicle Maintenance Link From Module Access Permission On Security Management System Page",logval);
			RMA_Verification_Utility.RMA_VerifyUXSpinnerDisappered(logval);
			RMA_GenericUsages_Utility.RMA_StaticWait(5, logval, "Wait Is Added To Loader Gets Disappeared");
			RMA_Navigation_Utility.RMA_ObjectClick(rmaseleniumPOM_UX.RMA_Selenium_POM_Vehicle.RMAApp_Vehicle_SMS_Attachments(driver, "Attachments"),"Click On Attachments From Module Access Permission On Security Management System Page",logval);
			...
			RMA_Verification_Utility.RMA_VerifyUXSpinnerDisappered(logval);
			//===========================================================Revert Attachments Permission Is Completed Here==============================================================================================================================================================================================================================================================================================================================================================================================================================================================
