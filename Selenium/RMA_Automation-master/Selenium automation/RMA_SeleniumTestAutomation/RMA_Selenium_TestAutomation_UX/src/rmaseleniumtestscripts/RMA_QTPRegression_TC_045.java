...
//=====================================================================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_QTPRegression_TC_045
//Description    : Recreation Of Checks From Funds Link Is Validated
//Depends On TC  : None
//Revision       : 0.0 - NidhiJha-09-13-2017
//===================================================================================================================================================================================================================================================================================================================================


public class RMA_QTPRegression_TC_045 extends RMA_TC_BaseTest{
	@Test
	public void RMA_QTPRegression_TC_045_Test() throws Exception,Error {
		...
		StrScreenShotTCName = "RMA_QTPRegression_TC_045";
		...
		try{
			...
			parentlogger = reports.startTest("RMA_QTPRegression_TC_045_Recreation_Of_Checks_Validation","Recreation Of Checks From Funds Link Is Validated");
			...
			GenClaimCreation_Txt_ClaimType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_045", 1, 0); //Claim Type Is Fetched From DataSheet RMA_QTPRegression_TC_045			
			GenClaimCreation_Txt_Department = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_045", 1,1 ); //Department Is Fetched From DataSheet RMA_QTPRegression_TC_045
			GenClaimCreation_Txt_ClaimStatus =  ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_045", 1,2 ); //Claim Status Is Fetched From DataSheet RMA_QTPRegression_TC_045
			GenClaimCreation_Txt_ServiceCode = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_045", 1,3 ); //Service Code Is Fetched From DataSheet RMA_QTPRegression_TC_045
			//General Claim Data Fetch From Excel WorkBook Is Completed Here

			PaymentCreation_Lst_PayeeType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_045", 1, 4); // Payee Type Is Fetched From DataSheet RMA_QTPRegression_TC_045
			FundsSplitDetails_Lst_TransactionType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_045", 1, 5); //Transaction Type Is Fetched From DataSheet RMA_QTPRegression_TC_045
			PaymentCreation_Txt_LastName = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_045", 1, 6); //LastName Is Fetched From DataSheet RMA_QTPRegression_TC_045
			PaymentCreation_Txt_DisType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_045", 1, 7); //Distribution Type Is Fetched From DataSheet RMA_QTPRegression_TC_045
			FundsSplitDetails_Lst_ReserveType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_045", 1, 8); // Reserve Type Is Fetched From DataSheet RMA_QTPRegression_TC_045
			FundsSplitDetails_Txt_Amount =  ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_QTPRegression_TC_045", 1, 9);//Funds Split Details Amount Is Fetched From DataSheet RMA_QTPRegression_TC_045
			//Payment Data Fetch From Excel WorkBook Is Completed Here

			CheckStockCreation_Txt_FontStyle = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_045", 1, 10);//Font Style Is Fetched From DataSheet RMA_QTPRegression_TC_045
			CheckStockCreation_Txt_FontSize = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_QTPRegression_TC_045", 1, 11);//Font Size Is Fetched From DataSheet RMA_QTPRegression_TC_045
			//Check Stock Data Fetch From Excel WorkBook Is Completed Here


			RMA_GenericUsages_Utility.RMA_Non_UXNavigation();

			RMA_Functionality_Utility.RMA_Suite23_Utility("RMA_QTPRegression_TC_045", logval);
			...
			ContentToBeVerified=new Object[]{"UNIVERSAL",GenClaimNumber,strcontrolnumber};
			...
			testcall5 = true;
			CheckBatchNumber = RMA_Functionality_Utility.RMA_PrintChecks_Utility("Funds-PrintChecks",BankAccountCreation_Txt_BankAccountName,"NA",ContentToBeVerified,"NA", logval1);
			...
			//========================================Steps To Re-Create Check By Navigate To Funds--->Re Create Check File Page Is Started Here=================================================================================================================================================================================================================
			parentlogger.log(LogStatus.INFO, "Following Function Is Called :: "+RMA_GenericUsages_Utility.RMA_LoggerHyperlink("ReCreateChecks","RMA_Funds_ReCreateCheckFile",0)+" To Successfully Re-Create Checks");
			testcall6 = true;
			RMA_Functionality_Utility.RMA_Funds_ReCreateCheckFile(BankAccountCreation_Txt_BankAccountName,CheckBatchNumber,logval1);
			parentlogger.log(LogStatus.INFO, "Check Is Recreated Successfully For Bank Account"+ " " + color.RMA_ChangeColor_Utility(BankAccountCreation_Txt_BankAccountName, 2));
			loggerval6 = logger.toString();
			parentlogger.appendChild(logger);
			//========================================Steps To Re-Create Check By Navigate To Funds--->Re Create Check File Page Is Completed Here======================================================================================================================================================================================================
			...
			{
				logger.log(LogStatus.FAIL, "Following Error Occurred  ::" + " "+  color.RMA_ChangeColor_Utility(FinalErrorMessage,1)+ " " + "While Executing Function Utility" +" "+ "RMA_Funds_ReCreateCheckFile" + " " +  "To Recreate Checks And Hence The Test Case Is A Fail");
				parentlogger.appendChild(logger);
				reports.endTest(logger);	
			}
