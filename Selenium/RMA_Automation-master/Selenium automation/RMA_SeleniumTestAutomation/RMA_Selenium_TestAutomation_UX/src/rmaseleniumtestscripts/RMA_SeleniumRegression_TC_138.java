...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_SeleniumRegression_TC_138
//Description    : Create, Edit and Delete of Attachments For A Witness(PI) On A Litigation Page Is Validated
//Depends On TC  : RMA_SeleniumRegression_TC_024(For the Litigation Creation)
//Revision       : 0.0 - ShrutiShruti-01-12-2018
//This TestCase Is Placed At The Last Of XML File As It Contains Code To Delete The Litigation As Well
//======================================================================================================================================================================================================================================================================================

public class RMA_SeleniumRegression_TC_138 extends RMA_TC_BaseTest{
	@Test
	public void RMA_SeleniumRegression_TC_138_Test() throws Exception,Error{
		try{
			parentlogger = reports.startTest("RMA_SeleniumRegression_TC_138_Create, Edit And Delete Of Attachments On Person Involved(Witness) On A Litigation Screen", "Create,Edit and Delete Of Attachments On A Person Involved(Witness) On A Litigation Is Validated");
			parentlogger.assignAuthor("Shruti Shruti");

			StrScreenShotTCName = "RMA_SeleniumRegression_TC_138";
			testcall1 = false;	
	...
	public void RMA_FailureReport(ITestResult result) //All The Information Associated With The Test Case Is Stored In Result Variable
	{
		...
		{
			try {
				RMA_GenericUsages_Utility.RMA_StaticWait(5, logval, "Wait Is Added As Error Condition Has Occured During Attachments Create, Edit And Delete And Its Screen Needs To Be Closed");
