...
//=====================================================================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_QTPRegression_TC_112
//Description    : Verify The Setting 'Calculate Collections In Reserve Balance(All Claims)' Is Not In Effect For The Recovery Reserve Is Validated
//Depends On TC  : None
//Revision       : 0.0 - AbhishekRai-10-24-2017
//===================================================================================================================================================================================================================================================================================================================================

public class RMA_QTPRegression_TC_112 extends RMA_TC_BaseTest {	
	
	@Test
	public void RMA_QTPRegression_TC_112_Test() throws Exception,Error {
		try{
			parentlogger = reports.startTest("RMA_QTPRegression_TC_112_Verify The Setting 'Calculate Collections In Reserve Balance(All Claims)' Is Not In Effect For The Recovery Reserve", "Verify The Setting 'Calculate Collections In Reserve Balance(All Claims)' Is Not In Effect For The Recovery Reserve Is Validated");
			parentlogger.assignAuthor("Abhishek Rai");		
			
			//Region =====================================================Global Variable Initialization Is Started Here=====================================================================================================
			StrScreenShotTCName = null;
			StrScreenShotTCName = "RMA_QTPRegression_TC_112";
			testcall1 = false;	
			...
			LineOfBussinessParameterSetup_Lst_LOBType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_112", 1, 0); //LOB Type Is Fetched From DataSheet RMA_QTPRegression_TC_112
			GenClaimCreation_Txt_ClaimType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_112", 1, 1); //Claim Type Is Fetched From DataSheet RMA_QTPRegression_TC_112
			GenClaimCreation_Txt_ClaimStatus = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_112", 1, 2); // Claim Status Is Fetched From DataSheet RMA_QTPRegression_TC_112
			GenClaimCreation_Txt_Department = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_112", 1, 3); // Department Is Fetched From DataSheet RMA_QTPRegression_TC_112						
			ReserveCreation_Lst_ReserveType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_112", 1, 4); //Reserve Type Is Fetched From DataSheet RMA_QTPRegression_TC_112
			ReserveCreation_Lst_ReserveStatus = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_112", 1, 5); //Reserve Status Is Fetched From DataSheet RMA_QTPRegression_TC_112
			ReserveCreation_Txt_ReserveAmount = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_QTPRegression_TC_112", 1, 6); //Amount Is Fetched From DataSheet RMA_QTPRegression_TC_112
			ReserveCreation_Lst_ReserveType_1 = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_112", 1, 7); //Reserve Type_1 Is Fetched From DataSheet RMA_QTPRegression_TC_112
			ReserveCreation_Txt_ReserveAmount_1 = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_QTPRegression_TC_112", 1, 8); //Amount_1 Is Fetched From DataSheet RMA_QTPRegression_TC_112												
			PaymentCreation_Lst_BankAccount = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_112", 1, 9); //BankAccount Is Fetched From DataSheet RMA_QTPRegression_TC_112
			PaymentCreation_Lst_PayeeType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_112", 1, 10); //Payee Type Is Fetched From DataSheet RMA_QTPRegression_TC_112
			Payment_Txt_LastName = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_112", 1, 11); //Last Name Is Fetched From DataSheet RMA_QTPRegression_TC_112
			PaymentCreation_Txt_DisType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_112", 1, 12); //Distribution Type Is Fetched From DataSheet RMA_QTPRegression_TC_112			
			FundsSplitDetails_Txt_Amount = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_QTPRegression_TC_112", 1, 13); //Amount Is Fetched From DataSheet RMA_QTPRegression_TC_112			
			FundsSplitDetails_Lst_TransactionType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_112", 1, 14); //Transaction Type Is Fetched From DataSheet RMA_QTPRegression_TC_112									
			FundsSplitDetails_Txt_Amount_1 = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_QTPRegression_TC_112", 1, 15); //Amount Is Fetched From DataSheet RMA_QTPRegression_TC_112			
			FundsSplitDetails_Lst_TransactionType_1 = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_112", 1, 16); //Transaction Type Is Fetched From DataSheet RMA_QTPRegression_TC_112
			...
			rmaseleniumutilties_UX.RMA_Functionality_Utility.RMA_Suite21_Check_Utility("RMA_QTPRegression_TC_112_01",LineOfBussinessParameterSetup_Lst_LOBType, logval);			
			...
			rmaseleniumutilties_UX.RMA_Functionality_Utility.RMA_Suite21_Check_Utility("RMA_QTPRegression_TC_112_02",LineOfBussinessParameterSetup_Lst_LOBType, logval);	
			driver.close();
			RMA_GenericUsages_Utility.RMA_WindowSwitching_Utility_NonUX();		
			...
			RMA_GenericUsages_Utility.RMA_Non_UXNavigation(true);
			rmaseleniumutilties_UX.RMA_Functionality_Utility.RMA_Suite21_Check_Utility("RMA_QTPRegression_TC_112_03",LineOfBussinessParameterSetup_Lst_LOBType, logval);	
			driver.close();
			RMA_GenericUsages_Utility.RMA_WindowSwitching_Utility_NonUX();	
		} 
