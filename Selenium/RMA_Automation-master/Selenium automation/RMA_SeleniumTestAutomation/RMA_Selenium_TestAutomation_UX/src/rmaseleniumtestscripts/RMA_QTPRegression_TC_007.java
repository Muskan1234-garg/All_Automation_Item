...
//=====================================================================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_QTPRegression_TC_007
//Description    : '6 - Split Amt, Trans Type, & Trans Date within X Days' Duplicate Payment Criteria Is Validated 
//Revision       : 0.0 - AnubhutiVyas-07-20-2017
//===================================================================================================================================================================================================================================================================================================================================

public class RMA_QTPRegression_TC_007 extends RMA_TC_BaseTest {	
	@Test
	public void RMA_QTPRegression_TC_007_Test() throws Exception,Error {
		...
		StrScreenShotTCName = "RMA_QTPRegression_TC_006";
		DefaultFrameID = null;
		//Global Variable Initialization Is Completed Here

		try{    

			parentlogger = reports.startTest("RMA_QTPRegression_TC_007_Duplicate_Payment_Criteria_6_Validation", "'6 - Split Amt, Trans Type, & Trans Date within X Days' Duplicate Payment Criteria Is Validated ");
			...
			RMA_ExcelDataRetrieval_Utility ExcelData = new RMA_ExcelDataRetrieval_Utility(System.getProperty("user.dir")+"\\RMASeleniumTestDataSheets\\RMA_Suite_02_QTPRegression_01.xlsx"); //Excel WorkBook RMA_Suite_02_QTPRegression_01 IS Fetched To Retrieve Data 
			Payment_Lst_PayeeType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_007", 1, 0); // Payee Type Is Fetched From DataSheet RMA_QTPRegression_TC_006
			FundsSplitDetails_Lst_TransactionType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_007", 1, 1); //Transaction Type Is Fetched From DataSheet RMA_QTPRegression_TC_007
			FundsSplitDetails_Txt_Amount = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_QTPRegression_TC_007", 1, 2); //Amount Is Fetched From DataSheet RMA_QTPRegression_TC_007
			Payment_Txt_LastName = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_007", 1, 3); //LastName Is Fetched From DataSheet RMA_QTPRegression_TC_007
			Payment_Txt_DisType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_007", 1, 4); //Distribution Type Is Fetched From DataSheet RMA_QTPRegression_TC_007
			ReserveType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_007", 1, 5); // Reserve Type Is Fetched From DataSheet RMA_QTPRegression_TC_007
			//Payment Data Fetched Is Completed Here

			GenClaimCreation_Txt_ClaimType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_007", 1, 6); //Claim Type Is Fetched From DataSheet RMA_QTPRegression_TC_007
			GenClaimCreation_Txt_ClaimStatus =  ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_007", 1,7); //Claim Status Is Fetched From DataSheet RMA_QTPRegression_TC_007
			GenClaimCreation_Txt_Department = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_007", 1,8); //Department Is Fetched From DataSheet RMA_QTPRegression_TC_007
			...
			rmaseleniumutilties_UX.RMA_Functionality_Utility.DuplicatePaymentCriteria_Utility("6 - Split Amt, Trans Type, & Trans Date within X Days", logval);	
			...
			testcall2 = true;
			StrControlNumber = RMA_Functionality_Utility.RMA_ConditionalPaymentCorpAddition_Utility(Payment_Txt_BankAccount, Payment_Lst_PayeeType,ReserveType, FundsSplitDetails_Lst_TransactionType,FundsSplitDetails_Txt_Amount, Payment_Txt_LastName, Payment_Txt_DisType, "NA", "NA",logval1);
			...
			testcall3 = true;
			RMA_Functionality_Utility.RMA_UnsuccessfulPaymentCorpAddition_Utility(Payment_Txt_BankAccount, Payment_Lst_PayeeType,ReserveType, FundsSplitDetails_Lst_TransactionType,FundsSplitDetails_Txt_Amount, Payment_Txt_LastName, Payment_Txt_DisType, "NA", logval1);
			loggerval3 = logger.toString();
			parentlogger.appendChild(logger);
			//==============================================================Steps To Add Second Payment For Created General Claim Is Completed Here====================================================================================================================================================================================================================================================================

			//==============================================================Steps To Verify Display Of Verification Message,Claim Number,Control Number And Funds Split Amount On Duplicate Payment Criteria Window Is Started Here==========================================================================================================================================================================================
			...
			//==============================================================Steps To Verify Display Of Verification Message,Claim Number,Control Number And Funds Split Amount On Duplicate Payment Criteria Window Is Completed Here===========================================================================================================================================================================
			...
			//==============================================================Steps To Verify Display Of Verification Message,Claim Number,Control Number And Funds Split Amount On Duplicate Payment Criteria Window For Third Payment Is Started Here============================================================================================================================================================
			RMA_Verification_Utility.RMA_ObjectDisplayVerify_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_RMAAppText(driver, RMA_Selenium_POM_VerificationMessage.DuplicatePaymentVerification), "displayed", "Duplicate Payment Criteria Message", logval);
			RMA_Verification_Utility.RMA_TableVerifyText_Utility(RMA_Selenium_POM_Home.RMAApp_GenericUXWindow_Tbl(driver), StrControlNumber, 6, "$" + String.valueOf(FundsSplitDetails_Txt_Amount)+ ".00", 8, ClaimNumber, "Duplicate Payment Criteria Table", logval1); 
			RMA_Verification_Utility.RMA_TableVerifyText_Utility(RMA_Selenium_POM_Home.RMAApp_GenericUXWindow_Tbl(driver), StrControlNumber_1, 6, "$" + String.valueOf(FundsSplitDetails_Txt_Amount)+ ".00", 8, ClaimNumber, "Duplicate Payment Criteria Table", logval1);			//==============================================================Steps To Verify Display Of Verification Message,Claim Number,Control Number And Funds Split Amount On Duplicate Payment Criteria Window For Third Payment Is Completed Here==========================================================================================================================================================
			...
			//==============================================================Steps To Verify Display Of Verification Message,Claim Number,Control Number And Funds Split Amount On Duplicate Payment Criteria Window For Third Payment Is Completed Here==========================================================================================================================================================
			...
			{
				logger.log(LogStatus.FAIL, "Following Error Occurred  ::" + " "+  color.RMA_ChangeColor_Utility(FinalErrorMessage,1)+ " " + "While Executing Function Utility" +" "+ "RMA_ConditionalPaymentCorpAddition_Utility" + " " +  "To Create New successful Payment And Hence The Test Case Is A Fail");
				parentlogger.appendChild(logger);
				reports.endTest(logger);	
			}
			if (testcall3 == true && loggerval3.equalsIgnoreCase("NotInitialized"))								
			{
				logger.log(LogStatus.FAIL, "Following Error Occurred  ::" + " "+  color.RMA_ChangeColor_Utility(FinalErrorMessage,1)+ " " + "While Executing Function Utility" +" "+ "RMA_UnsuccessfulPaymentCorpAddition_Utility" + " " +  "To Create New Unsuccessful Payment And Hence The Test Case Is A Fail");
				parentlogger.appendChild(logger);
				reports.endTest(logger);	
			}
