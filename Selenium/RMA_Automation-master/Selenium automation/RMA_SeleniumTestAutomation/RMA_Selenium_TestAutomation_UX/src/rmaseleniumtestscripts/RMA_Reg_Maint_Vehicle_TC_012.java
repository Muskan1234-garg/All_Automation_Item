...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_Reg_Maint_Vehicle_TC_012
//Description    : Verify That Page Cannot Be Displayed In Power View Must Be Displayed When Inspections Page Is Not Added In Power View Is Validated
//Depends On TC  : None
//Revision       : 0.0 - NikitaThani-02-23-2018 
//======================================================================================================================================================================================================================================================================================

public class RMA_Reg_Maint_Vehicle_TC_012 extends RMA_TC_BaseTest{
	@Test
	public void RMA_Reg_Maint_Vehicle_PowerView_TC_012_Test() throws Exception, Error
	{ 
		try{	
			parentlogger = reports.startTest("RMA_Reg_Maint_Vehicle_PowerView_TC_012_Verify Correct Validation Is Displayed When Inspections Page Is Not Added In PV", "Verify Page Cannot Be Displayed In Power View Is Displayed When Some Right Navigation Page Is Not Added In Power View Is Validated");
			parentlogger.assignAuthor("Nikita Thani");
			StrScreenShotTCName = "RMA_Reg_Maint_Vehicle_PowerView_TC_012";
			...
			RMAApp_Login_Txt_UserName = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_Reg_Maint_Vehicle_PV_TC_012", 1, 0); //UserName Fetched From DataSheet RMA_Reg_Maint_Vehicle_PV_TC_012
			RMAApp_Login_Txt_Password = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_Reg_Maint_Vehicle_PV_TC_012", 1, 1); //Password Fetched From DataSheet RMA_Reg_Maint_Vehicle_PV_TC_012
			RMAApp_Login_Txt_UserName1 = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_Reg_Maint_Vehicle_PV_TC_012", 1, 2); //UserName Fetched From DataSheet RMA_Reg_Maint_Vehicle_PV_TC_012
			RMAApp_Login_Txt_Password1 = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_Reg_Maint_Vehicle_PV_TC_012", 1, 3); //Password Fetched From DataSheet RMA_Reg_Maint_Vehicle_PV_TC_012
			RMAApp_SMS_Lst_DataSourceName = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_Reg_Maint_Vehicle_PV_TC_012", DSRow, 4); //Data Source Name Is Fetched From DataSheet RMA_Reg_Maint_Vehicle_PV_TC_012			
			...
			//============================================================Verification for Inspection Page Before Changes In PowerView Started Here=================================================================================================================================
			globalWait.until(ExpectedConditions.visibilityOf(RMA_Selenium_POM_Home.RMAApp_GenericBtn_EnityAdd(driver, "Inspections")));
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_Home.RMAApp_GenericBtn_EnityAdd(driver, "Inspections"), "Add Image Button For Vehicle Inspection For Vehicle With ID:: " + StrVehicleID  + " On Vehicle Creation Page",logval);					
			RMA_Verification_Utility.RMA_ElementExist_Utility(RMA_Selenium_POM_Vehicle.RMAApp_VehicleInsp_Txt_InspectionDate(driver), "Inspection Date TextBox On Vehicle Inspection Page", logval);
			//============================================================Verification for Inspection Page Before Changes In PowerView Completed Here=================================================================================================================================
			...
			//============================================================Steps To Change Power View Started Here===================================================================================================================================================
			...
			globalWait.until(ExpectedConditions.visibilityOf(RMA_Selenium_POM_PowerView.RMAApp_PowerView_Chk_Entity(driver, "Vehicle Inspection Data")));
			RMA_Navigation_Utility.RMA_WebCheckBoxSelect_Utility(RMA_Selenium_POM_PowerView.RMAApp_PowerView_Chk_Entity(driver, "Vehicle Inspection Data"), "uncheck", "Vehicle Inspection Data CheckBox", "Power View Editor Page", logval);
			...
			//==============================================================Steps To Change PoweView Completed Here===================================================================================================================================================

			//=====================================Steps To Verify changes Of PowerView Started Here==========================================================================
			driver.switchTo().window(StrRMAMaintUXWindowHandle);
			driver.switchTo().parentFrame();
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_Home.RMAApp_DefaultView_Img_Reload(driver),"Reload Button On Vehicle Inspection Page",logval);
			RMA_GenericUsages_Utility.RMA_DynamicFrameSwitching(RMA_Selenium_POM_VerificationMessage.VehicleFrame);
			RMA_Verification_Utility.RMA_VerifyUXMessage("The page can not be found in the PowerView.", true, "Vehicle-->Maintenance Creation Page", logval);
			driver.close();
			//=====================================Steps To Verify changes Of PowerView Completed Here==========================================================================
			...
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_PowerView.RMAApp_PowerView_Lbl_PowerViewName(driver, "Vehicle"), "PowerView Link On Power View Editor Page", logval);
			globalWait.until(ExpectedConditions.visibilityOf(RMA_Selenium_POM_PowerView.RMAApp_PowerView_Chk_Entity(driver, "Vehicle Inspection Data")));
			RMA_Navigation_Utility.RMA_WebCheckBoxSelect_Utility(RMA_Selenium_POM_PowerView.RMAApp_PowerView_Chk_Entity(driver, "Vehicle Inspection Data"), "check", "Vehicle Inspection Data CheckBox", "Power View Editor Page", logval);
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_PowerView.RMAApp_PowerView_Btn_Save(driver), "Save Image Button On Power View Editor Page", logval);
