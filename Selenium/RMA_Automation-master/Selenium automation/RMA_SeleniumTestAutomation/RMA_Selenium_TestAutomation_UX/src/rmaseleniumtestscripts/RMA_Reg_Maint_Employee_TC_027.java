...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_Reg_Maint_Employee_TC_027
//Description    : Create, Edit And Delete Of Attachment On Employee Is Validated
//Depends On TC  : None
//Revision       : 0.0 - ShrutiShruti-03-09-2018
//======================================================================================================================================================================================================================================================================================

public class RMA_Reg_Maint_Employee_TC_027 extends RMA_TC_BaseTest{
	@Test
	public void RMA_Reg_Maint_Employee_TC_027_Test() throws Exception,Error{
		try{
			parentlogger = reports.startTest("RMA_Reg_Maint_Employee_TC_027_Create, Edit and Delete of Attachmments On Employee On Maintenance Screen", "Create, Edit and Delete of Attachments On Employee Maintenance Page on Maintenance Screen Is Validated");
			...
			StrScreenShotTCName = "RMA_Reg_Maint_Employee_TC_027";
			ErrorMessage = null;
			CurrentFrameID=null;
			...
			//=================================================Steps To Delete Employee Started Here=================================================================================================================================================================================================
			RMA_Functionality_Utility.RMA_GenericDelete_Utility("Maintenance-->Employee", false, logval);
			RMA_Functionality_Utility.RMA_GenericDelete_Utility("Maintenance-->Employee", true, logval);
			//=================================================Steps To Delete Employee Completed Here=============================================================================================================================================================================================================================
