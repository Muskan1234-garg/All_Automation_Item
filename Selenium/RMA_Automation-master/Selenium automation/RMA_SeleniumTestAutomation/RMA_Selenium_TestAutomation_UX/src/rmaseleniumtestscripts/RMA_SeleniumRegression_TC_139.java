...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_SeleniumRegression_TC_139
//Description    : Create, Edit and Delete of Attachments For A OtherPerson(PI) On A Litigation Page Is Validated
//Depends On TC  : RMA_SeleniumRegression_TC_024(For the Litigation Creation)
//Revision       : 0.0 - ShrutiShruti-01-12-2018
//======================================================================================================================================================================================================================================================================================

public class RMA_SeleniumRegression_TC_139 extends RMA_TC_BaseTest{
	@Test
	public void RMA_SeleniumRegression_TC_139_Test() throws Exception,Error{
		try{
			parentlogger = reports.startTest("RMA_SeleniumRegression_TC_139_Create, Edit And Delete Of Attachments On Person Involved(OtherPerson) On A Litigation Screen", "Create,Edit and Delete Of Attachments On A Person Involved(OtherPerson) On A Litigation Is Validated");
			parentlogger.assignAuthor("Shruti Shruti");

			StrScreenShotTCName = "RMA_SeleniumRegression_TC_139";
			testcall1 = false;	
