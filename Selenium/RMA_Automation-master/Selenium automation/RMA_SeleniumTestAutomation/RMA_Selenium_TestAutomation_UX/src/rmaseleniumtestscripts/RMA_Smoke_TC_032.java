...
//Description    : Verify That Attachment Can Be Created,Edited And Deleted Successfully From Payment Page Along-with Data Entry In Title, Subject, Notes, Keywords TextBox And NG Grid Search Filter Functionalities
//Depends On TC  : RMA_Smoke_TC_002, RMA_Smoke_TC009, RMA_Smoke_TC011
//Modify By 	 :0.0- RenuVerma-06-19-2017
//======================================================================================================================================================================================================================
...
public class RMA_Smoke_TC_032 extends RMA_TC_BaseTest {
	...
	public void RMA_Smoke_TC_032_Test() throws Exception,Error {
		...
		testcall2 = false;
		StrScreenShotTCName = "RMA_Smoke_TC_032";
		...
		try{
			parentlogger = reports.startTest("RMA_Smoke_TC_032_Document Attachment On Payment", "Verify That Attachment Can Be Created,Edited And Deleted Successfully From Payment Page Along-with Data Entry In Title, Subject, Notes, Keywords TextBox And NG Grid Search Filter Functionalities");
			...
			//***************************************************Add, Edit  Of Document On Payment Is Started***************************************************************************************************************************************************************************************************************************************************************
			...
			parentlogger.log(LogStatus.INFO,  "Document Is Attached And Edited Successfully On Payment :"+" "+RMA_Smoke_TC_011.StrControlNumber_Smoke_TC_011);
			parentlogger.appendChild(logger);
			//***************************************************Add, Edit Of Document On Payment Is Completed***************************************************************************************************************************************************************************************************************************************************************
			...
			//***************************************************Attachment delete functionality on Payment screen is started here ***************************************************************************************************************************************************************************************************************************************	
		     ...
		     parentlogger.log(LogStatus.INFO, "Document Is  Deleted Successfully On Payment :"+" "+RMA_Smoke_TC_011.StrControlNumber_Smoke_TC_011);
