...
//==================================================================================================================================================================================
//TestCaseID   	 : RMA_QTPRegression_TC_125
//Description    : Verification Of EFT Payments When Check Box For Roll Up Payment To The Same Payee Is UnChecked
//Depends On TC  : RMA_QTPRegression_TC_124
//Revision       : 0.0 - AnubhutiVyas-02-07-2018
//========================================================================================================================================================================================
public class RMA_QTPRegression_TC_125 extends RMA_TC_BaseTest
{

	@Test  
	public void RMA_QTPRegression_TC_125_Test() throws Exception, Error
	{
		testcall1 = false;	
		...
		StrScreenShotTCName = "RMA_QTPRegression_TC_125";
		...
		try {
			parentlogger = reports.startTest("RMA_QTPRegression_TC_125_EFT Payments Roll Up To The Same Payee", "Verification Of EFT Payments When Check Box For Roll Up Payment To The Same Payee Is UnChecked");
			...
			GenClaimCreation_Txt_ClaimType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_124", 1, 3); //Claim Type Is Fetched From DataSheet RMA_QTPRegression_TC_125
			GenClaimCreation_Txt_ClaimStatus =  ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_124", 1,4 ); //Claim Status Is Fetched From DataSheet RMA_QTPRegression_TC_125
			GenClaimCreation_Txt_Department = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_124", 1,5); //Department Is Fetched From DataSheet RMA_QTPRegression_TC_125
			//Claim Data Fetch From Excel WorkBook Is Completed Here
			
			PaymentCreation_Lst_PayeeType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_124", 1, 6); // Payee Type Is Fetched From DataSheet RMA_QTPRegression_TC_125
			FundsSplitDetails_Lst_TransactionType= ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_124", 1,7); //Transaction Type For Medical Reserve Payment Is Fetched From DataSheet RMA_QTPRegression_TC_125
			FundsSplitDetails_Txt_Amount = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_QTPRegression_TC_124", 1, 8); //Medical Amount Is Fetched From DataSheet RMA_QTPRegression_TC_125
			PaymentCreation_Txt_LastName = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_124", 1, 9); //LastName Is Fetched From DataSheet RMA_QTPRegression_TC_125
			PaymentCreation_Txt_DisType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_124", 1, 10); //Distribution Type Is Fetched From DataSheet RMA_QTPRegression_TC_125
			PaymentCreation_Lst_ReserveType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_124", 1, 11); // Medical Reserve Type Is Fetched From DataSheet RMA_QTPRegression_TC_125
			PaymentCreation_Txt_BankAccount = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_124", 1, 12); // Bank Account Is Fetched From DataSheet RMA_QTPRegression_TC_125
			...
			testcall1 = true;
			RMA_Functionality_Utility.RMA_Suite06_Utility("RMA_QTPRegression_TC_125", logval1);//General System Parameter & Payment Parameter Settings Are Done
			...
			testcall3 = true;
			StrControlNumber_1 = RMA_Functionality_Utility.RMA_ConditionalPaymentCorpAddition_Utility(RMA_QTPRegression_TC_124.BankAccountName, PaymentCreation_Lst_PayeeType,PaymentCreation_Lst_ReserveType, FundsSplitDetails_Lst_TransactionType,FundsSplitDetails_Txt_Amount, RMA_QTPRegression_TC_124.Entity_Txt_Name, "NA","EFT","NA",logval1);
			...
			RMA_Verification_Utility.RMA_TextCompare(RMA_QTPRegression_TC_124.EntityAddress_Txt_Addr1, RMA_Selenium_POM_PaymentsCollections.RMAApp_PaymentCollection_Txt_Address1(driver).getAttribute("value"),"Address 1 Value", logval);
			RMA_Verification_Utility.RMA_TextCompare(RMA_QTPRegression_TC_124.EntityAddress_Txt_Addr2, RMA_Selenium_POM_PaymentsCollections.RMAApp_PaymentCollection_Txt_Address2(driver).getAttribute("value"),"Address 2 Value", logval);
			RMA_Verification_Utility.RMA_TextCompare(RMA_QTPRegression_TC_124.EntityAddress_Txt_Addr3, RMA_Selenium_POM_PaymentsCollections.RMAApp_PaymentCollection_Txt_Address3(driver).getAttribute("value"),"Address 3 Value", logval);
			RMA_Verification_Utility.RMA_TextCompare(RMA_QTPRegression_TC_124.EntityAddress_Txt_Addr4, RMA_Selenium_POM_PaymentsCollections.RMAApp_PaymentCollection_Txt_Address4(driver).getAttribute("value"),"Address 4 Value", logval);
			...
			parentlogger.log(LogStatus.INFO, "Following Function Is Called :: "+RMA_GenericUsages_Utility.RMA_LoggerHyperlink("PaymentAddition","RMA_ConditionalPaymentCorpAddition_Utility",0)+" To Create New Payment");
			testcall4 = true;
			StrControlNumber_2 = RMA_Functionality_Utility.RMA_ConditionalPaymentCorpAddition_Utility(RMA_QTPRegression_TC_124.BankAccountName, PaymentCreation_Lst_PayeeType,PaymentCreation_Lst_ReserveType, FundsSplitDetails_Lst_TransactionType,FundsSplitDetails_Txt_Amount, RMA_QTPRegression_TC_124.Entity_Txt_Name, "NA","EFT","NA",logval1);
			...
			parentlogger.log(LogStatus.INFO, "Following Function Is Called :: "+RMA_GenericUsages_Utility.RMA_LoggerHyperlink("PaymentAddition","RMA_ConditionalPaymentCorpAddition_Utility",0)+" To Create New Payment");
			testcall5 = true;
			StrControlNumber_3 = RMA_Functionality_Utility.RMA_ConditionalPaymentCorpAddition_Utility(RMA_QTPRegression_TC_124.BankAccountName, PaymentCreation_Lst_PayeeType,PaymentCreation_Lst_ReserveType, FundsSplitDetails_Lst_TransactionType,FundsSplitDetails_Txt_Amount, RMA_QTPRegression_TC_124.Entity_Txt_Name, "NA","EFT","NA",logval1);
			...
			ContentToBeVerified=new Object[]{StrClaimNumber,StrControlNumber_1,StrControlNumber_2,StrControlNumber_3,RMA_QTPRegression_TC_124.BankAccountName, RMA_QTPRegression_TC_124.Entity_Txt_Name};
			...
			testcall8 = true;
			RMA_Functionality_Utility.RMA_Suite07_PrintCheckUtility("RMA_QTPRegression_TC_124",RMA_QTPRegression_TC_124.BankAccountName,"EFT",ContentToBeVerified, logval1);//Print Checks Utility
