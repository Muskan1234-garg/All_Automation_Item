...
//===================================================================================================================================================================================================================================
//TestCaseID     : RMA_SeleniumRegression_TC_004
//Description    : Functionality of Non-occupational Claim Permission Setting On Security Management System Is Validated
//Depends On TC  : None
//Revision       : 0.0 - RenuVerma-08-03-2017
//===================================================================================================================================================================================================================================
public class RMA_SeleniumRegression_TC_004 extends rmaseleniumtestscripts.RMA_TC_BaseTest {

	@Test	
	public void RMA_SeleniumRegression_TC_004_Test() throws Exception, Error
	{   
		try {	 	 
			...
			parentlogger = reports.startTest("RMA_SeleniumRegression_TC_004_Non-occupational Claim Permission Setting Validation", "Functionality of Non-occupational Claim Permission Setting On Security Management System Is Validated");
			parentlogger.assignAuthor("Renu Verma");

			StrScreenShotTCName = "RMA_SeleniumRegression_TC_004";
			...
			System.out.println(RMAApp_SMS_Lnk_DataSourceName);
			...
			System.out.println(RMAApp_SMS_Lnk_ModuleAccessPermission);
			...
			//===========================================================Enabling Of "Use Non-occupational Claim:" Setting In General System Parameters Is Started Here==================================================================================================================================================================================================================================================================================================================================================================
			...
			RMA_Navigation_Utility.RMA_WebCheckBoxSelect_Utility(RMA_POM_GeneralSystemParameterSetUP.RMAApp_GenSysParaSetup_Chk_UseNonOccupationalClaim(driver), "uncheck", "Use Non Occupational: Checkbox", "General System Parameter Setup Page", logval);
			RMA_Navigation_Utility.RMA_WebCheckBoxSelect_Utility(RMA_POM_GeneralSystemParameterSetUP.RMAApp_GenSysParaSetup_Chk_UseNonOccupationalClaim(driver), "check", "Use Non Occupational: Checkbox", "General System Parameter Setup Page", logval);
			//"Use Non Occupational: Check Box" Is Checked
			...
			//=========================================================== Enabling Of "Use Non-occupational Claim:" Setting In Non-occupationalSystem Parameters Is Completed Here=============================================================================================================================================================================================================================================================================================================================================================

			//=========================================================== Disabling Of RiskMaster-->Non-occupational Claims Permission In Security Management System Is Started Here===================================================================================================================================================================================================================================================================================================================================================
			...
			RMA_Verification_Utility.RMA_VerifyUXSpinnerDisappered(logval);
			RMA_Navigation_Utility.RMA_WebCheckBoxSelect_Utility(RMA_Selenium_POM_SMS.RMAApp_SMSModuleAccPerm_Chk_ModuleAccessPermission(driver, "Non-Occupational Claims"), "uncheck", "Non Occupationals Checkbox", "Security Management System Page", logval);
			...
			//===========================================================Steps To Verify That Non-occupational Claim Creation Menu Option Is Not Displayed Is Started Here=====================================================================================================================================================================================================================================================================================================================================================================
			RMA_Navigation_Utility.RMA_MenuOptionClick("Document", logval);
			RMA_NegativeVerification_Utility.RMA_ElementNotExist_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_RMAAppLink(driver, "Non-occupational"),"Non-occupational Claim MDI Menu Link On RMA Application Default View", logval);  
			//===========================================================Steps To Verify That Non-occupational Claim Creation Menu Option Is Not Displayed Is Completed Here=================================================================================================================================================================================================================================================================================================================================================================

			//=========================================================== Enabling Of RiskMaster-->Non-occupational Claims Permission In Security Management System Is Started Here==========================================================================================================================================================================================================================================================================================================================================================
			RMA_GenericUsages_Utility.RMA_WindowSwitchingBasedOnTitle("CSC Riskmaster Accelerator");
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_Login_DSNSelect_Frames.RMAApp_Dashboard_Lbl_SMS(driver), "Security Management System Navigation Option Label On RiskMaster Application's Dashboard Page",logval);
			RMA_GenericUsages_Utility.RMA_WindowSwitchingBasedOnTitle("Riskmaster Security");
			RMA_Verification_Utility.RMA_VerifyUXSpinnerDisappered(logval);
			...
			RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_SMS.RMAApp_SMSModuleAccPerm_Img_ExpandCollapse(driver, RMAApp_SMS_Lnk_ModuleAccessPermission),"Expand Image Of Following Module Access Permission" + " "+ color.RMA_ChangeColor_Utility(RMAApp_SMS_Lnk_ModuleAccessPermission,3)+ " " + "For Module Security Group:"+ " "+color.RMA_ChangeColor_Utility(RMAApp_SMS_Lnk_ModuleSecurityGroup,3)+  " " +"On Left Navigation Menu Tree Of Security Management System Page",logval);
			RMA_Verification_Utility.RMA_VerifyUXSpinnerDisappered(logval);
			RMA_Navigation_Utility.RMA_WebCheckBoxSelect_Utility(RMA_Selenium_POM_SMS.RMAApp_SMSModuleAccPerm_Chk_ModuleAccessPermission(driver, "Non-Occupational Claims"), "check", "Non Occupationals Checkbox", "Security Management System Page", logval);
			...
			RMA_Verification_Utility.RMA_VerifyUXSpinnerDisappered(logval);
			driver.switchTo().window(StrRMAWindowHandle);
			//===========================================================Enabling Of RiskMaster-->Non-occupational Claims Permission In Security Management System Is Completed Here======================================================================================================================================================================================================================================================================================================================================================
			...
			//===========================================================Steps To Verify That Non-occupational Claim Creation Menu Option Displayed Is Started Here=====================================================================================================================================================================================================================================================================================================================================================================
			RMA_Navigation_Utility.RMA_MenuOptionClick("Document", logval);
			RMA_Verification_Utility.RMA_ElementExist_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_RMAAppLink(driver, "Non-occupational"),"Non-occupational Claim MDI Menu Link On RMA Application Default View", logval);  
			//===========================================================Steps To Verify That Non-occupational Claim Creation Menu Option Displayed Is Ended Here=====================================================================================================================================================================================================================================================================================================================================================================
