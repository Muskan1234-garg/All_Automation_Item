...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_SeleniumRegression_TC_082
//Description    : Create,Edit and Delete Of Enhanced Note On A Person Involved(Driver) On Litigation Page Is Validated
//Depends On TC  : RMA_SeleniumRegression_TC_024
//Revision       : 0.0 - ShrutiShruti-12-19-2017 
//======================================================================================================================================================================================================================================================================================

public class RMA_SeleniumRegression_TC_082 extends RMA_TC_BaseTest{
	@Test
	public void RMA_SeleniumRegression_TC_082_Test() throws Exception,Error{
		try{
			parentlogger = reports.startTest("RMA_SeleniumRegression_TC_082_Create, Edit And Delete Of Enhanced Notes On Person Involved(Driver) Screen On Litigation Page", "Create,Edit and Delete Of Enhanced Note On A Person Involved(Driver) On Litigation Page Is Validated");
			parentlogger.assignAuthor("Shruti Shruti");

			StrScreenShotTCName = "RMA_SeleniumRegression_TC_082";
			testcall1 = false;	
			...
			testcall2 = true;
			EnhancedNotes = RMA_Functionality_Utility.RMA_EnhancedNotesCreateEditDelete_SubEntity_Utility("Create/Edit", "Confidential", "CF Confidential",StrClaimNumber,StrDriverLastName, "NotRequired",Edit,logval1);
