...
//==================================================================================================================================================================================
//TestCaseID   	 : RMA_QTPRegression_TC_118
//Description    : Verification Of Making Combined Payment For Print Check To File Options: 'TO PRINTER ONLY'
//Depends On TC  : None
//Revision       : 0.0 - AnubhutiVyas-01-22-2018
//========================================================================================================================================================================================
public class RMA_QTPRegression_TC_118 extends RMA_TC_BaseTest{

	@Test 
	public void RMA_QTPRegression_TC_118_Test() throws Exception, Error
	{
		testcall1 = false;	
		...
		StrScreenShotTCName = "RMA_QTPRegression_TC_118";
		...
		try {
			parentlogger = reports.startTest("RMA_QTPRegression_TC_118_Make A Combined Payment For Print Check To File Options: 'TO PRINTER ONLY'", "Verification Of Making Combined Payment For Print Check To File Options: 'TO PRINTER ONLY'");
			...
			GenClaimCreation_Txt_ClaimType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_118", 1, 7); //Claim Type Is Fetched From DataSheet RMA_QTPRegression_TC_118
			GenClaimCreation_Txt_ClaimStatus =  ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_118", 1,8 ); //Claim Status Is Fetched From DataSheet RMA_QTPRegression_TC_118
			GenClaimCreation_Txt_Department = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_118", 1,9); //Department Is Fetched From DataSheet RMA_QTPRegression_TC_118
			//Claim Data Fetch From Excel WorkBook Is Completed Here
			
			PaymentCreation_Lst_PayeeType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_118", 1, 1); // Payee Type Is Fetched From DataSheet RMA_QTPRegression_TC_118
			FundsSplitDetails_Lst_TransactionType= ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_118", 1,2); //Transaction Type For Medical Reserve Payment Is Fetched From DataSheet RMA_QTPRegression_TC_118
			FundsSplitDetails_Txt_Amount = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_QTPRegression_TC_118", 1, 3); //Medical Amount Is Fetched From DataSheet RMA_QTPRegression_TC_118
			PaymentCreation_Txt_DisType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_118", 1, 5); //Distribution Type Is Fetched From DataSheet RMA_QTPRegression_TC_118
			PaymentCreation_Lst_ReserveType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_118", 1, 6); // Medical Reserve Type Is Fetched From DataSheet RMA_QTPRegression_TC_118
			...
			testcall6 = true;
			RMA_Functionality_Utility.RMA_Suite07_PrintCheckUtility("RMA_QTPRegression_TC_054",RMA_QTPRegression_TC_052_I.BankAccount_Txt_AccountName,PaymentCreation_Txt_DisType,ContentToBeVerified, logval1);//Print Checks Utility
