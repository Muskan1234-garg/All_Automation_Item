...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_SeleniumRegression_TC_132
//Description    : Create, Edit and Delete of Attachments For A Case Management Is Validated
//Depends On TC  : None
//Revision       : 0.0 - ShrutiShruti-01-10-2018
//======================================================================================================================================================================================================================================================================================

public class RMA_SeleniumRegression_TC_132 extends RMA_TC_BaseTest{
	@Test
	public void RMA_SeleniumRegression_TC_132_Test() throws Exception,Error{
		try{
			parentlogger = reports.startTest("RMA_SeleniumRegression_TC_132_Create,Edit And Delete Of Attachments On Case Management Page", "Create,Edit And Delete Of Attachments On Case Management Is Validated");
			...
			StrScreenShotTCName = "RMA_SeleniumRegression_TC_132";
			ErrorMessage = null;
			CurrentFrameID=null;
