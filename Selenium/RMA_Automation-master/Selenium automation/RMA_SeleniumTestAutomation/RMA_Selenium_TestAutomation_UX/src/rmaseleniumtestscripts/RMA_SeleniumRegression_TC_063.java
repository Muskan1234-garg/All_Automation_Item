...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_SeleniumRegression_TC_063
//Description    : Create,Edit and Delete Of Enhanced Note On A Defendant On General Claim Is Validated
//Depends On TC  : RMA_SeleniumRegression_TC_058
//Revision       : 0.0 - ShrutiShruti-12-08-2017 
//======================================================================================================================================================================================================================================================================================


public class RMA_SeleniumRegression_TC_063 extends RMA_TC_BaseTest{
	@Test
	public void RMA_SeleniumRegression_TC_063_Test() throws Exception,Error{
		try{
			parentlogger = reports.startTest("RMA_SeleniumRegression_TC_063_Create, Edit And Delete Of Enhanced Notes On Defendant Screen", "Create,Edit and Delete Of Enhanced Note On A Defendant Screen Is Validated");
			...
			StrScreenShotTCName = "RMA_SeleniumRegression_TC_063";
			ErrorMessage = null;
			CurrentFrameID=null;
