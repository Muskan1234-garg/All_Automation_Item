...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_Reg_Maint_Employee_TC_038
//Description    : Verify That Page Cannot Be Found In PowerView Message Is Displayed When User Removes Pages Of Right Navigation Link(Violation Page)
//Depends On TC  : None
//Revision       : 0.0 - ShrutiShruti-02-27-2018 
//======================================================================================================================================================================================================================================================================================

public class RMA_Reg_Maint_Employee_TC_038 extends RMA_TC_BaseTest{
	@Test
	public void RMA_Reg_Maint_Employee_TC_038_Text() throws Exception,Error{
		try{
			parentlogger = reports.startTest("RMA_Reg_Maint_Employee_TC_038_Verify PowerView UX Message When Violation Page Is Removed Form PowerView", "Page Cannot Be Found In PowerView Message Is Displayed When User Removes Pages Of Right Navigation Link(Violation Page) Is Validated");
			...
			StrScreenShotTCName = "RMA_Reg_Maint_Employee_TC_038";
			ErrorMessage = null;
			...
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_Home.RMAApp_GenericBtn_EnityAdd(driver, "Violations"), "Violations Page On Employee-->Maintenance Screen", logval);
			
			RMA_Verification_Utility.RMA_ElementExist_Utility(RMA_Selenium_POM_Violations.RMAApp_Violations_Txt_ViolationDate(driver), "Violation Date TextBox On Violation Creation Page", logval);
			//Verification Of Violation Page
			...
			globalWait.until(ExpectedConditions.visibilityOf(RMA_Selenium_POM_PowerView.RMAApp_PowerView_Chk_Entity(driver, "Employee Violation Info")));
			RMA_Navigation_Utility.RMA_WebCheckBoxSelect_Utility(RMA_Selenium_POM_PowerView.RMAApp_PowerView_Chk_Entity(driver, "Employee Violation Info"), "uncheck", "Employee Violation Info CheckBox", "Power View Editor Page", logval);
			...
			driver.close();
			//Verification Of Validation Message On Employee Violation Info Page
			...
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_PowerView.RMAApp_PowerView_Lbl_PowerViewName(driver, "Automation_PV"), "PowerView Link On Power View Editor Page", logval);
			globalWait.until(ExpectedConditions.visibilityOf(RMA_Selenium_POM_PowerView.RMAApp_PowerView_Chk_Entity(driver, "Employee Violation Info")));
			RMA_Navigation_Utility.RMA_WebCheckBoxSelect_Utility(RMA_Selenium_POM_PowerView.RMAApp_PowerView_Chk_Entity(driver, "Employee Violation Info"), "check", "Employee Violation Info CheckBox", "Power View Editor Page", logval);
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_PowerView.RMAApp_PowerView_Btn_Save(driver), "Save Image Button On Power View Editor Page", logval);
