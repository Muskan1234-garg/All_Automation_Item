...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_SeleniumRegression_TC_106
//Description    : Create, Edit and Delete of Attachments For A Claimant Is Validated
//Depends On TC  : None
//Revision       : 0.0 - ShrutiShruti-01-10-2018
//======================================================================================================================================================================================================================================================================================

public class RMA_SeleniumRegression_TC_106 extends RMA_TC_BaseTest{
	@Test
	public void RMA_SeleniumRegression_TC_106_Test() throws Exception,Error{
		try{
			parentlogger = reports.startTest("RMA_SeleniumRegression_TC_106_Create, Edit And Delete An Attachment on Claimant Screen", "Create,Edit And Delete of Attachment On The Claimant Screen Is Validated");
			...
			StrScreenShotTCName = "RMA_SeleniumRegression_TC_106";
			ErrorMessage = null;
			CurrentFrameID=null;
