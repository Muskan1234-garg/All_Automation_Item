...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_Reg_Maint_Vehicle_TC_022
//Description    : Supplementals SMS Permission From Vehicle Maintenance Is Validated
//Depends On TC  : None
//Revision       : 0.0 - JannathHussain-03-01-2018 
//======================================================================================================================================================================================================================================================================================

public class RMA_Reg_Maint_Vehicle_TC_022  extends rmaseleniumtestscripts.RMA_TC_BaseTest  {
	@Test	
	public void RMA_Reg_Maint_Vehicle_TC_022_Test() throws Exception, Error
	{   
		try {	 	 
			...
			parentlogger = reports.startTest("RMA_Reg_Maint_Vehicle_TC_022_Supplementals SMS Permission Setting For Vehicle Is Validation", "Functionality of Delete For Vehicle Permission Setting On Security Management System Is Validated");
			parentlogger.assignAuthor("Jannath Hussain");
         	StrScreenShotTCName = "RMA_Reg_Maint_Vehicle_TC_022";
			...
			RMAApp_SMS_Lnk_DataSourceName = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_Reg_Maint_Vehicle_TC_022", 4, 0); //Data Source Name Is Fetched From DataSheet RMA_Reg_Maint_Vehicle_TC_022
			RMAApp_Login_Txt_UserName = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_Reg_Maint_Vehicle_TC_022", 1, 1); //UserName Fetched From DataSheet RMA_Reg_Maint_Vehicle_TC_022
			RMAApp_Login_Txt_Password = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_Reg_Maint_Vehicle_TC_022", 1, 2); //Password Fetched From DataSheet RMA_Reg_Maint_Vehicle_TC_022
            RMAApp_SMS_Lnk_ModuleSecurityGroup = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_Reg_Maint_Vehicle_TC_022", 1, 3); //Module Security Group Name Is Fetched From DataSheet RMA_Reg_Maint_Vehicle_TC_022
			RMAApp_SMS_Lnk_ModuleAccessPermission = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_Reg_Maint_Vehicle_TC_022", 1, 4); //Module Access Permission Name Is Fetched From DataSheet RMA_Reg_Maint_Vehicle_TC_022
			...
			RMA_Navigation_Utility.RMA_ObjectClick(rmaseleniumPOM_UX.RMA_Selenium_POM_Vehicle.RMAApp_Vehicle_SMS_Supplementals(driver, "Supplemental Fields"),"Click On Supplementals From Module Access Permission On Security Management System Page",logval);
			...
			//===========================================================Verification Of Supplementals Tab From Vehicle As Per SMS Permission Is Started Here==============================================================================================================================================================================================================================================================================================================================================================
			RMA_GenericUsages_Utility.RMA_StaticWait(4, logval, "Wait Is Added To Switch To MAintenance-Vehicle Frame");
			RMA_NegativeVerification_Utility.RMA_ElementNotExist_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_RMAAppText(driver,"Supplementals"),"Supplementals Tab Permission From Vehicle Screen", logval);
			RMA_GenericUsages_Utility.RMA_WebPageRefresh_Utility_UX(logval);
			//===========================================================Verification Of Supplementals Tab From Vehicle As Per SMS Permission Is Completed Here============================================================================================================================================================================================================================================================================================================================================================

			//===========================================================Revert Supplementals Tab Permission Is Started Here==============================================================================================================================================================================================================================================================================================================================================================================================================================================================	
			driver.switchTo().window(StrRMAWindowHandle);
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_Login_DSNSelect_Frames.RMAApp_Dashboard_Lbl_SMS(driver), "Security Management System Navigation Option Label On RiskMaster Application's Dashboard Page",logval);
			RMA_GenericUsages_Utility.RMA_WindowSwitchingBasedOnTitle("Riskmaster Security");
			RMA_Verification_Utility.RMA_VerifyUXSpinnerDisappered(logval);
			...
			RMA_Verification_Utility.RMA_VerifyUXSpinnerDisappered(logval);
			RMA_GenericUsages_Utility.RMA_StaticWait(5, logval, "Wait Is Added To Loader Gets Disappeared");
			RMA_Navigation_Utility.RMA_ObjectClick(rmaseleniumPOM_UX.RMA_Selenium_POM_Vehicle.RMAApp_Vehicle_SMS_Supplementals(driver, "Supplemental Fields"),"Click On Delete From Module Access Permission On Security Management System Page",logval);
			...
			RMA_Verification_Utility.RMA_VerifyUXSpinnerDisappered(logval);
			//===========================================================Revert Supplementals Tab Permission Is Completed Here==============================================================================================================================================================================================================================================================================================================================================================================================================================================================
