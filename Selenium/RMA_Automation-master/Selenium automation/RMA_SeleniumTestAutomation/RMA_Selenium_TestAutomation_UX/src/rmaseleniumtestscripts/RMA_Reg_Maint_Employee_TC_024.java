...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_Reg_Maint_Employee_TC_024
//Description    : Verify That User Is Able To Add Values In Supplemental Tab
//Depends On TC  : RMA_Smoke_TC_041_I
//Revision       : 0.0 - ShrutiShruti-03-14-2018
//======================================================================================================================================================================================================================================================================================

public class RMA_Reg_Maint_Employee_TC_024 extends RMA_TC_BaseTest{
	@Test
	public void RMA_Reg_Maint_Employee_TC_024_Test() throws Exception,Error{
		try{
			parentlogger = reports.startTest("RMA_Reg_Maint_Employee_TC_024_Add Values In Supplemental Tab","User Is Able To Add Values In Supplemental Tab Is Validated");
			...
			StrScreenShotTCName = "RMA_Reg_Maint_Employee_TC_024";
			ErrorMessage = null;
			//Global Variable Initialization Completed 
			
			String StrEmployeeNumber;			
			String StrEmployeeLastName;
			String Employee_Creation_Txt_UpdatedDate;
			String Employee_Creation_Txt_SysUpdatedDate;
			//Local Variable Declaration Completed Here
			
			Employee_Creation_Txt_UpdatedDate=RMA_GenericUsages_Utility.RMA_PastFutureDateInfo_Utility(0, -1, 1, "MM/dd/yyyy");
			Employee_Creation_Txt_SysUpdatedDate=Employee_Creation_Txt_UpdatedDate;
			...
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_Employee.RMAApp_Employee_Tab_Supplementals(driver), "Supplementals Tab On Employee Creation Page", logval);
			RMA_Input_Utility.RMA_SetValue_Utility(RMA_Selenium_POM_Employee.RMAApp_EmployeeSupplemental_Txt_SysUpdatedDate(driver), "System Updated Date TextBox On Employee Creation Page", Employee_Creation_Txt_SysUpdatedDate, logval);
			RMA_Input_Utility.RMA_SetValue_Utility(RMA_Selenium_POM_Employee.RMAApp_EmployeeSupplemental_Txt_UpdatedDate(driver), "Updated Date TextBox On Employee Creation Page", Employee_Creation_Txt_UpdatedDate, logval);
			...
			//globalWait.until(ExpectedConditions.invisibilityOf(RMA_Selenium_POM_Employee.RMAApp_EmployeeSupplemental_ToastMessage(driver)));
			Thread.sleep(5000);
			//=========================================================Steps To Delete Created Employee Started Here==============================================================================================================================================
			...
			//=========================================================Steps To Delete Created Employee Completed Here=======================================================================================================================================
		}
