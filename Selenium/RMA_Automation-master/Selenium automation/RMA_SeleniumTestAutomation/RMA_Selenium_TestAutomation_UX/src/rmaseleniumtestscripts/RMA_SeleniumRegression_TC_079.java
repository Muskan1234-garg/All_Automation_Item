...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_SeleniumRegression_TC_079
//Description    : Create,Edit and Delete Of Enhanced Note On A Person Involved(Employee) On Litigation Page Is Validated
//Depends On TC  : RMA_SeleniumRegression_TC_024
//Revision       : 0.0 - ShrutiShruti-12-19-2017 
//======================================================================================================================================================================================================================================================================================

public class RMA_SeleniumRegression_TC_079 extends RMA_TC_BaseTest{
	@Test
	public void RMA_SeleniumRegression_TC_079_Test() throws Exception,Error{
		try{
			parentlogger = reports.startTest("RMA_SeleniumRegression_TC_079_Create,Edit and Delete Of Enhanced Note On A Person Involved(Employee) On Litigation Page", "Create,Edit and Delete Of Enhanced Note On A Person Involved(Employee) On Litigation Page Is Validated");
			parentlogger.assignAuthor("Shruti Shruti");

			StrScreenShotTCName = "RMA_SeleniumRegression_TC_079";
			testcall1 = false;	
			...
			testcall2 = true;
			EnhancedNotes = RMA_Functionality_Utility.RMA_EnhancedNotesCreateEditDelete_SubEntity_Utility("Create/Edit", "Confidential", "CF Confidential",StrClaimNumber,StrEmployeeLastName, "NotRequired",Edit,logval1);
