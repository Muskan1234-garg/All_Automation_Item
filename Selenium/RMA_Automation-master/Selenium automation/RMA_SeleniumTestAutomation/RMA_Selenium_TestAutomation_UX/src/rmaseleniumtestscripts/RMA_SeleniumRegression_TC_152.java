...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_SeleniumRegression_TC_152
//Description    : Create,Edit And Delete Of Attachments On Property On Maintenance Screen
//Depends On TC  : RMA_Smoke_TC_041_I
//Revision       : 0.0 - ShrutiShruti-01-11-2018 
//======================================================================================================================================================================================================================================================================================

public class RMA_SeleniumRegression_TC_152 extends RMA_TC_BaseTest{
	@Test
	public void RMA_SeleniumRegression_TC_152_Test() throws Exception,Error{
		try{
			parentlogger = reports.startTest("RMA_SeleniumRegression_TC_152_Create, Edit and Delete of Attachmments On Property Page On Maintenance Screen", "Create, Edit and Delete of Attachments On Property Page on Maintenance Screen Is Validated");
			...
			StrScreenShotTCName = "RMA_SeleniumRegression_TC_152";
			ErrorMessage = null;
			CurrentFrameID=null;
			...
			//===========================================================New Property Creation Is Started Here================================================================================================================================================================================================================================================================
			...
			testcall1 = true;
			StrPropertyID=RMA_Maintenance_Functionality_Utility.RMA_MaintenanceAddNewEntity_Utility("PropertyUnit", "Alberta","NA", logval1);
			loggerval1 = logger.toString();
			parentlogger.appendChild(logger);
			parentlogger.log(LogStatus.INFO, "New Property Is Created With Property ID::"+ " " + color.RMA_ChangeColor_Utility(StrPropertyID, 2));
			CurrentFrameID = RMA_GenericUsages_Utility.RMA_GetCurrentFrameID();
			// New Property From Maintenance Screen Is Successfully Created
			//============================================================New Property Creation Is Completed Here================================================================================================================================================================================================================================================================
			...
			//=================================================Steps To Delete Property Started Here=================================================================================================================================================================================================
			RMA_Functionality_Utility.RMA_GenericDelete_Utility("Maintenance-->Property", false, logval);
			RMA_Functionality_Utility.RMA_GenericDelete_Utility("Maintenance-->Property", true, logval);
			//=================================================Steps To Delete Property Completed Here=============================================================================================================================================================================================================================
			driver.switchTo().parentFrame();
		}
