...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_Reg_Maint_Employee_TC_056
//Description    : Verification of Record Summary On Dependent
//Depends On TC  : None
//Revision       : 0.0 - SheikhFaiza-02-14-2018 
//======================================================================================================================================================================================================================================================================================


public class RMA_Reg_Maint_Employee_TC_056 extends RMA_TC_BaseTest {
	@Test
	public void RMA_Reg_Maint_Employee_TC_056_Test() throws Exception,Error {

		try{
			parentlogger = reports.startTest("RMA_Reg_Maint_Employee_TC_056_Creating And Verifying Dependent Through Record Summary", " Create And Verify Dependent Through Record Summary From Employee Maintenance Screen Is Validated");
			...
			StrScreenShotTCName = "RMA_Reg_Maint_Employee_TC_056";
			ErrorMessage = null;
