...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_Reg_Maint_Employee_TC_042
//Description    : Verify That When User Removes Any Tab Then The Same Is Not Visible On That Screen
//Depends On TC  : None
//Revision       : 0.0 - ShrutiShruti-02-26-2018 
//======================================================================================================================================================================================================================================================================================

public class RMA_Reg_Maint_Employee_TC_042 extends RMA_TC_BaseTest{
	@Test
	public void RMA_Reg_Maint_Employee_TC_042_Test() throws Exception,Error{
		try{
			parentlogger = reports.startTest("RMA_Reg_Maint_Employee_TC_042_Verify That When User Removes Any Tab Then The Same Is Not Visible On That Screen", "User Removes Any Tab Then The Same Is Not Visible On That Screen Is Validated");
			...
			StrScreenShotTCName = "RMA_Reg_Maint_Employee_TC_042";
			ErrorMessage = null;
			...
			globalWait.until(ExpectedConditions.visibilityOf(RMA_Selenium_POM_PowerView.RMAApp_PowerView_Btn_TabDelete(driver, "Addresses")));
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_PowerView.RMAApp_PowerView_Btn_TabDelete(driver, "Addresses"), "Addresses Tab Remove Button On Power View Editor Page", logval);
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_PowerView.RMAApp_PowerView_Btn_TabDelete(driver, "Entity ID Type"),"Entity ID Type Tab Remove Button On Power View Editor Page", logval);
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_PowerView.RMAApp_PowerView_Btn_TabDelete(driver, "Supplementals"), "Supplementals Tab Remove Button On Power View Editor Page", logval);
