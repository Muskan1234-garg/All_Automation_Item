...
//==================================================================================================================================================================================
//TestCaseID   	 : RMA_QTPRegression_TC_048
//Description    : LOB Parameter Settings 'Set Negative Reserve Balance To Zero' To View Reserve Balances For Reserves When Closed Is Validated
//Depends On TC  : None
//Revision       : 0.0 - AnubhutiVyas-08-01-2017 
//========================================================================================================================================================================================
public class RMA_QTPRegression_TC_048 extends RMA_TC_BaseTest{

	@Test 
	public void RMA_QTPRegression_TC_048_Test() throws Exception, Error
	{
		testcall1 = false;	
		...
		try {
			parentlogger = reports.startTest("RMA_QTPRegression_TC_048_Set Negative Reserve Balance To Zero On Corporate Claim", "LOB Parameter Settings 'Set Negative Reserve Balance To Zero' To View Reserve Balances For Reserves When Closed Is Validated");
			...
			GenClaimCreation_Txt_ClaimType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_048", 1, 16); //Claim Type Is Fetched From DataSheet RMA_QTPRegression_TC_048
			GenClaimCreation_Txt_ClaimStatus =  ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_048", 1,17 ); //Claim Status Is Fetched From DataSheet RMA_QTPRegression_TC_048
			GenClaimCreation_Txt_Department = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_048", 1,18); //Department Is Fetched From DataSheet RMA_QTPRegression_TC_048
			//Claim Data Fetch From Excel WorkBook Is Completed Here
		 
			ReserveCreation_Txt_ReserveAmount = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_QTPRegression_TC_048", 1, 0); //Reserve Amount Is Fetched From DataSheet RMA_QTPRegression_TC_048
			ReserveCreation_Lst_Status = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_048", 1, 1); // Reserve Status Is Fetched From DataSheet RMA_QTPRegression_TC_048
			ReserveCreation_Lst_ReserveType_Medical = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_048", 1, 2); // Medical Reserve Type Is Fetched From DataSheet RMA_QTPRegression_TC_048
			ReserveCreation_Lst_ReserveType_Expense = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_048", 1, 3); // Expense Reserve Type Is Fetched From DataSheet RMA_QTPRegression_TC_048
			ReserveCreation_Lst_ReserveType_Litigation = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_048", 1, 4); // Litigation Reserve Type Is Fetched From DataSheet RMA_QTPRegression_TC_048
			//Reserve Data Fetch From Excel WorkBook Is Completed Here
			
			PaymentCreation_Txt_BankAccount = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_048", 1, 5); //Bank Account Is Fetched From DataSheet RMA_QTPRegression_TC_048
			PaymentCreation_Lst_PayeeType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_048", 1, 6); // Payee Type Is Fetched From DataSheet RMA_QTPRegression_TC_048
			FundsSplitDetails_Lst_TransactionType_Medical = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_048", 1, 7); //Transaction Type For Medical Reserve Payment Is Fetched From DataSheet RMA_QTPRegression_TC_048
			FundsSplitDetails_Lst_TransactionType_Expense = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_048", 1,12 ); //Transaction Type For Expense Reserve Payment Is Fetched From DataSheet RMA_QTPRegression_TC_048
			FundsSplitDetails_Lst_TransactionType_Litigation = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_048",1,13 ); //Transaction Type For Litigation Reserve Payment Is Fetched From DataSheet RMA_QTPRegression_TC_048
			FundsSplitDetails_Txt_Amount_Medical = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_QTPRegression_TC_048", 1, 8); //Medical Amount Is Fetched From DataSheet RMA_QTPRegression_TC_048
			FundsSplitDetails_Txt_Amount_Expense = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_QTPRegression_TC_048", 1,14 ); //Expense Amount Is Fetched From DataSheet RMA_QTPRegression_TC_048
			FundsSplitDetails_Txt_Amount_Litigation = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_QTPRegression_TC_048", 1,15 ); //Litigation Amount Is Fetched From DataSheet RMA_QTPRegression_TC_048
			PaymentCreation_Txt_LastName = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_048", 1, 9); //LastName Is Fetched From DataSheet RMA_QTPRegression_TC_048
			PaymentCreation_Txt_DisType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_048", 1, 10); //Distribution Type Is Fetched From DataSheet RMA_QTPRegression_TC_048
			//Payment Data Fetch From Excel WorkBook Is Completed Here
									
			ExpBalanceAmountAfterPaymentOnGrid_Medical=ReserveCreation_Txt_ReserveAmount-FundsSplitDetails_Txt_Amount_Medical;// Balance Amount After Payment On NG Grid				
			ExpBalanceAmountAfterPaymentOnGrid_Expense=ReserveCreation_Txt_ReserveAmount-FundsSplitDetails_Txt_Amount_Expense;// Balance Amount After Payment On NG Grid
			
			String []ExpectedColHeadersToBeVerified={"Balance","Paid","Collection","Incurred","Status"};		
			String []ExpectedValuesToBeVerified_Medical={"$"+ExpBalanceAmountAfterPaymentOnGrid_Medical+".00", "$"+FundsSplitDetails_Txt_Amount_Medical+".00", "$0.00", "$"+ReserveCreation_Txt_ReserveAmount+".00", "C - Closed"};
			String []ExpectedValuesToBeVerified_Expense={"$"+ExpBalanceAmountAfterPaymentOnGrid_Expense+".00", "$"+FundsSplitDetails_Txt_Amount_Expense+".00", "$0.00", "$"+ReserveCreation_Txt_ReserveAmount+".00", "C - Closed"};
			String []ExpectedValuesToBeVerified_Litigation={"$0.00", "$"+FundsSplitDetails_Txt_Amount_Litigation+".00", "$0.00", "$"+FundsSplitDetails_Txt_Amount_Litigation+".00", "C - Closed"};
			
			RMA_GenericUsages_Utility.RMA_Non_UXNavigation();
			RMA_Functionality_Utility.RMA_Suite24_Utility("RMA_QTPRegression_TC_048", logval);//General System Parameter & LOB Parameter Setting Is Done
			...
			parentlogger.appendChild(logger);
			//==========================================================Medical Reserve Creation Is Completed Here====================================================================================================================================================================================================================================================================================================
