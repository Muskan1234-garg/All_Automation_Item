...
//==================================================================================================================================================================================
//TestCaseID   	 : RMA_QTPRegression_TC_121
//Description    : Verification Of Making Combined Payment For Print Check To File Options: 'TO PRINTER AND FILE' 
//Depends On TC  : None
//Revision       : 0.0 - AnubhutiVyas-01-23-2018 
//========================================================================================================================================================================================
public class RMA_QTPRegression_TC_121 extends RMA_TC_BaseTest{

	@Test 
	public void RMA_QTPRegression_TC_121_Test() throws Exception, Error
	{
		testcall1 = false;	
		...
		StrScreenShotTCName = "RMA_QTPRegression_TC_121";
		...
		try {
			parentlogger = reports.startTest("RMA_QTPRegression_TC_121_Make A Combined Payment For Print Check To File Options: 'TO PRINTER AND FILE'", "Verification Of Making Combined Payment For Print Check To File Options: 'TO PRINTER AND FILE'");
			...
			GenClaimCreation_Txt_ClaimType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_121", 1, 7); //Claim Type Is Fetched From DataSheet RMA_QTPRegression_TC_121
			GenClaimCreation_Txt_ClaimStatus =  ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_121", 1,8 ); //Claim Status Is Fetched From DataSheet RMA_QTPRegression_TC_121
			GenClaimCreation_Txt_Department = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_121", 1,9); //Department Is Fetched From DataSheet RMA_QTPRegression_TC_121
			//Claim Data Fetch From Excel WorkBook Is Completed Here
			
			PaymentCreation_Lst_PayeeType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_121", 1, 1); // Payee Type Is Fetched From DataSheet RMA_QTPRegression_TC_121
			FundsSplitDetails_Lst_TransactionType= ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_121", 1,2); //Transaction Type For Medical Reserve Payment Is Fetched From DataSheet RMA_QTPRegression_TC_121
			FundsSplitDetails_Txt_Amount = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_QTPRegression_TC_121", 1, 3); //Medical Amount Is Fetched From DataSheet RMA_QTPRegression_TC_121
			//PaymentCreation_Txt_LastName = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_121", 1, 4); //LastName Is Fetched From DataSheet RMA_QTPRegression_TC_121
			PaymentCreation_Txt_DisType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_121", 1, 5); //Distribution Type Is Fetched From DataSheet RMA_QTPRegression_TC_121
			PaymentCreation_Lst_ReserveType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_121", 1, 6); // Medical Reserve Type Is Fetched From DataSheet RMA_QTPRegression_TC_121
			...
			testcall1 = true;
			RMA_Functionality_Utility.RMA_Suite06_Utility("RMA_QTPRegression_TC_121", logval1);//General System Parameter & Payment Parameter Settings Are Done
