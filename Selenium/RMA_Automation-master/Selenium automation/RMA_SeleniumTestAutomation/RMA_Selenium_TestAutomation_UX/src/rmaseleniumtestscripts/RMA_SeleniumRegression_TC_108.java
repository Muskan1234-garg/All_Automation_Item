...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_SeleniumRegression_TC_108
...
public class RMA_SeleniumRegression_TC_108 extends RMA_TC_BaseTest{
	@Test
	public void RMA_Selenium_TC_108_Test() throws Exception,Error{
		try{
			parentlogger = reports.startTest("RMA_SeleniumRegression_TC_108_Create,Edit And Delete Of Enhanced Notes On Case Manager Notes Page", "Create,Edit And Delete Of Enhanced Notes On Case Manager Notes Is Validated");
			...
			testcall4 = true;
			StrCaseManager=RMA_Functionality_Utility.RMA_ClaimEventEntityAddition_Utility("Case Managers", StrClaimNumber, "ASWE", "Restricted to Work",logval1);
