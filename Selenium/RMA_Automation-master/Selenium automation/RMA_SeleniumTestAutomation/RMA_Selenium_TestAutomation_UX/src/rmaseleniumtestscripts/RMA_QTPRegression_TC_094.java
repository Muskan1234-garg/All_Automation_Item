...
//=====================================================================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_QTPRegression_TC_094
//Description    : Verification Of Voiding Bank Deposits
//Depends On TC  : None
//Revision       : 0.0 - AnubhutiVyas-12-07-2017
//===================================================================================================================================================================================================================================================================================================================================

public class RMA_QTPRegression_TC_094 extends RMA_TC_BaseTest{
	@Test
	public void RMA_QTPRegression_TC_094_Test() throws Exception,Error {
		...
		StrScreenShotTCName = "RMA_QTPRegression_TC_094";	
		...
		try{
			parentlogger = reports.startTest("RMA_QTPRegression_TC_094_Voiding Bank Deposit",  "Verification Of Voiding Bank Deposits");
			...
			DepositCreation_Txt_TransactionAmount = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_QTPRegression_TC_094",1,0);//Transaction Amount Is Fetched From DataSheet RMA_QTPRegression_TC_094
			...
			//========================================Steps To Void The Deposit Is Started Here==========================================================================================================================================================================
			RMA_Navigation_Utility.RMA_WebCheckBoxSelect_Utility(RMA_Selenium_POM_BankAccount.RMAApp_BankAccount_Deposit_Chk_Void(driver), "check", "Void Checkbox", "Bank Account Deposit Page", logval);
			RMA_GenericUsages_Utility.RMA_WindMsgHandlerAndTextVerify_Utility("Yes", "NA", RMA_Selenium_POM_VerificationMessage.BankAccountDepositVoidMsg, "Message Displayed When Void Checkbox On Bank Account Deposit Screen Is Checked", logval);
			StrPrimaryWindowHandle = driver.getWindowHandle();
			...
			RMA_Input_Utility.RMA_SetValue_Utility(RMA_Selenium_POM_BankAccount.RMAApp_BankAccount_Deposit_Txt_Memo(driver), "Description Memo On Deposit Page", "To Void The Deposit ", logval);
			...
			parentlogger.log(LogStatus.INFO, logger.addScreenCapture(RMA_ScreenCapture_Utility.RMA_ScreenShotCapture_Utility(driver, "Successful Verification Of Voiding Deposits", "Successful Voiding Of Deposits")));
			//=========================================Steps To Void The Deposit Is Completed Here==========================================================================================================================================================================
