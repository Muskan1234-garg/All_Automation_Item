...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_Reg_Maint_Employee_TC_016
//Description    : Verify That Correct Validation Message Is Displayed When User Enters Birth Date Greater Than Todays Date
//Depends On TC  : None
//Revision       : 0.0 - DebasmitaPati-02-09-2018
//======================================================================================================================================================================================================================================================================================
public class RMA_Reg_Maint_Employee_TC_016 extends RMA_TC_BaseTest {
		
	@Test
		public void RMA_Reg_Maint_Employee_TC_016_Test() throws Exception,Error {

		try{
			parentlogger = reports.startTest("RMA_Reg_Maint_Employee_TC_016_Verify That Correct Validation Message Is Displayed When User Enters Birth Date Greater Than Todays Date","Validation Message Is Verified Successfully When User Enters Birth Date Greater Than Todays Date");
			...
			StrScreenShotTCName = "RMA_Reg_Maint_Employee_TC_016";
			ErrorMessage = null;
			CurrentFrameID=null;
			...
			RMA_Functionality_Utility.RMA_GenericSave_Utility(CurrentFrameID, true, "Date of Birth Must be less than or equal to Today's Date",  "Maintenance-->Employee Page", logval);
			parentlogger.log(LogStatus.PASS, color.RMA_ChangeColor_Utility("Date of Birth Must be less than or equal to Today's Date", 2)+ " Validation Message Is Verified Successfully");
