...
//=====================================================================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_QTPRegression_TC_023
//Description    : Setting Of Bank Account Owner To Line Of Business Is Validated 
//Depends On TC  : None
//Revision       : 0.0 - NidhiJha-08-21-2017
//===================================================================================================================================================================================================================================================================================================================================

public class RMA_QTPRegression_TC_023 extends RMA_TC_BaseTest{
	@Test
	public void RMA_QTPRegression_TC_023_Test() throws Exception,Error {
		...
		StrScreenShotTCName = "RMA_QTPRegression_TC_023";
		...
		try{
			...
			parentlogger = reports.startTest("RMA_QTPRegression_TC_023_Bank Account Owner Is Set To LOB_Validation","Bank Account Owner Is Set To Line Of Business Is Validated");
			...
			String WorkersCompClaimCreation_Txt_ClaimType;
			String WorkersCompClaimCreation_Txt_Department;
			String WorkersCompClaimCreation_Txt_Jurisdiction;
			String WorkersCompClaimCreation_Txt_ClaimInfoDept;
			String WorkersCompClaimCreation_Txt_DateOfEvent;
			String WorkersCompClaimCreation_Txt_DateOfClaim;
			String WorkersCompClaimCreation_Txt_TimeOfEvent;
			String WorkersCompClaimCreation_Txt_TimeOfClaim;
			int WorkersCompClaimCreation_Txt_EmployeeNo;
			...
			BankAccountCreation_Txt_BankAccountName = RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(4, "AA_RMABank_");
			...
			WorkersCompClaimCreation_Txt_DateOfEvent = RMA_GenericUsages_Utility.RMA_PastFutureDateInfo_Utility(0, -1, 0,"MM/dd/yyyy");
			WorkersCompClaimCreation_Txt_DateOfClaim = WorkersCompClaimCreation_Txt_DateOfEvent;
			WorkersCompClaimCreation_Txt_TimeOfEvent=RMA_GenericUsages_Utility.RMA_CurrentTimeInfo_Utility("HH:mm");
			WorkersCompClaimCreation_Txt_TimeOfClaim=WorkersCompClaimCreation_Txt_TimeOfEvent;
			...
			WorkersCompClaimCreation_Txt_EmployeeNo=111111111;
			...
			GenClaimCreation_Txt_ClaimType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_023", 1, 0); //Claim Type Is Fetched From DataSheet RMA_QTPRegression_TC_023			
			GenClaimCreation_Txt_Department = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_023", 1,1 ); //Department Is Fetched From DataSheet RMA_QTPRegression_TC_023
			GenClaimCreation_Txt_ClaimStatus =  ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_023", 1,2 ); //Claim Status Is Fetched From DataSheet RMA_QTPRegression_TC_023
			WorkersCompClaimCreation_Txt_ClaimType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_023", 1, 3); // Claim Type Is Fetched From DataSheet RMA_QTPRegression_TC_023
			WorkersCompClaimCreation_Txt_Department = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_023", 1, 4); // Department Is Fetched From DataSheet RMA_QTPRegression_TC_023
			WorkersCompClaimCreation_Txt_Jurisdiction = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_023", 1, 5); // Jurisdiction Is Fetched From DataSheet RMA_QTPRegression_TC_023
			WorkersCompClaimCreation_Txt_ClaimInfoDept = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_023", 1, 6); // Jurisdiction Is Fetched From DataSheet RMA_QTPRegression_TC_023
			VehicleClaimCreation_Txt_ClaimType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_023", 1, 7); // Claim Type Is Fetched From DataSheet RMA_QTPRegression_TC_023
			VehicleClaimCreation_Txt_Department = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_023", 1, 8); // Department Is Fetched From DataSheet RMA_QTPRegression_TC_023
			GenClaimCreation_Txt_ServiceCode = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_023", 1, 9); // Service Code Is Fetched From DataSheet RMA_QTPRegression_TC_023
			BankAccountCreation_Lst_DefaultExpansionList = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_023", 1, 10); //Default Expansion List Is Fetched From DataSheet RMA_QTPRegression_TC_023
			BankAccountCreation_Lst_OrgHierarchyLink = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_023", 1, 11); //Org Hierarchy Link Is Fetched From DataSheet RMA_QTPRegression_TC_023
			...
			testcall1 = true;
			rmaseleniumutilties_UX.RMA_Functionality_Utility.RMA_Suite22_Utility("RMA_QTPRegression_TC_023_Check", logval);
			...
			//========================================Steps To Navigate To Org Hierarchy Page For Department Selection Is Started Here============================================================================================================================================================================================================
			...
			RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_BankAccount.RMAApp_BankAccount_Btn_Owner(driver), "Owner Id Button On Bank Account Page", logval);
			...
			RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_BankAccount.RMAApp_BankAccount_RdBtn_GeneralClaim(driver), "General Claim Radio Button On Account Owner Tab Of Bank Account Page ", logval);
			...
			//========================================Steps To Navigate To Org Hierarchy Page For Department Selection Is Completed Here============================================================================================================================================================================================================
			...
			RMA_GenericUsages_Utility.RMA_StaticWait(12, logval, "Wait Is Added As Lookup Window Needs To Get Loaded");
			...
			//Switch To Org Hierarchy Page Is Done
			...
			RMA_GenericUsages_Utility.RMA_DynamicFrameSwitching(ParentFrame);
			RMA_GenericUsages_Utility.RMA_DynamicFrameSwitching(RMA_Selenium_POM_VerificationMessage.BankAccountFrame);
			RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_BankAccount.RMAApp_BankAccount_RdBtn_WCClaim(driver), "Workers Compensation Claim Radio Button On Account Owner Tab Of Bank Account Page ", logval);
			RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_Home.RMAApp_Generic_Img_Save(driver), "Save Image On "+ "saving ", logval);// Save Button Is Clicked
			...
			parentlogger.log(LogStatus.INFO, "Following Function Is Called :: "+RMA_GenericUsages_Utility.RMA_LoggerHyperlink("WorkersCompCorp","RMA_WorkersCompCorpClaimCreation",0)+" To Successfully Create A WC Claim");
			testcall4 = true;
			WCClaimNumber = RMA_Functionality_Utility.RMA_WorkersCompCorpClaimCreation( WorkersCompClaimCreation_Txt_ClaimType,GenClaimCreation_Txt_ClaimStatus, WorkersCompClaimCreation_Txt_EmployeeNo,  WorkersCompClaimCreation_Txt_Department,  WorkersCompClaimCreation_Txt_DateOfEvent,  WorkersCompClaimCreation_Txt_TimeOfEvent,  WorkersCompClaimCreation_Txt_DateOfClaim,  WorkersCompClaimCreation_Txt_TimeOfClaim,  WorkersCompClaimCreation_Txt_Jurisdiction, WorkersCompClaimCreation_Txt_ClaimInfoDept,true,logval1);
			...
			RMA_GenericUsages_Utility.RMA_StaticWait(10, logval, "Wait Is Added As Org Hierarchy Page Needs To Get Loaded");
			...
			RMA_GenericUsages_Utility.RMA_DynamicFrameSwitching(ParentFrame);
			RMA_GenericUsages_Utility.RMA_DynamicFrameSwitching(RMA_Selenium_POM_VerificationMessage.BankAccountFrame);
			RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_BankAccount.RMAApp_BankAccount_RdBtn_VehicleAccidentClaim(driver), "Workers Compensation Claim Radio Button On Account Owner Tab Of Bank Account Page ", logval);
			...
			testcall5 = true;
			VCClaimNumber = RMA_Functionality_Utility.RMA_VehicleCorpClaimCreation( VehicleClaimCreation_Txt_ClaimType,GenClaimCreation_Txt_ClaimStatus, VehicleClaimCreation_Txt_DateOfEvent,  VehicleClaimCreation_Txt_TimeOfEvent,  VehicleClaimCreation_Txt_DateOfClaim,  VehicleClaimCreation_Txt_TimeOfClaim, VehicleClaimCreation_Txt_Department, logval1);
			...
			RMA_GenericUsages_Utility.RMA_DynamicFrameSwitching(ParentFrame);
			RMA_GenericUsages_Utility.RMA_DynamicFrameSwitching(RMA_Selenium_POM_VerificationMessage.BankAccountFrame);
			RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_BankAccount.RMAApp_BankAccount_RdBtn_ShortTermDisability(driver), "Short Term Disability Radio Button On Account Owner Tab Of Bank Account Page ", logval);
			RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_Home.RMAApp_Generic_Img_Save(driver), "Save Image On "+ "saving ", logval);// Save Button Is Clicked
			//========================================Steps To Navigate To Org Hierarchy Page Is Completed Here===========================================================================================================================================================================================================
			...
			testcall7 = true;
			rmaseleniumutilties_UX.RMA_Functionality_Utility.RMA_Suite22_Utility("RMA_QTPRegression_TC_023_UnCheck", logval);
			parentlogger.log(LogStatus.INFO, "General System Parameter Setup Settings Are Done For Test Case:"+ " " + color.RMA_ChangeColor_Utility(StrScreenShotTCName, 2));
			...
			{
				logger.log(LogStatus.FAIL, "Following Error Occurred  ::" + " "+  color.RMA_ChangeColor_Utility(FinalErrorMessage,1)+ " " + "While Executing Function Utility" +" "+ "RMA_GenClaimCorpCreation" + " " +  "To Create New Corporate General Claim To And Hence The Test Case Is A Fail");
				parentlogger.appendChild(logger);
				reports.endTest(logger);	
			}
			...
			{
				logger.log(LogStatus.FAIL, "Following Error Occurred  ::" + " "+  color.RMA_ChangeColor_Utility(FinalErrorMessage,1)+ " " + "While Executing Function Utility" +" "+ "RMA_VehicleCorpClaimCreation" + " " +  "To Create New Corporate Vehicle Claim And Hence The Test Case Is A Fail");
				parentlogger.appendChild(logger);
				reports.endTest(logger);	
			}
			if (testcall6 == true && loggerval6.equalsIgnoreCase("NotInitialized"))								
			{
				logger.log(LogStatus.FAIL, "Following Error Occurred  ::" + " "+  color.RMA_ChangeColor_Utility(FinalErrorMessage,1)+ " " + "While Executing Function Utility" +" "+ "RMA_NonOccClaimCreation" + " " +  "To Create New Non Occ Claim And Hence The Test Case Is A Fail");
				parentlogger.appendChild(logger);
				reports.endTest(logger);	
			}
			...
			{
				logger.log(LogStatus.FAIL, "Following Error Occurred  ::" + " "+  color.RMA_ChangeColor_Utility(FinalErrorMessage,1)+ " " + "While Executing Function Utility" +" "+ "RMA_Suite22_Utility" + " " +  "To Revert Settings In New General System Parameter Setup And Hence The Test Case Is A Fail");
				parentlogger.appendChild(logger);
				reports.endTest(logger);	
			}
