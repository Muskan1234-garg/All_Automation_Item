...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_Reg_Maint_Employee_TC_029
//Description    : Verify That User Is Able To Make Any Field As Required and Validation Message Is Displayed In UX PowerView On Employee
//Depends On TC  : None
//Revision       : 0.0 - ShrutiShruti-03-07-2018 
//======================================================================================================================================================================================================================================================================================

public class RMA_Reg_Maint_Employee_TC_029 extends RMA_TC_BaseTest{
	@Test
	public void RMA_Reg_Maint_Employee_TC_029_Test() throws Exception,Error{
		try{
			parentlogger = reports.startTest("RMA_Reg_Maint_Employee_TC_029_Verify That Field Becomes Required By Flag On PV For Employee Page", "User Is Able To Make Any Field As Required and Validation Message Is Displayed In UX PowerView On Employee Is Validated");
			...
			StrScreenShotTCName = "RMA_Reg_Maint_Employee_TC_029";
			ErrorMessage = null;
			CurrentFrameID=null;
			...
			String StrEmployeeFirstName;
			int SocSecNumber;
			int EmployeeNumber;
			//Local Variables Are Declared Here
			
			StrEmployeeLastName=RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(3, "EmployeeLastName_");
			StrEmployeeFirstName=RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(3, "EmployeeFirstName_");
			...
			//================================================Steps For Verification Of Changes Made in PowerView Are Started Here
			driver.switchTo().window(StrRMAWindowHandle);
			...
			RMA_GenericUsages_Utility.RMA_MultipleWindowSwitching_Utility(3, "NA", "NA", "NA", "NA", "NA", "Maintenance Window Navigation From DashBoard", logval);
			...
			RMA_Verification_Utility.RMA_VerifyUXMessage(RMA_Selenium_POM_VerificationMessage.PowerViewMandatoryFieldMessage, true, "Error Message On Employee Creation Page", logval);
			RMA_Input_Utility.RMA_SetValue_Utility(RMA_Selenium_POM_Employee.RMAApp_Employee_Txt_FirstName(driver), "First Name TextBox On Employee Creation Page",StrEmployeeFirstName, logval);
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_Home.RMAApp_Generic_Img_Save(driver),"Save Image Button On Employee Creation Page", logval);
			RMA_Verification_Utility.RMA_VerifyUXMessage(RMA_Selenium_POM_VerificationMessage.DiarySuccessfulSave, false, "Employee Creation Page", logval);
			driver.close();
			//==================================================Steps For Verification Of Changes Made in PowerView Are Completed Here
			
			//===================================================Steps To Revert The Changes Made In PowerView Editor Completed Here
