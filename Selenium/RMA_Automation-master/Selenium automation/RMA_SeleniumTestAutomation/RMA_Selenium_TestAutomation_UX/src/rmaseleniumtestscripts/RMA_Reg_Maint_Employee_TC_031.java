...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_Reg_Maint_Employee_TC_031
//Description    : Verify That ToolTip Is Changed When Changed Via Old Power View By Enabling UX Setting Of Dependents Page
//Depends On TC  : None
//Revision       : 0.0 - ShrutiShruti-03-07-2018 
//======================================================================================================================================================================================================================================================================================

public class RMA_Reg_Maint_Employee_TC_031 extends RMA_TC_BaseTest{
	@Test
	public void RMA_Reg_Maint_Employee_TC_031_Test() throws Exception,Error{
		try{
			parentlogger = reports.startTest("RMA_Reg_Maint_Employee_TC_031_Verify ToolTip Changed Via UI PowerView For Dependents", "ToolTip Is Changed When Changed Via Old Power View By Enabling UX Setting Of Dependents Page Is Validated");
			...
			StrScreenShotTCName = "RMA_Reg_Maint_Employee_TC_031";
			ErrorMessage = null;
			...
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_Home.RMAApp_GenericBtn_EnityAdd(driver, "Dependents"), "Add Entity Button For Dependents On Employee Creation Page", logval);
			RMA_Verification_Utility.RMA_VerifyUXSpinnerDisappered(logval);
			RMA_Verification_Utility.RMA_ToolTip_Verification(RMA_Selenium_POM_Employee.RMAApp_Employee_Img_Save(driver), StrToolTip, "ToolTip Of Save Image Button On Dependents Creation Page", logval);
			...
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_Maintenance.RMAApp_Employee_Btn_Dependents(driver), "Dependents Image Button On Maintenance-->Employee Page", logval);
			RMA_Verification_Utility.RMA_VerifyUXSpinnerDisappered(logval);
			rmaseleniumutilties.RMA_Navigation_Utility.RMA_ToolTip_Verification(RMA_Selenium_POM_Maintenance.RMAApp_Dependents_Btn_Save(driver), StrToolTip, "ToolTip Of Save Image Button On Dependents Creation Page", logval);
