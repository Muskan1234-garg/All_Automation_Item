...
//=====================================================================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_QTPRegression_TC_041
//Description    : Verify Reserve and Incurred Balance calculations with selection of checkbox 'Calculate Collections in Incurred Balance Per Reserve'
//Depends On TC  : None
//Revision       : 0.0 - AbhishekRai-09-15-2017
//===================================================================================================================================================================================================================================================================================================================================

public class RMA_QTPRegression_TC_041 extends RMA_TC_BaseTest {	
	@Test
	public void RMA_QTPRegression_TC_041_Test() throws Exception,Error {
		try{
			parentlogger = reports.startTest("RMA_QTPRegression_TC_041_Calculate Collections in Incurred Balance Per Reserve", "Verify Reserve and Incurred Balance calculations with selection of checkbox 'Calculate Collections in Incurred Balance Per Reserve");
			parentlogger.assignAuthor("Abhishek Rai");	
			
			//Region =====================================================Global Variable Initialization Is Started Here=====================================================================================================
			StrScreenShotTCName = null;
			StrScreenShotTCName = "RMA_QTPRegression_TC_041";
			testcall1 = false;	
			...
			LineOfBussinessParameterSetup_Lst_LOBType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_041", 1, 0); //LOB Type Is Fetched From DataSheet RMA_QTPRegression_TC_042
			GenClaimCreation_Txt_ClaimType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_041", 1, 1); //Claim Type Is Fetched From DataSheet RMA_QTPRegression_TC_041			
			GenClaimCreation_Txt_Department = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_041", 1, 2); //Department Is Fetched From DataSheet RMA_QTPRegression_TC_041
			GenClaimCreation_Txt_ClaimStatus =  ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_041", 1, 3); //Claim Status Is Fetched From DataSheet RMA_QTPRegression_TC_041
			ReserveCreation_Lst_ReserveStatus = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_041", 1, 4); // Reserve Status Is Fetched From DataSheet RMA_QTPRegression_TC_041
			ReserveCreation_Lst_ReserveType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_041", 1, 5); // Reserve Type Is Fetched From DataSheet RMA_QTPRegression_TC_041
			ReserveCreation_Txt_ReserveAmount = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_QTPRegression_TC_041", 1, 6);  //Reserve Amount Is Fetched From DataSheet RMA_QTPRegression_TC_041
			ReserveCreation_Lst_ReserveType_1 = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_041", 1, 7); // Reserve Type_1 Is Fetched From DataSheet RMA_QTPRegression_TC_041
			ReserveCreation_Txt_ReserveAmount_1 = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_QTPRegression_TC_041", 1, 8);  //Reserve Amount_1 Is Fetched From DataSheet RMA_QTPRegression_TC_041
			ReserveCreation_Lst_ReserveType_2 = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_041", 1, 9); // Reserve Type_2 Is Fetched From DataSheet RMA_QTPRegression_TC_041
			ReserveCreation_Txt_ReserveAmount_2 = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_QTPRegression_TC_041", 1, 10);  //Reserve Amount_2 Is Fetched From DataSheet RMA_QTPRegression_TC_041
			PaymentCreation_Lst_BankAccount = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_041", 1, 11); //Bank Account Is Fetched From DataSheet RMA_QTPRegression_TC_041
			PaymentCreation_Lst_PayeeType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_041", 1, 12); // Payee Type Is Fetched From DataSheet RMA_QTPRegression_TC_041
			PaymentCreation_Txt_LastName = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_041", 1, 13); //LastName Is Fetched From DataSheet RMA_QTPRegression_TC_041			
			PaymentCreation_Txt_DisType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_041", 1, 14); //DisType Is Fetched From DataSheet RMA_QTPRegression_TC_041
			FundsSplitDetails_Txt_Amount = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_QTPRegression_TC_041", 1, 15); //Amount Is Fetched From DataSheet RMA_QTPRegression_TC_041
			FundsSplitDetails_Lst_TransactionType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_041", 1, 16); //Transaction Type Is Fetched From DataSheet RMA_QTPRegression_TC_041						
