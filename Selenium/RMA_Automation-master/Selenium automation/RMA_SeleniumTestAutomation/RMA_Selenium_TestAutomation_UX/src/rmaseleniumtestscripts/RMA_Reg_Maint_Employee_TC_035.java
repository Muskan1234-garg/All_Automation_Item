...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_Reg_Maint_Employee_TC_035
//Description    : Verify That When User Changes The ToolTip Of Any ToolBar Button Then The Same Is Updated In UX On Employee Page
//Depends On TC  : None
//Revision       : 0.0 - ShrutiShruti-03-05-2018 
//======================================================================================================================================================================================================================================================================================

public class RMA_Reg_Maint_Employee_TC_035 extends RMA_TC_BaseTest{
	@Test
	public void RMA_Reg_Maint_Employee_TC_035_Test() throws Exception,Error{
		try{
			parentlogger = reports.startTest("RMA_Reg_Maint_Employee_TC_035_Verify ToolTip Of ToolBar Button Is Changed According To The User", "User Changes The ToolTip Of Any ToolBar Button Then The Same Is Updated In UX On Employee Page Is Validated");
			...
			StrScreenShotTCName = "RMA_Reg_Maint_Employee_TC_035";
			ErrorMessage = null;
			...
			RMA_Verification_Utility.RMA_ToolTip_Verification(RMA_Selenium_POM_Employee.RMAApp_Employee_Img_Save(driver), "Save", "Save Image Button On Employee Page", logval);
			//Verification Of ToolTip Before Changes Are Made
			...
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_PowerView.RMAApp_PowerView_Lbl_DropDownField(driver, "Save"), "Save Label On DropDown Menu On ToolBar On Power View Editor Page", logval);
			...
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_PowerView.RMAApp_PowerView_Btn_Save(driver), "Save Image Button Power View Editor Page", logval);
			//===========================================================Changes Made In PowerView Editor Is Completed Here===============================================================================================================================================================================
			...
			RMA_GenericUsages_Utility.RMA_DynamicFrameSwitching(RMA_Selenium_POM_VerificationMessage.EmployeeFrame);
			RMA_Verification_Utility.RMA_ToolTip_Verification(RMA_Selenium_POM_Employee.RMAApp_Employee_Img_Save(driver), StrToolTip, "Save Image Button On Employee Creation Page", logval);
			driver.close();
			//Verification Is Done For Changed ToolTip Of toolBar Button
			...
			globalWait.until(ExpectedConditions.visibilityOf(RMA_Selenium_POM_PowerView.RMAApp_PowerView_DropDwn_ToolbarMainForm(driver)));
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_PowerView.RMAApp_PowerView_DropDwn_ToolbarMainForm(driver), "ToolBar DropDown On Power View Editor Page", logval);
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_PowerView.RMAApp_PowerView_Lbl_DropDownField(driver, StrToolTip), StrToolTip+" Label On DropDown Menu On ToolBar On Power View Editor Page", logval);
			RMA_Input_Utility.RMA_SetValue_Utility(RMA_Selenium_POM_PowerView.RMAApp_PowerView_Txt_Caption(driver), "Caption TextBox On Power View Editor Page", "Save", logval);
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_PowerView.RMAApp_PowerView_Btn_Save(driver), "Save Image Button Power View Editor Page", logval);
