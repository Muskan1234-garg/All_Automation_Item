...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_SeleniumRegression_TC_073
//Description    : Create,Edit and Delete Of Enhanced Note On A Person Involved(OtherPerson) Is Validated
//Depends On TC  : RMA_SeleniumRegression_TC_058
//Revision       : 0.0 - ShrutiShruti-12-13-2017 
//======================================================================================================================================================================================================================================================================================


public class RMA_SeleniumRegression_TC_073 extends RMA_TC_BaseTest{
	@Test
	public void RMA_SeleniumRegression_TC_073_Test() throws Exception,Error{
		try{
			parentlogger = reports.startTest("RMA_SeleniumRegression_TC_073_Create, Edit And Delete Of Enhanced Notes On Person Involved(OtherPerson) Screen", "Create,Edit and Delete Of Enhanced Note On A Person Involved(OtherPerson) Is Validated");
			parentlogger.assignAuthor("Shruti Shruti");

			StrScreenShotTCName = "RMA_SeleniumRegression_TC_073";
			testcall1 = false;	
