...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_Reg_Maint_Employee_TC_008
//Description    : Verify That Correct Validation Message Is Displayed When User Enters Date Of Death Before Date Hired
//Depends On TC  : None
//Revision       : 0.0 - DebasmitaPati-02-09-2018
//======================================================================================================================================================================================================================================================================================
public class RMA_Reg_Maint_Employee_TC_008 extends RMA_TC_BaseTest {
		
	@Test
		public void RMA_Reg_Maint_Employee_TC_008_Test() throws Exception,Error {

		try{
			parentlogger = reports.startTest("RMA_Reg_Maint_Employee_TC_008_Verify That Correct Validation Message Is Displayed When User Enters Date Of Death Before Date Hired","Validation Message Is Verified Successfully When User Enters Date Of Death Before Date Hired");
			...
			StrScreenShotTCName = "RMA_Reg_Maint_Employee_TC_008";
			ErrorMessage = null;
			CurrentFrameID=null;
			...
			Date_Death = RMA_GenericUsages_Utility.RMA_PastFutureDateInfo_Utility(0,-1,-1,"MM/dd/yyyy");
			...
			RMA_Input_Utility.RMA_SetTextValueandTabOut_Utility(RMA_Selenium_POM_Employee.RMAApp_Employee_Txt_HiredDate(driver), "Date of Hired TextBox On Maintenance-->Employee Page", Date_Hired, logval);
			...
			RMA_Input_Utility.RMA_SetTextValueandTabOut_Utility(RMA_Selenium_POM_Employee.RMAApp_Employee_Txt_DateOfDeath(driver), "Date of Death TextBox On Maintenance-->Employee Page",Date_Death, logval);
			CurrentFrameID = RMA_GenericUsages_Utility.RMA_GetCurrentFrameID();
			RMA_Functionality_Utility.RMA_GenericSave_Utility(CurrentFrameID, true, "Date of Death must be greater than or equal to Date Hired",  "Maintenance-->Employee Page", logval);
			parentlogger.log(LogStatus.PASS, color.RMA_ChangeColor_Utility("Date of Death must be greater than or equal to Date Hired", 2)+ " Validation Message Is Verified Successfully");
