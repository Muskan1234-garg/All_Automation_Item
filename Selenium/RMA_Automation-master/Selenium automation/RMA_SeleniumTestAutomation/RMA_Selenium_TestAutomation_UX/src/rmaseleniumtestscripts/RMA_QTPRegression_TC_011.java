...
//=====================================================================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_QTPRegression_TC_011
//Description    : '10 - Claims with same Claimant SSN, Amount, From - To Date Range, and Invoice Number' Duplicate Payment Criteria Is Validated 
//Revision       : 0.0 - NidhiJha-07-30-2017
//===================================================================================================================================================================================================================================================================================================================================

public class RMA_QTPRegression_TC_011 extends RMA_TC_BaseTest{
	@Test
	public void RMA_QTPRegression_TC_011_Test() throws Exception,Error {

		StrScreenShotTCName = null;
		StrScreenShotTCName = "RMA_QTPRegression_TC_011";
		testcall1 = false;	
		...
		try{   
			...
			parentlogger = reports.startTest("RMA_QTPRegression_TC_011_Duplicate_Payment_Criteria_10_Validation", "'10 - Claims with same Claimant SSN, Amount, From - To Date Range, and Invoice Number' Duplicate Payment Criteria Is Validated ");
			...
			Payment_Lst_PayeeType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_011", 1, 0); // Payee Type Is Fetched From DataSheet RMA_QTPRegression_TC_011
			FundsSplitDetails_Lst_TransactionType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_011", 1, 1); //Transaction Type Is Fetched From DataSheet RMA_QTPRegression_TC_011
			FundsSplitDetails_Txt_Amount = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_QTPRegression_TC_011", 1, 2); //Amount Is Fetched From DataSheet RMA_QTPRegression_TC_011
			Payment_Txt_LastName = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_011", 1, 3); //LastName Is Fetched From DataSheet RMA_QTPRegression_TC_011
			Payment_Txt_DisType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_011", 1, 4); //Distribution Type Is Fetched From DataSheet RMA_QTPRegression_TC_011
			ReserveType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_011", 1, 5); // Reserve Type Is Fetched From DataSheet RMA_QTPRegression_TC_011
			//Payment Data Fetched Is Completed Here

			GenClaimCreation_Txt_ClaimType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_011", 1, 6); //Claim Type Is Fetched From DataSheet RMA_QTPRegression_TC_011
			GenClaimCreation_Txt_ClaimStatus =  ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_011", 1,7 ); //Claim Status Is Fetched From DataSheet RMA_QTPRegression_TC_011
			GenClaimCreation_Txt_Department = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_011", 1,8 ); //Department Is Fetched From DataSheet RMA_QTPRegression_TC_011
			...
			rmaseleniumutilties_UX.RMA_Functionality_Utility.DuplicatePaymentCriteria_Utility("10 - Claims with same Claimant SSN, Amount, From - To Date Range, and Invoice Number", logval);
			...
			parentlogger.log(LogStatus.INFO, "Following Function Is Called :: "+RMA_GenericUsages_Utility.RMA_LoggerHyperlink("UnsuccessfulPaymentAddition","RMA_UnsuccessfulPaymentCorpAddition_Utility",1)+" To Create Second Payment");
			testcall6 = true;
			RMA_Functionality_Utility.RMA_UnsuccessfulPaymentCorpAddition_Utility(Payment_Txt_BankAccount, Payment_Lst_PayeeType,ReserveType, FundsSplitDetails_Lst_TransactionType,FundsSplitDetails_Txt_Amount, Payment_Txt_LastName, Payment_Txt_DisType, "10 - Claims with same Claimant SSN, Amount, From - To Date Range, and Invoice Number_FourthPayment", logval1);
