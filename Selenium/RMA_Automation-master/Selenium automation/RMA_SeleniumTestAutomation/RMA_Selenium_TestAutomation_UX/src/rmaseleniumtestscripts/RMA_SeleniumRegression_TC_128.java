...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_SeleniumRegression_TC_128
//Description    : Create,Edit And Delete Of Enhanced Notes On DemandOffer For Unit On Vehicle Claim
//Depends On TC  : RMA_SeleniumRegression_TC_059
//Revision       : 0.0 - ShrutiShruti-01-02-2018 
//======================================================================================================================================================================================================================================================================================

public class RMA_SeleniumRegression_TC_128 extends RMA_TC_BaseTest{
	@Test
	public void RMA_SeleniumRegression_TC_128_Test() throws Exception,Error{
		try{
			parentlogger = reports.startTest("RMA_SeleniumRegression_TC_128_Create,Edit And Delete Of Enhanced Notes On DemandOffer On Unit On Vehicle Claim", "Create,Edit And Delete Of Enhanced Notes On DemandOffer On Unit On Vehicle Claim Is Validated");
			...
			StrScreenShotTCName = "RMA_SeleniumRegression_TC_128";
			ErrorMessage = null;
			CurrentFrameID=null;
