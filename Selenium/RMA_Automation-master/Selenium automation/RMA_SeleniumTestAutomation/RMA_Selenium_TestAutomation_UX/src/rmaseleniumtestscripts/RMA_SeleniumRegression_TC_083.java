...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_SeleniumRegression_TC_083
//Description    : Create,Edit and Delete Of Enhanced Note On A Person Involved(Witness) On Litigation Page Is Validated
//Depends On TC  : RMA_SeleniumRegression_TC_024
//Revision       : 0.0 - ShrutiShruti-12-19-2017 
//======================================================================================================================================================================================================================================================================================

public class RMA_SeleniumRegression_TC_083 extends RMA_TC_BaseTest{ 
	@Test
	public void RMA_SeleniumRegression_TC_083_Test() throws Exception,Error{
		try{
			parentlogger = reports.startTest("RMA_SeleniumRegression_TC_083_Create, Edit And Delete Of Enhanced Notes On Person Involved(Witness) Screen On Litigation Page", "Create,Edit and Delete Of Enhanced Note On A Person Involved(Witness) On Litigation Page Is Validated");
			parentlogger.assignAuthor("Shruti Shruti");

			StrScreenShotTCName = "RMA_SeleniumRegression_TC_083";
			testcall1 = false;	
			...
			testcall2 = true;
			EnhancedNotes = RMA_Functionality_Utility.RMA_EnhancedNotesCreateEditDelete_SubEntity_Utility("Create/Edit", "Confidential", "CF Confidential",StrClaimNumber,StrWitnessLastName, "NotRequired",Edit,logval1);
		...
		catch(Exception|Error e)
		{
			...
			if (testcall2== true && loggerval2.equalsIgnoreCase("NotInitialized"))								
			 {
			 logger.log(LogStatus.FAIL, "Following Error Occurred  ::" + " "+  color.RMA_ChangeColor_Utility(FinalErrorMessage,1)+ " " + "While Executing Function Utility" +" "+ "RMA_EnhancedNotesCreateEditDelete_SubEntity_Utility" + " " +  "To Create And Edit Enhanced Notes And Hence The Test Case Is A Fail");
			 parentlogger.appendChild(logger);
			 reports.endTest(logger);	
			 }
		...
		finally
		{
			try {
				...
				if (!(RMA_Selenium_POM_EnhancedNotes.RMAApp_EnhancedNotes_Btn_Close(driver)== null)){
					...
					driver.switchTo().parentFrame();
					RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_Home.RMAApp_DefaultView_Lbl_BreadcrumbName(driver, RMA_SeleniumRegression_TC_024.LitCreation_Txt_DocketNumber),StrClaimNumber +" Litigation Number Link At Top Of The Screen",logval);
