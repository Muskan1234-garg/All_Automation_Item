...
//=====================================================================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_QTPRegression_TC_061
//Description    : Clearing Checks From Funds Link Is Validated
//Depends On TC  : None
//Revision       : 0.0 - NidhiJha-09-05-2017
//===================================================================================================================================================================================================================================================================================================================================

public class RMA_QTPRegression_TC_061 extends RMA_TC_BaseTest{
	@Test
	public void RMA_QTPRegression_TC_061_Test() throws Error,Exception{
		...
		StrScreenShotTCName = "RMA_QTPRegression_TC_061";	
		...
		try{
			parentlogger = reports.startTest("RMA_QTPRegression_TC_061_Check_Clearance_Validation",  "Clearance Check From Funds Link Is Validated");
			...
			GenClaimCreation_Txt_ClaimType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_061", 1, 0); //Claim Type Is Fetched From DataSheet RMA_QTPRegression_TC_061			
			GenClaimCreation_Txt_Department = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_061", 1,1 ); //Department Is Fetched From DataSheet RMA_QTPRegression_TC_061
			GenClaimCreation_Txt_ClaimStatus =  ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_061", 1,2 ); //Claim Status Is Fetched From DataSheet RMA_QTPRegression_TC_061
			GenClaimCreation_Txt_ServiceCode = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_061", 1,3 ); //Service Code Is Fetched From DataSheet RMA_QTPRegression_TC_061
			//General Claim Data Fetch From Excel WorkBook Is Completed Here
			
			PaymentCreation_Lst_PayeeType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_061", 1, 4); // Payee Type Is Fetched From DataSheet RMA_QTPRegression_TC_061
			FundsSplitDetails_Lst_TransactionType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_061", 1, 5); //Transaction Type Is Fetched From DataSheet RMA_QTPRegression_TC_061
			PaymentCreation_Txt_LastName = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_061", 1, 6); //LastName Is Fetched From DataSheet RMA_QTPRegression_TC_061
			PaymentCreation_Txt_DisType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_061", 1, 7); //Distribution Type Is Fetched From DataSheet RMA_QTPRegression_TC_061
			PaymentCreation_Txt_ReserveType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_061", 1, 8); // Reserve Type Is Fetched From DataSheet RMA_QTPRegression_TC_061
			FundsSplitDetails_Txt_Amount =  ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_QTPRegression_TC_061", 1, 9);//Funds Split Details Amount Is Fetched From DataSheet RMA_QTPRegression_TC_061
			//Payment Data Fetch From Excel WorkBook Is Completed Here
			
			CheckStockCreation_Txt_FontStyle = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_061", 1, 10);//Font Style Is Fetched From DataSheet RMA_QTPRegression_TC_061
			CheckStockCreation_Txt_FontSize = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_QTPRegression_TC_061", 1, 11);//Font Size Is Fetched From DataSheet RMA_QTPRegression_TC_061
			...
			RMA_GenericUsages_Utility.RMA_StaticWait(5, logval, "Wait Is Added As General Claim Page Needs To Get Loaded After Service Code Is Selected");
			...
			//========================================Steps To Mark Checks As Cleared Is Started Here=========================================================================================================================================================================================================================
			parentlogger.log(LogStatus.INFO, "Following Function Is Called :: "+RMA_GenericUsages_Utility.RMA_LoggerHyperlink("MarkChecksAsCleared","RMA_Funds_MarkChecksAsCleared",0)+" To Successfully Mark Checks As Cleared");
			testcall6 = true;
			RMA_Functionality_Utility.RMA_Funds_MarkChecksAsCleared(BankAccountCreation_Txt_BankAccountName,logval1);
			parentlogger.log(LogStatus.INFO, "Check Is Marked As Cleared Successfully For Bank Account"+ " " + color.RMA_ChangeColor_Utility(BankAccountCreation_Txt_BankAccountName, 2));
			loggerval6 = logger.toString();
			parentlogger.appendChild(logger);
			DefaultFrameID = RMA_GenericUsages_Utility.RMA_GetCurrentFrameID();
			//========================================Steps To Mark Checks As Cleared Is Completed Here============================================================================================================================================================================================================

			//===========================================Steps To Close The Mark Checks As Cleared Page Is Started Here==========================================================================================================================================================================
			//RMA_GenericUsages_Utility.RMA_StaticWait(6, logval, "Wait Is Added As Message Needs To Get Verified");
			RMA_Navigation_Utility.RMA_ObjectClick(rmaseleniumPOM.RMA_Selenium_POM_Home.RMAApp_DefaultView_Btn_Close(driver), "Close Button On Mark Checks As Cleared Page", logval);
			//===========================================Steps To Close The Mark Checks As Cleared Page Is Completed Here==========================================================================================================================================================================
			...
			{
				logger.log(LogStatus.FAIL, "Following Error Occurred  ::" + " "+  color.RMA_ChangeColor_Utility(FinalErrorMessage,1)+ " " + "While Executing Function Utility" +" "+ "RMA_Funds_MarkChecksAsCleared" + " " +  "To Mark Checks As Cleared And Hence The Test Case Is A Fail");
				parentlogger.appendChild(logger);
				reports.endTest(logger);	
			}
