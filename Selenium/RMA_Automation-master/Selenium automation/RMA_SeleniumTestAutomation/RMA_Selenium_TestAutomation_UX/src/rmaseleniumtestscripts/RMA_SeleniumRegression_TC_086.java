...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_SeleniumRegression_TC_086
//Description    : Claimant is Created And Create,Edit and Delete Of Enhanced Note On A DemandOffer Corresponding To Subrogation Screen Is Validated
//Depends On TC  : RMA_SeleniumRegression_TC_058
//Revision       : 0.0 - ShrutiShruti-12-20-2017 
//======================================================================================================================================================================================================================================================================================

public class RMA_SeleniumRegression_TC_086 extends RMA_TC_BaseTest{
	@Test
	public void RMA_SeleniumRegression_TC_086_Test() throws Exception,Error{
		try{
			parentlogger = reports.startTest("RMA_SeleniumRegression_TC_086_Create, Edit And Delete Of Enhanced Notes On A DemandOffer On A Subrogation Screen", "Create,Edit and Delete Of Enhanced Note On A DemandOffer On A Subrogation Screen Is Validated");
			parentlogger.assignAuthor("Shruti Shruti");

			StrScreenShotTCName = "RMA_SeleniumRegression_TC_086";
			testcall1 = false;	
