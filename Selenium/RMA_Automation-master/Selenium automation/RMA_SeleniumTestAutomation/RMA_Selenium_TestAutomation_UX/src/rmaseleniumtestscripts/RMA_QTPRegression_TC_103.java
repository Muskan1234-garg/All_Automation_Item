...
//=====================================================================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_QTPRegression_TC_103
//Description    : Verify system checks for insufficient reserves when checkbox 'Check for Insufficient Reserve Funds in Auto Checks' is checked Is Validated
//Depends On TC  : None
//Revision       : 0.0 - NidhiJha-01-03-2018
//===================================================================================================================================================================================================================================================================================================================================


public class RMA_QTPRegression_TC_103 extends RMA_TC_BaseTest {
	@Test
	public void RMA_QTPRegression_TC_103_Test() throws Exception,Error {
		...
		StrScreenShotTCName = "RMA_QTPRegression_TC_103";
		...
		try{
			...
			parentlogger = reports.startTest("RMA_QTPRegression_TC_103_System_Checks_For_Insufficient_Reserves_Validation", "Verify system checks for insufficient reserves when checkbox 'Check for Insufficient Reserve Funds in Auto Checks' is checked Is Validated");
			...
			String ScheduleChecksCreation_Txt_BankAccountName;
			...
			GenClaimCreation_Txt_ClaimType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_103", 1, 0); //Claim Type Is Fetched From DataSheet RMA_QTPRegression_TC_103
			GenClaimCreation_Txt_ClaimStatus =  ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_103", 1,1 ); //Claim Status Is Fetched From DataSheet RMA_QTPRegression_TC_103
			GenClaimCreation_Txt_Department = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_103", 1,2 ); //Department Is Fetched From DataSheet RMA_QTPRegression_TC_103
			//General claim Data Fetch From Excel WorkBook Is Completed Here

			ReserveCreation_Lst_Status = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_103", 1, 3); //Status Is Fetched From DataSheet RMA_QTPRegression_TC_103
			ReserveCreation_Lst_ReserveType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_103", 1, 4); //Reserve Type Is Fetched From DataSheet RMA_QTPRegression_TC_103
			ReserveCreation_Txt_ReserveAmount =  ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_QTPRegression_TC_103", 1, 5);// Amount Is Fetched From DataSheet RMA_QTPRegression_TC_103
			ReserveCreation_Lst_ReserveType_1 =  ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_103", 1, 6);// Reserve Type Is Fetched From DataSheet RMA_QTPRegression_TC_103
			//Reserve Data Fetch From Excel WorkBook Is Completed 

			ScheduleChecksCreation_Txt_Payeetype = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_103", 1,7 ); //Payee Type Is Fetched From DataSheet RMA_QTPRegression_TC_103
			ScheduleChecksCreation_Txt_TransType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_103", 1,8 );//Transaction Type Is Fetched From DataSheet RMA_QTPRegression_TC_103
			ScheduleChecksCreation_Txt_LastName =  ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_103", 1,9 );//Last Name Is Fetched From DataSheet RMA_QTPRegression_TC_103
			ScheduleChecksCreation_Txt_PayInterval = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_103", 1,10 );//Pay Interval Is Fetched From DataSheet RMA_QTPRegression_TC_103
			ScheduleChecksCreation_Txt_NumberOfPayment = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_QTPRegression_TC_103", 1,11 );//Number Of Payments Is Fetched From DataSheet RMA_QTPRegression_TC_103
			ScheduleChecksCreation_Txt_DistributionType  = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_103", 1,12 );//Distribution Type Is Fetched From DataSheet RMA_QTPRegression_TC_103
			ScheduleChecksCreation_Txt_Amount = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_QTPRegression_TC_103", 1,13 );//Amount Is Fetched From DataSheet RMA_QTPRegression_TC_103
			ScheduleChecksCreation_Txt_BankAccountName = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_103", 1,14 );//Distribution Type Is Fetched From DataSheet RMA_QTPRegression_TC_103
			//Schedule Check Fetch From Excel WorkBook Is Completed Here
			
			RMA_GenericUsages_Utility.RMA_Non_UXNavigation();
			
			//=========================================Steps To Do LOB Parameter Setup Settings Is Started Here===========================================================================================================================================================================================================================================================
			...
			testcall1 = true;
			RMA_Functionality_Utility.RMA_Suite28_Utility("RMA_QTPRegression_TC_103_Check", logval1);
			parentlogger.log(LogStatus.INFO, "UI Settings Successfully Completed");
			loggerval1 = logger.toString();
			parentlogger.appendChild(logger);
			//=========================================Steps To Do LOB Parameter Setup Settings Is Completed Here===========================================================================================================================================================================================================================================================
			...
			//========================================Steps To Create First Reserve On The Created General Claim Is Started Here===========================================================================================================================================================================================================================================================
			...
			parentlogger.appendChild(logger);
			//========================================Steps To Create First Reserve On The Created General Claim Is Completed Here===========================================================================================================================================================================================================================================================
			...
			{
				logger.log(LogStatus.FAIL, "Following Error Occurred  ::" + " "+  color.RMA_ChangeColor_Utility(FinalErrorMessage,1)+ " " + "While Executing Function Utility" +" "+ "RMA_Suite28_Utility" + " " +  "To Do settings On LOB System Parameter Page And Hence The Test Case Is A Fail");
				parentlogger.appendChild(logger);
			...
			{
				logger.log(LogStatus.FAIL, "Following Error Occurred  ::" + " "+  color.RMA_ChangeColor_Utility(FinalErrorMessage,1)+ " " + "While Executing Function Utility" +" "+ "RMA_ReserveCorpAddition_Utility" + " " +  "To Create First Reserve On The Created Claim And Hence The Test Case Is A Fail");
				parentlogger.appendChild(logger);
				reports.endTest(logger);	
			}
			if (testcall4 == true && loggerval4.equalsIgnoreCase("NotInitialized"))								
			{
				logger.log(LogStatus.FAIL, "Following Error Occurred  ::" + " "+  color.RMA_ChangeColor_Utility(FinalErrorMessage,1)+ " " + "While Executing Function Utility" +" "+ "RMA_ReserveCorpAddition_Utility" + " " +  "To Create Second Reserve On The Created Claim And Hence The Test Case Is A Fail");
				parentlogger.appendChild(logger);
				reports.endTest(logger);	
			}
			...
			{
				logger.log(LogStatus.FAIL, "Following Error Occurred  ::" + " "+  color.RMA_ChangeColor_Utility(FinalErrorMessage,1)+ " " + "While Executing Function Utility" +" "+ "RMA_ScheduleCheckCreation" + " " +  "To Create Schedule Check And Hence The Test Case Is A Fail");
				parentlogger.appendChild(logger);
				reports.endTest(logger);		
			}
