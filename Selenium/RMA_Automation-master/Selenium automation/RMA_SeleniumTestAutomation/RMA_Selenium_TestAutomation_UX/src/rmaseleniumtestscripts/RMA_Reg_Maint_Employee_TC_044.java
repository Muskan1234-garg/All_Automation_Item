...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_Reg_Maint_Employee_TC_044
//Description    : Verify That User Gets Validation When User Tries To Remove Any Required Field In Power View UX(Dependent)
//Depends On TC  : None
//Revision       : 0.0 - ShrutiShruti-02-26-2018 
//======================================================================================================================================================================================================================================================================================

public class RMA_Reg_Maint_Employee_TC_044 extends RMA_TC_BaseTest{
	@Test
	public void RMA_Reg_Maint_Employee_TC_044_Test() throws Exception,Error{
		try{
			parentlogger = reports.startTest("RMA_Reg_Maint_Employee_TC_044_Verify That User Gets Validation When User Tries To Remove Any Required Field In Dependent On Power View UX", "Correct Validation When User Tries To Remove Any Required Field In Dependent On Power View UX Is Validated");
			...
			StrScreenShotTCName = "RMA_Reg_Maint_Employee_TC_044";
			ErrorMessage = null;
			...
			Login_Txt_UserName = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_Reg_Maint_Employee_TC_044", 1, 0); //UserName Fetched From DataSheet RMA_Reg_Maint_Employee_TC_044
			Login_Txt_Password = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_Reg_Maint_Employee_TC_044", 1, 1); //Password Fetched From DataSheet RMA_Reg_Maint_Employee_TC_044
			Login_Txt_UserName_1 = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_Reg_Maint_Employee_TC_044", 1, 2); //UserName Fetched From DataSheet RMA_Reg_Maint_Employee_TC_044
			Login_Txt_Password_1 = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_Reg_Maint_Employee_TC_044", 1, 3); //Password Fetched From DataSheet RMA_Reg_Maint_Employee_TC_044
			DSNSelect_Lst_DataSourceName = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_Reg_Maint_Employee_TC_044", DSRow, 4); //Data Source Name Is Fetched From DataSheet RMA_Reg_Maint_Employee_TC_044			
			...
			globalWait.until(ExpectedConditions.visibilityOf(RMA_Selenium_POM_PowerView.RMAApp_PowerView_Lbl_Entity(driver, "Employee Dependent")));
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_PowerView.RMAApp_PowerView_Lbl_Entity(driver, "Employee Dependent"), "Employee Dependent Label On Power View Editor Page", logval);
			RMA_Verification_Utility.RMA_VerifyUXSpinnerDisappered(logval);
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_PowerView.RMAApp_PowerView_Btn_FieldDelete(driver, "Last Name"), "Dependent's Last Name Field Delete Button On Power View Editor Page", logval);
			...
			RMA_Verification_Utility.RMA_VerifyUXErrorMessage("Dependent's Last Name is a system required field can not be removed from the Powerview.", false, "Validation Error Message on Power View Editor Page", logval);
