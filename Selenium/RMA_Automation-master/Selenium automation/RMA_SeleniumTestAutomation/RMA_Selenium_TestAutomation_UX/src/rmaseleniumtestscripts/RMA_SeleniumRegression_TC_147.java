...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_SeleniumRegression_TC_147
//Description    : Create,Edit And Delete Of Attachments On Medical Staff On Maintenance Screen
//Depends On TC  : RMA_Smoke_TC_041_I
//Revision       : 0.0 - ShrutiShruti-01-11-2018 
//======================================================================================================================================================================================================================================================================================

public class RMA_SeleniumRegression_TC_147 extends RMA_TC_BaseTest{
	@Test
	public void RMA_SeleniumRegression_TC_147_Test() throws Exception,Error{
		try{
			parentlogger = reports.startTest("RMA_SeleniumRegression_TC_147_Create, Edit and Delete of Attachmments On MedicalStaff Page On Maintenance Screen", "Create, Edit and Delete of Attachments On MedicalStaff Page on Maintenance Screen Is Validated");
			...
			StrScreenShotTCName = "RMA_SeleniumRegression_TC_147";
			ErrorMessage = null;
			CurrentFrameID=null;
			...
			//=================================================Steps To Delete Medical Staff Started Here=================================================================================================================================================================================================
			RMA_Functionality_Utility.RMA_GenericDelete_Utility("Maintenance-->Medical Staff", false, logval);
			RMA_Functionality_Utility.RMA_GenericDelete_Utility("Maintenance-->Medical Staff", true, logval);
			//=================================================Steps To Delete Medical Staff Completed Here=============================================================================================================================================================================================================================
			driver.switchTo().parentFrame();
		}
