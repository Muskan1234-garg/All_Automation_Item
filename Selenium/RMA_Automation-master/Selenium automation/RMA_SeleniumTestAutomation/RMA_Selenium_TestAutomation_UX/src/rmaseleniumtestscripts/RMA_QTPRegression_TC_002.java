...
//=====================================================================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_QTPRegression_TC_002
//Description    : '2-Payment Total' Duplicate Payment Criteria Is Validated 
//Depends On TC  : None
//Revision       : 0.0 - NidhiJha-07-18-2017
//===================================================================================================================================================================================================================================================================================================================================

public class RMA_QTPRegression_TC_002  extends RMA_TC_BaseTest {
	@Test
	public void RMA_QTPRegression_TC_002_Test() throws Exception,Error {

		StrScreenShotTCName = null;
		StrScreenShotTCName = "RMA_QTPRegression_TC_002";
		testcall1 = false;	
		...
		try{    
			...
			parentlogger = reports.startTest("RMA_QTPRegression_TC_002_Duplicate_Payment_Criteria_2_Validation", "'2 - Payment Total' Duplicate Payment Criteria Is Validated ");
			...
			RMA_ExcelDataRetrieval_Utility ExcelData = new RMA_ExcelDataRetrieval_Utility(System.getProperty("user.dir")+"\\RMASeleniumTestDataSheets\\RMA_Suite_02_QTPRegression_01.xlsx"); //Excel WorkBook RMA_Suite_02_QTPRegression IS Fetched To Retrieve Data 
			Payment_Lst_PayeeType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_002", 1, 0); // Payee Type Is Fetched From DataSheet RMA_QTPRegression_TC_002
			FundsSplitDetails_Lst_TransactionType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_002", 1, 1); //Transaction Type Is Fetched From DataSheet RMA_QTPRegression_TC_002
			FundsSplitDetails_Txt_Amount = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_QTPRegression_TC_002", 1, 2); //Amount Is Fetched From DataSheet RMA_QTPRegression_TC_002
			Payment_Txt_LastName = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_002", 1, 3); //LastName Is Fetched From DataSheet RMA_QTPRegression_TC_002
			Payment_Txt_DisType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_002", 1, 4); //Distribution Type Is Fetched From DataSheet RMA_QTPRegression_TC_002
			ReserveType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_002", 1, 5); // Reserve Type Is Fetched From DataSheet RMA_QTPRegression_TC_002
			//Payment Data Fetched Is Completed Here

			GenClaimCreation_Txt_ClaimType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_002", 1, 6); //Claim Type Is Fetched From DataSheet RMA_QTPRegression_TC_002
			GenClaimCreation_Txt_ClaimStatus =  ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_002", 1,7 ); //Claim Status Is Fetched From DataSheet RMA_QTPRegression_TC_002
			GenClaimCreation_Txt_Department = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_002", 1,8 ); //Department Is Fetched From DataSheet RMA_QTPRegression_TC_002
			...
			rmaseleniumutilties_UX.RMA_Functionality_Utility.DuplicatePaymentCriteria_Utility("2 - Payment Total", logval);	
			...
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_PaymentsCollections.RMAApp_PaymentCollection_Tab_Transaction(driver), "Transaction Tab On Payment Creation Page",logval);// Transaction Tab On Payment Creation Page Is Clicked
