...
//================================================================================================
//TestCaseID     : RMA_SeleniumRegression_TC_049
//Description    : RMA_SeleniumRegression_TC_049_ Successful Creation Of A Diary From Defendant Is Validated
//Depends On TC  : RMA_Smoke_TC_002: For Claim Creation
//Revision       : 0.0 - RenuVerma-03-06-2017
//=================================================================================================

public class RMA_SeleniumRegression_TC_049 extends rmaseleniumtestscripts.RMA_TC_BaseTest {
	...
	@Test
	public void RMA_SeleniumRegression_TC_049_Test() throws Exception,Error {
		...
		try{
			parentlogger = reports.startTest("RMA_SeleniumRegression_TC_049_ Attach A Diary From Defendant", "Successful Creation Of A Diary From Defendant Is Validated");
			...
			ActivityList = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_SeleniumRegression_TC_047", 1, 0); // Activity List Is Fetched From DataSheet RMA_SeleniumRegression_TC_049
			...
			testcall1 = true;
			StrDefendant = RMA_Functionality_Utility.RMA_ClaimEventEntityAddition_Utility("Defendant", StrClaimNumber, "NA", "NA",logval1);
			loggerval1 = logger.toString();
			parentlogger.log(LogStatus.INFO, "New Defandent Is Created With Defentdant LastName::"+ " " + color.RMA_ChangeColor_Utility(StrDefendant, 2));
			parentlogger.appendChild(logger);
			/*===========================================================New Defendant Creation Is Completed Here======================================================================================================================================================================================*/
				
			/*===========================================================Steps To Attach Diary On Adjustor Is Started Here=======================================================================================================================================================================================*/
			RMA_GenericUsages_Utility.RMA_ConditionalFrameSwitching(DefaultFrameID);
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_Home.RMAApp_GenericClaim_Btn_Diary(driver), "Diary Image On Following  Claimant Screen::"+" "+StrDefendant,logval);
			DiaryTaskName = RMA_Functionality_Utility.RMA_AttachCreateEdit_Diary("Attached","NA",ActivityList,"NA","NA", "NA", "Important","defendant",logval);
			parentlogger.log(LogStatus.INFO, "Diary Is Created Successfully With TaskName :"+" "+color.RMA_ChangeColor_Utility(DiaryTaskName, 2)+" "+"On Claimant :"+" "+color.RMA_ChangeColor_Utility(StrDefendant,4));							
			Thread.sleep(1000);
			RMA_GenericUsages_Utility.RMA_ConditionalFrameSwitching(DefaultFrameID);
			RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_Home.RMAApp_Generic_Img_ViewRecordDiaries(driver), "View Record Diaries Image On  Claimant :"+" "+StrDefendant, logval);
			RMA_Verification_Utility.RMA_VerifyUXSpinnerDisappered(logval);
			RMA_GenericUsages_Utility.RMA_ConditionalFrameSwitching(RMA_Selenium_POM_VerificationMessage.DiaryFrame);
			RMA_Verification_Utility.RMA_VerifyUXGridPartially_Utility("Claim:"+StrClaimNumber, "Diary UX Grid",new String[]{ "Task Name","Priority","Attach Record"},new String[]{ DiaryTaskName,"Important", "Defendant"}, logval);
