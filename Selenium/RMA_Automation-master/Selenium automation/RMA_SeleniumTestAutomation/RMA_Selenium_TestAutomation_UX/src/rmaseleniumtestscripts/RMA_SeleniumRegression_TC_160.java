...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_SeleniumRegression_TC_160
//Description    : Create,Edit And Delete Of Enhanced Notes On Vocational Rehabilitation Page
//Depends On TC  : RMA_SeleniumRegression_TC_059
//Revision       : 0.0 - ShrutiShruti-03-01-2018 
//======================================================================================================================================================================================================================================================================================

public class RMA_SeleniumRegression_TC_160 extends RMA_TC_BaseTest{
	@Test
	public void RMA_SeleniumRegression_TC_160_Test() throws Exception,Error{
		try{
			parentlogger = reports.startTest("RMA_SeleniumRegression_TC_160_Create,Edit And Delete Of Enhanced Notes On Vocational Rehabilitation Page", "Create,Edit And Delete Of Enhanced Notes On Vocational Rehabilitation Is Validated");
			...
			//==========================================================Steps To Create Vocational Rehabilitation Started Here====================================================================================================================================================================================================================================================
			RMA_GenericUsages_Utility.RMA_ConditionalFrameSwitching(DefaultFrameID);
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_Home.RMAApp_Unit_Img_VocationalRehab(driver), "Vocational Rehabilitation Image Lookup Button On Case Management Page", logval);
			parentlogger.log(LogStatus.INFO, "The Functional Utility :" +RMA_GenericUsages_Utility.RMA_LoggerHyperlink("VocationalRehabCreateEditDelete", "RMA_VocationalRehabilitationCreateEditDelete_Utility",0)+" Is Called To Create A Vocational Rehabilitation");
			testcall4 = true;
			VocatRehab=RMA_Functionality_Utility.RMA_VocationalRehabilitationCreateEditDelete_Utility("Early Intervention", "Open", "Ready To Work", VocRehabCreation_Txt_StartDate, VocRehabCreation_Txt_EndDate, logval1);
			loggerval4 = logger.toString();
			parentlogger.log(LogStatus.INFO,  "Existing Vocational Rehabilitation ,With OccupationProposed::"+ " " + color.RMA_ChangeColor_Utility(VocatRehab, 2)+ "Is Created");
			parentlogger.appendChild(logger);
			//==========================================================Steps To Create Vocational Rehabilitation Completed Here===================================================================================================================================================================================
		...
		catch(Exception|Error e)
		{
			...
			{
				logger.log(LogStatus.FAIL, "Following Error Occurred  ::" + " "+  color.RMA_ChangeColor_Utility(FinalErrorMessage,1)+ " " + "While Executing Following Function: " +" "+ "RMA_InjuruIllnessCreateEditDelete_Utility" + " " +  "And Hence The Test Case Is A Fail");
				parentlogger.appendChild(logger);
				reports.endTest(logger);	
			}
			...
			{
				logger.log(LogStatus.FAIL, "Following Error Occurred  ::" + " "+  color.RMA_ChangeColor_Utility(FinalErrorMessage,1)+ " " + "While Executing Following Function: " +" "+ "RMA_VocationalRehabAddition_Utility" + " " +  "And Hence The Test Case Is A Fail");
				parentlogger.appendChild(logger);
				reports.endTest(logger);	
			}
		...
		finally
		{
			try {
				if (!(RMA_Selenium_POM_EnhancedNotes.RMAApp_EnhancedNotes_Btn_Close(driver)== null)){
					...
					RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_Home.RMAApp_DefaultView_Lbl_BreadcrumbName(driver, "Policy"),StrClaimNumber +" Litigation Number Link At Top Of The Screen",logval);
					RMA_GenericUsages_Utility.RMA_ModelDialogHandler_Utility(driver, "Yes", logval);
					RMA_Verification_Utility.RMA_VerifyUXSpinnerDisappered(logval);
