...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_Reg_Maint_Employee_TC_046
//Description    : Verify That Page Cannot Be Found In Power View Message Must Be Displayed When User Has Removed Employee Maintenance Screen From Power View
//Depends On TC  : None
//Revision       : 0.0 - ShrutiShruti-02-23-2018 
//======================================================================================================================================================================================================================================================================================

public class RMA_Reg_Maint_Employee_TC_046 extends RMA_TC_BaseTest{
	@Test
	public void RMA_Reg_Maint_EMployee_TC_046_Test() throws Exception,Error{
		try{
			parentlogger = reports.startTest("RMA_Reg_Maint_Employee_TC_046_Verify Correct Validation Message in PowerView", "Page Cannot Be Found In Power View Message Must Be Displayed When User Has Removed Employee Maintenance Screen From Power View Is Validated");
			...
			StrScreenShotTCName = "RMA_Reg_Maint_Employee_TC_046";
			ErrorMessage = null;
			...
			RMA_Navigation_Utility.RMA_WebCheckBoxSelect_Utility(RMA_Selenium_POM_PowerView.RMAApp_PowerView_Chk_Entity(driver, "Employee Maintenance"), "uncheck", "Employee Maintenance CheckBox", "Power View Editor Page", logval);
			...
			//===============================================================Verification Of Validation Message On Employee Page==========================================================================================================================================
