...
//=====================================================================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_QTPRegression_TC_040
//Description    : Verify Reserve and Incurred Balance calculations with selection of checkbox 'Calculate Collections in Reserve Balance Per Reserve'
//Depends On TC  : None
//Revision       : 0.0 - AbhishekRai-09-15-2017
//===================================================================================================================================================================================================================================================================================================================================

public class RMA_QTPRegression_TC_040 extends RMA_TC_BaseTest {	
	@Test
	public void RMA_QTPRegression_TC_040_Test() throws Exception,Error {
		try{
			parentlogger = reports.startTest("RMA_QTPRegression_TC_040_Calculate Collections in Reserve Balance Per Reserve", "Verify Reserve and Incurred Balance calculations with selection of checkbox 'Calculate Collections in Reserve Balance Per Reserve'");
			
			//Region =====================================================Global Variable Initialization Is Started Here=====================================================================================================
			StrScreenShotTCName = null;
			StrScreenShotTCName = "RMA_QTPRegression_TC_040";
			testcall1 = false;	
			...
			LineOfBussinessParameterSetup_Lst_LOBType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_042", 1, 0); //LOB Type Is Fetched From DataSheet RMA_QTPRegression_TC_042
			GenClaimCreation_Txt_ClaimType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_040", 1, 1); //Claim Type Is Fetched From DataSheet RMA_QTPRegression_TC_040			
			GenClaimCreation_Txt_Department = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_040", 1, 2); //Department Is Fetched From DataSheet RMA_QTPRegression_TC_040
			GenClaimCreation_Txt_ClaimStatus =  ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_040", 1, 3); //Claim Status Is Fetched From DataSheet RMA_QTPRegression_TC_040
			ReserveCreation_Lst_ReserveStatus = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_040", 1, 4); // Reserve Status Is Fetched From DataSheet RMA_QTPRegression_TC_040
			ReserveCreation_Lst_ReserveType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_040", 1, 5); // Reserve Type Is Fetched From DataSheet RMA_QTPRegression_TC_040
			ReserveCreation_Txt_ReserveAmount = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_QTPRegression_TC_040", 1, 6);  //Reserve Amount Is Fetched From DataSheet RMA_QTPRegression_TC_040
			ReserveCreation_Lst_ReserveType_1 = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_040", 1, 7); // Reserve Type Is Fetched From DataSheet RMA_QTPRegression_TC_040
			ReserveCreation_Txt_ReserveAmount_1 = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_QTPRegression_TC_040", 1, 8);  //Reserve Amount Is Fetched From DataSheet RMA_QTPRegression_TC_040
			ReserveCreation_Lst_ReserveType_2 = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_040", 1, 9); // Reserve Type Is Fetched From DataSheet RMA_QTPRegression_TC_040
			ReserveCreation_Txt_ReserveAmount_2 = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_QTPRegression_TC_040", 1, 10);  //Reserve Amount Is Fetched From DataSheet RMA_QTPRegression_TC_040
			PaymentCreation_Lst_BankAccount = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_040", 1, 11); //Bank Account Is Fetched From DataSheet RMA_QTPRegression_TC_040
			PaymentCreation_Lst_PayeeType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_040", 1, 12); // Payee Type Is Fetched From DataSheet RMA_QTPRegression_TC_040
			PaymentCreation_Txt_LastName = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_040", 1, 13); //LastName Is Fetched From DataSheet RMA_QTPRegression_TC_040			
			PaymentCreation_Txt_DisType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_040", 1, 14); //Distribution Type Is Fetched From DataSheet RMA_QTPRegression_TC_040
			FundsSplitDetails_Txt_Amount = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_QTPRegression_TC_040", 1, 15); //Amount Is Fetched From DataSheet RMA_QTPRegression_TC_040
			FundsSplitDetails_Lst_TransactionType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_040", 1, 16); //Transaction Type Is Fetched From DataSheet RMA_QTPRegression_TC_040						
			...
			parentlogger.log(LogStatus.INFO, "New Expense Reserve Is Created With Type::" + " " + color.RMA_ChangeColor_Utility(ReserveCreation_Lst_ReserveType_2, 2) + " " + "And Amount::"+ " " + color.RMA_ChangeColor_Utility(String.valueOf(ReserveCreation_Txt_ReserveAmount_1),2) + " " + "And Claim Number::"+ " "+ color.RMA_ChangeColor_Utility(String.valueOf(StrClaimNumber), 2));
			loggerval3 = logger.toString();
			parentlogger.appendChild(logger);
			//EndRegion ==================================================Steps To Create Expense Reserve Is Completed Here=======================================================================================
			
			//Region =====================================================Steps To Create Indemnity Reserve  Is Started Here================================================================================================			
			parentlogger.log(LogStatus.INFO,"The Functional Utility :" +RMA_GenericUsages_Utility.RMA_LoggerHyperlink("ReserveCorpAddition","RMA_ReserveCorpAddition_Utility",2)+" Is Called To Create A Indemnity Reserve ");
			testcall4 = true;
			...
			String []ExpectedValueToBeVerifiedM={"$"+ ReserveCreation_Txt_ReserveAmount +".00", "$"+ FundsSplitDetails_Txt_Amount +".00", "$"+ FundsSplitDetails_Txt_Amount +".00", "$"+ReserveCreation_Txt_ReserveAmount+ ".00", ReserveCreation_Lst_ReserveStatus};
			String []ExpectedValueToBeVerifiedE={"$" + (ReserveCreation_Txt_ReserveAmount - FundsSplitDetails_Txt_Amount) + ".00", "$"+ FundsSplitDetails_Txt_Amount +".00", "$"+ FundsSplitDetails_Txt_Amount +".00", "$" + ReserveCreation_Txt_ReserveAmount + ".00", ReserveCreation_Lst_ReserveStatus};
			String []ExpectedValueToBeVerifiedI={"$" +  (ReserveCreation_Txt_ReserveAmount - FundsSplitDetails_Txt_Amount) + ".00", "$"+ FundsSplitDetails_Txt_Amount +".00", "$"+ FundsSplitDetails_Txt_Amount +".00", "$"+ ReserveCreation_Txt_ReserveAmount+ ".00", ReserveCreation_Lst_ReserveStatus};
			...
			{
				logger.log(LogStatus.FAIL, "Following Error Occurred  ::" + " "+  color.RMA_ChangeColor_Utility(FinalErrorMessage,1)+ " " + "While Executing Function Utility" +" "+ "RMA_ConditionalPaymentCorpAddition_Utility" + " " +  "To Create New Indemnity Reserve And Hence The Test Case Is A Fail");
				parentlogger.appendChild(logger);
				reports.endTest(logger);	
			}
			if (testcall6== true && loggerval6.equalsIgnoreCase("NotInitialized"))								
			{
				logger.log(LogStatus.FAIL, "Following Error Occurred  ::" + " "+  color.RMA_ChangeColor_Utility(FinalErrorMessage,1)+ " " + "While Executing Function Utility" +" "+ "RMA_ConditionalCollectionCorpAddition_Utility" + " " +  "To Create New Indemnity Reserve And Hence The Test Case Is A Fail");
				parentlogger.appendChild(logger);
				reports.endTest(logger);	
			}
