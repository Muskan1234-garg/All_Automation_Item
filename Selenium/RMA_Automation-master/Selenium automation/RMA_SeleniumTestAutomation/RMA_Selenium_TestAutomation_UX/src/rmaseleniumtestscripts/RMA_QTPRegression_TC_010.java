...
public class RMA_QTPRegression_TC_010 extends RMA_TC_BaseTest{
	@Test
	public void RMA_QTPRegression_TC_010_Test() throws Exception,Error {

		StrScreenShotTCName = null;
		StrScreenShotTCName = "RMA_QTPRegression_TC_010";
		testcall1 = false;	
		...
		try{   
			...
			parentlogger = reports.startTest("RMA_QTPRegression_TC_010_Duplicate_Payment_Criteria_8_Validation", "'8 - Payment Total, Invoice Number, and Trans Date within X Days' Duplicate Payment Criteria Is Validated ");
			...
			GenClaimCreation_Txt_DateOfEvent = RMA_GenericUsages_Utility.RMA_PastFutureDateInfo_Utility(0,-6,0,"MM/dd/yyyy");
			...
			Payment_Lst_PayeeType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_010", 1, 0); // Payee Type Is Fetched From DataSheet RMA_QTPRegression_TC_010
			FundsSplitDetails_Lst_TransactionType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_010", 1, 1); //Transaction Type Is Fetched From DataSheet RMA_QTPRegression_TC_010
			FundsSplitDetails_Txt_Amount = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_QTPRegression_TC_010", 1, 2); //Amount Is Fetched From DataSheet RMA_QTPRegression_TC_010
			Payment_Txt_LastName = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_010", 1, 3); //LastName Is Fetched From DataSheet RMA_QTPRegression_TC_010
			Payment_Txt_DisType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_010", 1, 4); //Distribution Type Is Fetched From DataSheet RMA_QTPRegression_TC_010
			ReserveType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_010", 1, 5); // Reserve Type Is Fetched From DataSheet RMA_QTPRegression_TC_010
			//Payment Data Fetched Is Completed Here

			GenClaimCreation_Txt_ClaimType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_010", 1, 6); //Claim Type Is Fetched From DataSheet RMA_QTPRegression_TC_010
			GenClaimCreation_Txt_ClaimStatus =  ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_010", 1,7 ); //Claim Status Is Fetched From DataSheet RMA_QTPRegression_TC_010
			GenClaimCreation_Txt_Department = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_010", 1,8 ); //Department Is Fetched From DataSheet RMA_QTPRegression_TC_010
			...
			rmaseleniumutilties_UX.RMA_Functionality_Utility.DuplicatePaymentCriteria_Utility("8 - Payment Total, Invoice Number, and Trans Date within X Days", logval);
			...
			parentlogger.log(LogStatus.INFO, "Following Function Is Called :: "+RMA_GenericUsages_Utility.RMA_LoggerHyperlink("UnsuccessfulPaymentAddition","RMA_UnsuccessfulPaymentCorpAddition_Utility",1)+" To Create Second Payment");
			testcall5 = true;
			RMA_Functionality_Utility.RMA_UnsuccessfulPaymentCorpAddition_Utility(Payment_Txt_BankAccount, Payment_Lst_PayeeType,ReserveType, FundsSplitDetails_Lst_TransactionType,FundsSplitDetails_Txt_Amount, Payment_Txt_LastName, Payment_Txt_DisType, "8 - Payment Total, Invoice Number, and Trans Date within X Days_FourthPayment", logval1);
			...
			{
				logger.log(LogStatus.FAIL, "Following Error Occurred  ::" + " "+  color.RMA_ChangeColor_Utility(FinalErrorMessage,1)+ " " + "While Executing Function Utility" +" "+ "RMA_ConditionalPaymentCorpAddition_Utility" + " " +  "To Create First Payment And Hence The Test Case Is A Fail");
				parentlogger.appendChild(logger);
				reports.endTest(logger);	
			}
			if (testcall3 == true && loggerval3.equalsIgnoreCase("NotInitialized"))								
			{
				logger.log(LogStatus.FAIL, "Following Error Occurred  ::" + " "+  color.RMA_ChangeColor_Utility(FinalErrorMessage,1)+ " " + "While Executing Function Utility" +" "+ "RMA_UnsuccessfulPaymentCorpAddition_Utility" + " " +  "To Create Second Unsuccessful Payment And Hence The Test Case Is A Fail");
				parentlogger.appendChild(logger);
				reports.endTest(logger);	
			}
			if (testcall4 == true && loggerval4.equalsIgnoreCase("NotInitialized"))								
			{
				logger.log(LogStatus.FAIL, "Following Error Occurred  ::" + " "+  color.RMA_ChangeColor_Utility(FinalErrorMessage,1)+ " " + "While Executing Function Utility" +" "+ "RMA_UnsuccessfulPaymentCorpAddition_Utility" + " " +  "To Create Third Unsuccessful Payment And Hence The Test Case Is A Fail");
				parentlogger.appendChild(logger);
				reports.endTest(logger);	
			}
			if (testcall5 == true && loggerval5.equalsIgnoreCase("NotInitialized"))								
			{
				logger.log(LogStatus.FAIL, "Following Error Occurred  ::" + " "+  color.RMA_ChangeColor_Utility(FinalErrorMessage,1)+ " " + "While Executing Function Utility" +" "+ "RMA_UnsuccessfulPaymentCorpAddition_Utility" + " " +  "To Create Fourth Unsuccessful Payment And Hence The Test Case Is A Fail");
				parentlogger.appendChild(logger);
				reports.endTest(logger);	
			}
