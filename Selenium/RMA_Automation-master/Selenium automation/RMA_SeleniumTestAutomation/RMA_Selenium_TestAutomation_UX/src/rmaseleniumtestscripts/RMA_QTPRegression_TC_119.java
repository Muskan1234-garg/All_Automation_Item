...
//==================================================================================================================================================================================
//TestCaseID   	 : RMA_QTPRegression_TC_119
//Description    : Making A Combined Payment And Normal Payment For Print Check Where Payee Address Details Being Entered At Funds Screen Itself Is Validated
//Depends On TC  : RMA_QTPRegression_TC_52_I For Creating Combined Payee
//Revision       : 0.0 - AnubhutiVyas-01-18-2017 
//========================================================================================================================================================================================
public class RMA_QTPRegression_TC_119 extends RMA_TC_BaseTest{

	@Test 
	public void RMA_QTPRegression_TC_119_Test() throws Exception, Error
	{
		testcall1 = false;	
		...
		StrScreenShotTCName = "RMA_QTPRegression_TC_119";
		...
		try {
			parentlogger = reports.startTest("RMA_QTPRegression_TC_119_Combined Payment And Normal Payment For Print Check", "Making A Combined Payment And Normal Payment For Print Check Where Payee Address Details Being Entered At Funds Screen Itself Is Validated");
			...
			String EntityPaymntAddress_Txt_Addr1;
			String EntityPaymntAddress_Txt_Addr2;
			String EntityPaymntAddress_Txt_Addr3;
			String EntityPaymntAddress_Txt_Addr4;
			String EntityPaymntAddress_Txt_City;
			String EntityPaymntAddress_Txt_County;
			int EntityPaymntAddress_Txt_ZipCode;
			...
			EntityPaymntAddress_Txt_Addr1 = RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(4, "Address1_");
			EntityPaymntAddress_Txt_Addr2 = RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(4, "Address2_");	
			EntityPaymntAddress_Txt_Addr3 = RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(4, "Address3_");	
			EntityPaymntAddress_Txt_Addr4 = RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(4, "Address4_");	
 			EntityPaymntAddress_Txt_City = RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(4, "City_");
 			EntityPaymntAddress_Txt_County = RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(4, "County_");
			EntityPaymntAddress_Txt_ZipCode = RMA_GenericUsages_Utility.RMA_RandomIntGeneration_Utility(100000000,999999999);
			...
			GenClaimCreation_Txt_ClaimType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_119", 1, 7); //Claim Type Is Fetched From DataSheet RMA_QTPRegression_TC_119
			GenClaimCreation_Txt_ClaimStatus =  ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_119", 1,8 ); //Claim Status Is Fetched From DataSheet RMA_QTPRegression_TC_119
			GenClaimCreation_Txt_Department = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_119", 1,9); //Department Is Fetched From DataSheet RMA_QTPRegression_TC_119
			//Claim Data Fetch From Excel WorkBook Is Completed Here
			
			PaymentCreation_Lst_PayeeType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_119", 1, 1); // Payee Type Is Fetched From DataSheet RMA_QTPRegression_TC_119
			FundsSplitDetails_Lst_TransactionType= ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_119", 1,2); //Transaction Type For Medical Reserve Payment Is Fetched From DataSheet RMA_QTPRegression_TC_119
			FundsSplitDetails_Txt_Amount = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_QTPRegression_TC_119", 1, 3); //Medical Amount Is Fetched From DataSheet RMA_QTPRegression_TC_119
			PaymentCreation_Txt_LastName = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_119", 1, 4); //LastName Is Fetched From DataSheet RMA_QTPRegression_TC_119
			PaymentCreation_Txt_DisType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_119", 1, 5); //Distribution Type Is Fetched From DataSheet RMA_QTPRegression_TC_119
			PaymentCreation_Lst_ReserveType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_119", 1, 6); // Medical Reserve Type Is Fetched From DataSheet RMA_QTPRegression_TC_119
			...
			testcall1 = true;
			RMA_Functionality_Utility.RMA_Suite06_Utility("RMA_QTPRegression_TC_118", logval1);//General System Parameter & Payment Parameter Settings Are Done
			...
			parentlogger.log(LogStatus.INFO, "Following Function Is Called :: "+RMA_GenericUsages_Utility.RMA_LoggerHyperlink("PaymentAddition","RMA_ConditionalPaymentCorpAddition_Utility",0)+" To Create New Payment");
			testcall6 = true;
			StrControlNumber_4 = RMA_Functionality_Utility.RMA_ConditionalPaymentCorpAddition_Utility(RMA_QTPRegression_TC_052_I.BankAccount_Txt_AccountName, PaymentCreation_Lst_PayeeType,PaymentCreation_Lst_ReserveType, FundsSplitDetails_Lst_TransactionType,FundsSplitDetails_Txt_Amount, PaymentCreation_Txt_LastName, PaymentCreation_Txt_DisType,"MultipleSplits_QTP_Suite07","AddEntityAddress",logval1);
			...
			parentlogger.appendChild(logger);
			RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_PaymentsCollections.RMAApp_PaymentCollection_Tab_Transaction(driver), "Transaction Tab On Payment Creation Page",logval);// Transaction Tab On Payment Creation Page Is Clicked
			RMA_Input_Utility.RMA_SetValue_Utility(RMA_Selenium_POM_PaymentsCollections.RMAApp_PaymentCollection_Txt_Address1(driver), "Address1 TextBox On Payment Page", EntityPaymntAddress_Txt_Addr1, logval);
			RMA_Input_Utility.RMA_SetValue_Utility(RMA_Selenium_POM_PaymentsCollections.RMAApp_PaymentCollection_Txt_Address2(driver), "Address2 TextBox On Payment Page", EntityPaymntAddress_Txt_Addr2, logval);
			RMA_Input_Utility.RMA_SetValue_Utility(RMA_Selenium_POM_PaymentsCollections.RMAApp_PaymentCollection_Txt_Address3(driver), "Address3 TextBox On Payment Page", EntityPaymntAddress_Txt_Addr3, logval);
			RMA_Input_Utility.RMA_SetValue_Utility(RMA_Selenium_POM_PaymentsCollections.RMAApp_PaymentCollection_Txt_Address4(driver), "Address4 TextBox On Payment Page", EntityPaymntAddress_Txt_Addr4, logval);
			RMA_Input_Utility.RMA_SetValue_Utility(RMA_Selenium_POM_PaymentsCollections.RMAApp_PaymentCollection_Txt_City(driver), "City TextBox On Payment Page", EntityPaymntAddress_Txt_City, logval);
			// Data Is Entered In Address1,Address2,Address3,Address4,City Fields On Address Tab

			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_PaymentsCollections.RMAApp_PaymentCollection_Btn_State(driver), "State Code Look Up Button On Payment Page",logval);
			RMA_Navigation_Utility.RMA_WebPartialLinkSelect("Alabama", "State Link On State Selection Window", logval);
			RMA_GenericUsages_Utility.RMA_StaticWait(5, logval, "Wait Is Added As State Is Selected On Payment Page");
			// Data Is Entered In State Field Of Address Tab

			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_PaymentsCollections.RMAApp_PaymentCollection_Btn_Country(driver), "Country Code Look Up Button On Payment Page",logval);
			RMA_Navigation_Utility.RMA_WebPartialLinkSelect("United States", "Country Link On Country Selection Window", logval);
			RMA_GenericUsages_Utility.RMA_StaticWait(5, logval, "Wait Is Added As Country Is Selected On Payment Page");
			// Data Is Entered In Country Field Of Address Tab

			RMA_Input_Utility.RMA_SetValue_Utility(RMA_Selenium_POM_PaymentsCollections.RMAApp_PaymentCollection_Txt_County(driver), "County TextBox On Payment Page", EntityPaymntAddress_Txt_County, logval);
			RMA_Input_Utility.RMA_SetValue_Utility(RMA_Selenium_POM_PaymentsCollections.RMAApp_PaymentCollection_Txt_Zip(driver), "Zip/Postal Code TextBox On Payment Page", String.valueOf(EntityPaymntAddress_Txt_ZipCode), logval);
			// Data Is Entered In County & ZipCode Field Of Address Tab

			RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_Home.RMAApp_Generic_Img_Save(driver), "Save Image On Payment Page", logval);// Save Button Is Clicked
			RMA_GenericUsages_Utility.RMA_StaticWait(5, logval, "Wait Is Added As Save Is Clicked On Payment Page");
			//RMA_Functionality_Utility.RMA_GenericSave_Utility(FrameID, false, "NA",  "Maintenance--> Page", logval);
			RMA_Verification_Utility.RMA_TextCompare(ExpCheckStatus, RMA_Selenium_POM_PaymentsCollections.RMAApp_Payment_Txt_CheckStatus(driver).getAttribute("value"),"Check Status Value", logval);
			//RMA_Verification_Utility.RMA_TextCompare(EntityPaymntAddress_Txt_Addr1, RMA_Selenium_POM_PaymentsCollections.RMAApp_PaymentCollection_Txt_Address1(driver).getAttribute("value"),"Address 1 Value", logval);
			RMA_Verification_Utility.RMA_TextCompare(EntityPaymntAddress_Txt_Addr2, RMA_Selenium_POM_PaymentsCollections.RMAApp_PaymentCollection_Txt_Address2(driver).getAttribute("value"),"Address 2 Value", logval);
			RMA_Verification_Utility.RMA_TextCompare(EntityPaymntAddress_Txt_Addr3, RMA_Selenium_POM_PaymentsCollections.RMAApp_PaymentCollection_Txt_Address3(driver).getAttribute("value"),"Address 3 Value", logval);
			RMA_Verification_Utility.RMA_TextCompare(EntityPaymntAddress_Txt_Addr4, RMA_Selenium_POM_PaymentsCollections.RMAApp_PaymentCollection_Txt_Address4(driver).getAttribute("value"),"Address 4 Value", logval);
			...
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_PaymentsCollections.RMAApp_PaymentCollection_Btn_State(driver), "State Code Look Up Button On Payment Page",logval);
			RMA_Navigation_Utility.RMA_WebPartialLinkSelect("Alaska", "State Link On State Selection Window", logval);
			RMA_GenericUsages_Utility.RMA_StaticWait(5, logval, "Wait Is Added As State Is Selected On Payment Page");
			// Data Is Entered In State Field Of Address Tab
			...
			ContentToBeVerified=new Object[]{StrClaimNumber,StrControlNumber_1,StrControlNumber_2,StrControlNumber_3,StrControlNumber_4,StrControlNumber_5,RMA_QTPRegression_TC_052_I.BankAccount_Txt_AccountName, RMA_QTPRegression_TC_052_I.CombinedPayee_Txt_LastName,PaymentCreation_Txt_LastName};
			...
			{
				logger.log(LogStatus.FAIL, "Following Error Occurred  ::" + " "+  color.RMA_ChangeColor_Utility(FinalErrorMessage,1)+ " " + "While Executing Function For Making Fourth Payment" +" "+ "" + "RMA_ConditionalPaymentCorpAddition_Utility " +  "And Hence The Test Case Is A Fail");
				parentlogger.appendChild(logger);
				reports.endTest(logger);	
			}
			if (testcall7== true && loggerval7.equalsIgnoreCase("NotInitialized"))								
			{
				logger.log(LogStatus.FAIL, "Following Error Occurred  ::" + " "+  color.RMA_ChangeColor_Utility(FinalErrorMessage,1)+ " " + "While Executing Function For Making Fifth Payment" +" "+ "" + "RMA_ConditionalPaymentCorpAddition_Utility " +  "And Hence The Test Case Is A Fail");
				parentlogger.appendChild(logger);
				reports.endTest(logger);	
			}
