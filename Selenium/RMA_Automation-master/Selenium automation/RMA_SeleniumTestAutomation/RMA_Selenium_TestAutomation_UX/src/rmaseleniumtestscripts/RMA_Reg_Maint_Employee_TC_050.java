...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_Reg_Maint_Employee_TC_050
//Description    : Verify The Correct Validation When User Click ToolBar Button Of A Record Without Saving It
//Depends On TC  : None
//Revision       : 0.0 - ShrutiShruti-02-20-2018 
//======================================================================================================================================================================================================================================================================================

public class RMA_Reg_Maint_Employee_TC_050 extends RMA_TC_BaseTest{
	@Test
	public void RMA_Reg_Maint_Employee_TC_050_Test() throws Exception,Error{
		try{
			parentlogger = reports.startTest("RMA_Reg_Maint_Employee_TC_050_Correct Validation For ToolBar Clicks Without Saving Record", "Correct Validation When User Click ToolBar Button Without Saving A Record Is Validated");
			...
			StrScreenShotTCName = "RMA_Reg_Maint_Employee_TC_050";
			ErrorMessage = null;
			DefaultFrameID = null;
			...
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_Home.RMAApp_GenericClaim_Btn_RecordSummary(driver), "Record Summary Image Button On Violation Creation Page", logval);
			RMA_Verification_Utility.RMA_VerifyUXMessage("You are working on a new record and this functionality is available for existing records only. Please save the data and try again.", true, "Violation Creation Page", logval);
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_Home.RMAApp_Generic_Img_DeleteRecord(driver), "Delete Record Image Button On Violation Creation Page", logval);
			RMA_Verification_Utility.RMA_VerifyUXMessage("You are working on a new record and this functionality is available for existing records only. Please save the data and try again.", true, "Violation Creation Page", logval);
			//Verification Of Validation Message When ToolBar Buttons Are Clicked Without Saving Violation
			...
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_Home.RMAApp_Generic_Img_DeleteRecord(driver), "Delete Record Button On Banking Information Creation Page", logval);
			RMA_Verification_Utility.RMA_VerifyUXMessage("You are working on a new record and this functionality is available for existing records only. Please save the data and try again.", true, "Banking Infomation Creation Page", logval);
			//Verification Of Validation Message When ToolBar Buttons Are Clicked Without Saving Banking Information
			...
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_Home.RMAApp_GenericClaim_Btn_RecordSummary(driver), "Record Summary Image Button On Dependents Creation Page", logval);
			RMA_Verification_Utility.RMA_VerifyUXMessage("You are working on a new record and this functionality is available for existing records only. Please save the data and try again.", true, "Dependents Creation Page", logval);
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_Home.RMAApp_Generic_Img_DeleteRecord(driver), "Delete Record Image Button On Dependents Creation Page", logval);
			RMA_Verification_Utility.RMA_VerifyUXMessage("You are working on a new record and this functionality is available for existing records only. Please save the data and try again.", true, "Dependents Creation Page", logval);
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_Home.RMAApp_GenericClaim_Btn_Diary(driver), "Diary Image Button On Dependents Creation Page", logval);
			RMA_Verification_Utility.RMA_VerifyUXMessage("You are working on a new record and this functionality is available for existing records only. Please save the data and try again.", true, "Dependents Creation Page", logval);
			//Verification Of Validation Message When ToolBar Buttons Are Clicked Without Saving Dependents
		}
