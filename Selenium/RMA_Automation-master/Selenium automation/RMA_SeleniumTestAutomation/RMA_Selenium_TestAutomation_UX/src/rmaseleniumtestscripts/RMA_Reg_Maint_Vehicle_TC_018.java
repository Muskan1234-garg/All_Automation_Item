...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_Reg_Maint_Vehicle_TC_018
//Description    : Verify Child Menu Inspections Is Working As Per Changes In PowerView On Vehicle Creation Page IS Validated
//Depends On TC  : None
//Revision       : 0.0 - NikitaThani-03-07-2018 
//======================================================================================================================================================================================================================================================================================

public class RMA_Reg_Maint_Vehicle_TC_018 extends RMA_TC_BaseTest {
	@Test
	public void RMA_Reg_Maint_Vehicle_PowerView_TC_018_Test() throws Exception, Error
	{ 
		try{
			parentlogger = reports.startTest("RMA_Reg_Maint_Vehicle_PowerView_TC_018_Verify Inspections Is Working As Per Changes In PV On Vehicle Screen", "Verify Child Menu Inspections Is Working As Per Changes In PowerView Editor Vehicle Screen Is Validated");
			parentlogger.assignAuthor("Nikita Thani");
			
			StrScreenShotTCName = "RMA_Reg_Maint_Vehicle_PowerView_TC_018";
			...
			RMAApp_Login_Txt_UserName = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_Reg_Maint_Vehicle_PV_TC_018", 1, 0); //UserName Fetched From DataSheet RMA_Reg_Maint_Vehicle_PV_TC_018
			RMAApp_Login_Txt_Password = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_Reg_Maint_Vehicle_PV_TC_018", 1, 1); //Password Fetched From DataSheet RMA_Reg_Maint_Vehicle_PV_TC_018
			RMAApp_Login_Txt_UserName1 = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_Reg_Maint_Vehicle_PV_TC_018", 1, 2); //UserName Fetched From DataSheet RMA_Reg_Maint_Vehicle_PV_TC_018
			RMAApp_Login_Txt_Password1 = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_Reg_Maint_Vehicle_PV_TC_018", 1, 3); //Password Fetched From DataSheet RMA_Reg_Maint_Vehicle_PV_TC_018
			RMAApp_SMS_Lst_DataSourceName = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_Reg_Maint_Vehicle_PV_TC_018", DSRow, 4); //Data Source Name Is Fetched From DataSheet RMA_Reg_Maint_Vehicle_PV_TC_018			
			...
			globalWait.until(ExpectedConditions.visibilityOf((RMA_Selenium_POM_PowerView.RMAApp_PowerView_Lbl_Entity(driver, "Vehicle Inspection Data"))));			
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_PowerView.RMAApp_PowerView_Lbl_Entity(driver, "Vehicle Inspection Data"), "Vehicle Inspection Data Label On Power View Editor Page", logval1);
			...
			RMA_GenericUsages_Utility.RMA_MultipleWindowSwitching_Utility(3, "NA", "NA", "NA", "NA", "NA", "Maintenance Window", logval);
			...
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_Home.RMAApp_GenericBtn_EnityAdd(driver,"Inspections"), "Inspections On Vehicle Creation Page", logval1);
