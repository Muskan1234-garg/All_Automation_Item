...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_Reg_Maint_Vehicle_TC_021
//Description    : Delete SMS Permission From Vehicle Maintenance Is Validated
//Depends On TC  : None
//Revision       : 0.0 - JannathHussain-03-08-2018 
//======================================================================================================================================================================================================================================================================================

public class RMA_Reg_Maint_Vehicle_TC_021 extends rmaseleniumtestscripts.RMA_TC_BaseTest  {
	@Test	
	public void RMA_Reg_Maint_Vehicle_TC_021_Test() throws Exception, Error
	{   
		try {	 	 
			parentlogger = reports.startTest("RMA_Reg_Maint_Vehicle_TC_021_Delete SMS Permission Setting For Vehicle Is Validation", "Functionality of Delete For Vehicle Permission Setting On Security Management System Is Validated");
			parentlogger.assignAuthor("Jannath Hussain");
			StrScreenShotTCName = "RMA_Reg_Maint_Vehicle_TC_021";
			...
			RMAApp_SMS_Lnk_DataSourceName = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_Reg_Maint_Vehicle_TC_021", 4, 0); //Data Source Name Is Fetched From DataSheet RMA_Reg_Maint_Vehicle_TC_021
			RMAApp_Login_Txt_UserName = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_Reg_Maint_Vehicle_TC_021", 1, 1); //UserName Fetched From DataSheet RMA_Reg_Maint_Vehicle_TC_021
			RMAApp_Login_Txt_Password = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_Reg_Maint_Vehicle_TC_021", 1, 2); //Password Fetched From DataSheet RMA_Reg_Maint_Vehicle_TC_021
            RMAApp_SMS_Lnk_ModuleSecurityGroup = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_Reg_Maint_Vehicle_TC_021", 1, 3); //Module Security Group Name Is Fetched From DataSheet RMA_Reg_Maint_Vehicle_TC_021
			RMAApp_SMS_Lnk_ModuleAccessPermission = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_Reg_Maint_Vehicle_TC_021", 1, 4); //Module Access Permission Name Is Fetched From DataSheet RMA_Reg_Maint_Vehicle_TC_021
			...
			RMA_Navigation_Utility.RMA_ObjectClick(rmaseleniumPOM_UX.RMA_Selenium_POM_Vehicle.RMAApp_Vehicle_SMS_Delete(driver, "Delete"),"Click On Delete From Module Access Permission On Security Management System Page",logval);
			...
			RMA_Verification_Utility.RMA_VerifyUXSpinnerDisappered(logval);
			RMA_GenericUsages_Utility.RMA_StaticWait(3, logval, "Wait Is Added To Loader Gets Disappeared");
			...
			//===========================================================Click And Navigate To Vehicle Maintenance Is Started Here==================================================================================================================================================================================================================================================================================================================================================================
			...
			//===========================================================Click And Navigate To Vehicle Maintenance Is Completed Here==================================================================================================================================================================================================================================================================================================================================================================

			//==============================================Verification Of Delete Button From Vehicle Is Started======================================================================================================================================
			RMA_NegativeVerification_Utility.RMA_ElementNotExist_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_RMAAppText(driver,"Delete"), "Delete Vehicle Is Not Possible Because Delete Image On Vehicle Screen", logval);
			RMA_GenericUsages_Utility.RMA_StaticWait(3, logval, "Wait Is Added To Check Delete Button From Vehicle");
			RMA_GenericUsages_Utility.RMA_WebPageRefresh_Utility_UX(logval);
			//===============================================Verification Of Delete Button From Vehicle Is Completed=======================================================================================================================

			//===========================================================Revert Delete Permission Is Started Here==============================================================================================================================================================================================================================================================================================================================================================================================================================================================
			driver.switchTo().window(StrRMAWindowHandle);
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_Login_DSNSelect_Frames.RMAApp_Dashboard_Lbl_SMS(driver), "Security Management System Navigation Option Label On RiskMaster Application's Dashboard Page",logval);
			RMA_GenericUsages_Utility.RMA_WindowSwitchingBasedOnTitle("Riskmaster Security");
			RMA_Verification_Utility.RMA_VerifyUXSpinnerDisappered(logval);
			...
			RMA_Verification_Utility.RMA_VerifyUXSpinnerDisappered(logval);
			//===========================================================Revert Delete Permission Is Completed Here==============================================================================================================================================================================================================================================================================================================================================================================================================================================================	
