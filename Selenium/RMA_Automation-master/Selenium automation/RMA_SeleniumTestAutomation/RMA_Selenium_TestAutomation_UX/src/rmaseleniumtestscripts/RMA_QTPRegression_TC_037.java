...
//=====================================================================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_QTPRegression_TC_037
//Description    : Verify Incurred Handling Options : Add settings for Recovery Reserves to add their Recovery Reserve Balances to the Total Claim Reserve Balance or subtract their Recovery Reserve Balances from the Total Claim Reserve Balance
//Depends On TC  : None
//Revision       : 0.0 - AbhishekRai-08-18-2017
//===================================================================================================================================================================================================================================================================================================================================

public class RMA_QTPRegression_TC_037 extends RMA_TC_BaseTest {	
	@Test
	public void RMA_QTPRegression_TC_037_Test() throws Exception,Error {
		try{ 
			parentlogger = reports.startTest("RMA_QTPRegression_TC_037_Add settings for Recovery Reserves to add their Recovery Reserve Balances to the Total Claim Reserve Balance", " Verify Incurred Handling Options : Add settings for Recovery Reserves to add their Recovery Reserve Balances to the Total Claim Reserve Balance or subtract their Recovery Reserve Balances from the Total Claim Reserve Balance ");
			parentlogger.assignAuthor("Abhishek Rai");
			
			//Region =====================================================Global Variable Initialization Is Started Here=====================================================================================================
			StrScreenShotTCName = null;
			StrScreenShotTCName = "RMA_QTPRegression_TC_037";
			testcall1 = false;	
			...
			LineOfBussinessParameterSetup_Lst_LOBType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_037", 1, 0); //LOB Type Is Fetched From DataSheet RMA_QTPRegression_TC_037
			GenClaimCreation_Txt_ClaimType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_037", 1, 1); //Claim Type Is Fetched From DataSheet RMA_QTPRegression_TC_037			
			GenClaimCreation_Txt_Department = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_037", 1, 2); //Department Is Fetched From DataSheet RMA_QTPRegression_TC_037
			GenClaimCreation_Txt_ClaimStatus =  ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_037", 1, 3); //Claim Status Is Fetched From DataSheet RMA_QTPRegression_TC_037
			ReserveCreation_Lst_ReserveStatus = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_037", 1, 4); // Reserve Status Is Fetched From DataSheet RMA_QTPRegression_TC_037
			ReserveCreation_Lst_ReserveType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_037", 1, 5); // Reserve Type Is Fetched From DataSheet RMA_QTPRegression_TC_037
			ReserveCreation_Txt_ReserveAmount = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_QTPRegression_TC_037", 1, 6);  //Reserve Amount Is Fetched From DataSheet RMA_QTPRegression_TC_037
			ReserveCreation_Lst_ReserveType_1 = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_037", 1, 7); // Reserve Type_1 Is Fetched From DataSheet RMA_QTPRegression_TC_037
			ReserveCreation_Txt_ReserveAmount_1 = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_QTPRegression_TC_037", 1, 8);  //Reserve Amount_1 Is Fetched From DataSheet RMA_QTPRegression_TC_037
			ReserveCreation_Lst_ReserveType_2 = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_037", 1, 9); // Reserve Type_2 Is Fetched From DataSheet RMA_QTPRegression_TC_037
			ReserveCreation_Txt_ReserveAmount_2 = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_QTPRegression_TC_037", 1, 10);  //Reserve Amount_2 Is Fetched From DataSheet RMA_QTPRegression_TC_037
			...
			rmaseleniumutilties_UX.RMA_Functionality_Utility.RMA_Suite20_Check_Utility("RMA_QTPRegression_TC_037_01",LineOfBussinessParameterSetup_Lst_LOBType,"NA", "NA", logval);			
			...
			rmaseleniumutilties_UX.RMA_Functionality_Utility.RMA_Suite20_Check_Utility("RMA_QTPRegression_TC_037_02",LineOfBussinessParameterSetup_Lst_LOBType, "NA", "NA", logval);	
			driver.close();
			RMA_GenericUsages_Utility.RMA_WindowSwitching_Utility_NonUX();	
			...
			//Region =====================================================Steps To Revert Reserve Options Settings Is Started Here=============================================================
			RMA_GenericUsages_Utility.RMA_Non_UXNavigation(true); 			
			...
			RMA_GenericUsages_Utility.RMA_Non_UX_Dashboard_Navigation(logval);
			RMA_GenericUsages_Utility.RMA_WindowSwitching_Utility_NonUX();	
			//Region =====================================================Steps To Revert Reserve Options Settings Is Completed Here=============================================================
		} 
