...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_QTPRegression_TC_044
//Description    : Date/Time Validations For Worker's Compensation Claims When Time Zone Is Enabled For Org Level: Client & Time Zone Is CST
//Depends On TC  : None
//Revision       : 0.0 - AnubhutiVyas-11-01-2017 
//======================================================================================================================================================================================================================================================================================
public class RMA_QTPRegression_TC_044 extends RMA_TC_BaseTest {

	@Test
	public void RMA_QTPRegression_TC_044_Test() throws Exception,Error {


		try{
			parentlogger = reports.startTest("RMA_QTPRegression_TC_044_Date Time Validations For Worker's Claim Creation For Time Zone CST", "Date/Time Validations For Worker's Compensation Claims When Time Zone Is Enabled For Org Level: Client & Time Zone Is CST");
			parentlogger.assignAuthor("Anubhuti Vyas");

			StrScreenShotTCName = null;
			StrScreenShotTCName = "RMA_QTPRegression_TC_044";
			testcall1 = false;	
			...
			MaintOrgHierarchy_Txt_TimeZone = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_034", 1,7); //Time Zone Is Fetched From DataSheet RMA_QTPRegression_TC_034
