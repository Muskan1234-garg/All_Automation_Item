...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_SeleniumRegression_TC_157
//Description    : Create,Edit And Delete Of Enhanced Notes On Accommodations Page
//Depends On TC  : RMA_SeleniumRegression_TC_059
//Revision       : 0.0 - ShrutiShruti-03-01-2018 
//======================================================================================================================================================================================================================================================================================

public class RMA_SeleniumRegression_TC_157 extends RMA_TC_BaseTest{
	@Test
	public void RMA_SeleniumRegression_TC_157_Test() throws Exception,Error{
		parentlogger = reports.startTest("RMA_SeleniumRegression_TC_157_Create,Edit And Delete Of Enhanced Notes On Accommodations Page", "Create,Edit And Delete Of Enhanced Notes On Accommodations Is Validated");
		...
		try{
			...
			StrScreenShotTCName = "RMA_SeleniumRegression_TC_098";
			ErrorMessage = null;
			CurrentFrameID=null;
