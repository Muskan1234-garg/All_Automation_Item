...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_QTPRegression_TC_074
//Description    : Payment For Claimant Using Sub Bank Account  Is Validated
//Depends On TC  : None
//Revision       : 0.0 - AbhishekRai-10-05-2017 
//======================================================================================================================================================================================================================================================================================
public class RMA_QTPRegression_TC_074 extends RMA_TC_BaseTest {

	@Test
	public void RMA_QTPRegression_TC_074_Test() throws Exception,Error {

		try{
			parentlogger = reports.startTest("RMA_QTPRegression_TC_074_Payment For Claimant Using Sub Bank Account", "Payment For Claimant Using Sub Bank Account Is Validated");
			...
			StrScreenShotTCName = "RMA_QTPRegression_TC_074";
			ErrorMessage = null;
			CurrentFrameID=null;
			...
			PaymentCreation_Lst_BankAccount = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_074", 1, 0); //Bank Account Is Fetched From DataSheet RMA_QTPRegression_TC_074
			PaymentCreation_Lst_PayeeType =  ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_074", 1, 1); //Payee Type Is Fetched From DataSheet RMA_QTPRegression_TC_074
			ReserveCreation_Lst_ReserveType= ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_074", 1, 2); //Reserve Type Is Fetched From DataSheet RMA_QTPRegression_TC_074
			FundsSplitDetails_Lst_TransactionType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_074", 1, 3); //Transaction Type Is Fetched From DataSheet RMA_QTPRegression_TC_074
			FundsSplitDetails_Txt_Amount = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_QTPRegression_TC_074", 1, 4); //Amount Is Fetched From DataSheet RMA_QTPRegression_TC_074			
			PaymentCreation_Txt_DisType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_074", 1, 5); //DisType Is Fetched From DataSheet RMA_QTPRegression_TC_074			
