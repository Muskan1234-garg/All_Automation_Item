...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_Reg_Maint_Employee_TC_037
//Description    : Verify That Field Becomes ReadOnly When User Enables Read Only Flag Via UX PowerView On Employee Maintenance
//Depends On TC  : None
//Revision       : 0.0 - ShrutiShruti-02-28-2018 
//======================================================================================================================================================================================================================================================================================

public class RMA_Reg_Maint_Employee_TC_037 extends RMA_TC_BaseTest{
	@Test
	public void RMA_Reg_Maint_Employee_TC_037_Test() throws Exception,Error{
		try{
			parentlogger = reports.startTest("RMA_Reg_Maint_Employee_TC_037_Verify That Field Becomes ReadOnly By Flag On PV", "Field Becomes ReadOnly When User Enables Read Only Flag Via UX PowerView On Employee Page Is Validated");
			...
			StrScreenShotTCName = "RMA_Reg_Maint_Employee_TC_037";
			ErrorMessage = null;
			...
			RMA_Verification_Utility.RMA_ElementExist_Utility(RMA_Selenium_POM_Employee.RMAApp_Employee_Chk_FreezePayment(driver),"Freeze Paymnet CheckBox On Employee Creation Page", logval);
			RMA_Verification_Utility.RMA_EnbDisbStateVerify_Utility(RMA_Selenium_POM_Employee.RMAApp_Employee_Chk_FreezePayment(driver), "enable", "Freeze Payment CheckBox On Employee Creation Page", logval);
			//Verification For Freeze Payment CheckBox Is Done
			...
			globalWait.until(ExpectedConditions.visibilityOf(RMA_Selenium_POM_PowerView.RMAApp_PowerView_Lbl_FieldDelete(driver, "Freeze Payment")));
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_PowerView.RMAApp_PowerView_Lbl_FieldDelete(driver, "Freeze Payment"),"Freeze Payment Label On Power View Editor Page", logval);
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_PowerView.RMAApp_PowerView_ToggleBtn_ReadOnlyField(driver), "Read Only Flag Toggle Button On Power View Editor Page", logval);
			...
			//==========================================================Changes Made In Power View Editor Completed Here=======================================================================================================================================
			...
			RMA_GenericUsages_Utility.RMA_DynamicFrameSwitching(RMA_Selenium_POM_VerificationMessage.EmployeeFrame);
			RMA_Verification_Utility.RMA_EnbDisbStateVerify_Utility(RMA_Selenium_POM_Employee.RMAApp_Employee_Chk_FreezePayment(driver), "diable", "Freeze Paymment CheckBox On Employee Creation Page", logval);
			driver.close();
			//Verification Is Done After Changes In Power View Editor
