...
//=====================================================================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_QTPRegression_TC_008
//Description    : '3 - From and To Date Range' Duplicate Payment Criteria Is Validated 
//Revision       : 0.0 - AnubhutiVyas-07-25-2017
//===================================================================================================================================================================================================================================================================================================================================

public class RMA_QTPRegression_TC_008 extends RMA_TC_BaseTest {	
	@Test
	public void RMA_QTPRegression_TC_008_Test() throws Exception,Error {

		StrScreenShotTCName = null;
		StrScreenShotTCName = "RMA_QTPRegression_TC_008";
		testcall1 = false;	
		...
		try{    
			...
			parentlogger = reports.startTest("RMA_QTPRegression_TC_008_Duplicate_Payment_Criteria_3_Validation", "'3 - From and To Date Range' Duplicate Payment Criteria Is Validated ");
			...
			Payment_Lst_PayeeType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_008", 1, 0); // Payee Type Is Fetched From DataSheet RMA_QTPRegression_TC_008
			FundsSplitDetails_Lst_TransactionType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_008", 1, 1); //Transaction Type Is Fetched From DataSheet RMA_QTPRegression_TC_008
			FundsSplitDetails_Txt_Amount = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_QTPRegression_TC_008", 1, 2); //Amount Is Fetched From DataSheet RMA_QTPRegression_TC_008
			Payment_Txt_LastName = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_008", 1, 3); //LastName Is Fetched From DataSheet RMA_QTPRegression_TC_008
			Payment_Txt_DisType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_008", 1, 4); //Distribution Type Is Fetched From DataSheet RMA_QTPRegression_TC_008
			ReserveType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_008", 1, 5); // Reserve Type Is Fetched From DataSheet RMA_QTPRegression_TC_008
			//Payment Data Fetched Is Completed Here

			GenClaimCreation_Txt_ClaimType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_008", 1, 6); //Claim Type Is Fetched From DataSheet RMA_QTPRegression_TC_008
			GenClaimCreation_Txt_ClaimStatus =  ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_008", 1,7 ); //Claim Status Is Fetched From DataSheet RMA_QTPRegression_TC_008
			GenClaimCreation_Txt_Department = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_008", 1,8 ); //Department Is Fetched From DataSheet RMA_QTPRegression_TC_008
			...
			rmaseleniumutilties_UX.RMA_Functionality_Utility.DuplicatePaymentCriteria_Utility("3 - From and To Date Range", logval);
			...
			testcall2 = true;
			StrControlNumber = RMA_Functionality_Utility.RMA_ConditionalPaymentCorpAddition_Utility(Payment_Txt_BankAccount, Payment_Lst_PayeeType,ReserveType, FundsSplitDetails_Lst_TransactionType,FundsSplitDetails_Txt_Amount, Payment_Txt_LastName, Payment_Txt_DisType, "3 - From and To Date Range", "NA",logval1);
			...
			testcall3 = true;
			RMA_Functionality_Utility.RMA_UnsuccessfulPaymentCorpAddition_Utility(Payment_Txt_BankAccount, Payment_Lst_PayeeType,ReserveType, FundsSplitDetails_Lst_TransactionType,FundsSplitDetails_Txt_Amount, Payment_Txt_LastName, Payment_Txt_DisType, "3 - From and To Date Range", logval1);
