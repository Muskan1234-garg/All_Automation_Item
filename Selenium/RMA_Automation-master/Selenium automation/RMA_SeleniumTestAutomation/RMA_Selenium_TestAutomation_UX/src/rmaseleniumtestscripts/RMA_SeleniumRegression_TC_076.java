...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_SeleniumRegression_TC_076
//Description    : Create, Edit and Delete of Enhanced Notes For A Newly Created Payment Is Validated
//Depends On TC  : None
//Revision       : 0.0 - ShrutiShruti-12-18-2017
//======================================================================================================================================================================================================================================================================================

public class RMA_SeleniumRegression_TC_076 extends rmaseleniumtestscripts.RMA_TC_BaseTest{
	@Test
	public void RMA_SeleniumRegression_TC_076_Test() throws Exception,Error{
		try{
			testcall1 = false;	
			...
			StrScreenShotTCName = "SeleniumRegression_TC_076";
			...
			//Global Variable Initialization Completed Here
				...
				parentlogger = reports.startTest("RMA_SeleniumRegression_TC_076_Create, Edit and Delete of Enhanced Notes For A Newly Created Payment", "Create, Edit and Delete of Enhanced Notes For A Newly Created Payment Is Validated");
				...
				testcall1 = true;
				StrControlNumber = RMA_Functionality_Utility.RMA_PaymentCorpAddition_Utility(Payment_Lst_BankAccount, Payment_Lst_PayeeType,FundsSplitDetails_Lst_ReserveType, FundsSplitDetails_Lst_TransactionType, 	5, Payment_Txt_LastName, Payment_Txt_DisType, logval1);
