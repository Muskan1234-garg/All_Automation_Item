...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_SeleniumRegression_TC_133
//Description    : Create, Edit and Delete of Attachments For A MedicalStaff(PI) On A Litigation Page Is Validated
//Depends On TC  : RMA_SeleniumRegression_TC_024(For the Litigation Creation)
//Revision       : 0.0 - ShrutiShruti-01-12-2018
//======================================================================================================================================================================================================================================================================================

public class RMA_SeleniumRegression_TC_133 extends RMA_TC_BaseTest{
	@Test
	public void RMA_SeleniumRegression_TC_133_test() throws Exception,Error{
		try{
			parentlogger = reports.startTest("RMA_SeleniumRegression_TC_133_Create, Edit And Delete Of Attachments On Person Involved(Medical Staff) On A Litigation Screen", "Create,Edit and Delete Of Attachments On A Person Involved(Medical Staff) On A Litigation Is Validated");
			parentlogger.assignAuthor("Shruti Shruti");

			StrScreenShotTCName = "RMA_SeleniumRegression_TC_133";
			testcall1 = false;	
