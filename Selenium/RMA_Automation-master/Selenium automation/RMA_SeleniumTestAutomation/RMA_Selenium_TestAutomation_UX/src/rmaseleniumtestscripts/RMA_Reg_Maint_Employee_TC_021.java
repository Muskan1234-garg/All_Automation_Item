...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_Reg_Maint_Employee_TC_021
//Description    : Verify That User Is Able To Add New Supplemental Field On Dependents
//Depends On TC  : None
//Revision       : 0.0 - ShrutiShruti-03-15-2018 
//======================================================================================================================================================================================================================================================================================

public class RMA_Reg_Maint_Employee_TC_021 extends RMA_TC_BaseTest{
	@Test
	public void RMA_Reg_Maint_Employee_TC_021_Test() throws Exception,Error{
		try{
			parentlogger = reports.startTest("RMA_Reg_Maint_Employee_TC_021_Adding Supplementals Field On Dependents Screen", "User Is Able To Add New Supplemental Field Is Validated");
			...
			StrScreenShotTCName = "RMA_Reg_Maint_Employee_TC_021";
			ErrorMessage = null;
			...
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_SupplementalField.RMAApp_SupplementalFieldSetup_Chk_SupplementalField(driver, "Employee Dependent Supplemental|EMP_X_DEP_SUPP"), "Employee Dependent Supplemental Radio Button on Supplemental Field Setup Page", logval);
			...
			RMA_GenericUsages_Utility.RMA_MultipleWindowSwitching_Utility(3, "NA", "NA", "NA", "NA", "NA", "Employee Dependent Supplemental Window", logval);
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_SupplementalField.RMAApp_SupplementalFieldSetup_Btn_SupplementalNewFieldAdd(driver), "Add New Field Image Button On Employee Dependent Supplement Window", logval);
			...
			RMA_GenericUsages_Utility.RMA_MultipleWindowSwitching_Utility(3, "NA", "NA", "NA", "NA","NA", "Navigation To RMA Utilities Screen", logval);
			...
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_PowerView.RMAApp_PowerView_ExpandTabButton(driver, "Supplementals"), "Expand Tab Button for Supplementals Tab On Power View Page", logval);
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_PowerView.RMAApp_PowerView_DropDown_ControlPalette(driver), "Control Palette Drop Down On Power View Editor Page", logval);
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_PowerView.RMAApp_PowerView_Tab_ControlPalette(driver, "Supplementals"), "Supplementals Tab On Control Palette Drop Down On Power View Editor Page", logval);
			WebElement To=driver.findElement(By.xpath(".//*[@id='Div4']/ancestor::div[1]/div[2]/div"));
			RMA_Navigation_Utility.RMA_ObjectDragAndDrop(RMA_Selenium_POM_PowerView.RMAApp_PowerView_ControlPaletteField(driver, UserPrompt_Txt), To, UserPrompt_Txt+" Field", "Supplemental Field Area", "Power View Editor Page", logval);
			...
			driver.close();
			//======================================================Changes Made in PowerView Editor Are Completed Here====================================================================================================================================================================================
			...
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_Home.RMAApp_GenericBtn_EnityAdd(driver, "Dependents"), "Add New Dependents Button On Employee Creation Page", logval);
			
			//===========================================================Verification Of Added Supplemental Field On Dependent Started Here===================================================================================================================================================
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_Employee.RMAApp_Employee_Tab_Supplementals(driver), "Supplementals Tab On Dependents Page", logval);
			RMA_Verification_Utility.RMA_ElementExist_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_RMAAppText(driver, UserPrompt_Txt),UserPrompt_Txt+ " Added Field Label On Supplemental Tab on Dependents Creation Page", logval);
			parentlogger.log(LogStatus.INFO, parentlogger.addScreenCapture(RMA_ScreenCapture_Utility.RMA_ScreenShotCapture_Utility(driver, "Field Present On Dependents", "Successful Field Verification")));
			//===========================================================Verification Of Added Supplemental Field On Dependent Completed Here===================================================================================================================================================
			...
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_SupplementalField.RMAApp_SupplementalFieldSetup_Chk_SupplementalField(driver, "Employee Dependent Supplemental|EMP_X_DEP_SUPP"), "Employee Dependent Supplemental Radio Button on Supplemental Field Setup Page", logval);
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_SupplementalField.RMAApp_SupplementalFieldSetup_Btn_SupplementalFieldEdit(driver), "Supplemental Edit Button On Supplemental Field Setup Page", logval);
			RMA_GenericUsages_Utility.RMA_MultipleWindowSwitching_Utility(4, "NA", "NA", "NA", "NA", "NA", "Employee Dependent Supplemental Window", logval);
			...
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_SupplementalField.RMAApp_SupplementalFieldSetup_Btn_EditFieldOnLastWindow(driver), "Edit Field Image Button On Employee Dependent Supplement Window", logval);
			SupplementalWindowHandle=driver.getWindowHandle();
