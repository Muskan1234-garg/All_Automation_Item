...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_SeleniumRegression_TC_070
//Description    : Create,Edit and Delete Of Enhanced Note On A Person Involved(Physician) Is Validated
//Depends On TC  : RMA_SeleniumRegression_TC_058
//Revision       : 0.0 - ShrutiShruti-12-13-2017 
//======================================================================================================================================================================================================================================================================================


public class RMA_SeleniumRegression_TC_070 extends RMA_TC_BaseTest{
	@Test
	public void RMA_SeleniumRegression_TC_070_Test() throws Exception,Error{
		try{
			parentlogger = reports.startTest("RMA_SeleniumRegression_TC_070_Create, Edit And Delete Of Enhanced Notes On Person Involved(Physician) Screen", "Create,Edit and Delete Of Enhanced Note On A Person Involved(Physician) Is Validated");
			parentlogger.assignAuthor("Shruti Shruti");

			StrScreenShotTCName = "RMA_SeleniumRegression_TC_070";
			testcall1 = false;	
