...
//=====================================================================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_QTPRegression_TC_111
//Description    : Verify The Setting 'Set Negative Reserve Balance To Zero' Is Not In Effect For The Recovery Reserve Is Validated
//Depends On TC  : None
//Revision       : 0.0 - AbhishekRai-10-23-2017
//===================================================================================================================================================================================================================================================================================================================================

public class RMA_QTPRegression_TC_111 extends RMA_TC_BaseTest {	
	
	@Test
	public void RMA_QTPRegression_TC_111_Test() throws Exception,Error {
		try{
			parentlogger = reports.startTest("RMA_QTPRegression_TC_111_Verify The Setting 'Set Negative Reserve Balance To Zero' Is Not In Effect For The Recovery Reserve", "Verify The Setting 'Set Negative Reserve Balance To Zero' Is Not In Effect For The Recovery Reserve Is Validated");
			parentlogger.assignAuthor("Abhishek Rai");		
			
			//Region =====================================================Global Variable Initialization Is Started Here=====================================================================================================
			StrScreenShotTCName = null;
			StrScreenShotTCName = "RMA_QTPRegression_TC_111";
			testcall1 = false;	
			...
			LineOfBussinessParameterSetup_Lst_LOBType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_111", 1, 0); //LOB Type Is Fetched From DataSheet RMA_QTPRegression_TC_111
			GenClaimCreation_Txt_ClaimType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_111", 1, 1); //Claim Type Is Fetched From DataSheet RMA_QTPRegression_TC_111
			GenClaimCreation_Txt_ClaimStatus = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_111", 1, 2); // Claim Status Is Fetched From DataSheet RMA_QTPRegression_TC_111
			GenClaimCreation_Txt_Department = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_111", 1, 3); // Department Is Fetched From DataSheet RMA_QTPRegression_TC_111						
			ReserveCreation_Lst_ReserveType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_111", 1, 4); //Reserve Type Is Fetched From DataSheet RMA_QTPRegression_TC_111
			ReserveCreation_Lst_ReserveStatus = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_111", 1, 5); //Reserve Status Is Fetched From DataSheet RMA_QTPRegression_TC_111
			ReserveCreation_Txt_ReserveAmount = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_QTPRegression_TC_111", 1, 6); //Amount Is Fetched From DataSheet RMA_QTPRegression_TC_111
			ReserveCreation_Lst_ReserveType_1 = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_111", 1, 7); //Reserve Type_1 Is Fetched From DataSheet RMA_QTPRegression_TC_111
			ReserveCreation_Txt_ReserveAmount_1 = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_QTPRegression_TC_111", 1, 8); //Amount_1 Is Fetched From DataSheet RMA_QTPRegression_TC_111												
			PaymentCreation_Lst_BankAccount = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_111", 1, 9); //BankAccount Is Fetched From DataSheet RMA_QTPRegression_TC_111
			PaymentCreation_Lst_PayeeType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_111", 1, 10); //Payee Type Is Fetched From DataSheet RMA_QTPRegression_TC_111
			Payment_Txt_LastName = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_111", 1, 11); //Last Name Is Fetched From DataSheet RMA_QTPRegression_TC_111
			PaymentCreation_Txt_DisType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_111", 1, 12); //Distribution Type Is Fetched From DataSheet RMA_QTPRegression_TC_111			
			FundsSplitDetails_Txt_Amount = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_QTPRegression_TC_111", 1, 13); //Amount Is Fetched From DataSheet RMA_QTPRegression_TC_111			
			FundsSplitDetails_Lst_TransactionType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_111", 1, 14); //Transaction Type Is Fetched From DataSheet RMA_QTPRegression_TC_111									
			FundsSplitDetails_Txt_Amount_1 = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_QTPRegression_TC_111", 1, 15); //Amount Is Fetched From DataSheet RMA_QTPRegression_TC_111			
			FundsSplitDetails_Lst_TransactionType_1 = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_111", 1, 16); //Transaction Type Is Fetched From DataSheet RMA_QTPRegression_TC_111
			...
			String []ExpectedValuesToBeVerified_1 = {"$"+ ReserveCreation_Txt_ReserveAmount + ".00", "$0.00", "$"+ FundsSplitDetails_Txt_Amount_1 + ".00", "$" + ReserveCreation_Txt_ReserveAmount + ".00", "C - Closed"};
