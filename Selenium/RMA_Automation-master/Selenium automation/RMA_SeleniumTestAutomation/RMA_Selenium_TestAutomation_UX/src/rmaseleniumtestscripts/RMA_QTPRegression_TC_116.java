...
//=====================================================================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_QTPRegression_TC_116
//Description    : When checkbox 'Prevent Back-Dating of Reserves' is checked , user cannot create reserves at a back date from General System Parameter Setup Is Validated 
//Depends On TC  : None
//Revision       : 0.0 - NidhiJha-12-15-2017
//===================================================================================================================================================================================================================================================================================================================================


public class RMA_QTPRegression_TC_116 extends RMA_TC_BaseTest {
	@Test
	public void RMA_QTPRegression_TC_116_Test() throws Exception,Error {
		...
		StrScreenShotTCName = "RMA_QTPRegression_TC_116";
		...
		try{
			...
			parentlogger = reports.startTest("RMA_QTPRegression_TC_116_ User_Unable_To_Create_Reserves_At_A_Back_Date_Validation", "When checkbox 'Prevent Back-Dating of Reserves' is checked , user cannot create reserves at a back date from General System Parameter Setup Is Validated ");
			...
			String Unsuccesful_ReserveCreation_backdate;
			...
			Unsuccesful_ReserveCreation_backdate = RMA_GenericUsages_Utility.RMA_PastFutureDateInfo_Utility(0, -2, 0, "MM/dd/yyyy");
			...
			GenClaimCreation_Txt_ClaimType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_116", 1, 0); //Claim Type Is Fetched From DataSheet RMA_QTPRegression_TC_097
			GenClaimCreation_Txt_ClaimStatus =  ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_116", 1,1 ); //Claim Status Is Fetched From DataSheet RMA_QTPRegression_TC_097
			GenClaimCreation_Txt_Department = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_116", 1,2 ); //Department Is Fetched From DataSheet RMA_QTPRegression_TC_097
			//General claim Data Fetch From Excel WorkBook Is Completed Here

			ReserveCreation_Lst_Status = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_116", 1, 3); //Status Is Fetched From DataSheet RMA_QTPRegression_TC_046
			ReserveCreation_Lst_ReserveType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_116", 1, 4); //Reserve Type Is Fetched From DataSheet RMA_QTPRegression_TC_046
			ReserveCreation_Txt_ReserveAmount =  ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_QTPRegression_TC_116", 1, 5);// Amount Is Fetched From DataSheet RMA_QTPRegression_TC_046
			...
			testcall3 = true;
			RMA_Functionality_Utility.RMA_Suite28_Utility("RMA_QTPRegression_TC_116_Check", logval1);
			...
			parentlogger.log(LogStatus.INFO,"The Functional Utility :" +RMA_GenericUsages_Utility.RMA_LoggerHyperlink("UnsuccessfulReserveCorpAddition","RMA_UnsuccessfulReserveCorpAddition_Utility",0)+" Is Called To Create An Unsuccessful Reserve");
			testcall4 = true;
			RMA_Functionality_Utility.RMA_UnsuccessfulReserveCorpAddition_Utility(Unsuccesful_ReserveCreation_backdate, GenClaimNumber, "Date",logval1);
			parentlogger.log(LogStatus.INFO, "Unsuccessful Reserve Is Created With Type::" + " " + color.RMA_ChangeColor_Utility(ReserveCreation_Lst_ReserveType, 2));
			...
			//=========================================Steps To Do More General System Parameter Settings Is Started Here===========================================================================================================================================================================================================================================================
			parentlogger.log(LogStatus.INFO, "Following Function Is Called :: "+RMA_GenericUsages_Utility.RMA_LoggerHyperlink("Suite28ParaSetupSettings","RMA_Suite28_Utility",0)+"General System Parameter Settings Are Done");
			testcall5 = true;
			RMA_Functionality_Utility.RMA_Suite28_Utility("RMA_QTPRegression_TC_116_check_1", logval1);
			parentlogger.log(LogStatus.INFO, "UI Settings Successfully Completed");
			loggerval5 = logger.toString();
			parentlogger.appendChild(logger);
			//=========================================Steps To Do More General System Parameter Settings Is Completed Here===========================================================================================================================================================================================================================================================
			...
			parentlogger.log(LogStatus.INFO,"The Functional Utility :" +RMA_GenericUsages_Utility.RMA_LoggerHyperlink("UnsuccessfulReserveCorpAddition","RMA_UnsuccessfulReserveCorpAddition_Utility",0)+" Is Called To Create An Unsuccessful Reserve");
			testcall6 = true;
			RMA_Functionality_Utility.RMA_UnsuccessfulReserveCorpAddition_Utility("NA", GenClaimNumber, "Amount",logval1);
			parentlogger.log(LogStatus.INFO, "Unsuccessful Reserve Is Created With Type::" + " " + color.RMA_ChangeColor_Utility(ReserveCreation_Lst_ReserveType, 2));
			...
			parentlogger.log(LogStatus.INFO, "Following Function Is Called :: "+RMA_GenericUsages_Utility.RMA_LoggerHyperlink("Suite28ParaSetupSettings","RMA_Suite28_Utility",0)+"General System Parameter Settings Are Done");
			testcall7 = true;
			RMA_Functionality_Utility.RMA_Suite28_Utility("RMA_QTPRegression_TC_116_uncheck", logval1);
			parentlogger.log(LogStatus.INFO, "UI Settings Successfully Completed");
