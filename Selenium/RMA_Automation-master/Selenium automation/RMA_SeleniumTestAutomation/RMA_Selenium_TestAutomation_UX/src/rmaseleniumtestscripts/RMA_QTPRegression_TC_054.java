...
//==================================================================================================================================================================================
//TestCaseID   	 : RMA_QTPRegression_TC_054
//Description    : Roll Up A Payment For The Same Payee Through Print Check To File Options: 'TO CUSTOM FILE ONLY' Option Is Validated
//Depends On TC  : None
//Revision       : 0.0 - AnubhutiVyas-09-01-2017 
//========================================================================================================================================================================================
public class RMA_QTPRegression_TC_054 extends RMA_TC_BaseTest{

	@Test 
	public void RMA_QTPRegression_TC_054_Test() throws Exception, Error
	{
		testcall1 = false;	
		...
		StrScreenShotTCName = "RMA_QTPRegression_TC_054";
		...
		try {
			parentlogger = reports.startTest("RMA_QTPRegression_TC_054_Roll Up A Payment Through Print Check To File Options: 'TO CUSTOM FILE ONLY'", "Roll Up A Payment For The Same Payee Through Print Check To File Options: 'TO CUSTOM FILE ONLY' Option Is Validated");
			...
			GenClaimCreation_Txt_ClaimType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_054", 1, 7); //Claim Type Is Fetched From DataSheet RMA_QTPRegression_TC_054
			GenClaimCreation_Txt_ClaimStatus =  ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_054", 1,8 ); //Claim Status Is Fetched From DataSheet RMA_QTPRegression_TC_054
			GenClaimCreation_Txt_Department = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_054", 1,9); //Department Is Fetched From DataSheet RMA_QTPRegression_TC_054
			//Claim Data Fetch From Excel WorkBook Is Completed Here
			
			PaymentCreation_Lst_PayeeType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_054", 1, 1); // Payee Type Is Fetched From DataSheet RMA_QTPRegression_TC_054
			FundsSplitDetails_Lst_TransactionType= ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_054", 1,2); //Transaction Type For Medical Reserve Payment Is Fetched From DataSheet RMA_QTPRegression_TC_054
			FundsSplitDetails_Txt_Amount = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_QTPRegression_TC_054", 1, 3); //Medical Amount Is Fetched From DataSheet RMA_QTPRegression_TC_054
			PaymentCreation_Txt_LastName = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_054", 1, 4); //LastName Is Fetched From DataSheet RMA_QTPRegression_TC_054
			PaymentCreation_Txt_DisType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_054", 1, 5); //Distribution Type Is Fetched From DataSheet RMA_QTPRegression_TC_054
			PaymentCreation_Lst_ReserveType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_054", 1, 6); // Medical Reserve Type Is Fetched From DataSheet RMA_QTPRegression_TC_054
			...
			testcall1 = true;
			RMA_Functionality_Utility.RMA_Suite07_Utility("RMA_QTPRegression_TC_054", logval1);//General System Parameter & Payment Parameter Settings Are Done
			...
			testcall8 = true;
			RMA_Functionality_Utility.RMA_Suite07_PrintCheckUtility("RMA_QTPRegression_TC_054",RMA_QTPRegression_TC_052_I.BankAccount_Txt_AccountName,PaymentCreation_Txt_DisType,ContentToBeVerified, logval);//Print Checks Utility
