...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_Reg_Maint_Employee_TC_022
//Description    : Verify That Same Fields Are Coming In PowerView As Defined In PowerView Editor For Employee Screen
//Depends On TC  : None
//Revision       : 0.0 - ShrutiShruti-03-15-2018 
//======================================================================================================================================================================================================================================================================================

public class RMA_Reg_Maint_Employee_TC_022 extends RMA_TC_BaseTest{
	@Test
	public void RMA_Reg_Maint_Employee_TC_022_Test() throws Exception,Error{
		try{
			parentlogger = reports.startTest("RMA_Reg_Maint_Employee_TC_022_Verification Of Fields On PowerView Editor and PowerView Of Employee Screen", "Same Fields Are Coming In PowerView As Defined In PowerView Editor For Employee Screen Is Validated");
			...
			StrScreenShotTCName = "RMA_Reg_Maint_Employee_TC_022";
			ErrorMessage = null;
			...
			for(int i=0;i<EmployeeFields.length;i++)
			{
				RMA_Verification_Utility.RMA_ElementExist_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_RMAAppText(driver, EmployeeFields[i]), EmployeeFields[i]+" Field Label On Power View Editor Page", logval);
			}
			//===========================================================Verification Done In PowerView Completed Here===============================================================================================================================================================
