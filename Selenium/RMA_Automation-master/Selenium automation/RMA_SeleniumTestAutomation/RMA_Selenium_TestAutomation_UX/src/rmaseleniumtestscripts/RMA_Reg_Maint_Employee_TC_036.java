...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_Reg_Maint_Employee_TC_036
//Description    : Verify That User Is Able To Make Any Field As Required and Validation Message Is Displayed In UX PowerView On Dependents
//Depends On TC  : None
//Revision       : 0.0 - ShrutiShruti-02-28-2018 
//======================================================================================================================================================================================================================================================================================

public class RMA_Reg_Maint_Employee_TC_036 extends RMA_TC_BaseTest{
	@Test
	public void RMA_Reg_Maint_Employee_TC_036_Test() throws Exception,Error{
		try{
			parentlogger = reports.startTest("RMA_Reg_Maint_Employee_TC_036_Verify That Field Becomes Required By Flag On PV For Dependents Page", "User Is Able To Make Any Field As Required and Validation Message Is Displayed In UX PowerView On Dependents Is Validated");
			...
			StrScreenShotTCName = "RMA_Reg_Maint_Employee_TC_036";
			ErrorMessage = null;
			CurrentFrameID=null;
			...
			String Dependent_Creation_Txt_LastName;
			...
			Dependent_Creation_Txt_FirstName = RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(3, "DependentsFirstName_");
			Dependent_Creation_Txt_LastName=RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(3, "DependentsLastName_");
			...
			Login_Txt_UserName = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_Reg_Maint_Employee_TC_036", 1, 0); //UserName Fetched From DataSheet RMA_Reg_Maint_Employee_TC_036
			Login_Txt_Password = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_Reg_Maint_Employee_TC_036", 1, 1); //Password Fetched From DataSheet RMA_Reg_Maint_Employee_TC_036
			Login_Txt_UserName_1 = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_Reg_Maint_Employee_TC_036", 1, 2); //UserName Fetched From DataSheet RMA_Reg_Maint_Employee_TC_036
			Login_Txt_Password_1 = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_Reg_Maint_Employee_TC_036", 1, 3); //Password Fetched From DataSheet RMA_Reg_Maint_Employee_TC_036
			DSNSelect_Lst_DataSourceName = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_Reg_Maint_Employee_TC_036", DSRow, 4); //Data Source Name Is Fetched From DataSheet RMA_Reg_Maint_Employee_TC_036		
			Dependent_Creation_Txt_Country=ExcelData.RMA_ExcelStringDataRead_Utility("RMA_Reg_Maint_Employee_TC_036", 1, 5);//Country Fetched From DataSheet RMA_Reg_Maint_Employee_TC_036
			Dependent_Creation_Txt_State=ExcelData.RMA_ExcelStringDataRead_Utility("RMA_Reg_Maint_Employee_TC_036", 1, 6);//State Fetched From DataSheet RMA_Reg_Maint_Employee_TC_036
			...
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_Home.RMAApp_GenericBtn_EnityAdd(driver, "Dependents"),"Dependents Add New Button On Employee Page", logval);
			...
			globalWait.until(ExpectedConditions.visibilityOf(RMA_Selenium_POM_PowerView.RMAApp_PowerView_Lbl_FieldDelete(driver, "Relation to Employee")));
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_PowerView.RMAApp_PowerView_Lbl_FieldDelete(driver, "Relation to Employee"), "Relation To Employee Field Label On Power View Editor Page", logval);
			...
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_Home.RMAApp_GenericBtn_EnityAdd(driver, "Dependents"),"Dependents Add New Button On Employee Creation Page" , logval);
			RMA_Verification_Utility.RMA_VerifyUXSpinnerDisappered(logval);
			RMA_Input_Utility.RMA_SetValue_Utility(RMA_Selenium_POM_Dependents.RMAApp_Dependents_Txt_FirstName(driver), "First Name TextBox On Dependents Creation Page", Dependent_Creation_Txt_FirstName, logval);
			RMA_Input_Utility.RMA_SetValue_Utility(RMA_Selenium_POM_Dependents.RMAApp_Dependents_Txt_LastName(driver), "Last Name TextBox On Dependents Creation Page", Dependent_Creation_Txt_LastName, logval);
			...
			RMA_Verification_Utility.RMA_VerifyUXMessage(RMA_Selenium_POM_VerificationMessage.PowerViewMandatoryFieldMessage, true, "Required Field Toast Message On Dependents Creation Page", logval);;
			RMA_Input_Utility.RMA_SetTextValueandTabOut_Utility(RMA_Selenium_POM_Dependents.RMAApp_Dependents_Txt_RelationToEmployee(driver), "Relation To Employee TextBox On Dependents Creation Page", "C", logval);
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_Home.RMAApp_Generic_Img_Save(driver), "Save Image Button On Dependents Creation Page", logval);
			driver.close();
			//Verification of Mandatory Fields On Dependents Field
