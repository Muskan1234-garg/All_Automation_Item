...
//=====================================================================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_QTPRegression_TC_031
//Description    : Setting Of SubBank Account Owner To Effective Trigger and Dates Is Validated 
//Depends On TC  : None
//Revision       : 0.0 - NidhiJha-08-28-2017
//===================================================================================================================================================================================================================================================================================================================================


public class RMA_QTPRegression_TC_031 extends RMA_TC_BaseTest{
	@Test
	public void RMA_QTPRegression_TC_031_Test() throws Exception,Error {
		...
		StrScreenShotTCName = "RMA_QTPRegression_TC_031";
		...
		try{
			parentlogger = reports.startTest("RMA_QTPRegression_TC_031_Sub Bank Account Owner Setting To Effective Trigger and Dates_Validation",  "Setting Of Sub Bank Account Owner To Effective Trigger and Dates Is Validated");
			...
			BankAccountCreation_Txt_BankAccountName = RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(4, "ADRMABank_");
			...
			GenClaimCreation_Txt_ClaimType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_031", 1, 0); //Claim Type Is Fetched From DataSheet RMA_QTPRegression_TC_031			
			GenClaimCreation_Txt_Department = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_031", 1,1 ); //Department Is Fetched From DataSheet RMA_QTPRegression_TC_031
			GenClaimCreation_Txt_ClaimStatus =  ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_031", 1,2 ); //Claim Status Is Fetched From DataSheet RMA_QTPRegression_TC_031
			GenClaimCreation_Txt_ServiceCode = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_031", 1,3 ); //Service Code Is Fetched From DataSheet RMA_QTPRegression_TC_031
			...
			testcall1 = true;
			rmaseleniumutilties_UX.RMA_Functionality_Utility.RMA_Suite22_Utility("RMA_QTPRegression_TC_031_Check", logval1);
			...
			//========================================Steps To Navigate To Account Owner Tab And Save Sub Bank Account Is Started Here=======================================================================================================================================================================
			...
			//========================================Steps To Navigate To Account Owner Tab And Save Sub Bank Account Is Completed Here=======================================================================================================================================================================
			...
			RMA_NegativeVerification_Utility.RMA_NegVerifyMultipleDataInWebList(RMA_Selenium_POM_PaymentsCollections.RMAApp_PaymentCollection_Lst_BankAccount(driver), SubBankAccountName, "Bank Account List On Payments Page", logval);
			...
			RMA_GenericUsages_Utility.RMA_StaticWait(6, logval, "Wait Is Added As Payment Page Needs To Get Loaded After Verification");
			driver.switchTo().parentFrame();
			...
			//=========================================Steps To Navigate To UI Screen And Lookup The Created Sub Bank Account Is Started Here===========================================================================================================================================================================================================================================================================
			...
			//========================================Steps To Lookup The Created Sub Bank Account Page Is Started Here=====================================================================================================================================================================================================
			RMA_Navigation_Utility.RMA_ObjectClick(RMA_POM_BankAccount.RMAApp_BankAccount_Img_SubAccounts(driver), "Sub Bank Account Image on Maintenance-->Bank Account Page", logval);
			//========================================Steps To Lookup The Created Sub Bank Account Page Is Completed Here=====================================================================================================================================================================================================
		...
		//	RMA_Functionality_Utility.RMA_GenericSave_Utility(RMA_Selenium_POM_VerificationMessage.BankAccountFrame, false, "NA", "Bank Account Page", logval);
			...
			parentlogger.log(LogStatus.INFO, "Following Function Is Called :: "+RMA_GenericUsages_Utility.RMA_LoggerHyperlink("Suite22GenSysParaSetupsettings","RMA_Suite22_Utility",0)+" To Successfully Do Settings On General System Parameter Setup Page");
			testcall4 = true;
			rmaseleniumutilties_UX.RMA_Functionality_Utility.RMA_Suite22_Utility("RMA_QTPRegression_TC_031_UnCheck", logval);
			parentlogger.log(LogStatus.INFO, "General System Parameter Setup Settings Are Done For Test Case:"+ " " + color.RMA_ChangeColor_Utility(BankAccountCreation_Txt_BankAccountName, 2));
