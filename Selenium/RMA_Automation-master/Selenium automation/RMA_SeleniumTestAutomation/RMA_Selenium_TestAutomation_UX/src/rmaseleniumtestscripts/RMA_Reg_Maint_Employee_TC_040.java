...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_Reg_Maint_Employee_TC_040
//Description    : Verify That No ToolBar Buttons, Child Navigation Options Are Displayed When User Has Removed The Same From PowerView
//Depends On TC  : None
//Revision       : 0.0 - ShrutiShruti-02-27-2018 
//======================================================================================================================================================================================================================================================================================

public class RMA_Reg_Maint_Employee_TC_040 extends RMA_TC_BaseTest{
	@Test
	public void RMA_Reg_Maint_Employee_TC_040_Test() throws Exception,Error{
		try{
			parentlogger = reports.startTest("RMA_Reg_Maint_Employee_TC_040_Verify That Child Navigation, ToolBar Buttons Do Not Displayed When User Removes Them From Employee", "No ToolBar Buttons, Child Navigation Options Are Displayed When User Has Removed The Same From PowerView Is Validated");
			...
			StrScreenShotTCName = "RMA_Reg_Maint_Employee_TC_040";
			ErrorMessage = null;
			...
			RMA_Verification_Utility.RMA_ElementExist_Utility(RMA_Selenium_POM_Home.RMAApp_GenericClaim_Btn_Diary(driver),"Diary Image Button On Employee Creation Page", logval);
			RMA_Verification_Utility.RMA_ElementExist_Utility(RMA_Selenium_POM_Home.RMAApp_Employee_Img_WithHolding(driver), "Withholding image Button On Employee Creation Page", logval);
			RMA_Verification_Utility.RMA_ElementExist_Utility(RMA_Selenium_POM_Home.RMAApp_GenericClaim_Btn_RecordSummary(driver), "Record Summary Image Button On Employee Creation Page", logval);
			globalWait.until(ExpectedConditions.visibilityOf(RMA_Selenium_POM_Home.RMAApp_GenericBtn_EnityAdd(driver, "Violations")));
			RMA_Verification_Utility.RMA_ElementExist_Utility(RMA_Selenium_POM_Home.RMAApp_GenericBtn_EnityAdd(driver, "Violations"), "Violations Add New Child Button On Right Side Panel On Employee Creation Page", logval);
			RMA_Verification_Utility.RMA_ElementExist_Utility(RMA_Selenium_POM_Home.RMAApp_GenericBtn_EnityAdd(driver, "Dependents"), "Dependents Add New Child Button On Right Side Panel On Employee Creation Page", logval);
			RMA_Verification_Utility.RMA_ElementExist_Utility(RMA_Selenium_POM_Home.RMAApp_GenericBtn_EnityAdd(driver, "Banking Information "), "Banking Information Add New Child Button On Right Side Panel On Employee Creation Page", logval);
			//Verification Is Completed Here For The ToolBar And Child Navigation Links Existence
			...
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_PowerView.RMAApp_PowerView_Lbl_Entity(driver, "Employee Maintenance"), "Employee Maintenance Label On Power View Editor Page", logval);
			...
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_PowerView.RMAApp_PowerView_DropDwn_ToolbarMainForm(driver), "ToolBar DropDown On Power View Editor Page", logval);
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_PowerView.RMAApp_PowerView_Btn_RemoveToolbarButton(driver, "Diary"), "Diary Remove Button On Power View Editor Page", logval);
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_PowerView.RMAApp_PowerView_Btn_RemoveToolbarButton(driver, "Record Summary"), "Record Summary Remove Button On Power View Editor Page", logval);
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_PowerView.RMAApp_PowerView_Btn_RemoveToolbarButton(driver, "Withholding"), "Withholding Button On Power View Editor Page", logval);
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_PowerView.RMAApp_PowerView_DropDwn_ChildNavigationMainForm(driver), "Child/Navigation Link DropDown On Power View Editor Page", logval);
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_PowerView.RMAApp_PowerView_Btn_RemoveChildNavigationLinkButton(driver, "Banking Information"), "Banking Information Remove Button On Power View Editor Page", logval);
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_PowerView.RMAApp_PowerView_Btn_RemoveChildNavigationLinkButton(driver, "Violations"), "Violations Remove Button On Power View Editor Page", logval);
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_PowerView.RMAApp_PowerView_Btn_RemoveChildNavigationLinkButton(driver, "Dependents"), "Dependents Remove Button On Power View Editor Page", logval);
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_PowerView.RMAApp_PowerView_Btn_Save(driver),"Save Iamge Button On Power View Editor Page", logval);
			...
			RMA_NegativeVerification_Utility.RMA_ElementNotExist_Utility(RMA_Selenium_POM_Home.RMAApp_GenericClaim_Btn_Diary(driver), "Diary Image Button On Employee Creation Page", logval);
			RMA_NegativeVerification_Utility.RMA_ElementNotExist_Utility(RMA_Selenium_POM_Home.RMAApp_GenericClaim_Btn_RecordSummary(driver), "Record Summary Image Button On Employee Creation Page", logval);
			RMA_NegativeVerification_Utility.RMA_ElementNotExist_Utility(RMA_Selenium_POM_Home.RMAApp_Employee_Img_WithHolding(driver), "Withholding Image Button On Employee Creation Page", logval);
			RMA_NegativeVerification_Utility.RMA_ElementNotExist_Utility(RMA_Selenium_POM_Home.RMAApp_GenericBtn_EnityAdd(driver, "Banking Information "), "Banking Information Add New Child Button On Right Side Panel On Employee Creation Page", logval);
			RMA_NegativeVerification_Utility.RMA_ElementNotExist_Utility(RMA_Selenium_POM_Home.RMAApp_GenericBtn_EnityAdd(driver, "Violations"), "Violations Add New Child Button On Right Side Panel On Employee Creation Page", logval);
			RMA_NegativeVerification_Utility.RMA_ElementNotExist_Utility(RMA_Selenium_POM_Home.RMAApp_GenericBtn_EnityAdd(driver, "Dependents"), "Dependents Add New Child Button On Right Side Panel On Employee Creation Page", logval);
			driver.close();
			//Verification Is Completed For Non-Existence Of the Controls Removed In Power View
			...
			globalWait.until(ExpectedConditions.visibilityOf(RMA_Selenium_POM_PowerView.RMAApp_PowerView_DropDwn_ToolbarMainForm(driver)));
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_PowerView.RMAApp_PowerView_DropDwn_ToolbarMainForm(driver), "ToolBar DropDown On Power View Editor Page", logval);
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_PowerView.RMAApp_PowerView_DropDwn_ToolbarSidePanel(driver), "ToolBar DropDown On Isde Panel On PowerView Editor Page", logval);
			RMA_Navigation_Utility.RMA_ObjectDragAndDrop(RMA_Selenium_POM_PowerView.RMAApp_PowerView_DiaryField(driver),RMA_Selenium_POM_PowerView.RMAApp_PowerView_Area_ToolBarField(driver), "Diary Field", "ToolBar Field", "Power View Editor Page", logval);
			RMA_Navigation_Utility.RMA_ObjectDragAndDrop(RMA_Selenium_POM_PowerView.RMAApp_PowerView_RecordSummaryField(driver),RMA_Selenium_POM_PowerView.RMAApp_PowerView_Area_ToolBarField(driver), "Record Summary Field", "ToolBar Field", "Power View Editor Page", logval);
			RMA_Navigation_Utility.RMA_ObjectDragAndDrop(RMA_Selenium_POM_PowerView.RMAApp_PowerView_WithholdingField(driver),RMA_Selenium_POM_PowerView.RMAApp_PowerView_Area_ToolBarField(driver), "Withholding Field", "ToolBar Field", "Power View Editor Page", logval);
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_PowerView.RMAApp_PowerView_DropDown_ChildSidePanel(driver), "Child/Navigation DropDown On Side Panel On Power View Editor Page", logval);
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_PowerView.RMAApp_PowerView_DropDwn_ChildNavigationMainForm(driver), "Child/Navigation DropDown On Main Form On Power View Editor Page", logval);
			RMA_Navigation_Utility.RMA_ObjectDragAndDrop(RMA_Selenium_POM_PowerView.RMAApp_PowerView_BankingInfoField(driver), RMA_Selenium_POM_PowerView.RMAApp_PowerView_Area_ChildNavigation(driver), "Banking Information Field", "Child/ Navigation Field", "Power View Editor Page", logval);
			RMA_Navigation_Utility.RMA_ObjectDragAndDrop(RMA_Selenium_POM_PowerView.RMAApp_PowerView_ViolationsField(driver), RMA_Selenium_POM_PowerView.RMAApp_PowerView_Area_ChildNavigation(driver), "Violations Field", "Child/ Navigation Field", "Power View Editor Page", logval);
			RMA_Navigation_Utility.RMA_ObjectDragAndDrop(RMA_Selenium_POM_PowerView.RMAApp_PowerView_DependentsField(driver), RMA_Selenium_POM_PowerView.RMAApp_PowerView_Area_ChildNavigation(driver), "Dependents Field", "Child/ Navigation Field", "Power View Editor Page", logval);
