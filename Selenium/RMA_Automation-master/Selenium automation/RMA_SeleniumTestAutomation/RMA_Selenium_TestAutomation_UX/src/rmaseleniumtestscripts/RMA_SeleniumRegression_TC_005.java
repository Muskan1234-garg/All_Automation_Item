...
//===================================================================================================================================================================================================================================
//TestCaseID     : RMA_SeleniumRegression_TC_005
//Description    : Functionality of Adjuster Creation Permission Setting For General Claim On Security Management System Is Validated
//Depends On TC  : None
//Revision       : 0.0 - RenuVerma-08-03-2017
//===================================================================================================================================================================================================================================
public class RMA_SeleniumRegression_TC_005 extends rmaseleniumtestscripts.RMA_TC_BaseTest {

	@Test	
	public void RMA_SeleniumRegression_TC_005_Test() throws Exception, Error
	{   
		try {	 	 
			...
			parentlogger = reports.startTest("RMA_SeleniumRegression_TC_005_Adjuster Creation Permission Setting For General Claim Setting Validation", "Functionality of Adjuster Creation Permission Setting For General Claim On Security Management System Is Validated");
			parentlogger.assignAuthor("Renu Verma");

			StrScreenShotTCName = "RMA_SeleniumRegression_TC_005";
			...
			RMAApp_SMS_Lnk_ModuleSecurityGroup = ExcelData_1.RMA_ExcelStringDataRead_Utility("RMA_SeleniumRegression_TC_005", 1, 0); //Module Security Group Name Is Fetched From DataSheet RMA_SeleniumRegression_TC_005
			RMAApp_SMS_Lnk_ModuleAccessPermission = ExcelData_1.RMA_ExcelStringDataRead_Utility("RMA_SeleniumRegression_TC_005", 1, 1); //Module Access Permission Name Is Fetched From DataSheet RMA_SeleniumRegression_TC_005	
			RMAApp_SMS_Lnk_ModuleAccessPermission_1 = ExcelData_1.RMA_ExcelStringDataRead_Utility("RMA_SeleniumRegression_TC_005", 1, 2); //Module Access Permission Name Is Fetched From DataSheet RMA_SeleniumRegression_TC_005
			RMAApp_SMS_Lnk_ModuleAccessPermission_2 = ExcelData_1.RMA_ExcelStringDataRead_Utility("RMA_SeleniumRegression_TC_005", 1, 3); //Module Access Permission Name Is Fetched From DataSheet RMA_SeleniumRegression_TC_005
			RMAApp_SMS_Lnk_ModuleAccessPermission_3 = ExcelData_1.RMA_ExcelStringDataRead_Utility("RMA_SeleniumRegression_TC_005", 1, 4); //Module Access Permission Name Is Fetched From DataSheet RMA_SeleniumRegression_TC_005	
			...
			GenClaimCreation_Txt_ClaimType = ExcelData2.RMA_ExcelStringDataRead_Utility("RMA_TC_004", 1, 0); //Claim Type Is Fetched From DataSheet RMA_TC_004
			GenClaimCreation_Txt_ClaimStatus =  ExcelData2.RMA_ExcelStringDataRead_Utility("RMA_TC_004", 1,1 ); //Claim Status Is Fetched From DataSheet RMA_TC_004
			GenClaimCreation_Txt_Department = ExcelData2.RMA_ExcelStringDataRead_Utility("RMA_TC_004", 1,2 ); //Department Is Fetched From DataSheet RMA_TC_004
			//Fetch Of Data From Excel WorkBook Completed


			//=========================================================== Disabling Of New Adjuster Creation Permission For General Claims In Security Management System Is Started Here===================================================================================================================================================================================================================================================================================================================================================
			...
			//=========================================================== Disabling Of New Adjuster Creation Permission For General Claims In Security Management System Is Ended Here===================================================================================================================================================================================================================================================================================================================================================
			...
			//=========================================================== Enabling Of New Adjuster Creation Permission For General Claims In Security Management System Is Started Here===================================================================================================================================================================================================================================================================================================================================================
			RMA_GenericUsages_Utility.RMA_WindowSwitchingBasedOnTitle("CSC Riskmaster Accelerator");
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_Login_DSNSelect_Frames.RMAApp_Dashboard_Lbl_SMS(driver), "Security Management System Navigation Option Label On RiskMaster Application's Dashboard Page",logval);
			RMA_GenericUsages_Utility.RMA_WindowSwitchingBasedOnTitle("Riskmaster Security");
			RMA_Verification_Utility.RMA_VerifyUXSpinnerDisappered(logval);
			...
			{
				logger.log(LogStatus.FAIL,"Following Error Occurred  ::" + " "+  color.RMA_ChangeColor_Utility(FinalErrorMessage,1)+ " " + "While Executing Functionality" +" "+ "RMA_GenClaimCorpCreation" + " " +  "And Hence The Test Case Is A Fail");
				parentlogger.appendChild(logger);
			}
