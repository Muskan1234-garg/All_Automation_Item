...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_SeleniumRegression_TC_116
//Description    : Create, Edit and Delete of Attachments For A Witness(PI) Is Validated
//Depends On TC  : None
//Revision       : 0.0 - ShrutiShruti-01-11-2018
//======================================================================================================================================================================================================================================================================================

public class RMA_SeleniumRegression_TC_116 extends RMA_TC_BaseTest{
	@Test
	public void RMA_SeleniumRegression_TC_116_Test() throws Exception,Error{
		try{
			parentlogger = reports.startTest("RMA_SeleniumRegression_TC_116_Create, Edit And Delete Of Attachments On Person Involved(Witness) Screen", "Create,Edit and Delete Of Attachments On A Person Involved(Witness) Is Validated");
			parentlogger.assignAuthor("Shruti Shruti");

			StrScreenShotTCName = "RMA_SeleniumRegression_TC_116";
			testcall1 = false;	
