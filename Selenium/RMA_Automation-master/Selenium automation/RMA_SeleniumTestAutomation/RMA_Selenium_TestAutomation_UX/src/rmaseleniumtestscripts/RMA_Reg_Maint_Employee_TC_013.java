...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_Reg_Maint_Employee_TC_013
//Description    : Verify That Correct Validation Message Is Displayed When User Enters Date Hired Less Than Termination Date
//Depends On TC  : None
//Revision       : 0.0 - DebasmitaPati-02-09-2018
//======================================================================================================================================================================================================================================================================================
public class RMA_Reg_Maint_Employee_TC_013 extends RMA_TC_BaseTest {
		
	@Test
		public void RMA_Reg_Maint_Employee_TC_013_Test() throws Exception,Error {

		try{
			parentlogger = reports.startTest("RMA_Reg_Maint_Employee_TC_013_Verify That Correct Validation Message Is Displayed When User Enters Date Hired Less Than Termination Date","Validation Message Is Verified Successfully When User Enters Date Hired Less Than Termination Date");
			...
			StrScreenShotTCName = "RMA_Reg_Maint_Employee_TC_013";
			ErrorMessage = null;
			CurrentFrameID=null;
			...
			Date_Hired = RMA_GenericUsages_Utility.RMA_PastFutureDateInfo_Utility(0,-1,0,"MM/dd/yyyy");
			Termination_Date = RMA_GenericUsages_Utility.RMA_PastFutureDateInfo_Utility(0,-2,0,"MM/dd/yyyy");
			...
			RMA_Input_Utility.RMA_SetTextValueandTabOut_Utility(RMA_Selenium_POM_Employee.RMAApp_Employee_Txt_TerminationDate(driver), "Termination Date TextBox On Maintenance-->Employee Page",Termination_Date, logval);
			CurrentFrameID = RMA_GenericUsages_Utility.RMA_GetCurrentFrameID();
			RMA_Functionality_Utility.RMA_GenericSave_Utility(CurrentFrameID, true, "Date Employment Termination must be greater than or equal to Date Hired",  "Maintenance-->Employee Page", logval);
			parentlogger.log(LogStatus.PASS, color.RMA_ChangeColor_Utility("Date Employment Termination must be greater than or equal to Date Hired", 2)+ " Validation Message Is Verified Successfully");
