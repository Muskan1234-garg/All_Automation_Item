...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_SeleniumRegression_TC_121
//Description    : Create, Edit and Delete of Attachments On A Expert Created On Litigation Screen Is Validated
//Depends On TC  : RMA_SeleniumRegression_TC_102
//Revision       : 0.0 - ShrutiShruti-01-11-2018
//======================================================================================================================================================================================================================================================================================

public class RMA_SeleniumRegression_TC_121 extends RMA_TC_BaseTest{
	@Test
	public void RMA_SeleniumRegression_TC_121_Test() throws Exception,Error{
		try{
			testcall1 = false;	
			...
			StrScreenShotTCName = "RMA_SeleniumRegression_TC_121";
			...
			parentlogger = reports.startTest("RMA_Smoke_TC_121_Create, Edit and Delete of Attachments For A Newly Created Expert On Litigation Screen", "Create, Edit and Delete of Attachments For A Newly Created Expert On Litigation Screen Is Validated");
			...
			//===========================================================New Expert Creation Is Started Here=====================================================================================================================================================================================*/
			RMA_GenericUsages_Utility.RMA_ConditionalFrameSwitching(DefaultFrameID);
			parentlogger.log(LogStatus.INFO, "Following Function Is Called :: "+RMA_GenericUsages_Utility.RMA_LoggerHyperlink("Claim/EventEntityAdd", "RMA_ClaimEventEntityAddition_Utility",0)+" To Create Expert");
			testcall2 = true;
			StrExpert=RMA_Functionality_Utility.RMA_ClaimEventEntityAddition_Utility("Expert", StrClaimNumber, "ASWE", "NA",logval1);
			loggerval2 = logger.toString();
			parentlogger.log(LogStatus.INFO, "New Expert Is Created With Last Name::"+ " " + color.RMA_ChangeColor_Utility(StrExpert, 2));
			parentlogger.appendChild(logger);
			//===========================================================New Expert Creation Is Completed Here====================================================================================================================================================================================*/
			...
			//===========================================================Delete Of Created Expert Started Here=========================================================================================================================================================================================*/
			RMA_Functionality_Utility.RMA_GenericDelete_Utility("Expert Creation Page", false,logval);
			RMA_Functionality_Utility.RMA_GenericDelete_Utility("Expert Creation Page", true, logval);
			//===========================================================Delete Of Created Expert Completed Here=======================================================================================================================================================================================*/
