...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_SeleniumRegression_TC_061
//Description    : Create,Edit And Delete of Enhanced Notes On The Adjuster Screen
//Depends On TC  : RMA_SeleniumRegressionTC_058
//Revision       : 0.0 - ShrutiShruti-12-08-2017 
//======================================================================================================================================================================================================================================================================================


public class RMA_SeleniumRegression_TC_061 extends RMA_TC_BaseTest{
	@Test
	public void RMA_SeleniumRegression_TC_061_Test() throws Exception,Error{
		try{
			parentlogger = reports.startTest("RMA_SeleniumRegression_TC_061_Create, Edit And Delete An Enhanced Note on Adjuster Screen", "Create,Edit And Delete of Enhanced Notes On The Adjuster Screen Is Validated");
			...
			StrScreenShotTCName = "RMA_SeleniumRegression_TC_061";
			ErrorMessage = null;
			CurrentFrameID=null;
