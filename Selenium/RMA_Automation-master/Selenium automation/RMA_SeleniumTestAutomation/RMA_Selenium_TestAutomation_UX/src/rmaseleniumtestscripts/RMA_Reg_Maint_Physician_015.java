...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     :  RMA_Reg_Maint_Physician_015
//Description    : Verify That Help Is Displayed If Added Via PowerView For Any Field On Physician Page
//Depends On TC  : None
//Revision       : 0.0 - AnubhutiVyas-03-21-2018 
//======================================================================================================================================================================================================================================================================================

public class RMA_Reg_Maint_Physician_015 extends RMA_TC_BaseTest{
	@Test
	public void RMA_Reg_Maint_Physician_015_Test() throws Exception,Error{
		try{
			parentlogger = reports.startTest("RMA_Reg_Maint_Physician_015_Verify Help Is Displayed On Physician", "Help Is Displayed If Added Via PowerView For Any Field On Physician Page Is Validated");
			...
			StrScreenShotTCName = "RMA_Reg_Maint_Physician_015";
			ErrorMessage = null;
			...
			StrHelpMessage=RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(3, "Help_");
			...
			globalWait.until(ExpectedConditions.visibilityOf(RMA_Selenium_POM_PowerView.RMAApp_PowerView_Chk_Entity(driver, "Physician Maintenance")));
			...
			RMA_Input_Utility.RMA_SetValue_Utility(RMA_Selenium_POM_PowerView.RMAApp_PowerView_Txt_HelpMessage(driver), "Help Message TextBox On Power View Editor Page",StrHelpMessage , logval);
			...
			testcall1 = true;
			RMA_Maintenance_Functionality_Utility.RMA_MaintenanceAddNewEntity_Utility("Physician", "Great Britain", "Alberta",logval1);
			...
			//=====================Function To Check Help Text Started Here=============================
			WebElement Help=driver.findElement(By.xpath(".//*[@id='A3']"));
			Actions Build=new Actions(driver);
			Build.moveToElement(Help).build().perform();
			StrTitle=Help.getAttribute("title");
			
			if(StrTitle.equalsIgnoreCase(StrHelpMessage))
			{
				parentlogger.log(LogStatus.PASS, "Help Message::"+ " " + color.RMA_ChangeColor_Utility(StrHelpMessage, 2)+ " Is Successfully Found On Privileges Page");
			}
			//====================Function To Check Help Text Completed Here============================
			//Verification Completed For The Changes DOne In Power View Editor Page
