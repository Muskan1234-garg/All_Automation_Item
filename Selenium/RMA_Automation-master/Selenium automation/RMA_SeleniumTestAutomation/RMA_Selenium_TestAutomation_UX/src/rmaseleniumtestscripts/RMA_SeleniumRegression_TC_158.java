...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_SeleniumRegression_TC_158
//Description    : Create, Edit and Delete of Enhanced Notes For A Case Managers Notes Is Validated
//Depends On TC  : None
//Revision       : 0.0 - ShrutiShruti-01-10-2018
//======================================================================================================================================================================================================================================================================================

public class RMA_SeleniumRegression_TC_158 extends RMA_TC_BaseTest{
	@Test
	public void RMA_Selenium_TC_158_Test() throws Exception,Error{
		try{
			parentlogger = reports.startTest("RMA_SeleniumRegression_TC_158_Create,Edit And Delete Of Enhanced Notes On Case Manager Notes Page", "Create,Edit And Delete Of Enhanced Notes On Case Manager Notes Is Validated");
			...
			//==========================================================Steps To Create Case Managers Notes Started Here=============================================================================================================================================================================================================================
			RMA_GenericUsages_Utility.RMA_ConditionalFrameSwitching(DefaultFrameID);
			parentlogger.log(LogStatus.INFO, "Following Function Is Called :: "+RMA_GenericUsages_Utility.RMA_LoggerHyperlink("Claim/EventEntityAdd", "RMA_ClaimEventEntityAddition_Utility",0)+" To Create Case Managers");
			testcall5 = true;
			StrCaseManagerNotes=RMA_Functionality_Utility.RMA_ClaimEventEntityAddition_Utility("Case Manager Notes", StrClaimNumber, "Nurse", "NA",logval1);
			loggerval5 = logger.toString();
			parentlogger.log(LogStatus.INFO, "New Case Manager Notes Is Created With Type::"+ " " + color.RMA_ChangeColor_Utility(StrCaseManagerNotes, 2));
			parentlogger.appendChild(logger);
			//=========================================================Steps To Create Case Managers Notes Completed Here=========================================================================================================================================
			...
			//=========================================================Steps To Delete Created Case Manager Notes Started Here==============================================================================================================================================
			RMA_Functionality_Utility.RMA_GenericDelete_Utility("Case Managers Notes Creation Page", false, logval);
			RMA_Functionality_Utility.RMA_GenericDelete_Utility("Case Managers Notes Creation Page", true, logval);
			//=========================================================Steps To Delete Created Case Manager Notes Completed Here=======================================================================================================================================
