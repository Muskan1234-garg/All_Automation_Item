...
//=====================================================================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_QTPRegression_TC_104
//Description    : Verify Editing a Transaction when per claim pay limit is enabled
//Depends On TC  : None
...
public class RMA_QTPRegression_TC_104 extends RMA_TC_BaseTest {
	@Test
	public void RMA_QTPRegression_TC_104_Test() throws Exception,Error {
		...
		StrScreenShotTCName = "RMA_QTPRegression_TC_104";
		...
		try{
			...
			parentlogger = reports.startTest("RMA_QTPRegression_TC_104_Editing_A_Transaction_Validation", "Verify Editing a Transaction when per claim pay limit is enabled");
			...
			String Payment_Txt_Address1;
			String Payment_Txt_Address2;
			String Payment_Txt_Address3;
			String Payment_Txt_Address4;
			...
			Payment_Txt_Address1 = RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(3, "ADD1_428_");
			Payment_Txt_Address2 = RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(3, "ADD2_428_");
			Payment_Txt_Address3 = RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(3, "ADD3_428_");
			Payment_Txt_Address4 = RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(3, "ADD4_428_");
			...
			GenClaimCreation_Txt_ClaimType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_104", 1, 0); //Claim Type Is Fetched From DataSheet RMA_QTPRegression_TC_104
			GenClaimCreation_Txt_ClaimStatus =  ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_104", 1,1 ); //Claim Status Is Fetched From DataSheet RMA_QTPRegression_TC_104
			GenClaimCreation_Txt_Department = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_104", 1,2 ); //Department Is Fetched From DataSheet RMA_QTPRegression_TC_104
			//General claim Data Fetch From Excel WorkBook Is Completed Here

			ReserveCreation_Lst_Status = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_104", 1, 3); //Status Is Fetched From DataSheet RMA_QTPRegression_TC_104
			ReserveCreation_Lst_ReserveType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_104", 1, 4); //Reserve Type Is Fetched From DataSheet RMA_QTPRegression_TC_104
			ReserveCreation_Txt_ReserveAmount =  ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_QTPRegression_TC_104", 1, 5);// Amount Is Fetched From DataSheet RMA_QTPRegression_TC_104
			//Reserve Data Fetch From Excel WorkBook Is Completed 

			Payment_Lst_BankAccount = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_104", 1, 6); //Bank Account Is Fetched From DataSheet RMA_QTPRegression_TC_104
			Payment_Lst_PayeeType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_104", 1, 7); // Payee Type Is Fetched From DataSheet RMA_QTPRegression_TC_104
			FundsSplitDetails_Lst_TransactionType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_104", 1, 8); //Transaction Type Is Fetched From DataSheet RMA_QTPRegression_TC_104
			FundsSplitDetails_Txt_Amount = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_QTPRegression_TC_104", 1, 9); //Amount Is Fetched From DataSheet RMA_QTPRegression_TC_104
			Payment_Txt_LastName = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_104", 1, 10); //LastName Is Fetched From DataSheet RMA_QTPRegression_TC_104
			Payment_Txt_DisType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_104", 1, 11); //Distribution Type Is Fetched From DataSheet RMA_QTPRegression_TC_104
			FundsSplitDetails_Lst_ReserveType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_104", 1, 12); // Reserve Type Is Fetched From DataSheet RMA_QTPRegression_TC_104
			...
			//=========================================Steps To Do Payment Parameter Setup Settings Is Started Here===========================================================================================================================================================================================================================================================
			...
			testcall1 = true;
			RMA_Functionality_Utility.RMA_Suite28_Utility("RMA_QTPRegression_TC_104_Check", logval1);
			parentlogger.log(LogStatus.INFO, "UI Settings Successfully Completed");
			loggerval1 = logger.toString();
			parentlogger.appendChild(logger);
			//=========================================Steps To Do Payment Parameter Setup Settings Is Completed Here===========================================================================================================================================================================================================================================================
			...
			//=========================================Steps To Navigate To Finacials/Reserves Page Is Started Here===========================================================================================================================================================================================================================================================================
			...
			RMA_Verification_Utility.RMA_VerifyUXSpinnerDisappered(logval);
			//=========================================Steps To Navigate To Finacials/Reserves Page Is Ended Here===========================================================================================================================================================================================================================================================================
			...
			RMA_Input_Utility.RMA_SetValue_Utility(RMA_Selenium_POM_PaymentsCollections.RMAApp_PaymentCollection_Txt_Address1(driver), "Address 1 TextBox On Payments Page", Payment_Txt_Address1, logval);
			RMA_Input_Utility.RMA_SetValue_Utility(RMA_Selenium_POM_PaymentsCollections.RMAApp_PaymentCollection_Txt_Address2(driver), "Address 2 TextBox On Payments Page", Payment_Txt_Address2, logval);
			RMA_Input_Utility.RMA_SetValue_Utility(RMA_Selenium_POM_PaymentsCollections.RMAApp_PaymentCollection_Txt_Address3(driver), "Address 3 TextBox On Payments Page", Payment_Txt_Address3, logval);
			RMA_Input_Utility.RMA_SetValue_Utility(RMA_Selenium_POM_PaymentsCollections.RMAApp_PaymentCollection_Txt_Address4(driver), "Address 4 TextBox On Payments Page", Payment_Txt_Address4, logval);
			RMA_Functionality_Utility.RMA_GenericSave_Utility(DefaultFrameID, false, "NA", "Payment Creation Page", logval);
			//Save Button Is Clicked To Save The Transaction

			RMA_GenericUsages_Utility.RMA_Non_UXNavigation(true);

			//=========================================Steps To Revert Payment Parameter Setup Settings Is Started Here===========================================================================================================================================================================================================================================================
			parentlogger.log(LogStatus.INFO, "Following Function Is Called :: "+RMA_GenericUsages_Utility.RMA_LoggerHyperlink("Suite28ParaSetupSettings","RMA_Suite28_Utility",0)+"General System Parameter Settings Are Done");
			testcall5 = true;
			RMA_Functionality_Utility.RMA_Suite28_Utility("RMA_QTPRegression_TC_104_unCheck", logval1);
			parentlogger.log(LogStatus.INFO, "UI Settings Successfully Completed");
			loggerval5 = logger.toString();
			parentlogger.appendChild(logger);
			//=========================================Steps To Revert Payment Parameter Setup Settings Is Completed Here===========================================================================================================================================================================================================================================================
			...
			{
				logger.log(LogStatus.FAIL, "Following Error Occurred  ::" + " "+  color.RMA_ChangeColor_Utility(FinalErrorMessage,1)+ " " + "While Executing Function Utility" +" "+ "RMA_Suite28_Utility" + " " +  "To Do settings On Payment Parameter SetupPage And Hence The Test Case Is A Fail");
				parentlogger.appendChild(logger);
			...
			{
				logger.log(LogStatus.FAIL, "Following Error Occurred  ::" + " "+  color.RMA_ChangeColor_Utility(FinalErrorMessage,1)+ " " + "While Executing Function Utility" +" "+ "RMA_Suite28_Utility" + " " +  "To Revert Settings On Payment Parameter Setup Page And Hence The Test Case Is A Fail");
				parentlogger.appendChild(logger);
				reports.endTest(logger);
			}
