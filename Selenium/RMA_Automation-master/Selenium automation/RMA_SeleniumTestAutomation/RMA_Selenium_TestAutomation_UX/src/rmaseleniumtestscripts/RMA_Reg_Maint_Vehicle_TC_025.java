...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_Reg_Maint_Vehicle_TC_025
//Description    : Update SMS Permission From Vehicle Maintenance Is Validated
//Depends On TC  : None
//Revision       : 0.0 - JannathHussain-03-15-2018 
//======================================================================================================================================================================================================================================================================================

public class RMA_Reg_Maint_Vehicle_TC_025  extends rmaseleniumtestscripts.RMA_TC_BaseTest  {
	@Test	
	public void RMA_Reg_Maint_Vehicle_TC_025_Test() throws Exception, Error
	{   
		try {	 	 
			...
			parentlogger = reports.startTest("RMA_Reg_Maint_Vehicle_TC_025_View SMS Permission Setting For Vehicle Is Validation", "Functionality of View For Vehicle Permission Setting On Security Management System Is Validated");
			parentlogger.assignAuthor("Jannath Hussain");

			StrScreenShotTCName = "RMA_Reg_Maint_Vehicle_TC_025";
			...
			RMAApp_SMS_Lnk_DataSourceName = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_Reg_Maint_Vehicle_TC_022", 4, 0); //Data Source Name Is Fetched From DataSheet RMA_Reg_Maint_Vehicle_TC_025			
			RMAApp_Login_Txt_UserName = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_Reg_Maint_Vehicle_TC_022", 1, 1); //UserName Fetched From DataSheet RMA_Reg_Maint_Vehicle_TC_025
			RMAApp_Login_Txt_Password = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_Reg_Maint_Vehicle_TC_022", 1, 2); //Password Fetched From DataSheet RMA_Reg_Maint_Vehicle_TC_025
			...
			RMAApp_SMS_Lnk_ModuleSecurityGroup = ExcelData_1.RMA_ExcelStringDataRead_Utility("RMA_Reg_Maint_Vehicle_TC_022", 1, 3); //Module Security Group Name Is Fetched From DataSheet RMA_Reg_Maint_Vehicle_TC_025
			RMAApp_SMS_Lnk_ModuleAccessPermission = ExcelData_1.RMA_ExcelStringDataRead_Utility("RMA_Reg_Maint_Vehicle_TC_022", 1, 4); //Module Access Permission Name Is Fetched From DataSheet RMA_Reg_Maint_Vehicle_TC_025			
			...
			RMA_Navigation_Utility.RMA_ObjectClick(rmaseleniumPOM_UX.RMA_Selenium_POM_Vehicle.RMAApp_Vehicle_SMS_View(driver, "Update"),"Click On View From Module Access Permission On Security Management System Page",logval);
			...
			//===========================================================Verification Of Disabled Fields From Vehicle As Per SMS Permission Is Started Here==============================================================================================================================================================================================================================================================================================================================================================
		    ...
		    RMA_Verification_Utility.RMA_EnbDisbStateVerify_Utility(RMA_Selenium_POM_Vehicle.RMAApp_Vehicle_Txt_VehicleModel(driver),"disable", "Vehicle Modal Field", logval);
			RMA_Verification_Utility.RMA_EnbDisbStateVerify_Utility(RMA_Selenium_POM_Vehicle.RMAApp_Vehicle_Txt_VehicleID(driver),"disable", "VehicleID Field", logval);
			RMA_Verification_Utility.RMA_EnbDisbStateVerify_Utility(RMA_Selenium_POM_Vehicle.RMAApp_Vehicle_Txt_VehicleMake(driver),"disable", "VehicleMake Field", logval);
        	RMA_GenericUsages_Utility.RMA_StaticWait(3, logval, "Wait Is Added Verify Permission Message");
        	RMA_GenericUsages_Utility.RMA_WebPageRefresh_Utility_UX(logval);
			//===========================================================Verification Of Disabled Fields From Vehicle As Per SMS Permission Is Completed Here============================================================================================================================================================================================================================================================================================================================================================

			//===========================================================Revert Update Permission Is Started Here==============================================================================================================================================================================================================================================================================================================================================================================================================================================================	
			driver.switchTo().window(StrRMAWindowHandle);
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_Login_DSNSelect_Frames.RMAApp_Dashboard_Lbl_SMS(driver), "Security Management System Navigation Option Label On RiskMaster Application's Dashboard Page",logval);
			RMA_GenericUsages_Utility.RMA_WindowSwitchingBasedOnTitle("Riskmaster Security");
			RMA_Verification_Utility.RMA_VerifyUXSpinnerDisappered(logval);
			...
			RMA_Verification_Utility.RMA_VerifyUXSpinnerDisappered(logval);
			//===========================================================Revert Update Permission Is Completed Here==============================================================================================================================================================================================================================================================================================================================================================================================================================================================
