...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_SeleniumRegression_TC_102
//Description    : Create, Edit and Delete of Attachments For A Newly Created General Claim Is Validated
//Depends On TC  : None
//Revision       : 0.0 - ShrutiShruti-01-10-2018
//======================================================================================================================================================================================================================================================================================

public class RMA_SeleniumRegression_TC_102 extends RMA_TC_BaseTest{
	@Test 
	public void RMA_SeleniumRegression_TC_102_Test() throws Exception,Error{
		try{
			parentlogger = reports.startTest("RMA_SeleniumRegression_TC_102_Create, Edit And Delete Of Attachments_General Claim", "Create, Edit And Delete Of Attachments On A Newly Created General Claim Is Validated");
			...
			StrScreenShotTCName = "RMA_SeleniumRegression_TC_102";
			ErrorMessage = null;
			CurrentFrameID=null;
