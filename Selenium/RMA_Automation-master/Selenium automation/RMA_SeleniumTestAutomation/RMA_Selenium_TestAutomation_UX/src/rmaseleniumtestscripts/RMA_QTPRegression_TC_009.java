...
//=====================================================================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_QTPRegression_TC_009
//Description    : '7 - Claims with same claimant SSN & From - To Date Range' Duplicate Payment Criteria Is Validated 
//Revision       : 0.0 - NidhiJha-07-24-2017
//===================================================================================================================================================================================================================================================================================================================================

public class RMA_QTPRegression_TC_009 extends RMA_TC_BaseTest{
	@Test
	public void RMA_QTPRegression_TC_009_Test() throws Exception,Error {

		StrScreenShotTCName = null;
		StrScreenShotTCName = "RMA_QTPRegression_TC_009";
		testcall1 = false;	
		...
		try{   
			parentlogger = reports.startTest("RMA_QTPRegression_TC_009_Duplicate_Payment_Criteria_7_Validation", "'7 - Claims with same claimant SSN & From - To Date Range' Duplicate Payment Criteria Is Validated ");
			...
			Payment_Lst_PayeeType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_009", 1, 0); // Payee Type Is Fetched From DataSheet RMA_QTPRegression_TC_009
			FundsSplitDetails_Lst_TransactionType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_009", 1, 1); //Transaction Type Is Fetched From DataSheet RMA_QTPRegression_TC_009
			FundsSplitDetails_Txt_Amount = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_QTPRegression_TC_009", 1, 2); //Amount Is Fetched From DataSheet RMA_QTPRegression_TC_009
			Payment_Txt_LastName = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_009", 1, 3); //LastName Is Fetched From DataSheet RMA_QTPRegression_TC_009
			Payment_Txt_DisType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_009", 1, 4); //Distribution Type Is Fetched From DataSheet RMA_QTPRegression_TC_009
			ReserveType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_009", 1, 5); // Reserve Type Is Fetched From DataSheet RMA_QTPRegression_TC_009
			//Payment Data Fetched Is Completed Here

			GenClaimCreation_Txt_ClaimType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_009", 1, 6); //Claim Type Is Fetched From DataSheet RMA_QTPRegression_TC_009
			GenClaimCreation_Txt_ClaimStatus =  ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_009", 1,7 ); //Claim Status Is Fetched From DataSheet RMA_QTPRegression_TC_009
			GenClaimCreation_Txt_Department = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_009", 1,8 ); //Department Is Fetched From DataSheet RMA_QTPRegression_TC_009
			...
			rmaseleniumutilties_UX.RMA_Functionality_Utility.DuplicatePaymentCriteria_Utility("7 - Claims with same claimant SSN & From - To Date Range", logval);
			...
			testcall4 = true;
			RMA_Functionality_Utility.RMA_UnsuccessfulPaymentCorpAddition_Utility(Payment_Txt_BankAccount, Payment_Lst_PayeeType,ReserveType, FundsSplitDetails_Lst_TransactionType,FundsSplitDetails_Txt_Amount, Payment_Txt_LastName, Payment_Txt_DisType, "7 - Claims with same claimant SSN & From - To Date Range", logval1);
			...
			{
				logger.log(LogStatus.FAIL, "Following Error Occurred  ::" + " "+  color.RMA_ChangeColor_Utility(FinalErrorMessage,1)+ " " + "While Executing Function Utility" +" "+ "RMA_ClaimEventEntityAddition_Utility" + " " +  "To Create Successful New Claimant  And Hence The Test Case Is A Fail");
				parentlogger.appendChild(logger);
				reports.endTest(logger);	
			}
