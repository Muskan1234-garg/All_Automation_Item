...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_SeleniumRegression_TC_071
//Description    : Create,Edit and Delete Of Enhanced Note On A Person Involved(Driver) Is Validated
//Depends On TC  : RMA_SeleniumRegression_TC_058
//Revision       : 0.0 - ShrutiShruti-12-13-2017 
//======================================================================================================================================================================================================================================================================================


public class RMA_SeleniumRegression_TC_071 extends RMA_TC_BaseTest{
	@Test
	public void RMA_SeleniumRegression_TC_071_Test() throws Exception,Error{
		try{
			parentlogger = reports.startTest("RMA_SeleniumRegression_TC_071_Create, Edit And Delete Of Enhanced Notes On Person Involved(Driver) Screen", "Create,Edit and Delete Of Enhanced Note On A Person Involved(Driver) Is Validated");
			parentlogger.assignAuthor("Shruti Shruti");

			StrScreenShotTCName = "RMA_SeleniumRegression_TC_071";
			testcall1 = false;	
