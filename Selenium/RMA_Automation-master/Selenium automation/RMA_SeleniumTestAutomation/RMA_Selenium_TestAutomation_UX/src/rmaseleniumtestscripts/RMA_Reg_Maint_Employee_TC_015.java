...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_Reg_Maint_Employee_TC_015
//Description    : Verify That Correct Validation Message Is Displayed When User Enters Termination Date Greater Than Todays Date
//Depends On TC  : None
//Revision       : 0.0 - DebasmitaPati-02-09-2018
//======================================================================================================================================================================================================================================================================================
public class RMA_Reg_Maint_Employee_TC_015 extends RMA_TC_BaseTest {
		
	@Test
		public void RMA_Reg_Maint_Employee_TC_015_Test() throws Exception,Error {

		try{
			parentlogger = reports.startTest("RMA_Reg_Maint_Employee_TC_015_Verify That Correct Validation Message Is Displayed When User Enters Termination Date Greater Than Todays Date","Validation Message Is Verified Successfully When User Enters Termination Date Greater Than Todays Date");
			...
			StrScreenShotTCName = "RMA_Reg_Maint_Employee_TC_015";
			ErrorMessage = null;
			CurrentFrameID=null;
			...
			Termination_Date = RMA_GenericUsages_Utility.RMA_PastFutureDateInfo_Utility(0,1,0,"MM/dd/yyyy");
			...
			RMA_Functionality_Utility.RMA_GenericSave_Utility(CurrentFrameID, true, "Date Employment Termination Must be less than or equal to Today's Date:"+Todays_Date,  "Maintenance-->Employee Page", logval);
			parentlogger.log(LogStatus.PASS, color.RMA_ChangeColor_Utility("Date Employment Termination Must be less than or equal to Today's Date: "+Todays_Date, 2)+ " Validation Message Is Verified Successfully");
