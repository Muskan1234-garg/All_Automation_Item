...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_SeleniumRegression_TC_040
//Description    : Add, Edit And Delete Of Existing OtherPerson As Person Involved For Created Claim/Event/Litigation Is Validated
...
//======================================================================================================================================================================================================================================================================================
public class RMA_SeleniumRegression_TC_040 extends RMA_TC_BaseTest {
	@Test
	public void RMA_SeleniumRegression_TC_040_Test() throws Exception,Error {
		try{
			parentlogger = reports.startTest("RMA_SeleniumRegression_TC_040_Add, Edit And Delete Of Existing PI OtherPerson", "Add, Edit And Delete Of Existing OtherPerson As Person Involved For Created Claim/Event/Litigation Is Validated");
			...
			StrScreenShotTCName = "RMA_SeleniumRegression_TC_040";
			ErrorMessage = null;
			CurrentFrameID=null;
			//Global Variable Initialization Completed 
			
			//===========================================================Addition Of Existing OtherPerson As Person Involved Is Started Here================================================================================================================================================================================================================================================================
			RMA_GenericUsages_Utility.RMA_ConditionalFrameSwitching(DefaultFrameID);
			parentlogger.log(LogStatus.INFO, "Following Function Is Called :: "+RMA_GenericUsages_Utility.RMA_LoggerHyperlink("PIExistingEntityAdd", "RMA_PersonInvolvedExistingEntityAdd_Utility",0)+" To Add Existing OtherPerson As Person Involved For Record"+ " "+color.RMA_ChangeColor_Utility(StrClaimNumber, 2));
			testcall1 = true;
			StrOtherPersonLastName=RMA_Maintenance_Functionality_Utility.RMA_PersonInvolvedExistingEntityAdd_Utility("OtherPerson", StrClaimNumber,RMA_SeleniumRegression_TC_034_PI_DataCreation.StrOtherPersonLastName, "Adjusters",logval1);
			loggerval1 = logger.toString();
			parentlogger.appendChild(logger);
			parentlogger.log(LogStatus.INFO, "Existing OtherPerson With Last Name"+ " "+color.RMA_ChangeColor_Utility(StrOtherPersonLastName, 2)+ " "+ "Is Added As Person Involved To Record"+ " "+color.RMA_ChangeColor_Utility(StrClaimNumber, 2));;
			CurrentFrameID = RMA_GenericUsages_Utility.RMA_GetCurrentFrameID();
			// Existing OtherPerson As Person Involved Is Successfully Created
			//============================================================Addition Of Existing OtherPerson As Person Involved Is Completed Here================================================================================================================================================================================================================================================================
			
			//===========================================================Verification That Added OtherPerson As Person Involved Is Displayed On Claim Right Hand Navigation Tree And Can Be Navigated From There Is Started Here==================================================================================================================================================
			...
			//RMA_GenericUsages_Utility.RMA_StaticWait(5, logval, "Wait Is Added As User Migrates Back To Entity (Claim/Event/Litigation) Page");
			...
			//===========================================================Verification That Added OtherPerson As Person Involved Is Displayed On Claim Right Hand Navigation Tree And Can Be Navigated From There Is Completed Here=====================================================================================================================================================================
			
			//==========================================================Edit Of Existing OtherPerson Added Person Involved Is Started Here===========================================================================================================================================================================================================================================================================================
