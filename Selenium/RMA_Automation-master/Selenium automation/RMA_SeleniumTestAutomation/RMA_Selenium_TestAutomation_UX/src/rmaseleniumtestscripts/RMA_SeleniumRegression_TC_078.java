...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_SeleniumRegression_TC_078
//Description    : Create,Edit and Delete Of Enhanced Note On A Person Involved(Medical Staff) On A Litigation Page Is Validated
//Depends On TC  : RMA_SeleniumRegression_TC_024
//Revision       : 0.0 - ShrutiShruti-12-19-2017 
//======================================================================================================================================================================================================================================================================================

public class RMA_SeleniumRegression_TC_078 extends RMA_TC_BaseTest{
	@Test
	public void RMA_SeleniumRegression_TC_078_Test() throws Exception,Error{
		try{
			parentlogger = reports.startTest("RMA_SeleniumRegression_TC_078_Create,Edit and Delete Of Enhanced Note On A Person Involved(Medical Staff) On A Litigation Page", "Create,Edit and Delete Of Enhanced Note On A Person Involved(Medical Staff) On A Litigation Page Is Validated");
			parentlogger.assignAuthor("Shruti Shruti");

			StrScreenShotTCName = "RMA_SeleniumRegression_TC_078";
			testcall1 = false;	
			...
			testcall2 = true;
			EnhancedNotes = RMA_Functionality_Utility.RMA_EnhancedNotesCreateEditDelete_SubEntity_Utility("Create/Edit", "Confidential", "CF Confidential",StrClaimNumber,StrMedicalStaffLastName, "NotRequired",Edit,logval1);
