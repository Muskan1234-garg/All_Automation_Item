...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_Reg_Maint_Employee_TC_033
//Description    : Verify That Sequence Of ToolBar Buttons Are Getting Changed Via UX Power View On Violation Page
//Depends On TC  : None
//Revision       : 0.0 - ShrutiShruti-03-06-2018 
//======================================================================================================================================================================================================================================================================================

public class RMA_Reg_Maint_Employee_TC_033 extends RMA_TC_BaseTest{
	@Test
	public void RMA_Reg_Maint_Employee_TC_033_Test() throws Exception,Error{
		try{
			parentlogger = reports.startTest("RMA_Reg_Maint_Employee_TC_033_Verify Sequence Of ToolBar Button Is Changed According To The User For Violations", "User Changes The Sequence Of ToolBar Buttons Then The Same Is Updated In UX On Violation Page Is Validated");
			...
			String [] expected={"Save","Delete Record","Record Summary","Lookup"};
			...
			//Function To Verify Sequence Of ToolBar Buttons Started Here=====================================================================================
			String [] expectedVerify={"Delete Record","Save","Record Summary","Lookup"};
