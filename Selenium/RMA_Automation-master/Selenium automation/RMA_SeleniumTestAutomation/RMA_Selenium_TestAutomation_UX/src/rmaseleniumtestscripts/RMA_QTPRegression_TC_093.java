...
//=====================================================================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_QTPRegression_TC_093
//Description    : Verification Of Clearing Bank Deposits
//Depends On TC  : None
//Revision       : 0.0 - AnubhutiVyas-12-07-2017
//===================================================================================================================================================================================================================================================================================================================================

public class RMA_QTPRegression_TC_093 extends RMA_TC_BaseTest{
	@Test
	public void RMA_QTPRegression_TC_093_Test() throws Exception,Error {
		...
		StrScreenShotTCName = "RMA_QTPRegression_TC_093";	
		...
		try{
			parentlogger = reports.startTest("RMA_QTPRegression_TC_093_Clearing Bank Deposit",  "Verification Of Clearing Bank Deposits");
			...
			DepositCreation_Txt_TransactionAmount = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_QTPRegression_TC_093",1,0);//Transaction Amount Is Fetched From DataSheet RMA_QTPRegression_TC_093
			...
			RMA_GenericUsages_Utility.RMA_StaticWait(6, logval, "Wait Is Added As Parent Frame Needs To Get Switched");
			...
			//========================================Steps To Clear The Deposit Is Started Here==========================================================================================================================================================================
			RMA_Navigation_Utility.RMA_WebCheckBoxSelect_Utility(RMA_Selenium_POM_BankAccount.RMAApp_BankAccount_Deposit_Chk_Cleared(driver), "check", "Cleared Checkbox", "Bank Account Deposit Page", logval);
			RMA_GenericUsages_Utility.RMA_WindMsgHandlerAndTextVerify_Utility("Yes", "NA", RMA_Selenium_POM_VerificationMessage.BankAccountDepositClearedMsg, "Message Displayed When Cleared Checkbox On Bank Account Deposit Screen Is Checked", logval);
			StrPrimaryWindowHandle = driver.getWindowHandle();
			RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_BankAccount.RMAApp_BankAccount_Deposit_Btn_Description(driver), "Description Button On Deposit Page", logval);
			RMA_GenericUsages_Utility.RMA_StaticWait(5, logval, "Wait Is Added For Description Window To Open On Deposit Page");
			RMA_GenericUsages_Utility.RMA_MultipleWindowSwitching_Utility(4, StrRMAWindowHandle, StrRMAUXWindowHandle, StrPrimaryWindowHandle, "NA", "NA", "Navigation TO Description Memo On Deposit Page", logval);
			RMA_Input_Utility.RMA_SetValue_Utility(RMA_Selenium_POM_BankAccount.RMAApp_BankAccount_Deposit_Txt_Memo(driver), "Description Memo On Deposit Page", "To Clear The Deposit ", logval);
			RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_BankAccount.RMAApp_BankAccount_Deposit_Description_Btn_Ok(driver), "Ok Button On Description Memo Window On Deposit Page ", logval);
			RMA_GenericUsages_Utility.RMA_StaticWait(5, logval, "Wait Is Added As OK Button Is Clicked On Description Window On Deposit Page");
			driver.switchTo().window(StrPrimaryWindowHandle);
			RMA_GenericUsages_Utility.RMA_DynamicFrameSwitching(ParentFrame);
			RMA_GenericUsages_Utility.RMA_DynamicFrameSwitching(RMA_Selenium_POM_VerificationMessage.BankAccountFrame);
			RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_Home.RMAApp_Generic_Img_Save(driver), "Save Image On Deposit Page", logval);// Save Button Is Clicked
			parentlogger.log(LogStatus.INFO, logger.addScreenCapture(RMA_ScreenCapture_Utility.RMA_ScreenShotCapture_Utility(driver, "Successful Verification Of Clearing Bank Deposits", "Successful Clearing Of Bank Deposits")));
			//=========================================Steps To Clear The DepositIs Completed Here==========================================================================================================================================================================
