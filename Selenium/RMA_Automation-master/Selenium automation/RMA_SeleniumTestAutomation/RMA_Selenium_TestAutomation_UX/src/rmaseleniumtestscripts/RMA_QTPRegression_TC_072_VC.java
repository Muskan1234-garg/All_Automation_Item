...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_QTPRegression_TC_072_VC
//Description    : Create A New Vehicle Compensation Claim Is Validated
//Depends On TC  : None
//Revision       : 0.0 - AbhishekRai-10-05-2017 
//======================================================================================================================================================================================================================================================================================
public class RMA_QTPRegression_TC_072_VC extends RMA_TC_BaseTest {

	@Test
	public void RMA_QTPRegression_TC_072_VC_Test() throws Exception,Error {

		try{
			parentlogger = reports.startTest("RMA_QTPRegression_TC_072_VC_Create A New Vehicle Compensation Claim", "Create A New Vehicle Compensation Claim Is Validated");
			...
			StrScreenShotTCName = "RMA_QTPRegression_TC_072_VC";
			ErrorMessage = null;
			CurrentFrameID=null;
			...
			VehicleClaim_Txt_ClaimType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_072_VC", 1, 0); // Claim Type Is Fetched From DataSheet RMA_QTPRegression_TC_072_VC
			VehicleClaim_Txt_Department = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_072_VC", 1, 1); // Department Is Fetched From DataSheet RMA_QTPRegression_TC_072_VC
			//EndRegion ==================================================Data Fetch From Excel WorkBook Is Completed Here==================================================================================================

			//Region =====================================================Vehicle Compensation Claim Creation Is Started Here===============================================================================================================================================================================================
			...
			//EndRegion ==================================================Vehicle Compensation Claim Creation Is Completed Here==============================================================================================================================================================================================
