...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_QTPRegression_TC_033
//Description    : Date/Time Validations For General Claims When Time Zone Is Enabled For Org Level: Client & Time Zone Is CST
//Depends On TC  : None
//Revision       : 0.0 - AnubhutiVyas-10-31-2017 
//======================================================================================================================================================================================================================================================================================
public class RMA_QTPRegression_TC_033 extends RMA_TC_BaseTest {

	@Test
	public void RMA_QTPRegression_TC_033_Test() throws Exception,Error {


		try{
			parentlogger = reports.startTest("RMA_QTPRegression_TC_033_Date Time Validations For General Claim Creation For Time Zone CST", "Date/Time Validations For General Claims When Time Zone Is Enabled For Org Level: Client & Time Zone Is CST");
			parentlogger.assignAuthor("Anubhuti Vyas");

			StrScreenShotTCName = null;
			StrScreenShotTCName = "RMA_QTPRegression_TC_033";
			testcall1 = false;	
			...
			MaintOrgHierarchy_Txt_TimeZone = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_032", 1,5); //Time Zone Is Fetched From DataSheet RMA_QTPRegression_TC_032
