...
//=====================================================================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_QTPRegression_TC_060
//Description    : Creating Deposit From Funds Link Is Validated 
//Depends On TC  : None
//Revision       : 0.0 - NidhiJha-09-04-2017
//===================================================================================================================================================================================================================================================================================================================================

public class RMA_QTPRegression_TC_060 extends RMA_TC_BaseTest{
	@Test
	public void RMA_QTPRegression_TC_060_Test() throws Exception,Error {
		...
		StrScreenShotTCName = "RMA_QTPRegression_TC_060";	
		...
		try{
			parentlogger = reports.startTest("RMA_QTPRegression_TC_060_Deposit_Validation",  "Creating Deposit From Funds Link Is Validated");
			...
			CheckStockCreation_Txt_FontStyle = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_060", 1, 0);//Font Style Is Fetched From DataSheet RMA_QTPRegression_TC_060
			CheckStockCreation_Txt_FontSize = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_QTPRegression_TC_060", 1, 1);//Font Size Is Fetched From DataSheet RMA_QTPRegression_TC_060
			//Check Stock Data Fetch From Excel WorkBook Is Completed Here
			DepositCreation_Txt_TransactionAmount = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_QTPRegression_TC_060", 1, 2);//Transaction Amount Is Fetched From DataSheet RMA_QTPRegression_TC_060
			...
			RMA_Navigation_Utility.RMA_ObjectClick(rmaseleniumPOM.RMA_Selenium_POM_Home.RMAApp_DefaultView_Btn_Close(driver), "Close Button On Claim Page", logval);
			...
			testcall3 = true;
			DepositCreation_Txt_ControlNumber = RMA_Functionality_Utility.RMA_DepositCreation_Utility(BankAccountCreation_Txt_BankAccountName, DepositCreation_Txt_TransactionDate, DepositCreation_Txt_TransactionAmount, false, logval1);
			...
			//==========================================Steps To Create Verify Deposit Control Number Through Navigation To Funds---> Bank Account Is Started Here=======================================================================================================================================================================================================================
			...
			{
				logger.log(LogStatus.FAIL, "Following Error Occurred  ::" + " "+  color.RMA_ChangeColor_Utility(FinalErrorMessage,1)+ " " + "While Executing Function Utility" +" "+ "RMA_CheckStocksCreation_Utility" + " " +  "To Create Check Stocks On Bank Account And Hence The Test Case Is A Fail");
				parentlogger.appendChild(logger);
				reports.endTest(logger);	
			}
