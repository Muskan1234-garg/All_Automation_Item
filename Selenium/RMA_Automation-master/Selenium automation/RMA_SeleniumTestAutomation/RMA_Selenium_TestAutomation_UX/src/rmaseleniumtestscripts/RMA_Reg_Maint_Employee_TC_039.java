...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_Reg_Maint_Employee_TC_039
//Description    : Verify That User Is Able To Add Again ToolBar Button And Field Via UX PowerView In Violation Page
//Depends On TC  : None
//Revision       : 0.0 - ShrutiShruti-03-06-2018 
//======================================================================================================================================================================================================================================================================================

public class RMA_Reg_Maint_Employee_TC_039 extends RMA_TC_BaseTest{
	@Test
	public void RMA_Reg_Maint_Employee_TC_039_Test() throws Exception,Error{
		try{
			parentlogger = reports.startTest("RMA_Reg_Maint_Employee_TC_039_Verify That Fields And ToolBar Button Is Added In The Violation", "Verify That User Is Able To Add Again ToolBar Button And Field Via UX PowerView In Violation Page Is Validated");
			...
			StrScreenShotTCName = "RMA_Reg_Maint_Employee_TC_039";
			ErrorMessage = null;
			...
			RMA_NegativeVerification_Utility.RMA_ElementNotExist_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_Img_DeleteRecord(driver), "Delete Record Image Button on Violaton Creation Page", logval);
			RMA_NegativeVerification_Utility.RMA_ElementNotExist_Utility(RMA_Selenium_POM_Violations.RMAApp_Violations_Txt_Violation(driver), "Violation TextBox On Violation Creation Page", logval);
			...
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_PowerView.RMAApp_PowerView_Lbl_Entity(driver, "Employee Violation Info"), "Employee Violation Info Label On Power View Editor Page", logval);
			...
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_PowerView.RMAApp_PowerView_DropDwn_ToolbarSidePanel(driver), "ToolBar DropDown On Side Panel On Power View Editor Page", logval);
			RMA_Navigation_Utility.RMA_ObjectDragAndDrop(RMA_Selenium_POM_PowerView.RMAApp_PowerView_DeleteField(driver), RMA_Selenium_POM_PowerView.RMAApp_PowerView_Area_ToolBarField(driver), "Delete Record ToolBar Button", "ToolBar DropDown Menu", "Power View Editor Page", logval);
			...
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_PowerView.RMAApp_PowerView_Tab_ControlPalette(driver, "Violation"), "Violation Tab On Control Palette On Pwer View Editor Page", logval);
			RMA_Navigation_Utility.RMA_ObjectDragAndDrop(RMA_Selenium_POM_PowerView.RMAApp_PowerView_ViolationField(driver), RMA_Selenium_POM_PowerView.RMAApp_PowerView_Area_Fields(driver), "Violation Field On Drop Down Of Control Palette", "Fields Placed Area", "Power View Editor Page", logval);
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_PowerView.RMAApp_PowerView_Btn_Save(driver), "Save Button On Power View Editor Page", logval);
			...
			RMA_Verification_Utility.RMA_ElementExist_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_Img_DeleteRecord(driver), "Delete Record Image Button On Power View Editor Page", logval);
			driver.close();
			//Verification Done After Making Changes In PowerView
