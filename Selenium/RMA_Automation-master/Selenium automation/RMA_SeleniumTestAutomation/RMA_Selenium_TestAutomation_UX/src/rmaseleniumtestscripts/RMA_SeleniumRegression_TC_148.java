...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_SeleniumRegression_TC_148
//Description    : Create,Edit And Delete Of Attachments On Patient Tracking On Maintenance Screen
//Depends On TC  : RMA_Smoke_TC_041_I
//Revision       : 0.0 - ShrutiShruti-01-11-2018 
//======================================================================================================================================================================================================================================================================================

public class RMA_SeleniumRegression_TC_148 extends RMA_TC_BaseTest{
	@Test
	public void RMA_SeleniumRegression_TC_148_Test() throws Exception,Error{
		try{
			parentlogger = reports.startTest("RMA_SeleniumRegression_TC_148_Create, Edit and Delete of Attachmments On Patient Tracking Page On Maintenance Screen", "Create, Edit and Delete of Attachments On Patient Tracking Page on Maintenance Screen Is Validated");
			...
			StrScreenShotTCName = "RMA_SeleniumRegression_TC_148";
			ErrorMessage = null;
			CurrentFrameID=null;
			...
			//=================================================Steps To Delete Patient Tracking Started Here=================================================================================================================================================================================================
			RMA_Functionality_Utility.RMA_GenericDelete_Utility("Maintenance-->Patient Tracking", false, logval);
			RMA_Functionality_Utility.RMA_GenericDelete_Utility("Maintenance-->Patient Tracking", true, logval);
			//=================================================Steps To Delete Patient Tracking Completed Here=============================================================================================================================================================================================================================
			driver.switchTo().parentFrame();
		}
