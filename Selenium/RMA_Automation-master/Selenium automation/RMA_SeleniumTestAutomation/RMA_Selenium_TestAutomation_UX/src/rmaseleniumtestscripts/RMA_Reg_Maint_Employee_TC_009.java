...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_Reg_Maint_Employee_TC_009
//Description    : Verify That Correct Validation Message Is Displayed When User Enters Date Hired Less Than Date Of Birth
//Depends On TC  : None
//Revision       : 0.0 - DebasmitaPati-02-09-2018
//======================================================================================================================================================================================================================================================================================
public class RMA_Reg_Maint_Employee_TC_009 extends RMA_TC_BaseTest {
		
	@Test
		public void RMA_Reg_Maint_Employee_TC_009_Test() throws Exception,Error {

		try{
			parentlogger = reports.startTest("RMA_Reg_Maint_Employee_TC_009_Verify That Correct Validation Message Is Displayed When User Enters Date Hired Less Than Date Of Birth","Validation Message Is Verified Successfully When User Enters Date Hired Less Than Date Of Birth");
			...
			StrScreenShotTCName = "RMA_Reg_Maint_Employee_TC_009";
			ErrorMessage = null;
			CurrentFrameID=null;
			...
			Date_Hired = RMA_GenericUsages_Utility.RMA_PastFutureDateInfo_Utility(0,-1,-1,"MM/dd/yyyy");
			...
			RMA_Functionality_Utility.RMA_GenericSave_Utility(CurrentFrameID, true, "Date Hired must be greater than or equal to Date of Birth",  "Maintenance-->Employee Page", logval);
			parentlogger.log(LogStatus.PASS, color.RMA_ChangeColor_Utility("Date Hired must be greater than or equal to Date of Birth", 2)+ " Validation Message Is Verified Successfully");
