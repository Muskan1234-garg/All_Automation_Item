...
//==================================================================================================================================================================================
//TestCaseID   	 : RMA_QTPRegression_TC_066
//Description    : Deleting A Reserve Type from Utilities Is Validated
//Depends On TC  : RMA_QTPRegression_TC_065
//Revision       : 0.0 - AnubhutiVyas-08-31-2017 
//========================================================================================================================================================================================
public class RMA_QTPRegression_TC_066 extends RMA_TC_BaseTest{

	@Test 
	public void RMA_QTPRegression_TC_066_Test() throws Exception, Error
	{
		testcall1 = false;	
		loggerval1 = "NotInitialized";
		StrScreenShotTCName = null;
		StrScreenShotTCName = "RMA_QTPRegression_TC_066";
		...
		try {
			parentlogger = reports.startTest("RMA_QTPRegression_TC_066_Deleting A Reserve Type From Utilities", "Deleting A Reserve Type From Utilities Is Validated");
			...
			GenClaimCreation_Txt_ClaimType = ExcelDataClaim.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_066", 1, 0); //Claim Type Is Fetched From DataSheet RMA_QTPRegression_TC_066
			GenClaimCreation_Txt_ClaimStatus =  ExcelDataClaim.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_066", 1,1 ); //Claim Status Is Fetched From DataSheet RMA_QTPRegression_TC_066
			GenClaimCreation_Txt_Department = ExcelDataClaim.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_066", 1,2 ); //Department Is Fetched From DataSheet RMA_QTPRegression_TC_066
			//Claim Data Fetch From Excel WorkBook Is Completed Here

			RMA_GenericUsages_Utility.RMA_Non_UXNavigation(true);
			RMA_Functionality_Utility.RMA_Suite04_Utility("RMA_QTPRegression_TC_066", logval);//LOB Parameter Setting Is Done
			...
			RMA_Verification_Utility.RMA_VerifyUXSpinnerDisappered(logval);
			parentlogger.log(LogStatus.INFO, logger.addScreenCapture(RMA_ScreenCapture_Utility.RMA_ScreenShotCapture_Utility(driver, "Successful Reserve Type Deletion Verification", "Reserve Type Is Deleted Successfully")));
			RMA_NegativeVerification_Utility.RMA_NegVerifyMultipleDataInWebList(RMA_Selenium_POM_FinancialReserves.RMAApp_ReserveCreation_Lst_ReserveType(driver),ExpectedReserveType,"Reserve Type List",logval);
