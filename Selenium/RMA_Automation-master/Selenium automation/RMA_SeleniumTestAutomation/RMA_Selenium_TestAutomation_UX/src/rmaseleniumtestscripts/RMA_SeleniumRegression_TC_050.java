...
//================================================================================================
//TestCaseID     : RMA_SeleniumRegression_TC_050
//Description    : RMA_SeleniumRegression_TC_050_ Successful Creation Of A Diary From Litigation Is Validated
//Depends On TC  : RMA_Smoke_TC_002: For Claim Creation
//Revision       : 0.0 - RenuVerma-09-07-2017
//=================================================================================================

public class RMA_SeleniumRegression_TC_050 extends rmaseleniumtestscripts.RMA_TC_BaseTest {

	@Test
	public void RMA_SeleniumRegression_TC_050_Test() throws Exception,Error {
		
		StrScreenShotTCName ="RMA_SeleniumRegression_TC_050";
		...
		try{
			parentlogger = reports.startTest("RMA_SeleniumRegression_TC_050_ Attach A Diary From Litigation", "Successful Creation Of A Diary From Litigation Is Validated");
			...
			ActivityList = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_SeleniumRegression_TC_047", 1, 0); // Activity List Is Fetched From DataSheet RMA_SeleniumRegression_TC_050
			testcall1 = false;			
			loggerval1 = "NotInitialized";
			StrScreenShotTCName = "RMA_SeleniumRegression_TC_050";
			...
			RMA_GenericUsages_Utility.RMA_ConditionalFrameSwitching(DefaultFrameID);
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_Home.RMAApp_GenericClaim_Btn_Diary(driver), "Diary Image On Following  Litigation Screen::"+" "+StrLitigation,logval);
			DiaryTaskName = RMA_Functionality_Utility.RMA_AttachCreateEdit_Diary("Attached","NA",ActivityList,"NA","NA", "NA", "Important","litigation",logval);
			parentlogger.log(LogStatus.INFO, "Diary Is Created Successfully With TaskName :"+" "+color.RMA_ChangeColor_Utility(DiaryTaskName, 2)+" "+"On Litigation :"+" "+color.RMA_ChangeColor_Utility(StrLitigation,4));							
			Thread.sleep(1000);
			RMA_GenericUsages_Utility.RMA_ConditionalFrameSwitching(DefaultFrameID);
			RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_Home.RMAApp_Generic_Img_ViewRecordDiaries(driver), "View Record Diaries Image On  Litigation :"+" "+StrLitigation, logval);
			RMA_Verification_Utility.RMA_VerifyUXSpinnerDisappered(logval);
			RMA_GenericUsages_Utility.RMA_ConditionalFrameSwitching(RMA_Selenium_POM_VerificationMessage.DiaryFrame);
			RMA_Verification_Utility.RMA_VerifyUXGridPartially_Utility("Claim:"+StrClaimNumber, "Diary UX Grid",new String[]{ "Task Name","Priority","Attach Record"},new String[]{ DiaryTaskName,"Important", "Litigation"}, logval);
