...
//=====================================================================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_QTPRegression_TC_012
//Description    : '12 - Payment Total, Invoice Number, Split Amt and Trans Date Within X Days' Duplicate Payment Criteria Is Validated 
//Revision       : 0.0 - NidhiJha-07-31-2017
//===================================================================================================================================================================================================================================================================================================================================

public class RMA_QTPRegression_TC_012 extends RMA_TC_BaseTest {
	@Test
	public void RMA_QTPRegression_TC_012_Test() throws Exception,Error {

		StrScreenShotTCName = null;
		StrScreenShotTCName = "RMA_QTPRegression_TC_012";
		testcall1 = false;	
		...
		try{  
			...
			parentlogger = reports.startTest("RMA_QTPRegression_TC_012_Duplicate_Payment_Criteria_12_Validation", "'12 - Payment Total, Invoice Number, Split Amt and Trans Date within X Days' Duplicate Payment Criteria Is Validated ");
			...
			GenClaimCreation_Txt_DateOfEvent = RMA_GenericUsages_Utility.RMA_PastFutureDateInfo_Utility(0,-1,-1,"MM/dd/yyyy");
			...
			Payment_Lst_PayeeType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_012", 1, 0); // Payee Type Is Fetched From DataSheet RMA_QTPRegression_TC_012
			FundsSplitDetails_Lst_TransactionType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_012", 1, 1); //Transaction Type Is Fetched From DataSheet RMA_QTPRegression_TC_012
			FundsSplitDetails_Txt_Amount = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_QTPRegression_TC_012", 1, 2); //Amount Is Fetched From DataSheet RMA_QTPRegression_TC_012
			Payment_Txt_LastName = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_012", 1, 3); //LastName Is Fetched From DataSheet RMA_QTPRegression_TC_012
			Payment_Txt_DisType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_012", 1, 4); //Distribution Type Is Fetched From DataSheet RMA_QTPRegression_TC_012
			ReserveType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_012", 1, 5); // Reserve Type Is Fetched From DataSheet RMA_QTPRegression_TC_012
			//Payment Data Fetched Is Completed Here
			
			GenClaimCreation_Txt_ClaimType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_012", 1, 6); //Claim Type Is Fetched From DataSheet RMA_QTPRegression_TC_012
			GenClaimCreation_Txt_ClaimStatus =  ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_012", 1,7 ); //Claim Status Is Fetched From DataSheet RMA_QTPRegression_TC_012
			GenClaimCreation_Txt_Department = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_012", 1,8 ); //Department Is Fetched From DataSheet RMA_QTPRegression_TC_012
			...
			rmaseleniumutilties_UX.RMA_Functionality_Utility.DuplicatePaymentCriteria_Utility("12 - Payment Total, Invoice Number, Split Amt and Trans Date within X Days", logval);
			...
			parentlogger.log(LogStatus.INFO, "Following Function Is Called :: "+RMA_GenericUsages_Utility.RMA_LoggerHyperlink("UnsuccessfulPaymentAddition","RMA_UnsuccessfulPaymentCorpAddition_Utility",1)+" To Create Second Payment");
			testcall5 = true;
			RMA_Functionality_Utility.RMA_UnsuccessfulPaymentCorpAddition_Utility(Payment_Txt_BankAccount, Payment_Lst_PayeeType,ReserveType, FundsSplitDetails_Lst_TransactionType,FundsSplitDetails_Txt_Amount, Payment_Txt_LastName, Payment_Txt_DisType, "12 - Payment Total, Invoice Number, Split Amt and Trans Date within X Days_FourthPayment", logval1);
