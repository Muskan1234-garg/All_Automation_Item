...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_Reg_Maint_Employee_TC_043
//Description    : Verify That User Is Able To Remove Any Field And Save The Dependent On Main Screen Without Any Error
//Depends On TC  : None
//Revision       : 0.0 - ShrutiShruti-02-26-2018 
//======================================================================================================================================================================================================================================================================================

public class RMA_Reg_Maint_Employee_TC_043 extends RMA_TC_BaseTest{
	@Test
	public void RMA_Reg_Maint_Employee_TC_043_Test() throws Exception,Error{
		try{
			parentlogger = reports.startTest("RMA_Reg_Maint_Employee_TC_043_Verify That User Removes Any Field And Save Dependent Without Error", "User Is Able To Remove Any Field And Save The Dependent On Main Screen Without Any Error Is Validated");
			...
			StrScreenShotTCName = "RMA_Reg_Maint_Employee_TC_043";
			ErrorMessage = null;
			...
			Dependent_Creation_Txt_City=RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(3, "City_");
			...
			Login_Txt_UserName = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_Reg_Maint_Employee_TC_043", 1, 0); //UserName Fetched From DataSheet RMA_Reg_Maint_Employee_TC_043
			Login_Txt_Password = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_Reg_Maint_Employee_TC_043", 1, 1); //Password Fetched From DataSheet RMA_Reg_Maint_Employee_TC_043
			Login_Txt_UserName_1 = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_Reg_Maint_Employee_TC_043", 1, 2); //UserName Fetched From DataSheet RMA_Reg_Maint_Employee_TC_043
			Login_Txt_Password_1 = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_Reg_Maint_Employee_TC_043", 1, 3); //Password Fetched From DataSheet RMA_Reg_Maint_Employee_TC_043
			DSNSelect_Lst_DataSourceName = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_Reg_Maint_Employee_TC_043", DSRow, 4); //Data Source Name Is Fetched From DataSheet RMA_Reg_Maint_Employee_TC_043			
			Dependent_Creation_Txt_State=ExcelData.RMA_ExcelStringDataRead_Utility("RMA_Reg_Maint_Employee_TC_043", 1, 5); //State Fetched From DataSheet RMA_Reg_Maint_Employee_TC_043
			Dependent_Creation_Txt_Country=ExcelData.RMA_ExcelStringDataRead_Utility("RMA_Reg_Maint_Employee_TC_043", 1, 6); //Country Fetched From DataSheet RMA_Reg_Maint_Employee_TC_043
			...
			RMA_Verification_Utility.RMA_ElementExist_Utility(RMA_Selenium_POM_Dependents.RMAApp_Dependents_Txt_PostalCode(driver), "Zip/Postal Code TextBox On Dependents Creation Page", logval);
			RMA_Verification_Utility.RMA_ElementExist_Utility(RMA_Selenium_POM_Dependents.RMAApp_Dependents_Txt_City(driver), "City TextBox On Dependents Creation Page", logval);
			...
			globalWait.until(ExpectedConditions.visibilityOf(RMA_Selenium_POM_PowerView.RMAApp_PowerView_Btn_FieldDelete(driver, "Zip/Postal Code")));
			RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_PowerView.RMAApp_PowerView_Btn_FieldDelete(driver, "Zip/Postal Code"), "Zip/Postal Code Remove Field Button On Power View Editor Page", logval);
			RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_PowerView.RMAApp_PowerView_Btn_FieldDelete(driver, "City"), "City Remove Field Button On Power View Editor Page", logval);
			...
			RMA_NegativeVerification_Utility.RMA_ElementNotExist_Utility(RMA_Selenium_POM_Dependents.RMAApp_Dependents_Txt_PostalCode(driver), "Zip/Postal Code TextBox On Dependents Creation Page", logval);
			RMA_NegativeVerification_Utility.RMA_ElementNotExist_Utility(RMA_Selenium_POM_Dependents.RMAApp_Dependents_Txt_City(driver), "City TextBox On Dependents Creation Page", logval);
			...
			testcall2 = true;
			StrDependentsLastName= RMA_Maintenance_Functionality_Utility.RMA_EmployeeDependentsAddEditDeleteEntity_Utility("Create",Dependent_Creation_Txt_FirstName, Dependent_Creation_Txt_City,Dependent_Creation_Txt_State,Dependent_Creation_Txt_Country,Dependent_Creation_Txt_SSN, logval1);
			parentlogger.log(LogStatus.INFO, "New Dependent Is Created With Last Name::"+ " " + color.RMA_ChangeColor_Utility(StrDependentsLastName, 2));
			...
			globalWait.until(ExpectedConditions.visibilityOf(RMA_Selenium_POM_PowerView.RMAApp_EmployeePowerview_Lbl_Dependent(driver)));
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_PowerView.RMAApp_EmployeePowerview_Lbl_Dependent(driver), "Employee Dependent Label On Power View Editor Page", logval);
			globalWait.until(ExpectedConditions.visibilityOf(RMA_Selenium_POM_PowerView.RMAApp_PowerView_DropDown_ControlPalette(driver)));
			...
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_PowerView.RMAApp_PowerView_Tab_ControlPalette(driver, "Dependent Info"), "Dependent Info Tab Under Control Palette Drop Down On Power View Editor Page", logval);
			WebElement To=driver.findElement(By.xpath(".//*[@class='ng-scope ng-binding' and contains(text(),'Address 1')]//ancestor::div[6]"));
			RMA_Navigation_Utility.RMA_ObjectDragAndDrop(RMA_Selenium_POM_PowerView.RMAApp_PowerView_ControlPaletteField(driver, "Postal Code"), To, "Postal Code Field", "Dependents Field Area", "Power View Editor Page", logval);
			RMA_Navigation_Utility.RMA_ObjectDragAndDrop(RMA_Selenium_POM_PowerView.RMAApp_PowerView_ControlPaletteField(driver, "City"),To, "City Field", "Dependents Field Area", "Power VIew Editor Page", logval);
