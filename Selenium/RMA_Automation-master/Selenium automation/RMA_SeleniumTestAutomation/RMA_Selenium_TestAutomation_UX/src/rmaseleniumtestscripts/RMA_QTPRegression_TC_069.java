...
//==================================================================================================================================================================================
//TestCaseID   	 : RMA_QTPRegression_TC_069
//Description    : To Mark A Payment As Printed Is Validated
//Depends On TC  : None
//Revision       : 0.0 - AnubhutiVyas-08-22-2017 
//========================================================================================================================================================================================
public class RMA_QTPRegression_TC_069 extends RMA_TC_BaseTest{

	@Test 
	public void RMA_QTPRegression_TC_069_Test() throws Exception, Error
	{
		testcall1 = false;	
		...
		StrScreenShotTCName = "RMA_QTPRegression_TC_069";
		...
		try {
			parentlogger = reports.startTest("RMA_QTPRegression_TC_069_Mark A Payment As Printed", "To Mark A Payment As Printed Is Validated");
			...
			GenClaimCreation_Txt_ClaimType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_069", 1, 0); //Claim Type Is Fetched From DataSheet RMA_QTPRegression_TC_069
			GenClaimCreation_Txt_ClaimStatus =  ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_069", 1,1 ); //Claim Status Is Fetched From DataSheet RMA_QTPRegression_TC_069
			GenClaimCreation_Txt_Department = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_069", 1,2 ); //Department Is Fetched From DataSheet RMA_QTPRegression_TC_069
			//Claim Data Fetch From Excel WorkBook Is Completed Here

			Payment_Txt_BankAccount = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_069", 1, 3); // Bank account Is Fetched From DataSheet RMA_QTPRegression_TC_069
			Payment_Lst_PayeeType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_069", 1, 4); // Payee Type Is Fetched From DataSheet RMA_QTPRegression_TC_069
			FundsSplitDetails_Lst_TransactionType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_069", 1, 5); //Transaction Type For Medical Reserve Payment Is Fetched From DataSheet RMA_QTPRegression_TC_069
			FundsSplitDetails_Txt_Amount = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_QTPRegression_TC_069", 1, 6); //Medical Amount Is Fetched From DataSheet RMA_QTPRegression_TC_069
			Payment_Txt_LastName = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_069", 1, 7); //LastName Is Fetched From DataSheet RMA_QTPRegression_TC_069
			Payment_Txt_DisType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_069", 1, 8); //Distribution Type Is Fetched From DataSheet RMA_QTPRegression_TC_069
			ReserveCreation_Lst_ReserveType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_069", 1, 9); // Medical Reserve Type Is Fetched From DataSheet RMA_QTPRegression_TC_069
			...
			RMA_Navigation_Utility.RMA_ObjectActionsClick(RMA_Selenium_POM_PaymentsCollections.RMAApp_ChecksAndEOB_Btn_checkBatchSaveIcon(driver), "OK Button On Checks And EOB Reports Page",logval);
