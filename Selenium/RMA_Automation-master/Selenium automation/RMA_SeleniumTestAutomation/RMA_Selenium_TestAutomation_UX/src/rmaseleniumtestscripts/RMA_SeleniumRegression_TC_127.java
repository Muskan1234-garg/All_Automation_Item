...
public class RMA_SeleniumRegression_TC_127 extends RMA_TC_BaseTest{
	@Test
	public void RMA_SeleniumRegression_TC_127_Test() throws Exception,Error{
		try{
			parentlogger = reports.startTest("RMA_SeleniumRegression_TC_127_Create,Edit And Delete Of Enhanced Notes On Case Managers Page", "Create,Edit And Delete Of Enhanced Notes On Case Managers Is Validated");
