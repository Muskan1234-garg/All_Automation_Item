...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_SeleniumRegression_TC_127
//Description    : Create,Edit And Delete Of Enhanced Notes On Case Managers Page
//Depends On TC  : RMA_SeleniumRegression_TC_059
//Revision       : 0.0 - ShrutiShruti-03-01-2018 
//======================================================================================================================================================================================================================================================================================

public class RMA_SeleniumRegression_TC_161 extends RMA_TC_BaseTest{
	@Test
	public void RMA_SeleniumRegression_TC_161_Test() throws Exception,Error{
		try{
			parentlogger = reports.startTest("RMA_SeleniumRegression_TC_161_Create,Edit And Delete Of Enhanced Notes On Case Managers Page", "Create,Edit And Delete Of Enhanced Notes On Case Managers Is Validated");
