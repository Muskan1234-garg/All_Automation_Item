...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_SeleniumRegression_TC_115
//Description    : Create, Edit and Delete of Attachments For A Driver(PI) Is Validated
//Depends On TC  : None
//Revision       : 0.0 - ShrutiShruti-01-11-2018
//======================================================================================================================================================================================================================================================================================

public class RMA_SeleniumRegression_TC_115 extends RMA_TC_BaseTest{
	@Test
	public void RMA_SeleniumRegression_TC_115_Test() throws Exception,Error{
		try{
			parentlogger = reports.startTest("RMA_SeleniumRegression_TC_115_Create, Edit And Delete Of Attachments On Person Involved(Driver) Screen", "Create,Edit and Delete Of Attachments On A Person Involved(Driver) Is Validated");
			parentlogger.assignAuthor("Shruti Shruti");

			StrScreenShotTCName = "RMA_SeleniumRegression_TC_115";
			testcall1 = false;	
