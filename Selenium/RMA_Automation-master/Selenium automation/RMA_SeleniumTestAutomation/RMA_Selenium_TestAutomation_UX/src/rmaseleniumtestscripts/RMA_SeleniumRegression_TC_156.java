...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_SeleniumRegression_TC_56
//Description    : Create,Edit And Delete Of Enhanced Notes On DemandOffer On Injury/Illness Page
//Depends On TC  : RMA_SeleniumRegression_TC_059
//Revision       : 0.0 - ShrutiShruti-03-01-2018 
//======================================================================================================================================================================================================================================================================================

public class RMA_SeleniumRegression_TC_156 extends RMA_TC_BaseTest{
	@Test
	public void RMA_SeleniumRegression_TC_156_Test() throws Exception,Error{
		parentlogger = reports.startTest("RMA_SeleniumRegression_TC_156_Create,Edit And Delete Of Enhanced Notes On DemandOffer Page", "Create,Edit And Delete Of Enhanced Notes On Demand Offer On Injury/Illness Page Is Validated");
		...
		try{
			...
			StrScreenShotTCName = "RMA_SeleniumRegression_TC_097";
			ErrorMessage = null;
			CurrentFrameID=null;
		...
		catch(Exception|Error e)
		{
			...
			{
				logger.log(LogStatus.FAIL, "Following Error Occurred  ::" + " "+  color.RMA_ChangeColor_Utility(FinalErrorMessage,1)+ " " + "While Executing Following Function: " +" "+ "RMA_InjuryIlnessCreateEditDelete_Utility" + " " +  "And Hence The Test Case Is A Fail");
				parentlogger.appendChild(logger);
				reports.endTest(logger);	
			}
			if (testcall3 == true && loggerval2.equalsIgnoreCase("NotInitialized"))				
			{
				logger.log(LogStatus.FAIL, "Following Error Occurred  ::" + " "+  color.RMA_ChangeColor_Utility(FinalErrorMessage,1)+ " " + "While Executing Following Function: " +" "+ "RMA_DemandOfferCreateEditDelete_Utility" + " " +  "And Hence The Test Case Is A Fail");
				parentlogger.appendChild(logger);
				reports.endTest(logger);	
			}
	...
	public void RMA_FailureReport(ITestResult result) //All The Information Associated With The Test Case Is Stored In Result Variable
	{
		...
		finally
		{
			try {
				...
				driver.switchTo().parentFrame();
				RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_Home.RMAApp_DefaultView_Lbl_BreadcrumbName(driver,"Policy"),StrClaimNumber +" Claim Number Link At Top Of The Screen",logval);
