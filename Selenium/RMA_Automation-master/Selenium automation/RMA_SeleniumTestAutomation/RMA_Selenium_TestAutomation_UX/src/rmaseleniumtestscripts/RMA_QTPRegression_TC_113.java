...
//=====================================================================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_QTPRegression_TC_113
//Description    : Verify The Setting 'Calculate Collections In Incurred Balance(All Claims):' Is Not In Effect For The Recovery Reserve Is Validated
//Depends On TC  : None
//Revision       : 0.0 - AbhishekRai-10-24-2017
//===================================================================================================================================================================================================================================================================================================================================

public class RMA_QTPRegression_TC_113 extends RMA_TC_BaseTest {	
	
	@Test
	public void RMA_QTPRegression_TC_113_Test() throws Exception,Error {
		try{
			parentlogger = reports.startTest("RMA_QTPRegression_TC_113_Verify The Setting 'Calculate Collections In Incurred Balance(All Claims):' Is Not In Effect For The Recovery Reserve", "Verify The Setting 'Calculate Collections In Incurred Balance(All Claims):' Is Not In Effect For The Recovery Reserve Is Validated");
			parentlogger.assignAuthor("Abhishek Rai");		
			
			//Region =====================================================Global Variable Initialization Is Started Here=====================================================================================================
			StrScreenShotTCName = null;
			StrScreenShotTCName = "RMA_QTPRegression_TC_113";
			testcall1 = false;	
			...
			int FundsSplitDetails_Txt_Amount_1;			
			...
			LineOfBussinessParameterSetup_Lst_LOBType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_113", 1, 0); //LOB Type Is Fetched From DataSheet RMA_QTPRegression_TC_113
			GenClaimCreation_Txt_ClaimType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_113", 1, 1); //Claim Type Is Fetched From DataSheet RMA_QTPRegression_TC_113
			GenClaimCreation_Txt_ClaimStatus = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_113", 1, 2); // Claim Status Is Fetched From DataSheet RMA_QTPRegression_TC_113
			GenClaimCreation_Txt_Department = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_113", 1, 3); // Department Is Fetched From DataSheet RMA_QTPRegression_TC_113						
			ReserveCreation_Lst_ReserveType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_113", 1, 4); //Reserve Type Is Fetched From DataSheet RMA_QTPRegression_TC_113
			ReserveCreation_Lst_ReserveStatus = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_113", 1, 5); //Reserve Status Is Fetched From DataSheet RMA_QTPRegression_TC_113
			ReserveCreation_Txt_ReserveAmount = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_QTPRegression_TC_113", 1, 6); //Amount Is Fetched From DataSheet RMA_QTPRegression_TC_113
			ReserveCreation_Lst_ReserveType_1 = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_113", 1, 7); //Reserve Type_1 Is Fetched From DataSheet RMA_QTPRegression_TC_113
			ReserveCreation_Txt_ReserveAmount_1 = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_QTPRegression_TC_113", 1, 8); //Amount_1 Is Fetched From DataSheet RMA_QTPRegression_TC_113												
			PaymentCreation_Lst_BankAccount = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_113", 1, 9); //BankAccount Is Fetched From DataSheet RMA_QTPRegression_TC_113
			PaymentCreation_Lst_PayeeType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_113", 1, 10); //Payee Type Is Fetched From DataSheet RMA_QTPRegression_TC_113
			Payment_Txt_LastName = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_113", 1, 11); //Last Name Is Fetched From DataSheet RMA_QTPRegression_TC_113
			PaymentCreation_Txt_DisType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_113", 1, 12); //Distribution Type Is Fetched From DataSheet RMA_QTPRegression_TC_113			
			FundsSplitDetails_Txt_Amount = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_QTPRegression_TC_113", 1, 13); //Amount Is Fetched From DataSheet RMA_QTPRegression_TC_113			
			FundsSplitDetails_Lst_TransactionType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_113", 1, 14); //Transaction Type Is Fetched From DataSheet RMA_QTPRegression_TC_113									
			FundsSplitDetails_Txt_Amount_1 = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_QTPRegression_TC_113", 1, 15); //Amount Is Fetched From DataSheet RMA_QTPRegression_TC_113			
			FundsSplitDetails_Lst_TransactionType_1 = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_113", 1, 16); //Transaction Type Is Fetched From DataSheet RMA_QTPRegression_TC_113
			//EndRegion ==================================================Data Fetch From Excel WorkBook Is Completed Here==================================================================================================
					
			//Region =====================================================Steps To Select General System Parameter Settings Is Started Here=============================================================
			RMA_GenericUsages_Utility.RMA_Non_UXNavigation();			
			rmaseleniumutilties_UX.RMA_Functionality_Utility.RMA_Suite21_Check_Utility("RMA_QTPRegression_TC_113_01",LineOfBussinessParameterSetup_Lst_LOBType, logval);			
			...
			//EndRegion ==================================================Steps To Select General System Parameter Settings Is Completed Here=============================================================
			...
			testcall4 = true;
			StrControlNumber = RMA_Functionality_Utility.RMA_CollectionCorpAddition_Utility(PaymentCreation_Lst_BankAccount, PaymentCreation_Lst_PayeeType, ReserveCreation_Lst_ReserveType, FundsSplitDetails_Lst_TransactionType, FundsSplitDetails_Txt_Amount, Payment_Txt_LastName, PaymentCreation_Txt_DisType, logval1);
			...
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_Home.RMAApp_DefaultView_Lbl_BreadcrumbName(driver, "Financials/Reserves"),"General Claim Breadcrumb From Financial Reserves Page",logval);
			RMA_GenericUsages_Utility.RMA_ConditionalFrameSwitching(DefaultFrameID);		
			
			//Region =====================================================Steps To Add Collection For Created General Claim Is Started Here======================================================================================
			parentlogger.log(LogStatus.INFO,"The Functional Utility :" +RMA_GenericUsages_Utility.RMA_LoggerHyperlink("CollectionCorpAddition","RMA_CollectionCorpAddition_Utility",0)+" Is Called To Create A Collection ");
			testcall5 = true;
			StrControlNumber_1 = RMA_Functionality_Utility.RMA_CollectionCorpAddition_Utility(PaymentCreation_Lst_BankAccount, PaymentCreation_Lst_PayeeType, ReserveCreation_Lst_ReserveType_1, FundsSplitDetails_Lst_TransactionType_1, FundsSplitDetails_Txt_Amount_1, Payment_Txt_LastName, PaymentCreation_Txt_DisType, logval1);
			...
			String []ExpectedValuesToBeVerified = {"$" + (ReserveCreation_Txt_ReserveAmount - FundsSplitDetails_Txt_Amount)  +  ".00", "$0.00", "$" + FundsSplitDetails_Txt_Amount +  ".00", "$" + ReserveCreation_Txt_ReserveAmount + ".00", "O - Open"};
			...
			String []ExpectedValuesToBeVerified_1 = {"$"+ ReserveCreation_Txt_ReserveAmount + ".00", "$0.00", "$"+ FundsSplitDetails_Txt_Amount_1 + ".00", "$" + ReserveCreation_Txt_ReserveAmount + ".00", "O - Open"};
			...
			rmaseleniumutilties_UX.RMA_Functionality_Utility.RMA_Suite21_Check_Utility("RMA_QTPRegression_TC_113_02",LineOfBussinessParameterSetup_Lst_LOBType, logval);	
			driver.close();
			RMA_GenericUsages_Utility.RMA_WindowSwitching_Utility_NonUX();		
			...
			//Region =====================================================Steps To Verify REC Recovery Reserve Amount, Status Is Started Here=================================================================================================	
			String []ExpectedColHeadersToBeVerified_2={"Balance","Paid","Collection","Incurred","Status"};		
			String []ExpectedValuesToBeVerified_2={"$" + (ReserveCreation_Txt_ReserveAmount - FundsSplitDetails_Txt_Amount)  +  ".00", "$0.00", "$" + FundsSplitDetails_Txt_Amount +  ".00", "$" + ReserveCreation_Txt_ReserveAmount + ".00", "O - Open"};
			
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_Home.RMAApp_NGGrid_Btn_NGGridColumnSort(driver), "Column Header of Reserve NG Grid Table",logval);
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_FinancialReserves.RMAApp_ReserveCreationTbl_Btn_RestoreState(driver), "Restore State Button In Column Selection Header On Reserves NG Grid Table", logval);
			RMA_GenericUsages_Utility.RMA_CheckVerificationNGGridColumnHeader(ExpectedColHeadersToBeVerified_2, "Reserve", logval);			
			RMA_Verification_Utility.RMA_VerifyUXGrid_Utility(ReserveCreation_Lst_ReserveType, "Reserve UX Grid",ExpectedColHeadersToBeVerified_2, ExpectedValuesToBeVerified_2, logval);
			//EndRegion ==================================================Steps To Verify REC Recovery Reserve Amount, Status Is Started Here=======================================================================================
			
			//Region =====================================================Steps To Verify Expense Reserve Amount, Status Is Started Here=================================================================================================
			String []ExpectedColHeadersToBeVerified_3 = {"Balance","Paid","Collection","Incurred","Status"};		
			String []ExpectedValuesToBeVerified_3 = {"$"+ ReserveCreation_Txt_ReserveAmount + ".00", "$0.00", "$"+ FundsSplitDetails_Txt_Amount_1 + ".00", "$" + ReserveCreation_Txt_ReserveAmount + ".00", "O - Open"};
			
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_Home.RMAApp_NGGrid_Btn_NGGridColumnSort(driver), "Column Header of Reserve NG Grid Table",logval);
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_FinancialReserves.RMAApp_ReserveCreationTbl_Btn_RestoreState(driver), "Restore State Button In Column Selection Header On Reserves NG Grid Table", logval);
			RMA_GenericUsages_Utility.RMA_CheckVerificationNGGridColumnHeader(ExpectedColHeadersToBeVerified_3, "Reserve", logval);			
			RMA_Verification_Utility.RMA_VerifyUXGrid_Utility(ReserveCreation_Lst_ReserveType_1, "Reserve UX Grid",ExpectedColHeadersToBeVerified_3, ExpectedValuesToBeVerified_3, logval);
			//EndRegion ==================================================Steps To Verify Expense Reserve Amount, Status Is Started Here=======================================================================================
			...
			{
				logger.log(LogStatus.FAIL, "Following Error Occurred  ::" + " "+  color.RMA_ChangeColor_Utility(FinalErrorMessage,1)+ " " + "While Executing Function Utility" +" "+ "RMA_ReserveCorpAddition_Utility" + " " +  "To Create REC Recovery Reserve And Hence The Test Case Is A Fail");
				parentlogger.appendChild(logger);
				reports.endTest(logger);	
			}
			if (testcall3== true && loggerval3.equalsIgnoreCase("NotInitialized"))								
			{
				logger.log(LogStatus.FAIL, "Following Error Occurred  ::" + " "+  color.RMA_ChangeColor_Utility(FinalErrorMessage,1)+ " " + "While Executing Function Utility" +" "+ "RMA_ReserveCorpAddition_Utility" + " " +  "To Create Expense Reserve And Hence The Test Case Is A Fail");
				parentlogger.appendChild(logger);
				reports.endTest(logger);	
			}
