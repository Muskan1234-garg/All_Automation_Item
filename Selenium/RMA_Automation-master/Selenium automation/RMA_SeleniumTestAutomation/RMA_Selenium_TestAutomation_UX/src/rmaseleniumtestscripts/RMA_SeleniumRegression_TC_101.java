...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_SeleniumRegression_TC_101
...
public class RMA_SeleniumRegression_TC_101 extends RMA_TC_BaseTest{
	@Test
	public void RMA_SeleniumRegression_TC_101_Test() throws Exception,Error{
		...
		try{
		parentlogger = reports.startTest("RMA_SeleniumRegression_TC_101_Create, Edit And Delete Of Attachments_Event", "Create, Edit and Delete of an Attachments For A Newly Created Event Is Validated");
		parentlogger.assignAuthor("Shruti Shruti");
		
		StrScreenShotTCName = null;
		StrScreenShotTCName = "RMA_SeleniumRegression_TC_101";
		testcall1 = false;	
