...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_QTPRegression_TC_079
//Description    : Collection For 'Persons Involved' Using Sub Bank Account Is Validated
//Depends On TC  : None
//Revision       : 0.0 - AbhishekRai-10-11-2017 
//======================================================================================================================================================================================================================================================================================
public class RMA_QTPRegression_TC_079 extends RMA_TC_BaseTest {

	@Test
	public void RMA_QTPRegression_TC_079_Test() throws Exception,Error {

		try{
			parentlogger = reports.startTest("RMA_QTPRegression_TC_079_Collection For 'Persons Involved' Using Sub Bank Account", "Collection For 'Persons Involved' Using Sub Bank Account Is Validated");
			...
			StrScreenShotTCName = "RMA_QTPRegression_TC_079";
			ErrorMessage = null;
			CurrentFrameID=null;
			...
			PaymentCreation_Lst_BankAccount = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_079", 1, 0); //Bank Account Is Fetched From DataSheet RMA_QTPRegression_TC_079
			PaymentCreation_Lst_PayeeType =  ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_079", 1, 1); //Payee Type Is Fetched From DataSheet RMA_QTPRegression_TC_079
			ReserveCreation_Lst_ReserveType= ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_079", 1, 2); //Reserve Type Is Fetched From DataSheet RMA_QTPRegression_TC_079
			FundsSplitDetails_Lst_TransactionType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_079", 1, 3); //Transaction Type Is Fetched From DataSheet RMA_QTPRegression_TC_079
			FundsSplitDetails_Txt_Amount = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_QTPRegression_TC_079", 1, 4); //Amount Is Fetched From DataSheet RMA_QTPRegression_TC_079			
			PaymentCreation_Txt_DisType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_079", 1, 5); //DisType Is Fetched From DataSheet RMA_QTPRegression_TC_079			
			...
			testcall1 = true;
			StrControlNumber = RMA_Functionality_Utility.RMA_CollectionCorpAddition_Utility(PaymentCreation_Lst_BankAccount, PaymentCreation_Lst_PayeeType, ReserveCreation_Lst_ReserveType, FundsSplitDetails_Lst_TransactionType, FundsSplitDetails_Txt_Amount, "NA", PaymentCreation_Txt_DisType, logval1);
