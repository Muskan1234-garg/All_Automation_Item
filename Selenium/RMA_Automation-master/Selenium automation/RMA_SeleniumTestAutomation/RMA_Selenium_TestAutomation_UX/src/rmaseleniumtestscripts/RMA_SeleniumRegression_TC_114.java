...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_SeleniumRegression_TC_114
//Description    : Create, Edit and Delete of Attachments For A Physician(PI) Is Validated
//Depends On TC  : None
//Revision       : 0.0 - ShrutiShruti-01-11-2018
//======================================================================================================================================================================================================================================================================================

public class RMA_SeleniumRegression_TC_114 extends RMA_TC_BaseTest{
	@Test
	public void RMA_SeleniumRegression_TC_114_Test() throws Exception,Error{
		try{
			parentlogger = reports.startTest("RMA_SeleniumRegression_TC_114_Create, Edit And Delete Of Attachments On Person Involved(Physician) Screen", "Create,Edit and Delete Of Attachments On A Person Involved(Physician) Is Validated");
			parentlogger.assignAuthor("Shruti Shruti");

			StrScreenShotTCName = "RMA_SeleniumRegression_TC_114";
			testcall1 = false;	
