...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_SeleniumRegression_TC_131
//Description    : Create, Edit and Delete of Attachments For A Dated Text On An Event Is Validated
//Depends On TC  : None
//Revision       : 0.0 - ShrutiShruti-01-10-2018
//======================================================================================================================================================================================================================================================================================

public class RMA_SeleniumRegression_TC_131 extends RMA_TC_BaseTest{
	@Test
	public void RMA_SeleniumREgression_TC_131_Test() throws Exception,Error{
		try{
			parentlogger = reports.startTest("RMA_SeleniumRegression_TC_131_Create, Edit And Delete An Attachment For A Dated Text on Event Screen", "Create,Edit And Delete of Attachment For A Dated Text On An Event Screen Is Validated");
			...
			StrScreenShotTCName = "RMA_SeleniumRegression_TC_131";
			ErrorMessage = null;
			CurrentFrameID=null;
			...
			testcall1 = true;
			StrDatedText=RMA_Functionality_Utility.RMA_ClaimEventEntityAddition_Utility("Dated Text_Event", StrClaimNumber, "Appraisal", "NA",logval1);
