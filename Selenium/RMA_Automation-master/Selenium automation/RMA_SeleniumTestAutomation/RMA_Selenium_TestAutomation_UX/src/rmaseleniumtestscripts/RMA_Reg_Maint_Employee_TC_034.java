...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_Reg_Maint_Employee_TC_034
//Description    : Verify That When User Changes The ToolTip Of Navigation Link By UX Power View Then Same Is Updated Correctly
//Depends On TC  : None
//Revision       : 0.0 - ShrutiShruti-03-05-2018 
//======================================================================================================================================================================================================================================================================================

public class RMA_Reg_Maint_Employee_TC_034 extends RMA_TC_BaseTest{
	@Test
	public void RMA_Reg_Maint_Employee_TC_034_Test() throws Exception,Error{
		try{
			parentlogger = reports.startTest("RMA_Reg_Maint_Employee_TC_034_Verify ToolTip Of Right Navigation Link Is Changed According To The User", "User Changes The ToolTip Of Navigation Link By UX Power View Then Same Is Updated Correctly On Employee Page Is Validated");
			...
			StrScreenShotTCName = "RMA_Reg_Maint_Employee_TC_034";
			ErrorMessage = null;
			...
			RMA_Verification_Utility.RMA_ElementExist_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_RMAAppText(driver, "Banking Information "), "Banking Information Right Navigation Link On Employee Creation Page", logval);
			//Verification Is Done For ToolTip Without Changes Done in PowerView
			...
			globalWait.until(ExpectedConditions.visibilityOf(RMA_Selenium_POM_PowerView.RMAApp_PowerView_DropDwn_ChildNavigationMainForm(driver)));
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_PowerView.RMAApp_PowerView_DropDwn_ChildNavigationMainForm(driver), "Child Navigation DropDown Menu On Power View Editor Page", logval);
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_PowerView.RMAApp_PowerView_Lbl_DropDownField(driver, "Banking Information"), "Banking Information Label On DropDown Menu On Child Navigation Link On Power View Editor Page", logval);
			RMA_Input_Utility.RMA_SetValue_Utility(RMA_Selenium_POM_PowerView.RMAApp_PowerView_Txt_Caption(driver), "Caption TextBox on Power View Editor Page", StrToolTip, logval);
			...
			RMA_Verification_Utility.RMA_ElementExist_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_RMAAppText(driver, StrToolTip), StrToolTip +" Right Navigation Link On Employee Creation Page", logval);
			driver.close();
			//Verification Is Done For ToolTip After Changes Made In Power View Editor
			...
			globalWait.until(ExpectedConditions.visibilityOf(RMA_Selenium_POM_PowerView.RMAApp_PowerView_DropDwn_ChildNavigationMainForm(driver)));
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_PowerView.RMAApp_PowerView_DropDwn_ChildNavigationMainForm(driver), "Child Navigation DropDown Menu On Power View Editor Page", logval);
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_PowerView.RMAApp_PowerView_Lbl_DropDownField(driver, StrToolTip), StrToolTip +" Label On DropDown Menu On Child Navigation Link On Power View Editor Page", logval);
			RMA_Input_Utility.RMA_SetValue_Utility(RMA_Selenium_POM_PowerView.RMAApp_PowerView_Txt_Caption(driver), "Caption TextBox on Power View Editor Page", "Banking Information", logval);
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_PowerView.RMAApp_PowerView_Btn_Save(driver), "Save Image Button On Power View Editor Page", logval);
