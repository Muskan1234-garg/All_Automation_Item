...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_Reg_Maint_Vehicle_TC_023
//Description    : View SMS Permission From Vehicle Maintenance Is Validated
//Depends On TC  : None
//Revision       : 0.0 - JannathHussain-03-14-2018 
//======================================================================================================================================================================================================================================================================================

public class RMA_Reg_Maint_Vehicle_TC_023   extends rmaseleniumtestscripts.RMA_TC_BaseTest  {
	@Test	
	public void RMA_Reg_Maint_Vehicle_TC_023_Test() throws Exception, Error
	{   
		try {	 	 
			...
			parentlogger = reports.startTest("RMA_Reg_Maint_Vehicle_TC_023_View SMS Permission Setting For Vehicle Is Validation", "Functionality of View For Vehicle Permission Setting On Security Management System Is Validated");
			parentlogger.assignAuthor("Jannath Hussain");
			StrScreenShotTCName = "RMA_Reg_Maint_Vehicle_TC_023";
			...
			RMA_ExcelDataRetrieval_Utility ExcelData = new RMA_ExcelDataRetrieval_Utility(System.getProperty("user.dir")+"\\RMASeleniumTestDataSheets\\RMA_Suite01_Maint_Vehicle_Module.xlsx"); //Excel WorkBook RMASeleniumAutomationTestData Is Fetched To Retrieve Data 
			RMAApp_SMS_Lnk_DataSourceName = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_Reg_Maint_Vehicle_TC_023", 4, 0); //Data Source Name Is Fetched From DataSheet RMA_Reg_Maint_Vehicle_TC_023			
			RMAApp_Login_Txt_UserName = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_Reg_Maint_Vehicle_TC_023", 1, 1); //UserName Fetched From DataSheet RMA_Reg_Maint_Vehicle_TC_023
			RMAApp_Login_Txt_Password = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_Reg_Maint_Vehicle_TC_023", 1, 2); //Password Fetched From DataSheet RMA_Reg_Maint_Vehicle_TC_023
        	RMA_ExcelDataRetrieval_Utility ExcelData_1 = new RMA_ExcelDataRetrieval_Utility(System.getProperty("user.dir")+"\\RMASeleniumTestDataSheets\\RMA_Suite01_Maint_Vehicle_Module.xlsx"); //Excel WorkBook RMA_Suite01_Maint_Vehicle_Module Is Fetched To Retrieve Data 
			RMAApp_SMS_Lnk_ModuleSecurityGroup = ExcelData_1.RMA_ExcelStringDataRead_Utility("RMA_Reg_Maint_Vehicle_TC_023", 1, 3); //Module Security Group Name Is Fetched From DataSheet RMA_Reg_Maint_Vehicle_TC_023
			RMAApp_SMS_Lnk_ModuleAccessPermission = ExcelData_1.RMA_ExcelStringDataRead_Utility("RMA_Reg_Maint_Vehicle_TC_023", 1, 4); //Module Access Permission Name Is Fetched From DataSheet RMA_Reg_Maint_Vehicle_TC_023		
			...
			RMA_Navigation_Utility.RMA_ObjectClick(rmaseleniumPOM_UX.RMA_Selenium_POM_Vehicle.RMAApp_Vehicle_SMS_View(driver, "View"),"Click On View From Module Access Permission On Security Management System Page",logval);
			...
			//==========================================================Navigation To Maintenance Screen Is Started Here=======================================================================================================================
			driver.switchTo().window(StrRMAWindowHandle);
			...
			//===========================================================Navigation To Maintenance Screen Is Completed Here==============================================================================================================================================================================================================================================================================================================================================================================================
			
			//===========================================================Creation Of Vehicle Is Started Here==============================================================================================================================================================================================================================================================================================================================================================================================
			testcall3 = true;
			...
			//===========================================================Creation Of Vehicle Is Completed Here==============================================================================================================================================================================================================================================================================================================================================================================================
			
			//===========================================================Verification Of View Permission From Vehicle As Per SMS Permission Is Started Here==============================================================================================================================================================================================================================================================================================================================================================
			RMA_GenericUsages_Utility.RMA_StaticWait(4, logval, "Wait Is Added To Switch To MAintenance-Vehicle Frame");
			driver.switchTo().parentFrame(); 
			RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_Home.RMAApp_DefaultView_Img_Reload(driver), "Reload Image Button On" +  "Maintenance " , logval);
        	...
        	RMA_Verification_Utility.RMA_VerifyUXMessage(RMA_Selenium_POM_VerificationMessage.VehicleView, false, "No View Permission Verification", logval);
			RMA_GenericUsages_Utility.RMA_WebPageRefresh_Utility_UX(logval);
			//===========================================================Verification Of View Permission From Vehicle As Per SMS Permission Is Completed Here============================================================================================================================================================================================================================================================================================================================================================

			//===========================================================Revert View Permission Is Started Here==============================================================================================================================================================================================================================================================================================================================================================================================================================================================	
			driver.switchTo().window(StrRMAWindowHandle);
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_Login_DSNSelect_Frames.RMAApp_Dashboard_Lbl_SMS(driver), "Security Management System Navigation Option Label On RiskMaster Application's Dashboard Page",logval);
			RMA_GenericUsages_Utility.RMA_WindowSwitchingBasedOnTitle("Riskmaster Security");
			RMA_Verification_Utility.RMA_VerifyUXSpinnerDisappered(logval);
			...
			RMA_Verification_Utility.RMA_VerifyUXSpinnerDisappered(logval);
			RMA_GenericUsages_Utility.RMA_StaticWait(5, logval, "Wait Is Added To Loader Gets Disappeared");
			RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_Vehicle.RMAApp_Vehicle_SMS_View(driver, "View"),"Click On View From Module Access Permission On Security Management System Page",logval);
			...
			RMA_Verification_Utility.RMA_VerifyUXSpinnerDisappered(logval);
			//===========================================================Revert View Permission Is Completed Here==============================================================================================================================================================================================================================================================================================================================================================================================================================================================
			...
			{
				logger.log(LogStatus.FAIL,"Following Error Occurred  ::" + " "+  color.RMA_ChangeColor_Utility(FinalErrorMessage,1)+ " " + "While Executing Functionality" +" "+ "RMA_MaintenanceAddNewEntity_Utility" + " " +  "And Hence The Test Case Is A Fail");
				parentlogger.appendChild(logger);
			}
