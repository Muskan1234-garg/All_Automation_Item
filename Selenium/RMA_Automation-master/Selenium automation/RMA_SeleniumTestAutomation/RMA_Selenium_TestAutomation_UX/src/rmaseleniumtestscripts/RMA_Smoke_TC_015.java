...
//Description    : Claim Activity Log Is Validated
...
public void RMA_Smoke_TC_015_Test() throws Exception,Error {
	...
	try{
	parentlogger = reports.startTest("RMA_Smoke_TC_015_Claim Activity Log Working", "Claim Activity Log Is Validated");
	...
	RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_Home.RMAApp_Generic_ModelPopup_Img_Close(driver), "Close Button On Claim Activity Log Popup On  Workers' Comp Claim Creation Page",logval);
