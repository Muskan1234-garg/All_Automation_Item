...
//=====================================================================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_QTPRegression_TC_025
//Description    : Setting Of Bank Account Owner To Service Code(s) Is Validated 
//Depends On TC  : None
//Revision       : 0.0 - NidhiJha-08-24-2017
//===================================================================================================================================================================================================================================================================================================================================

public class RMA_QTPRegression_TC_025 extends RMA_TC_BaseTest{
	@Test
	public void RMA_QTPRegression_TC_025_Test() throws Exception,Error {
		...
		StrScreenShotTCName = "RMA_QTPRegression_TC_025";
		...
		try{
			parentlogger = reports.startTest("RMA_QTPRegression_TC_025_Bank Account Owner Setting To Service Code(s)_Validation",  "Setting Of Bank Account Owner To Service Code(s) Is Validated");
			...
			GenClaimCreation_Txt_ClaimType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_025", 1, 0); //Claim Type Is Fetched From DataSheet RMA_QTPRegression_TC_025			
			GenClaimCreation_Txt_Department = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_025", 1,1 ); //Department Is Fetched From DataSheet RMA_QTPRegression_TC_025
			GenClaimCreation_Txt_ClaimStatus =  ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_025", 1,2 ); //Claim Status Is Fetched From DataSheet RMA_QTPRegression_TC_025
			GenClaimCreation_Txt_ServiceCode = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_025", 1,3 ); //Service Code Is Fetched From DataSheet RMA_QTPRegression_TC_025
			GenClaimCreation_Txt_ServiceCode_1 = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_025", 1,4 );//Service Code 2 Is Fetched From DataSheet RMA_QTPRegression_TC_025
			...
			testcall1 = true;
			rmaseleniumutilties_UX.RMA_Functionality_Utility.RMA_Suite22_Utility("RMA_QTPRegression_TC_025_Check", logval1);
			...
			//=========================================Steps To Negatively Verify Values In bank Account List On Payments Page Is Completed Here===============================BankAccountCreation_Txt_BankAccountName==================================================================================================================================================================================
			...
			parentlogger.log(LogStatus.INFO, "Following Function Is Called :: "+RMA_GenericUsages_Utility.RMA_LoggerHyperlink("Suite22GenSysParaSetupsettings","RMA_Suite22_Utility",0)+" To Successfully Do Settings On General System Parameter Setup Page");
			testcall6 = true;
			rmaseleniumutilties_UX.RMA_Functionality_Utility.RMA_Suite22_Utility("RMA_QTPRegression_TC_025_UnCheck", logval1);
			parentlogger.log(LogStatus.INFO, "General System Parameter Setup Settings Are Done For Test Case:"+ " " + color.RMA_ChangeColor_Utility(StrScreenShotTCName, 2));
