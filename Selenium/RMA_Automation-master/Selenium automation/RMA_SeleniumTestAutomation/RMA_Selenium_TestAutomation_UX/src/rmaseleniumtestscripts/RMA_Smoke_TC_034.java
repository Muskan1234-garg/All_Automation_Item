...
//Description    : RMA_Smoke_TC_034_Verify That Enhanced Notes Can Be Created,Edited And Deleted Successfully From Payment Page Along-with Back To Notes, Note Type And NG Grid Search Filter Functionalities
//Depends On TC  : RMA_Smoke_TC_002, RMA_Smoke_TC009.RMA_Smoke_TC011
//Revision       : 0.0 - RenuVerma-06-19-2017
//=================================================================================================================================================================================================================
...
public class RMA_Smoke_TC_034 extends RMA_TC_BaseTest {
	...
	public void RMA_TC_034_Test() throws Exception,Error {
		...
		try{
			parentlogger = reports.startTest("RMA_Smoke_TC_034_Enhanced Notes Create, Edit And Delete", "Verify That Enhanced Notes Can Be Created,Edited And Deleted Successfully From Payment Page Along-with Back To Notes, Note Type And NG Grid Search Filter Functionalities");
