...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_SeleniumRegression_TC_137
//Description    : Create, Edit and Delete of Attachments For A Driver(PI) On A Litigation Page Is Validated
//Depends On TC  : RMA_SeleniumRegression_TC_024(For the Litigation Creation)
//Revision       : 0.0 - ShrutiShruti-01-12-2018
//======================================================================================================================================================================================================================================================================================

public class RMA_SeleniumRegression_TC_137 extends RMA_TC_BaseTest{
	@Test
	public void RMA_SeleniumRegression_TC_137_Test() throws Exception,Error{
		try{
			parentlogger = reports.startTest("RMA_SeleniumRegression_TC_137_Create, Edit And Delete Of Attachments On Person Involved(Driver) On A Litigation Screen", "Create,Edit and Delete Of Attachments On A Person Involved(Driver) On A Litigation Is Validated");
			parentlogger.assignAuthor("Shruti Shruti");

			StrScreenShotTCName = "RMA_SeleniumRegression_TC_137";
			testcall1 = false;	
	...
	public void RMA_FailureReport(ITestResult result) //All The Information Associated With The Test Case Is Stored In Result Variable
	{
		...
		finally
		{
			try {
				...
				driver.switchTo().parentFrame();
				RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_Home.RMAApp_DefaultView_Lbl_BreadcrumbName(driver, RMA_SeleniumRegression_TC_024.LitCreation_Txt_DocketNumber),StrClaimNumber +" Claim Number Link At Top Of The Screen",logval);
