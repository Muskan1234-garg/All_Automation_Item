...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_Reg_Maint_Vehicle_TC_016
//Description    : Verify That Validation Is Displayed When User Has Not Entered Data In Any Required Field On Vehicle Screen Is Validated
//Depends On TC  : None
//Revision       : 0.0 - NikitaThani-03-06-2018 
//======================================================================================================================================================================================================================================================================================

public class RMA_Reg_Maint_Vehicle_TC_016  extends RMA_TC_BaseTest{
	@Test
	public void RMA_Reg_Maint_Vehicle_PowerView_TC_016_Test() throws Exception, Error{
		try{
			parentlogger = reports.startTest("RMA_Reg_Maint_Vehicle_PowerView_TC_016_Verify That Validation Is Displayed When User Has Not Entered Data In Any Required Field", "Verify That Validation Is Displayed When User Has Not Entered Data In Any Required Field Is Validated");
			parentlogger.assignAuthor("Nikita Thani");
			StrScreenShotTCName = "RMA_Reg_Maint_Vehicle_PowerView_TC_016";
			...
			RMAApp_SMS_Lst_DataSourceName = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_Reg_Maint_Vehicle_PV_TC_016",DSRow, 4); //Data Source Name Is Fetched From DataSheet RMA_Reg_Maint_Vehicle_PV_TC_016
			RMAApp_Login_Txt_UserName = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_Reg_Maint_Vehicle_PV_TC_016", 1, 0); //UserName Fetched From DataSheet RMA_Reg_Maint_Vehicle_PV_TC_016
			RMAApp_Login_Txt_Password = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_Reg_Maint_Vehicle_PV_TC_016", 1, 1); //Password Fetched From DataSheet RMA_Reg_Maint_Vehicle_PV_TC_016		 
			RMAApp_Login_Txt_UserName1=ExcelData.RMA_ExcelStringDataRead_Utility("RMA_Reg_Maint_Vehicle_PV_TC_016", 1, 2); //UserName Fetched From DataSheet RMA_Reg_Maint_Vehicle_PV_TC_016		 
			RMAApp_Login_Txt_Password1 =ExcelData.RMA_ExcelStringDataRead_Utility("RMA_Reg_Maint_Vehicle_PV_TC_016", 1, 3); //Password Fetched From DataSheet RMA_Reg_Maint_Vehicle_PV_TC_016		 
