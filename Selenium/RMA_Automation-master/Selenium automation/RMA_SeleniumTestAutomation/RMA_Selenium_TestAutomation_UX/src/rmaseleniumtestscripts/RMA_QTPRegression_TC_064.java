...
//=====================================================================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_QTPRegression_TC_064
//Description    : Void Of Checks From Funds Link Is Validated
//Depends On TC  : None
//Revision       : 0.0 - NidhiJha-09-11-2017
//===================================================================================================================================================================================================================================================================================================================================

public class RMA_QTPRegression_TC_064 extends RMA_TC_BaseTest{
	@Test
	public void RMA_QTPRegression_TC_064_Test() throws Exception,Error {
		...
		StrScreenShotTCName = "RMA_QTPRegression_TC_064";
		...
		try{   
			...
			parentlogger = reports.startTest("RMA_QTPRegression_TC_064_Void_Of_Checks_Validation",  "Void Of Checks From Funds Link Is Validated");
			...
			GenClaimCreation_Txt_ClaimType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_064", 1, 0); //Claim Type Is Fetched From DataSheet RMA_QTPRegression_TC_064			
			GenClaimCreation_Txt_Department = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_064", 1,1 ); //Department Is Fetched From DataSheet RMA_QTPRegression_TC_064
			GenClaimCreation_Txt_ClaimStatus =  ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_064", 1,2 ); //Claim Status Is Fetched From DataSheet RMA_QTPRegression_TC_064
			GenClaimCreation_Txt_ServiceCode = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_064", 1,3 ); //Service Code Is Fetched From DataSheet RMA_QTPRegression_TC_064
			//General Claim Data Fetch From Excel WorkBook Is Completed Here

			PaymentCreation_Lst_PayeeType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_064", 1, 4); // Payee Type Is Fetched From DataSheet RMA_QTPRegression_TC_064
			FundsSplitDetails_Lst_TransactionType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_064", 1, 5); //Transaction Type Is Fetched From DataSheet RMA_QTPRegression_TC_064
			PaymentCreation_Txt_LastName = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_064", 1, 6); //LastName Is Fetched From DataSheet RMA_QTPRegression_TC_064
			PaymentCreation_Txt_DisType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_064", 1, 7); //Distribution Type Is Fetched From DataSheet RMA_QTPRegression_TC_064
			FundsSplitDetails_Lst_ReserveType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_064", 1, 8); // Reserve Type Is Fetched From DataSheet RMA_QTPRegression_TC_064
			FundsSplitDetails_Txt_Amount =  ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_QTPRegression_TC_064", 1, 9);//Funds Split Details Amount Is Fetched From DataSheet RMA_QTPRegression_TC_064
			//Payment Data Fetch From Excel WorkBook Is Completed Here

			CheckStockCreation_Txt_FontStyle = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_064", 1, 10);//Font Style Is Fetched From DataSheet RMA_QTPRegression_TC_064
			CheckStockCreation_Txt_FontSize = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_QTPRegression_TC_064", 1, 11);//Font Size Is Fetched From DataSheet RMA_QTPRegression_TC_064
			...
			//========================================Steps To Void Checks By Navigating To Funds--->Void Checks Page Is Started Here=========================================================================================================================================================================================================================
			parentlogger.log(LogStatus.INFO, "Following Function Is Called :: "+RMA_GenericUsages_Utility.RMA_LoggerHyperlink("VoidOfChecks","RMA_Funds_VoidChecks",0)+" To Successfully Void Checks");
			testcall6 = true;
			RMA_Functionality_Utility.RMA_Funds_VoidChecks(BankAccountCreation_Txt_BankAccountName,logval1);
			parentlogger.log(LogStatus.INFO, "Check Is Voided Successfully For Bank Account"+ " " + color.RMA_ChangeColor_Utility(BankAccountCreation_Txt_BankAccountName, 2));
			loggerval6 = logger.toString();
			parentlogger.appendChild(logger);
			//========================================Steps To Void Checks By Navigating To Funds--->Void Checks Page Is Completed Here=========================================================================================================================================================================================================================

			//===========================================Steps To Close The Funds--->Void Checks Page Is Started Here==========================================================================================================================================================================
			//RMA_GenericUsages_Utility.RMA_StaticWait(6, logval, "Wait Is Added As Message Needs To Get Verified");
			RMA_Navigation_Utility.RMA_ObjectClick(rmaseleniumPOM.RMA_Selenium_POM_Home.RMAApp_DefaultView_Btn_Close(driver), "Close Button On Void Checks Page", logval);
			//===========================================Steps To Close The Funds--->Void Checks Page Is Completed Here==========================================================================================================================================================================
			...
			{
				logger.log(LogStatus.FAIL, "Following Error Occurred  ::" + " "+  color.RMA_ChangeColor_Utility(FinalErrorMessage,1)+ " " + "While Executing Function Utility" +" "+ "RMA_Funds_VoidChecks" + " " +  "To Void Checks And Hence The Test Case Is A Fail");
				parentlogger.appendChild(logger);
				reports.endTest(logger);	
			}
