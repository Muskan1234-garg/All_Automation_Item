...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_Reg_Maint_Employee_TC_041
//Description    : Verify That When User Add Any Tab Then The Same Is Visible On The Screen
//Depends On TC  : None
//Revision       : 0.0 - ShrutiShruti-02-26-2018 
//======================================================================================================================================================================================================================================================================================

public class RMA_Reg_Maint_Employee_TC_041 extends RMA_TC_BaseTest{
	@Test
	public void RMA_Reg_Maint_Employee_TC_041_Test() throws Exception,Error{
		try{
			parentlogger = reports.startTest("RMA_Reg_Maint_Employee_TC_041_Verify That When User Adds Any Tab Then The Same Is Visible On That Screen", "User Adds Any Tab Then The Same Is Visible On That Screen Is Validated");
			...
			StrScreenShotTCName = "RMA_Reg_Maint_Employee_TC_041";
			ErrorMessage = null;
			...
			Login_Txt_UserName = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_Reg_Maint_Employee_TC_042", 1, 0); //UserName Fetched From DataSheet RMA_Reg_Maint_Employee_TC_042
			Login_Txt_Password = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_Reg_Maint_Employee_TC_042", 1, 1); //Password Fetched From DataSheet RMA_Reg_Maint_Employee_TC_042
			Login_Txt_UserName_1 = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_Reg_Maint_Employee_TC_042", 1, 2); //UserName Fetched From DataSheet RMA_Reg_Maint_Employee_TC_042
			Login_Txt_Password_1 = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_Reg_Maint_Employee_TC_042", 1, 3); //Password Fetched From DataSheet RMA_Reg_Maint_Employee_TC_042
			DSNSelect_Lst_DataSourceName = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_Reg_Maint_Employee_TC_042", DSRow, 4); //Data Source Name Is Fetched From DataSheet RMA_Reg_Maint_Employee_TC_042			
			...
			RMA_NegativeVerification_Utility.RMA_ElementNotExist_Utility(RMA_Selenium_POM_Employee.RMAApp_Employee_Tab_Addresses(driver), "Addresses Tab On Employee Creation Page", logval);
			RMA_NegativeVerification_Utility.RMA_ElementNotExist_Utility(RMA_Selenium_POM_Employee.RMAApp_Employee_Tab_EntityIDType(driver), "Entity ID Type Tab On Employee Creation Page", logval);
			RMA_NegativeVerification_Utility.RMA_ElementNotExist_Utility(RMA_Selenium_POM_Employee.RMAApp_Employee_Tab_Supplementals(driver), "Supplementals Tab On Employee Creation Page", logval);
			//Verification Of Tabs Existence Done On Employee Page
			...
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_PowerView.RMAApp_PowerView_DropDown_ControlPalette(driver), "Control Palette Expand Tab On Power View Editor Page", logval);
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_PowerView.RMAApp_PowerView_Btn_TabAdd(driver, "Addresses"), "Addresses Tab Add Button On Power View Editor Page", logval);
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_PowerView.RMAApp_PowerView_Btn_TabAdd(driver, "Entity ID Type"),"Entity ID Type Tab Add Button On Power View Editor Page", logval);
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_PowerView.RMAApp_PowerView_Btn_TabAdd(driver, "Supplementals"), "Supplementals Tab Add Button On Power View Editor Page", logval);
			...
			RMA_GenericUsages_Utility.RMA_DynamicFrameSwitching(RMA_Selenium_POM_VerificationMessage.EmployeeFrame);
			RMA_Verification_Utility.RMA_ElementExist_Utility(RMA_Selenium_POM_Employee.RMAApp_Employee_Tab_Addresses(driver), "Addresses Tab On Employee Creation Page", logval);
			RMA_Verification_Utility.RMA_ElementExist_Utility(RMA_Selenium_POM_Employee.RMAApp_Employee_Tab_EntityIDType(driver), "Entity ID Type Tab On Employee Creation Page", logval);
			RMA_Verification_Utility.RMA_ElementExist_Utility(RMA_Selenium_POM_Employee.RMAApp_Employee_Tab_Supplementals(driver), "Supplementals Tab On Employee Creation Page", logval);
			driver.close();
			//Verification Of Non-Existence Of Tabs On Employee Page
