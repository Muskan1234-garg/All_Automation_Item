...
//==================================================================================================================================================================================
//TestCaseID   	 : RMA_QTPRegression_TC_047
//Description    : LOB Parameter Settings 'Set Reserve Balance To Zero' To View Reserve Balances For Reserves When Closed Is Validated
//Depends On TC  : None
//Revision       : 0.0 - AnubhutiVyas-07-27-2017 
//========================================================================================================================================================================================
public class RMA_QTPRegression_TC_047 extends RMA_TC_BaseTest{

	@Test 
	public void RMA_QTPRegression_TC_047_Test() throws Exception, Error
	{
		testcall1 = false;	
		...
		StrScreenShotTCName = "RMA_QTPRegression_TC_047";
		...
		try {
			parentlogger = reports.startTest("RMA_QTPRegression_TC_047_LOB Parameter Settings Set Reserve Balance To Zero On Reserve Close", "LOB parameter settings 'Set Reserve Balance To Zero' To View Reserve Balances For Reserves When Closed Is Validated");
			...
			GenClaimCreation_Txt_ClaimType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_047", 1, 16); //Claim Type Is Fetched From DataSheet RMA_QTPRegression_TC_047
			GenClaimCreation_Txt_ClaimStatus =  ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_047", 1,17 ); //Claim Status Is Fetched From DataSheet RMA_QTPRegression_TC_047
			GenClaimCreation_Txt_Department = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_047", 1,18); //Department Is Fetched From DataSheet RMA_QTPRegression_TC_047
			//Claim Data Fetch From Excel WorkBook Is Completed Here
		 
			ReserveCreation_Txt_ReserveAmount = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_QTPRegression_TC_047", 1, 0); //Reserve Amount Is Fetched From DataSheet RMA_QTPRegression_TC_047
			ReserveCreation_Lst_Status = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_047", 1, 1); // Reserve Status Is Fetched From DataSheet RMA_QTPRegression_TC_047
			ReserveCreation_Lst_ReserveType_Medical = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_047", 1, 2); // Medical Reserve Type Is Fetched From DataSheet RMA_QTPRegression_TC_047
			ReserveCreation_Lst_ReserveType_Expense = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_047", 1, 3); // Expense Reserve Type Is Fetched From DataSheet RMA_QTPRegression_TC_047
			ReserveCreation_Lst_ReserveType_Litigation = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_047", 1, 4); // Litigation Reserve Type Is Fetched From DataSheet RMA_QTPRegression_TC_047
			//Reserve Data Fetch From Excel WorkBook Is Completed Here
			
			PaymentCreation_Txt_BankAccount = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_047", 1, 5); //Bank Account Is Fetched From DataSheet RMA_QTPRegression_TC_047
			PaymentCreation_Lst_PayeeType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_047", 1, 6); // Payee Type Is Fetched From DataSheet RMA_QTPRegression_TC_047
			FundsSplitDetails_Lst_TransactionType_Medical = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_047", 1, 7); //Transaction Type For Medical Reserve Payment Is Fetched From DataSheet RMA_QTPRegression_TC_047
			FundsSplitDetails_Lst_TransactionType_Expense = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_047", 1,12 ); //Transaction Type For Expense Reserve Payment Is Fetched From DataSheet RMA_QTPRegression_TC_047
			FundsSplitDetails_Lst_TransactionType_Litigation = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_047",1,13 ); //Transaction Type For Litigation Reserve Payment Is Fetched From DataSheet RMA_QTPRegression_TC_047
			FundsSplitDetails_Txt_Amount_Medical = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_QTPRegression_TC_047", 1, 8); //Medical Amount Is Fetched From DataSheet RMA_QTPRegression_TC_047
			FundsSplitDetails_Txt_Amount_Expense = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_QTPRegression_TC_047", 1,14 ); //Expense Amount Is Fetched From DataSheet RMA_QTPRegression_TC_047
			FundsSplitDetails_Txt_Amount_Litigation = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_QTPRegression_TC_047", 1,15 ); //Litigation Amount Is Fetched From DataSheet RMA_QTPRegression_TC_047
			PaymentCreation_Txt_LastName = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_047", 1, 9); //LastName Is Fetched From DataSheet RMA_QTPRegression_TC_047
			PaymentCreation_Txt_DisType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_047", 1, 10); //Distribution Type Is Fetched From DataSheet RMA_QTPRegression_TC_047
			...
			String []ExpectedValuesToBeVerified_Medical={"$0.00", "$"+FundsSplitDetails_Txt_Amount_Medical+".00", "$0.00", "$"+FundsSplitDetails_Txt_Amount_Medical+".00", "C - Closed"};
			String []ExpectedValuesToBeVerified_Expense={"$0.00", "$"+FundsSplitDetails_Txt_Amount_Expense+".00", "$0.00", "$"+FundsSplitDetails_Txt_Amount_Expense+".00", "C - Closed"};
			...
			RMA_Functionality_Utility.RMA_Suite24_Utility("RMA_QTPRegression_TC_047", logval);//General System Parameter & LOB Parameter Setting Is Done
			...
			RMA_GenericUsages_Utility.RMA_StaticWait(5, logval, "Wait Added On Claim Status LookUp Window On General Claim Creation Page ");// Wait Is Added To Encounter State Element Reference Exception
