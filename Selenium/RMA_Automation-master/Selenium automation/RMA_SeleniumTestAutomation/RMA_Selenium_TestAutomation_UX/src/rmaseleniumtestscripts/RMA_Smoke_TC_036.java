...
//Description    : Verify That Attachment Can Be Created,Edited And Deleted Successfully From Collection Page Along-with Data Entry In Title, Subject, Notes, Keywords TextBox And NG Grid Search Filter Functionalities
//Depends On TC  : RMA_Smoke_TC_002, RMA_Smoke_TC009, RMA_Smoke_TC011
//Modify By 	:0.0- RenuVerma-06-26-2017
//=============================================================================================================================================================
...
public class RMA_Smoke_TC_036 extends RMA_TC_BaseTest {
	...
	public void RMA_Smoke_TC_036_Test() throws Exception,Error {
		...
		testcall2 = false;
		StrScreenShotTCName = "RMA_Smoke_TC_036";
		...
		try{
			parentlogger = reports.startTest("RMA_Smoke_TC_036_Document Attachment On Collection", "Verify That Attachment Can Be Created,Edited And Deleted Successfully From Collection Page Along-with Data Entry In Title, Subject, Notes, Keywords TextBox And NG Grid Search Filter Functionalities");
			...
			//***************************************************Add, Edit  Of Document On Collection Is Started***************************************************************************************************************************************************************************************************************************************************************
			...
			parentlogger.log(LogStatus.INFO,"The Functional Utility :" +RMA_GenericUsages_Utility.RMA_LoggerHyperlink("RMA_Attachment_Add_Edit_Delete","RMA_Attachment_Add_Edit_Delete",0)+" Is Called To Add And Edit Attached Document On Collection :"+" "+RMA_Smoke_TC_014.StrControlNumber_Smoke_TC_014);
			testcall1 = true;
			RMA_Functionality_Utility.RMA_Attachment_Add_Edit_Delete("Add_Edit", FileName, FileSize, false, logval1);
			loggerval1 = logger.toString();
			parentlogger.log(LogStatus.INFO,  "Document Is Attached And Edited Successfully On Collection :"+" "+RMA_Smoke_TC_014.StrControlNumber_Smoke_TC_014);
			parentlogger.appendChild(logger);
			//***************************************************Add, Edit Of Document On Collection Is Completed***************************************************************************************************************************************************************************************************************************************************************
			
			//***************************************************Attachment delete functionality on Collection screen is started here ***************************************************************************************************************************************************************************************************************************************	
		     parentlogger.log(LogStatus.INFO, "Following Function Is Called ::" +RMA_GenericUsages_Utility.RMA_LoggerHyperlink("RMA_Attachment_Add_Edit_Delete","RMA_Attachment_Add_Edit_Delete",1)+" Is Called To  Delete Attached Document On Collection :"+" "+RMA_Smoke_TC_014.StrControlNumber_Smoke_TC_014);
		     testcall2 = true;
		     RMA_Functionality_Utility.RMA_Attachment_Add_Edit_Delete("Delete", FileName, FileSize, false, logval1);
		     parentlogger.log(LogStatus.INFO, "Document Is  Deleted Successfully On Collection :"+" "+RMA_Smoke_TC_014.StrControlNumber_Smoke_TC_014);
