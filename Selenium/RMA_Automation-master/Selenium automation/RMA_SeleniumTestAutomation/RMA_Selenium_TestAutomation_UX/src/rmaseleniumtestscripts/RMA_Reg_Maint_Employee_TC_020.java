...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_Reg_Maint_Employee_TC_020
//Description    : Verify That Error Must Be Displayed If Required Supplemental Field Is Not Present On The Dependent
//Depends On TC  : None
//Revision       : 0.0 - ShrutiShruti-03-15-2018 
//======================================================================================================================================================================================================================================================================================

public class RMA_Reg_Maint_Employee_TC_020 extends RMA_TC_BaseTest{
	@Test
	public void RMA_Reg_Maint_Employee_TC_020_Test() throws Exception,Error{
		try{
			parentlogger = reports.startTest("RMA_Reg_Maint_Employee_TC_020_Validation If Supplementals Field Is Not Present On Dependents Screen", "Error Must Be Displayed If Required Supplemental Field Is Not Present On The Dependent Is Validated");
			...
			StrScreenShotTCName = "RMA_Reg_Maint_Employee_TC_020";
			ErrorMessage = null;
			...
			StrDependentsFirstName=RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(3, "DependentsFirstName_");
			...
			RMA_Input_Utility.RMA_SetValue_Utility(RMA_Selenium_POM_Dependents.RMAApp_Dependents_Txt_FirstName(driver), "First Name TextBox On Dependents Creation Page", StrDependentsFirstName, logval);
			...
			RMA_Verification_Utility.RMA_VerifyUXMessage("Missing value for required supplemental field: "+UserPrompt_Txt, false, "Dependents Creation Page", logval);			
			//Verification Of Error Message On Power View Editor Page
			
			parentlogger.log(LogStatus.INFO, parentlogger.addScreenCapture(RMA_ScreenCapture_Utility.RMA_ScreenShotCapture_Utility(driver, "Validation Messages Over Dependents", "Successful Validation Message")));
