...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_SeleniumRegression_TC_134
//Description    : Create, Edit and Delete of Attachments For A Employee(PI) On A Litigation Page Is Validated
//Depends On TC  : RMA_SeleniumRegression_TC_024(For the Litigation Creation)
//Revision       : 0.0 - ShrutiShruti-01-12-2018
//======================================================================================================================================================================================================================================================================================

public class RMA_SeleniumRegression_TC_134 extends RMA_TC_BaseTest{
	@Test
	public void RMA_SeleniumRegression_TC_134_Test() throws Exception,Error{
		try{
		parentlogger = reports.startTest("RMA_SeleniumRegression_TC_134_Create, Edit And Delete Of Attachments On Person Involved(Employee) On A Litigation Screen", "Create,Edit and Delete Of Attachments On A Person Involved(Employee) On A Litigation Is Validated");
		parentlogger.assignAuthor("Shruti Shruti");

		StrScreenShotTCName = "RMA_SeleniumRegression_TC_134";
		testcall1 = false;	
