...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_SeleniumRegression_TC_068
//Description    : Create,Edit and Delete Of Enhanced Note On A Person Involved(Employee) Is Validated
//Depends On TC  : RMA_SeleniumRegression_TC_058/059
//Revision       : 0.0 - ShrutiShruti-12-19-2017 
//======================================================================================================================================================================================================================================================================================


public class RMA_SeleniumRegression_TC_068 extends RMA_TC_BaseTest{ 
	@Test
	public void RMA_SeleniumRegression_TC_068_Test() throws Exception,Error{
		try{
			parentlogger = reports.startTest("RMA_SeleniumRegression_TC_068_Create, Edit And Delete Of Enhanced Notes On Person Involved(Employee) Screen", "Create,Edit and Delete Of Enhanced Note On A Person Involved(Employee) Is Validated");
			parentlogger.assignAuthor("Shruti Shruti");

			StrScreenShotTCName = "RMA_SeleniumRegression_TC_068";
			testcall1 = false;	
