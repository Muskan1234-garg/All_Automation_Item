...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_SeleniumRegression_TC_091
...
public class RMA_SeleniumRegression_TC_091 extends RMA_TC_BaseTest{
	@Test
	public void RMA_SeleniumRegression_TC_091_Test() throws Exception,Error{
		try{
			testcall1=false;
			...
			StrScreenShotTCName = "SeleniumRegression_TC_091";
			...
			parentlogger = reports.startTest("RMA_SeleniumRegression_TC_091_Create, Edit and Delete of Enhanced Notes On Injury/Illness Page", "Create, Edit and Delete of Enhanced Notes On Injury/illness Page Is Validated");
			...
			testcall2 = true;
			Injury=RMA_Functionality_Utility.RMA_InjuryIllnessCreateEditDelete_Utility("Caught Between", "Injuries","AB", StrPatientLastName, InjuryCreation_Txt_DateOfFileClosing, InjuryCreation_Txt_DisabilityDate, logval);
			...
			driver.switchTo().parentFrame();
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_Home.RMAApp_DefaultView_Lbl_BreadcrumbName(driver, StrPatientLastName),StrClaimNumber +" Claim Number Link At Top Of The Screen",logval);
