...
//====================================================================================================================================================================================================================================================================================
public class RMA_Smoke_TC_039 extends rmaseleniumtestscripts.RMA_TC_BaseTest {
	@Test 
	public void RMA_Smoke_TC_039_Test () throws Exception, Error 
	{
		StrScreenShotTCName = null;
		StrScreenShotTCName = "Smoke_TC_039";
		testcall1 = false;	
		...
		parentlogger = reports.startTest("RMA_Smoke_TC_039_Send Mail Verification For Collection", "Send Mail Functionality For A Collection Is Validated");
		...
		RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_Home.RMAApp_Generic_Img_SendMail(driver), "Send Mail Image On Collection Page", logval);
		//===========================================================Steps To Open Send Mail Page Completed Here=========================================================================================================
		//===========================================================Steps To Send Mail Started Here===================================================================================================================
		parentlogger.log(LogStatus.INFO,"Following Function:: "+RMA_GenericUsages_Utility.RMA_LoggerHyperlink("SendMail","RMA_SendMail_Utility",0)+" Is Called To Send Mail For Collection::"+ " "+RMA_Smoke_TC_014.StrControlNumber_Smoke_TC_014);
		testcall1 = true;
		MailBody = RMA_Functionality_Utility.RMA_SendMail_Utility(RMAApp_SendMail_Txt_To, RMAApp_SendMail_Txt_CC, "Collection Page For Control Number" +  " " +RMA_Smoke_TC_014.StrControlNumber_Smoke_TC_014 , "Email", StrClaimNumber,true,logval1);
