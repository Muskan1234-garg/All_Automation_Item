...
//=====================================================================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_QTPRegression_TC_004
//Description    : '1 - Transaction Date within X Days.' Duplicate Payment Criteria Is Validated 
//Depends On TC  : None
//Revision       : 0.0 - NidhiJha-07-19-2017
//===================================================================================================================================================================================================================================================================================================================================

public class RMA_QTPRegression_TC_004 extends RMA_TC_BaseTest {
	@Test
	public void RMA_QTPRegression_TC_004_Test() throws Exception,Error{

		StrScreenShotTCName = null;
		StrScreenShotTCName = "RMA_QTPRegression_TC_004";
		testcall1 = false;	
		...
		try{    
			parentlogger = reports.startTest("RMA_QTPRegression_TC_004_Duplicate_Payment_Criteria_1_Validation", "'1 - Transaction Date within X Days' Duplicate Payment Criteria Is Validated ");
			...
			Payment_Lst_PayeeType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_004", 1, 0); // Payee Type Is Fetched From DataSheet RMA_QTPRegression_TC_004
			FundsSplitDetails_Lst_TransactionType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_004", 1, 1); //Transaction Type Is Fetched From DataSheet RMA_QTPRegression_TC_004
			FundsSplitDetails_Txt_Amount = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_QTPRegression_TC_004", 1, 2); //Amount Is Fetched From DataSheet RMA_QTPRegression_TC_004
			Payment_Txt_LastName = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_004", 1, 3); //LastName Is Fetched From DataSheet RMA_QTPRegression_TC_004
			Payment_Txt_DisType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_004", 1, 4); //Distribution Type Is Fetched From DataSheet RMA_QTPRegression_TC_004
			ReserveType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_004", 1, 5); // Reserve Type Is Fetched From DataSheet RMA_QTPRegression_TC_004
			//Payment Data Fetched Is Completed Here

			GenClaimCreation_Txt_ClaimType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_004", 1, 6); //Claim Type Is Fetched From DataSheet RMA_QTPRegression_TC_004
			GenClaimCreation_Txt_ClaimStatus =  ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_004", 1,7 ); //Claim Status Is Fetched From DataSheet RMA_QTPRegression_TC_004
			GenClaimCreation_Txt_Department = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_004", 1,8 ); //Department Is Fetched From DataSheet RMA_QTPRegression_TC_004
			...
			rmaseleniumutilties_UX.RMA_Functionality_Utility.DuplicatePaymentCriteria_Utility("1 - Transaction Date within X Days", logval);	
