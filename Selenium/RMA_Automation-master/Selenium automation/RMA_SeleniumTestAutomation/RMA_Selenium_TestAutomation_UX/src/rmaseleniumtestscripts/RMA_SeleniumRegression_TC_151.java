...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_SeleniumRegression_TC_151
//Description    : Create,Edit And Delete Of Attachments On Vehicle On Maintenance Screen
//Depends On TC  : RMA_Smoke_TC_041_I
//Revision       : 0.0 - ShrutiShruti-01-11-2018 
//======================================================================================================================================================================================================================================================================================

public class RMA_SeleniumRegression_TC_151 extends RMA_TC_BaseTest{
	@Test
	public void RMA_SeleniumRegression_TC_151_Test() throws Exception,Error{
		try{
			parentlogger = reports.startTest("RMA_SeleniumRegression_TC_151_Create, Edit and Delete of Attachmments On Vehicle Page On Maintenance Screen", "Create, Edit and Delete of Attachments On Vehicle Page on Maintenance Screen Is Validated");
			...
			StrScreenShotTCName = "RMA_SeleniumRegression_TC_151";
			ErrorMessage = null;
			CurrentFrameID=null;
			...
			//=================================================Steps To Delete Vehicle Started Here=================================================================================================================================================================================================
			RMA_Functionality_Utility.RMA_GenericDelete_Utility("Maintenance-->Vehicle", false, logval);
			RMA_Functionality_Utility.RMA_GenericDelete_Utility("Maintenance-->Vehicle", true, logval);
			//=================================================Steps To Delete Vehicle Completed Here=============================================================================================================================================================================================================================
			driver.switchTo().parentFrame();
		}
