...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_SeleniumRegression_TC_117
//Description    : Create, Edit and Delete of Attachments For A OtherPerson(PI) Is Validated
//Depends On TC  : None
//Revision       : 0.0 - ShrutiShruti-01-11-2018
//======================================================================================================================================================================================================================================================================================

public class RMA_SeleniumRegression_TC_117 extends RMA_TC_BaseTest{
	@Test
	public void RMA_SeleniumRegression_TC_117_Test() throws Exception,Error{
		try{
			parentlogger = reports.startTest("RMA_SeleniumRegression_TC_117_Create, Edit And Delete Of Attachments On Person Involved(OtherPerson) Screen", "Create,Edit and Delete Of Attachments On A Person Involved(OtherPerson) Is Validated");
