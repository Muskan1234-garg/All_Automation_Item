...
//====================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_Reg_Maint_Vehicle_TC_004
//Description    : Create And Delete Of Vehicle From Maintenance Screen Is Validated
//Depends On TC  : None
//Revision       : 0.0 - NikitaThani-02-17-2018 
//======================================================================================================================================================================================================================================================================================

public class RMA_Reg_Maint_Vehicle_TC_004 extends RMA_TC_BaseTest {
	@Test
	public void RMA_Reg_Maint_Vehicle_TC_004_Test() throws Exception,Error
	{
		try{
			parentlogger = reports.startTest("RMA_Reg_Maint_Vehicle_TC_004_Create And Delete Of Vehicle From Maintenance Screen", " Create And Delete Of Vehicle From Maintenance Screen Is Validated");
			...
			StrScreenShotTCName = "RMA_Reg_Maint_Vehicle_TC_004";
			ErrorMessage = null;
