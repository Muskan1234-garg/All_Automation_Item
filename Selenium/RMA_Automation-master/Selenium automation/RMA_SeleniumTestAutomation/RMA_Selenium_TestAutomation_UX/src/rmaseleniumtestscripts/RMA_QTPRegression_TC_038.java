...
//=====================================================================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_QTPRegression_TC_038
//Description    : Verify Reserve and Incurred Balance calculations with selection of checkbox 'Calculate Collections in Reserve Balance
//Depends On TC  : None
//Revision       : 0.0 - AbhishekRai-09-12-2017
//===================================================================================================================================================================================================================================================================================================================================

public class RMA_QTPRegression_TC_038 extends RMA_TC_BaseTest {	
	@Test
	public void RMA_QTPRegression_TC_038_Test() throws Exception,Error {
		try{ 
			parentlogger = reports.startTest("RMA_QTPRegression_TC_038_Calculate Collections in Reserve Balance", "Verify Reserve and Incurred Balance calculations with selection of checkbox 'Calculate Collections in Reserve Balance");
			parentlogger.assignAuthor("Abhishek Rai");
			
			//Region =====================================================Global Variable Initialization Is Started Here=====================================================================================================
			StrScreenShotTCName = null;
			StrScreenShotTCName = "RMA_QTPRegression_TC_038";
			testcall1 = false;	
			...
			LineOfBussinessParameterSetup_Lst_LOBType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_038", 1, 0); //LOB Type Is Fetched From DataSheet RMA_QTPRegression_TC_038
			GenClaimCreation_Txt_ClaimType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_038", 1, 1); //Claim Type Is Fetched From DataSheet RMA_QTPRegression_TC_038			
			GenClaimCreation_Txt_Department = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_038", 1, 2); //Department Is Fetched From DataSheet RMA_QTPRegression_TC_038
			GenClaimCreation_Txt_ClaimStatus =  ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_038", 1, 3); //Claim Status Is Fetched From DataSheet RMA_QTPRegression_TC_038
			ReserveCreation_Lst_ReserveStatus = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_038", 1, 4); // Reserve Status Is Fetched From DataSheet RMA_QTPRegression_TC_038
			ReserveCreation_Lst_ReserveType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_038", 1, 5); // Reserve Type Is Fetched From DataSheet RMA_QTPRegression_TC_038
			ReserveCreation_Txt_ReserveAmount = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_QTPRegression_TC_038", 1, 6);  //Reserve Amount Is Fetched From DataSheet RMA_QTPRegression_TC_038
			ReserveCreation_Lst_ReserveType_1 = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_038", 1, 7); // Reserve Type_1 Is Fetched From DataSheet RMA_QTPRegression_TC_038
			ReserveCreation_Txt_ReserveAmount_1 = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_QTPRegression_TC_038", 1, 8);  //Reserve Amount_1 Is Fetched From DataSheet RMA_QTPRegression_TC_038
			ReserveCreation_Lst_ReserveType_2 = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_038", 1, 9); // Reserve Type_2 Is Fetched From DataSheet RMA_QTPRegression_TC_038
			ReserveCreation_Txt_ReserveAmount_2 = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_QTPRegression_TC_038", 1, 10);  //Reserve Amount_2 Is Fetched From DataSheet RMA_QTPRegression_TC_038
			PaymentCreation_Lst_BankAccount = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_038", 1, 11); //Bank Account Is Fetched From DataSheet RMA_QTPRegression_TC_038
			PaymentCreation_Lst_PayeeType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_038", 1, 12); // Payee Type Is Fetched From DataSheet RMA_QTPRegression_TC_038
			PaymentCreation_Txt_LastName = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_038", 1, 13); //LastName Is Fetched From DataSheet RMA_QTPRegression_TC_038			
			PaymentCreation_Txt_DisType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_038", 1, 14); //Distribution Type Is Fetched From DataSheet RMA_QTPRegression_TC_011
			FundsSplitDetails_Txt_Amount = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_QTPRegression_TC_038", 1, 15); //Amount Is Fetched From DataSheet RMA_QTPRegression_TC_038
			FundsSplitDetails_Lst_TransactionType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_QTPRegression_TC_038", 1, 16); //Transaction Type Is Fetched From DataSheet RMA_QTPRegression_TC_038						
			...
			String []ExpectedValueToBeVerifiedE={"$" + ReserveCreation_Txt_ReserveAmount + ".00", "$"+ FundsSplitDetails_Txt_Amount +".00", "$"+ FundsSplitDetails_Txt_Amount +".00", "$" + ReserveCreation_Txt_ReserveAmount + ".00", ReserveCreation_Lst_ReserveStatus};
			String []ExpectedValueToBeVerifiedI={"$" + ReserveCreation_Txt_ReserveAmount + ".00", "$"+ FundsSplitDetails_Txt_Amount +".00", "$"+ FundsSplitDetails_Txt_Amount +".00", "$"+ ReserveCreation_Txt_ReserveAmount+ ".00", ReserveCreation_Lst_ReserveStatus};
