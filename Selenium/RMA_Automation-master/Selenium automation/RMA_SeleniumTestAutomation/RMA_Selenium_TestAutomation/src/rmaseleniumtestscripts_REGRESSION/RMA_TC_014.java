...
//Description    : RMA_TC_014_ Successful Creation Of A Diary From Person Involved Is Validated
...
public class RMA_TC_014 extends rmaseleniumtestscripts.RMA_TC_BaseTest {
	...
	public void RMA_TC_014_Test() throws Exception,Error {
		...
		try{
			parentlogger = reports.startTest("RMA_TC_014_ Attach A Diary From Person Involved", "Successful Creation Of A Diary From Person Involved Is Validated");
			...
			ActivityList = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_014", 1, 0); // Activity List Is Fetched From DataSheet RMA_TC_014
			testcall1 = false;			
			loggerval1 = "NotInitialized";
			StrScreenShotTCName = "RMA_TC_014";
			//Variable Initialization Completed
			
			/*================================================== Steps To Add New Employee Is On Claim--> PI Started Here================================================================*/
			RMA_Navigation_Utility.RMA_ObjectRightClick(RMA_Selenium_POM_Home.RMAApp_LeftHandNavTree_Lnk_Claim_PI(driver, StrClaimNumber_002), "Person Involved Link On Left Hand Navigation Tree Under Claim", logval);
			...
			parentlogger.log(LogStatus.INFO, "New Employee Is Created Successfully With Employee Number::"+ " " + color.RMA_ChangeColor_Utility(StrEmployeeNumber,3));
			...
			/*================================================== Steps To Add New Employee Is On Claim--> PI Ended Here================================================================*/
