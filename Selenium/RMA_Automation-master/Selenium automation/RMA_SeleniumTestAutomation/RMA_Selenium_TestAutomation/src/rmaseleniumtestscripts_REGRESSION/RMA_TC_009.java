...
//Description    : RMA_TC_009_ Successful Creation Of A Diary From Adjuster Is Validated
...
public class RMA_TC_009 extends rmaseleniumtestscripts.RMA_TC_BaseTest {
	...
	@Test
	public void RMA_TC_009_Test() throws Exception,Error {

		try{
			parentlogger = reports.startTest("RMA_TC_009_ Attach A Diary From Adjuster", "Successful Creation Of A Diary From Adjuster Is Validated");
			...
			ActivityList = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_009", 1, 0); // Activity List Is Fetched From DataSheet RMA_TC_009
			testcall1 = false;			
			loggerval1 = "NotInitialized";
			StrScreenShotTCName = "RMA_TC_009";
			...
			testcall1 = true;
			StrAdjuster = RMA_Functionality_Utility.RMA_ClaimEntityAddition_Utility("Adjustor", "Adjuster (0)", StrClaimNumber_002, "curradj", "Not Required", "Not Required", "Not Required", "Not Required", "Not Required", "Not Required", logval1);
			...
			RMA_Navigation_Utility.RMA_WebCheckBoxSelect_Utility(RMA_Selenium_POM_DiaryList.RMAApp_Diaries_Chk_ActiveDiaries(driver), "uncheck", "Active Diaries Check Box", "View Diary Page", logval);
