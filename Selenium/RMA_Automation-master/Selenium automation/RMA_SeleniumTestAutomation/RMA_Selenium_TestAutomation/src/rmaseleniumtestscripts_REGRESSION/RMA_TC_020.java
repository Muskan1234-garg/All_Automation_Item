...
//Description    : Successful Add, Edit And Delete User And Assign and Delete User from A DataSource Is Validated
//Depends On TC  : None
//Revision       : 0.0 - RenuVerma-03-14-2017
//=================================================================================================

public class RMA_TC_020 extends rmaseleniumtestscripts.RMA_TC_BaseTest {
	...
	public void RMA_TC_020_Test() throws Exception,Error {
		try{
			parentlogger = reports.startTest("RMA_TC_020_ Add, Edit And Delete User And Assign and Delete User from A DataSource From SMS Page", "Successful Add, Edit And Delete User And Assign and Delete User from A DataSource From SMS Page Is Validated");
			...
			UserManager = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_020", 1, 0); // User Manager Is Fetched From DataSheet RMA_TC_020
			UserEmail=ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_020", 1, 1); // User Email Is Fetched From DataSheet RMA_TC_020
			AccessSMSStatus=ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_020", 1, 2); // Access SMS CheckBox Status Is Fetched From DataSheet RMA_TC_020
			AccessUSPStatus=ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_020", 1, 3); // Access USP CheckBox Status Is Fetched From DataSheet RMA_TC_020
			ModuleName=ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_020", 1, 4); // Module Name Is Fetched From DataSheet RMA_TC_020
			UserCompanyName=ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_020", 1, 5); //Company Name Is Fetched From DataSheet RMA_TC_020
			EditedUserManager = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_TC_020", 5, 0); // Edited User Manager Is Fetched From DataSheet RMA_TC_020
			EditedAccessSMSStatus=ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_020", 5, 1); // Edited Access SMS CheckBox Status Is Fetched From DataSheet RMA_TC_020
			EditedAccessUSPStatus=ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_020", 5, 2); // Edited Access USP CheckBox Status Is Fetched From DataSheet RMA_TC_020
			...
			EditedUserFirstName=RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(6, "EditUFN_");// Generate User first name to edit the user name
			EditedUserLastName=RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(6, "EditULN_");// Generate User last name to edit the user name
			testcall1 = false;	
			...
			StrScreenShotTCName = "RMA_TC_020";
			...
			//ToolTipMessageOnEdit=RMA_GenericUsages_Utility.RMA_GetToolTip_Info(RMA_Selenium_POM_SMS.RMAApp_SMSUser_Btn_EditUser(driver), logval);
			//RMA_Verification_Utility.RMA_TextCompare("Edit", ToolTipMessageOnEdit, "Tool Tip Message On User Setting Edit Button ", logval);
			...
			//Verify that Company Name containing special characters is getting saved properly while creating new user.
			...
			//uncomment after fixing of JIRA RMA-37632 
