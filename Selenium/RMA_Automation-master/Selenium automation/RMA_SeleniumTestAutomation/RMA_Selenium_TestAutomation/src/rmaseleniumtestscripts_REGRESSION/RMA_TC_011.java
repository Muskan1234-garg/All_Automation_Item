...
//Description    : RMA_TC_011_ Successful Creation Of A Diary From Defendant Is Validated
...
public class RMA_TC_011 extends rmaseleniumtestscripts.RMA_TC_BaseTest {
	...
	public void RMA_TC_011_Test() throws Exception,Error {
		...
		try{
			parentlogger = reports.startTest("RMA_TC_011_ Attach A Diary From Defendant", "Successful Creation Of A Diary From Defendant Is Validated");
			...
			ActivityList = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_011", 1, 0); // Activity List Is Fetched From DataSheet RMA_TC_011
			testcall1 = false;			
			loggerval1 = "NotInitialized";
			StrScreenShotTCName = "RMA_TC_011";
			...
			testcall1 = true;
			StrDefendant = RMA_Functionality_Utility.RMA_ClaimEntityAddition_Utility("Defendant", "Defendant (0)", StrClaimNumber_002, "Not Required", "Not Required", "Not Required", "Not Required", "Not Required", "Not Required", "Not Required", logval1);
			parentlogger.log(LogStatus.INFO, "New Defendant Is Created Successfully With Last Name::"+ " " + color.RMA_ChangeColor_Utility(StrDefendant, 3));
