...
public class RMA_TC_004 extends rmaseleniumtestscripts.RMA_TC_BaseTest {
	...
	static String CurrentUserName_TC_004;
	static String CurrentUserPassword_TC_004;

	@Test
	public void RMA_TC_004_Test() throws Exception,Error {

		try{
			parentlogger = reports.startTest("RMA_TC_004_ Route Diary To A Specific User On Diary List Page", "Successfully Route Diary To a Specific User On Diary List Page Is Validated");
			...
			ActivityList = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_004", 1, 0); // Activity List Is Fetched From DataSheet RMA_TC_004
			RoutedUserName = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_004", 1, 1); //RoutedUserName Fetched From DataSheet RMA_TC_004
			RoutedPassword = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_004", 1, 2); //RoutedPassword Fetched From DataSheet RMA_TC_004
			DiaryNote= ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_004", 1, 3); //DiaryNote Fetched From DataSheet RMA_TC_004
			...
			CurrentUserName_TC_004 = ExcelData1.RMA_ExcelStringDataRead_Utility("RMA_TC_001", 1, 0); //Current UserName Fetched From DataSheet RMA_TC_001
			CurrentUserPassword_TC_004 = ExcelData1.RMA_ExcelStringDataRead_Utility("RMA_TC_001", 1, 1); //Current User Password Fetched From DataSheet RMA_TC_001
			...
			DiaryTaskName = RMA_Functionality_Utility.RMA_AttachCreateEdit_Diary("Create", DiaryNote, ActivityList, "check", "check", DueDate, logval);
			...
			driver.switchTo().parentFrame(); // A Switch To The Parent Frame Is Made
			...
			RMA_Input_Utility.RMA_SetValue_Utility(RMA_Selenium_POM_Login_DSNSelect_Frames.RMAApp_Login_Txt_UserName(driver), "RoutedUserName Text Box On RMA Application Login Page", RoutedUserName,logval);
			RMA_Input_Utility.RMA_SetValue_Utility(RMA_Selenium_POM_Login_DSNSelect_Frames.RMAApp_Login_Txt_PassWord(driver), "RoutedPassword Text Box On RMA Application Login Page", RoutedPassword,logval);
			RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_Login_DSNSelect_Frames.RMAApp_Login_Btn_Login(driver), "LogIn Button On RMA Application Default View Page",logval);
			...
			RMA_Verification_Utility.RMA_TextCompare( RoutedUserName, RMA_Selenium_POM_Home.RMAApp_DefaultView_LoginUserName(driver).getText(), "Correct RoutedUserName Display", logval);
	...
	public void RMA_FailureReport(ITestResult result) throws Exception, Error   //All The Information Associated With The Test Case Is Stored In Result Variable
	{
		...
		{			
			try {
				...
				RMA_Input_Utility.RMA_SetValue_Utility(RMA_Selenium_POM_Login_DSNSelect_Frames.RMAApp_Login_Txt_UserName(driver), "RoutedUserName Text Box On RMA Application Login Page", CurrentUserName_TC_004,logval);
				RMA_Input_Utility.RMA_SetValue_Utility(RMA_Selenium_POM_Login_DSNSelect_Frames.RMAApp_Login_Txt_PassWord(driver), "RoutedPassword Text Box On RMA Application Login Page", CurrentUserPassword_TC_004,logval);
				RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_Login_DSNSelect_Frames.RMAApp_Login_Btn_Login(driver), "LogIn Button On RMA Application Default View Page",logval);
				globalWait.until(ExpectedConditions.elementToBeClickable(RMA_Selenium_POM_Login_DSNSelect_Frames.RMAApp_DSNSelect_Lst_DataSourceName(driver)));
				// Application Is Logged In
				...
				parentlogger.appendChild(logger);
				// Data Source Is Selected 
				RMA_Verification_Utility.RMA_TextCompare( CurrentUserName_TC_004,RMA_Selenium_POM_Home.RMAApp_DefaultView_LoginUserName(driver).getText(), "Correct RoutedUserName Display", logval);
