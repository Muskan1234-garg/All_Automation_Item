...
//Description    : RMA_TC_010_ Successful Creation Of A Diary From Claimant Is Validated
...
public class RMA_TC_010 extends rmaseleniumtestscripts.RMA_TC_BaseTest {
	...
	@Test
	public void RMA_TC_010_Test() throws Exception,Error {

		try{
			parentlogger = reports.startTest("RMA_TC_010_ Attach A Diary From Claimant", "Successful Creation Of A Diary From Claimant Is Validated");
			...
			ActivityList = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_010", 1, 0); // Activity List Is Fetched From DataSheet RMA_TC_010
			testcall1 = false;			
			loggerval1 = "NotInitialized";
			StrScreenShotTCName = "RMA_TC_010";
			...
			testcall1 = true;
			StrClaimant = RMA_Functionality_Utility.RMA_ClaimEntityAddition_Utility("Claimant", "Claimant (0)", StrClaimNumber_002, "Not Required", "Not Required", "Not Required", "Not Required", "Not Required", "Not Required", "Not Required", logval1);
			parentlogger.log(LogStatus.INFO, "New Claimant Is Created Successfully With Last Name::"+ " " + color.RMA_ChangeColor_Utility(StrClaimant, 3));
