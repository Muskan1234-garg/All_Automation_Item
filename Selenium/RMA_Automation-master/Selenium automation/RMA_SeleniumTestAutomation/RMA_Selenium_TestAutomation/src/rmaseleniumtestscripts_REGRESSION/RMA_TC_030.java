...
import rmaseleniumtestscripts.RMA_Smoke_TC_002_NonOcc;
...
//Description    : Functionality of Adjuster Creation Permission Setting For Non-Occupational Claims On Security Management System Is Validated
//Depends On TC  : None
//Revision       : 0.0 - KumudNaithani-05-11-2017
//===================================================================================================================================================================================================================================
public class RMA_TC_030 extends rmaseleniumtestscripts.RMA_TC_BaseTest {
...
{   
	...
	String StrClaimNumber_030;
	//Local Variable Declaration Completed
	 
	 parentlogger = reports.startTest("RMA_TC_030 Adjuster Creation Permission Setting For Non-Occupational Claim Validation", "Functionality of Adjuster Creation Permission Setting For Non-Occupational Claim On Security Management System Is Validated");
	 ...
	 RMAApp_SMS_Lnk_ModuleSecurityGroup = ExcelData_1.RMA_ExcelStringDataRead_Utility("RMA_TC_030", 1, 0); //Module Security Group Name Is Fetched From DataSheet RMA_TC_030
	 RMAApp_SMS_Lnk_ModuleAccessPermission = ExcelData_1.RMA_ExcelStringDataRead_Utility("RMA_TC_030", 1, 1); //Module Access Permission Name Is Fetched From DataSheet RMA_TC_030
	 RMAApp_SMS_Lnk_ModuleAccessPermission_1 = ExcelData_1.RMA_ExcelStringDataRead_Utility("RMA_TC_030", 1, 2); //Module Access Permission Name Is Fetched From DataSheet RMA_TC_030
	 RMAApp_SMS_Lnk_ModuleAccessPermission_2 = ExcelData_1.RMA_ExcelStringDataRead_Utility("RMA_TC_030", 1, 3); //Module Access Permission Name Is Fetched From DataSheet RMA_TC_030
	 RMAApp_SMS_Lnk_ModuleAccessPermission_3 = ExcelData_1.RMA_ExcelStringDataRead_Utility("RMA_TC_030", 1, 4); //Module Access Permission Name Is Fetched From DataSheet RMA_TC_030	
	...
	// Required Module Security Group Link Is Expanded
	 ...
	 RMA_Verification_Utility.RMA_VerifyUXSpinnerDisappered(logval);
	 System.out.println("module1"+RMAApp_SMS_Lnk_ModuleAccessPermission_1);
	 ...
	 RMA_Verification_Utility.RMA_VerifyUXSpinnerDisappered(logval);
	 System.out.println("module2"+RMAApp_SMS_Lnk_ModuleAccessPermission_2);
	...
	//Required Module Access Permissions Are Set
	 ...
	 //===========================================================Disabling Of New Adjuster Creation Permission For Non-Occupational Claims In Security Management System Is Completed Here==================================================================================================================================================================================================================================================================================================================================================
	...
	//===========================================================New Non Occupational Claim Creation Is Started Here====================================================================================================================================================================================================================================================================================================================================================
	 parentlogger.log(LogStatus.INFO, "Following Test Is Called To Create A Non Occupational Claim:: "+RMA_GenericUsages_Utility.RMA_LoggerHyperlink("RMASmokeTC002NonOcc", "RMA_Smoke_TC_002_NonOcc",0));
     testcall1 = true;
     RMA_Smoke_TC_002_NonOcc nonoccupationalclaim = new RMA_Smoke_TC_002_NonOcc();
     StrClaimNumber_030 = nonoccupationalclaim.RMA_Smoke_TC_002_NonOcc_Test();  //Created Non Occupational Claim Number Is Stored In Variable StrClaimNumber_030
     loggerval1 = logger.toString();
     parentlogger.log(LogStatus.INFO, "A New Non Occupational Claim Is Created With Claim Number:: "+ color.RMA_ChangeColor_Utility(StrClaimNumber_030, 2));
     parentlogger.appendChild(logger);
 	//===========================================================New Non Occupational Claim Creation Is Completed Here=================================================================================================================================================================================================================================================================================================================================================
	...
	//Required Module Access Permissions Are Set
	 ...
	 driver.close();
	 driver.switchTo().window(StrRMAWindowHandle);
	 //===========================================================Enabling Of New Adjuster Creation Permission For Non-Occupational Claims In Security Management System Is Completed Here==================================================================================================================================================================================================================================================================================================================================================
	...
	//=========================================================== Steps To Validate That New Adjustor Can Be Created Is Completed Here====================================================================================================================================================================================================================================================================================================================================================================
		 ...
		 FinalErrorMessage = ExceptionRecorded;
			...
			{
				logger.log(LogStatus.FAIL,"Following Error Occurred  ::" + " "+  color.RMA_ChangeColor_Utility(FinalErrorMessage,1)+ " " + "While Executing Test Case" +" "+ "RMA_Smoke_TC_002_NonOcc: Non Occupational Claim Creation " + " " +  "And Hence The Test Case Is A Fail");
				parentlogger.appendChild(logger);
			}
