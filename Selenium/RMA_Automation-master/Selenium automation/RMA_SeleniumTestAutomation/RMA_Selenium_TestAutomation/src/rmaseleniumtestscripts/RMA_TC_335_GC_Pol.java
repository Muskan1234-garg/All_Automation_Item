...
//================================================================================================
//TestCaseID     : RMA_TC_335_GC_Pol
//Description    : Successful Creation Of General Claim With Attached Policy Is Validated
//Depends On TC  : None
//Revision       : 0.0 - KumudNaithani-03-14-2017
//=================================================================================================

public class RMA_TC_335_GC_Pol extends RMA_TC_BaseTest {
	...
	@Test
	public void RMA_TC_335_GC_Pol_Test() throws Exception,Error {

		try{
			parentlogger = reports.startTest("RMA_TC_335_GC_Pol_General Claim Creation With Attached Policy", "Successful Creation Of General Claim With Attached Policy Is Validated");
			...
			String StrPolicyNo_335_GC_Pol;		
			//Local Variable Declaration Completed Here
			
			StrScreenShotTCName = "TC_335_GC_Pol";
			testcall1 = false;
			...
			RMA_GenericUsages_Utility.RMA_WindMsgHandlerAndTextVerify_Utility("Yes", "Partial", "Policy Interface is used for point policy system.", "Message To Confirm Usage/Enabling Of Policy System Interface System", logval);
			...
			parentlogger.log(LogStatus.INFO, "HTML","The Functional Utility : "+RMA_GenericUsages_Utility.RMA_LoggerHyperlink("GCClaimACON", "RMA_GeneralClaimCreation_ACON", 0)+ " Is Called To Create A General Claim Policy");
			testcall1 = true;
			StrClaimNumber_335=RMA_Functionality_Utility.RMA_GeneralClaimCreation_ACON(RMAApp_GeneralClaim_Txt_ClaimType, RMAApp_GeneralClaim_Txt_Department, RMAApp_GeneralClaim_Txt_DateOfEvent, RMAApp_GeneralClaim_Txt_TimeOfEvent, RMAApp_GeneralClaim_Txt_DateOfClaim, RMAApp_GeneralClaim_Txt_TimeOfClaim, RMAApp_GeneralClaim_Txt_PolicyLOB,false, logval1);
			loggerval1 = logger.toString();
			parentlogger.appendChild(logger);
			//===========================================================Creation Of General Claim Is Completed ===================================================================================================================================================================================================================================================================================================================================================================
			
			//===========================================================Steps To Attach Policy To Created General Claim Is Started ==============================================================================================================================================================================================================================================================================================================================================================
			...
			StrPolicyName_335=RMA_Functionality_Utility.RMA_PolicyDownload_Utility(RMAApp_GeneralClaim_Txt_PolicySystemName,RMAApp_GeneralClaim_Txt_DateOfEvent,RMAApp_GeneralClaim_Txt_PolicyLOB , RMAApp_GeneralClaim_Txt_PolicyNo, "Status:Verified",StrClaimNumber_335 ,"Yes","Download Policy",logval1);
			String StrPolicyName[]=StrPolicyName_335.split(" "); // Split The Policy No from the Policy Name
			StrPolicyNo_335_GC_Pol=StrPolicyName[1];// Filter Box Value// Fetch the Policy No Which Is On The First Index(e.g.APV 0381852 03)
			loggerval1 = logger.toString();
			parentlogger.appendChild(logger);
			parentlogger.log(LogStatus.INFO, "New General Claim Is Created With Claim Number:: "+ color.RMA_ChangeColor_Utility(StrClaimNumber_335, 2)+ " And Policy Number:: "+color.RMA_ChangeColor_Utility(StrPolicyNo_335_GC_Pol, 2));
			//===========================================================Steps To Attach Policy To Created General Claim Is Completed ==============================================================================================================================================================================================================================================================================================================================================================
