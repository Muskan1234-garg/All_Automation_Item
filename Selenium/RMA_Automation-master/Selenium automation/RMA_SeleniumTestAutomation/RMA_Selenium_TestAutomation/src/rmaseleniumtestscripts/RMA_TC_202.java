...
//================================================================================================
//TestCaseID     : RMA_TC_202
//Description    : TC_202_Verify Adding,Editing And Deleting Of Existing Other Person As Person Involved  For Vechile Accident Claim
//Depends On TC  : RMA_TC_198
//Revision       : 0.0 - KumudNaithani-07-21-2016
//=================================================================================================

public class RMA_TC_202 extends RMA_TC_BaseTest {
	...
	@Test
	public void RMA_TC_202_Test() throws Exception,Error {

		try{
			parentlogger = reports.startTest("TC_202_Adding, Editing And Deleting Of An Existing Other Person", "Verify Adding,Editing And Deleting Of An Existing Other Person As Person Involved For Vechile Accident Claim");
			parentlogger.assignAuthor("Kumud Naithani");

			String StrOtherPersonLastName_202;
			String StrPrimaryWindowHandle;
			String StrOtherPersonLastNameActual_202;
			String StrOtherPersonNameChanged;
			String StrClaimNaumberActual;

			//Local Variable Declaration Completed Here

			StrScreenShotTCName = "TC_202";
			testcall1 = false;	
			testcall2 = false;	
			...
			testcall1 = true;
			StrOtherPersonLastName_202 = RMA_Functionality_Utility.RMA_MaintEntityAddition_Utility("OtherPeople", logval1);
			parentlogger.log(LogStatus.INFO, "Other Person Is Created Successfully With Name::"+ " " + color.RMA_ChangeColor_Utility(StrOtherPersonLastName_202, 2));
			...
			RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_Home.RMAApp_LeftHandNavTree_Img_ExpandCollapse(driver, RMA_TC_198.StrClaimNumber_198), "Expand Image Corresponding To Vechile Accident Link On Left Navigation Tree", logval);
			RMA_GenericUsages_Utility.RMA_StaticWait(5, logval, "Wait Is Added As Expand Image Corresponding To Vechile Accident Claim Link On Left Navigation Tree Is Clicked ");
			...
			RMA_Functionality_Utility.RMA_StandardSearch_Window(RMA_POM_Search.RMAApp_SearchEntity_Txt_LastName(driver), "Standard Entity Search Page", "Last Name TextBox", StrOtherPersonLastName_202, "Other People", "piother", StrPrimaryWindowHandle, logval);
			RMA_Functionality_Utility.RMA_GenericSave_Utility("piother", false, "NA", "Persons Involved-->Other Person Page", logval);
			StrOtherPersonLastNameActual_202 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrOtherPersonLastName_202, StrOtherPersonLastNameActual_202 , "Other Person Last Name", logval);
			...
			RMA_Functionality_Utility.RMA_GenericSave_Utility("piother", false, "NA", "Persons Involved-->Other Person Page", logval);
			StrOtherPersonLastNameActual_202 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrOtherPersonNameChanged, StrOtherPersonLastNameActual_202 , "Other Person Last Name", logval);
