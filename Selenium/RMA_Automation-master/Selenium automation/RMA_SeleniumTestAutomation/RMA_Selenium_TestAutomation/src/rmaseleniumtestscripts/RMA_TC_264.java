...
//================================================================================================
//TestCaseID     : RMA_TC_264
//Description    : TC_264_Verify That Adding,Editing And Deleting Of Existing Other Person As Person Involved on General Claim Policy
//Depends On TC  : RMA_TC_260
//Revision       : 0.0 -RenuVerma-08-24-2016 
//=================================================================================================

public class RMA_TC_264 extends RMA_TC_BaseTest {
	...
	@Test
	public void RMA_TC_264_Test() throws Exception,Error {

		try{
			parentlogger = reports.startTest("TC_264_Verify That Adding, Editing And Deleting Of An Existing Other Person On General Claim Policy", "Verify Adding,Editing And Deleting Of An Existing Other Person As Person Involved on General Claim Policy");
			parentlogger.assignAuthor("Renu Verma");

			String StrOtherPersonLastName_264;
			String StrPrimaryWindowHandle;
			String StrOtherPersonLastNameActual_264;
			String OtherPersonLastNameChanged_264;
			String OtherPersonLastNameChanged_264_Actual;
			String StrGeneralClaimNumberActual;
			//Local Variable Declaration Completed Here

			StrScreenShotTCName = "TC_264";
			testcall1 = false;	
			testcall2 = false;	
			...
			testcall1 = true;
			StrOtherPersonLastName_264 = RMA_Functionality_Utility.RMA_MaintEntityAddition_Utility("OtherPeople", logval1);
			parentlogger.log(LogStatus.INFO, "Other Person Is Created Successfully With Name::"+ " " + color.RMA_ChangeColor_Utility(StrOtherPersonLastName_264, 2));
			...
			//===============================================Addition Of Other Person On General Claim Policy Created in TC_260 Is Started Here=====================================================================================================
			...
			RMA_Functionality_Utility.RMA_StandardSearch_Window(RMA_POM_Search.RMAApp_SearchEntity_Txt_LastName(driver), "Standard Entity Search page","Last Name Text Box",StrOtherPersonLastName_264,"Other People", "piother",StrPrimaryWindowHandle, logval);
			RMA_Functionality_Utility.RMA_GenericSave_Utility("piother",false,"NA","Persons Involved-->Other Person Page", logval);
			StrOtherPersonLastNameActual_264 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrOtherPersonLastName_264, StrOtherPersonLastNameActual_264 , "Other Person Last Name", logval);
			...
			OtherPersonLastNameChanged_264 = RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(4, "OtherPerson_264_");
			RMA_Input_Utility.RMA_SetValue_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "LastName TextBox On PI Other Person Page ", OtherPersonLastNameChanged_264, logval);
			...
			RMA_Functionality_Utility.RMA_GenericSave_Utility("piother",false,"NA", "Persons Involved-->Other Person Page", logval);
			OtherPersonLastNameChanged_264_Actual = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(OtherPersonLastNameChanged_264, OtherPersonLastNameChanged_264_Actual , "Other Person Last Name", logval);
			...
			parentlogger.log(LogStatus.INFO, "The Functional Utility :" +" " +"RMA_GenericDelete_Utility Is Called To Delete A Other Person :" +" "+ color.RMA_ChangeColor_Utility(OtherPersonLastNameChanged_264, 2));
			testcall2 = true;
			RMA_Functionality_Utility.RMA_GenericDelete_Utility("PI Other Person Page", logval1);
			parentlogger.log(LogStatus.INFO, "Other Person Is Deleted Successfully::"+ " " + color.RMA_ChangeColor_Utility(OtherPersonLastNameChanged_264, 2));
