...
//================================================================================================
//TestCaseID     : RMA_TC_062
//Description    : Transaction Created In RMA_TC_052 Can Be Approved By Top Level Manager Is Validated
//Depends On TC  : TC_064, TC_051, TC_052, TC_057, TC_058, TC_059, TC_060
//Revision       : 0.0 - KumudNaithani-02-09-2016 
...
public class RMA_TC_062 extends rmaseleniumtestscripts.RMA_TC_BaseTest {
	...
	@Test 
	public void RMA_TC_062_Test () throws Exception, Error
	//Verify That Transaction Created In RMA_TC_052 Can Be Approved By Top Level Manager
	{
		try {
			parentlogger = reports.startTest("TC_062_Transaction Is Approved By Top Level Manager", "Transaction Created In RMA_TC_052 Can Be Approved By Top Level Manager Is Validated");
			String StrAccept;
			...
			RMAApp_Login_Txt_UserName = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_062", 1, 0); //UserName Fetched From DataSheet RMA_TC_062
			RMAApp_Login_Txt_Password = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_062", 1, 1); //Password Fetched From DataSheet RMA_TC_062
			...
			RMA_GenericUsages_Utility.RMA_StaticWait(6, logval, "Wait Is Added As Save Image On Supervisory Approval Page Is Clicked");
			...
			globalWait.until(ExpectedConditions.elementToBeClickable(RMA_Selenium_POM_Funds_SprApproval.RMAApp_SprApproval_Tab_Payment(driver)));
			RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_Funds_SprApproval.RMAApp_SprApproval_Tab_Payment(driver), "Payment Tab On User View On The Supervisory Approval Page", logval);
			RMA_GenericUsages_Utility.RMA_StaticWait(5, logval, "Wait Is Added As Payemnt Tab On Supervisory Approval Page Is Clicked");
			...
			if (RMA_Selenium_POM_Funds_SprApproval.RMAApp_SprApproval_PaymntNoRecordsAvailable(driver).isDisplayed() )
			{
				...
				parentlogger.log(LogStatus.INFO, logger.addScreenCapture(RMA_ScreenCapture_Utility.RMA_ScreenShotCapture_Utility(driver, "Payment $2500 Does Not Exist", StrScreenShotTCName)));
			...
			RMA_Functionality_Utility.RMA_StandardSearch_Screen(RMA_POM_Search.RMAApp_SearchFunds_Txt_ControlNumber(driver), "Search_Funds", "Check Control Number Text Box", RMA_TC_052.StrControlNumber_RMA_TC_01_052, RMA_TC_052.StrControlNumber_RMA_TC_01_052, "Transaction", "num", 2, logval);
