...
//================================================================================================
//TestCaseID     : RMA_TC_207
//Description    : TC_207_Verify Adding,Editing And Deleting Of new Employee As Person Involved For Property Claim
//Depends On TC  : RMA_TC_206
//Revision       : 0.0 - RenuVerma-07-14-2016 
//=================================================================================================

public class RMA_TC_207 extends RMA_TC_BaseTest {
	...
	@Test
	public void RMA_TC_207_Test() throws Exception,Error {

		try{
			parentlogger = reports.startTest("TC_207_Adding, Editing And Deleting Of New Employee", "Verify Adding,Editing And Deleting Of New Employee As Person Involved For Property Claim");
			parentlogger.assignAuthor("Renu Verma");

			String StrEmployeeNumber_207;
			String StrEmployeeLastNameActual_207;
			String StrEmployeeNameChanged_207;
			String StrClaimNaumberActual;
			//Local Variable Declaration Completed Here
			
			StrScreenShotTCName = "TC_207";
			testcall1 = false;	
			testcall2 = false;	
			...
			/*================================================== Step Add Existing Employee Is On Claim--> PI Started Here================================================================*/
			...
			testcall1 = true;
			StrEmployeeNumber_207 = RMA_Functionality_Utility.RMA_PIAddNewEntity_Utility("Employee", logval1);
			parentlogger.log(LogStatus.INFO, "New Employee Is Created Successfully With Employee Number::"+ " " + color.RMA_ChangeColor_Utility(StrEmployeeNumber_207, 2));
			...
			/*===============================================Editing Of An Existing Employee Is Started Here================================*/
			StrEmployeeNameChanged_207 = RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(4, "EmpName_207_");
			RMA_Input_Utility.RMA_SetValue_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "LastName TextBox On PI Employee Page ", StrEmployeeNameChanged_207, logval);
			RMA_Functionality_Utility.RMA_GenericSave_Utility("piemployee", false, "NA","Persons Involved-->Employee Page", logval);
			StrEmployeeLastNameActual_207 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrEmployeeNameChanged_207, StrEmployeeLastNameActual_207 , "EmployeeLast Name", logval);
			parentlogger.log(LogStatus.INFO, parentlogger.addScreenCapture(RMA_ScreenCapture_Utility.RMA_ScreenShotCapture_Utility(driver, "Employee Name Is Edited", StrScreenShotTCName)));

			/*=================================================Editing Of An Existing Employee Is Completed Here=============================================*/

			/*===========================================================Deletion Of New Employee Is Started Here================================================*/

			parentlogger.log(LogStatus.INFO, "The Functional Utility :" +" " +"RMA_GenericDelete_Utility Is Called To Delete An Employee : " +" "+ color.RMA_ChangeColor_Utility(StrEmployeeNameChanged_207, 2));
			testcall2 = true;
			RMA_Functionality_Utility.RMA_GenericDelete_Utility("PI Employee Page", logval1);
			parentlogger.log(LogStatus.INFO, "Employee Is Deleted Successfully ::"+ " " + color.RMA_ChangeColor_Utility(StrEmployeeNameChanged_207, 2));
