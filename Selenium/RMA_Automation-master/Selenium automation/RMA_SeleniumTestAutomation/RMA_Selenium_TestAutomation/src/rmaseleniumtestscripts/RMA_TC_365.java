...
//====================================================================================================================================
//TestCaseID     : RMA_TC_365
//Description    : Creation, Edit And Deletion Of Enhanced Notes For A Salvage (Added To Vehicle Claim-->Unit) Associated With A Claim
//Depends On TC  : RMA_TC_335,362
//Revision       : 0.0 - KumudNaithani-03-13-2017
//====================================================================================================================================
public class RMA_TC_365 extends RMA_TC_BaseTest {
...
@Test	
public void RMA_TC_365_Test() throws Exception, Error
{   
	try {	 	 
	 String StrSalvage;
	 ...
	 parentlogger = reports.startTest("RMA_TC_365_Creation, Edit And Deletion Of Enhanced Notes For A Vehicle Unit Salvage", "Creation, Edit And Deletion Of Enhanced Notes For A Salvage (Added To Vehicle Claim-->Unit) Associated With A Claim");
	 ...
	 StrScreenShotTCName = "RMA_TC_365";
	 Edit = true;
	//===========================================================New Salvage (Added To Vehicle Claim-->Unit) Creation Associated With Claim Is Started Here=====================================================================================================================================================================================================================================================================================================================================
	 parentlogger.log(LogStatus.INFO, "The Functional Utility :" +" " +RMA_GenericUsages_Utility.RMA_LoggerHyperlink("ClaimEntity", "Claim Entity Addition",0)+ " "+ "Is Called To Add A Salvage (Added To Vehicle Claim-->Unit) To Claim" + " "+color.RMA_ChangeColor_Utility(StrClaimNumber_335, 2));
	 testcall1 = true;
	 StrSalvage = RMA_Functionality_Utility.RMA_ClaimEntityAddition_Utility("Salvage", "Salvage", StrClaimNumber_335, "Not Required", "Not Required", "O", "Not Required", "Not Required", "Not Required", "Not Required", logval1);
	 parentlogger.log(LogStatus.INFO, "Following New Salvage (Added To Vehicle Claim-->Unit) Is Created Successfully::"+ " "+ color.RMA_ChangeColor_Utility(StrSalvage, 2) + " " +"Associated To Claim Number::" + color.RMA_ChangeColor_Utility(StrClaimNumber_335, 2));
	 loggerval1 = logger.toString();
	 parentlogger.appendChild(logger);
	 parentlogger.log(LogStatus.INFO, parentlogger.addScreenCapture(RMA_ScreenCapture_Utility.RMA_ScreenShotCapture_Utility(driver, "Successful Salvage (Added To Vehicle Claim-->Unit) Creation", StrScreenShotTCName)));
	//=========================================================== New Salvage (Added To Vehicle Claim-->Unit) Creation Associated With Claim Is Completed Here=======================================================================================================================================================================================================================================================================================================================================
	
	//===========================================================Steps To Create And Edit Progress Notes Started Here==================================================================================================================================================================================================================================================================================================================================================
    StrPrimaryWindowHandle = driver.getWindowHandle();
	RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_Home.RMAApp_Generic_Img_EnhancedNotes(driver), "Enhanced Notes Image For Salvage (Added To Vehicle Claim-->Unit)"+ " "+ color.RMA_ChangeColor_Utility(StrSalvage, 2)+ " "+ "Associated With Claim:"+" "+color.RMA_ChangeColor_Utility(StrClaimNumber_335, 2), logval); // Claim ID Is Same For All Line Of Business
	...
	//===========================================================Steps To Delete Progress Notes Completed Here===============================================================================================================================================================================================================================================================================================================================================================
		 ...
		 {
		 logger.log(LogStatus.FAIL, "Following Error Occurred  ::" + " "+  color.RMA_ChangeColor_Utility(FinalErrorMessage,1)+ " " + "While Executing Function Utility" +" "+ "RMA_ClaimEntityAddition_Utility" + " For New Salvage (Added To Vehicle Claim-->Unit) Creation Associated With A Claim And Hence The Test Case Is A Fail");
		 parentlogger.appendChild(logger);
		 }
