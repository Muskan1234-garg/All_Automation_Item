...
//================================================================================================
//TestCaseID     : RMA_TC_159
//Description    : TC_159_Verify Adding,Editing And Deleting Of New Employee As Person Involved In Litigation For NonOccupational Claim
//Depends On TC  : RMA_TC_158
//Revision       : 0.0 - ImteyazAhmad-07-04-2016 
//=================================================================================================

public class RMA_TC_159 extends RMA_TC_BaseTest {
	...
	@Test
	public void RMA_TC_159_Test() throws Exception,Error {

		try{
			parentlogger = reports.startTest("TC_159_Adding, Editing And Deleting Of New Employee", "Verify Adding,Editing And Deleting Of New Employee As Person Involved In Litigation For NonOccupational Claim");
			parentlogger.assignAuthor("Imteyaz Ahmad");

			String StrEmployeeNumber_159;
			String StrEmployeeLastNameActual_159;
			String StrEmployeeNameChanged;
			String StrClaimNaumberActual;

			StrScreenShotTCName = "TC_159";
			testcall1 = false;	
			testcall2 = false;	
			...
			testcall1 = true;
			StrEmployeeNumber_159 = RMA_Functionality_Utility.RMA_PIAddNewEntity_Utility("Employee", logval1);
			parentlogger.log(LogStatus.INFO, "New Employee Is Created Successfully With Employee Number::"+ " " + color.RMA_ChangeColor_Utility(StrEmployeeNumber_159, 2));
			loggerval1 = logger.toString();
			parentlogger.appendChild(logger);
			parentlogger.log(LogStatus.INFO, parentlogger.addScreenCapture(RMA_ScreenCapture_Utility.RMA_ScreenShotCapture_Utility(driver, "Employee Creation Is Successfull", StrScreenShotTCName)));
			//===============================================Steps To Create A New Employee Completed============================================================================================================================================

			/*===============================================Editing Of New Employee Is Started Here================================*/
			StrEmployeeNameChanged = RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(4, "EmpName_TC_159_");
			...
			StrEmployeeLastNameActual_159 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrEmployeeNameChanged, StrEmployeeLastNameActual_159 , "EmployeeLast Name", logval);
