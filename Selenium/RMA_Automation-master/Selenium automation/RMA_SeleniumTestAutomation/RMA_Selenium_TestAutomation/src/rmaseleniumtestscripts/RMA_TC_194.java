...
//================================================================================================
//TestCaseID     : RMA_TC_194
//Description    : TC_194_Verify Adding,Editing And Deleting Of Existing Other Person As Person Involved  For Non Occupational Claim
//Depends On TC  : RMA_TC_190
//Revision       : 0.0 - ImteyazAhmad-07-19-2016
//=================================================================================================

public class RMA_TC_194 extends RMA_TC_BaseTest {
	...
	@Test
	public void RMA_TC_194_Test() throws Exception,Error {

		try{
			parentlogger = reports.startTest("TC_194_Adding, Editing And Deleting Of An Existing Other Person", "Verify Adding,Editing And Deleting Of An Existing Other Person As Person Involved For Non Occupational Claim");
			parentlogger.assignAuthor("Imteyaz Ahmad");

			String StrOtherPersonLastName_194;
			String StrPrimaryWindowHandle;
			String StrOtherPersonLastNameActual_194;
			String StrOtherPersonNameChanged;
			String StrClaimNaumberActual;

			//Local Variable Declaration Completed Here

			StrScreenShotTCName = "TC_194";
			testcall1 = false;	
			testcall2 = false;	
			...
			testcall1 = true;
			StrOtherPersonLastName_194 = RMA_Functionality_Utility.RMA_MaintEntityAddition_Utility("OtherPeople", logval1);
			parentlogger.log(LogStatus.INFO, "Other Person Is Created Successfully With Name::"+ " " + color.RMA_ChangeColor_Utility(StrOtherPersonLastName_194, 2));
			...
			RMA_Functionality_Utility.RMA_StandardSearch_Window(RMA_POM_Search.RMAApp_SearchEntity_Txt_LastName(driver), "Standard Entity Search Page", "Last Name TextBox", StrOtherPersonLastName_194, "Other People", "piother", StrPrimaryWindowHandle, logval);
			RMA_Functionality_Utility.RMA_GenericSave_Utility("piother", false, "NA", "Persons Involved-->Other Person Page", logval);
			StrOtherPersonLastNameActual_194 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrOtherPersonLastName_194, StrOtherPersonLastNameActual_194 , "Other Person Last Name", logval);
			...
			RMA_Functionality_Utility.RMA_GenericSave_Utility("piother", false, "NA", "Persons Involved-->Other Person Page", logval);
			StrOtherPersonLastNameActual_194 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrOtherPersonNameChanged, StrOtherPersonLastNameActual_194 , "Other Person Last Name", logval);
