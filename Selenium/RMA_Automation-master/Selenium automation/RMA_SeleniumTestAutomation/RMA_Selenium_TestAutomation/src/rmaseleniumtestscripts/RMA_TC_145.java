...
//================================================================================================
//TestCaseID     : RMA_TC_145
//Description    : TC_145_Verify Adding,Editing And Deleting Of new Physician As Person Involved In Litigation For Property Claim
//Depends On TC  : RMA_TC_141
//Revision       : 0.0 - RenuVerma-06-27-2016 
//=================================================================================================

public class RMA_TC_145 extends RMA_TC_BaseTest {
	...
	@Test
	public void RMA_TC_145_Test() throws Exception,Error {

		try{
			parentlogger = reports.startTest("TC_145_Adding, Editing And Deleting Of New Physician", "Verify Adding,Editing And Deleting Of New Physician As Person Involved In Litigation For Property Claim");
			parentlogger.assignAuthor("Renu Verma");

			String StrPhysicianNumber_145;
			String StrPhysicianLastNameActual_145;
			String StrPhysicianNameChanged;

			//Local Variable Declaration Completed Here

			
			StrScreenShotTCName = "TC_145";
			testcall1 = false;	
			testcall2 = false;	
			...
			parentlogger.log(LogStatus.INFO, "The Functional Utility :" +" " +"RMA_PIAddNewEntity_Utility Is Called To Create An Physician ");
			testcall1 = true;
			StrPhysicianNumber_145 = RMA_Functionality_Utility.RMA_PIAddNewEntity_Utility("Physician", logval1);
			parentlogger.log(LogStatus.INFO, "New Physician Is Created Successfully With Physician Number::"+ " " + color.RMA_ChangeColor_Utility(StrPhysicianNumber_145, 2));
		...
		/*===============================================Editing Of New Physician Is Started Here================================*/
			StrPhysicianNameChanged = RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(4, "Physician_");
			RMA_Input_Utility.RMA_SetValue_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "LastName TextBox On PI Physician Page ", StrPhysicianNameChanged, logval);
			...
			RMA_GenericUsages_Utility.RMA_StaticWait(5, logval, "Wait Is Added As PI Physician Is Saved");
			...
			StrPhysicianLastNameActual_145 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrPhysicianNameChanged, StrPhysicianLastNameActual_145 , "PhysicianLast Name", logval);
			parentlogger.log(LogStatus.INFO, parentlogger.addScreenCapture(RMA_ScreenCapture_Utility.RMA_ScreenShotCapture_Utility(driver, "New Physician Is Edited", StrScreenShotTCName)));

			/*=================================================Editing Of New Physician Is Completed Here=============================================*/

			/*===========================================================Deletion Of New Physician Is Started Here================================================*/

			parentlogger.log(LogStatus.INFO, "The Functional Utility :" +" " +"RMA_GenericDelete_Utility Is Called To Delete An Physician : " +" "+ color.RMA_ChangeColor_Utility(StrPhysicianNameChanged, 2));
			testcall2 = true;
			RMA_Functionality_Utility.RMA_GenericDelete_Utility("PI Physician Page", logval1);
			driver.switchTo().parentFrame();
			parentlogger.log(LogStatus.INFO, "Physician Is Deleted Successfully ::"+ " " + color.RMA_ChangeColor_Utility(StrPhysicianNameChanged, 2));
