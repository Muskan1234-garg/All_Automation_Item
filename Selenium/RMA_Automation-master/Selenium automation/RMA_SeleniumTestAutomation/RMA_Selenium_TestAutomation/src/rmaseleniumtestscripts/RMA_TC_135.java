...
//================================================================================================
//TestCaseID     : RMA_TC_135
//Description    : TC_135_Verify Adding,Editing And Deleting Of New Employee As Person Involved In Litigation For Workers Comp Claim
//Depends On TC  : RMA_TC_135
//Revision       : 0.0 - ImteyazAhmad-06-28-2016 
//=================================================================================================

public class RMA_TC_135 extends RMA_TC_BaseTest {
	...
	public static String StrEmployeeLastNameActual_135;

	@Test
	public void RMA_TC_135_Test() throws Exception,Error {

		try{
			parentlogger = reports.startTest("TC_135_Adding, Editing And Deleting Of New Employee", "Verify Adding,Editing And Deleting Of New Employee As Person Involved In Litigation For Workers Comp Claim");
			parentlogger.assignAuthor("Imteyaz Ahmad");

			String StrEmployeeNumber_135;
			String StrEmployeeLastNameActual_135;
			String StrEmployeeNameChanged;

			StrScreenShotTCName = "TC_135";
			testcall1 = false;	
			testcall2 = false;	
			...
			testcall1 = true;
			StrEmployeeNumber_135 = RMA_Functionality_Utility.RMA_PIAddNewEntity_Utility("Employee", logval1);
			parentlogger.log(LogStatus.INFO, "New Employee Is Created Successfully With Employee Number::"+ " " + color.RMA_ChangeColor_Utility(StrEmployeeNumber_135, 2));
			loggerval1 = logger.toString();
			parentlogger.appendChild(logger);
			//===============================================Steps To Create A New Employee Completed============================================================================================================================================
			
			/*===============================================Editing Of New Employee Is Started Here================================*/
			StrEmployeeNameChanged = RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(4, "EmpName_TC_135_");
			...
			StrEmployeeLastNameActual_135 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrEmployeeNameChanged, StrEmployeeLastNameActual_135 , "EmployeeLast Name", logval);
