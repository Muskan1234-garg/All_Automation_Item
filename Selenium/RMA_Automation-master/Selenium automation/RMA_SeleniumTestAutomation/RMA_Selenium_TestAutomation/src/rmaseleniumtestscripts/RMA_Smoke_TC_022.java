...
//Description    : RMA_Smoke_TC_022_ Verify Successful Diary Creation For Claim
...
public class RMA_Smoke_TC_022 extends RMA_TC_BaseTest {
	...
	public static String DiaryTaskName_Smoke_TC_022;

	@Test
	public void RMA_Smoke_TC_022_Test() throws Exception,Error {

		try{
			parentlogger = reports.startTest("RMA_Smoke_TC_022_ Verify Successful Diary Creation For Claim", " Verify Successful Diary Creation For Claim");
			...
			DiaryTaskName_Smoke_TC_022 = RMA_Functionality_Utility.RMA_AttachCreateEdit_Diary("Attach","NA","CQE Complete Quick Entry","NA","NA", "NA", logval);
			parentlogger.log(LogStatus.INFO, "Diary Is Created Successfully With TaskName :"+" "+color.RMA_ChangeColor_Utility(DiaryTaskName_Smoke_TC_022, 2)+" "+"On Claim :"+" "+color.RMA_ChangeColor_Utility(StrClaimNumber_002,4));							
