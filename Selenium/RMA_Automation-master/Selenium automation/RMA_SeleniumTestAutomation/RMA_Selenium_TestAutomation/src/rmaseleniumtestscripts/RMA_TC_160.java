...
//================================================================================================
//TestCaseID     : RMA_TC_160
//Description    : TC_160_Verify Adding,Editing And Deleting Of New Medical Staff As Person Involved In Litigation For NonOccupational Claim
//Depends On TC  : RMA_TC_158
//Revision       : 0.0 - ImteyazAhmad-07-04-2016 
//=================================================================================================

public class RMA_TC_160 extends RMA_TC_BaseTest {
	...
	@Test
	public void RMA_TC_160_Test() throws Exception,Error {

		try{
			parentlogger = reports.startTest("TC_160_Adding, Editing And Deleting Of New Medical Staff", "Verify Adding,Editing And Deleting Of New Medical Staff As Person Involved In Litigation For NonOccupational Claim");
			parentlogger.assignAuthor("Imteyaz Ahmad");

			String StrMedicalLastName_160;
			String StrMedicalLastNameActual_160;
			String StrMedicalLastNameChanged;
			String StrClaimNaumberActual;

			StrScreenShotTCName = "TC_160";
			testcall1 = false;	
			testcall2 = false;	
			...
			testcall1 = true;
			StrMedicalLastName_160 = RMA_Functionality_Utility.RMA_PIAddNewEntity_Utility("Medical Staff", logval1);
			parentlogger.log(LogStatus.INFO, "New Medical Staff Is Created Successfully With Medical Staff Last Name::"+ " " + color.RMA_ChangeColor_Utility(StrMedicalLastName_160, 2));
			loggerval1 = logger.toString();
			parentlogger.appendChild(logger);
			parentlogger.log(LogStatus.INFO, parentlogger.addScreenCapture(RMA_ScreenCapture_Utility.RMA_ScreenShotCapture_Utility(driver, "New Medical Staff Creation Is Successfull", StrScreenShotTCName)));
			//===============================================Steps To Create A New Medical Staff Completed============================================================================================================================================
			
			/*===============================================Editing Of New Medical Staff Is Started Here================================*/
			StrMedicalLastNameChanged = RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(4, "Medical_TC_160_");
			...
			StrMedicalLastNameActual_160 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Maintenance.RMAApp_MaintMedStaff_Txt_LstName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrMedicalLastNameChanged, StrMedicalLastNameActual_160 , "Medical StaffLast Name", logval);
