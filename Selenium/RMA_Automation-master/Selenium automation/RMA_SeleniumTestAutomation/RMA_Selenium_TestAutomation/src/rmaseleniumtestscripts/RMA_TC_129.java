...
//================================================================================================
//TestCaseID     : RMA_TC_129
//Description    : TC_129_Verify Adding,Editing And Deleting Of New Driver As Person Involved In Litigation For General Claim Claim
//Depends On TC  : RMA_TC_126
//Revision       : 0.0 - KumudNaithani-06-30-2016 
//=================================================================================================

public class RMA_TC_129 extends RMA_TC_BaseTest {
	...
	@Test
	public void RMA_TC_129_Test() throws Exception,Error {

		try{
			parentlogger = reports.startTest("TC_129_Adding, Editing And Deleting Of New Driver", "Verify Adding,Editing And Deleting Of New Driver As Person Involved In Litigation For General Claim Claim");
			parentlogger.assignAuthor("Kumud Naithani");

			String StrDriverLastName_129;
			String StrDriverLastNameActual_129;
			String StrDriverLastNameChanged;

			StrScreenShotTCName = "TC_129";
			testcall1 = false;	
			testcall2 = false;	
			...
			RMA_Functionality_Utility.RMA_StandardSearch_Screen(RMA_POM_Search.RMAApp_SearchClaims_Txt_ClaimNumber(driver), "Claim Search Page", "Claim Number TextBox", RMA_TC_126.StrClaimNumber_RMA_TC_126, RMA_TC_126.StrClaimNumber_RMA_TC_126, "claimgc", "num", 2, logval);
			...
			testcall1 = true;
			StrDriverLastName_129 = RMA_Functionality_Utility.RMA_PIAddNewEntity_Utility("Driver", logval1);
			parentlogger.log(LogStatus.INFO, "New Driver Is Created Successfully With Driver Last Name::"+ " " + color.RMA_ChangeColor_Utility(StrDriverLastName_129, 2));
			parentlogger.log(LogStatus.INFO, parentlogger.addScreenCapture(RMA_ScreenCapture_Utility.RMA_ScreenShotCapture_Utility(driver, "Creation Of New Driver Is Successfull", StrScreenShotTCName)));
			loggerval1 = logger.toString();
			parentlogger.appendChild(logger);
			//===============================================Steps To Create A New Driver Completed===================================================================================================================================================================================================================================
			
			/*===============================================Editing Of New Driver Is Started Here======================================================================================================================================================================================================================================*/
			StrDriverLastNameChanged = RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(4, "Driver_TC_129_");
			...
			StrDriverLastNameActual_129 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Maintenance.RMAApp_MaintDriver_Txt_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrDriverLastNameChanged, StrDriverLastNameActual_129 , "Driver Last Name", logval);
