...
//================================================================================================
//TestCaseID     : RMA_TC_130
//Description    : TC_130_Verify Adding,Editing And Deleting Of New Other Person As Person Involved In Litigation For General Claim Claim
//Depends On TC  : RMA_TC_126
//Revision       : 0.0 - KumudNaithani-06-30-2016 
//=================================================================================================

public class RMA_TC_130 extends RMA_TC_BaseTest {
	...
	@Test
	public void RMA_TC_130_Test() throws Exception,Error {

		try{
			parentlogger = reports.startTest("TC_130_Adding, Editing And Deleting Of New Other Person", "Verify Adding,Editing And Deleting Of New Other Person As Person Involved In Litigation For General Claim Claim");
			parentlogger.assignAuthor("Kumud Naithani");

			String StrOtherPersonLastName_130;
			String StrOtherPersonLastNameActual_130;
			String StrOtherPersonLastNameChanged;

			StrScreenShotTCName = "TC_130";
			testcall1 = false;	
			testcall2 = false;	
			...
			testcall1 = true;
			StrOtherPersonLastName_130 = RMA_Functionality_Utility.RMA_PIAddNewEntity_Utility("Other Person", logval1);
			parentlogger.log(LogStatus.INFO, "New Other Person Is Created Successfully With Other Person Last Name::"+ " " + color.RMA_ChangeColor_Utility(StrOtherPersonLastName_130, 2));
			parentlogger.log(LogStatus.INFO, parentlogger.addScreenCapture(RMA_ScreenCapture_Utility.RMA_ScreenShotCapture_Utility(driver, "Creation Of New Other Person Is Successfull", StrScreenShotTCName)));
			loggerval1 = logger.toString();
			parentlogger.appendChild(logger);
			//===============================================Steps To Create A New Other Person Completed=============================================================================================================================================================================================================
			
			/*===============================================Editing Of New Other Person Is Started Here=======================================================================*/
			StrOtherPersonLastNameChanged = RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(4, "Other Person_TC_130_");
			...
			StrOtherPersonLastNameActual_130 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Maintenance.RMAApp_MaintPeople_Txt_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrOtherPersonLastNameChanged, StrOtherPersonLastNameActual_130 , "Other Person Last Name", logval);
