...
//================================================================================================
//TestCaseID     : RMA_TC_144
//Description    : TC_144_Verify Adding,Editing And Deleting Of new Patient As Person Involved In Litigation For Property Claim
//Depends On TC  : RMA_TC_141
//Revision       : 0.0 - RenuVerma-06-27-2016 
//=================================================================================================

public class RMA_TC_144 extends RMA_TC_BaseTest {
	...
	@Test
	public void RMA_TC_144_Test() throws Exception,Error {

		try{
			parentlogger = reports.startTest("TC_144_Adding, Editing And Deleting Of New Patient", "Verify Adding,Editing And Deleting Of New Patient As Person Involved In Litigation For Property Claim");
			parentlogger.assignAuthor("Renu Verma");

			String StrPatientNumber_144;
			String StrPatientLastNameActual_144;
			String StrPatientNameChanged;

			//Local Variable Declaration Completed Here

			
			StrScreenShotTCName = "TC_144";
			testcall1 = false;	
			testcall2 = false;	
			...
			parentlogger.log(LogStatus.INFO, "The Functional Utility :" +" " +"RMA_PIAddNewEntity_Utility Is Called To Create An Patient ");
			testcall1 = true;
			StrPatientNumber_144 = RMA_Functionality_Utility.RMA_PIAddNewEntity_Utility("Patient", logval1);
			parentlogger.log(LogStatus.INFO, "New Patient Is Created Successfully With Patient Number::"+ " " + color.RMA_ChangeColor_Utility(StrPatientNumber_144, 2));
		...
		/*===============================================Editing Of New Patient Is Started Here================================*/
			...
			RMA_GenericUsages_Utility.RMA_StaticWait(5, logval, "Wait Is Added As PI Patient Is Saved");
			...
			StrPatientLastNameActual_144 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrPatientNameChanged, StrPatientLastNameActual_144 , "PatientLast Name", logval);
			parentlogger.log(LogStatus.INFO, parentlogger.addScreenCapture(RMA_ScreenCapture_Utility.RMA_ScreenShotCapture_Utility(driver, "New Patient Is Edited", StrScreenShotTCName)));

			/*=================================================Editing Of New Patient Is Completed Here=============================================*/

			/*===========================================================Deletion Of New Patient Is Started Here================================================*/

			parentlogger.log(LogStatus.INFO, "The Functional Utility :" +" " +"RMA_GenericDelete_Utility Is Called To Delete An Patient : " +" "+ color.RMA_ChangeColor_Utility(StrPatientNameChanged, 2));
			testcall2 = true;
