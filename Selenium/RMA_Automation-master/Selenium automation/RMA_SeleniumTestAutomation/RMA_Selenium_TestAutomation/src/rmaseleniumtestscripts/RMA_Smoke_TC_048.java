...
//Description    : Successful Collection Against An Already Created Reserve For Carrier Claim Is Validated 
//Depends On TC  : RMA_Smoke_TC_045_GC/RMA_Smoke_TC_045_WC, RMA_Smoke_TC_046, RMA_Smoke_TC_047
//Revision       : 0.0 - RenuVerma-09-22-2016 
//=================================================================================================
public class RMA_Smoke_TC_048 extends rmaseleniumtestscripts.RMA_TC_BaseTest{
...
{
	try {
		parentlogger = reports.startTest("Smoke_TC_048_Collection Creation On Carrier Claim", "Successful Collection Against An Already Created Reserve For Carrier Claim Is Validated ");
		...
		String StrControlNumber_TC_048;
		//Local Variable Declaration
		
		testcall1 = false;	
		loggerval1 = "NotInitialized";
		StrScreenShotTCName = "RMA_TC_048";
		...
		Collection_Lst_BankAccount = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_048", 1, 0); //Bank Account Is Fetched From DataSheet RMA_TC_048
		Collection_Lst_PayeeType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_048", 1, 1); // Payee Type Is Fetched From DataSheet RMA_TC_048
		FundsSplitDetails_Lst_TransactionType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_048", 1, 2); //Transaction Type Is Fetched From DataSheet RMA_TC_048
		FundsSplitDetails_Txt_Amount = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_TC_048", 1, 3); //Amount Is Fetched From DataSheet RMA_TC_048
		Collection_Txt_LastName = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_048", 1, 4); //LastName Is Fetched From DataSheet RMA_TC_048
		Collection_Txt_DisType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_048", 1, 5); //Distribution Type Is Fetched From DataSheet RMA_TC_048
		CollectionGrid_Cell_Balance =ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_048", 1, 6); //Reserve Grid Collection Balance Amount Is Fetched From DataSheet RMA_TC_048
		CollectionGrid_Cell_Paid = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_048", 1, 7); // Reserve Grid Collection Paid Amount Is Fetched From DataSheet RMA_TC_048
		CollectionGrid_Cell_Incured = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_048", 1, 8); // Reserve Grid Collection Incurred Amount Is Fetched From DataSheet RMA_TC_048
		CollectionGrid_Cell_Collection = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_048", 1, 9); // Reserve Grid Collection Amount Is Fetched From DataSheet RMA_TC_048
		...
		testcall1 = true;
		StrControlNumber_TC_048 = RMA_Functionality_Utility.RMA_AddNewCollection_Utility(Collection_Lst_BankAccount, Collection_Lst_PayeeType, FundsSplitDetails_Lst_TransactionType, FundsSplitDetails_Txt_Amount, Collection_Txt_LastName, Collection_Txt_DisType, logval1);
		...
		RMA_Input_Utility.RMA_SetValue_Utility(RMA_Selenium_POM_FinancialReserves.RMAApp_ReserveCreation_Tbl_ReserveNGGrid_FilterTextBox(driver, "Reserve Type"), "Reserve Type Filter Text Box On Reserve Table", RMA_Smoke_TC_046.ReserveCreation_Lst_ReserveType,logval);//Name of The Reserve Type Is Entered In Reserve Type Input Box On Reserves NG Grid
		...
		parentlogger.log(LogStatus.INFO, "A Collection Is Created Successfully With Control Number::"+ " " + color.RMA_ChangeColor_Utility(StrControlNumber_TC_048, 2)+" Is Done");
