...
//==============================================================================================================
//TestCaseID     : RMA_TC_335_GeneralClaim
//Description    : Creation, Edit And Deletion Of Enhanced Notes For An Already Created General Claim 
//Depends On TC  : None
//Revision       : 0.0 - KumudNaithani-02-27-2017
//=============================================================================================================

public class RMA_TC_335_GeneralClaim extends RMA_TC_BaseTest {	
...
@Test 
public void RMA_TC_335_GeneralClaim_Test() throws Exception, Error
{
...
try
	{
	 parentlogger = reports.startTest("RMA_TC_335_Creation, Edit And Deletion Of Enhanced Notes For General Claim", "Creation, Edit And Deletion Of Enhanced Notes For An Already Created General Claim");
	 ...
	 StrScreenShotTCName = "RMA_TC_335_GeneralClaim";
	 Edit = true;
	 ...
	 //===========================================================New General Claim Creation Is Started Here======================================================================================================================================================
     ...
     StrClaimNumber_335 = generalclaim.GeneralClaimCreation();  //Created General Claim Number Is Stored In Variable StrClaimNumber_335
     loggerval1 = logger.toString();
     parentlogger.log(LogStatus.INFO, "A New General Claim Is Created With Claim Number:: "+ color.RMA_ChangeColor_Utility(StrClaimNumber_335, 2));
     parentlogger.appendChild(logger);
 	//===========================================================New General Claim Creation Is Completed Here================================================================================================================================================================
	...
	RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_Home.RMAApp_Generic_Img_EnhancedNotes(driver), "Enhanced Notes Image On General Claim :"+" "+StrClaimNumber_335+ " " +"Page", logval); // Claim ID Is Same For All Line Of Business
	...
	parentlogger.log(LogStatus.INFO,  "New Progress Notes ,Is Created With Text::"+ " " + color.RMA_ChangeColor_Utility(ProgressNotes, 2));
	parentlogger.appendChild(logger);
	// New Progress Notes Is Created And Edit	
	...
	//===========================================================Steps To Delete Progress Notes Completed Here============================================================================================================================================================================================================================================================
	 ...
	 {
	 logger.log(LogStatus.FAIL, "Following Error Occurred  ::" + " "+  color.RMA_ChangeColor_Utility(FinalErrorMessage,1)+ " " + "While Executing Child Test Case" +" "+ "RMA_TC_004" + " " +  "For General Claim Creation And Hence The Test Case Is A Fail");
	 parentlogger.appendChild(logger);
	 }
