...
//================================================================================================
//TestCaseID     : RMA_TC_267
//Description    : TC_267_Verify That Add,Edit And Delete Of Existing Witness As Person Involved on General Claim Policy
//Depends On TC  : RMA_TC_260
//Revision       : 0.0 - RenuVerma-08-25-2016 
//=================================================================================================

public class RMA_TC_267 extends rmaseleniumtestscripts.RMA_TC_BaseTest {
	...
	@Test 
	public void RMA_TC_267_Test () throws Exception, Error
	{
		parentlogger = reports.startTest("TC_267_Verify That Add,Edit And Delete Existing Witness As Person Involved", "Verify Add,Edit And Delete Of Existing Witness As Person Involved on General Claim Policy");
		parentlogger.assignAuthor("Renu Verma");
		try {
			String StrPrimaryWindowHandle;
		    String StrEditedWitLastNameActual_267;
			String StrEditedWitLastName267;
			String StrWitLastNameActual_267;
			...
			//===============================================Addition Of Witness On General Claim Created in TC_260 Is Started Here=====================================================================================================
			...
			RMA_Functionality_Utility.RMA_StandardSearch_Window(RMA_POM_Search.RMAApp_SearchEntity_Txt_LastName(driver), "Standard Entity Search page","Last Name Text Box",RMA_TC_260.StrWitnessLastName_260,"Witness","piwitness",StrPrimaryWindowHandle, logval);
			RMA_Functionality_Utility.RMA_GenericSave_Utility("piwitness",false,"NA","Witness Involved-->Witness Page", logval);
			StrWitLastNameActual_267 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(RMA_TC_260.StrWitnessLastName_260, StrWitLastNameActual_267, "Witness Name", logval);
			...
			StrEditedWitLastName267 = RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(4, "Witness_267_");
			RMA_Input_Utility.RMA_SetValue_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "LastName TextBox On Persons Involved-->Witness Page", StrEditedWitLastName267, logval);
			RMA_Functionality_Utility.RMA_GenericSave_Utility("piwitness",false,"NA","Persons Involved-->Witness Page", logval);
			StrEditedWitLastNameActual_267 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrEditedWitLastName267, StrEditedWitLastNameActual_267 , "Witness Last Name Value",logval);
			...
			parentlogger.log(LogStatus.INFO, "Following Utility :" +" " +"RMA_GenericDelete_Utility Is Called To Delete The Witness"+ " "+ color.RMA_ChangeColor_Utility(StrEditedWitLastNameActual_267, 2) +" " +"Added As Persons Involved");
			testcall2 = true;
			RMA_Functionality_Utility.RMA_GenericDelete_Utility("Persons Involved-->Witness Page", logval1);
			parentlogger.log(LogStatus.INFO, "Witness Added As Persons Involved Is Deleted Successfully::"+ " " + color.RMA_ChangeColor_Utility(StrEditedWitLastNameActual_267, 2));
