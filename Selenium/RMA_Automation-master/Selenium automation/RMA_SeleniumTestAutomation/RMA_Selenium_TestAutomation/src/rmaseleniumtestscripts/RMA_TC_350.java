...
//=======================================================================================================================================================
//TestCaseID     : RMA_TC_350
//Description    : Creation, Edit And Deletion Of Enhanced Notes For A MedicalStaff (Person Involved Added To Litigation) Associated With A Claim
//Depends On TC  : RMA_TC_335,339
//Revision       : 0.0 - KumudNaithani-03-03-2017
//==============================================================================================================================================================
public class RMA_TC_350 extends RMA_TC_BaseTest {
...
@Test	
public void RMA_TC_350_Test() throws Exception, Error
{   
	try {	 	 
	 ...
	 parentlogger = reports.startTest("RMA_TC_350_Creation, Edit And Deletion Of Enhanced Notes For A Litigation MedicalStaff (Person Involved)", "Creation, Edit And Deletion Of Enhanced Notes For A MedicalStaff (Person Involved Added To Litgation) Associated With A Claim");
	 ...
	 StrScreenShotTCName = "RMA_TC_350";
	 Edit = true;
	 //Variable Initialization Completed
     
	//===========================================================New MedicalStaff (Person Involved Added To Litigation) Creation Associated With Claim Is Started Here=====================================================================================================================================================================================================================================================================================================================================
	 ...
	 parentlogger.log(LogStatus.INFO, "The Functional Utility :" +" " +"RMA_PIAddNewEntity_Utility Is Called To add A New MedicalStaff As Person Involved To Litigation"+ " "+ color.RMA_ChangeColor_Utility(RMA_TC_339.StrLitDocketNumber,2));
	 testcall1 = true;
	 StrMedicalStaffLastName = RMA_Functionality_Utility.RMA_PIAddNewEntity_Utility("Medical Staff", logval1);
	 parentlogger.log(LogStatus.INFO, "New MedicalStaff With MedicalStaff Number::"+ " " + color.RMA_ChangeColor_Utility(StrMedicalStaffLastName, 2) + " "+"Is Added Successfully As Person Involved To Litigation::" + color.RMA_ChangeColor_Utility(RMA_TC_339.StrLitDocketNumber,2) + " " +"Associated To Claim Number::" + color.RMA_ChangeColor_Utility(StrClaimNumber_335, 2));
	 loggerval1 = logger.toString();
	 parentlogger.appendChild(logger);
	 parentlogger.log(LogStatus.INFO, parentlogger.addScreenCapture(RMA_ScreenCapture_Utility.RMA_ScreenShotCapture_Utility(driver, "New MedicalStaff Addition As Person Involved To Litigation", StrScreenShotTCName)));
	//=========================================================== New MedicalStaff (Person Involved Added To Litigation) Creation Associated With Claim Is Completed Here=======================================================================================================================================================================================================================================================================================================================================
	
	//===========================================================Steps To Create And Edit Progress Notes Started Here==================================================================================================================================================================================================================================================================================================================================================
    StrPrimaryWindowHandle = driver.getWindowHandle();
	RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_Home.RMAApp_Generic_Img_EnhancedNotes(driver), "Enhanced Notes Image For MedicalStaff"+ " "+ color.RMA_ChangeColor_Utility(StrMedicalStaffLastName, 2)+ " "+ "Person Involved Added To Litigation"+ " "+ color.RMA_ChangeColor_Utility(RMA_TC_339.StrLitDocketNumber,2)+  " "+ "Associated With Claim:"+" "+color.RMA_ChangeColor_Utility(StrClaimNumber_335, 2), logval); // Claim ID Is Same For All Line Of Business
	...
	//===========================================================Steps To Delete Progress Notes Completed Here===============================================================================================================================================================================================================================================================================================================================================================
		 ...
		 {
		 logger.log(LogStatus.FAIL, "Following Error Occurred  ::" + " "+  color.RMA_ChangeColor_Utility(FinalErrorMessage,1)+ " " + "While Executing Function Utility" +" "+ "RMA_ClaimEntityAddition_Utility" + " For New MedicalStaff (Person Involved Added To Litigation) Creation Associated With A Claim And Hence The Test Case Is A Fail");
		 parentlogger.appendChild(logger);
		 }
		 ...
		 System.out.println("Following Error Occurred In AfterMethod Code Block Of Test Case :" +" " +StrScreenShotTCName +" :" +" " +e.getMessage() );
		 ...
		 finally
		    {
			 try {
				...
				RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_Home.RMAApp_DefaultView_Btn_Close(driver), "Close Button On Right Side Of Litigation-MedicalStaff Page",logval);
				RMA_GenericUsages_Utility.RMA_StaticWait(2, logval, "Wait Is Added As Litigation-MedicalStaff Page Is Closed");
