...
//================================================================================================
//TestCaseID     : RMA_TC_237
//Description    : TC_237_Verify Add,Edit And Delete Of New Witness As Person Involved on Non Occupational Claims
//Depends On TC  : RMA_TC_230
//Revision       : 0.0 - RenuVerma-07-28-2016 
//=================================================================================================

public class RMA_TC_237 extends rmaseleniumtestscripts.RMA_TC_BaseTest {
	...
	@Test 
	public void RMA_TC_237_Test () throws Exception, Error
	{
		parentlogger = reports.startTest("TC_237_Adding, Editing And Deleting Of New Witness As Person Involved On Non Occupational Claim", "Verify Add,Edit And Delete Of New Witness As Person Involved on Non Occupational Claim");
		parentlogger.assignAuthor("Renu Verma");
		try {
			
		    String StrEditedWitLastNameActual_237;
			String StrEditedWitLastName237;
			String StrWitLastName_237;
			...
			//===============================================Addition Of Witness On Claim Created in TC_230 Is Started Here=====================================================================================================
			...
			testcall1 = true;
			StrWitLastName_237 = RMA_Functionality_Utility.RMA_PIAddNewEntity_Utility("Witness", logval1);
			parentlogger.log(LogStatus.INFO, "New Witness Is Created Successfully With Witness Name::"+ " " + color.RMA_ChangeColor_Utility(StrWitLastName_237, 2));
			...
			StrEditedWitLastName237 = RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(4, "Witness_RMA_TC_237_");
			RMA_Input_Utility.RMA_SetValue_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "LastName TextBox On Persons Involved-->Witness Page", StrEditedWitLastName237, logval);
			RMA_Functionality_Utility.RMA_GenericSave_Utility("piwitness",false,"NA","Persons Involved-->Witness Page", logval);
			StrEditedWitLastNameActual_237 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrEditedWitLastName237, StrEditedWitLastNameActual_237 , "Witness Last Name Value",logval);
			...
			parentlogger.log(LogStatus.INFO, "Following Utility :" +" " +"RMA_GenericDelete_Utility Is Called To Delete The Witness"+ " "+ color.RMA_ChangeColor_Utility(StrEditedWitLastNameActual_237, 2) +" " +"Added As Persons Involved");
			testcall2 = true;
			RMA_Functionality_Utility.RMA_GenericDelete_Utility("Persons Involved-->Witness Page", logval1);
			parentlogger.log(LogStatus.INFO, "Witness Added As Persons Involved Is Deleted Successfully::"+ " " + color.RMA_ChangeColor_Utility(StrEditedWitLastNameActual_237, 2));
