...
//Description    : Verify That Chain Of  Login User With Jump Functionality Can Be Chosen In Payment Parameter Setup.
//Depends On TC  : None
//Revision       : 0.0 - ImteyazAhmad-01-14-2016
//Modified By    : 0.1 - KumudNaithani-08-03-2016
//				 : Modified To Include Change Related To Calling RMA_MenuOptionClick_Utility Function Instead Of Directly Calling The Numeric X-Path Of The Function And Removing Unnecessary Static Waits And Replacing Existing Static Waits With Dynamic Waits If Possible And Spelling Mistakes
//========================================================================================================================================================================================================================================================================================================================================================================================================
public class RMA_TC_028 extends RMA_TC_BaseTest{
	...
	//Verify That Chain Of  Login User With Jump Functionality Can Be Chosen In Payment Parameter Setup.
	{
		try{
			...
			RMA_Navigation_Utility.RMA_WebCheckBoxSelect_Utility(RMA_Selenium_POM_PaymentParameterSetUp.RMAApp_PmntSetUpSprVsr_Chk_PayLimitExceed(driver), "check", "Payment Limits are exceeded CheckBox ", "Payment Parameter Setup",1);   // Check box "Payment Limits are exceeded" is checked on Payment Parameter Setup
			RMA_Navigation_Utility.RMA_WebCheckBoxSelect_Utility(RMA_Selenium_POM_PaymentParameterSetUp.RMAApp_PmntSetUpSprVsr_Chk_SupervisoryApproval(driver), "check", "Supervisor Approval CheckBox", "Payment Parameter Setup",1);  // Check box "Supervisor Approval" is checked on Payment Parameter Setup
			RMA_Navigation_Utility.RMA_WebCheckBoxSelect_Utility(RMA_Selenium_POM_PaymentParameterSetUp.RMAApp_PmntSetUpSprVsr_Chk_UseCurrentAdjuster(driver), "uncheck", "Use Current Adjuster Supervisory Chain CheckBox", "Payment Parameter Setup",1); //Check box "Use Current Adjuster Chain " is checked on Payment Parameter Setup
			RMA_Navigation_Utility.RMA_WebCheckBoxSelect_Utility(RMA_Selenium_POM_PaymentParameterSetUp.RMAApp_PmntSetUpSprVsr_Chk_EnbPmtDiary(driver), "check", "Enable Payment Approval Diary CheckBox ", "Payment Parameter Setup",1); //Check box "Enable Payment Approval Diary " is checked on Payment Parameter Setup
			RMA_Navigation_Utility.RMA_WebCheckBoxSelect_Utility(RMA_Selenium_POM_PaymentParameterSetUp.RMAApp_PmntSetUpSprVsr_Chk_EnbPmtEmail(driver), "check", "Enable Payment Approval Email CheckBox", "Payment Parameter Setup",1); //Check box "Enable Payment Approval Email " is checked on Payment Parameter Setup
			RMA_Navigation_Utility.RMA_WebCheckBoxSelect_Utility(RMA_Selenium_POM_PaymentParameterSetUp.RMAApp_PmntSetUpSprVsr_Chk_NotifyImmSupervisor(driver), "uncheck", "Notify Immediate Supervisor CheckBox", "Payment Parameter Setup",1); //Check box "Enable Payment Approval Email " is unchecked on Payment Parameter Setup
