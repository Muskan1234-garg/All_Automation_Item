...
//Description    : Transaction Created In RMA_TC_013 Is Listed For Manager Of Current Adjuster Manager And User Has Also Received Diary For The Same Is Validated
//Depends On TC  : TC_011, TC_012, TC_013, TC_016, TC_017
...
{
	try {
		parentlogger = reports.startTest("TC_018_Transaction Is Listed For Manager Of Current Adjuster Manager", "Is Listed For Manager Of Current Adjuster Manager And And User Has Also Received A Diary For The Same Is Validated");
		String StrAccept;
		...
		RMAApp_Login_Txt_UserName = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_018", 1, 0); //UserName Fetched From DataSheet RMA_TC_018
		RMAApp_Login_Txt_Password = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_018", 1, 1); //Password Fetched From DataSheet RMA_TC_018
