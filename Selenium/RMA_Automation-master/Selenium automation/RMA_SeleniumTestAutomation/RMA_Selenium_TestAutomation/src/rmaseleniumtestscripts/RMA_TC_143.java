...
//================================================================================================
//TestCaseID     : RMA_TC_143
//Description    : TC_143_Verify Adding,Editing And Deleting Of new Medical Staff As Person Involved In Litigation For Property Claim
//Depends On TC  : RMA_TC_141
//Revision       : 0.0 - RenuVerma-06-27-2016 
//=================================================================================================

public class RMA_TC_143 extends RMA_TC_BaseTest {
	...
	@Test
	public void RMA_TC_143_Test() throws Exception,Error {

		try{
			parentlogger = reports.startTest("TC_143_Adding, Editing And Deleting Of New Medical Staff", "Verify Adding,Editing And Deleting Of New Medical Staff As Person Involved In Litigation For Property Claim");
			parentlogger.assignAuthor("Renu Verma");

			String StrMedicalStaffNumber_143;
			String StrMedicalStaffLastNameActual_143;
			String StrMedicalStaffNameChanged;
			//Local Variable Declaration Completed Here

			
			StrScreenShotTCName = "TC_143";
			testcall1 = false;	
			testcall2 = false;	
			...
			parentlogger.log(LogStatus.INFO, "The Functional Utility :" +" " +"RMA_PIAddNewEntity_Utility Is Called To Create An Medical Staff ");
			testcall1 = true;
			StrMedicalStaffNumber_143 = RMA_Functionality_Utility.RMA_PIAddNewEntity_Utility("Medical Staff", logval1);
			parentlogger.log(LogStatus.INFO, "New Medical Staff Is Created Successfully With Medical Staff Number::"+ " " + color.RMA_ChangeColor_Utility(StrMedicalStaffNumber_143, 2));
		...
		/*===============================================Editing Of New Medical Staff Is Started Here================================*/
			StrMedicalStaffNameChanged = RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(4, "MedStaff_");
			...
			StrMedicalStaffLastNameActual_143 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrMedicalStaffNameChanged, StrMedicalStaffLastNameActual_143 , "Medical StaffLast Name", logval);
			...
			parentlogger.log(LogStatus.INFO, "The Functional Utility :" +" " +"RMA_GenericDelete_Utility Is Called To Delete An Medical Staff : " +" "+ color.RMA_ChangeColor_Utility(StrMedicalStaffNameChanged, 2));
			testcall2 = true;
