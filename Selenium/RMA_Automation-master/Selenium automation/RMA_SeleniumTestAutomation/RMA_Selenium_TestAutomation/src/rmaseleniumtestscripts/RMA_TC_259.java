...
//================================================================================================
//TestCaseID     : RMA_TC_259
//Description    : TC_259_Verify Add,Edit And Delete Of New Physician As Person Involved on Event
//Depends On TC  : RMA_TC_246
//Revision       : 0.0 - RenuVerma-07-27-2016 
//=================================================================================================

public class RMA_TC_259 extends rmaseleniumtestscripts.RMA_TC_BaseTest {
	...
	@Test 
	public void RMA_TC_259_Test () throws Exception, Error
	{
		parentlogger = reports.startTest("TC_259_Adding, Editing And Deleting Of New Physician As Person Involved", "Verify Add,Edit And Delete Of New Physician As Person Involved on Event");
		parentlogger.assignAuthor("Renu Verma");
		try {
			String StrPhysicianLastName_259;
			String StrEditedPhysicianLastName_Actual_259;
			String StrEditedPhysicianLastName_259;
			...
			testcall1 = true;
			StrPhysicianLastName_259 = RMA_Functionality_Utility.RMA_PIAddNewEntity_Utility("Physician", logval1);
			parentlogger.log(LogStatus.INFO, "New Physician Is Created Successfully With Physician Name::"+ " " + color.RMA_ChangeColor_Utility(StrPhysicianLastName_259, 2));
			...
			StrEditedPhysicianLastName_259 = RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(4, "Physician_259_");
			RMA_Input_Utility.RMA_SetValue_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "LastName TextBox On Persons Involved-->Physician Page", StrEditedPhysicianLastName_259, logval);
			RMA_Functionality_Utility.RMA_GenericSave_Utility("piphysician",false,"NA","Persons Involved-->Physician Page", logval);
			StrEditedPhysicianLastName_Actual_259 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrEditedPhysicianLastName_259, StrEditedPhysicianLastName_Actual_259 , "Physician Last Name Value",logval);
			...
			parentlogger.log(LogStatus.INFO, "Following Utility :" +" " +"RMA_GenericDelete_Utility Is Called To Delete The Physician"+ " "+ color.RMA_ChangeColor_Utility(StrEditedPhysicianLastName_Actual_259, 2) +" " +"Added As Persons Involved");
			testcall2 = true;
			RMA_Functionality_Utility.RMA_GenericDelete_Utility("Persons Involved-->Physician Page", logval1);
			parentlogger.log(LogStatus.INFO, "Physician Added As Persons Involved Is Deleted Successfully::"+ " " + color.RMA_ChangeColor_Utility(StrEditedPhysicianLastName_Actual_259, 2));
