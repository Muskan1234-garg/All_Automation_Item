...
//================================================================================================
//TestCaseID     : RMA_TC_092
//Description    : TC_092_Verify Add,Edit And Delete Of Existing Physician As Person Involved In Litigation For General Claims
//Depends On TC  : RMA_TC_086
//Revision       : 0.0 - KumudNaithani-05-10-2016 
//=================================================================================================

public class RMA_TC_092 extends rmaseleniumtestscripts.RMA_TC_BaseTest {
	...
	@Test 
	public void RMA_TC_092_Test () throws Exception, Error
	{
		parentlogger = reports.startTest("TC_092_Existing Physician As Person Involved", "Verify Add,Edit And Delete Of Existing Physician As Person Involved In Litigation For General Claims");
		parentlogger.assignAuthor("Kumud Naithani");
		try {
			String StrPhyLastName_RMA_TC_092;
			String StrPhyLastNameActual_RMA_TC_092;
			String StrPrimaryWindowHandle;
		    String StrEditedPhysLastNameAct_RMA_TC_092;
			String StrEditedPhyLastName;
			...
			testcall1 = true;
			StrPhyLastName_RMA_TC_092 = RMA_Functionality_Utility.RMA_MaintEntityAddition_Utility("Physician", 1);
			parentlogger.log(LogStatus.INFO, "New Physician Is Created With Physician Name::"+ " " + color.RMA_ChangeColor_Utility(StrPhyLastName_RMA_TC_092, 2));
			...
			RMA_GenericUsages_Utility.RMA_StaticWait(3, 0, "Wait Is Added As A Switch To The Frame Containing Litigation Screen Controls Is Done");
			...
			RMA_Input_Utility.RMA_SetValue_Utility(RMA_POM_Search.RMAApp_SearchPhysician_Txt_LastName(driver), "Physician Last Name TextBox On Search Window", StrPhyLastName_RMA_TC_092, 0);
			RMA_Navigation_Utility.RMA_WebCheckBoxSelect_Utility(RMA_POM_Search.RMAApp_Search_Chk_Soundex(driver), "uncheck", "Soundex CheckBox", " Physician Search Page", 0);
			RMA_Navigation_Utility.RMA_ObjectClick(RMA_POM_Search.RMAApp_Search_Btn_Submit(driver), "Submit Button On Physician Search Page", 0);
			RMA_GenericUsages_Utility.RMA_StaticWait(5, 0, "Wait is Added As Search Page Specific To Searched Physician Crietria Is Loaded");
			RMA_Navigation_Utility.RMA_WebPartialLinkSelect(StrPhyLastName_RMA_TC_092, "Search Page Specific To Searched Physician Criteria" , 0);
			RMA_GenericUsages_Utility.RMA_StaticWait(5, 0, "Wait is Added As Physician Page is Loaded");
			...
			RMA_GenericUsages_Utility.RMA_StaticWait(2, 0, "Wait Is Added As Switch To Frame Containing Persons Involved-->Physician Screen Controls Is Done");
			RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_Home.RMAApp_Generic_Img_Save(driver), "Save Image On Persons Involved-->Physician Page", 0);
			RMA_GenericUsages_Utility.RMA_StaticWait(5, 0, "Wait Is Added As Physician On Persons Involved Page Is Saved");
			StrPhyLastNameActual_RMA_TC_092 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			...
			driver.switchTo().parentFrame();
			RMA_Verification_Utility.RMA_UnsavedChangeVerification_Utility("Persons Involved-->Physician Page" , 0);
			RMA_Verification_Utility.RMA_TextCompare(StrPhyLastName_RMA_TC_092, StrPhyLastNameActual_RMA_TC_092, "Physician Name", 0);
			...
			StrEditedPhyLastName = RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(4, "Physician_RMA_TC_092_");
			driver.switchTo().frame(RMA_GenericUsages_Utility.RMA_FrameNavigation("piphysician"));
			RMA_GenericUsages_Utility.RMA_StaticWait(2, 0, "Wait Is Added As Switch To Frame Containing Persons Involved-->Physician Screen Controls Is Done");
			RMA_Input_Utility.RMA_SetValue_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "LastName TextBox On Persons Involved-->Physician Page", StrEditedPhyLastName, 0);
			RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_Home.RMAApp_Generic_Img_Save(driver), "Save Image On Persons Involved-->Physician Page", 0);
			RMA_GenericUsages_Utility.RMA_StaticWait(5, 0, "Wait Is Added As Persons Involved-->Physician Page Is Saved");
			RMA_NegativeVerification_Utility.RMA_ElementNotExist_Utility(RMA_Selenium_POM_Home.RMAApp_DefaultView_Err_StaticErrorText(driver), "RMA Application Static Error Message",0);
			StrEditedPhysLastNameAct_RMA_TC_092 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			driver.switchTo().parentFrame();
			RMA_Verification_Utility.RMA_UnsavedChangeVerification_Utility("Persons Involved-->Physician Page" , 0);
			RMA_Verification_Utility.RMA_TextCompare(StrEditedPhyLastName, StrEditedPhysLastNameAct_RMA_TC_092 , "Physician Last Name Value",0);
			...
			parentlogger.log(LogStatus.INFO, "Following Utility :" +" " +"RMA_GenericDelete_Utility Is Called To Delete The Physician"+ " "+ color.RMA_ChangeColor_Utility(StrEditedPhysLastNameAct_RMA_TC_092, 2) +" " +"Added As Persons Involved");
			testcall2 = true;
			RMA_Functionality_Utility.RMA_GenericDelete_Utility("Persons Involved-->Physician Page", 1);
			parentlogger.log(LogStatus.INFO, "Physician Added As Persons Involved Is Deleted Successfully::"+ " " + color.RMA_ChangeColor_Utility(StrEditedPhysLastNameAct_RMA_TC_092, 2));
