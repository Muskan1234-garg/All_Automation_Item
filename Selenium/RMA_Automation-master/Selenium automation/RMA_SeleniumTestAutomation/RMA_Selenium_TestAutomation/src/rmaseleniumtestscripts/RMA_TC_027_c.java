...
//=========================================================================================================================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_TC_027
//Description    : TC_027_Verify That Diary/Email Is Sent To Current Adjuster Of Claim.
//Depends On TC  : TC_011, TC_021, TC_022 & TC_026
...
public class RMA_TC_027_c extends rmaseleniumtestscripts.RMA_TC_BaseTest {
...
@Test 
public void RMA_TC_027_Test () throws Exception, Error
//Verify That Diary/Email Is Sent To Current Adjuster Of Claim.
{
	try {
		parentlogger = reports.startTest("TC_027_Transaction is Approved", "Verify user is able to approve the transaction and diary/email is sent to Current Adjuster of Claim.");
		String StrAccept;
		...
		StrAccept = "Yes";
		AttachedRecord = "FUNDS:"+" "+RMA_TC_022.StrControlNum_022;
		TaskName = "Check Approved";
		TaskNameVal = "Payments:"+" "+ RMA_TC_022.StrControlNum_022;
		ParentRecord = "Claim:"+RMA_TC_022.StrClaimNumber_022;
		...
		RMAApp_Login_Txt_UserName = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_027", 1, 0); //UserName Fetched From DataSheet RMA_TC_027
		RMAApp_Login_Txt_Password = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_027", 1, 1); //Password Fetched From DataSheet RMA_TC_027
		
		
		//==============================================='CurrAdj' Logging In Is Started=================================================================================================================================================================================================================================================================================================================================================================================================================================
		...
		//==============================================='CurrAdj' Logging In Is Completed===========================================================================================================================================================================================================================================================================================================================================================================================================================
		//===============================================Existence Of Payment (Created In TC_022) Approval Diary In Diaries Page Validation Is Started=================================================================================================================================================================================================================================================================================================================================================================
		...
		//================================================Existence Of Payment (Created In TC_022) Approval Diary In Diaries Page Validation Is Completed=============================================================================================================================================================================================================================================================================================================================================================
		...
		RMA_Functionality_Utility.RMA_StandardSearch_Screen(RMA_POM_Search.RMAApp_SearchFunds_Txt_ControlNumber(driver), "Search_Funds", "Check Control Number Text Box", RMA_TC_022.StrControlNum_022, RMA_TC_022.StrControlNum_022, "Transaction", "num", 2, logval);
		...
		//===============================================Disabling Of Required Payment Parameter Set Up Settings (Enabled In TC_021) Is Started========================================================================================================================================================================================================================================================================================================================================================================
		...
		RMA_Navigation_Utility.RMA_WebCheckBoxSelect_Utility(RMA_Selenium_POM_PaymentParameterSetUp.RMAApp_PmntSetUpSprVsr_Chk_PayLimitExceed(driver), "uncheck", "Payment Limits are exceeded CheckBox ", "Payment Parameter Setup",0);   // Check box "Payment Limits are exceeded" is checked on Payment Parameter Setup
		RMA_Navigation_Utility.RMA_WebCheckBoxSelect_Utility(RMA_Selenium_POM_PaymentParameterSetUp.RMAApp_PmntSetUpSprVsr_Chk_SupervisoryApproval(driver), "uncheck", "Supervisor Approval CheckBox", "Payment Parameter Setup",0);  // Check box "Supervisor Approval" is checked on Payment Parameter Setup
		RMA_Navigation_Utility.RMA_WebCheckBoxSelect_Utility(RMA_Selenium_POM_PaymentParameterSetUp.RMAApp_PmntSetUpSprVsr_Chk_UseCurrentAdjuster(driver), "uncheck", "Use Current Adjuster Supervisory Chain CheckBox", "Payment Parameter Setup",0); //Check box "Use Current Adjuster Chain " is checked on Payment Parameter Setup
		RMA_Navigation_Utility.RMA_WebCheckBoxSelect_Utility(RMA_Selenium_POM_PaymentParameterSetUp.RMAApp_PmntSetUpSprVsr_Chk_EnbPmtDiary(driver), "uncheck", "Enable Payment Approval Diary CheckBox ", "Payment Parameter Setup",0); //Check box "Enable Payment Approval Diary " is checked on Payment Parameter Setup
		RMA_Navigation_Utility.RMA_WebCheckBoxSelect_Utility(RMA_Selenium_POM_PaymentParameterSetUp.RMAApp_PmntSetUpSprVsr_Chk_EnbPmtEmail(driver), "uncheck", "Enable Payment Approval Email CheckBox", "Payment Parameter Setup",0); //Check box "Enable Payment Approval Email " is checked on Payment Parameter Setup
		RMA_Navigation_Utility.RMA_WebCheckBoxSelect_Utility(RMA_Selenium_POM_PaymentParameterSetUp.RMAApp_PmntSetUpSprVsr_Chk_NotifyImmSupervisor(driver), "uncheck", "Notify Immediate Supervisor CheckBox", "Payment Parameter Setup",0); //Check box "Enable Payment Approval Email " is unchecked on Payment Parameter Setup
		...
		//===============================================Disabling Of Required Payment Parameter Set Up Settings (Enabled In TC_021) Is Completed======================================================================================================================================================================================================================================================================================================================================
