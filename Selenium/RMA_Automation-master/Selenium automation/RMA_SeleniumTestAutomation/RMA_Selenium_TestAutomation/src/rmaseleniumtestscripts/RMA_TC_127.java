...
//================================================================================================
//TestCaseID     : RMA_TC_127
//Description    : TC_127_Verify Adding,Editing And Deleting Of New Employee As Person Involved In Litigation For General Claim
//Depends On TC  : RMA_TC_126
//Revision       : 0.0 - KumudNaithani-06-28-2016 
//=================================================================================================

public class RMA_TC_127 extends RMA_TC_BaseTest {
	...
	@Test
	public void RMA_TC_127_Test() throws Exception,Error {

		try{
			parentlogger = reports.startTest("TC_127_Adding, Editing And Deleting Of New Employee", "Verify Adding,Editing And Deleting Of New Employee As Person Involved In Litigation For General Claim");
			parentlogger.assignAuthor("Kumud Naithani");

			String StrEmployeeNumber_127;
			String StrEmployeeLastNameActual_127;
			String StrEmployeeNameChanged;

			StrScreenShotTCName = "TC_127";
			testcall1 = false;	
			testcall2 = false;	
			...
			testcall1 = true;
			StrEmployeeNumber_127 = RMA_Functionality_Utility.RMA_PIAddNewEntity_Utility("Employee", logval1);
			parentlogger.log(LogStatus.INFO, "New Employee Is Created Successfully With Employee Number::"+ " " + color.RMA_ChangeColor_Utility(StrEmployeeNumber_127, 2));
			...
			StrEmployeeNameChanged = RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(4, "EmpName_TC_127_");
			...
			StrEmployeeLastNameActual_127 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrEmployeeNameChanged, StrEmployeeLastNameActual_127 , "EmployeeLast Name", logval);
