...
//================================================================================================
//TestCaseID     : RMA_TC_173
//Description    : TC_173_Verify Add,Edit And Delete Of Existing Witness As Person Involved on Property Claims
//Depends On TC  : RMA_TC_166
//Revision       : 0.0 - RenuVerma-07-06-2016 
//=================================================================================================

public class RMA_TC_173 extends rmaseleniumtestscripts.RMA_TC_BaseTest {
	...
	@Test 
	public void RMA_TC_173_Test () throws Exception, Error
	{
		parentlogger = reports.startTest("TC_173_Existing Witness As Person Involved", "Verify Add,Edit And Delete Of Existing Witness As Person Involved on Property Claims");
		parentlogger.assignAuthor("Renu Verma");
		try {
			String StrPrimaryWindowHandle;
		    String StrEditedWitLastNameActual_173;
			String StrEditedWitLastName173;
			String StrWitLastNameActual_173;
			...
			RMA_Functionality_Utility.RMA_StandardSearch_Window(RMA_POM_Search.RMAApp_SearchEntity_Txt_LastName(driver), "Claim-->PI-->Search-->Existing Witness Criteria Page","Witness Last Name Text Box",RMA_TC_166.StrWitnessLastName_166,"Witness","piwitness",StrPrimaryWindowHandle, logval);
			RMA_Functionality_Utility.RMA_GenericSave_Utility("piwitness",false,"NA","Witness Involved-->Witness Page", logval);
			StrWitLastNameActual_173 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(RMA_TC_166.StrWitnessLastName_166, StrWitLastNameActual_173, "Witness Name", logval);
			...
			StrEditedWitLastName173 = RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(4, "Witness_173_");
			RMA_Input_Utility.RMA_SetValue_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "LastName TextBox On Persons Involved-->Witness Page", StrEditedWitLastName173, logval);
			RMA_Functionality_Utility.RMA_GenericSave_Utility("piwitness",false,"NA","Persons Involved-->Witness Page", logval);
			StrEditedWitLastNameActual_173 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrEditedWitLastName173, StrEditedWitLastNameActual_173 , "Witness Last Name Value",logval);
			...
			parentlogger.log(LogStatus.INFO, "Following Utility :" +" " +"RMA_GenericDelete_Utility Is Called To Delete The Witness"+ " "+ color.RMA_ChangeColor_Utility(StrEditedWitLastNameActual_173, 2) +" " +"Added As Persons Involved");
			testcall2 = true;
			RMA_Functionality_Utility.RMA_GenericDelete_Utility("Persons Involved-->Witness Page", logval1);
			parentlogger.log(LogStatus.INFO, "Witness Added As Persons Involved Is Deleted Successfully::"+ " " + color.RMA_ChangeColor_Utility(StrEditedWitLastNameActual_173, 2));
