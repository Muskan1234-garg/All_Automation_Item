...
//================================================================================================
//TestCaseID     : RMA_TC_285
//Description    : TC_285_ Verify Adding,Editing And Deleting Of New Employee As Person Involved For Workers' Comp Claim At Policy level
//Depends On TC  : RMA_TC_284
//Revision       : 0.0 - RenuVerma-09-12-2016 
//=================================================================================================

public class RMA_TC_285 extends RMA_TC_BaseTest {
	...
	@Test
	public void RMA_TC_285_Test() throws Exception,Error {

		try{
			parentlogger = reports.startTest("TC_285_ Verify Adding,Editing And Deleting Of New Employee As Person Involved For Workers' Comp Claim At Policy level", " Verify Adding,Editing And Deleting Of New Employee As Person Involved For Workers' Comp Claim At Policy level");
			parentlogger.assignAuthor("Renu Verma");

			String StrEmployeeNumber_285;
			String StrEmployeeLastNameActual_285;
			String StrEmployeeNameChanged_285;
			String StrClaimActual;
						
			//Local Variable Declaration Completed Here
			
			StrScreenShotTCName = "TC_285";
			testcall1 = false;	
			testcall2 = false;	
			...
			RMA_Verification_Utility.RMA_TextCompare(RMA_TC_284.StrClaimNumber_284, StrClaimActual, "Workers' comp Number", logval);
			//===============================================Search Of The Workers' Comp Claim Policy Created In TC_284 Is Completed=====================================================================================================

			/*================================================== Step Add New Employee On Workers' Comp Claim Policy--> PI Started Here================================================================*/
			...
			testcall1 = true;
			StrEmployeeNumber_285 = RMA_Functionality_Utility.RMA_PIAddNewEntity_Utility("Employee", logval1);
			parentlogger.log(LogStatus.INFO, "New Employee Is Created Successfully With Employee Number::"+ " " + color.RMA_ChangeColor_Utility(StrEmployeeNumber_285, 2));
			...
			/*====================================================Addition Of New Employee On Workers' Comp Claim Policy Created in TC_284 Is Completed Here=======================================*/

			/*===============================================Editing Of Exiting Employee Is Started Here================================*/
			StrEmployeeNameChanged_285 = RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(4, "EmpName_285_");
			RMA_Input_Utility.RMA_SetValue_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "LastName TextBox On PI Employee Page ", StrEmployeeNameChanged_285, logval);
			RMA_Functionality_Utility.RMA_GenericSave_Utility("piemployee", false, "NA","Persons Involved-->Employee Page", logval);
			StrEmployeeLastNameActual_285 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrEmployeeNameChanged_285, StrEmployeeLastNameActual_285 , "EmployeeLast Name", logval);
			...
			parentlogger.log(LogStatus.INFO, "The Functional Utility :" +" " +"RMA_GenericDelete_Utility Is Called To Delete An Employee : " +" "+ color.RMA_ChangeColor_Utility(StrEmployeeNameChanged_285, 2));
			testcall2 = true;
			RMA_Functionality_Utility.RMA_GenericDelete_Utility("PI Employee Page", logval1);
			parentlogger.log(LogStatus.INFO, "Employee Is Deleted Successfully ::"+ " " + color.RMA_ChangeColor_Utility(StrEmployeeNameChanged_285, 2));
