...
//================================================================================================
//TestCaseID     : RMA_TC_137
//Description    : TC_137_Verify Adding,Editing And Deleting Of New Driver As Person Involved In Litigation For Workers Comp Claim
//Depends On TC  : RMA_TC_137
//Revision       : 0.0 - ImteyazAhmad-06-28-2016 
//=================================================================================================

public class RMA_TC_137 extends RMA_TC_BaseTest {
	...
	@Test
	public void RMA_TC_137_Test() throws Exception,Error {

		try{
			parentlogger = reports.startTest("TC_137_Adding, Editing And Deleting Of New Driver", "Verify Adding,Editing And Deleting Of New Driver As Person Involved In Litigation For Workers Comp Claim");
			parentlogger.assignAuthor("Imteyaz Ahmad");

			String StrDriverLastName_137;
			String StrDriverLastNameActual_137;
			String StrDriverLastNameChanged;

			StrScreenShotTCName = "TC_137";
			testcall1 = false;	
			testcall2 = false;	
			...
			testcall1 = true;
			StrDriverLastName_137 = RMA_Functionality_Utility.RMA_PIAddNewEntity_Utility("Driver", logval1);
			parentlogger.log(LogStatus.INFO, "New Driver Is Created Successfully With Driver Last Name::"+ " " + color.RMA_ChangeColor_Utility(StrDriverLastName_137, 2));
			loggerval1 = logger.toString();
			parentlogger.appendChild(logger);
			//===============================================Steps To Create A New Driver Completed============================================================================================================================================
			
			/*===============================================Editing Of New Driver Is Started Here=======================================================================*/
			StrDriverLastNameChanged = RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(4, "Driver_TC_137_");
			...
			StrDriverLastNameActual_137 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Maintenance.RMAApp_MaintDriver_Txt_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrDriverLastNameChanged, StrDriverLastNameActual_137 , "Driver Last Name", logval);
