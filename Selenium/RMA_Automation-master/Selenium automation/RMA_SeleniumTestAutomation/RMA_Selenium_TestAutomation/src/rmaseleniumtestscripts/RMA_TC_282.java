...
//================================================================================================
//TestCaseID     : RMA_TC_282
//Description    : TC_282_Verify Add,Edit And Delete Of New Physician As Person Involved For General Claim At Policy Level
//Depends On TC  : RMA_TC_246
//Revision       : 0.0 - RenuVerma-07-27-2016 
//=================================================================================================

public class RMA_TC_282 extends rmaseleniumtestscripts.RMA_TC_BaseTest {
	...
	@Test 
	public void RMA_TC_282_Test () throws Exception, Error
	{
		parentlogger = reports.startTest("TC_282_Verify Adding, Editing And Deleting Of New Physician As Person Involved For General Claim At Policy Level", "Verify Add,Edit And Delete Of New Physician As Person Involved For General Claim At Policy Level");
		parentlogger.assignAuthor("Renu Verma");
		try {
			String StrPhysicianLastName_282;
			String StrEditedPhysicianLastName_Actual_282;
			String StrEditedPhysicianLastName_282;
			...
			//===============================================Addition Of Physician On General Claim Policy Created in TC_246 Is Started Here=====================================================================================================
			...
			testcall1 = true;
			StrPhysicianLastName_282 = RMA_Functionality_Utility.RMA_PIAddNewEntity_Utility("Physician", logval1);
			parentlogger.log(LogStatus.INFO, "New Physician Is Created Successfully With Physician Name::"+ " " + color.RMA_ChangeColor_Utility(StrPhysicianLastName_282, 2));
			...
			//===============================================Addition Of Physician On General Claim Policy Created in TC_246 Is Completed Here =================================================================================================================================================
			
			//===============================================Steps To Edit The Physician Added As Persons Involved Started ======================================================================================================================================================
			StrEditedPhysicianLastName_282 = RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(4, "Physician_282_");
			RMA_Input_Utility.RMA_SetValue_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "LastName TextBox On Persons Involved-->Physician Page", StrEditedPhysicianLastName_282, logval);
			RMA_Functionality_Utility.RMA_GenericSave_Utility("piphysician",false,"NA","Persons Involved-->Physician Page", logval);
			StrEditedPhysicianLastName_Actual_282 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrEditedPhysicianLastName_282, StrEditedPhysicianLastName_Actual_282 , "Physician Last Name Value",logval);
			...
			parentlogger.log(LogStatus.INFO, "Following Utility :" +" " +"RMA_GenericDelete_Utility Is Called To Delete The Physician"+ " "+ color.RMA_ChangeColor_Utility(StrEditedPhysicianLastName_Actual_282, 2) +" " +"Added As Persons Involved");
			testcall2 = true;
			RMA_Functionality_Utility.RMA_GenericDelete_Utility("Persons Involved-->Physician Page", logval1);
			parentlogger.log(LogStatus.INFO, "Physician Added As Persons Involved Is Deleted Successfully::"+ " " + color.RMA_ChangeColor_Utility(StrEditedPhysicianLastName_Actual_282, 2));
