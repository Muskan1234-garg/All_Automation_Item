...
//================================================================================================
//TestCaseID     : RMA_TC_212
//Description    : TC_212_Verify Add,Edit And Delete Of New Physician As Person Involved on Property Claim
//Depends On TC  : RMA_TC_206
//Revision       : 0.0 - RenuVerma-07-15-2016 
//=================================================================================================

public class RMA_TC_212 extends rmaseleniumtestscripts.RMA_TC_BaseTest {
	...
	{
		parentlogger = reports.startTest("TC_212_Adding, Editing And Deleting Of New Physician As Person Involved", "Verify Add,Edit And Delete Of New Physician As Person Involved on Property Claim");
		parentlogger.assignAuthor("Renu Verma");
		try {
			String StrPhysicianLastName_212;
			String StrEditedPhysicianLastName_Actual_212;
			String StrEditedPhysicianLastName_212;
			...
			testcall1 = true;
			StrPhysicianLastName_212 = RMA_Functionality_Utility.RMA_PIAddNewEntity_Utility("Physician", logval1);
			parentlogger.log(LogStatus.INFO, "New Physician Is Created Successfully With Physician Name::"+ " " + color.RMA_ChangeColor_Utility(StrPhysicianLastName_212, 2));
			...
			StrEditedPhysicianLastName_212 = RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(4, "Physician_RMA_TC_212_");
			RMA_Input_Utility.RMA_SetValue_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "LastName TextBox On Persons Involved-->Physician Page", StrEditedPhysicianLastName_212, logval);
			RMA_Functionality_Utility.RMA_GenericSave_Utility("piphysician",false,"NA","Persons Involved-->Physician Page", logval);
			StrEditedPhysicianLastName_Actual_212 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrEditedPhysicianLastName_212, StrEditedPhysicianLastName_Actual_212 , "Physician Last Name Value",logval);
			...
			parentlogger.log(LogStatus.INFO, "Following Utility :" +" " +"RMA_GenericDelete_Utility Is Called To Delete The Physician"+ " "+ color.RMA_ChangeColor_Utility(StrEditedPhysicianLastName_Actual_212, 2) +" " +"Added As Persons Involved");
			testcall2 = true;
			RMA_Functionality_Utility.RMA_GenericDelete_Utility("Persons Involved-->Physician Page", logval1);
			parentlogger.log(LogStatus.INFO, "Physician Added As Persons Involved Is Deleted Successfully::"+ " " + color.RMA_ChangeColor_Utility(StrEditedPhysicianLastName_Actual_212, 2));
