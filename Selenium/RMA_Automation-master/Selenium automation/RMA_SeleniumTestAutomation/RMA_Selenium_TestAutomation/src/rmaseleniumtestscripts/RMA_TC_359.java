...
//=============================================================================================================================
//TestCaseID     : RMA_TC_359
//Description    : Creation, Edit And Deletion Of Enhanced Notes For Financial/Reserves Page Associated With A Claim
//Depends On TC  : RMA_TC_335
//Revision       : 0.0 - KumudNaithani-03-08-2017
//==============================================================================================================================

public class RMA_TC_359 extends RMA_TC_BaseTest {
...
@Test	
public void RMA_TC_359_Test() throws Exception, Error
{   
	try {
	 ...
	 parentlogger = reports.startTest("RMA_TC_359_Creation, Edit And Deletion Of Enhanced Notes For Claim Financial/Reserves Page", "Creation, Edit And Deletion Of Enhanced Notes For Financial/Reserves Page Associated With A Claim");
	 ...
	 StrScreenShotTCName = "RMA_TC_359";
	 Edit = true;
	 //Variable Initialization Completed
     
	//===========================================================Loading Of Financial/Reserves Page Associated With Claim Is Started Here=====================================================================================================================================================================================================================================================================================================================================
	...
	//===========================================================Loading Of Financial/Reserves Page Associated With Claim Is Completed Here=======================================================================================================================================================================================================================================================================================================================================
	
	//===========================================================Steps To Create And Edit Progress Notes Started Here==================================================================================================================================================================================================================================================================================================================================================
    StrPrimaryWindowHandle = driver.getWindowHandle();
	RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_Home.RMAApp_Generic_Img_EnhancedNotes(driver), "Enhanced Notes Image For Financials/Reserves Page"+ " "+ "Associated With Claim:"+" "+color.RMA_ChangeColor_Utility(StrClaimNumber_335, 2), logval); // Claim ID Is Same For All Line Of Business
