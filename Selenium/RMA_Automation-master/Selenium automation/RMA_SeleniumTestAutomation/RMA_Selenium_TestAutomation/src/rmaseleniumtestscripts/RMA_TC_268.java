...
//================================================================================================
//TestCaseID     : RMA_TC_268
//Description    : TC_268_Verify That Person Involved Link Is Present In Created Workers Compensation Claim At Policy Level & Also Catering Addition And Deletion Of Witness For Future Reference
//Depends On TC  : None
//Revision       : 0.0 - RenuVerma-09-06-2016 
//=================================================================================================

public class RMA_TC_268 extends RMA_TC_BaseTest {
	...
	public static String StrClaimNumber_268;
	public static String StrPolicyName_268;
	public static String StrWitnessLastName_268;
	public static String RMAApp_WorkersCompClaim_Txt_PolicyNo;
	
	@Test
	public void RMA_TC_268_Test() throws Exception,Error {

		try{
			parentlogger = reports.startTest("TC_268_Verify That Person Involved Link Is Present In Created Workers Compensation Claim At Policy Level & Also Catering Addition And Deletion Of Witness For Future Reference", "Verify That Person Involved Link Is Present In Created Workers Compensation Claim At Policy Level & Also Catering Addition And Deletion Of Witness For Future Reference");
			...
			String StrPolicyNo_268;
			
		
			//Local Variable Declaration Completed Here
			
			StrScreenShotTCName = "TC_268";
			testcall1 = false;
			testcall2 = false;
			testcall3 = false;
			testcall4 = false;
			...
			RMAApp_WorkersCompClaim_Txt_ClaimType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_268", 1, 0); // Claim Type Is Fetched From DataSheet RMA_TC_268
			RMAApp_WorkersCompClaim_Txt_EmployeeNo = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_TC_268", 1, 1);//Employee Number Is Fetched From DataSheet RMA_TC_268
			RMAApp_WorkersCompClaim_Txt_Department = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_268", 1, 2); // Department Is Fetched From DataSheet RMA_TC_268
			RMAApp_WorkersCompClaim_Txt_DateOfEvent = ExcelData.RMA_ExcelDateDataRead_Utility("RMA_TC_268", 1, 3);//DateOfEvent Is Fetched From DataSheet RMA_TC_268
			RMAApp_WorkersCompClaim_Txt_TimeOfEvent = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_TC_268", 1, 4);//TimeOfEvent Is Fetched From DataSheet RMA_TC_268
			RMAApp_WorkersCompClaim_Txt_DateOfClaim = ExcelData.RMA_ExcelDateDataRead_Utility("RMA_TC_268", 1, 5);//DateOfClaim Is Fetched From DataSheet RMA_TC_268
			RMAApp_WorkersCompClaim_Txt_TimeOfClaim = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_TC_268", 1, 6);//TimeOfClaim Is Fetched From DataSheet RMA_TC_268
			RMAApp_WorkersCompClaim_Txt_Jurisdiction = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_268", 1, 7); // Jurisdiction Is Fetched From DataSheet RMA_TC_268
			RMAApp_WorkersCompClaim_Txt_PolicyLOB = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_268", 1, 8); // PolicyLOB  Is Fetched From DataSheet RMA_TC_268
			RMAApp_WorkersCompClaim_Txt_PolicySystemName = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_268", 1, 9); // PolicySystemName Is Fetched From DataSheet RMA_TC_268
			RMAApp_WorkersCompClaim_Txt_PolicyNo = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_268", 1, 10); // PolicyNo Is Fetched From DataSheet RMA_TC_268
			...
			testcall1 = true;
			StrClaimNumber_268 = RMA_Functionality_Utility.RMA_WorkersCompClaimCreation_ACON(RMAApp_WorkersCompClaim_Txt_ClaimType, RMAApp_WorkersCompClaim_Txt_EmployeeNo, RMAApp_WorkersCompClaim_Txt_Department,RMAApp_WorkersCompClaim_Txt_DateOfEvent, RMAApp_WorkersCompClaim_Txt_TimeOfEvent,  RMAApp_WorkersCompClaim_Txt_DateOfClaim, RMAApp_WorkersCompClaim_Txt_TimeOfClaim, RMAApp_WorkersCompClaim_Txt_Jurisdiction,RMAApp_WorkersCompClaim_Txt_PolicyLOB,false, logval1);
			loggerval1 = logger.toString();
			parentlogger.appendChild(logger);
			RMA_GenericUsages_Utility.RMA_DynamicFrameSwitching(StrClaimNumber_268 );
			...
			StrPolicyName_268=RMA_Functionality_Utility.RMA_PolicyDownload_Utility(RMAApp_WorkersCompClaim_Txt_PolicySystemName, RMAApp_WorkersCompClaim_Txt_DateOfEvent,RMAApp_WorkersCompClaim_Txt_PolicyLOB , RMAApp_WorkersCompClaim_Txt_PolicyNo, "Status:Verified",StrClaimNumber_268 ,"NA","Download Policy",logval1);
			loggerval2 = logger.toString();
			parentlogger.appendChild(logger);
		//	StrClaimNumber_268 = RMA_Selenium_POM_Document_GeneralClaims.RMAApp_GeneralClaim_Txt_ClaimNumber(driver).getAttribute("value"); //Value Of the Generated Claim Number Is Fetched In The Variable StrClaimNumber
			String StrPolicyName[]=StrPolicyName_268.split(" "); // Split The Policy No from the Policy Name
			StrPolicyNo_268=StrPolicyName[1];// Filter Box Value// Fetch the Policy No Which Is On The First Index(e.g.APV 0381852 03)
			parentlogger.log(LogStatus.INFO, "A Workers' comp With Claim Number:: "+ color.RMA_ChangeColor_Utility(StrClaimNumber_268, 3)+ " Is Successfully Download Policy With Policy Number:: "+color.RMA_ChangeColor_Utility(StrPolicyNo_268, 2));
			...
			driver.switchTo().parentFrame();
			RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_Home.RMAApp_LeftHandNavTree_Img_ExpandCollapse(driver, "Policy ("+StrPolicyName_268), "Expand Image For The Created Policy On Left Hand Navigation Tree",logval);
			RMA_GenericUsages_Utility.RMA_StaticWait(3, logval, "Wait Is Added As Expand Image Corresponding To Policy "+" "+StrPolicyName_268 +" Is Clicked");
			RMA_Verification_Utility.RMA_ElementExist_Utility(RMA_Selenium_POM_Home.RMAApp_LeftHandNavTree_Lnk_Policy_PI(driver, StrPolicyName_268), "Person Involved Link On Left Hand Navigation Tree Of Workers Comp Claim-->Policy", logval);
			...
			RMA_Navigation_Utility.RMA_ObjectRightClick(RMA_Selenium_POM_Home.RMAApp_LeftHandNavTree_Lnk_Policy_PI(driver, StrPolicyName_268), "Persons Involded Link Present Under Policy Tree", logval);
			parentlogger.log(LogStatus.INFO, "The Functional Utility :" +" " +"RMA_PIAddNewEntity_Utility Is Called To Create An Witness ");
			testcall2 = true;
			StrWitnessLastName_268 = RMA_Functionality_Utility.RMA_PIAddNewEntity_Utility("Witness", logval1);
			parentlogger.log(LogStatus.INFO, "New Witness Is Created Successfully With Witness Number::"+ " " + color.RMA_ChangeColor_Utility(StrWitnessLastName_268, 3));
			loggerval2 = logger.toString();
			parentlogger.appendChild(logger);
			...
			parentlogger.log(LogStatus.INFO, "The Functional Utility : "+RMA_GenericUsages_Utility.RMA_LoggerHyperlink("DeleteLink", "RMA_GenericDelete_Utility", 0) +" Is Called To Delete The Witness"+ " "+ color.RMA_ChangeColor_Utility(StrWitnessLastName_268, 2) +" Added As Persons Involved");
			testcall4 = true;
			RMA_Functionality_Utility.RMA_GenericDelete_Utility("Persons Involved-->Witness Page", logval1);
			parentlogger.log(LogStatus.INFO, "Witness Added As Persons Involved Is Deleted Successfully::"+ " " + color.RMA_ChangeColor_Utility(StrWitnessLastName_268, 3));
