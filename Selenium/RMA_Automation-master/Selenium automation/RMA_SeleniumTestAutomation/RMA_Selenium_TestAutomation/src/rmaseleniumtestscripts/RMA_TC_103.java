...
//================================================================================================
//TestCaseID     : RMA_TC_103
//Description    : TC_103_Verify Add,Edit And Delete Of Existing Employee As Person Involved In Litigation In Vehicle Accident Claim.
//Depends On TC  : RMA_TC_102
//Revision       : 0.0 - KumudNaithani-05-13-2016 
//=================================================================================================

public class RMA_TC_103 extends rmaseleniumtestscripts.RMA_TC_BaseTest {
	...
	@Test 
	public void RMA_TC_103_Test () throws Exception, Error
	{
		parentlogger = reports.startTest("TC_103_Existing Employee As Person Involved For Vehicle Accident Claim", "Verify Add,Edit And Delete Of Existing Employee As Person Involved In Litigation For Vehicle Accident Claim");
		parentlogger.assignAuthor("Kumud Naithani");
		try {
			String StrEmpNum_RMA_TC_103;
			String StrPrimaryWindowHandle;
			String StrEditedEmpNameActual_RMA_TC_103;
			String StrEditedEmpName;
			String StrEmpNumActual_RMA_TC_103;
			loggerval1 = "NotInitialized";
			testcall1 = false;
			loggerval2 = "NotInitialized";
			testcall2 = false;
			StrScreenShotTCName = "TC_103";
			...
			testcall1 = true;
			StrEmpNum_RMA_TC_103 = RMA_Functionality_Utility.RMA_MaintEntityAddition_Utility("Employee", logval1);
			parentlogger.log(LogStatus.INFO, "New Employee Is Created With Employee Number::"+ " " + color.RMA_ChangeColor_Utility(StrEmpNum_RMA_TC_103, 2));
			loggerval1 = logger.toString();
			parentlogger.appendChild(logger);
			// New Employee Is Created
			
			//===============================================Creation Of Employee Completed=====================================================================================================
			//===============================================Search Of The Claim Created In TC_103 Is Started=====================================================================================================
			...
			//===============================================Search Of The Claim Created In TC_103 Is Completed=====================================================================================================
			...
			RMA_Navigation_Utility.RMA_ObjectJavaScriptClick(RMA_Selenium_POM_Home.RMAApp_LeftHandTreeRightClick_Lnk_EntName(driver, "Employee"), "Employee Under Add Existing On Persons Involved Submenu", logval);
			...
			RMA_Input_Utility.RMA_SetValue_Utility(RMA_POM_Search.RMAApp_SearchEmployee_Txt_EmployeeNumber(driver), "Employee Number TextBox On Search Window", StrEmpNum_RMA_TC_103, logval);
			...
			RMA_Navigation_Utility.RMA_WebPartialLinkSelect(StrEmpNum_RMA_TC_103, "Search Page Specific To Searched Employee Criteria" , logval);
			RMA_GenericUsages_Utility.RMA_StaticWait(5, logval, "Wait is Added As Employee Page is Loaded");
			...
			RMA_GenericUsages_Utility.RMA_StaticWait(5, logval, "Wait Is Added As Employee On Persons Involved Page Is Saved");
			StrEmpNumActual_RMA_TC_103 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_PersonInvolved.RMAApp_PIEmp_Txt_EmpNumber(driver), "value");
			...
			driver.switchTo().parentFrame();
			RMA_Verification_Utility.RMA_UnsavedChangeVerification_Utility("Persons Involved-->Employee Page" , logval);
			RMA_Verification_Utility.RMA_TextCompare(StrEmpNum_RMA_TC_103, StrEmpNumActual_RMA_TC_103, "Employee Number", logval);
			...
			StrEditedEmpName = RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(4, "Emp_RMA_TC_103_");
			driver.switchTo().frame(RMA_GenericUsages_Utility.RMA_FrameNavigation("piemployee"));
			...
			RMA_Input_Utility.RMA_SetValue_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "LastName TextBox On Persons Involved-->Employee Page", StrEditedEmpName, logval);
			RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_Home.RMAApp_Generic_Img_Save(driver), "Save Image On Persons Involved-->Employee Page", logval);
			RMA_GenericUsages_Utility.RMA_StaticWait(5, logval, "Wait Is Added As Persons Involved-->Employee Page Is Saved");
			RMA_NegativeVerification_Utility.RMA_ElementNotExist_Utility(RMA_Selenium_POM_Home.RMAApp_DefaultView_Err_StaticErrorText(driver), "RMA Application Static Error Message",logval);
			...
			StrEditedEmpNameActual_RMA_TC_103 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			driver.switchTo().parentFrame();
			RMA_Verification_Utility.RMA_UnsavedChangeVerification_Utility("Persons Involved-->Employee Page" , logval);
			RMA_Verification_Utility.RMA_TextCompare(StrEditedEmpName, StrEditedEmpNameActual_RMA_TC_103 , "Employee Last Name Value",logval);
			driver.switchTo().frame(RMA_GenericUsages_Utility.RMA_FrameNavigation("piemployee"));
			RMA_GenericUsages_Utility.RMA_StaticWait(2, 0, "Wait Is Added As Switch To Frame Containing Persons Involved-->Employee Screen Controls Is Done");
			...
			parentlogger.log(LogStatus.INFO, "Following Utility :" +" " +"RMA_GenericDelete_Utility Is Called To Delete The Employee"+ " "+ StrEditedEmpNameActual_RMA_TC_103 +" " +"Added As Persons Involved");
			testcall2 = true;
			RMA_Functionality_Utility.RMA_GenericDelete_Utility("Persons Involved-->Employee Page", logval1);
			parentlogger.log(LogStatus.INFO, "Employee Added As Persons Involved Is Deleted Successfully::"+ " " + color.RMA_ChangeColor_Utility(StrEditedEmpNameActual_RMA_TC_103, 2));
