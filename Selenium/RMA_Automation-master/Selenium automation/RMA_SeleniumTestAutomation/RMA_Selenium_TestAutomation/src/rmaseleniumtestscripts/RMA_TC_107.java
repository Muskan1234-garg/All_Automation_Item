...
//================================================================================================
//TestCaseID     : RMA_TC_107
//Description    : TC_107_Verify Add,Edit And Delete Of Existing Patient As Person Involved In Litigation For Vehicle Accident Claims
//Depends On TC  : RMA_TC_102
//Revision       : 0.0 - KumudNaithani-05-16-2016 
//=================================================================================================

public class RMA_TC_107 extends rmaseleniumtestscripts.RMA_TC_BaseTest {
	...
	@Test 
	public void RMA_TC_107_Test () throws Exception, Error
	{
		parentlogger = reports.startTest("TC_107_Existing Patient As Person Involved", "Verify Add,Edit And Delete Of Existing Patient As Person Involved In Litigation For Vehicle Accident Claims");
		...
		try {
			...
			StrEditedPatientLastName = RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(4, "Patient_RMA_TC_107_");
			driver.switchTo().frame(RMA_GenericUsages_Utility.RMA_FrameNavigation("pipatient"));
			RMA_GenericUsages_Utility.RMA_StaticWait(2, logval, "Wait Is Added As Switch To Frame Containing Persons Involved-->Patient Screen Controls Is Done");
