...
//================================================================================================
//TestCaseID     : RMA_TC_231
//Description    : TC_231_Verify Adding,Editing And Deleting Of new Employee As Person Involved  For Non Occupational Claim
//Depends On TC  : RMA_TC_230
//Revision       : 0.0 - ImteyazAhmad-07-29-2016 
//=================================================================================================

public class RMA_TC_231 extends RMA_TC_BaseTest {
	...
	@Test
	public void RMA_TC_231_Test() throws Exception,Error {

		try{
			parentlogger = reports.startTest("TC_231_Adding, Editing And Deleting Of New Employee", "Verify Adding,Editing And Deleting Of New Employee As Person Involved For Non Occupational Claim");
			parentlogger.assignAuthor("Imteyaz Ahmad");

			String StrEmployeeNumber_231;
			String StrEmployeeLastNameActual_231;
			String StrEmployeeNameChanged_231;
			String StrClaimNaumberActual;
			//Local Variable Declaration Completed Here
			
			StrScreenShotTCName = "TC_231";
			testcall1 = false;	
			testcall2 = false;	
			...
			testcall1 = true;
			StrEmployeeNumber_231 = RMA_Functionality_Utility.RMA_PIAddNewEntity_Utility("Employee", logval1);
			parentlogger.log(LogStatus.INFO, "New Employee Is Created Successfully With Employee Number::"+ " " + color.RMA_ChangeColor_Utility(StrEmployeeNumber_231, 2));
			...
			/*================================================== Step Add New Employee Is On Claim--> PI Completed Here================================================================*/
			
			/*===============================================Editing Of New Employee Is Started Here================================*/
			StrEmployeeNameChanged_231 = RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(4, "EmpName_231_");
			RMA_Input_Utility.RMA_SetValue_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "LastName TextBox On PI Employee Page ", StrEmployeeNameChanged_231, logval);
			RMA_Functionality_Utility.RMA_GenericSave_Utility("piemployee", false, "NA","Persons Involved-->Employee Page", logval);
			StrEmployeeLastNameActual_231 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrEmployeeNameChanged_231, StrEmployeeLastNameActual_231 , "EmployeeLast Name", logval);
			...
			parentlogger.log(LogStatus.INFO, "The Functional Utility :" +" " +"RMA_GenericDelete_Utility Is Called To Delete An Employee : " +" "+ color.RMA_ChangeColor_Utility(StrEmployeeNameChanged_231, 2));
			testcall2 = true;
			RMA_Functionality_Utility.RMA_GenericDelete_Utility("PI Employee Page", logval1);
			parentlogger.log(LogStatus.INFO, "Employee Is Deleted Successfully ::"+ " " + color.RMA_ChangeColor_Utility(StrEmployeeNameChanged_231, 2));
