...
//================================================================================================
//TestCaseID     : RMA_TC_211
//Description    : TC_211_Verify Add,Edit And Delete Of New Patient As Person Involved on Property Claims
//Depends On TC  : RMA_TC_206
//Revision       : 0.0 - RenuVerma-07-15-2016 
//=================================================================================================

public class RMA_TC_211 extends rmaseleniumtestscripts.RMA_TC_BaseTest {
	...
	@Test 
	public void RMA_TC_211_Test () throws Exception, Error
	{
		parentlogger = reports.startTest("TC_211_Adding,Editing And Deleting Of New Patient As Person Involved", "Verify Add,Edit And Delete Of New Patient As Person Involved on Property Claims");
		parentlogger.assignAuthor("Renu Verma");
		try {
			String StrPatientLastName_211;
			String StrEditedPatientLastName_Actual_211;
			String StrEditedPatientLastName_211;
			...
			//===============================================Addition Of Patient On Claim Created in TC_206 Is Started Here=====================================================================================================
			...
			testcall1 = true;
			StrPatientLastName_211 = RMA_Functionality_Utility.RMA_PIAddNewEntity_Utility("Patient", logval1);
			parentlogger.log(LogStatus.INFO, "New Patient Is Created Successfully With Patient Name::"+ " " + color.RMA_ChangeColor_Utility(StrPatientLastName_211, 2));
			...
			//===============================================Addition Of Patient On Claim Created in TC_206 Is Completed =================================================================================================================================================
			
			
			//===============================================Steps To Edit The Patient Added As Persons Involved Started ======================================================================================================================================================
			StrEditedPatientLastName_211 = RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(4, "Patient_RMA_TC_211_");
			RMA_Input_Utility.RMA_SetValue_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "LastName TextBox On Persons Involved-->Patient Page", StrEditedPatientLastName_211, logval);
			RMA_Functionality_Utility.RMA_GenericSave_Utility("pipatient",false,"NA","Persons Involved-->Patient Page", logval);
			StrEditedPatientLastName_Actual_211 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrEditedPatientLastName_211, StrEditedPatientLastName_Actual_211 , "Patient Last Name Value",logval);
			parentlogger.log(LogStatus.INFO, parentlogger.addScreenCapture(RMA_ScreenCapture_Utility.RMA_ScreenShotCapture_Utility(driver, "Successful Edit Of Patient Name", StrScreenShotTCName)));
			...
			parentlogger.log(LogStatus.INFO, "Following Utility :" +" " +"RMA_GenericDelete_Utility Is Called To Delete The Patient"+ " "+ color.RMA_ChangeColor_Utility(StrEditedPatientLastName_Actual_211, 2) +" " +"Added As Persons Involved");
			testcall2 = true;
			RMA_Functionality_Utility.RMA_GenericDelete_Utility("Persons Involved-->Patient Page", logval1);
			parentlogger.log(LogStatus.INFO, "Patient Added As Persons Involved Is Deleted Successfully::"+ " " + color.RMA_ChangeColor_Utility(StrEditedPatientLastName_Actual_211, 2));
