...
//================================================================================================
//TestCaseID     : RMA_TC_056
//Description    : Hold Transaction Created In RMA_TC_052 Is Not Listed In LOB Manager's List Is Validated
//Depends On TC  : TC_064, TC_051, TC_052
//Revision       : 0.0 - KumudNaithani-02-04-2016
//Revision       : 0.1 - ImteyazAhmad-08-10-2016
//=================================================================================================

public class RMA_TC_056 extends rmaseleniumtestscripts.RMA_TC_BaseTest {
	...
	@Test 
	public void RMA_TC_056_Test () throws Exception, Error
	//Verify That Hold Transaction Is Not Listed In LOB Managers List
	{
		try {
			parentlogger = reports.startTest("TC_056_Hold Transaction Not Listed In LOB Manager's List", "Hold Transaction Created In RMA_TC_052 Is Not Listed In LOB Managers List Is Validated");
			String StrAccept;
			...
			RMAApp_Login_Txt_UserName = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_056", 1, 0); //UserName Fetched From DataSheet RMA_TC_056
			RMAApp_Login_Txt_Password = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_056", 1, 1); //Password Fetched From DataSheet RMA_TC_056
			...
			if (RMA_Selenium_POM_Funds_SprApproval.RMAApp_SprApproval_PaymntNoRecordsAvailable(driver).isDisplayed() )
			{
				...
				parentlogger.log(LogStatus.INFO, logger.addScreenCapture(RMA_ScreenCapture_Utility.RMA_ScreenShotCapture_Utility(driver, "Payment $2500 Not Listed For LOB Manager's List Verification", StrScreenShotTCName)));
				...
				parentlogger.log(LogStatus.PASS, Strlogstatement);
				parentlogger.log(LogStatus.INFO, logger.addScreenCapture(RMA_ScreenCapture_Utility.RMA_ScreenShotCapture_Utility(driver, "Payment $2000 Not Listed For LOB Manager's List Verification", StrScreenShotTCName)));
