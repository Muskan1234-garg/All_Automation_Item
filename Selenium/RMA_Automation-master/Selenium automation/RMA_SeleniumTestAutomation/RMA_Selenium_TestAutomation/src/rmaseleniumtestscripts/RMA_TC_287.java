...
//================================================================================================
//TestCaseID     : RMA_TC_287
//Description    : TC_287_Verify Adding,Editing And Deleting Of New Driver As Person Involved on Workers' Comp Claim Policy
//Depends On TC  : RMA_TC_284
//Revision       : 0.0 - RenuVerma-09-13-2016
//=================================================================================================

public class RMA_TC_287 extends RMA_TC_BaseTest {
	...
	@Test
	public void RMA_TC_287_Test() throws Exception,Error {

		try{
			parentlogger = reports.startTest("TC_287_Verify Adding,Editing And Deleting Of New Driver As Person Involved on Workers' Comp Claim Policy", "Verify Adding,Editing And Deleting Of New Driver As Person Involved on Workers' Comp Claim Policy");
			parentlogger.assignAuthor("Renu Verma");

			String StrDriverLastName_287;
			String StrDriverLastNameChanged_287;
			String StrDriverLastNameChanged_Actual_287;
			String StrClaimNumberActual;
			//Local Variable Declaration Completed Here
			
			StrScreenShotTCName = "TC_287";
			testcall1 = false;	
			testcall2 = false;	
			...
			//===============================================Addition Of Driver Employee On Claim Created in TC_284 Is Started Here=====================================================================================================
			...
			testcall1 = true;
			StrDriverLastName_287 = RMA_Functionality_Utility.RMA_PIAddNewEntity_Utility("Driver", logval1);
			parentlogger.log(LogStatus.INFO, "New Driver Is Created Successfully With Driver Name::"+ " " + color.RMA_ChangeColor_Utility(StrDriverLastName_287, 2));
			...
			/*====================================================Addition Of New Driver On Claim Created in TC_284 Is Completed Here=======================================*/

			/*===============================================Editing Of An New Driver Is Started Here================================*/
			StrDriverLastNameChanged_287 = RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(4, "Driver_287_");
			RMA_Input_Utility.RMA_SetValue_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "LastName TextBox On PI Driver Page ", StrDriverLastNameChanged_287, logval);
			RMA_Functionality_Utility.RMA_GenericSave_Utility("pidriver",false,"NA","Persons Involved-->Driver Page", logval);
			StrDriverLastNameChanged_Actual_287 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrDriverLastNameChanged_287, StrDriverLastNameChanged_Actual_287 , "Driver Last Name", logval);
			...
			/*=================================================Editing Of An New Driver Is Completed Here=============================================*/

			/*===========================================================Deletion Of An New Driver Is Started Here================================================*/
			parentlogger.log(LogStatus.INFO, "The Functional Utility :" +" " +"RMA_GenericDelete_Utility Is Called To Delete A Driver :" +" "+ color.RMA_ChangeColor_Utility(StrDriverLastNameChanged_287, 2));
			testcall2 = true;
			RMA_Functionality_Utility.RMA_GenericDelete_Utility("PI Driver Page", logval1);
			parentlogger.log(LogStatus.INFO, "Driver Is Deleted Successfully With Name::"+ " " + color.RMA_ChangeColor_Utility(StrDriverLastNameChanged_287, 2));
