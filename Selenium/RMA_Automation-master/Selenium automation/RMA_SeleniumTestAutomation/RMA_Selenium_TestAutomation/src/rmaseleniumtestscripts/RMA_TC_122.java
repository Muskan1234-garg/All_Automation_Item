...
//================================================================================================
//TestCaseID     : RMA_TC_122
//Description    : TC_122_Verify Adding,Editing And Deleting Of Existing Other Person As Person Involved In Litigation For Property Claim
//Depends On TC  : RMA_TC_118
//Revision       : 0.0 - KumudNaithani-06-21-2016 
//=================================================================================================

public class RMA_TC_122 extends RMA_TC_BaseTest {
	...
	@Test
	public void RMA_TC_122_Test() throws Exception,Error {

		try{
			parentlogger = reports.startTest("TC_122_Adding, Editing And Deleting Of An Existing Other Person", "Verify Adding,Editing And Deleting Of An Existing Other Person As Person Involved In Litigation For Property Claim");
			parentlogger.assignAuthor("Kumud Naithani");

			String StrOtherPersonLastName_122;
			String StrPrimaryWindowHandle;
			String StrOtherPersonLastNameActual_122;
			String OtherPersonLastNameChanged;

			//Local Variable Declaration Completed Here

			StrScreenShotTCName = "TC_122";
			testcall1 = false;	
			testcall2 = false;	
			...
			testcall1 = true;
			StrOtherPersonLastName_122 = RMA_Functionality_Utility.RMA_MaintEntityAddition_Utility("OtherPeople", logval1);
			parentlogger.log(LogStatus.INFO, "Other Person Is Created Successfully With Name::"+ " " + color.RMA_ChangeColor_Utility(StrOtherPersonLastName_122, 2));
			...
			driver.switchTo().parentFrame();
			RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_Home.RMAApp_LeftHandNavTree_Img_ExpandCollapse(driver, "Property"), "Expand Image Corresponding To Property Claim Link On Left Navigation Tree", logval);
			...
			RMA_Input_Utility.RMA_SetValue_Utility(RMA_POM_Search.RMAApp_SearchEntity_Txt_LastName(driver), "Last Name TextBox On Standard Entity Search Page", StrOtherPersonLastName_122, logval);
			...
			driver.switchTo().frame(RMA_GenericUsages_Utility.RMA_FrameNavigation("piother"));
			RMA_GenericUsages_Utility.RMA_StaticWait(2, logval, "Wait Is Added As Switch To Frame Containing Persons Involved-->Other Person Screen Controls Is Done");
			StrOtherPersonLastNameActual_122 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrOtherPersonLastName_122, StrOtherPersonLastNameActual_122 , "Other Person Last Name", logval);
			...
			RMA_GenericUsages_Utility.RMA_StaticWait(2, logval, "Wait Is Added As Switch To Frame Containing Persons Involved-->Other Person Screen Controls Is Done");
			StrOtherPersonLastNameActual_122 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(OtherPersonLastNameChanged, StrOtherPersonLastNameActual_122 , "Other Person Last Name", logval);
