...
//================================================================================================
//TestCaseID     : RMA_TC_080
//Description    : TC_080_User Is Able To Select Multiple Reserves/Payment For Approval/Rejection And Proceed With Approve/Reject Functions Is Validated
...
//Revision       : 0.0 - KumudNaithani-03-03-2016 
...
public class RMA_TC_080 extends rmaseleniumtestscripts.RMA_TC_BaseTest {
	...
	@Test 
	public void RMA_TC_080_Test () throws Exception, Error 
	//Verify User Is Able To Select Multiple Reserves And Payment For Approval/Rejection And Proceed With Approve And Reject Functions
	{
		parentlogger = reports.startTest("TC_080_Approve And Reject Functionality For Reserves And Payments", "User Is Able To Select Multiple Reserves/Payment For Approval/Rejection And Proceed With Approve/Reject Functions Is Validated");
		...
		try {
			...
			int RMAApp_ReserveCreation_Txt_LitReserveAmount;
			String RMAApp_ReserveCreation_Lst_ExpStatus;
			String RMAApp_ReserveCreation_Lst_LitStatus;
			...
			String RMAApp_ReserveCreation_Lnk_LitReserveType;
			...
			String StrControlNumber_RMA_TC_080;
			String StrControlNumber_RMA_TC_01_080;
			String StrControlNumber_RMA_TC_02_080;
			String StrClaimNumber_RMA_TC_080;
			String Strlogstatement;
			String StExpErrorMessage;
			int ActualRowCount;
			...
			RMAApp_UserPrev_Lst_LOB = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_080", 1, 0); //Line Of Business Name Is Fetched From DataSheet RMA_TC_080
			RMAApp_UserPrev_Txt_LoginUser_MaxResAmt = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_TC_080", 1, 1); //Maximum Reserve Limit Amount For LoginUser Is Fetched From DataSheet RMA_TC_080
			RMAApp_UserPrev_Lst_ReserveType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_080", 1, 2); //Reserve Type For LoginUser Is Fetched From DataSheet RMA_TC_080
			RMAApp_UserPrev_Txt_LoginUser_MaxAmt = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_TC_080", 1, 3); //Max Payment Limit Amount For LoginUser Is Fetched From DataSheet RMA_TC_080
			RMAApp_UserPrev_Txt_LoginMgr1User_MaxResAmt = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_TC_080", 1, 4); //Maximum Reserve Limit For LoginMgr1 User Name Is Fetched From DataSheet RMA_TC_080
			RMAApp_UserPrev_Txt_LoginMgr1User_MaxAmt = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_TC_080", 1, 5); //Maximum Payment Limit For LoginMgr1 User Name Is Fetched From DataSheet RMA_TC_080
			RMAApp_ReserveCreation_Txt_MedReserveAmount = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_TC_080", 1, 6); //Reserve Amount Is Fetched From DataSheet RMA_TC_080
			RMAApp_ReserveCreation_Lst_MedStatus = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_080", 1, 7); //Reserve Status Is Fetched From DataSheet RMA_TC_080
			RMAApp_ReserveCreation_Lnk_MedReserveType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_080", 1, 8); //Reserve Type Is Fetched From DataSheet RMA_TC_080
			RMAApp_ReserveCreation_Txt_IndemReserveAmount = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_TC_080", 1, 9); //Reserve Amount Is Fetched From DataSheet RMA_TC_080
			RMAApp_ReserveCreation_Lst_IndemStatus = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_080", 1, 10); //Reserve Status Is Fetched From DataSheet RMA_TC_080
			RMAApp_ReserveCreation_Lnk_IndemReserveType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_080", 1, 11); //Reserve Type Is Fetched From DataSheet RMA_TC_080
			RMAApp_ReserveCreation_Txt_ExpReserveAmount = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_TC_080", 1, 12); //Reserve Amount Is Fetched From DataSheet RMA_TC_080
			RMAApp_ReserveCreation_Lst_ExpStatus = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_080", 1, 13); //Reserve Status Is Fetched From DataSheet RMA_TC_080
			RMAApp_ReserveCreation_Lnk_ExpReserveType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_080", 1, 14); //Reserve Type Is Fetched From DataSheet RMA_TC_080
			RMAApp_Payment_Lst_BankAccount = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_080", 1, 15); //Bank Account Is Fetched From DataSheet RMA_TC_080
			RMAApp_Payment_Lst_PayeeType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_080", 1, 16); // Payee Type Is Fetched From DataSheet RMA_TC_080
			RMAApp_FundsSplitDetails_Lst_TransactionType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_080", 1, 17); //Transaction Type Is Fetched From DataSheet RMA_TC_080
			RMAApp_FundsSplitDetails_Txt_Amount = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_TC_080", 1, 18); //Amount Is Fetched From DataSheet RMA_TC_080
			RMAApp_FundsSplitDetails_Txt_Amount_1 = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_TC_080", 1, 20); //Amount For Second Payment Is Fetched From DataSheet RMA_TC_080
			RMAApp_Payment_Txt_LastName = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_080", 1, 19); //LastName Is Fetched From DataSheet RMA_TC_080
			RMAApp_Payment_Txt_DistributionType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_080", 1, 21); //Distribution Type Is Fetched From DataSheet RMA_TC_080
			RMAApp_FundsSplitDetails_Txt_Amount_2 = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_TC_080", 1, 22); //Amount For Second Payment Is Fetched From DataSheet RMA_TC_080
			RMAApp_ReserveCreation_Txt_LitReserveAmount = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_TC_080", 1, 24); //Reserve Amount Is Fetched From DataSheet RMA_TC_080
			RMAApp_ReserveCreation_Lst_LitStatus = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_080", 1, 25); //Reserve Status Is Fetched From DataSheet RMA_TC_080
			RMAApp_ReserveCreation_Lnk_LitReserveType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_080", 1, 23); //Reserve Type Is Fetched From DataSheet RMA_TC_080
			...
			StrClaimNumber_RMA_TC_080 = generalclaim.GeneralClaimCreation(); //Claim Number Is Fetched And Stored In Variable StrClaimNumber_RMA_TC_080
			parentlogger.log(LogStatus.INFO, "New Claim Is Created With Claim Number::"+ " " + color.RMA_ChangeColor_Utility(StrClaimNumber_RMA_TC_080, 2));
			loggerval2 = logger.toString();
			parentlogger.appendChild(logger);
			// New Claim Is Created
			//===============================================General Claim Creation Is Completed================================================================================================================================================================================================================================================================================================================================================
			//===============================================Medical Reserve Creation (On Hold) Of Amount $200 Is Started======================================================================================================================================================================================================================================================================================================================================
			RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_Home.RMAApp_LeftHandNavTree_Img_ExpandCollapse(driver, StrClaimNumber_RMA_TC_080), "Expand Image Corresponding To Claim Link" +" "+StrClaimNumber_RMA_TC_080+" " +" On Left Navigation Tree", logval);
			RMA_GenericUsages_Utility.RMA_StaticWait(2,0,"Wait Is Added As Expand Image Corresponding To Claim Link" +" "+StrClaimNumber_RMA_TC_080+" " +" On Left Navigation Tree");			
			...
			parentlogger.appendChild(logger);
			driver.switchTo().parentFrame();
			//Medical Reserve Of Amount $200 Is Created And Its Going On Hold Is Verified
			//===============================================Medical Reserve Creation Of Amount $200 (On Hold) Is Completed=========================================================================================================================================================================================================================================================================================================================================
			...
			//===============================================Indemnity Reserve Creation Of Amount $200 (On Hold) Is Started=========================================================================================================================================================================================================================================================================================================================================
			...
			parentlogger.appendChild(logger);
			driver.switchTo().parentFrame();
			//Indemnity Reserve Of Amount $200 Is Created And Its Going On Hold Is Verified
			//===============================================Indemnity Reserve Creation Of Amount $200 (On Hold) Is Completed=========================================================================================================================================================================================================================================================================================================================================
			//===============================================Litigation Reserve Creation Of Amount $90 Is Started====================================================================================================================================================================================================================================================================================================================================================
			parentlogger.log(LogStatus.INFO, "Following Function Is Called :: RMA_ReserveAddition_Utility To Add Litigation Reserve");
			testcall5 = true;
			RMA_Functionality_Utility.RMA_ReserveAddition_Utility(RMAApp_ReserveCreation_Txt_LitReserveAmount, RMAApp_ReserveCreation_Lst_LitStatus, 1, RMAApp_ReserveCreation_Lnk_LitReserveType, "No", StrExpErrMessage, "Open", "Not Required", "Not Required");
			loggerval5 = logger.toString();
			parentlogger.appendChild(logger);
			//Litigation Reserve Of Amount $90 Is Created
			//===============================================Litigation Reserve Creation Of Amount $90 Is Completed=======================================================================================================================================================================================================================================================================================================================================================
			//===============================================Payment Creation Of Amount $30 (Going On Hold) Is Started=====================================================================================================================================================================================================================================================================================================================================================
			parentlogger.log(LogStatus.INFO, "Following Function Is Called :: RMA_PaymentAddition_Utility To Add Payment Of $30");
			testcall6 = true;
			StrControlNumber_RMA_TC_080 = RMA_Functionality_Utility.RMA_PaymentAddition_Utility(RMAApp_Payment_Lst_BankAccount, RMAApp_Payment_Lst_PayeeType, RMAApp_FundsSplitDetails_Lst_TransactionType, RMAApp_FundsSplitDetails_Txt_Amount, RMAApp_Payment_Txt_LastName, RMAApp_Payment_Txt_DistributionType, 1);
			parentlogger.log(LogStatus.INFO, "New Payment With Control Number::"+ " " + color.RMA_ChangeColor_Utility(StrControlNumber_RMA_TC_080, 2)+ " "+ "Is Done");
			...
			//===============================================Payment Creation Of Amount $30 (Going On Hold) Is Completed==============================================================================================================================================================================================================================================================================================================================================================
			//===============================================Payment Creation Of Amount $50 (Going On Hold) Is Started==============================================================================================================================================================================================================================================================================================================================================================

			parentlogger.log(LogStatus.INFO, "Following Function Is Called :: RMA_PaymentAddition_Utility To Add Payment Of $50");
			testcall7 = true;
			StrControlNumber_RMA_TC_01_080 = RMA_Functionality_Utility.RMA_PaymentAddition_Utility(RMAApp_Payment_Lst_BankAccount, RMAApp_Payment_Lst_PayeeType, RMAApp_FundsSplitDetails_Lst_TransactionType, RMAApp_FundsSplitDetails_Txt_Amount_1, RMAApp_Payment_Txt_LastName, RMAApp_Payment_Txt_DistributionType, 1);
			parentlogger.log(LogStatus.INFO, "New Payment With Control Number::"+ " " + color.RMA_ChangeColor_Utility(StrControlNumber_RMA_TC_01_080, 2)+ " "+ "Is Done");
			loggerval7 = logger.toString();
			parentlogger.appendChild(logger);
			//Payment Of Amount $50 Is Created

			RMA_Verification_Utility.RMA_ElementExist_Utility(RMA_Selenium_POM_Home.RMAApp_DefaultView_Err_StaticErrorText(driver), "RMA Application Error Message",0);
			RMA_Verification_Utility.RMA_ElementExist_Utility(RMA_Selenium_POM_PaymentsCollections.RMAApp_Payment_Err_SprApprovalHoldText(driver), "Payment On Hold Requires SuperVisory Approval Error Message",0);
			StrActualErrorMessage = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_PaymentsCollections.RMAApp_Payment_Err_SprApprovalHoldText(driver), "innerHTML");
			RMA_Verification_Utility.RMA_TextCompare(StrErrorMessageExpected, StrActualErrorMessage, "Correct Error Message Display",0);
			//Payment Of Amount $50 Going On Hold Is Verified
			RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_PaymentsCollections.RMAApp_Payment_Img_BackToFinancials(driver), "Back To Financial Image On Payment Creation Page",0);
			RMA_GenericUsages_Utility.RMA_StaticWait(3, 0, "Wait Is Added As Back To Financials Image Is Clicked");
			//===============================================Payment Creation Of Amount $50 (Going On Hold) Is Completed==============================================================================================================================================================================================================================================================================================================================================================
			//===============================================Payment Creation Of Amount $60 (Going On Hold) Is Started==============================================================================================================================================================================================================================================================================================================================================================
			
			parentlogger.log(LogStatus.INFO, "Following Function Is Called :: RMA_PaymentAddition_Utility To Add Payment Of $60");
			testcall8 = true;
			StrControlNumber_RMA_TC_02_080 = RMA_Functionality_Utility.RMA_PaymentAddition_Utility(RMAApp_Payment_Lst_BankAccount, RMAApp_Payment_Lst_PayeeType, RMAApp_FundsSplitDetails_Lst_TransactionType, RMAApp_FundsSplitDetails_Txt_Amount_2, RMAApp_Payment_Txt_LastName, RMAApp_Payment_Txt_DistributionType, 1);
			parentlogger.log(LogStatus.INFO, "New Payment With Control Number::"+ " " + color.RMA_ChangeColor_Utility(StrControlNumber_RMA_TC_02_080, 2)+ " "+ "Is Done");
			...
			//===============================================Payment Creation Of Amount $60 (Going On Hold) Is Completed=======================================================================================================================================================================================================================================================================================================================================================================
			...
			//===============================================Payment Of Amount $50 Approval Is Started=================================================================================================================================================================================================================================================================================================================================================================================
			...
			RMA_Input_Utility.RMA_SetValue_Utility(RMA_Selenium_POM_Funds_SprApproval.RMAApp_SprApproval_Txt_UXPymntGridFilterTxtBox(driver,2,"Control Number",2), "Control Number Filter TextBox On Payment Tab  On Supervisory Approval Page",  StrControlNumber_RMA_TC_01_080, logval);
			...
			Strlogstatement  = "Record With Control Number" + " " + StrControlNumber_RMA_TC_01_080 + " " + "In Payment Approval Grid On Supervisory Approval Page";
			RMA_Verification_Utility.RMA_VerifyUXGridSingleText_Utility(StrClaimNumber_RMA_TC_080, "Payment Approval Grid On Supervisory Approval Page", StrControlNumber_RMA_TC_01_080, 3, logval);
			parentlogger.log(LogStatus.INFO, parentlogger.addScreenCapture(RMA_ScreenCapture_Utility.RMA_ScreenShotCapture_Utility(driver, "Existence Of Control Number" + " " + StrControlNumber_RMA_TC_01_080 + " " + "For Payment OF $50 In Payment UX Grid On Supervisory Approval Page Verification", StrScreenShotTCName)));
			...
			{
				Strlogstatement  = "Payment with Control Number" + " " + StrControlNumber_RMA_TC_01_080 + " " + "Does Not Exist In Payment UXGrid On Supervisory Approval Page";
			...
			else
			{
				...
				RMA_GenericUsages_Utility.RMA_StaticWait(4, logval, "Wait Is Added As Control Number Value Is Set In Filter TextBox In Payment Tab On Supervisory Approval Page");
				//Payments Grid Is Filtered On The Basis Of The Provided Control Number
				RMA_Verification_Utility.RMA_VerifyRecordNotExistInUXGrid_Utility(StrControlNumber_RMA_TC_01_080, "Payment UXGrid On Supervisory Page", logval);
			}
			//===============================================Payment Of Amount $50 Approval Is Completed================================================================================================================================================================================================================================================================================================================================================================================
			//===============================================Payment Of Amount $60 Approval Is Started=================================================================================================================================================================================================================================================================================================================================================================================			
			
			RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_Funds_SprApproval.RMAApp_SprApproval_Txt_UXPymntGridFilterTxtBox(driver,2,"Control Number",2), "Control Number Filter TextBox On Payment Tab On Supervisory Approval Page", logval);
			RMA_Input_Utility.RMA_SetValue_Utility(RMA_Selenium_POM_Funds_SprApproval.RMAApp_SprApproval_Txt_UXPymntGridFilterTxtBox(driver,2,"Control Number",2), "Control Number Filter TextBox On Payment Tab  On Supervisory Approval Page",  StrControlNumber_RMA_TC_02_080, logval);
			RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_Funds_SprApproval.RMAApp_SprApproval_Txt_UXPymntGridFilterTxtBox(driver,2,"Split Amount",2), "Split Amount Filter TextBox On Payment Tab On Supervisory Approval Page", logval);
			RMA_GenericUsages_Utility.RMA_StaticWait(4, logval, "Wait Is Added As Control Number Value Is Set In Filter TextBox In Payment Tab On Supervisory Approval Page");
			//Payments Grid Is Filtered On The Basis Of The Provided Control Number
			
			Strlogstatement  = "Record With Control Number" + " " + StrControlNumber_RMA_TC_02_080 + " " + "In Payment UXGrid On Supervisory Approval Page";
			RMA_Verification_Utility.RMA_VerifyUXGridSingleText_Utility(StrClaimNumber_RMA_TC_080, "Payment UXGrid On Supervisory Approval Page", StrControlNumber_RMA_TC_02_080, 3, logval);
			parentlogger.log(LogStatus.INFO, parentlogger.addScreenCapture(RMA_ScreenCapture_Utility.RMA_ScreenShotCapture_Utility(driver, "Existence Of Control Number" + " " + StrControlNumber_RMA_TC_02_080 + " " + "For Payment OF $50 In Funds Approval Table Verification", StrScreenShotTCName)));
			//Record With Provided Control Number Exists Is Verified As Only Existing Record Can Be Processed Further
			...
			StrControlNumberExpected = StrControlNumber_RMA_TC_02_080;
			...
			//===============================================Payment Of Amount $60 Approval Is Completed==========================================================================================================================================================================================================================================================================================================================================================================================================================================			
			//===============================================Payment Of Amount $30 Approval Is Started============================================================================================================================================================================================================================================================================================================================================================================================================================================			
			
			RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_Funds_SprApproval.RMAApp_SprApproval_Txt_UXPymntGridFilterTxtBox(driver,2,"Control Number",2), "Control Number Filter TextBox On Payment Tab On Supervisory Approval Page", logval);
			RMA_Input_Utility.RMA_SetValue_Utility(RMA_Selenium_POM_Funds_SprApproval.RMAApp_SprApproval_Txt_UXPymntGridFilterTxtBox(driver,2,"Control Number",2), "Control Number Filter TextBox On Payment Tab  On Supervisory Approval Page",  StrControlNumber_RMA_TC_080, logval);
			RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_Funds_SprApproval.RMAApp_SprApproval_Txt_UXPymntGridFilterTxtBox(driver,2,"Split Amount",2), "Split Amount Filter TextBox On Payment Tab On Supervisory Approval Page", logval);
			RMA_GenericUsages_Utility.RMA_StaticWait(4, logval, "Wait Is Added As Control Number Value Is Set In Filter TextBox In Payment Tab On Supervisory Approval Page");
			//Payments Grid Is Filtered On The Basis Of The Provided Control Number
			
			Strlogstatement  = "Record With Control Number" + " " + StrControlNumber_RMA_TC_080 + " " + "In Payment UXGrid On Supervisory Approval Page";
			RMA_Verification_Utility.RMA_VerifyUXGridSingleText_Utility(StrClaimNumber_RMA_TC_080, "Payment UXGrid On Supervisory Approval Page", StrControlNumber_RMA_TC_080, 3, logval);
			parentlogger.log(LogStatus.INFO, parentlogger.addScreenCapture(RMA_ScreenCapture_Utility.RMA_ScreenShotCapture_Utility(driver, "Existence Of Control Number" + " " + StrControlNumber_RMA_TC_080 + " " + "For Payment OF $30 In Payment UXGrid On Supervisory Approval Page Verification", StrScreenShotTCName)));
			//Record With Provided Control Number Exists Is Verified As Only Existing Record Can Be Processed Further
			...
			if (RMA_Selenium_POM_Funds_SprApproval.RMAApp_SprApproval_PaymntNoRecordsAvailable(driver).isDisplayed() )
			{
				Strlogstatement  = "Payment with Control Number" + " " + StrControlNumber_RMA_TC_080 + " " + "Does Not Exist In Payment UXGrid On Supervisory Approval Page";
				parentlogger.log(LogStatus.INFO, Strlogstatement);
			}
			else
			{
				...
				RMA_GenericUsages_Utility.RMA_StaticWait(4, logval, "Wait Is Added As Control Number Value Is Set In Filter TextBox In Payment Tab On Supervisory Approval Page");
				//Payments Grid Is Filtered On The Basis Of The Provided Control Number
				RMA_Verification_Utility.RMA_VerifyRecordNotExistInUXGrid_Utility(StrControlNumber_RMA_TC_080, "Payment UXGrid On Supervisory Page", logval);
			}
			//===============================================Payment Of Amount $30 Approval Is Started===================================================================================================================================================================================================================================================================================================================================================================================================================================================			
			...
			RMA_Input_Utility.RMA_SetValue_Utility(RMA_Selenium_POM_Funds_SprApproval.RMAApp_SprApproval_Txt_UXRsvPymntGridFilterTxtBox(driver, 1), "Claim Number Filter TextBox On Reserve Tab  On Supervisory Approval Page", StrClaimNumber_RMA_TC_080, logval);
			...
			RMA_Input_Utility.RMA_SetValue_Utility(RMA_Selenium_POM_Funds_SprApproval.RMAApp_SprApproval_Txt_UXRsvPymntGridFilterTxtBox(driver, 3), "Reserve Type Filter TextBox On Reserve Tab  On Supervisory Approval Page", "Indemnity", logval);
			...
			Strlogstatement  = "Indenmity Reserve With Claim Number" + " " + StrClaimNumber_RMA_TC_080 + " " + "In Reserve Approval UX Grid On Supervisory Approval Page";
			//RMA_Verification_Utility.RMA_VerifyUXGridSingleText_Utility(StrClaimNumber_RMA_TC_080, "Reserves Grid In Supervisory Approval Page", "I Indemnity", 3, logval);
			parentlogger.log(LogStatus.INFO, parentlogger.addScreenCapture(RMA_ScreenCapture_Utility.RMA_ScreenShotCapture_Utility(driver, "Existence Of Indemnity Reserve For Claim" + " " + StrClaimNumber_RMA_TC_080 + " " + "Of Amount $200 In Reserve Approval UX Grid On Supervisory Approval Page Verification", StrScreenShotTCName)));
			//Indemnity Reserve Of Amount $200 Exists Is Verified As Only Existing Record Can Be Processed Further
			...
			{
				Strlogstatement  = "Indemnity Reserve Of Amount $200 With Claim Number" + " " + StrClaimNumber_RMA_TC_080 + " " + "Does Not Exist In Reserve UXGrid On Supervisory Approval Page";
				parentlogger.log(LogStatus.INFO, Strlogstatement);
			}
			else
			{
			...
			//===============================================Indemnity Reserve Of Amount $200 Approval Is Completed=======================================================================================================================================================================================================================================================================================================================================================================================================================================================			
			//===============================================Expense Reserve Of Amount $150 Approval Is Started=======================================================================================================================================================================================================================================================================================================================================================================================================================================================			
			...
			Strlogstatement  = "Expense Reserve With Claim Number" + " " + StrClaimNumber_RMA_TC_080 + " " + "In Reserve Approval UX Grid On Supervisory Approval Page";
			//RMA_Verification_Utility.RMA_VerifyUXGridSingleText_Utility(StrClaimNumber_RMA_TC_080, "Reserves Grid In Supervisory Approval Page", "E Expense", 3, logval);
			parentlogger.log(LogStatus.INFO, parentlogger.addScreenCapture(RMA_ScreenCapture_Utility.RMA_ScreenShotCapture_Utility(driver, "Existence Of Expense Reserve For Claim" + " " + StrClaimNumber_RMA_TC_080 + " " + "Of Amount $150 In Funds Reserve Approval Table Verification", StrScreenShotTCName)));
			//Indemnity Reserve Of Amount $200 Exists Is Verified As Only Existing Record Can Be Processed Further
			...
			if (RMA_Selenium_POM_Funds_SprApproval.RMAApp_SprApproval_ReserveNoRecordsAvailable(driver).isDisplayed() )
			{
				Strlogstatement  = "Expense Reserve Of Amount $150 With Claim Number" + " " + StrClaimNumber_RMA_TC_080 + " " + "Does Not Exist In Reserve UXGrid On Supervisory Approval Page";
				parentlogger.log(LogStatus.INFO, Strlogstatement);
			}
			else
			{
			...
			//===============================================Expense Reserve Of Amount $150 Approval Is Completed=======================================================================================================================================================================================================================================================================================================================================================================================================================================================					
			//===============================================Medical Reserve Of Amount $250 Approval Is Started=======================================================================================================================================================================================================================================================================================================================================================================================================================================================			
			...
			Strlogstatement  = "Medical Reserve With Claim Number" + " " + StrClaimNumber_RMA_TC_080 + " " + "In Reserve Approval UX Grid On Supervisory Approval Page";
			//RMA_Verification_Utility.RMA_VerifyUXGridSingleText_Utility(StrClaimNumber_RMA_TC_080, "Reserves Grid In Supervisory Approval Page", "M Medical", 3, logval);
			parentlogger.log(LogStatus.INFO, parentlogger.addScreenCapture(RMA_ScreenCapture_Utility.RMA_ScreenShotCapture_Utility(driver, "Existence Of Medical Reserve For Claim" + " " + StrClaimNumber_RMA_TC_080 + " " + "Of Amount $250 In Reserve UXGrid On Supervisory Approval Page Verification", StrScreenShotTCName)));
			//Medical Reserve Of Amount $250 Exists Is Verified As Only Existing Record Can Be Processed Further
			...
			RMA_Verification_Utility.RMA_ElementExist_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_ToastMessage(driver), "Payment Requires Supervisory Approval Message", logval);
			StrActualErrorMessage = RMA_Selenium_POM_Home.RMAApp_Generic_ToastMessage(driver).getText();
			StExpErrorMessage = "Amount exceeds user's reserve limit";
			RMA_Verification_Utility.RMA_PartialTextVerification(StExpErrorMessage, StrActualErrorMessage, "Correct Error Message Display When Hold Reserve Is Not Approved by Manager", 0);
			StExpErrorMessage = "Medical";
			RMA_Verification_Utility.RMA_PartialTextVerification(StExpErrorMessage, StrActualErrorMessage, "Correct Error Message Display When Hold Reserve Is Not Approved by Manager", 0);
			parentlogger.log(LogStatus.INFO, parentlogger.addScreenCapture(RMA_ScreenCapture_Utility.RMA_ScreenShotCapture_Utility(driver, "EMedical Reserve For Claim" + " " + StrClaimNumber_RMA_TC_080 + " " + "Not Getting Approved By Manager Verification", StrScreenShotTCName)));
			//===============================================Medical Reserve Of Amount $250 Approval Is Started=======================================================================================================================================================================================================================================================================================================================================================================================================================================================			
			...
			RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_UserPrivilegesSetUp.RMAApp_UserPrevReserve_Btn_Remove(driver), "Remove Button For Reserve Limits", 0);
			RMA_GenericUsages_Utility.RMA_StaticWait(4, 0, "Wait Is Added As Reserve Limit Max Amount For"+ " " + StrConLoginMgr1FirstAndLastName+ "Is Removed");
			RMA_Verification_Utility.RMA_RowColCountVerify_Utility(RMA_Selenium_POM_UserPrivilegesSetUp.RMAApp_UserPrevReserve_Tbl_ReserveLimitsGrid(driver), 0, ActualRowCount-1, true, false, "Reserve Limits Grid Table" , 0);
			...
			RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_UserPrivilegesSetUp.RMAApp_UserPrevPymntLimit_Rdb_PaymentLimitsGridRadioButton(driver), "RadioButton Corresponding to Text" + " " + StrConLoginUserFirstAndLastName, 0);
			RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_UserPrivilegesSetUp.RMAApp_UserPrevPymntLimit_Btn_Remove(driver), "Remove Button For Payment Limits", 0);
			RMA_GenericUsages_Utility.RMA_StaticWait(4, 0, "Wait Is Added As Payment Limit Max Amount For User" + " " + StrConLoginUserFirstAndLastName + "Is Removed");
			RMA_Verification_Utility.RMA_RowColCountVerify_Utility(RMA_Selenium_POM_UserPrivilegesSetUp.RMAApp_UserPrevPymntLimit_Tbl_PaymentLimitsGrid(driver), 0, ActualRowCount-1, true, false, "Payment Limits Grid Table" , 0);
			...
			RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_UserPrivilegesSetUp.RMAApp_UserPrevPymntLimit_Btn_Remove(driver), "Remove Button For Payment Limits", 0);
			RMA_GenericUsages_Utility.RMA_StaticWait(4, 0, "Wait Is Added As Payment Limit Max Amount For User" + StrConLoginMgr1FirstAndLastName + "Is Removed");
			RMA_Verification_Utility.RMA_RowColCountVerify_Utility(RMA_Selenium_POM_UserPrivilegesSetUp.RMAApp_UserPrevPymntLimit_Tbl_PaymentLimitsGrid(driver), 0, ActualRowCount-1, true, false, "Payment Limits Grid Table" , 0);
