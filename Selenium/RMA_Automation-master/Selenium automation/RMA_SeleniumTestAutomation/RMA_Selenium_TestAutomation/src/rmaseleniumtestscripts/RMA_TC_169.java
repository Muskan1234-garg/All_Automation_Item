...
//================================================================================================
//TestCaseID     : RMA_TC_169
//Description    : TC_169_Verify Adding,Editing And Deleting Of Existing Driver As Person Involved on Property Claim
//Depends On TC  : RMA_TC_166
//Revision       : 0.0 - RenuVerma-07-05-2016 
//=================================================================================================

public class RMA_TC_169 extends RMA_TC_BaseTest {
	...
	@Test
	public void RMA_TC_169_Test() throws Exception,Error {

		try{
			parentlogger = reports.startTest("TC_169_Adding, Editing And Deleting Of An Existing Driver On Property Claim", "Verify Adding,Editing And Deleting Of An Existing Driver As Person Involved On Property Claim");
			parentlogger.assignAuthor("Renu Verma");

			String StrDriverLastName_169;
			String StrPrimaryWindowHandle;
			String StrDriverLastNameActual_169;
			String StrDriverLastNameChanged_169;
			String StrDriverLastNameChanged_Actual_169;
			String StrClaimNaumberActual;
			//Local Variable Declaration Completed Here

			
			StrScreenShotTCName = "TC_169";
			testcall1 = false;	
			testcall2 = false;	
			...
			testcall1 = true;
			StrDriverLastName_169 = RMA_Functionality_Utility.RMA_MaintEntityAddition_Utility("Driver", logval1);
			parentlogger.log(LogStatus.INFO, "New Driver Is Created Successfully With Name::"+ " " + color.RMA_ChangeColor_Utility(StrDriverLastName_169, 2));
			...
			//===============================================Addition Of Driver Employee On Claim Created in TC_166 Is Started Here=====================================================================================================
			...
			RMA_Functionality_Utility.RMA_StandardSearch_Window(RMA_POM_Search.RMAApp_SearchDriver_Txt_DriverLastName(driver), "Claim-->PI-->Search-->Existing Driver Criteria Page","Driver Last Name Text Box",StrDriverLastName_169,StrDriverLastName_169, "pidriver",StrPrimaryWindowHandle, logval);
			RMA_Functionality_Utility.RMA_GenericSave_Utility("pidriver",false,"NA","Persons Involved-->Driver Page", logval);
			StrDriverLastNameActual_169 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrDriverLastName_169, StrDriverLastNameActual_169 , "Driver Last Name", logval);
			...
			/*====================================================Addition Of Existing Driver On Claim Created in TC_166 Is Completed Here=======================================*/

			/*===============================================Editing Of An Existing Driver Is Started Here================================*/
			StrDriverLastNameChanged_169 = RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(4, "Driver_169_");
			RMA_Input_Utility.RMA_SetValue_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "LastName TextBox On PI Driver Page ", StrDriverLastNameChanged_169, logval);
			RMA_Functionality_Utility.RMA_GenericSave_Utility("pidriver",false,"NA","Persons Involved-->Driver Page", logval);
			StrDriverLastNameChanged_Actual_169 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrDriverLastNameChanged_169, StrDriverLastNameChanged_Actual_169 , "Driver Last Name", logval);
			...
			parentlogger.log(LogStatus.INFO, "The Functional Utility :" +" " +"RMA_GenericDelete_Utility Is Called To Delete A Driver :" +" "+ color.RMA_ChangeColor_Utility(StrDriverLastNameChanged_169, 2));
			testcall2 = true;
			RMA_Functionality_Utility.RMA_GenericDelete_Utility("PI Driver Page", logval1);
			parentlogger.log(LogStatus.INFO, "Driver Is Deleted Successfully With Name::"+ " " + color.RMA_ChangeColor_Utility(StrDriverLastNameChanged_169, 2));
