...
//================================================================================================
//TestCaseID     : RMA_TC_053
//Description    : Listing Of Hold Transaction Created In RMA_TC_052 In Pending Transaction's Submitted Column Under Current Adjuster's Hierarchy Is Validated. 
//Depends On TC  : TC_064, TC_051, TC_052
//Revision       : 0.0 - KumudNaithani-02-02-2016
//Revision       : 0.1 - ImteyazAhmad-08-10-2016
//=================================================================================================
public class RMA_TC_053 extends rmaseleniumtestscripts.RMA_TC_BaseTest {
	...
	@Test 
	public void RMA_TC_053_Test () throws Exception, Error 
	//Verify Transaction Is Listed In My Pending Transactions And In Submitted To Column,User Should Be Current Adjuster
	{
		try {
			logger = reports.startTest("TC_053_Listing Of Hold Transaction In Submitted Pending Transactions", "Listing Of Hold Transaction In Submitted Pending Transactions Under Current Adjuster's Hierarchy Validated");

			String StrExpSubmittedVal;
			//Local Variable Declaration

			StrExpSubmittedVal = "curradj";
			StrScreenShotTCName = "TC_053";
...
//			RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_Funds_SprApproval.RMAApp_SprApproval_Img_aSelectedView2(driver), "Selected View Image On The Supervisory Approval Page", logval1);
			...
			RMA_Input_Utility.RMA_ActionSetValue_Utility(RMA_Selenium_POM_Funds_SprApproval.RMAApp_SprApproval_Txt_UXPymntGridFilterTxtBox(driver, 2, "Control Number", 2), "Control Number Filter TextBox On Payment Tab Of Pending View On Supervisory Approval Page", RMA_TC_052.StrControlNumber_RMA_TC_052, logval1);
			...
			RMA_Verification_Utility.RMA_VerifyUXGridSingleText_Utility(RMA_TC_052.StrControlNumber_RMA_TC_052, "Pending Payments Grid In Supervisory Approval Page", StrExpSubmittedVal, 7, logval1);
			RMA_Input_Utility.RMA_ActionSetValue_Utility(RMA_Selenium_POM_Funds_SprApproval.RMAApp_SprApproval_Txt_UXPymntGridFilterTxtBox(driver, 2, "Control Number", 2), "Control Number Filter TextBox On Payment Tab Of Pending View On Supervisory Approval Page", RMA_TC_052.StrControlNumber_RMA_TC_01_052, logval1);
			RMA_GenericUsages_Utility.RMA_StaticWait(8,1, "Wait Is Added As Control Number Value Is Set In Filter TextBox In Payment Tab Of Pending View On Supervisory Approval Page");
			RMA_Navigation_Utility.RMA_ObjectActionsClick(RMA_Selenium_POM_Funds_SprApproval.RMAApp_SprApproval_Txt_UXRsvPymntGridFilterTxtBox(driver, 4), "Filter Text Box", logval1);
			RMA_Verification_Utility.RMA_VerifyUXGridSingleText_Utility(RMA_TC_052.StrControlNumber_RMA_TC_01_052, "Pending Payments Grid In Supervisory Approval Page", StrExpSubmittedVal, 7, logval1);
