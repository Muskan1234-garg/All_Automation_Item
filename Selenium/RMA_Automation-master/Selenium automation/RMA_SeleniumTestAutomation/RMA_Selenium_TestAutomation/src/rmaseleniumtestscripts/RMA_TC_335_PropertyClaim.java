...
//====================================================================================================================================
//TestCaseID     : RMA_TC_335_PropertyClaim
//Description    : Successful Creation, Edit And Deletion Of Enhanced Notes For An Already Created Property Claim Is Validated
//Depends On TC  : None
//Revision       : 0.0 - KumudNaithani-02-27-2017
//=======================================================================================================================================

public class RMA_TC_335_PropertyClaim extends RMA_TC_BaseTest {	
...
@Test 
public void RMA_TC_335_PropertyClaim_Test() throws Exception, Error
{
...
try
	{
	 parentlogger = reports.startTest("RMA_TC_335_Creation, Edit And Deletion Of Enhanced Notes For Property Claim", "Successful Creation, Edit And Deletion Of Enhanced Notes For An Already Created Property Claim Is Validated");
	 ...
	 StrScreenShotTCName = "RMA_TC_335_PropertyClaim";
	 Edit = true;
	 //Variable Initialization Completed

	//===========================================================New Property Claim Creation Is Started Here=====================================================================================================================================================================================================================================================================================================================================
	 parentlogger.log(LogStatus.INFO, "Following Test Is Called To Create A PropertyClaim:: "+RMA_GenericUsages_Utility.RMA_LoggerHyperlink("RMASmokeTC002Prop", "RMA_Smoke_TC_002_Prop",0));
     testcall1 = true;
     RMA_Smoke_TC_002_Prop propertyclaim = new RMA_Smoke_TC_002_Prop();
     StrClaimNumber_335 = propertyclaim.RMA_Smoke_TC_002_Prop_Test();  //Created Property Claim Number Is Stored In Variable StrClaimNumber_335
     loggerval1 = logger.toString();
     parentlogger.log(LogStatus.INFO, "A New Property Claim Is Created With Claim Number:: "+ color.RMA_ChangeColor_Utility(StrClaimNumber_335, 2));
     parentlogger.appendChild(logger);
 	//===========================================================New Property Claim Creation Is Completed Here==================================================================================================================================================================================================================================================================================================================================
	
	//===========================================================Steps To Create And Edit Progress Notes Started Here==================================================================================================================================================================================================================================================================================================================================================
    StrPrimaryWindowHandle = driver.getWindowHandle();
	RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_Home.RMAApp_Generic_Img_EnhancedNotes(driver), "Enhanced Notes Image On Property Claim :"+" "+StrClaimNumber_335, logval); // Claim ID Is Same For All Line Of Business
	...
	//===========================================================Steps To Delete Progress Notes Completed Here============================================================================================================================================================================================================================================================	
	 ...
	 {
	 logger.log(LogStatus.FAIL, "Following Error Occurred  ::" + " "+  color.RMA_ChangeColor_Utility(FinalErrorMessage,1)+ " " + "While Executing Child Test Case" +" "+ "RMA_Smoke_TC_002_Prop" + " " +  "For Property Claim Creation And Hence The Test Case Is A Fail");
	 parentlogger.appendChild(logger);
	 }
