...
//=============================================================================================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_TC_038
//Description    : Transaction Created In RMA_TC_036 Is Not Listed In Current Adjustor's List Is Validated
//Depends On TC  : TC_011, TC_035, TC_036
//Revision       : 0.0 - KumudNaithani-19-01-2016
...
public class RMA_TC_038 extends rmaseleniumtestscripts.RMA_TC_BaseTest {
...
//Transaction Created In RMA_TC_036 Is Not Listed In Current Adjustor's List Is Validated
{
	try {
		parentlogger = reports.startTest("TC_038_Transaction Not Listed In Current Adjustor's List", "Transaction Created In RMA_TC_036 Is Not Listed In Current Adjustor's List Is Validated");
		String StrAccept;
		...
		RMAApp_Login_Txt_UserName = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_038", 1, 0); //UserName Fetched From DataSheet RMA_TC_038
		RMAApp_Login_Txt_Password = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_038", 1, 1); //Password Fetched From DataSheet RMA_TC_038
		...
		//===============================================Non Existence Of Payment Created In TC_036 In SuperVisory Approval Page Validation Is Started==========================================================================================================================================================================================================================================================================
		...
		//===============================================Non Existence Of Payment Created In TC_036 In SuperVisory Approval Page Validation Is Completed=========================================================================================================================================================================================================================================================================
