...
//================================================================================================
//TestCaseID     : RMA_TC_051
//Description    : Chain Of Current Adjuster With Notify Immediate User Functionality Settings In Payment Parameter Set-Up Is Validated
//Depends On TC  : None
//Revision       : 0.0 - KumudNaithani-29-01-2016
//               : 0.1 - ImteyazAhmad-08-09-2016 
//=================================================================================================
public class RMA_TC_051 extends rmaseleniumtestscripts.RMA_TC_BaseTest {
...
@Test 
public void RMA_TC_051_Test () throws Exception, Error 
//Verify That Chain Of Current Adjuster With Notify Immediate User Functionality Can Be  Chosen In Payment Parameter Set-Up
{
	try {
		logger = reports.startTest("TC_051_CurrAdjuster Chain With Notify Immediate User Setting", "Chain Of Current Adjuster With Notify Immediate User Functionality Setting In Payment Parameter Set-Up Is Validated");
		
		StrScreenShotTCName = "TC_051";
		...
		RMA_GenericUsages_Utility.RMA_StaticWait(2, 1, "Wait Is Added As SuperVisor Approval Configuration Tab Is Clicked");
		...
		RMA_Navigation_Utility.RMA_WebCheckBoxSelect_Utility(RMA_Selenium_POM_PaymentParameterSetUp.RMAApp_PmntSetUpSprVsr_Chk_UseCurrentAdjuster(driver), "check", "Use Current Adjuster SuperVisory Chain Check Box", "Payment Parameter Setup Page",1); //Use Current Adjuster SuperVisory Chain Check Box Is Checked on Payment Parameter Setup Page
