...
//================================================================================================
//TestCaseID     : RMA_TC_196
//Description    : TC_196_Verify Adding,Editing And Deleting Of Existing Physician As Person Involved For Non Occupational Claim
//Depends On TC  : RMA_TC_190
//Revision       : 0.0 - ImteyazAhmad-07-20-2016
//=================================================================================================

public class RMA_TC_196 extends RMA_TC_BaseTest {
	...
	@Test
	public void RMA_TC_196_Test() throws Exception,Error {

		try{
			parentlogger = reports.startTest("TC_196_Adding, Editing And Deleting Of An Existing Physician", "Verify Adding,Editing And Deleting Of An Existing Physician As Person Involved For Non Occupational Claim");
			parentlogger.assignAuthor("Imteyaz Ahmad");

			String StrPhysicianLastName_196;
			String StrPrimaryWindowHandle;
			String StrPhysicianLastNameActual_196;
			...
			testcall1 = true;
			StrPhysicianLastName_196 = RMA_Functionality_Utility.RMA_MaintEntityAddition_Utility("Physician", logval1);
			parentlogger.log(LogStatus.INFO, "New Physician Is Created Successfully With Name::"+ " " + color.RMA_ChangeColor_Utility(StrPhysicianLastName_196, 2));
			...
			RMA_Functionality_Utility.RMA_StandardSearch_Window(RMA_POM_Search.RMAApp_SearchPhysician_Txt_LastName(driver), "Standard Physician Search Page", "Physician Last Name TextBox", StrPhysicianLastName_196, StrPhysicianLastName_196, "piphysician", StrPrimaryWindowHandle, logval);
			RMA_Functionality_Utility.RMA_GenericSave_Utility("piphysician", false, "NA", "Save Image On PI Physician Page", logval);
			StrPhysicianLastNameActual_196 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrPhysicianLastName_196, StrPhysicianLastNameActual_196 , "Physician Last Name", logval);
			...
			RMA_Functionality_Utility.RMA_GenericSave_Utility("piphysician", false, "NA", "Save Image On PI Physician Page", logval);
			StrPhysicianLastNameActual_196 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrPhysicianLastNameChanged, StrPhysicianLastNameActual_196 , "Physician Last Name", logval);
