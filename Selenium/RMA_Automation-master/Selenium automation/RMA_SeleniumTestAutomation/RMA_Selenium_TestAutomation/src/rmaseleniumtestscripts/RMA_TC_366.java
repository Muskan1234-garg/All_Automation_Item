...
//====================================================================================================================================
//TestCaseID     : RMA_TC_366
//Description    : Creation, Edit And Deletion Of Enhanced Notes For Policy Attached With A Claim
//Depends On TC  : None
//Revision       : 0.0 - KumudNaithani-03-13-2017
//====================================================================================================================================
public class RMA_TC_366 extends RMA_TC_BaseTest {
...
@Test	
public void RMA_TC_366_Test() throws Exception, Error
{   
	try {	 	 
	 ...
	 parentlogger = reports.startTest("RMA_TC_366_Creation, Edit And Deletion Of Enhanced Notes For Policy Attached With A Claim", "Successful Creation, Edit And Deletion Of Enhanced Notes For Policy Attached With A Claim Is Validated");
	 parentlogger.assignAuthor("Kumud Naithani");		
	 testcall1 = false;
	 loggerval1 = "NotInitialized";	
	 testcall2 = false;
	 loggerval2 = "NotInitialized";	
	 StrScreenShotTCName = "RMA_TC_366";
	 Edit = true;
	
	//===========================================================Steps To Create And Edit Progress Notes Started Here==================================================================================================================================================================================================================================================================================================================================================
	RMA_GenericUsages_Utility.RMA_DynamicFrameSwitching(StrPolicyName_335);
	StrPrimaryWindowHandle = driver.getWindowHandle();
	RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_Home.RMAApp_Generic_Img_EnhancedNotes(driver), "Enhanced Notes Image For Policy"+ " "+ color.RMA_ChangeColor_Utility(StrPolicyName_335, 2) +" "+ "Associated With Claim:"+" "+color.RMA_ChangeColor_Utility(StrClaimNumber_335, 2), logval); // Claim ID Is Same For All Line Of Business
