...
//================================================================================================================
//TestCaseID     : RMA_TC_297
//Description    : RMA_TC_297_Attachment Add, Edit & Delete On CLAIM -> Person Involved-> Add New DRIVER screen
...
public class RMA_TC_297 extends RMA_TC_BaseTest {
	...
	static String StrDriverLastName;
	
@Test	
public void RMA_TC_297_Test() throws Exception, Error
  {   
	try {
		String StrPrimaryWindowHandle;
		
		parentlogger = reports.startTest("RMA_TC_297_Attachment Add, Edit & Delete On "+ " "+ color.RMA_ChangeColor_Utility("CLAIM -> Person Involved-> Add New DRIVER", 3) +" " +"Screen", "Verifying Attachment Add, Edit & Delete On CLAIM -> Person Involved-> Add New DRIVER screen");
		...
		parentlogger.log(LogStatus.INFO, "New Driver Is Created Successfully With Driver Last Name::"+ " " + color.RMA_ChangeColor_Utility(StrDriverLastName, 2) +" " + "for CLAIM Number:: "+ color.RMA_ChangeColor_Utility(StrClaimNumber_292, 2));
		...
		//++++++++++++++++++++++++++++++++++++++++  Step CLAIM -> Person Involved-> Add New DRIVER Finished Here ++++++++++++++++++++++++++++++++++++++++++++++++	
		
		//++++++++++++++++++++++++++++++++++++++++Attachment Add,edit,delete functionality on CLAIM -> Person Involved-> Add New DRIVER screen is started here ++++++++++++++++++++++++++++++++++++++++++++++++	
		 ...
		 parentlogger.log(LogStatus.INFO, "Following Function Is Called :: Attachment_Add_Edit_Email_Delete To Verify Attachment Add & Edit On CLAIM -> Person Involved-> Add New DRIVER screen");
		 testcall2 = true;
		 RMA_Functionality_Utility.RMA_Attachment_Add_Edit_Delete("Add_Edit", PhysicalPath, FileSize, false, logval1);
		 parentlogger.log(LogStatus.INFO, "Attachment Add & Edit Functionality is verified on CLAIM -> Person Involved-> Add New DRIVER screen for CLAIM Number:: "+ color.RMA_ChangeColor_Utility(StrClaimNumber_292, 2));
		 loggerval2 = logger.toString();
		 parentlogger.appendChild(logger);
	
	    //++++++++++++++++++++++++++++++++++++++++Attachment Add,edit,delete functionality on CLAIM -> Person Involved-> Add New DRIVER screen is finished here ++++++++++++++++++++++++++++++++++++++++++++++++	
		//++++++++++++++++++++++++++++++++++++++++Attachment delete functionality on CLAIM -> Person Involved-> Add New DRIVER screen is started here ++++++++++++++++++++++++++++++++++++++++++++++++	
	     
	     parentlogger.log(LogStatus.INFO, "Following Function Is Called :: Attachment_Add_Edit_Email_Delete To Verify Attachment Delete on CLAIM -> Person Involved-> Add New DRIVER screen");
	     testcall3 = true;
	     RMA_Functionality_Utility.RMA_Attachment_Add_Edit_Delete("Delete", PhysicalPath, FileSize, false, logval1);
	     parentlogger.log(LogStatus.INFO, "Attachment Delete Functionality is verified on CLAIM -> Person Involved-> Add New DRIVER screen for CLAIM Number:: "+ color.RMA_ChangeColor_Utility(StrClaimNumber_292, 2));
	     loggerval3 = logger.toString();
	     parentlogger.appendChild(logger);
	    
	     driver.close();
		 driver.switchTo().window(StrPrimaryWindowHandle);	
	//++++++++++++++++++++++++++++++++++++++++Attachment delete functionality on CLAIM -> Person Involved-> Add New DRIVER screen is finished here ++++++++++++++++++++++++++++++++++++++++++++++++			 
