...
//=============================================================================================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_TC_039
//Description    : Transaction Created In RMA_TC_036 Is Listed In Login Manager's List And On Approval Goes To His Manager Is Validated
...
public class RMA_TC_039 extends rmaseleniumtestscripts.RMA_TC_BaseTest {
...
@Test 
public void RMA_TC_039_Test () throws Exception, Error
//Transaction Created In RMA_TC_036 Is Listed In Login Manager's List And On Approval Goes To His Manager Is Validated
{
	try {
		parentlogger = reports.startTest("TC_039_Transaction Is Listed In Current Adjuster Manager's List", "Is Listed In Login Manager's List And On Approval Goes To His Manager Is Validated");
		String StrAccept;
		...
		RMAApp_Login_Txt_UserName = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_039", 1, 0); //UserName Fetched From DataSheet RMA_TC_039
		RMAApp_Login_Txt_Password = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_039", 1, 1); //Password Fetched From DataSheet RMA_TC_039
		...
		//StrControlNumberExpected = RMA_TC_036.StrControlNumber_RMA_TC_036;
