...
//================================================================================================
//TestCaseID     : RMA_TC_244
//Description    : TC_244_Verify Add,Edit And Delete Of New Physician As Person Involved on Vehicle Accident Claim
//Depends On TC  : RMA_TC_238
//Revision       : 0.0 - RenuVerma-07-27-2016 
//=================================================================================================

public class RMA_TC_244 extends rmaseleniumtestscripts.RMA_TC_BaseTest {
	...
	@Test 
	public void RMA_TC_244_Test () throws Exception, Error
	{
		parentlogger = reports.startTest("TC_244_Adding, Editing And Deleting Of New Physician As Person Involved", "Verify Add,Edit And Delete Of New Physician As Person Involved on Vehicle Accident Claim");
		parentlogger.assignAuthor("Renu Verma");
		try {
			String StrPhysicianLastName_244;
			String StrEditedPhysicianLastName_Actual_244;
			String StrEditedPhysicianLastName_244;
			...
			//===============================================Addition Of Physician On Claim Created in TC_238 Is Started Here=====================================================================================================
			...
			testcall1 = true;
			StrPhysicianLastName_244 = RMA_Functionality_Utility.RMA_PIAddNewEntity_Utility("Physician", logval1);
			parentlogger.log(LogStatus.INFO, "New Physician Is Created Successfully With Physician Name::"+ " " + color.RMA_ChangeColor_Utility(StrPhysicianLastName_244, 2));
			...
			//===============================================Addition Of Physician On Claim Created in TC_238 Is Completed Here =================================================================================================================================================
			
			//===============================================Steps To Edit The Physician Added As Persons Involved Started ======================================================================================================================================================
			StrEditedPhysicianLastName_244 = RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(4, "Physician_RMA_TC_244_");
			RMA_Input_Utility.RMA_SetValue_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "LastName TextBox On Persons Involved-->Physician Page", StrEditedPhysicianLastName_244, logval);
			RMA_Functionality_Utility.RMA_GenericSave_Utility("piphysician",false,"NA","Persons Involved-->Physician Page", logval);
			StrEditedPhysicianLastName_Actual_244 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrEditedPhysicianLastName_244, StrEditedPhysicianLastName_Actual_244 , "Physician Last Name Value",logval);
			...
			parentlogger.log(LogStatus.INFO, "Following Utility :" +" " +"RMA_GenericDelete_Utility Is Called To Delete The Physician"+ " "+ color.RMA_ChangeColor_Utility(StrEditedPhysicianLastName_Actual_244, 2) +" " +"Added As Persons Involved");
			testcall2 = true;
			RMA_Functionality_Utility.RMA_GenericDelete_Utility("Persons Involved-->Physician Page", logval1);
			parentlogger.log(LogStatus.INFO, "Physician Added As Persons Involved Is Deleted Successfully::"+ " " + color.RMA_ChangeColor_Utility(StrEditedPhysicianLastName_Actual_244, 2));
