...
//=================================================================================================================================
//TestCaseID     : RMA_TC_335_NonOccupationalClaim
//Description    : Successful Creation, Edit And Deletion Of Enhanced Notes For An Already Created Non Occupational Claim Is Validated
//Depends On TC  : None
//Revision       : 0.0 - KumudNaithani-02-27-2017
//=======================================================================================================================================

public class RMA_TC_335_NonOccupationalClaim extends RMA_TC_BaseTest {	
...
@Test 
public void RMA_TC_335_NonOccupationalClaim_Test() throws Exception,Error
{
...
try
	{
	 parentlogger = reports.startTest("RMA_TC_335_Creation, Edit And Deletion Of Enhanced Notes For Non Occupational Claim", "Successful Creation, Edit And Deletion Of Enhanced Notes For An Already Created Non Occupational Claim Is Validated");
	 ...
	 StrScreenShotTCName = "RMA_TC_335_NonOccupationalClaim";
	 Edit = true;
	...
	//===========================================================New Non Occupational Claim Creation Is Started Here====================================================================================================================================================================================================================================================================================================================================================
     ...
     StrClaimNumber_335 = nonoccupationalclaim.RMA_Smoke_TC_002_NonOcc_Test();  //Created Non Occupational Claim Number Is Stored In Variable StrClaimNumber_335
     loggerval1 = logger.toString();
     parentlogger.log(LogStatus.INFO, "A New Non Occupational Claim Is Created With Claim Number:: "+ color.RMA_ChangeColor_Utility(StrClaimNumber_335, 2));
     parentlogger.appendChild(logger);
 	//===========================================================New Non Occupational Claim Creation Is Completed Here=================================================================================================================================================================================================================================================================================================================================================
	
	//===========================================================Steps To Create And Edit Progress Notes Started Here==================================================================================================================================================================================================================================================================================================================================================
    StrPrimaryWindowHandle = driver.getWindowHandle();
	RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_Home.RMAApp_Generic_Img_EnhancedNotes(driver), "Enhanced Notes Image On Non Occupational Claim :"+" "+StrClaimNumber_335, logval); // Claim/Non Occupational Claim ID Is Same For All Line Of Business
	...
	parentlogger.log(LogStatus.INFO,  "Notes Exist With Text::"+ " " + color.RMA_ChangeColor_Utility(ProgressNotes, 2));
	parentlogger.appendChild(logger);
	...
	//===========================================================Steps To Delete Progress Notes Completed Here=================================================================================================================================================================================================================================================================================================================================================================
	 ...
	 {
	 logger.log(LogStatus.FAIL, "Following Error Occurred  ::" + " "+  color.RMA_ChangeColor_Utility(FinalErrorMessage,1)+ " " + "While Executing Child Test Case" +" "+ "RMA_Smoke_TC_002_NonOcc" + " " +  "For Non Occupational Claim Creation And Hence The Test Case Is A Fail");
	 parentlogger.appendChild(logger);
	 }
