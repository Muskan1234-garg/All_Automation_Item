...
//Description    : Verify Print Preview Functionality Working on Payment Screen Successfully
...
public class RMA_Smoke_TC_041 extends RMA_TC_BaseTest {
	...
	public void RMA_Smoke_TC_041_Test() throws Exception,Error {
		...
		try{
			parentlogger = reports.startTest("RMA_Smoke_TC_041_Print Preview On Payment Screen", "Verify Print Preview Functionality Working on Payment Screen Successfully");
			...
			StrScreenShotTCName = "Smoke_TC_041";
			testcall1 = false;	
			...
			//===========================================================Steps To Do Print Preview On Payment Screen Is Started Here============================================================================================================================================================================================================================================================
			...
			testcall1 = true;
			RMA_Functionality_Utility.RMA_PrintPreview_Utility(RMAApp_Login_Txt_Password ,"Open", String.valueOf(RMA_Smoke_TC_011.FundsSplitDetails_Txt_Amount_Smoke_TC_011), false, logval1);
			loggerval1 = logger.toString();
			parentlogger.log(LogStatus.INFO,  "Print Preview Fuctionality On Payment Screen Done Successfully For Control No:"+ " " + color.RMA_ChangeColor_Utility(RMA_Smoke_TC_011.StrControlNumber_RMA_Smoke_TC_011, 3));
			parentlogger.appendChild(logger);
			//===========================================================Steps To Do Print Preview On Payment Screen Is Completed Here============================================================================================================================================================================================================================================================
