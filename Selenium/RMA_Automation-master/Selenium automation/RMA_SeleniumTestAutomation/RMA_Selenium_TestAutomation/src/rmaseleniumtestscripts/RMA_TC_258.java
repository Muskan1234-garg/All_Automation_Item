...
//================================================================================================
//TestCaseID     : RMA_TC_258
//Description    : TC_258_Verify Add,Edit And Delete Of New Patient As Person Involved on Event
//Depends On TC  : RMA_TC_246
//Revision       : 0.0 - RenuVerma-07-27-2016 
//=================================================================================================

public class RMA_TC_258 extends rmaseleniumtestscripts.RMA_TC_BaseTest {
	...
	@Test 
	public void RMA_TC_258_Test () throws Exception, Error
	{
		parentlogger = reports.startTest("TC_258_Adding,Editing And Deleting Of New Patient As Person Involved", "Verify Add,Edit And Delete Of New Patient As Person Involved on Event");
		parentlogger.assignAuthor("Renu Verma");
		try {
			String StrPatientLastName_258;
			String StrEditedPatientLastName_Actual_258;
			String StrEditedPatientLastName_258;
			...
			testcall1 = true;
			StrPatientLastName_258 = RMA_Functionality_Utility.RMA_PIAddNewEntity_Utility("Patient", logval1);
			parentlogger.log(LogStatus.INFO, "New Patient Is Created Successfully With Patient Name::"+ " " + color.RMA_ChangeColor_Utility(StrPatientLastName_258, 2));
			...
			StrEditedPatientLastName_258 = RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(4, "Patient_258_");
			RMA_Input_Utility.RMA_SetValue_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "LastName TextBox On Persons Involved-->Patient Page", StrEditedPatientLastName_258, logval);
			RMA_Functionality_Utility.RMA_GenericSave_Utility("pipatient",false,"NA","Persons Involved-->Patient Page", logval);
			StrEditedPatientLastName_Actual_258 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrEditedPatientLastName_258, StrEditedPatientLastName_Actual_258 , "Patient Last Name Value",logval);
			...
			parentlogger.log(LogStatus.INFO, "Following Utility :" +" " +"RMA_GenericDelete_Utility Is Called To Delete The Patient"+ " "+ color.RMA_ChangeColor_Utility(StrEditedPatientLastName_Actual_258, 2) +" " +"Added As Persons Involved");
			testcall2 = true;
			RMA_Functionality_Utility.RMA_GenericDelete_Utility("Persons Involved-->Patient Page", logval1);
			parentlogger.log(LogStatus.INFO, "Patient Added As Persons Involved Is Deleted Successfully::"+ " " + color.RMA_ChangeColor_Utility(StrEditedPatientLastName_Actual_258, 2));
