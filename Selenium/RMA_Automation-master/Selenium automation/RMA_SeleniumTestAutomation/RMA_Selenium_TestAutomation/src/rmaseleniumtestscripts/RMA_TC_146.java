...
//================================================================================================
//TestCaseID     : RMA_TC_146
//Description    : TC_146_Verify Adding,Editing And Deleting Of new Driver As Person Involved In Litigation For Property Claim
//Depends On TC  : RMA_TC_141
//Revision       : 0.0 - RenuVerma-06-27-2016 
//=================================================================================================

public class RMA_TC_146 extends RMA_TC_BaseTest {
	...
	@Test
	public void RMA_TC_146_Test() throws Exception,Error {

		try{
			parentlogger = reports.startTest("TC_146_Adding, Editing And Deleting Of New Driver", "Verify Adding,Editing And Deleting Of New Driver As Person Involved In Litigation For Property Claim");
			parentlogger.assignAuthor("Renu Verma");

			String StrDriverNumber_146;
			String StrDriverLastNameActual_146;
			String StrDriverNameChanged;

			//Local Variable Declaration Completed Here

			
			StrScreenShotTCName = "TC_146";
			testcall1 = false;	
			testcall2 = false;	
			...
			parentlogger.log(LogStatus.INFO, "The Functional Utility :" +" " +"RMA_PIAddNewEntity_Utility Is Called To Create An Driver ");
			testcall1 = true;
			StrDriverNumber_146 = RMA_Functionality_Utility.RMA_PIAddNewEntity_Utility("Driver", logval1);
			parentlogger.log(LogStatus.INFO, "New Driver Is Created Successfully With Driver Number::"+ " " + color.RMA_ChangeColor_Utility(StrDriverNumber_146, 2));
		...
		/*===============================================Editing Of New Driver Is Started Here================================*/
			...
			RMA_GenericUsages_Utility.RMA_StaticWait(5, logval, "Wait Is Added As PI Driver Is Saved");
			...
			StrDriverLastNameActual_146 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrDriverNameChanged, StrDriverLastNameActual_146 , "DriverLast Name", logval);
			...
			parentlogger.log(LogStatus.INFO, "The Functional Utility :" +" " +"RMA_GenericDelete_Utility Is Called To Delete An Driver : " +" "+ color.RMA_ChangeColor_Utility(StrDriverNameChanged, 2));
			testcall2 = true;
			RMA_Functionality_Utility.RMA_GenericDelete_Utility("PI Driver Page", logval1);
			driver.switchTo().parentFrame();
			parentlogger.log(LogStatus.INFO, "Driver Is Deleted Successfully ::"+ " " + color.RMA_ChangeColor_Utility(StrDriverNameChanged, 2));
