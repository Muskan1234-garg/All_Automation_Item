...
//================================================================================================
//TestCaseID     : RMA_TC_058
//Description    : Transaction Created In RMA_TC_052 Is Listed In Current Adjuster Manager's List And On Approval Goes To His Manager Is Validated
//Depends On TC  : TC_064, TC_051, TC_052, TC_57
//Revision       : 0.0 - KumudNaithani-02-05-2016 
//Revision       : 0.1 - ImteyazAhmad-08-11-2016
//=================================================================================================

public class RMA_TC_058 extends rmaseleniumtestscripts.RMA_TC_BaseTest {
	...
	@Test 
	public void RMA_TC_058_Test () throws Exception, Error
	//Verify That Transaction Created In RMA_TC_052 Is Listed In Current Adjuster Manager's List And On Approval Goes To His Manager
	{
		try {
			parentlogger = reports.startTest("TC_058_Transaction Is Listed In Current Adjuster Manager's List", "Transaction Created In RMA_TC_052 Is Listed In Current Adjustor Manager's List And On Approval Goes To His Manager Is Validated");
			String StrAccept;
			...
			RMAApp_Login_Txt_UserName = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_058", 1, 0); //UserName Fetched From DataSheet RMA_TC_058
			RMAApp_Login_Txt_Password = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_058", 1, 1); //Password Fetched From DataSheet RMA_TC_058
			...
			parentlogger.log(LogStatus.INFO, logger.addScreenCapture(RMA_ScreenCapture_Utility.RMA_ScreenShotCapture_Utility(driver, "Error Message On Payment $2000 Approval By CurrAdjMgr1 Verification", StrScreenShotTCName)));
			...
			RMA_Verification_Utility.RMA_PartialTextVerification(StrErrorMessageExpected, StrActualErrorMessage, "Correct Error Message Display",0);
			RMA_Verification_Utility.RMA_PartialTextVerification(StrControlNumberExpected, StrActualErrorMessage, "Correct Control Number Display In Error Message",0);
			parentlogger.log(LogStatus.INFO, logger.addScreenCapture(RMA_ScreenCapture_Utility.RMA_ScreenShotCapture_Utility(driver, "Error Message On Payment $2500 Approval By CurrAdjMgr1 Verification", StrScreenShotTCName)));
