...
//================================================================================================
//TestCaseID     : RMA_TC_153
//Description    : TC_153_Verify Adding,Editing And Deleting Of New Driver As Person Involved In Litigation For Vehicle Accident Claim
//Depends On TC  : RMA_TC_150
//Revision       : 0.0 - KumudNaithani-06-30-2016 
//=================================================================================================

public class RMA_TC_153 extends RMA_TC_BaseTest {
	...
	@Test
	public void RMA_TC_153_Test() throws Exception,Error {

		try{
			parentlogger = reports.startTest("TC_153_Adding, Editing And Deleting Of New Driver", "Verify Adding,Editing And Deleting Of New Driver As Person Involved In Litigation For Vehicle Accident Claim");
			parentlogger.assignAuthor("Kumud Naithani");

			String StrDriverLastName_153;
			String StrDriverLastNameActual_153;
			String StrDriverLastNameChanged;

			StrScreenShotTCName = "TC_153";
			testcall1 = false;	
			testcall2 = false;	
			...
			RMA_Functionality_Utility.RMA_StandardSearch_Screen(RMA_POM_Search.RMAApp_SearchClaims_Txt_ClaimNumber(driver), "Claim Search Page", "Claim Number TextBox", RMA_TC_150.StrClaimNumber_RMA_TC_150, RMA_TC_150.StrClaimNumber_RMA_TC_150, "Vehicle Accident", "num", 2, logval);
			...
			testcall1 = true;
			StrDriverLastName_153 = RMA_Functionality_Utility.RMA_PIAddNewEntity_Utility("Driver", logval1);
			parentlogger.log(LogStatus.INFO, "New Driver Is Created Successfully With Driver Last Name::"+ " " + color.RMA_ChangeColor_Utility(StrDriverLastName_153, 2));
			loggerval1 = logger.toString();
			parentlogger.appendChild(logger);
			parentlogger.log(LogStatus.INFO, parentlogger.addScreenCapture(RMA_ScreenCapture_Utility.RMA_ScreenShotCapture_Utility(driver, "Creation Of New Driver Is Successful", StrScreenShotTCName)));
			//===============================================Steps To Create A New Driver Completed===================================================================================================================================================================================================================================
			
			/*===============================================Editing Of New Driver Is Started Here======================================================================================================================================================================================================================================*/
			StrDriverLastNameChanged = RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(4, "Driver_TC_153_");
			...
			StrDriverLastNameActual_153 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Maintenance.RMAApp_MaintDriver_Txt_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrDriverLastNameChanged, StrDriverLastNameActual_153 , "Driver Last Name", logval);
