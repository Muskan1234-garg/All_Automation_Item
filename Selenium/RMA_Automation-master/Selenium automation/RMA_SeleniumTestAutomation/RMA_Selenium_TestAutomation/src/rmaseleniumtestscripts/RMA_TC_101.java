...
//================================================================================================
//TestCaseID     : RMA_TC_101
//Description    : TC_101_Verify Add,Edit And Delete Of Existing Witness As Person Involved In Litigation For Workers Comp Claims
//Depends On TC  : RMA_TC_094
//Revision       : 0.0 - ImteyazAhmad-05-11-2016 
//=================================================================================================

public class RMA_TC_101 extends rmaseleniumtestscripts.RMA_TC_BaseTest {
	...
	@Test 
	public void RMA_TC_101_Test () throws Exception, Error
	{
		parentlogger = reports.startTest("TC_101_Adding, Editing And Deleting Of An Existing Witness", "Verify Adding,Editing And Deleting Of An Existing Witness As Person Involved In Litigation For Workers Comp Claim");
		...
		try {
			...
			String StrClaimNumber_TC_101;
			String DocketNumber_TC_101;
			String StrLitigationDocketNumActual_TC_101;
			...
			RMAApp_WorkersCompClaim_Txt_ClaimType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_101", 1, 0); // Claim Type Is Fetched From DataSheet RMA_TC_101
			RMAApp_WorkersCompClaim_Txt_EmployeeNo = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_TC_101", 1, 1);//Employee Number Is Fetched From DataSheet RMA_TC_101
			RMAApp_WorkersCompClaim_Txt_Department = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_101", 1, 2); // Department Is Fetched From DataSheet RMA_TC_101
			RMAApp_WorkersCompClaim_Txt_DateOfEvent = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_TC_101", 1, 3);//DateOfEvent Is Fetched From DataSheet RMA_TC_101
			RMAApp_WorkersCompClaim_Txt_TimeOfEvent = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_TC_101", 1, 4);//TimeOfEvent Is Fetched From DataSheet RMA_TC_101
			RMAApp_WorkersCompClaim_Txt_DateOfClaim = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_TC_101", 1, 5);//DateOfClaim Is Fetched From DataSheet RMA_TC_101
			RMAApp_WorkersCompClaim_Txt_TimeOfClaim = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_TC_101", 1, 6);//TimeOfClaim Is Fetched From DataSheet RMA_TC_101
			RMAApp_WorkersCompClaim_Txt_Jurisdiction = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_101", 1, 7); // Jurisdiction Is Fetched From DataSheet RMA_TC_101
			...
			testcall1 = true;
			StrClaimNumber_TC_101 = RMA_Functionality_Utility.RMA_WorkersCompClaimCreation(RMAApp_WorkersCompClaim_Txt_ClaimType, RMAApp_WorkersCompClaim_Txt_EmployeeNo, RMAApp_WorkersCompClaim_Txt_Department, RMAApp_WorkersCompClaim_Txt_DateOfEvent, RMAApp_WorkersCompClaim_Txt_TimeOfEvent, RMAApp_WorkersCompClaim_Txt_DateOfClaim, RMAApp_WorkersCompClaim_Txt_TimeOfClaim, RMAApp_WorkersCompClaim_Txt_Jurisdiction, logval1);
			parentlogger.log(LogStatus.INFO, "New Workers Comp Claim Is Created With Claim Number::"+ " " + color.RMA_ChangeColor_Utility(StrClaimNumber_TC_101, 2));
			...
			DocketNumber_TC_101 = String.valueOf("Lit_"+RMA_GenericUsages_Utility.RMA_RandomIntGeneration_Utility(1111, 9999));
			...
			RMA_Input_Utility.RMA_SetValue_Utility(RMA_Selenium_POM_Litigation.RMAApp_Litigation_Txt_DocketNumber(driver), "Docket Number Text Box On Litigation Page" , DocketNumber_TC_101, logval);
			...
			driver.switchTo().frame(RMA_GenericUsages_Utility.RMA_FrameNavigation("litigation"));
			RMA_GenericUsages_Utility.RMA_StaticWait(2, logval, "Wait Is Added As Switch To The Litigation Frame Is Done");
			StrLitigationDocketNumActual_TC_101 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Litigation.RMAApp_Litigation_Txt_DocketNumber(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(DocketNumber_TC_101, StrLitigationDocketNumActual_TC_101 , "Litigation Docket Number Value", logval);
			...
			driver.switchTo().parentFrame();
			RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_Home.RMAApp_LeftHandNavTree_Img_ExpandCollapse(driver, "Litigation ("+DocketNumber_TC_101+")"), "Expand Image For The Created Litigation On Left Hand Navigation Tree",logval);
			RMA_GenericUsages_Utility.RMA_StaticWait(3, logval, "Wait Is Added As Expand Image Corresponding To Litigation "+" "+DocketNumber_TC_101 +" "+"Is Clicked");
			RMA_Navigation_Utility.RMA_ObjectRightClick(RMA_Selenium_POM_Home.RMAApp_LeftHandNavTree_Lnk_LitPersonsInvolved(driver, "Litigation ("+DocketNumber_TC_101+")"), "Persons Involded Link Present Under Litigation Tree", logval);
			...
			RMA_Input_Utility.RMA_SetValue_Utility(RMA_POM_Search.RMAApp_SearchEntity_Txt_LastName(driver), "Last Name TextBox On Standard Entity Search Window", RMA_TC_094.StrWitnessLastNameActual, logval);
			...
			RMA_Verification_Utility.RMA_TextCompare(RMA_TC_094.StrWitnessLastNameActual, StrWitLastNameActual, "Witness Name", logval);
			...
			StrEditedWitLastName = RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(4, "Witness_TC_101_");
			driver.switchTo().frame(RMA_GenericUsages_Utility.RMA_FrameNavigation("piwitness"));
