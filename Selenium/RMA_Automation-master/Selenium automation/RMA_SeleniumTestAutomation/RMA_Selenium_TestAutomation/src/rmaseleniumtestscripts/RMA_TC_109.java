...
//================================================================================================
//TestCaseID     : RMA_TC_109
//Description    : TC_109_Verify Add,Edit And Delete Of Existing Witness As Person Involved In Litigation For Vehicle Accident Claims
//Depends On TC  : RMA_TC_102
//Revision       : 0.0 - KumudNaithani-05-17-2016 
//=================================================================================================

public class RMA_TC_109 extends rmaseleniumtestscripts.RMA_TC_BaseTest {
	...
	@Test 
	public void RMA_TC_109_Test () throws Exception, Error
	{
		parentlogger = reports.startTest("TC_109_Existing Witness As Person Involved", "Verify Add,Edit And Delete Of Existing Witness As Person Involved In Litigation For Vehicle Accident Claims");
		...
		try {
			...
			String StrClaimNumber_RMA_TC_109;
			String DocketNumber;
			int LitFrameIndex;
			String StrLitigation_RMA_TC_109;
			
			loggerval1 = "NotInitialized";
			testcall1 = false;
			loggerval2 = "NotInitialized";
			testcall2 = false;
			StrScreenShotTCName = "TC_109";
			...
			RMAApp_VehAccClaim_Txt_ClaimType   =   ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_109", 1, 0); // Claim Type Is Fetched From DataSheet RMA_TC_109
			RMAApp_VehAccClaim_Txt_Department  =  ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_109", 1, 1); // Department Is Fetched From DataSheet RMA_TC_109
			RMAApp_VehAccClaim_Txt_DateOfEvent = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_TC_109", 1, 2);//DateOfEvent Is Fetched From DataSheet RMA_TC_109
			RMAApp_VehAccClaim_Txt_TimeOfEvent = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_TC_109", 1, 3);//TimeOfEvent Is Fetched From DataSheet RMA_TC_109
			RMAApp_VehAccClaim_Txt_DateOfClaim = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_TC_109", 1, 4);//DateOfClaim Is Fetched From DataSheet RMA_TC_109
			RMAApp_VehAccClaim_Txt_TimeOfClaim = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_TC_109", 1, 5);//TimeOfClaim Is Fetched From DataSheet RMA_TC_109
			...
			testcall1 = true;
			StrClaimNumber_RMA_TC_109 = RMA_Functionality_Utility.RMA_VehicleAccClaimCreation(RMAApp_VehAccClaim_Txt_ClaimType, RMAApp_VehAccClaim_Txt_Department, RMAApp_VehAccClaim_Txt_DateOfEvent, RMAApp_VehAccClaim_Txt_TimeOfEvent, RMAApp_VehAccClaim_Txt_DateOfClaim, RMAApp_VehAccClaim_Txt_TimeOfClaim, logval1); //Claim Number Is Fetched And Stored In Variable StrClaimNumber_RMA_TC_109
			parentlogger.log(LogStatus.INFO, "New Vehicle Accident Claim Is Created With Claim Number::"+ " " + color.RMA_ChangeColor_Utility(StrClaimNumber_RMA_TC_109, 2));
			...
			StrLitigation_RMA_TC_109 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Litigation.RMAApp_Litigation_Txt_DocketNumber(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(DocketNumber, StrLitigation_RMA_TC_109 , "Litigation Docket Number Value", logval);
			
			driver.switchTo().parentFrame();
			RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_Home.RMAApp_LeftHandNavTree_Img_ExpandCollapse(driver, "Litigation ("+StrLitigation_RMA_TC_109+")"), "Expand Image For The Created Litigation On Left Hand Navigation Tree",logval);
			RMA_GenericUsages_Utility.RMA_StaticWait(2, logval, "Wait Is Added As Expand Image Corresponding To Litigation "+" "+StrLitigation_RMA_TC_109 +" "+"Is Clicked");
			RMA_Navigation_Utility.RMA_ObjectRightClick(RMA_Selenium_POM_Home.RMAApp_LeftHandNavTree_Lnk_LitPersonsInvolved(driver, "Litigation ("+StrLitigation_RMA_TC_109+")"), "Persons Involded Link Present Under Litigation Tree", logval);
			...
			RMA_Input_Utility.RMA_SetValue_Utility(RMA_POM_Search.RMAApp_SearchEntity_Txt_LastName(driver), "Witness Last Name TextBox On Search Window", RMA_TC_102.StrWitLastNameActual, logval);
			...
			RMA_Verification_Utility.RMA_TextCompare(RMA_TC_102.StrWitLastNameActual, StrWitLastNameActual, "Witness Name", logval);
			...
			StrEditedWitLastName = RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(4, "Witness_RMA_TC_109_");
			driver.switchTo().frame(RMA_GenericUsages_Utility.RMA_FrameNavigation("piwitness"));
