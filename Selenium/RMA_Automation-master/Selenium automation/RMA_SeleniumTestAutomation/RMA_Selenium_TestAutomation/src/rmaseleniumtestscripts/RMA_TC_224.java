...
//================================================================================================
//TestCaseID     : RMA_TC_224
//Description    : TC_224_Verify Adding,Editing And Deleting Of New Medical Staff As Person Involved For Workers Comp Claim
//Depends On TC  : RMA_TC_222
//Revision       : 0.0 - ImteyazAhmad-07-22-2016 
//=================================================================================================

public class RMA_TC_224 extends RMA_TC_BaseTest {
	...
	@Test
	public void RMA_TC_224_Test() throws Exception,Error {

		try{
			parentlogger = reports.startTest("TC_224_Adding,Editing And Deleting Of New Medical Staff On Workers Comp Claim", "Verify Adding,Editing And Deleting Of New Medical Staff As Person Involved For Workers Comp Claim");
			parentlogger.assignAuthor("Imteyaz Ahmad");

			String StrMedicalStaff_224;
			String StrMedicalStaffLastNameChanged_224;
			String StrMedicalLastNameChangedActual_224;			
			String StrClaimNaumberActual;
			//Local Variable Declaration Completed Here

			StrScreenShotTCName = "TC_224";
			testcall1 = false;	
			testcall2 = false;	
			...
			//===============================================Addition Of New Medical Staff On Claim Created in TC_222 Is Started Here=====================================================================================================
			...
			testcall1 = true;
			StrMedicalStaff_224 = RMA_Functionality_Utility.RMA_PIAddNewEntity_Utility("Medical Staff", logval1);
			parentlogger.log(LogStatus.INFO, "New Medical Staff Is Created Successfully With Medical Staff Name::"+ " " + color.RMA_ChangeColor_Utility(StrMedicalStaff_224, 2));
			...
			/*====================================================Addition Of New Medical Staff On Claim Created in TC_222 Is Completed Here=======================================*/

			/*===============================================Editing Of New Medical Staff Is Started Here================================*/
			StrMedicalStaffLastNameChanged_224 = RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(4, "MedicalStaff_224_");
			RMA_Input_Utility.RMA_SetValue_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "LastName TextBox On PI Medical Staff Page ", StrMedicalStaffLastNameChanged_224, logval);
			RMA_Functionality_Utility.RMA_GenericSave_Utility("pimedstaff", false,"NA","Persons Involved-->MedicalStaff Page", logval);
			StrMedicalLastNameChangedActual_224 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrMedicalStaffLastNameChanged_224, StrMedicalLastNameChangedActual_224 , "Medical Staff Last Name", logval);
			...
			parentlogger.log(LogStatus.INFO, "The Functional Utility :" +" " +"RMA_GenericDelete_Utility Is Called To Delete A Medical Staff : " +" " + color.RMA_ChangeColor_Utility(StrMedicalStaffLastNameChanged_224, 2));
			testcall2 = true;
			RMA_Functionality_Utility.RMA_GenericDelete_Utility("PI Medical Staff Page", logval1);
			parentlogger.log(LogStatus.INFO, "Medical Staff Is Deleted Successfully::"+ " " + color.RMA_ChangeColor_Utility(StrMedicalStaffLastNameChanged_224, 2));
