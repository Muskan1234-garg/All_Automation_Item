...
//================================================================================================
//TestCaseID     : RMA_TC_291
//Description    : TC_291_Verify Adding,Editing And Deleting Of New Witness As Person Involved For Workers' Comp Claim At Policy level
//Depends On TC  : RMA_TC_284
//Revision       : 0.0 - RenuVerma-09-15-2016 
//=================================================================================================

public class RMA_TC_291 extends rmaseleniumtestscripts.RMA_TC_BaseTest {
	...
	public void RMA_TC_291_Test () throws Exception, Error
	{
		parentlogger = reports.startTest("TC_291_New Witness As Person Involved", "Verify Adding,Editing And Deleting Of New Witness As Person Involved For Workers' Comp Claim At Policy level");
		parentlogger.assignAuthor("Renu Verma");
		try {
			String StrEditedWitLastNameActual_291;
		    String StrWitnessLastName_291;
			String StrEditedWitLastName291;
			...
			//===============================================Addition Of Witness On Workers' comp Created in TC_284 Is Started Here=====================================================================================================
			...
			testcall1 = true;
			StrWitnessLastName_291 = RMA_Functionality_Utility.RMA_PIAddNewEntity_Utility("Witness", logval1);
			parentlogger.log(LogStatus.INFO, "New Witness Is Created Successfully With Witness Name::"+ " " + color.RMA_ChangeColor_Utility(StrWitnessLastName_291, 2));
			...
			StrEditedWitLastName291 = RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(4, "Witness_291_");
			RMA_Input_Utility.RMA_SetValue_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "LastName TextBox On Persons Involved-->Witness Page", StrEditedWitLastName291, logval);
			RMA_Functionality_Utility.RMA_GenericSave_Utility("piwitness",false,"NA","Persons Involved-->Witness Page", logval);
			StrEditedWitLastNameActual_291 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrEditedWitLastName291, StrEditedWitLastNameActual_291 , "Witness Last Name Value",logval);
			...
			parentlogger.log(LogStatus.INFO, "Following Utility :" +" " +"RMA_GenericDelete_Utility Is Called To Delete The Witness"+ " "+ color.RMA_ChangeColor_Utility(StrEditedWitLastNameActual_291, 2) +" " +"Added As Persons Involved");
			testcall2 = true;
			RMA_Functionality_Utility.RMA_GenericDelete_Utility("Persons Involved-->Witness Page", logval1);
			parentlogger.log(LogStatus.INFO, "Witness Added As Persons Involved Is Deleted Successfully::"+ " " + color.RMA_ChangeColor_Utility(StrEditedWitLastNameActual_291, 2));
