...
//================================================================================================
//TestCaseID     : RMA_TC_203
//Description    : TC_203_Verify Adding,Editing And Deleting Of Existing Patient As Person Involved For Vehicle Accident Claim
//Depends On TC  : RMA_TC_198
//Revision       : 0.0 - KumudNaithani-07-21-2016 
//=================================================================================================

public class RMA_TC_203 extends RMA_TC_BaseTest {
	...
	@Test
	public void RMA_TC_203_Test() throws Exception,Error {

		try{
			parentlogger = reports.startTest("TC_203_Adding, Editing And Deleting Of An Existing Patient", "Verify Adding,Editing And Deleting Of An Existing Patient As Person Involved For Vehicle Accident Claim");
			parentlogger.assignAuthor("Kumud Naithani");

			String StrPatientLastName_203;
			String StrPrimaryWindowHandle;
			String StrPatientLastNameActual_203;
			String StrPatientNameChanged;
			String StrClaimNaumberActual;

			//Local Variable Declaration Completed Here

			StrScreenShotTCName = "TC_203";
			testcall1 = false;	
			testcall2 = false;	
			...
			testcall1 = true;
			StrPatientLastName_203 = RMA_Functionality_Utility.RMA_MaintEntityAddition_Utility("PatientTracking", logval1);
			parentlogger.log(LogStatus.INFO, "New Patient Is Created Successfully With Name::"+ " " + color.RMA_ChangeColor_Utility(StrPatientLastName_203, 2));
			...
			RMA_Functionality_Utility.RMA_StandardSearch_Window(RMA_POM_Search.RMAApp_SearchPatient_Txt_PatientLastName(driver), "Standard Patient Search Page", "Patient Last Name TextBox", StrPatientLastName_203, StrPatientLastName_203, "pipatient", StrPrimaryWindowHandle, logval);
			RMA_Functionality_Utility.RMA_GenericSave_Utility("pipatient", false, "NA", "Save Image On PI Patient Page", logval);
			StrPatientLastNameActual_203 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrPatientLastName_203, StrPatientLastNameActual_203 , "Driver Last Name", logval);
			...
			RMA_Functionality_Utility.RMA_GenericSave_Utility("pipatient", false, "NA", "Save Image On PI Patient Page", logval);
			StrPatientLastNameActual_203 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrPatientNameChanged, StrPatientLastNameActual_203 , "Patient Last Name", logval);
