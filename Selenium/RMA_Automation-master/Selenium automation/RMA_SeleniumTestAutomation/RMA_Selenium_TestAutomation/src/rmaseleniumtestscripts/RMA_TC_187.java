...
//================================================================================================
//TestCaseID     : RMA_TC_187
//Description    : TC_187_Verify Adding,Editing And Deleting Of Existing Patient As Person Involved For General Claim
//Depends On TC  : RMA_TC_182
//Revision       : 0.0 - KumudNaithani-07-15-2016 
//=================================================================================================

public class RMA_TC_187 extends RMA_TC_BaseTest {
	...
	@Test
	public void RMA_TC_187_Test() throws Exception,Error {

		try{
			parentlogger = reports.startTest("TC_187_Adding, Editing And Deleting Of An Existing Patient", "Verify Adding,Editing And Deleting Of An Existing Patient As Person Involved For General Claim");
			parentlogger.assignAuthor("Kumud Naithani");

			String StrPatientLastName_187;
			String StrPrimaryWindowHandle;
			String StrPatientLastNameActual_187;
			String StrPatientNameChanged;
			String StrClaimNaumberActual;

			//Local Variable Declaration Completed Here

			StrScreenShotTCName = "TC_187";
			testcall1 = false;	
			testcall2 = false;	
			...
			testcall1 = true;
			StrPatientLastName_187 = RMA_Functionality_Utility.RMA_MaintEntityAddition_Utility("PatientTracking", logval1);
			parentlogger.log(LogStatus.INFO, "New Patient Is Created Successfully With Name::"+ " " + color.RMA_ChangeColor_Utility(StrPatientLastName_187, 2));
			...
			RMA_Functionality_Utility.RMA_StandardSearch_Window(RMA_POM_Search.RMAApp_SearchPatient_Txt_PatientLastName(driver), "Standard Patient Search Page", "Patient Last Name TextBox", StrPatientLastName_187, StrPatientLastName_187, "pipatient", StrPrimaryWindowHandle, logval);
			RMA_Functionality_Utility.RMA_GenericSave_Utility("pipatient", false, "NA", "Save Image On PI Patient Page", logval);
			StrPatientLastNameActual_187 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrPatientLastName_187, StrPatientLastNameActual_187 , "Driver Last Name", logval);
			...
			RMA_Functionality_Utility.RMA_GenericSave_Utility("pipatient", false, "NA", "Save Image On PI Patient Page", logval);
			StrPatientLastNameActual_187 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrPatientNameChanged, StrPatientLastNameActual_187 , "Patient Last Name", logval);
