...
//================================================================================================
//TestCaseID     : RMA_TC_234
//Description    : TC_234_Verify Adding,Editing And Deleting Of New Other Person As Person Involved on Non Occupational Claim
//Depends On TC  : RMA_TC_230
//Revision       : 0.0 -RenuVerma-08-03-2016
//=================================================================================================

public class RMA_TC_234 extends RMA_TC_BaseTest {
	...
	@Test
	public void RMA_TC_234_Test() throws Exception,Error {

		try{
			parentlogger = reports.startTest("TC_234_Adding, Editing And Deleting Of New Other Person On Non Occupational Claim", "Verify Adding,Editing And Deleting Of New Other Person As Person Involved on Non Occupational Claim");
			parentlogger.assignAuthor("Renu Verma");

			String StrOtherPersonLastName_234;
			String OtherPersonLastNameChanged_234;
			String OtherPersonLastNameChanged_Actual_234;
			String StrClaimNaumberActual;
			//Local Variable Declaration Completed Here

			StrScreenShotTCName = "TC_234";
			testcall1 = false;	
			testcall2 = false;	
			...
			//===============================================Addition Of Other Person On Claim Created in TC_230 Is Started Here=====================================================================================================
			...
			testcall1 = true;
			StrOtherPersonLastName_234 = RMA_Functionality_Utility.RMA_PIAddNewEntity_Utility("Other Person", logval1);
			parentlogger.log(LogStatus.INFO, "New Other Person Is Created Successfully With Other Person Name::"+ " " + color.RMA_ChangeColor_Utility(StrOtherPersonLastName_234, 2));
			...
			OtherPersonLastNameChanged_234 = RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(4, "OtherPerson_234_");
			RMA_Input_Utility.RMA_SetValue_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "LastName TextBox On PI Other Person Page ", OtherPersonLastNameChanged_234, logval);
			RMA_Functionality_Utility.RMA_GenericSave_Utility("piother",false,"NA", "Persons Involved-->Other Person Page", logval);
			OtherPersonLastNameChanged_Actual_234 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(OtherPersonLastNameChanged_234, OtherPersonLastNameChanged_Actual_234 , "Other Person Last Name", logval);
			...
			parentlogger.log(LogStatus.INFO, "The Functional Utility :" +" " +"RMA_GenericDelete_Utility Is Called To Delete A Other Person :" +" "+ color.RMA_ChangeColor_Utility(OtherPersonLastNameChanged_234, 2));
			testcall2 = true;
			RMA_Functionality_Utility.RMA_GenericDelete_Utility("PI Other Person Page", logval1);
			parentlogger.log(LogStatus.INFO, "Other Person Is Deleted Successfully::"+ " " + color.RMA_ChangeColor_Utility(OtherPersonLastNameChanged_234, 2));
