...
//================================================================================================
//TestCaseID     : RMA_TC_188
//Description    : TC_188_Verify Adding,Editing And Deleting Of Existing Physician As Person Involved For General Claim
//Depends On TC  : RMA_TC_182
//Revision       : 0.0 - KumudNaithani-07-14-2016
//=================================================================================================

public class RMA_TC_188 extends RMA_TC_BaseTest {
	...
	@Test
	public void RMA_TC_188_Test() throws Exception,Error {

		try{
			parentlogger = reports.startTest("TC_188_Adding, Editing And Deleting Of An Existing Physician", "Verify Adding,Editing And Deleting Of An Existing Physician As Person Involved For General Claim");
			parentlogger.assignAuthor("Kumud Naithani");

			String StrPhysicianLastName_188;
			String StrPrimaryWindowHandle;
			String StrPhysicianLastNameActual_188;
			...
			testcall1 = true;
			StrPhysicianLastName_188 = RMA_Functionality_Utility.RMA_MaintEntityAddition_Utility("Physician", logval1);
			parentlogger.log(LogStatus.INFO, "New Physician Is Created Successfully With Name::"+ " " + color.RMA_ChangeColor_Utility(StrPhysicianLastName_188, 2));
			...
			RMA_Functionality_Utility.RMA_StandardSearch_Window(RMA_POM_Search.RMAApp_SearchPhysician_Txt_LastName(driver), "Standard Physician Search Page", "Physician Last Name TextBox", StrPhysicianLastName_188, StrPhysicianLastName_188, "piphysician", StrPrimaryWindowHandle, logval);
			RMA_Functionality_Utility.RMA_GenericSave_Utility("piphysician", false, "NA", "Save Image On PI Physician Page", logval);
			StrPhysicianLastNameActual_188 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrPhysicianLastName_188, StrPhysicianLastNameActual_188 , "Physician Last Name", logval);
			...
			RMA_Functionality_Utility.RMA_GenericSave_Utility("piphysician", false, "NA", "Save Image On PI Physician Page", logval);
			StrPhysicianLastNameActual_188 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrPhysicianLastNameChanged, StrPhysicianLastNameActual_188 , "Physician Last Name", logval);
