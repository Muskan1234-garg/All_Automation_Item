...
//================================================================================================
//TestCaseID     : RMA_TC_257
//Description    : TC_257_Verify Adding,Editing And Deleting Of New Other Person As Person Involved on Event
//Depends On TC  : RMA_TC_246
//Revision       : 0.0 -RenuVerma-07-27-2016 
//=================================================================================================

public class RMA_TC_257 extends RMA_TC_BaseTest {
	...
	@Test
	public void RMA_TC_257_Test() throws Exception,Error {

		try{
			parentlogger = reports.startTest("TC_257_Adding, Editing And Deleting Of New Other Person As Person Involved", "Verify Adding,Editing And Deleting Of New Other Person As Person Involved on Event");
			parentlogger.assignAuthor("Renu Verma");

			String StrOtherPersonLastName_257;
			String OtherPersonLastNameChanged_257;
			String OtherPersonLastNameChanged_Actual_257;
			String StrEventNaumberActual;
			//Local Variable Declaration Completed Here

			StrScreenShotTCName = "TC_257";
			testcall1 = false;	
			testcall2 = false;	
			...
			testcall1 = true;
			StrOtherPersonLastName_257 = RMA_Functionality_Utility.RMA_PIAddNewEntity_Utility("Other Person", logval1);
			parentlogger.log(LogStatus.INFO, "New Other Person Is Created Successfully With Other Person Name::"+ " " + color.RMA_ChangeColor_Utility(StrOtherPersonLastName_257, 2));
			...
			OtherPersonLastNameChanged_257 = RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(4, "OtherPerson_257_");
			RMA_Input_Utility.RMA_SetValue_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "LastName TextBox On PI Other Person Page ", OtherPersonLastNameChanged_257, logval);
			RMA_Functionality_Utility.RMA_GenericSave_Utility("piother",false,"NA", "Persons Involved-->Other Person Page", logval);
			OtherPersonLastNameChanged_Actual_257 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(OtherPersonLastNameChanged_257, OtherPersonLastNameChanged_Actual_257 , "Other Person Last Name", logval);
			...
			parentlogger.log(LogStatus.INFO, "The Functional Utility :" +" " +"RMA_GenericDelete_Utility Is Called To Delete A Other Person :" +" "+ color.RMA_ChangeColor_Utility(OtherPersonLastNameChanged_257, 2));
			testcall2 = true;
			RMA_Functionality_Utility.RMA_GenericDelete_Utility("PI Other Person Page", logval1);
			parentlogger.log(LogStatus.INFO, "Other Person Is Deleted Successfully::"+ " " + color.RMA_ChangeColor_Utility(OtherPersonLastNameChanged_257, 2));
