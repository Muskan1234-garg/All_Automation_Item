...
//====================================================================================================================================
//TestCaseID     : RMA_TC_335_WorkersCompClaim
//Description    : Creation, Edit And Deletion Of Enhanced Notes For An Already Created Workers Compensation Claim 
//Depends On TC  : NA
//Revision       : 0.0 - KumudNaithani-02-27-2017
//====================================================================================================================================

public class RMA_TC_335_WorkersCompClaim extends RMA_TC_BaseTest {	
...
@Test 
public void RMA_TC_335_WorkersCompClaim_Test() throws Exception, Error
{
...
try
	{
	 parentlogger = reports.startTest("RMA_TC_335_Creation, Edit And Deletion Of Enhanced Notes For Workers Compensation Claim", "Creation, Edit And Deletion Of Enhanced Notes For An Already Created Workers Compensation Claim");
	 ...
	 StrScreenShotTCName = "RMA_TC_335_WorkersCompClaim";
	 Edit = true;
	 //Variable Initialization Completed
	 
	//===========================================================New Workers Compensation Claim Creation Is Started Here=====================================================================================================================================================================================================================================================================================================================================
     ...
     StrClaimNumber_335 = WorkersCompensationClaim.RMA_Smoke_TC_002_WC_Test();  //Created Workers Compensation Claim Number Is Stored In Variable StrClaimNumber_335
     loggerval1 = logger.toString();
     parentlogger.log(LogStatus.INFO, "A New Workers Compensation Claim Is Created With Claim Number:: "+ color.RMA_ChangeColor_Utility(StrClaimNumber_335, 2));
     parentlogger.appendChild(logger);;
 	//===========================================================New Workers Compensation Claim Creation Is Completed Here==================================================================================================================================================================================================================================================================================================================================
	
	//===========================================================Steps To Create And Edit Progress Notes Started Here==================================================================================================================================================================================================================================================================================================================================================
    StrPrimaryWindowHandle = driver.getWindowHandle();
    RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_Home.RMAApp_Generic_Img_EnhancedNotes(driver), "Enhanced Notes Image On Workers Compensation Claim :"+" "+StrClaimNumber_335, logval); //Claim ID Is Same For All Line Of Business
	...
	//===========================================================Steps To Delete Progress Notes Completed Here============================================================================================================================================================================================================================================================
	 ...
	 {
	 logger.log(LogStatus.FAIL, "Following Error Occurred  ::" + " "+  color.RMA_ChangeColor_Utility(FinalErrorMessage,1)+ " " + "While Executing Child Test Case" +" "+ "RMA_Smoke_TC_002_WC" + " " +  "For Workers Compensation Claim Creation And Hence The Test Case Is A Fail");
	 parentlogger.appendChild(logger);
	 }
