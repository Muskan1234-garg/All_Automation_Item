...
//================================================================================================
//TestCaseID     : RMA_TC_136
//Description    : TC_136_Verify Adding,Editing And Deleting Of New Medical Staff As Person Involved In Litigation For Workers Comp Claim
//Depends On TC  : RMA_TC_136
//Revision       : 0.0 - ImteyazAhmad-06-28-2016 
//=================================================================================================

public class RMA_TC_136 extends RMA_TC_BaseTest {
	...
	@Test
	public void RMA_TC_136_Test() throws Exception,Error {

		try{
			parentlogger = reports.startTest("TC_136_Adding, Editing And Deleting Of New Medical Staff", "Verify Adding,Editing And Deleting Of New Medical Staff As Person Involved In Litigation For Workers Comp Claim");
			parentlogger.assignAuthor("Imteyaz Ahmad");

			String StrMedicalLastName_136;
			String StrMedicalLastNameActual_136;
			String StrMedicalLastNameChanged;

			StrScreenShotTCName = "TC_136";
			testcall1 = false;	
			testcall2 = false;	
			...
			testcall1 = true;
			StrMedicalLastName_136 = RMA_Functionality_Utility.RMA_PIAddNewEntity_Utility("Medical Staff", logval1);
			parentlogger.log(LogStatus.INFO, "New Medical Staff Is Created Successfully With Medical Staff Last Name::"+ " " + color.RMA_ChangeColor_Utility(StrMedicalLastName_136, 2));
			loggerval1 = logger.toString();
			parentlogger.appendChild(logger);
			//===============================================Steps To Create A New Medical Staff Completed============================================================================================================================================
			
			/*===============================================Editing Of New Medical Staff Is Started Here================================*/
			StrMedicalLastNameChanged = RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(4, "Medical_TC_136_");
			...
			StrMedicalLastNameActual_136 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Maintenance.RMAApp_MaintMedStaff_Txt_LstName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrMedicalLastNameChanged, StrMedicalLastNameActual_136 , "Medical StaffLast Name", logval);
