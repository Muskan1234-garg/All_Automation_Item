...
public class RMA_TC_022 extends RMA_TC_BaseTest {
	
	static String ExceptionRecorded;
	static String []ErrorMessage;
	static String FinalErrorMessage;
	static String ErrorMessageType;	
	static String StrClaimNumber_022;
	static String StrControlNum_022;
	static String StrScreenShotTCName;
	
	@Test
	public void RMA_TC_022_Test() throws Exception,Error {
		try{
		parentlogger = reports.startTest("TC_022_Payment is Created and Going on Hold","Verify Payment can be created and is going on Hold because of exceeded payment limits");
		
		String RMAApp_Login_Txt_UserName;
		String RMAApp_Login_Txt_Password;
		String StrAccept;
		String AdjusterName_TC_022;
		...
		RMAApp_Login_Txt_UserName = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_022", 1, 0); //UserName Fetched From DataSheet RMA_TC_022
		RMAApp_Login_Txt_Password = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_022", 1, 1); //Password Fetched From DataSheet RMA_TC_022
		...
		StrClaimNumber_022 = generalClaim.GeneralClaimCreation(); //Claim Number Is Fetched And Stored In Variable StrClaimNumber_022
		loggerval2 = logger.toString();
		parentlogger.log(LogStatus.INFO,  "New Claim, After TC_004 IS Called ,Is Created With Claim Number::"+ " " + color.RMA_ChangeColor_Utility(StrClaimNumber_022, 2));
		parentlogger.appendChild(logger);
		// New Claim Is Created	
		//===============================================General Claim Creation Is Completed================================================================================================================================================================================================================================================================================	
		
		//===============================================General Claim's Adjuster Creation Is Started=========================================================================================================================================================================================================================================================================	  
		RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_Home.RMAApp_LeftHandNavTree_Img_ExpandCollapse(driver, StrClaimNumber_022), "Expand Image Corresponding To Claim Link" +" "+StrClaimNumber_022+" " +" On Left Navigation Tree", logval);
		...
		testcall4 = true;
		AdjusterName_TC_022 = RMA_Functionality_Utility.RMA_ClaimEntityAddition_Utility("Adjustor", "Adjuster (0)", StrClaimNumber_022, "curradj", "Not Required", "Not Required", "Not Required", "Not Required", "Not Required", "Not Required", logval1);
		parentlogger.log(LogStatus.INFO, "New Adjuster Is Created Successfully With Last Name::"+ " " + color.RMA_ChangeColor_Utility(AdjusterName_TC_022, 2));
		loggerval1 = logger.toString();
		parentlogger.appendChild(logger);
		...
		StrControlNum_022 = PaymentAdd.PaymentAddition();// Control Number is fetched and stored in variable StrControlNum_022
		loggerval3 = logger.toString();
		parentlogger.log(LogStatus.INFO, "Control Number,After TC_006 is Called, is Generated::"+ " " + color.RMA_ChangeColor_Utility(StrControlNum_022, 2));
		parentlogger.appendChild(logger);
		//New Payment Is Done
