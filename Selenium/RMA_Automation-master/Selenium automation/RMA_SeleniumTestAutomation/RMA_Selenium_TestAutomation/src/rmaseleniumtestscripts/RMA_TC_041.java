...
//================================================================================================
//TestCaseID     : RMA_TC_041
//Description    : TC_041 Diary Is Sent To The User Who Created The Transaction Is Validated
//Depends On TC  : TC_011, TC_035, TC_036, TC_039, TC_040
...
public class RMA_TC_041 extends rmaseleniumtestscripts.RMA_TC_BaseTest {
...
@Test 
public void RMA_TC_041_Test () throws Exception, Error
//Diary/Email Is Sent To The User Who Created The Transaction Is Validated
{
	try {
		parentlogger = reports.startTest("TC_041_Diary To User Creating Transaction", "Diary Is Sent To The User Who Created The Transaction Is Validated");
		String StrAccept;
		...
		RMAApp_Login_Txt_UserName = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_041", 1, 0); //UserName Fetched From DataSheet RMA_TC_041
		RMAApp_Login_Txt_Password = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_041", 1, 1); //Password Fetched From DataSheet RMA_TC_041
		...
		RMA_Functionality_Utility.RMA_StandardSearch_Screen(RMA_POM_Search.RMAApp_SearchFunds_Txt_ControlNumber(driver), "Search_Funds", "Check Control Number Text Box", RMA_TC_036.StrControlNumber_RMA_TC_036, RMA_TC_036.StrControlNumber_RMA_TC_036, "Transaction", "num", 2, logval);
