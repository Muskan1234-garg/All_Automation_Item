...
//================================================================================================
//TestCaseID     : RMA_TC_163
//Description    : TC_163_Verify Adding,Editing And Deleting Of New Patient As Person Involved In Litigation For NonOccupational Claim
//Depends On TC  : RMA_TC_158
//Revision       : 0.0 - ImteyazAhmad-07-06-2016 
//=================================================================================================

public class RMA_TC_163 extends RMA_TC_BaseTest {
	...
	@Test
	public void RMA_TC_163_Test() throws Exception,Error {

		try{
			parentlogger = reports.startTest("TC_163_Adding, Editing And Deleting Of New Patient", "Verify Adding,Editing And Deleting Of New Patient As Person Involved In Litigation For NonOccupational Claim");
			parentlogger.assignAuthor("Imteyaz Ahmad");

			String StrPatientLastName_163;
			String StrPatientLastNameActual_163;
			String StrPatientLastNameChanged;
			String StrClaimNaumberActual;

			StrScreenShotTCName = "TC_163";
			testcall1 = false;	
			testcall2 = false;	
			...
			testcall1 = true;
			StrPatientLastName_163 = RMA_Functionality_Utility.RMA_PIAddNewEntity_Utility("Patient", logval1);
			parentlogger.log(LogStatus.INFO, "New Patient Is Created Successfully With Patient Last Name::"+ " " + color.RMA_ChangeColor_Utility(StrPatientLastName_163, 2));
			loggerval1 = logger.toString();
			parentlogger.appendChild(logger);
			parentlogger.log(LogStatus.INFO, parentlogger.addScreenCapture(RMA_ScreenCapture_Utility.RMA_ScreenShotCapture_Utility(driver, "New Patient Creation Is Successfull", StrScreenShotTCName)));
			//===============================================Steps To Create A New Patient Completed============================================================================================================================================
			
			/*===============================================Editing Of New Patient Is Started Here=======================================================================*/
			StrPatientLastNameChanged = RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(4, "Patient_TC_163_");
			...
			StrPatientLastNameActual_163 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrPatientLastNameChanged, StrPatientLastNameActual_163 , "Patient Last Name", logval);
