...
//================================================================================================
//TestCaseID     : RMA_TC_165
//Description    : TC_165_Verify Adding,Editing And Deleting Of New Witness As Person Involved In Litigation For NonOccupational Claim
//Depends On TC  : RMA_TC_158
//Revision       : 0.0 - ImteyazAhmad-07-08-2016 
//=================================================================================================

public class RMA_TC_165 extends RMA_TC_BaseTest {
	...
	@Test
	public void RMA_TC_165_Test() throws Exception,Error {

		try{
			parentlogger = reports.startTest("TC_165_Adding, Editing And Deleting Of New Witness", "Verify Adding,Editing And Deleting Of New Witness As Person Involved In Litigation For NonOccupational Claim");
			parentlogger.assignAuthor("Imteyaz Ahmad");

			String StrWitnessLastName_165;
			String StrWitnessLastNameActual_165;
			String StrWitnessLastNameChanged;
			String StrClaimNaumberActual;

			StrScreenShotTCName = "TC_165";
			testcall1 = false;	
			testcall2 = false;	
			...
			testcall1 = true;
			StrWitnessLastName_165 = RMA_Functionality_Utility.RMA_PIAddNewEntity_Utility("Witness", logval1);
			parentlogger.log(LogStatus.INFO, "New Witness Is Created Successfully With Witness Last Name::"+ " " + color.RMA_ChangeColor_Utility(StrWitnessLastName_165, 2));
			...
			StrWitnessLastNameChanged = RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(4, "Witness_TC_165_");
			...
			StrWitnessLastNameActual_165 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Maintenance.RMAApp_MaintPeople_Txt_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrWitnessLastNameChanged, StrWitnessLastNameActual_165 , "Witness Last Name", logval);
