...
public class RMA_TC_013 extends rmaseleniumtestscripts.RMA_TC_BaseTest {
	...
	public static String StrClaimNumber_RMA_TC_013;
	public static String StrControlNumber_RMA_TC_013;
...
{
	try {
		parentlogger = reports.startTest("TC_013_Hold Of Created Payments On Payments Limits Exceed", "Hold Of Created Payments When Payment Limits Are Exceeded Is Validated");
		String StrAccept;
		...
		String StrClaimAdjustor_RMA_TC_013;
		...
		StrClaimAdjustor_RMA_TC_013 = "ClaimAdjustor_RMA_TC_013";
		StrClaimAdjustor_RMA_TC_013 = RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(4,StrClaimAdjustor_RMA_TC_013);
		...
		RMAApp_Login_Txt_UserName = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_013", 1, 0); //UserName Fetched From DataSheet RMA_TC_013
		RMAApp_Login_Txt_Password = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_013", 1, 1); //Password Fetched From DataSheet RMA_TC_013
		...
		StrClaimNumber_RMA_TC_013 = generalClaim.GeneralClaimCreation(); //Claim Number Is Fetched And Stored In Variable StrClaimNumber
		parentlogger.log(LogStatus.INFO, "New Claim Is Created With Claim Number::"+ " " + color.RMA_ChangeColor_Utility(StrClaimNumber_RMA_TC_013, 2));
		...
		RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_Home.RMAApp_LeftHandNavTree_Img_ExpandCollapse(driver, StrClaimNumber_RMA_TC_013), "Expand Image Corresponding To Claim Link" +" "+StrClaimNumber_RMA_TC_013+" " +" On Left Navigation Tree", logval);
		...
		testcall4 = true;
		StrClaimAdjustor_RMA_TC_013 = RMA_Functionality_Utility.RMA_ClaimEntityAddition_Utility("Adjustor", "Adjuster (0)", StrClaimNumber_RMA_TC_013, "curradj", "Not Required", "Not Required", "Not Required", "Not Required", "Not Required", "Not Required", logval1);
		parentlogger.log(LogStatus.INFO, "New Adjuster Is Created Successfully With Last Name::"+ " " + color.RMA_ChangeColor_Utility(StrClaimAdjustor_RMA_TC_013, 2));
		...
		parentlogger.log(LogStatus.INFO, "Following Test Is Called :: RMA_TC_006 To Create New Payment");
		
		testcall3 = true;
		RMA_TC_006 paymentaddition = new RMA_TC_006();
		StrControlNumber_RMA_TC_013 = paymentaddition.PaymentAddition();
		parentlogger.log(LogStatus.INFO, "New Payment With Control Number Is Done::"+ " " + color.RMA_ChangeColor_Utility(StrControlNumber_RMA_TC_013, 2));
