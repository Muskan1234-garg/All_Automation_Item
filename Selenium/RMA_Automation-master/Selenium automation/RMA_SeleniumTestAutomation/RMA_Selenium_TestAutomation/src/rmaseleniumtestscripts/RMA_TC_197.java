...
//================================================================================================
//TestCaseID     : RMA_TC_197
//Description    : TC_197_Verify Add,Edit And Delete Of Existing Witness As Person Involved For Non Occupational Claims
//Depends On TC  : RMA_TC_197
//Revision       : 0.0 - ImteyazAhmad-07-15-2016 
//=================================================================================================

public class RMA_TC_197 extends rmaseleniumtestscripts.RMA_TC_BaseTest {
	...
	@Test 
	public void RMA_TC_197_Test () throws Exception, Error
	{
		parentlogger = reports.startTest("TC_197_Adding, Editing And Deleting Of An Existing Witness", "Verify Adding,Editing And Deleting Of An Existing Witness As Person Involved For Non Occupational Claim");
		...
		try {
			...
			RMAApp_NonOccupationalClaim_Txt_ClaimType = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_197", 1, 0); // Claim Type Is Fetched From DataSheet RMA_TC_197
			RMAApp_NonOccupationalClaim_Txt_EmployeeNo = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_TC_197", 1, 1);//Employee Number Is Fetched From DataSheet RMA_TC_197
			RMAApp_NonOccupationalClaim_Txt_Department = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_197", 1, 2); // Department Is Fetched From DataSheet RMA_TC_197
			RMAApp_NonOccupationalClaim_Txt_DateOfEvent = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_TC_197", 1, 3);//DateOfEvent Is Fetched From DataSheet RMA_TC_197
			RMAApp_NonOccupationalClaim_Txt_TimeOfEvent = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_TC_197", 1, 4);//TimeOfEvent Is Fetched From DataSheet RMA_TC_197
			RMAApp_NonOccupationalClaim_Txt_DateOfClaim = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_TC_197", 1, 5);//DateOfClaim Is Fetched From DataSheet RMA_TC_197
			RMAApp_NonOccupationalClaim_Txt_TimeOfClaim = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_TC_197", 1, 6);//TimeOfClaim Is Fetched From DataSheet RMA_TC_197
			RMAApp_NonOccupationalClaim_Txt_Jurisdiction = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_197", 1, 7); // Jurisdiction Is Fetched From DataSheet RMA_TC_197
			RMAApp_NonOccupationalClaim_Txt_DisabilityStartDate = ExcelData.RMA_ExcelNumberDataRead_Utility("RMA_TC_197", 1, 8);//Disability Start Date Is Fetched From DataSheet RMA_TC_197
			...
			testcall1 = true;
			StrClaimNumber_TC_197 = RMA_Functionality_Utility.RMA_NonOccupationalClaimCreation(RMAApp_NonOccupationalClaim_Txt_ClaimType, RMAApp_NonOccupationalClaim_Txt_EmployeeNo, RMAApp_NonOccupationalClaim_Txt_Department, RMAApp_NonOccupationalClaim_Txt_DateOfEvent, RMAApp_NonOccupationalClaim_Txt_TimeOfEvent, RMAApp_NonOccupationalClaim_Txt_DateOfClaim, RMAApp_NonOccupationalClaim_Txt_TimeOfClaim, "MyPlan", RMAApp_NonOccupationalClaim_Txt_Jurisdiction,RMAApp_NonOccupationalClaim_Txt_DisabilityStartDate, logval1);
			parentlogger.log(LogStatus.INFO, "New Non Occupational Claim Is Created With Claim Number::"+ " " + color.RMA_ChangeColor_Utility(StrClaimNumber_TC_197, 2));
			loggerval1 = logger.toString();
			parentlogger.appendChild(logger);
			RMA_Verification_Utility.RMA_ElementExist_Utility(RMA_Selenium_POM_Home.RMAApp_LeftHandNavTree_Lnk_Claim_PI(driver, StrClaimNumber_TC_197), "Person Involved Link Under Non Occupational Claim On Left Hand Navigation Tree", logval);
			/*===========================================================Creation Of Non Occupational Claim Is Completed Here================================================*/
								
			//===============================================Addition Of An Existing Witness Is Started Here==========================================================================================================================================================
			
			RMA_Navigation_Utility.RMA_ObjectRightClick(RMA_Selenium_POM_Home.RMAApp_LeftHandNavTree_Lnk_Claim_PI(driver, StrClaimNumber_TC_197), "Person Involved Link Under Non Occupational Claim On Left Hand Navigation Tree", logval);
			...
			RMA_Functionality_Utility.RMA_StandardSearch_Window(RMA_POM_Search.RMAApp_SearchEntity_Txt_LastName(driver), "Standard Entity Search Page", "Last Name TextBox", RMA_TC_190.StrWitnessLastName_190, "Witness", "piwitness", StrPrimaryWindowHandle, logval);
			...
			RMA_Verification_Utility.RMA_TextCompare(RMA_TC_190.StrWitnessLastName_190, StrWitLastNameActual , "Witness Last Name Value",logval);
			...
			StrEditedWitLastName = RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(4, "Witness_TC_197_");
