...
//================================================================================================
//TestCaseID     : RMA_TC_119
//Description    : TC_119_Verify Adding,Editing And Deleting Of Existing Employee As Person Involved In Litigation For Property Claim
//Depends On TC  : RMA_TC_118
//Revision       : 0.0 - ImteyazAhmad-06-20-2016 
//=================================================================================================

public class RMA_TC_119 extends RMA_TC_BaseTest {
	...
	@Test
	public void RMA_TC_119_Test() throws Exception,Error {

		try{
			parentlogger = reports.startTest("TC_119_Adding, Editing And Deleting Of Existing Employee", "Verify Adding,Editing And Deleting Of Existing Employee As Person Involved In Litigation For Property Claim");
			parentlogger.assignAuthor("Imteyaz Ahmad");

			String StrEmployeeNumber_119;
			String StrEmployeeNumberActual_119;
			String StrPrimaryWindowHandle;
			String StrEmployeeLastNameActual_119;
			String StrEmployeeNameChanged;

			//Local Variable Declaration Completed Here

			
			StrScreenShotTCName = "TC_119";
			testcall1 = false;	
			testcall2 = false;	
			...
			testcall1 = true;
			StrEmployeeNumber_119 = RMA_Functionality_Utility.RMA_MaintEntityAddition_Utility("Employee", logval1);
			parentlogger.log(LogStatus.INFO, "New Employee Is Created Successfully With Employee Number::"+ " " + color.RMA_ChangeColor_Utility(StrEmployeeNumber_119, 2));
			...
			RMA_Input_Utility.RMA_SetValue_Utility(RMA_POM_Search.RMAApp_SearchEmployee_Txt_EmployeeNumber(driver), "EmployeeNumber TextBox On Employee Search Page", StrEmployeeNumber_119, logval);
			...
			RMA_Navigation_Utility.RMA_WebPartialLinkSelect(StrEmployeeNumber_119, "Search Page Specific To Searched Employee Criteria" , logval);
			...
			StrEmployeeNumberActual_119 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_PersonInvolved.RMAApp_PIEmp_Txt_EmpNumber(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrEmployeeNumber_119, StrEmployeeNumberActual_119 , "EmployeeNumber", logval);
			...
			driver.switchTo().frame(RMA_GenericUsages_Utility.RMA_FrameNavigation("piemployee"));
			RMA_GenericUsages_Utility.RMA_StaticWait(2, logval, "Wait Is Added As Switch To PI Employee Frame Is Done");		
			StrEmployeeLastNameActual_119 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrEmployeeNameChanged, StrEmployeeLastNameActual_119 , "EmployeeLast Name", logval);
