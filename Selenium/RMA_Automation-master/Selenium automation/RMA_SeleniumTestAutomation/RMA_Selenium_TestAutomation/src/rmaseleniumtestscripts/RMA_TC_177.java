...
//================================================================================================
//TestCaseID     : RMA_TC_177
//Description    : TC_177_Verify Adding,Editing And Deleting Of Existing Driver As Person Involved For WC Claim
//Depends On TC  : RMA_TC_174
//Revision       : 0.0 - ImteyazAhmad-07-13-2016 
//=================================================================================================

public class RMA_TC_177 extends RMA_TC_BaseTest {
	...
	@Test
	public void RMA_TC_177_Test() throws Exception,Error {

		try{
			parentlogger = reports.startTest("TC_177_Adding, Editing And Deleting Of An Existing Driver", "Verify Adding,Editing And Deleting Of An Existing Driver As Person Involved For Workers Comp Claim");
			parentlogger.assignAuthor("Imteyaz Ahmad");

			String StrDriverLastName_177;
			String StrPrimaryWindowHandle;
			String StrDriverLastNameActual_177;
			...
			testcall1 = true;
			StrDriverLastName_177 = RMA_Functionality_Utility.RMA_MaintEntityAddition_Utility("Driver", logval1);
			parentlogger.log(LogStatus.INFO, "New Driver Is Created Successfully With Name::"+ " " + color.RMA_ChangeColor_Utility(StrDriverLastName_177, 2));
			...
			RMA_Functionality_Utility.RMA_StandardSearch_Window(RMA_POM_Search.RMAApp_SearchDriver_Txt_DriverLastName(driver), "Standard Driver Search Page", "Driver Last Name TextBox", StrDriverLastName_177, StrDriverLastName_177, "pidriver", StrPrimaryWindowHandle, logval);
			...
			StrDriverLastNameActual_177 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrDriverLastName_177, StrDriverLastNameActual_177 , "Driver Last Name", logval);
			...
			StrDriverNameChanged = RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(4, "Drive_");
			...
			RMA_GenericUsages_Utility.RMA_DynamicFrameSwitching("pidriver");			
			StrDriverLastNameActual_177 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrDriverNameChanged, StrDriverLastNameActual_177 , "Driver Last Name", logval);
