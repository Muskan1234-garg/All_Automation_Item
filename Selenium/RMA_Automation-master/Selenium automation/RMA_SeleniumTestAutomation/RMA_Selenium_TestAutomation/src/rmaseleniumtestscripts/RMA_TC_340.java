...
//=============================================================================================================================
//TestCaseID     : RMA_TC_340
//Description    : Creation, Edit And Deletion Of Enhanced Notes For A Subrogation Associated With A Claim
//Depends On TC  : RMA_TC_335
//Revision       : 0.0 - KumudNaithani-02-28-2017
//==============================================================================================================================

public class RMA_TC_340 extends RMA_TC_BaseTest {
	static String ExceptionRecorded;
	static String []ErrorMessage;
	static String FinalErrorMessage;
	static String ErrorMessageType;
	static String StrScreenShotTCName;
	public static String StrSubrogationType_340;
	
@Test	
public void RMA_TC_340_Test() throws Exception, Error
{   
	try {	 	 
	...
	String RMAApp_SubrogationCreation_Txt_Date;
	boolean Edit;
	 //Local Variable Declaration Completed
	 
	 parentlogger = reports.startTest("RMA_TC_340_Creation, Edit And Deletion Of Enhanced Notes For A Subrogation", "Creation, Edit And Deletion Of Enhanced Notes For A Subrogation Associated With A Claim");
	...
	RMAApp_SubrogationCreation_Txt_Date = RMA_GenericUsages_Utility.RMA_CurrentDateInfo_Utility();
	//===========================================================New Subrogation Creation Associated With Claim Is Started Here=====================================================================================================================================================================================================================================================================================================================================
	parentlogger.log(LogStatus.INFO, "The Functional Utility :" +" " +RMA_GenericUsages_Utility.RMA_LoggerHyperlink("ClaimEntity", "Claim Entity Addition",0)+ " "+ "Is Called To Add Subrogation To Claim" + " "+color.RMA_ChangeColor_Utility(StrClaimNumber_335, 2));
	 testcall1 = true;
	 StrSubrogationType_340 = RMA_Functionality_Utility.RMA_ClaimEntityAddition_Utility("Subrogation", "Subrogation (0)", StrClaimNumber_335, "Not Required", RMAApp_SubrogationCreation_Txt_Type, RMAApp_SubrogationCreation_Txt_Status, RMAApp_SubrogationCreation_Txt_Date, "Not Required", "Not Required", RMAApp_SubrogationCreation_Txt_FinType, logval1);
	 parentlogger.log(LogStatus.INFO, "Following New Subrogation Is Created Successfully::"+ " " + color.RMA_ChangeColor_Utility(StrSubrogationType_340, 2));
	 loggerval1 = logger.toString();
	 parentlogger.appendChild(logger);
	 parentlogger.log(LogStatus.INFO, parentlogger.addScreenCapture(RMA_ScreenCapture_Utility.RMA_ScreenShotCapture_Utility(driver, "Successful Subrogation Creation", StrScreenShotTCName)));
	//=========================================================== New Subrogation Creation Associated With Claim Is Completed Here=======================================================================================================================================================================================================================================================================================================================================
	
	//===========================================================Steps To Create And Edit Progress Notes Started Here==================================================================================================================================================================================================================================================================================================================================================
    StrPrimaryWindowHandle = driver.getWindowHandle();
	RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_Home.RMAApp_Generic_Img_EnhancedNotes(driver), "Enhanced Notes Image For Subrogation"+ " " + color.RMA_ChangeColor_Utility(StrSubrogationType_340, 2) + " " +" Associated With Claim:"+" "+color.RMA_ChangeColor_Utility(StrClaimNumber_335, 2), logval); // Claim ID Is Same For All Line Of Business
	...
	//===========================================================Steps To Delete Progress Notes Completed Here============================================================================================================================================================================================================================================================
		 ...
		 {
		 logger.log(LogStatus.FAIL, "Following Error Occurred  ::" + " "+  color.RMA_ChangeColor_Utility(FinalErrorMessage,1)+ " " + "While Executing Function Utility" +" "+ "RMA_ClaimEntityAddition_Utility" + " For New Subrogation Creation Associated With A Claim And Hence The Test Case Is A Fail");
		 parentlogger.appendChild(logger);
		 }
		 ...
		 System.out.println("Following Error Occurred In AfterMethod Code Block Of Test Case :" +" " +StrScreenShotTCName +" :" +" " +e.getMessage() );
		 ...
		 finally
		    {
			 try {
				...
				Date date = new Date();
				String RMAApp_SubrogationCreation_Txt_Date = dateformat.format(date);
				RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_Home.RMAApp_LeftHandNavTree_Img_ExpandCollapse(driver, RMAApp_SubrogationCreation_Txt_Date), "Expand Image Corresponding To Subrogation Link On Left Hand Navigation Tree", logval);
			 } catch (Exception|Error e) {
