...
//================================================================================================
//TestCaseID     : RMA_TC_261
//Description    : TC_261_Verify That Adding,Editing And Deleting Of Existing Employee As Person Involved For General Claim Policy
//Depends On TC  : RMA_TC_260
//Revision       : 0.0 - RenuVerma-07-29-2016 
//=================================================================================================

public class RMA_TC_261 extends RMA_TC_BaseTest {
	...
	@Test
	public void RMA_TC_261_Test() throws Exception,Error {

		try{
			parentlogger = reports.startTest("TC_261_Verify That Adding, Editing And Deleting Of Existing Employee On General Claim Policy", "Verify Adding,Editing And Deleting Of Existing Employee As Person Involved For General Claim Policy");
			parentlogger.assignAuthor("Renu Verma");

			String StrEmployeeNumber_261;
			String StrEmployeeNumberActual_261;
			String StrEmployeeLastNameActual_261;
			String StrEmployeeNameChanged_261;
			String StrGeneralClaimActual;
			String StrPrimaryWindowHandle;
			//Local Variable Declaration Completed Here
			
			StrScreenShotTCName = "TC_261";
			testcall1 = false;	
			testcall2 = false;	
			...
			testcall1 = true;
			StrEmployeeNumber_261 = RMA_Functionality_Utility.RMA_MaintEntityAddition_Utility("Employee", logval1);
			parentlogger.log(LogStatus.INFO, "Existing Employee Is Created Successfully With Employee Number::"+ " " + color.RMA_ChangeColor_Utility(StrEmployeeNumber_261, 2));
			...
			StrGeneralClaimActual = RMA_Selenium_POM_Document_GeneralClaims.RMAApp_GeneralClaim_Txt_ClaimNumber(driver).getAttribute("value");
			RMA_Verification_Utility.RMA_TextCompare(RMA_TC_260.StrClaimNumber_260, StrGeneralClaimActual, "General Claim Number", logval);
			//===============================================Search Of The General Claim Policy Created In TC_260 Is Completed=====================================================================================================

			/*================================================== Step Add Existing Employee Is On General Claim Policy--> PI Started Here================================================================*/
			...
			RMA_Functionality_Utility.RMA_StandardSearch_Window(RMA_POM_Search.RMAApp_SearchEmployee_Txt_EmployeeNumber(driver), " General Claim Policy-->PI-->Search-->Existing Employee Criteria Page","Employee Number Text Box", StrEmployeeNumber_261, StrEmployeeNumber_261, "piemployee",StrPrimaryWindowHandle, logval);
			RMA_Functionality_Utility.RMA_GenericSave_Utility("piemployee",false,"NA", "Persons Involved-->Employee Page", logval);
			StrEmployeeNumberActual_261 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_PersonInvolved.RMAApp_PIEmp_Txt_EmpNumber(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrEmployeeNumber_261, StrEmployeeNumberActual_261 , "EmployeeNumber", logval);
			...
			/*====================================================Addition Of Existing Employee On General Claim Policy Created in TC_260 Is Completed Here=======================================*/

			/*===============================================Editing Of Exiting Employee Is Started Here================================*/
			StrEmployeeNameChanged_261 = RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(4, "EmpName_261_");
			RMA_Input_Utility.RMA_SetValue_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "LastName TextBox On PI Employee Page ", StrEmployeeNameChanged_261, logval);
			RMA_Functionality_Utility.RMA_GenericSave_Utility("piemployee", false, "NA","Persons Involved-->Employee Page", logval);
			StrEmployeeLastNameActual_261 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrEmployeeNameChanged_261, StrEmployeeLastNameActual_261 , "EmployeeLast Name", logval);
			...
			parentlogger.log(LogStatus.INFO, "The Functional Utility :" +" " +"RMA_GenericDelete_Utility Is Called To Delete An Employee : " +" "+ color.RMA_ChangeColor_Utility(StrEmployeeNameChanged_261, 2));
			testcall2 = true;
			RMA_Functionality_Utility.RMA_GenericDelete_Utility("PI Employee Page", logval1);
			parentlogger.log(LogStatus.INFO, "Employee Is Deleted Successfully ::"+ " " + color.RMA_ChangeColor_Utility(StrEmployeeNameChanged_261, 2));
