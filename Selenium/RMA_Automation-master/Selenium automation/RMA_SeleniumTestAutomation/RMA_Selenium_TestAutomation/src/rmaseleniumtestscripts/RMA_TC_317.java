...
//================================================================================================================
//TestCaseID     : RMA_TC_317
//Description    : RMA_TC_317_Attachment Add, Edit & Delete On Maintenance -> Vehicle  screen
//Depends On TC  : NA
//Revision       : 0.0 - MahendraPSingh-02-24-2017
//=================================================================================================================

public class RMA_TC_317 extends RMA_TC_BaseTest {
...
@Test	
public void RMA_TC_317_Test() throws Exception, Error
  {   
	try {
		...
		parentlogger = reports.startTest("RMA_TC_317_Attachment Add, Edit & Delete On "+ " "+ color.RMA_ChangeColor_Utility("Maintenance -> Vehicle ", 3) +" " +"Screen", "Verifying Attachment Add, Edit & Delete On Maintenance -> Vehicle  screen");
	    ...
	    StrScreenShotTCName = "RMA_TC_317";
		...
		//++++++++++++++++++++++++++++++++++++++++ Attachment Add & Edit functionality on Maintenance -> Vehicle  screen is started here ++++++++++++++++++++++++++++++++++++++++++++++++	
		 RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_Home.RMAApp_Generic_Img_Attach(driver), "Attachchment document Image on Vehicle  screen", logval);
         StrPrimaryWindowHandle = driver.getWindowHandle();
         RMA_GenericUsages_Utility.RMA_WindowSwitching_Utility();
		 parentlogger.log(LogStatus.INFO, "Following Function Is Called :: Attachment_Add_Edit_Email_Delete To Verify Attachment Add & Edit On Maintenance -> Vehicle  screen");
		 testcall2 = true;
		 RMA_Functionality_Utility.RMA_Attachment_Add_Edit_Delete("Add_Edit", PhysicalPath, FileSize, false, logval1);
		 parentlogger.log(LogStatus.INFO, "Attachment Add & Edit Functionality is verified on Maintenance -> Vehicle  screen");
		 loggerval2 = logger.toString();
		 parentlogger.appendChild(logger);
	
	    //++++++++++++++++++++++++++++++++++++++++ Attachment Add & Edit functionality on Maintenance -> Vehicle  screen is finished here ++++++++++++++++++++++++++++++++++++++++++++++++	
		 
		//++++++++++++++++++++++++++++++++++++++++ Attachment Delete functionality on Maintenance -> Vehicle  screen is started here ++++++++++++++++++++++++++++++++++++++++++++++++	
	     
	     parentlogger.log(LogStatus.INFO, "Following Function Is Called :: Attachment_Add_Edit_Email_Delete To Verify Attachment Delete On Maintenance -> Vehicle  screen");
	     testcall3 = true;
	     RMA_Functionality_Utility.RMA_Attachment_Add_Edit_Delete("Delete", PhysicalPath, FileSize, false, logval1);
	     parentlogger.log(LogStatus.INFO, "Attachment Delete Functionality is verified on Maintenance -> Vehicle  screen");
	     loggerval3 = logger.toString();
	     parentlogger.appendChild(logger);
	    
	     driver.close();
		 driver.switchTo().window(StrPrimaryWindowHandle);	
	   //++++++++++++++++++++++++++++++++++++++++++ Attachment Delete functionality on Maintenance -> Vehicle  screen is finished here ++++++++++++++++++++++++++++++++++++++++++++++++	
		 ...
		 {
		 logger.log(LogStatus.FAIL, "Following Error Occurred  ::" + " "+  color.RMA_ChangeColor_Utility(FinalErrorMessage,1)+ " " + "While Executing Function Utility" +" "+ "RMA_MaintenanceVehicle_AddEdit_Utility" + " " +  "And Hence The Test Case Is A Fail");
		 parentlogger.appendChild(logger);
		 }
