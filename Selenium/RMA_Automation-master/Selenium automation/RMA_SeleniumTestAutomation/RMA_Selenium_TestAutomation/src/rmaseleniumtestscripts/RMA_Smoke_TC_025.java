...
//Description    : RMA_Smoke_TC_025_Verify That Enhanced Notes Can Be Created,Edited And Deleted Successfully From Claim Page
...
public class RMA_Smoke_TC_025 extends RMA_TC_BaseTest {
	...
	public void RMA_TC_025_Test() throws Exception,Error {
		...
		try{
			parentlogger = reports.startTest("RMA_Smoke_TC_025_Enhanced Notes Create, Edit And Delete", "Verify That Enhanced Notes Can Be Created,Edited And Deleted Successfully From Claim Page");
			...
			StrScreenShotTCName = "Smoke_TC_025";
			testcall1 = false;	
			testcall2 = false;
