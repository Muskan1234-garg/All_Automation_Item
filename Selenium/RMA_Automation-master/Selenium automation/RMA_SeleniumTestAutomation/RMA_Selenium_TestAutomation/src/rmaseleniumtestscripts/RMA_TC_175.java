...
//================================================================================================
//TestCaseID     : RMA_TC_175
//Description    : TC_175_Verify Adding,Editing And Deleting Of Existing Employee As Person Involved For WC Claim
//Depends On TC  : RMA_TC_174
//Revision       : 0.0 - ImteyazAhmad-07-08-2016 
//=================================================================================================

public class RMA_TC_175 extends RMA_TC_BaseTest {
	...
	@Test
	public void RMA_TC_175_Test() throws Exception,Error {

		try{
			parentlogger = reports.startTest("TC_175_Adding, Editing And Deleting Of Existing Employee", "Verify Adding,Editing And Deleting Of Existing Employee As Person Involved  For Workers Comp Claim");
			parentlogger.assignAuthor("Imteyaz Ahmad");

			String StrEmployeeNumber_175;
			String StrEmployeeNumberActual_175;
			String StrPrimaryWindowHandle;
			String StrEmployeeLastNameActual_175;
			String StrEmployeeNameChanged;
			String StrClaimNaumberActual;

			//Local Variable Declaration Completed Here

			StrScreenShotTCName = "TC_175";
			testcall1 = false;	
			testcall2 = false;	
			...
			testcall1 = true;
			StrEmployeeNumber_175 = RMA_Functionality_Utility.RMA_MaintEntityAddition_Utility("Employee", logval1);
			parentlogger.log(LogStatus.INFO, "New Employee Is Created Successfully With Employee Number::"+ " " + color.RMA_ChangeColor_Utility(StrEmployeeNumber_175, 2));
			...
			RMA_Functionality_Utility.RMA_StandardSearch_Window(RMA_POM_Search.RMAApp_SearchEmployee_Txt_EmployeeNumber(driver), "Standard Employee Search Page", "EmployeeNumber TextBox", StrEmployeeNumber_175, StrEmployeeNumber_175, "piemployee", StrPrimaryWindowHandle, logval);
			...
			StrEmployeeNumberActual_175 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_PersonInvolved.RMAApp_PIEmp_Txt_EmpNumber(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrEmployeeNumber_175, StrEmployeeNumberActual_175 , "EmployeeNumber", logval);
			...
			StrEmployeeLastNameActual_175 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrEmployeeNameChanged, StrEmployeeLastNameActual_175 , "EmployeeLast Name", logval);
