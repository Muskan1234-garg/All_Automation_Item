...
//================================================================================================
//TestCaseID     : RMA_TC_156
//Description    : TC_156_Verify Adding,Editing And Deleting Of New Physician As Person Involved In Litigation For Vehicle Accident Claim
//Depends On TC  : RMA_TC_150
//Revision       : 0.0 - KumudNaithani-07-07-2016 
//=================================================================================================

public class RMA_TC_156 extends RMA_TC_BaseTest {
	...
	@Test
	public void RMA_TC_156_Test() throws Exception,Error {

		try{
			parentlogger = reports.startTest("TC_156_Adding, Editing And Deleting Of New Physician", "Verify Adding,Editing And Deleting Of New Physician As Person Involved In Litigation For Vehicle Accident Claim");
			parentlogger.assignAuthor("Kumud Naithani");

			String StrPhysicianLastName_156;
			String StrPhysicianLastNameActual_156;
			String StrPhysicianLastNameChanged;

			StrScreenShotTCName = "TC_156";
			testcall1 = false;	
			testcall2 = false;	
			...
			RMA_Navigation_Utility.RMA_ObjectClick(RMA_Selenium_POM_Home.RMAApp_LeftHandNavTree_Img_ExpandCollapse(driver, "Vehicle"), "Expand Image Corresponding To Vehicle Accident  Link On Left Navigation Tree", logval);
			RMA_GenericUsages_Utility.RMA_StaticWait(5, logval, "Wait Is Added As Expand Image Corresponding To Vehicle Accident Link On Left Navigation Tree Is Clicked ");
			...
			testcall1 = true;
			StrPhysicianLastName_156 = RMA_Functionality_Utility.RMA_PIAddNewEntity_Utility("Physician", logval1);
			parentlogger.log(LogStatus.INFO, "New Physician Is Created Successfully With Physician Last Name::"+ " " + color.RMA_ChangeColor_Utility(StrPhysicianLastName_156, 2));
			parentlogger.log(LogStatus.INFO, parentlogger.addScreenCapture(RMA_ScreenCapture_Utility.RMA_ScreenShotCapture_Utility(driver, "Creation Of New Physician Is Successful", StrScreenShotTCName)));
			loggerval1 = logger.toString();
			parentlogger.appendChild(logger);
			//===============================================Steps To Create A New Physician Completed============================================================================================================================================
			
			/*===============================================Editing Of New Physician Is Started Here=======================================================================*/
			StrPhysicianLastNameChanged = RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(4, "Physician_TC_156_");
			...
			StrPhysicianLastNameActual_156 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Maintenance.RMAApp_MaintPhysician_Txt_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrPhysicianLastNameChanged, StrPhysicianLastNameActual_156 , "Physician Last Name", logval);
