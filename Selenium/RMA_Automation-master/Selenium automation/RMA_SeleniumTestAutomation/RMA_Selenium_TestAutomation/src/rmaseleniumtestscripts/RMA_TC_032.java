...
//===============================================================================================================================================================================================================================================================================================================================================================
//TestCaseId     : RMA_TC_032
//Description    : Verify that hold transaction (Created in TC_029) is not listed in current adjuster's list.
...
public class RMA_TC_032 extends RMA_TC_BaseTest {
	...
	@Test
	public void RMA_TC_032_Test() throws Exception,Error
	//Verify that hold transaction (Created in TC_029) is not listed in current adjuster's list.
	{
		try
		{
			parentlogger = reports.startTest("TC_032_Hold Transaction Not Listed in Current Adjuster's list","Verify that hold transaction (Created in TC_029) is not listed in current adjuster's list.");
			String StrAccept;
			...
			RMAApp_Login_Txt_UserName = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_032", 1, 0); //UserName Fetched From DataSheet RMA_TC_032
			RMAApp_Login_Txt_Password = ExcelData.RMA_ExcelStringDataRead_Utility("RMA_TC_032", 1, 1); //Password Fetched From DataSheet RMA_TC_032
