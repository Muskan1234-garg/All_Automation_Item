...
//================================================================================================
//TestCaseID     : RMA_TC_155
//Description    : TC_155_Verify Adding,Editing And Deleting Of New Patient As Person Involved In Litigation For Vehicle Accident Claim
//Depends On TC  : RMA_TC_150
//Revision       : 0.0 - KumudNaithani-06-29-2016 
//=================================================================================================

public class RMA_TC_155 extends RMA_TC_BaseTest {
	...
	@Test
	public void RMA_TC_155_Test() throws Exception,Error {

		try{
			parentlogger = reports.startTest("TC_155_Adding, Editing And Deleting Of New Patient", "Verify Adding,Editing And Deleting Of New Patient As Person Involved In Litigation For Vehicle Accident Claim");
			parentlogger.assignAuthor("Kumud Naithani");

			String StrPatientLastName_155;
			String StrPatientLastNameActual_155;
			String StrPatientLastNameChanged;

			StrScreenShotTCName = "TC_155";
			testcall1 = false;	
			testcall2 = false;	
			...
			RMA_Functionality_Utility.RMA_StandardSearch_Screen(RMA_POM_Search.RMAApp_SearchClaims_Txt_ClaimNumber(driver), "Search => Claim Page ", "Claim Number TextBox", RMA_TC_150.StrClaimNumber_RMA_TC_150, RMA_TC_150.StrClaimNumber_RMA_TC_150, "Vehicle Accident", "num", 2, logval);
			...
			testcall1 = true;
			StrPatientLastName_155 = RMA_Functionality_Utility.RMA_PIAddNewEntity_Utility("Patient", logval1);
			parentlogger.log(LogStatus.INFO, "New Patient Is Created Successfully With Patient Last Name::"+ " " + color.RMA_ChangeColor_Utility(StrPatientLastName_155, 2));
			parentlogger.log(LogStatus.INFO, parentlogger.addScreenCapture(RMA_ScreenCapture_Utility.RMA_ScreenShotCapture_Utility(driver, "Creation Of New Patient Is Successful", StrScreenShotTCName)));
			loggerval1 = logger.toString();
			parentlogger.appendChild(logger);
			//===============================================Steps To Create A New Patient Completed============================================================================================================================================*/
			
			/*===============================================Editing Of New Patient Is Started Here============================================================================================================================================*/
			StrPatientLastNameChanged = RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(4, "Patient_TC_155_");
			...
			StrPatientLastNameActual_155 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrPatientLastNameChanged, StrPatientLastNameActual_155 , "Patient Last Name", logval);
