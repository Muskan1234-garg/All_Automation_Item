...
//==========================================================================================================================================================================================================================================================================================================================================================
//TestCaseID     : RMA_TC_037
//Description    : Listing Of Transaction Created In RMA_TC_036 In Pending Transaction's Submitted Column For Login User's Manager Is Validated 
//Depends On TC  : TC_011, TC_035, TC_036
...
public class RMA_TC_037 extends rmaseleniumtestscripts.RMA_TC_BaseTest {
...
@Test 
public void RMA_TC_037_Test () throws Exception, Error 
//Listing Of Transaction Created In RMA_TC_036 In Pending Transaction's Submitted Column For Login User's Manager Is Validated 	
{
	try {
		logger = reports.startTest("TC_037_Listing Of Transactions In Submitted Pending Transactions", "Listing Of Transactions In Submitted Pending Transactions For Login User's Manager Is Validated");
		
		String StrExpSubmittedVal;
		//Local Variable Declaration
		
		StrExpSubmittedVal = "loginmgr1";
		...
		RMA_Input_Utility.RMA_SetValue_Utility(RMA_Selenium_POM_Funds_SprApproval.RMAApp_SprApproval_Txt_UXPymntGridFilterTxtBox(driver,2,"Control Number",2), "Control Number Filter TextBox On Payment Tab  On Supervisory Approval Page", RMA_TC_036.StrControlNumber_RMA_TC_036, logval1);
		...
		RMA_Verification_Utility.RMA_VerifyUXGridSingleText_Utility(RMA_TC_036.StrControlNumber_RMA_TC_036, "Pending Payments Grid In Supervisory Approval Page", StrExpSubmittedVal, 7, logval1);
