...
//================================================================================================
//TestCaseID     : RMA_TC_176
//Description    : TC_176_Verify Adding,Editing And Deleting Of Existing Medical Staff As Person Involved For WC Claim
//Depends On TC  : RMA_TC_174
//Revision       : 0.0 - ImteyazAhmad-07-13-2016 
//=================================================================================================

public class RMA_TC_176 extends RMA_TC_BaseTest {
	...
	@Test
	public void RMA_TC_176_Test() throws Exception,Error {

		try{
			parentlogger = reports.startTest("TC_176_Adding, Editing And Deleting Of Existing Medical Staff", "Verify Adding,Editing And Deleting Of Existing Medical Staff As Person Involved For Workers Comp Claim");
			parentlogger.assignAuthor("Imteyaz Ahmad");

			String StrMedicalStaff_176;
			String StrPrimaryWindowHandle;
			String StrMedicalLastNameActual_176;
			String StrMedicalStaffNameChanged;
			String StrClaimNaumberActual;
			//Local Variable Declaration Completed Here

			StrScreenShotTCName = "TC_176";
			testcall1 = false;	
			testcall2 = false;	
			...
			testcall1 = true;
			StrMedicalStaff_176 = RMA_Functionality_Utility.RMA_MaintEntityAddition_Utility("MedicalStaff", logval1);
			parentlogger.log(LogStatus.INFO, "New Medical Staff Is Created Successfully With Name::"+ " " + color.RMA_ChangeColor_Utility(StrMedicalStaff_176, 2));
			...
			RMA_Functionality_Utility.RMA_StandardSearch_Window(RMA_POM_Search.RMAApp_Search_Txt_MedicalStaffLastName(driver), "Medical Staff Search Page", "Medical Staff Last Name TextBox", StrMedicalStaff_176, StrMedicalStaff_176, "pimedstaff", StrPrimaryWindowHandle, logval);
			...
			StrMedicalLastNameActual_176 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrMedicalStaff_176, StrMedicalLastNameActual_176 , "Medical Staff Last Name", logval);
			...
			StrMedicalStaffNameChanged = RMA_GenericUsages_Utility.RMA_RandomStringGeneration_Utility(4, StrMedicalStaff_176);
			...
			RMA_GenericUsages_Utility.RMA_DynamicFrameSwitching("pimedstaff");
			StrMedicalLastNameActual_176 = RMA_Verification_Utility.RMA_AttributeFetch_Utility(RMA_Selenium_POM_Home.RMAApp_Generic_LastName(driver), "value");
			RMA_Verification_Utility.RMA_TextCompare(StrMedicalStaffNameChanged, StrMedicalLastNameActual_176 , "Medical Staff Last Name", logval);
