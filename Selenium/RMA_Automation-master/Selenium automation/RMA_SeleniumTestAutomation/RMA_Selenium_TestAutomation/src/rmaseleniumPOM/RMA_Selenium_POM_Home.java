...
public class RMA_Selenium_POM_Home {
	...
	public static WebElement RMAApp_Genereic_UX_ToastMessage(WebDriver driver,String Message)
	{
		WebElement Element = null;
		try {
			//Element = driver.findElement(By.xpath(".//*[@class='toast toast-error']//following::*[contains(text(),'"+ErrorMessage+"')]  or .//*[@class='toast-message']//following::*[contains(text(),'"+ErrorMessage+"')]")); //Unique className Of Toast Error Message On RMA Application UX Page Is Fetched	
			Element = driver.findElement(By.xpath(".//*[@class='toast-message']//following::*[contains(text(),'"+Message+"')]")); //Unique className Of Toast Message On RMA Application UX Page Is Fetched
		} catch (Exception|Error e) {	
		}
		return Element;	
	}
