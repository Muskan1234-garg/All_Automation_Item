...
{
	Element = driver.findElement(By.id("btnRoll")); //Unique Id Of Delete Button On Alert Message On RMA Application Progress Notes Page Is Fetched
	return Element;
}
...
{
	Element = driver.findElement(By.id("btnCancel")); //Unique Id Of Cancel Button On Alert Message On RMA Application Progress Notes Page Is Fetched
	return Element;
}
