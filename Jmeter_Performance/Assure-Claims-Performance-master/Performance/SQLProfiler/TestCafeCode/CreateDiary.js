...
dataSet.forEach(data => {
    test('CreateDiary', async t => {
        ...
        await t
            ...
            .click(Selector('[role="menuitem"]').withExactText('Diaries'))
            .click(Selector('[role="menuitem"]').withExactText('Diary List'))
        ...
        console.log("Diary: " + TaskName.green + " Not found in the List.Testcase Successful".red);
