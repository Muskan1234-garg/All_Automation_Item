...
class AssureClaims_Maintenance_Functionality_Utility{
    constructor(){}
...
async AssureClaims_PolicyTrackingCreation_ClientProgram(Premium,InternalPolicyStatus,InternalPolicyLOB,InternalInsurer,InternalInsured,InternalInsured1,InternalCoverageType,InternalPolicyLimit,InternalPolicyMco,ClientProgramName,SyndicateName,UMRNumber) 
{
    ...
    await In_Utility.AssureClaims_SetValue_Utility(PolicyTracking.AssureClaims_Policy_Txt_PolicyNameSearch,ClientProgramName,"Client ProgramName Search")
...
return PolicyName;
    ...
    //Description      : Utility for creating Entity, Employee, Driver, Medical Staff, Patient, Physician, Witness for ERON
    //Input Parameters : EntityType-->Which entity user want to create, ReqParam--> Entity type,ReqParam1--> Name of entity,
    //ReqParam2,ReqParam3-->other required parameter as per user requirement
    //Revision	       : 0.0 Muskan Garg 8/2/2023
    //**********************************************************************************************************************************************************
    async AssureClaims_MaintenanceAddNewEntity_ERON_Utility(EntityType, ReqParam, ReqParam1, ReqParam2, ReqParam3) {
        ...
        switch (EntityType) {
            ...
            case "Entity":
                ...
                await Nav_Utility.AssureClaims_ElementClick_Utility(Entity_POM.AsssureClaims_Maintenence_Lst_EntityType.find('option').withAttribute('label', ReqParam), "Entity Type")
                await In_Utility.AssureClaims_SetValue_Utility(Entity_POM.AsssureClaims_EntityCreation_Txt_EntityLastname, ReqParam1, "Entity lastname textbox")
                if (ReqParam2 != "NA") {
                    await In_Utility.AssureClaims_ElementWebListSelect_Utility(Entity_POM.AsssureClaims_Manitenance_Lst_IDType, ReqParam2, "ID Type")
                    await In_Utility.AssureClaims_SetValue_Utility(Entity_POM.AsssureClaims_Manitenance_Txt_SSNTxt, ReqParam3, "SSN textbox")
                }
		await t.wait(2000)	
            ...
            case "Employee":
                ...
                await In_Utility.AssureClaims_SetValue_Utility(Entity_POM.AsssureClaims_EmployeeManitenance_Txt_EmployeenumberTxt, ReqParam, "Employee number textbox")
                await Nav_Utility.AssureClaims_ElementClick_Utility(Home_POM.AssureClaims_GerericTabs_Tab_Accordians.withText("Employment Info"), " Employment Info tab")
                await In_Utility.AssureClaims_SetValue_Utility(Entity_POM.AsssureClaims_EmployeeManitenance_Txt_DepartmentTxt, ReqParam1, "Department txt")
                await t.pressKey('tab')
		await t.wait(2000)
                await Nav_Utility.AssureClaims_ElementClick_Utility(Home_POM.AssureClaims_Generic_Img_Save, "Save button")
                break;
            ...
            //===========================Driver creation, started here==================================================================================================================================================================================================================
            case "Driver":
                await Nav_Utility.AssureClaims_ElementClick_Utility(Entity_POM.AsssureClaims_EntityCreation_Btn_DriverInfo, "Driver info tab")
                await t.switchToMainWindow();
                await Generic_Utility.AssureClaims_DynamicFrameSwitching(Verification_Msg.AssureCliams_MaintenanceERON_EnityIframe);
                await In_Utility.AssureClaims_ElementWebListSelectInteger_Utility(Entity_POM.AsssureClaims_DriverManitenance_Lst_TypeOfDriver, 1, "Driver Type");
                await t.wait(2000)
		await Nav_Utility.AssureClaims_ElementClick_Utility(Home_POM.AssureClaims_Generic_Img_Save, "Save button")
                break;
            //===========================Driver creation, ended here==================================================================================================================================================================================================================

            //===========================MedicalStaff creation, started here==================================================================================================================================================================================================================
            case "Medical Staff":
                await Nav_Utility.AssureClaims_ElementClick_Utility(Entity_POM.AsssureClaims_EntityCreation_Btn_MedStaffInfo, "Medical Staff tab")
                await t.switchToMainWindow();
                await Generic_Utility.AssureClaims_DynamicFrameSwitching(Verification_Msg.AssureCliams_MaintenanceERON_EnityIframe);
                await In_Utility.AssureClaims_SetValue_Utility(Entity_POM.AsssureClaims_MedStaffCreation_Txt_StaffNumber, ReqParam, ReqParam + " : Medical staff number")
                await t.wait(2000)
		await Nav_Utility.AssureClaims_ElementClick_Utility(Home_POM.AssureClaims_Generic_Img_Save, "Save button")
                break;
            //===========================MediclaStaff creation, ended here==================================================================================================================================================================================================================

            //===========================Patient creation, started here==================================================================================================================================================================================================================
            case "Patient":
                await Nav_Utility.AssureClaims_ElementClick_Utility(Entity_POM.AsssureClaims_Manitenance_Lst_List, "List")
                await Nav_Utility.AssureClaims_ElementClick_Utility(Entity_POM.AsssureClaims_EntityCreation_Btn_PatientInfo, "Patient Info Button")
                await t.switchToMainWindow();
                await Generic_Utility.AssureClaims_DynamicFrameSwitching(Verification_Msg.AssureCliams_MaintenanceERON_EnityIframe);
                await Nav_Utility.AssureClaims_ElementClick_Utility(Entity_POM.AsssureClaims_PatientManitenance_Btn_MaritalStatusLookup, "Marital status Lookup")
                await Nav_Utility.AssureClaims_ElementClick_Utility(Home_POM.AssureClaims_GenericLnk_Lnk_LnkforSelectValueFromLookUp.withText(ReqParam), "Select Marital Status")
                await t.wait(2000)
		await Nav_Utility.AssureClaims_ElementClick_Utility(Home_POM.AssureClaims_Generic_Img_Save, "Save button")
                break;
            //===========================Patient creation, ended here==================================================================================================================================================================================================================

            //===========================Physician creation, started here==================================================================================================================================================================================================================
            case "Physician":
                await Nav_Utility.AssureClaims_ElementClick_Utility(Entity_POM.AsssureClaims_Manitenance_Lst_List, "List")
                await Nav_Utility.AssureClaims_ElementClick_Utility(Entity_POM.AsssureClaims_EntityCreation_Btn_PhysicianInfo, "Physician Info Button")
                await t.switchToMainWindow();
                await Generic_Utility.AssureClaims_DynamicFrameSwitching(Verification_Msg.AssureCliams_MaintenanceERON_EnityIframe);
                await In_Utility.AssureClaims_SetValue_Utility(Entity_POM.AsssureClaims_PhysicianManitenance_Txt_PhyscianNumber, ReqParam, "Physician Number Text")
                await t.wait(2000)
		await Nav_Utility.AssureClaims_ElementClick_Utility(Home_POM.AssureClaims_Generic_Img_Save, "Save button")
                break;
            //===========================Physician creation, ended here==================================================================================================================================================================================================================

            //===========================Witness creation, started here==================================================================================================================================================================================================================
            case "Witness":case "Judges":case "Attorneys":case "Adjusters":
                await Nav_Utility.AssureClaims_MenuOptionClick_Utility("Maintenance:Entity");
                await Generic_Utility.AssureClaims_DynamicFrameSwitching(Verification_Msg.AssureClaims_Generic_EntityFrame);
                await Nav_Utility.AssureClaims_ElementClick_Utility(Entity_POM.AsssureClaims_Maintenence_Lst_EntityType, "Entity Type")
                await Nav_Utility.AssureClaims_ElementClick_Utility(Entity_POM.AsssureClaims_Maintenence_Lst_EntityType.find('option').withAttribute('label', ReqParam), "Entity Type")
                ...
                await In_Utility.AssureClaims_SetValue_Utility(Home_POM.AssureClaims_GenericTxt_Txt_DescriptionTextboxOnLookup.nth(1), ReqParam2, "Type Entity Catrgory")
    ...
    //**********************************************************************************************************************************************************
    //JIRA ID OF STORY : RMA-97293
    //Description      : Search "Entity, Employee, Driver, Medical Staff, Patient, Physician, Witness" and delete it according to passed parameter "intFlag"
    //Input Parameters : EntityType-->Which entity user want to search, strEntityName--> name of entity,intFlag=0 indicates user don't want to delete searched entity,
    //Revision	       : 0.0 Muskan Garg 8/2/2023
    //************************************************************************************************************************************************************
    async AssureClaims_SearchEntity_Utility(EntityType, strEntityName, intFlag) {

        switch (EntityType) {

            case "Entity":
                //===========================Search Entity,started here==================================================================================================================================================================================================================
                await t.switchToMainWindow()
                await Nav_Utility.AssureClaims_MenuOptionClick_Utility("Search:Entity");
                await Generic_Utility.AssureClaims_DynamicFrameSwitching(Verification_Msg.AssureClaims_MaintenanceERON_SearchEntityFrame);
                await t.wait(3000)
                ...
                await t.wait(4000)
                await Generic_Utility.AssureClaims_DynamicFrameSwitching(Verification_Msg.AssureCliams_MaintenanceERON_EnityIframe);
                //===========================Search Entity,ended here==================================================================================================================================================================================================================

                //===========================Delete Searched Entity,started here==================================================================================================================================================================================================================
                if (intFlag != 0) {
                ...
                //===========================Delete Searched Entity,ended here==================================================================================================================================================================================================================
                break;

            case "Employee":
                //===========================Search Employee,started here==================================================================================================================================================================================================================
                await t.switchToMainWindow()
                ...
                await t.wait(4000)
                await Generic_Utility.AssureClaims_DynamicFrameSwitching(Verification_Msg.AssureCliams_MaintenanceERON_EnityIframe);
                //===========================Search Employee,ended here==================================================================================================================================================================================================================
               
                //===========================Delete Searched Employee,started here==================================================================================================================================================================================================================
                if (intFlag != 0) {
                    await Nav_Utility.AssureClaims_ElementClick_Utility(Home_POM.AssureClaims_Generic_Img_DeleteRecord, "Delete employee");
                    await Nav_Utility.AssureClaims_ElementClick_Utility(Home_POM.AssureClaims_Generic_Img_DeleteOK, "Ok button");
                    await t.wait(5000)
                }
                //===========================Delete Searched Employee,ended here==================================================================================================================================================================================================================
                break;

            case "Driver":
                //===========================Search Driver,started here==================================================================================================================================================================================================================
                await t.switchToMainWindow()
                await Nav_Utility.AssureClaims_MenuOptionClick_Utility("Search:Driver");
                await Generic_Utility.AssureClaims_DynamicFrameSwitching(Verification_Msg.AssuereClaim_Search_DriverIframe);
                await In_Utility.AssureClaims_SetValue_Utility(Search_POM.AssureClaims_Search_Txt_DriverLastName, strEntityName, "Entity LastName")
                await Nav_Utility.AssureClaims_ElementClick_Utility(Search_POM.AssureClaims_Search_Btn_SubmitQuery, "SubmitQuery")
                await t.wait(3000)
                await t.switchToMainWindow();
                await Generic_Utility.AssureClaims_DynamicFrameSwitching(Verification_Msg.AssuereClaim_SearchResult_DriverIframe);
                await Nav_Utility.AssureClaims_ElementClick_Utility(Search_POM.AssureClaims_Search_Lnk_GenericLinkOverSearchScreen.nth(0), "Entity LastName link")
                await t.switchToMainWindow()
                await t.wait(4000)
                await Generic_Utility.AssureClaims_DynamicFrameSwitching(Verification_Msg.AssureCliams_MaintenanceERON_EnityIframe);
                //===========================Search Driver,ended here==================================================================================================================================================================================================================
               
                //===========================Delete Searched Driver,started here==================================================================================================================================================================================================================
                if (intFlag != 0) {
                    await Nav_Utility.AssureClaims_ElementClick_Utility(Home_POM.AssureClaims_Generic_Img_DeleteRecord, "Delete driver");
                    await Nav_Utility.AssureClaims_ElementClick_Utility(Home_POM.AssureClaims_Generic_Img_DeleteOK, "Ok button");
                    await t.wait(5000)
                }
                //===========================Delete Searched Driver,ended here==================================================================================================================================================================================================================
                break;

            case "Medical Staff":
                //===========================Search MedicalStaff,started here==================================================================================================================================================================================================================
                await t.switchToMainWindow()
                ...
                await In_Utility.AssureClaims_SetValue_Utility(Search_POM.AssureClaims_Search_Txt_MedStaffLastName, strEntityName, "Entity LastName")
                await Nav_Utility.AssureClaims_ElementClick_Utility(Search_POM.AssureClaims_Search_Btn_SubmitQuery, "SubmitQuery")
                await t.wait(3000)
                await t.switchToMainWindow();
                ...
                await t.wait(4000)
                await Generic_Utility.AssureClaims_DynamicFrameSwitching(Verification_Msg.AssureCliams_MaintenanceERON_EnityIframe);
                //===========================Search MedicalStaff,ended here==================================================================================================================================================================================================================
                
                //===========================Delete Searched MedicalStaff,started here==================================================================================================================================================================================================================
                if (intFlag != 0) {
                    await Nav_Utility.AssureClaims_ElementClick_Utility(Home_POM.AssureClaims_Generic_Img_DeleteRecord, "Delete medicalstaff");
                    await Nav_Utility.AssureClaims_ElementClick_Utility(Home_POM.AssureClaims_Generic_Img_DeleteOK, "Ok button");
                    await t.wait(5000)
                }
                //===========================Delete Searched MedicalStaff,ended here==================================================================================================================================================================================================================
                break;

            case "Patient":
                //===========================Search Patient,started here==================================================================================================================================================================================================================
                await t.switchToMainWindow()
                await Nav_Utility.AssureClaims_MenuOptionClick_Utility("Search:Patient");
                await Generic_Utility.AssureClaims_DynamicFrameSwitching(Verification_Msg.AssuereClaim_Search_PatientIframe);
                await In_Utility.AssureClaims_SetValue_Utility(Search_POM.AssureClaims_Search_Txt_PatientLastName, strEntityName, "Entity LastName")
                await Nav_Utility.AssureClaims_ElementClick_Utility(Search_POM.AssureClaims_Search_Btn_SubmitQuery, "SubmitQuery")
                await t.wait(3000)
                await t.switchToMainWindow();
                await Generic_Utility.AssureClaims_DynamicFrameSwitching(Verification_Msg.AssuereClaim_SearchResult_PatientIframe);
                await Nav_Utility.AssureClaims_ElementClick_Utility(Search_POM.AssureClaims_Search_Lnk_GenericLinkOverSearchScreen.nth(0), "Entity LastName link")
                console.log("Search is Completed");
                await t.switchToMainWindow()
                await t.wait(4000)
                await Generic_Utility.AssureClaims_DynamicFrameSwitching(Verification_Msg.AssureCliams_MaintenanceERON_EnityIframe);
                //===========================Search Patient,ended here==================================================================================================================================================================================================================
                
                //===========================Delete Searched Patient,started here==================================================================================================================================================================================================================
                if (intFlag != 0) {
                    await Nav_Utility.AssureClaims_ElementClick_Utility(Home_POM.AssureClaims_Generic_Img_DeleteRecord, "Delete patient");
                    await Nav_Utility.AssureClaims_ElementClick_Utility(Home_POM.AssureClaims_Generic_Img_DeleteOK, "Ok button");
                    await t.wait(5000)
                }
                //===========================Delete Searched Patient,ended here==================================================================================================================================================================================================================
                break;

            case "Physician":
                //===========================Search Physician,started here==================================================================================================================================================================================================================
                await t.switchToMainWindow()
                await Nav_Utility.AssureClaims_MenuOptionClick_Utility("Search:Physician");
                await Generic_Utility.AssureClaims_DynamicFrameSwitching(Verification_Msg.AssuereClaim_Search_PhysicianIframe);
                await In_Utility.AssureClaims_SetValue_Utility(Search_POM.AssureClaims_Search_Txt_PhysicianLastName, strEntityName, "Entity LastName")
                await Nav_Utility.AssureClaims_ElementClick_Utility(Search_POM.AssureClaims_Search_Btn_SubmitQuery, "SubmitQuery")
                await t.wait(3000)
                await t.switchToMainWindow();
                await Generic_Utility.AssureClaims_DynamicFrameSwitching(Verification_Msg.AssuereClaim_SearchResult_PhysicianIframe);
                await Nav_Utility.AssureClaims_ElementClick_Utility(Search_POM.AssureClaims_Search_Lnk_GenericLinkOverSearchScreen.nth(0), "Entity LastName link")
                console.log("Search is Completed");
                await t.switchToMainWindow()
                await t.wait(4000)
                await Generic_Utility.AssureClaims_DynamicFrameSwitching(Verification_Msg.AssureCliams_MaintenanceERON_EnityIframe);
                //===========================Search Physician,ended here==================================================================================================================================================================================================================
              
                //===========================Delete Searched Physician,started here==================================================================================================================================================================================================================
                if (intFlag != 0) {
                    await Nav_Utility.AssureClaims_ElementClick_Utility(Home_POM.AssureClaims_Generic_Img_DeleteRecord, "Delete physician");
                    await Nav_Utility.AssureClaims_ElementClick_Utility(Home_POM.AssureClaims_Generic_Img_DeleteOK, "Ok button");
                    await t.wait(5000)
                }
                //===========================Delete Searched Physician,ended here==================================================================================================================================================================================================================
                break;
...
export default AssureClaims_Maintenance_Functionality_Utility;
