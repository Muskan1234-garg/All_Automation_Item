...
//Description      : ExhSmoke_LifeClaim
...
DataIUT.forEach(data => {
  ...
  //Searching LifeClaimNumber
  //Payee Creation On Created Claim
  //Verification That All Tabs Are Present For Payee
  //Payee Edit & Delete On Created Claim
  test('PayeeCreateEditDelete_Test_02', async t => {
    ...
    //================================================================Verification If All Tabs Are Present For Payee Screen===============================================================
  ...
  //Searching LifeClaimNumber
  //Adding Party As PI On LC Claim Creation
  test('AssureClaims_PersonInvolved_Test_03', async t => {
    await t.wait(5000)
    //======================================================Muskan's Code :RMA-97695 Claim search started here===================================================================================================================
    await Function_Utility.AssureClaims_GenericSearch_Utility('ClaimZone', 'Claim', StrLifeClaimNumber, "NA");
    //======================================================Muskan's Code :RMA-97695 Claim search started completed here=========================================================================================================(StrLifeClaimNumber)
    await Generic_Utility.AssureClaims_DynamicFrameSwitching(Verification_Msg.AssureClaims_LifeClaim_ClaimLCIframe)
  ...
  //Searching LifeClaimNumber
  //Including Coverage On  LC Claim Creation
  ...
  //Searching LifeClaimNumber
  //Adding Designation on Life Claim
