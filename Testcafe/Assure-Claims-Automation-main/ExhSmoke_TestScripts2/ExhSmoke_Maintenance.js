...
import AssureClaims_Maintenance_Functionality_Utility_Sec_Exh from '../Functional_Utilities/Maintenance_Functionality_Utility_Sec_Exh';
...
const Maint_Utility = new AssureClaims_Maintenance_Functionality_Utility_Sec_Exh();
...
//Description      : ExhSmoke_Maintenance
//AUTHOR           : Saikrishan,Maddula
//DEPENDANCY       : No
// PRE-REQUISITES  : No
//Preferred Server : IUTSQL(Client)
//***********************************************************************************
...
fixture `ExhSmoke_Maintenance`.beforeEach(async t => {
  await t.setNativeDialogHandler(() => true).useRole(LoggedInUser);
  await t.wait(10000)
});
//Login In To Maintenace Zone 
//Createing Employeee
//Verification O All Tabs Present
//Editing Of Created Employee
//Deleting Of Created Employee
test('AssureClaims_Employee_Test_01', async t => {
        var Violations = "Viol"+faker.random.alphaNumeric(4).toUpperCase();
        //=======================================================New Employee Is Starts Here=================================================================================================
    ...
    //==========================================================Scrolling Ends Here====================================================================================================================
    //========================================================Verification Of All the Tabs Starts Here==============================================================================
        ...
        //========================================================Created Employee Is Edited Starts sHere==========================================================================================
        ...
        //========================================================Created Employee Is Deleted Ends Here=========================================================================================      
        //========================================================Created Employee Is Edited Starts Here==========================================================================================
...
//Createing MedicalStaff
//Verification O All Tabs Present
//Editing Of Created MedicalStaff
//Deleting Of Created MedicalStaff
test('AssureClaims_MedicalStaff_Test_02', async t => {
        var AlsoKnownAs = faker.name.firstName();
        //=========================================================New Medical Staff Starts Here==================================================================================================
        ...
        //==========================================================Verification Of All the Tabs Completed Here====================================================================================
        //==========================================================Created Medical Staff Entity Is Edited Starts Here=====================================================================================
        ...
        //==========================================================Created Medical Staff Entity Is Edited Ends Here=====================================================================================
        //==========================================================Created Medical Staff Entity Is Deleted Starts Here=====================================================================================       
        ...
        //==========================================================Created Medical Staff Entity Is Deleted Ends Here=====================================================================================       
});
//Createing PatientTracking
//Verification O All Tabs Present
//Editing Of Created PatientTracking
//Deleting Of Created PatientTracking
test('AssureClaims_PatientTracking_Test_03', async t => {
        var MedRecordNumber = faker.name.firstName();
        //=========================================================================New Patient Starts Here=================================================================================================
        ...
        //==============================================================Verification Of All the Tabs Completed Here===============================================================================================
        //=================================================================Created Patient Entity Is Starts Here===================================================================================================
        ...
        //=================================================================Created Patient Entity Is Edited Ends Here===================================================================================================
        //==================================================================Created Patient Entity Is Deleted Starts Here==================================================================================================       
        ...
        //==================================================================Created Patient Entity Is Deleted Ends Here==================================================================================================       
});
//Createing Driver
//Verification O All Tabs Present
//Editing Of Created Driver
//Deleting Of Created Driver
test('AssureClaims_Driver_Test_04', async t => {
        ...
        //======================================================================Verification Of All the Tabs Completed Here============================================================================================
        //=====================================================================Created Driver Entity Is Edited Starts Here=====================================================================================================
        ...
        //=====================================================================Created Driver Entity Is Edited Ends Here=====================================================================================================
        //======================================================================Created Driver Entity Is Deleted Starts Here=================================================================================================== 
        ...
        await t.setNativeDialogHandler(() => true).useRole(LoggedInUser);
        //======================================================================Created Driver Entity Is Deleted Ends Here=================================================================================================== 
...
test("AssureClaims_Entity_Test_05", async t=>{
    ...
    //==========================================================Scrolling Ends Here====================================================================================================================
    //====================================================================Created Entity Is Edited Starts Here====================================================================================================
        ...
        //====================================================================Created Entity Is Edited Ends Here====================================================================================================
        //====================================================================Created Entity Is Deleted Starts Here===================================================================================================
        ...
        await t.setNativeDialogHandler(() => true).useRole(LoggedInUser);
        //====================================================================Created Entity Is Deleted Ends Here===================================================================================================
});
//Createing Driver
//Verification O All Tabs Present
//Editing Of Created Driver
...
test('AssureClaims_Vehicle_Test_06', async t => {
        ...
        //=================================================================New Vehicle Ends Here===============================================================================================================
        //==================================================================Created Vehicle Is Edited Starts Here=======================================================================================================
        ...
        //==================================================================Created Vehicle Is Edited Ends Here=======================================================================================================
        //==================================================================Created Vehicle Is Deleted Starts Here=======================================================================================================      
        ...
        //==================================================================Created Vehicle Is Deleted Ends Here=======================================================================================================      
});
