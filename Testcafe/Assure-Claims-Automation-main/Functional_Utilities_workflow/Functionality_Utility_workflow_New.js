...
import POM_Workflow_Generic from '../Functional_POM/POM_Workflow_Generic';
import GenericUsages_Utility from './GenericUsages_Utility_workflow';
import Input_Utility from './Input_Utility_workflow_new';
import Navigation_Utility from './Navigation_Utility_workflow';
import Verification_Utility from './Verification_Utility_workflow_new';
...
const POM_Workflow_Generic_POM = new POM_Workflow_Generic();

var faker = require('faker');

class Functionality_Utility {
    constructor() { }
    async AssureClaims_LoginIntoApplication_Utility(Username, Password, DSN, Zone) {
        ...
        await In_Utility.AssureClaims_SetValue_Utility(POM_LoginPOM.AssureClaims_Login_LoginPasswordTextbox, Password, "Password Textbox")
    ...
    async AssureClaims_GeneralClaimCreation(GenClaimCreation_Txt_DateOfClaim, GenClaimCreation_Txt_DateOfEvent, GenClaimCreation_Txt_ClaimStatus, GenClaimCreation_Txt_ClaimType, GenClaimCreation_Txt_Department, GenClaimCreation_Txt_PolicyLOB) {
        await Nav_Utility.AssureClaims_MenuOptionClick_Utility("Document:General Claim");
        ...
        const ele2 = Generic_Claims.AssureClaims_GenericClaim_Lnk_SelectClaimType.withText(GenClaimCreation_Txt_ClaimType).with({ visibilityCheck: true })
        ...
        const ele3 = Generic_Claims.AssureClaims_GenericClaim_Lnk_SelectPolicyLOB.withText(GenClaimCreation_Txt_PolicyLOB).with({ visibilityCheck: true })
    ...
    async AssureClaims_LifeClaimCreation(LifeClaimCreation_Txt_DateOfClaim, LifeClaimCreation_Txt_DateOfEvent, LifeClaimCreation_Txt_ClaimStatus,
        ...
        await Nav_Utility.AssureClaims_MenuOptionClick_Utility("Document:Life Claim");
        ...
        const ele2 = Life_Claims.AssureClaims_LifeClaim_Lnk_SelectClaimType.withText(LifeClaimCreation_Txt_ClaimType).with({ visibilityCheck: true })
        await t.expect(ele2.exists).ok('', { timeout: 20000 })
        await Nav_Utility.AssureClaims_ElementClick_Utility(ele2, "Claim Type Option")
        ...
        const ele3 = Life_Claims.AssureClaims_LifeClaim_Lnk_SelectPolicyLOB.withText(LifeClaimCreation_Txt_PolicyLOB).with({ visibilityCheck: true })
        await t.expect(ele3.exists).ok('', { timeout: 20000 })
        await Nav_Utility.AssureClaims_ElementClick_Utility(ele3, "Policy LOB Option")
        ...
        await t.wait(2000)
        await In_Utility.AssureClaims_SetValue_Utility(Life_Claims.AssureClaims_LifeClaim_Lnk_PolicySearch, "27NRMARC2 08 PHMI", "Policy Name Is Searched")
    ...
    async AssureClaims_PropertyClaimCreation(PropertyClaimCreation_Txt_DateOfClaim, PropertyClaimCreation_Txt_DateOfEvent, PropertyClaimCreation_Txt_ClaimStatus, PropertyClaimCreation_Txt_ClaimType, PropertyClaimCreation_Txt_Department, PropertyClaimCreation_Txt_PolicyLOB, PropertyId) {
        await Nav_Utility.AssureClaims_MenuOptionClick_Utility("Document:Property Claim")
        ...
        const ele_PCType = Property_Claims.AssureClaims_PropertyClaim_Lnk_SelectClaimType.withText(PropertyClaimCreation_Txt_ClaimType).with({ visibilityCheck: true })
        ...
        const elePCPolicyLOB = Property_Claims.AssureClaims_PropertyClaim_Lnk_SelectPolicyLOB.withText(PropertyClaimCreation_Txt_PolicyLOB).with({ visibilityCheck: true })
    ...
    async AssureClaims_EventCreation(EventCreation_Txt_DateOfEvent, EventCreation_Txt_DateReported, EventCreation_Txt_EventStatus, EventCreation_Txt_EventType, EventCreation_Txt_Department) {
        var StrEventNumber;
        await Nav_Utility.AssureClaims_MenuOptionClick_Utility("Document:Event")
        ...
        await In_Utility.AssureClaims_SetValue_Utility(Event_POM.AssureClaims_EventCreation_Txt_EventStatus, EventCreation_Txt_EventStatus, "Event Status")
        ...
        await In_Utility.AssureClaims_SetValue_Utility(Event_POM.AssureClaims_EventCreation_Txt_EventType, EventCreation_Txt_EventType, "Event Type")
    ...
    async AssureClaims_VehicleAccidentClaimCreation(VAClaimCreation_Txt_DateOfClaim, VAClaimCreation_Txt_DateOfEvent, VAClaimCreation_Txt_ClaimStatus, VAClaimCreation_Txt_ClaimType, VAClaimCreation_Txt_Department, VAClaimCreation_Txt_PolicyLOB) {
        await Nav_Utility.AssureClaims_MenuOptionClick_Utility("Document:Vehicle Accident");
        ...
        const ele_VehClaimType = Vehicle_Accident.AssureClaims_VehicleAccidentClaim_Lnk_SelectClaimType.withText(VAClaimCreation_Txt_ClaimType).with({ visibilityCheck: true })
        ...
        const ele_VehPolicyLOB = Vehicle_Accident.AssureClaims_VehicleAccidentClaim_Lnk_SelectPolicyLOB.withText(VAClaimCreation_Txt_PolicyLOB).with({ visibilityCheck: true })
    ...
    async AssureClaims_WorkersCompClaimCreation(WCClaimCreation_Txt_DateOfClaim, WCClaimCreation_Txt_DateOfEvent, WCClaimCreation_Txt_ClaimStatus, WCClaimCreation_Txt_ClaimType, WCClaimCreation_Txt_Department, WCClaimCreation_Txt_PolicyLOB, WCClaimCreation_Txt_Jurisdiction) {
        await Nav_Utility.AssureClaims_MenuOptionClick_Utility("Document:Workers’ Comp");
        ...
        const ele2_WCClaimType = WorkersComp_Claims.AssureClaims_WorkersComp_Claims_Lnk_SelectClaimType.withText(WCClaimCreation_Txt_ClaimType).with({ visibilityCheck: true })
        ...
        const ele3_WCPolicyLOB = WorkersComp_Claims.AssureClaims_WorkersComp_Claims_Lnk_SelectPolicyLOB.withText(WCClaimCreation_Txt_PolicyLOB).with({ visibilityCheck: true })
        ...
        await In_Utility.AssureClaims_SetValue_Utility(WorkersComp_Claims.AssureClaims_WorkersComp_Claims__Select_EmployeeNum, "12345", "Empolyee Number")
        await t.pressKey('tab')
    ...
    async AssureClaims_PaymentCorpAddition_Utility(BankAccount, payeetype, lastname, reservetype, transactiontype, amounttype) {
    ...
    async AssureClaims_CarrierGCClaimCreation(GenClaimCreation_Txt_DateOfEvent, GenClaimCreation_Txt_DateOfClaim, GenClaimCreation_Txt_ClaimType, GenClaimCreation_Txt_ClaimStatus, GenClaimCreation_Txt_Department, GenClaimCreation_Txt_PolicyLOB, GenClaimCreation_Lst_PolicySystem, PolicyName) {
        ...
        await In_Utility.AssureClaims_SetValue_Utility(Generic_Claims.AssureClaims_GenericClaim_Txt_ClaimType, 'PROD', "Claim type")
        await t.pressKey('tab')
    ...
    async AssureClaims_CarrierReserveAddition_Utility(ReserveAmount, LossType, ReserveUnit, CoverageType, ReserveStatus, ReserveType) {
        await Nav_Utility.AssureClaims_ElementClick_Utility(Reserve_Utility.AssureClaims_SelectFinancialReserve, "Click On Financial Reserve")
        await t.wait(12000)
        await Nav_Utility.AssureClaims_ElementClick_Utility(Reserve_Utility.AssureClaims_ReserveCreation_Btn_AddReserve, "Add Reserve")
  ...
  */
    ...
    async AssureClaims_Funds_Transaction_Creation(ClaimNumber, DetailedTrackingClaimant, BankAccount, payeetype, lastname, reservetype, transactiontype, AmountType) {
        ...
        await Nav_Utility.AssureClaims_ElementClick_Utility(Payment_POM.AssureClaims_PaymentCollection_Btn_AddNewFunds, "Add New Funds Button On Payment Creation Screen")
        if (DetailedTrackingClaimant != 'NA') {
            await In_Utility.AssureClaims_ElementWebListSelect_Utility(Payment_POM.AssureClaims_FundsSplitDetails_Lst_FundPolicy, 'STest565464', "Bank Account On Payment Creation Screen")
            await In_Utility.AssureClaims_ElementWebListSelect_Utility(Payment_POM.AssureClaims_FundsSplitDetails_Lst_FundUnit, '0000078', "Bank Account On Payment Creation Screen")
            await In_Utility.AssureClaims_ElementWebListSelect_Utility(Payment_POM.AssureClaims_FundsSplitDetails_Lst_FundCoverageType, '101 Auto Bodily Injury', "Bank Account On Payment Creation Screen")
            await In_Utility.AssureClaims_ElementWebListSelect_Utility(Payment_POM.AssureClaims_FundsSplitDetails_Lst_FundLossType, 'NEWCODE', "Bank Account On Payment Creation Screen")
    ...
    async AssureClaims_EnhancedNotesCreateEditDelete_Utility(Case, NoteText, NoteType, EditNoteText) {
        ...
        switch (Case) {
            case "Create/Edit":
                ...
                const ColValue3 = [NoteType]
                await Verify_Utility.AssureClaims_VerifyUXGrid_Utility(NoteType, "EnhanceNotes grid view", ColHeader3, ColValue3)
                break;
    ...
    async AssureClaims_SearchClaim(StrClaimNumber) {
    ...
    async AssureClaims_NonOccClaimCreation(NonOcc_DateOfEvent, NonOcc_DateOfClaim, NonOcc_ClaimStatus, NonOcc_ClaimType, NonOcc_Department, NonOcc_PolicyLOB, NonOcc_EmployeeNo, NonOcc_Jurisdiction, PlanName, ClassName, DateHired, MonthlyRate) {
        ...
        await Nav_Utility.AssureClaims_MenuOptionClick_Utility("Document:Non-occupational");
        await t.switchToMainWindow()
        await t.wait(8000)
        ...
        await Nav_Utility.AssureClaims_ElementClick_Utility(Generic_Claims.AssureClaims_GenericClaim_Btn_ClaimType, "Claim Type Lookup")
        const ele2_NonOcc_ClaimType = Generic_Claims.AssureClaims_GenericClaim_Lnk_SelectClaimType.withText(NonOcc_ClaimType).with({ visibilityCheck: true })
    ...
    async AssureClaims_LoginIntoApplicationWorkflow_Utility(Username, Password) {
        await t.wait(4000)
        await In_Utility.AssureClaims_SetValue_Utility(POM_WorkflowLogin_POM.AssureClaims_WorkflowLogin_LoginUserNameTextbox, Username, "UserName Textbox")
        await t.pressKey('tab')
        await In_Utility.AssureClaims_SetValue_Utility(POM_WorkflowLogin_POM.AssureClaims_WorkflowLogin_LoginPasswordTextbox, Password, "Password Textbox")
        await t.pressKey('enter')
        await t.wait(4000)
        // await In_Utility.AssureClaims_SetValue_Utility(POM_WorkflowLogin_POM.AssureClaims_WorkflowMenu_SearchBox, "Configure Workflows", "Search Box")
        //        await Nav_Utility.AssureClaims_ElementClick_Utility(POM_WorkflowLogin_POM.AssureClaims_WorkflowLogin_Modulename, "Module")
        //  await Nav_Utility.AssureClaims_ElementClick_Utility_test(POM_WorkflowLogin_POM.AssureClaims_WorkflowLogin_Modulename, "p", "Configure Workflows", "Configure Workflows", "Menu")
        //   .expect(Selector(POM_WorkflowLogin_POM.AssureClaims_WorkflowLogin_Headingname).withText("Workflow").exists).ok()
        //  await Nav_Utility.AssureClaims_ElementClick_Utility_test(POM_WorkflowLogin_POM.AssureClaims_ConfigureWorkflow_Buttonname, "aria-label", "Add", "Add","Configure Workflows")
        /*   await Nav_Utility.AssureClaims_ElementClick_Utility(POM_WorkflowLogin_POM.AssureClaims_WorkflowLogin_Modulename, "Module")
           await Nav_Utility.AssureClaims_ElementClick_Utility(POM_WorkflowLogin_POM.AssureClaims_WorkflowLogin_Menu,"Menu")
           await Nav_Utility.AssureClaims_ElementClick_Utility(POM_WorkflowLogin_POM.AssureClaims_WorkflowLogin_Modulename1,"Module1")
   
        //   await In_Utility.AssureClaims_ElementWebListSelect_Utility_test(POM_WorkflowLogin_POM.AssureClaims_ConfigureWorkflow_Buttonname, "Add", "Add")*/
    }
    async AssureClaims_Workflow_Menu_Item_Open_Utility(Screenname, MenuItem, Heading) {
        //Screen name  = Menu,Control Type  = menu item , Heading Name = workflow 
        /* await Nav_Utility.AssureClaims_ElementClick_Utility_test(POM_WorkflowLogin_POM.AssureClaims_WorkflowLogin_Modulename, "p", "Configure Workflows", "Configure Workflows", "Menu")
         await Nav_Utility.AssureClaims_ElementClick_Utility_test(POM_WorkflowLogin_POM.AssureClaims_ConfigureWorkflow_Buttonname, "aria-label", "Add", "Add", "Configure Workflows")
         await In_Utility.AssureClaims_SetValue_Utility(POM_Workflow_Screen_POM.AssureClaims_Workflow_Configure_Screen_NameTextbox, "Username", "Name Textbox")
         await In_Utility.AssureClaims_SetValue_Utility(POM_Workflow_Screen_POM.AssureClaims_Workflow_Configure_Screen_DescriptionTextbox, "Description", "Description Textbox")*/

        await Nav_Utility.AssureClaims_ElementClick_Utility_test(POM_WorkflowLogin_POM.AssureClaims_WorkflowLogin_Modulename, MenuItem, MenuItem, Screenname)
        //   await t.expect(Selector('#DivHeader').withText("Workflow").exists).ok()
        const ele2 = POM_WorkflowLogin_POM.AssureClaims_Workflow_Screen_Heading
        //await t.expect(ele2.exists).ok('', { timeout: 20000 })
        await t.expect((POM_WorkflowLogin_POM.AssureClaims_Workflow_Screen_Heading.withText((Heading))).exists).ok()
        // await Nav_Utility.AssureClaims_ElementClick_Utility(POM_WorkflowLogin_POM.AssureClaims_WorkflowLogin_Menu, "Menu")
        /* await Nav_Utility.AssureClaims_ElementClick_Utility_test(POM_WorkflowLogin_POM.AssureClaims_WorkflowLogin_Modulename, ControlType, ControlType, Screenname, HeadingName)
         await Nav_Utility.AssureClaims_ElementClick_Utility_test(POM_WorkflowLogin_POM.AssureClaims_ConfigureWorkflow_Buttonname, "Add", "Add", "Configure Workflows")
         await In_Utility.AssureClaims_SetValue_Utility(POM_Workflow_Screen_POM.AssureClaims_Workflow_Configure_Screen_NameTextbox, "Username", "Name Textbox")
         await In_Utility.AssureClaims_SetValue_Utility(POM_Workflow_Screen_POM.AssureClaims_Workflow_Configure_Screen_DescriptionTextbox, "Description", "Description Textbox")*/
    }

    async AssureClaims_Configure_Workflow_Utility(Case, Screenname) {
        switch (Case) {
            case "Add":
                await Nav_Utility.AssureClaims_ElementClick_Utility_test(POM_WorkflowLogin_POM.AssureClaims_ConfigureWorkflow_Buttonname, Case, Case, Screenname)
                await In_Utility.AssureClaims_SetValue_Utility(POM_Workflow_Screen_POM.AssureClaims_Workflow_Configure_Screen_NameTextbox, "Username", "Name Textbox")
                await In_Utility.AssureClaims_SetValue_Utility(POM_Workflow_Screen_POM.AssureClaims_Workflow_Configure_Screen_DescriptionTextbox, "Description", "Description Textbox")
                await Nav_Utility.AssureClaims_ElementClick_Utility(POM_Workflow_Screen_POM.AssureClaims_Workflow_Configure_Screen_SaveButton, "Save Button of Add Workflow")
                await Verify_Utility.AssureClaims_VerifyUXMessage_Workflow_Utility("Saved Successfully", false, "Add Workflow Save");
                await In_Utility.AssureClaims_SetValue_Workflow_Utility(POM_Workflow_Screen_POM.AssureClaims_Workflow_Configure_Screen_Filter, "WorkFlow Name:Username", "Filter Textbox Of Configure Workflow")
                // await Nav_Utility.AssureClaims_ElementClick_Utility(POM_Workflow_Screen_POM.AssureClaims_Workflow_Configure_Screen_Filter_row, "Filtered row of  Workflow")
                break;
            case "Edit":
                await In_Utility.AssureClaims_SetValue_Workflow_Utility(POM_Workflow_Screen_POM.AssureClaims_Workflow_Configure_Screen_Filter, "WorkFlow Name:Username", "Filter Textbox Of Configure Workflow")
                await Nav_Utility.AssureClaims_ElementClick_Utility(POM_Workflow_Screen_POM.AssureClaims_Workflow_Configure_Screen_Filter_row, "Selected Filtered row of  Workflow")
                await Nav_Utility.AssureClaims_ElementClick_Utility_test(POM_WorkflowLogin_POM.AssureClaims_ConfigureWorkflow_Buttonname, Case, Case, Screenname)
                await In_Utility.AssureClaims_SetValue_Utility(POM_Workflow_Screen_POM.AssureClaims_Workflow_Configure_Screen_NameTextbox, "Username1", "Name Textbox")
                await In_Utility.AssureClaims_SetValue_Utility(POM_Workflow_Screen_POM.AssureClaims_Workflow_Configure_Screen_DescriptionTextbox, "Description1", "Description Textbox")
                await Nav_Utility.AssureClaims_ElementClick_Utility(POM_Workflow_Screen_POM.AssureClaims_Workflow_Configure_Screen_SaveButton, "Save Button of Add Workflow")
                await Verify_Utility.AssureClaims_VerifyUXMessage_Workflow_Utility("Saved Successfully", false, "Add Workflow Save");
                await In_Utility.AssureClaims_SetValue_Workflow_Utility(POM_Workflow_Screen_POM.AssureClaims_Workflow_Configure_Screen_Filter, "WorkFlow Name:Username1", "Filter Textbox Of Configure Workflow")
        }
    }
    ...
    async AssureClaims_Workflow_Menu_Item_Open_Utility(Screenname, MenuItem, Heading, MenuCheck) {
        await Nav_Utility.AssureClaims_ElementClick_Utility_test(POM_Workflow_Generic_POM.AssureClaims_WorkflowLogin_Modulename, MenuItem, MenuItem, Screenname)
        const ele2 = POM_Workflow_Generic_POM.AssureClaims_Workflow_Screen_Heading
        await t.expect((POM_Workflow_Generic_POM.AssureClaims_Workflow_Screen_Heading.withText((Heading))).exists).ok()
        await t.wait(6000)
        if (MenuCheck === 'YES') {
            await Nav_Utility.AssureClaims_ElementClick_Utility(POM_Workflow_Generic_POM.AssureClaims_WorkflowLogin_Menu, "Menu")
        }
    }

    async AssureClaims_Configure_Workflow_Utility(Case, Screenname, Workflow_Name, Workflow_Description) {
        switch (Case) {
            case "Add":
                await Nav_Utility.AssureClaims_ElementClick_Utility(POM_Workflow_Screen_POM.AssureClaims_Workflow_Configure_Screen_Grid_Refresh_Button, "Grid refresh")
                await Nav_Utility.AssureClaims_ElementClick_Utility_test(POM_WorkflowLogin_POM.AssureClaims_ConfigureWorkflow_Buttonname, Case, Case, Screenname)
                await In_Utility.AssureClaims_SetValue_Utility(POM_Workflow_Screen_POM.AssureClaims_Workflow_Configure_Screen_NameTextbox, Workflow_Name, "Name Textbox")
                await In_Utility.AssureClaims_SetValue_Utility(POM_Workflow_Screen_POM.AssureClaims_Workflow_Configure_Screen_DescriptionTextbox, Workflow_Description, "Description Textbox")
                await Nav_Utility.AssureClaims_ElementClick_Utility(POM_Workflow_Screen_POM.AssureClaims_Workflow_Configure_Screen_SaveButton, "Save Button of Add Workflow")
                await Verify_Utility.AssureClaims_VerifyUXMessage_Workflow_Utility("Saved Successfully", false, "Add Workflow Save");
                await In_Utility.AssureClaims_SetValue_Workflow_Utility(POM_Workflow_Generic_POM.AssureClaims_Workflow_Configure_Screen_Filter, "WorkFlow Name:" + Workflow_Name, "Filter Textbox Of Configure Workflow")
                await Nav_Utility.AssureClaims_ElementClick_Utility(POM_Workflow_Screen_POM.AssureClaims_Workflow_Configure_Screen_Grid_Refresh_Button, "Grid refresh")
                break;
            case "Edit":
                await In_Utility.AssureClaims_SetValue_Workflow_Utility(POM_Workflow_Generic_POM.AssureClaims_Workflow_Configure_Screen_Filter, "WorkFlow Name:" + Workflow_Name, "Filter Textbox Of Configure Workflow")
                await Nav_Utility.AssureClaims_ElementClick_Utility(POM_Workflow_Screen_POM.AssureClaims_Workflow_Configure_Screen_Filter_row, "Selected Filtered row of  Workflow")
                await Nav_Utility.AssureClaims_ElementClick_Utility_test(POM_WorkflowLogin_POM.AssureClaims_ConfigureWorkflow_Buttonname, Case, Case, Screenname)
                await In_Utility.AssureClaims_SetValue_Utility(POM_Workflow_Screen_POM.AssureClaims_Workflow_Configure_Screen_NameTextbox, Workflow_Name + "_Edit", "Name Textbox")
                await In_Utility.AssureClaims_SetValue_Utility(POM_Workflow_Screen_POM.AssureClaims_Workflow_Configure_Screen_DescriptionTextbox, Workflow_Description + "_Edit", "Description Textbox")
                await Nav_Utility.AssureClaims_ElementClick_Utility(POM_Workflow_Screen_POM.AssureClaims_Workflow_Configure_Screen_SaveButton, "Save Button of Add Workflow")
                await Verify_Utility.AssureClaims_VerifyUXMessage_Workflow_Utility("Saved Successfully", false, "Add Workflow Save");
                await Nav_Utility.AssureClaims_ElementClick_Utility(POM_Workflow_Screen_POM.AssureClaims_Workflow_Configure_Screen_Grid_Refresh_Button, "Grid refresh")
                await In_Utility.AssureClaims_SetValue_Workflow_Utility(POM_Workflow_Generic_POM.AssureClaims_Workflow_Configure_Screen_Filter, "WorkFlow Name:" + Workflow_Name + "_Edit", "Filter Textbox Of Configure Workflow")
                await Nav_Utility.AssureClaims_ElementClick_Utility(POM_Workflow_Screen_POM.AssureClaims_Workflow_Configure_Screen_Grid_Refresh_Button, "Grid refresh")
                break;
            case "Delete":
                await In_Utility.AssureClaims_SetValue_Workflow_Utility(POM_Workflow_Generic_POM.AssureClaims_Workflow_Configure_Screen_Filter, "WorkFlow Name:" + Workflow_Name, "Filter Textbox Of Configure Workflow")
                await Nav_Utility.AssureClaims_ElementClick_Utility(POM_Workflow_Screen_POM.AssureClaims_Workflow_Configure_Screen_Filter_row, "Selected Filtered row of  Workflow")
                await Nav_Utility.AssureClaims_ElementClick_Utility_test(POM_WorkflowLogin_POM.AssureClaims_ConfigureWorkflow_Buttonname, Case, Case, Screenname)
                await Nav_Utility.AssureClaims_ElementClick_Utility(POM_Workflow_Screen_POM.AssureClaims_Workflow_Configure_Screen_Confirmation_popup_ok_button, "Ok Button of Delete Confirmation Popup")
                await Verify_Utility.AssureClaims_VerifyUXMessage_Workflow_Utility("Deleted Successfully", false, "Delete Workflow Message");
                break;
            case "Configure Workflow":
                ...
                await Nav_Utility.AssureClaims_ElementClick_Utility(POM_Workflow_Screen_POM.AssureClaims_Workflow_Configure_Screen_Filter_row, "Selected Filtered row of  Workflow")
                await Nav_Utility.AssureClaims_ElementClick_Utility_test(POM_WorkflowLogin_POM.AssureClaims_ConfigureWorkflow_Buttonname, Case, Case, Screenname)
                await t.expect((POM_Workflow_Screen_POM.AssureClaims_Workflow_Configure_Step_Screen_Header.withText(("Configure Workflow - Workflow Steps (" + Workflow_Name))).exists).ok()
                break;
        }
    }


    async AssureClaims_Configure_Workflow_Steps_Utility(Case, Screenname, Workflow_Name, Workflow_Step1, Workflow_Step2, User1, User2, Group1, Document_Type) {
        switch (Case) {
            case "Add":
                await t.wait(4000)
                await Nav_Utility.AssureClaims_ElementClick_Utility_test(POM_Workflow_Screen_POM.AssureClaims_ConfigureWorkflow_Step_Screen_Buttonname, Case, Case, Screenname)
                await In_Utility.AssureClaims_SetValue_Utility(POM_Workflow_Screen_POM.AssureClaims_Workflow_Configure_Step_Screen_Step_DetailTextbox, Workflow_Step1, "Step Detail Textbox")
                await In_Utility.AssureClaims_SetValue_Utility(POM_Workflow_Screen_POM.AssureClaims_Workflow_Configure_Step_Screen_instructionsTextbox, Workflow_Step1, "Instruction Textbox")




                await In_Utility.AssureClaims_ElementMultitSelect_Workflow_Utility_Test2(POM_Workflow_Generic_POM.AssureClaims_Workflow_Configure_Step_Screen_Trigger_Add_rule_Dropdown, User1, "Assign User Dropdown on Step Screen", POM_Workflow_Generic_POM.AssureClaims_ConfigureWorkflow_Step_Screen_Multiselect, "Select assignee", POM_Workflow_Generic_POM.AssureClaims_ConfigureWorkflow_Step_Screen_Searchtext_Textbox, "Search assignee", Case)
                await In_Utility.AssureClaims_ElementMultitSelect_Workflow_Utility_Test2(POM_Workflow_Generic_POM.AssureClaims_Workflow_Configure_Step_Screen_Trigger_Add_rule_Dropdown, Group1, "Assign Group Dropdown on Step Screen", POM_Workflow_Generic_POM.AssureClaims_ConfigureWorkflow_Step_Screen_Multiselect, "Select group", POM_Workflow_Generic_POM.AssureClaims_ConfigureWorkflow_Step_Screen_Searchtext_Textbox, "Search group", Case)



                await Nav_Utility.AssureClaims_ElementClick_Utility(POM_Workflow_Screen_POM.AssureClaims_Workflow_Configure_Screen_SaveButton, "Save Button of Steps Add Window")
                await Verify_Utility.AssureClaims_VerifyUXMessage_Workflow_Utility("Saved Successfully", false, "Add Workflow Step Save Functionality");
                await In_Utility.AssureClaims_SetValue_Workflow_Utility(POM_Workflow_Generic_POM.AssureClaims_Workflow_Configure_Screen_Filter, "Step Details:" + Workflow_Step1, "Filter Textbox Of Step Screen")
                await Nav_Utility.AssureClaims_ElementClick_Utility(POM_Workflow_Screen_POM.AssureClaims_Workflow_Configure_Screen_Grid_Refresh_Button, "Grid refresh")
                await Nav_Utility.AssureClaims_ElementClick_Utility_test(POM_Workflow_Screen_POM.AssureClaims_ConfigureWorkflow_Step_Screen_Buttonname, Case, Case, Screenname)
                await In_Utility.AssureClaims_SetValue_Utility(POM_Workflow_Screen_POM.AssureClaims_Workflow_Configure_Step_Screen_Step_DetailTextbox, Workflow_Step2, "Step Detail Textbox")
                await In_Utility.AssureClaims_SetValue_Utility(POM_Workflow_Screen_POM.AssureClaims_Workflow_Configure_Step_Screen_instructionsTextbox, Workflow_Step2, "Instruction Textbox")




                await In_Utility.AssureClaims_ElementMultitSelect_Workflow_Utility_Test2(POM_Workflow_Generic_POM.AssureClaims_Workflow_Configure_Step_Screen_Trigger_Add_rule_Dropdown, User2, "Assign User Dropdown on Step Screen", POM_Workflow_Generic_POM.AssureClaims_ConfigureWorkflow_Step_Screen_Multiselect, "Select assignee", POM_Workflow_Generic_POM.AssureClaims_ConfigureWorkflow_Step_Screen_Searchtext_Textbox, "Search assignee",Case)
                ...
                await Nav_Utility.AssureClaims_ElementClick_Utility(POM_Workflow_Screen_POM.AssureClaims_Workflow_Configure_Screen_SaveButton, "Save Button of Steps Add Window")
                await Verify_Utility.AssureClaims_VerifyUXMessage_Workflow_Utility("Saved Successfully", false, "Add Workflow Step Save Functionality");
                await In_Utility.AssureClaims_SetValue_Workflow_Utility(POM_Workflow_Generic_POM.AssureClaims_Workflow_Configure_Screen_Filter, "Step Details:" + Workflow_Step2, "Filter Textbox Of Step Screen")
                break;
            case "Start trigger condition":
                await Nav_Utility.AssureClaims_ElementClick_Utility_test(POM_Workflow_Screen_POM.AssureClaims_ConfigureWorkflow_Step_Screen_Buttonname, Case, Case, Screenname)
                await t.expect((POM_Workflow_Screen_POM.AssureClaims_Workflow_Configure_Step_Screen_Popup_Heading.withText(("Add Start Trigger Condition (" + Workflow_Name))).exists).ok()
                break;
            case "Add Rule":
                await Nav_Utility.AssureClaims_ElementClick_Utility_test(POM_Workflow_Screen_POM.AssureClaims_ConfigureWorkflow_Step_Screen_Buttonname, Case, Case, Screenname)


                await In_Utility.AssureClaims_ElementMultitSelect_Workflow_Utility_Test2(POM_Workflow_Generic_POM.AssureClaims_Workflow_Configure_Step_Screen_Trigger_Add_rule_Dropdown, Document_Type, "Trigger Rule Dropdown on Step Screen", POM_Workflow_Generic_POM.AssureClaims_ConfigureWorkflow_Step_Screen_Multiselect, "Select Document Type", POM_Workflow_Generic_POM.AssureClaims_ConfigureWorkflow_Step_Screen_Searchtext_Textbox, "Search from records", Case)


                await Nav_Utility.AssureClaims_ElementClick_Utility(POM_Workflow_Screen_POM.AssureClaims_Workflow_Configure_Screen_SaveButton, "Save Button of Trigger Screen")
                await Verify_Utility.AssureClaims_VerifyUXMessage_Workflow_Utility("Rule saved successfully", false, "Trigger Add Rule Functionality");
                break;
            case "Delete Rule":
                await Nav_Utility.AssureClaims_ElementClick_Utility_test(POM_Workflow_Screen_POM.AssureClaims_Workflow_Configure_Step_Screen_Trigger_Add_Rule_Button, "Delete", "Delete", Screenname)
                await Verify_Utility.AssureClaims_VerifyUXMessage_Workflow_Utility("Deleted Successfully", false, "Delete Trigger Condition Message");
                break;
        }
    }
    ...
    async AssureClaims_Document_Upload_Workflow_Utility(Case, Screenname, FileName, Heading, Record_Type, Document_Type, Recordnumber, Workflowname) {
        switch (Case) {
            case "Upload Documents":
                await t.wait(8000)
                await t.setFilesToUpload(POM_Workflow_Screen_POM.AssureClaims_Workflow_Initiate_Document_Screen_File_Upload, ['./upload/' + FileName])
                await Nav_Utility.AssureClaims_ElementClick_Utility(POM_Workflow_Screen_POM.AssureClaims_Workflow_Initiate_Document_Screen_Upload_Button, "Upload button of Intitiate Document Workflow Screen")
                await Verify_Utility.AssureClaims_VerifyUXMessage_Workflow_Utility("Record uploaded Successfully.", false, "File Upload Message Of Intitiate Document Workflow Screen");
                await Nav_Utility.AssureClaims_ElementClick_Utility(POM_Workflow_Screen_POM.AssureClaims_Workflow_Initiate_Document_Screen_Finish_button, "Finish Button of Upload Window On Initiate Document Workflow Screen")
                break;
            case "Archive":
                await In_Utility.AssureClaims_SetValue_Workflow_Utility(POM_Workflow_Generic_POM.AssureClaims_Workflow_Configure_Screen_Filter, "Name:" + FileName, "Filter Textbox Of Intitiate Document Workflow Screen")
                await Nav_Utility.AssureClaims_ElementClick_Utility(POM_Workflow_Screen_POM.AssureClaims_Workflow_Configure_Screen_Filter_row, "Selected Filtered row of Initiate Document Workflow Screen")
                await Nav_Utility.AssureClaims_ElementClick_Utility_test(POM_Workflow_Screen_POM.AssureClaims_ConfigureWorkflow_Step_Screen_Buttonname, Case, Case, Screenname)
                await Verify_Utility.AssureClaims_VerifyUXMessage_Workflow_Utility("Document moved successfully.", false, "File Moved To Archive Folder.");
                break;
            case "Associate Documents":
                ...
                await Nav_Utility.AssureClaims_ElementClick_Utility(POM_Workflow_Screen_POM.AssureClaims_Workflow_Configure_Screen_Filter_row, "Selected Filtered row of Initiate Document Workflow Screen")
                await Nav_Utility.AssureClaims_ElementClick_Utility_test(POM_Workflow_Screen_POM.AssureClaims_ConfigureWorkflow_Step_Screen_Buttonname, Case, Case, Screenname)
                await t.expect((POM_Workflow_Screen_POM.AssureClaims_Workflow_Configure_Step_Screen_Header.withText(("Associate Documents"))).exists).ok()


                await In_Utility.AssureClaims_ElementMultitSelect_Workflow_Utility_Test2(POM_Workflow_Generic_POM.AssureClaims_Workflow_Configure_Step_Screen_Trigger_Add_rule_Dropdown, Record_Type, "Record Locator Type On Associate Documents Screen", POM_Workflow_Generic_POM.AssureClaims_ConfigureWorkflow_Step_Screen_Multiselect, "Select record locator type", POM_Workflow_Screen_POM.AssureClaims_ConfigureWorkflow_Step_Screen_searchtext_record, "Search", Case)
                await In_Utility.AssureClaims_ElementMultitSelect_Workflow_Utility_Test2(POM_Workflow_Generic_POM.AssureClaims_Workflow_Configure_Step_Screen_Trigger_Add_rule_Dropdown, Document_Type, "Document Type On Associate Documents Screen", POM_Workflow_Generic_POM.AssureClaims_ConfigureWorkflow_Step_Screen_Multiselect, "Select document type", POM_Workflow_Screen_POM.AssureClaims_ConfigureWorkflow_Step_Screen_searchtext_doc, "Search", Case)




                await Nav_Utility.AssureClaims_ElementClick_Utility(POM_Workflow_Screen_POM.AssureClaims_Workflow_Associate_Document_Screen_Next_Button, "Next Button On Associate Document Screen")
                await In_Utility.AssureClaims_SetValue_Utility(POM_Workflow_Screen_POM.AssureClaims_Workflow_Associate_Document_Screen_Event_Number_Textbox, Recordnumber, "Event Number entered in Event Number Textbox In Search Tab")
                await Nav_Utility.AssureClaims_ElementClick_Utility(POM_Workflow_Screen_POM.AssureClaims_Workflow_Associate_Document_Screen_Search_Button, "Search Button On Associate Document Screen")
                await Nav_Utility.AssureClaims_ElementClick_Utility(POM_Workflow_Screen_POM.AssureClaims_Workflow_Configure_Screen_Filter_row, "Selected Filtered row of Associate Document Screen")
                await Nav_Utility.AssureClaims_ElementClick_Utility(POM_Workflow_Screen_POM.AssureClaims_Workflow_Associate_Document_Screen_Attach_Button, "Attach Button On Associate Document Screen")
                await this.AssureClaims_Confirmation_Popup_Workflow_Utility("Confirmation", "Confirmation", "Are you sure? You wish to continue.", "OK")

                await In_Utility.AssureClaims_ElementMultitSelect_Workflow_Utility_Test2(POM_Workflow_Generic_POM.AssureClaims_Workflow_Configure_Step_Screen_Trigger_Add_rule_Dropdown, Workflowname, "Select Workflow to Attach Document On Associate Documents Screen", POM_Workflow_Generic_POM.AssureClaims_ConfigureWorkflow_Step_Screen_Multiselect, "Select", POM_Workflow_Screen_POM.AssureClaims_ConfigureWorkflow_Step_Screen_searchtext_attach, "Search", Case)


                await Nav_Utility.AssureClaims_ElementClick_Utility(POM_Workflow_Screen_POM.AssureClaims_Workflow_attach1, "Attach Button On Associate Document Screen")
                await Verify_Utility.AssureClaims_VerifyUXMessage_Workflow_Utility("Document linked to Workflow Successfully.", false, "File associated to Record Successfully on Associate Document Screen");
        }
    }
    ...
    async AssureClaims_Confirmation_Popup_Workflow_Utility(PopupTitle, Operation_Type, Expected_Message, Action) {
        if (Operation_Type === "Confirmation") {
            await t.expect((POM_Workflow_Generic_POM.AssureClaims_Workflow_Confirmation_Popup_Heading.withText((PopupTitle))).exists).ok()
            var ActualMessage = await Verify_Utility.AssureClaims_AttributeFetch_Workflow_Utility(POM_Workflow_Generic_POM.AssureClaims_Workflow_Confirmation_Popup_message);
            console.log("ActualMessage is" + ActualMessage)
            await Verify_Utility.AssureClaims_PartialTextVerification(Expected_Message, ActualMessage, "Confirmation Message Box")
            await Nav_Utility.AssureClaims_ElementClick_Utility_test(POM_Workflow_Generic_POM.AssureClaims_Workflow_Confirmation_Button, Action, Action, PopupTitle)
        }
    }

    async AssureClaims_Closed_Workflow_Utility(Case, Grid_Name, ColHeader, ColValue, Workflow_Name, RecordNo) {
        switch (Case) {
            case "Grid Verification":
                await t.wait(8000)
                await Nav_Utility.AssureClaims_ElementClick_Utility(POM_Workflow_Screen_POM.AssureClaims_Workflow_Configure_Screen_Grid_Refresh_Button, "Grid refresh")
                await In_Utility.AssureClaims_SetValue_Workflow_Utility(POM_Workflow_Generic_POM.AssureClaims_Workflow_Configure_Screen_Filter, "Record number:" + RecordNo, "Filter Textbox Of Intitiate Document Workflow Screen")
                await Verify_Utility.AssureClaims_VerifyUXGrid_Workflow_Utility(Workflow_Name, Grid_Name, ColHeader, ColValue)
                break;
            case "History":
                await Nav_Utility.AssureClaims_ElementClick_Utility_test(POM_Workflow_Screen_POM.AssureClaims_ConfigureWorkflow_Step_Screen_Buttonname, Case, Case, Grid_Name)
                break;
        }
    }
    ...
    async AssureClaims_LogoutFromApplication_Workflow_Utility() {
        await Nav_Utility.AssureClaims_ElementClick_Utility(POM_Workflow_Generic_POM.AssureClaims_Workflow_Logout_Button, "Logout")
    }

    async AssureClaims_MyWorkflow_Approve_reject_Workflow_Utility(RecordNo, Comments, ColHeader1, ColValue1,Operation) {

        await Nav_Utility.AssureClaims_ElementClick_Utility(POM_Workflow_Screen_POM.AssureClaims_Workflow_Configure_Screen_Grid_Refresh_Button, "Grid refresh")
        await In_Utility.AssureClaims_SetValue_Workflow_Utility(POM_Workflow_Generic_POM.AssureClaims_Workflow_Configure_Screen_Filter, "Record number:" + RecordNo, "Filter Textbox Of Intitiate Document Workflow Screen")

        await Nav_Utility.AssureClaims_ElementClick_Utility(POM_Workflow_Screen_POM.AssureClaims_Workflow_Configure_Screen_Filter_row, "Selected Filtered row of Associate Document Screen")
        await Nav_Utility.AssureClaims_ElementClick_Utility(POM_Workflow_Screen_POM.AssureClaims_Workflow_MY_Workflow_Screen_Verify_Button, "Verify Document Button on My Workflow Screen")
        await In_Utility.AssureClaims_SetValue_Workflow_Utility(POM_Workflow_Screen_POM.AssureClaims_Workflow_MY_Workflow_Screen_Comments_Textarea, Comments, "Comments Field Of My Workflow Verify Document Window")
        await Nav_Utility.AssureClaims_ElementClick_Utility(POM_Workflow_Screen_POM.AssureClaims_Workflow_MY_Workflow_Screen_History_Button, "History Button Of My Workflow Verify Document Window")
        const label_val1 = await Verify_Utility.AssureClaims_AttributeFetch_Workflow_Utility(POM_Workflow_Screen_POM.AssureClaims_Workflow_MY_Workflow_Screen_History_Label)
        await Verify_Utility.AssureClaims_PartialTextVerification("Workflow History", label_val1, "My Workflow Verify Document Screen")
        await Verify_Utility.AssureClaims_TableVerifyText_Workflow_Utility(ColHeader1, ColValue1)

        if (Operation === 'Next') {

            await Nav_Utility.AssureClaims_ElementClick_Utility(POM_Workflow_Screen_POM.AssureClaims_Workflow_MY_Workflow_Screen_Next_Button, "Next Button Of My Workflow Verify Document Window")
              await this.AssureClaims_Confirmation_Popup_Workflow_Utility("Confirmation", "Confirmation", "Are you sure? You wish to continue.", "OK")
            await Verify_Utility.AssureClaims_VerifyUXMessage_Workflow_Utility("Moved to next step successfully", false, "Message after Next Button is clicked on My Workflow Verify Document Window");
        }

        if (Operation === 'Finish') {

            await Nav_Utility.AssureClaims_ElementClick_Utility(POM_Workflow_Screen_POM.AssureClaims_Workflow_MY_Workflow_Screen_Finish_Button, "Finish Button Of My Workflow Verify Document Window")
            await this.AssureClaims_Confirmation_Popup_Workflow_Utility("Confirmation", "Confirmation", "Are you sure? You wish to continue.", "OK")
            await Verify_Utility.AssureClaims_VerifyUXMessage_Workflow_Utility("Workflow ended successfully", false, "Message after Finsih Button is clicked on My Workflow Verify Document Window");
        }
...
export default Functionality_Utility;
