...
# Define the class and property you want to change
$targetClass = ".scrollbar"
$propertyToChange = "overflow-y: overlay;"
 
# Find the first occurrence of the target class and change the property
