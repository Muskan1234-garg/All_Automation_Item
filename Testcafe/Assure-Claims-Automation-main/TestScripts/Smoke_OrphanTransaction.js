...
DataIUT.forEach(data => {
    ...
    fixture`Smoke_OrphanTransaction`.beforeEach(async t => {
    ...
    test('AssureClaim_CarrierFundTransaction_Test_05', async t => {     
        ...
        await Function_Utility.AssureClaims_CarrierReserveAddition_Utility(data.ReserveAmount, data.PolicyCoverage, data.PolicyLossCode, data.PolicyUnit, data.ReserveStatus, data.ReserveType)
        ...
        console.log("AssureClaims_Funds_Transaction_Creation Function is Called To Create Reserve ".yellow);
        await t.switchToMainWindow();
        StrControlNumber2 = await Function_Utility.AssureClaims_Funds_Transaction_Creation("NA", "NA", "NA", StrClaimNumber2, 'Jerry Spiegel Associates, et al', data.BankAccount, data.PayeeType, data.LastName, data.ReserveType, data.TransactionType, data.ReserveAmount)
        console.log("Funds Transaction is Created");
