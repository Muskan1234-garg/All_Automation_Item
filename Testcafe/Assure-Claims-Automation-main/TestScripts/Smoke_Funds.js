...
DataIUT.forEach(data => {
  ...
  test('Void Payment And Orphan Transaction Test_04', async t => {
    ...
    await Function_Utility.AssureClaims_PaymentCorpAddition_Utility(StrBankAccountName1, data.PayeeType, LastName, data.TransactionType, data.PaymentAmount)
    ...
    await Function_Utility.AssureClaims_Funds_Transaction_Creation("NA", "NA", "NA", "NA", "NA", StrBankAccountName1, data.PayeeType, LastName, "NA", data.TransactionType, data.PaymentAmount)
  ...
  test('ClearCheck Test_09', async t => {
    ...
    await Function_Utility.AssureClaims_CollectionCorpAddition_Utility(StrBankAccountName1, data.PayeeType, LastName, "NA", data.TransactionType, data.PaymentAmount)
    console.log("New Payment is Createdr");
