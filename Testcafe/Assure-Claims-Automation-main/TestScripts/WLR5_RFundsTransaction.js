...
//*********************************************************************************************************************************************
//JIRA ID OF STORY : RMA-87829, RMA-87941
//Description : NONE
//AUTHOR : Muskan garg
//DEPENDANCY : Depandant on WorklossRestriction.js
//PRE-REQUISITE : turn off Case managment from utility
...
DataIUT.forEach(data => {
    ...
    fixture`WLR5_RFundsTransaction`.beforeEach(async t => {
    ...
    test('AssureClaims_WorkLoss/RestrictionFromTodate_TC_001', async t => {
        ...
        StrControlNumber = await Function_Utility.AssureClaims_Funds_WorklossTransaction_Creation(StrWCClaimNumber, data.BankAccount, data.PayeeTypeClaimant, data.ReserveType, data.RestrictionTransType, data.Amount, '1', Restrictiondate, Restrictiondate)
    ...
    test('AssureClaims_WorkLoss/RestrictionFromTodate_TC_003', async t => {
        ...
        StrControlNumber1 = await Function_Utility.AssureClaims_Funds_WorklossTransaction_Creation(StrWCClaimNumber, data.BankAccount, data.PayeeTypeClaimant, data.ReserveType, data.RestrictionTransType, data.Amount, 'NA', Restrictiondate, Restrictiondate)
    ...
    test('AssureClaims_WorkLoss/RestrictionFromTodate_TC_004', async t => {
        ...
        StrControlNumber2 = await Function_Utility.AssureClaims_Funds_WorklossTransaction_Creation(StrWCClaimNumber, data.BankAccount, data.PayeeTypeClaimant, data.ReserveType, data.RestrictionTransType, data.Amount, 'NA', d, d)
        /*=========================================================== Funds->Transaction Creation with  Different Same From & To Date --> To verify new Restriction record gets Created  ================================================================================================================================================================================================================================================================================== */
    })
    ...
    test('AssureClaims_WorkLoss/RestrictionFromTodate_TC_006', async t => {
        ...
        await Nav_Utility.AssureClaims_ElementClick_Utility(Payment_POM.AssureClaims_FundsSplitDetails_Lst_ReserveType.find('option').withText(data.ReserveType), "Reserve Type Value On Funds Split Detail Screen")
