...
//Description      : Automating Life Claim script for including coverage with Non Annuity amount for Parent child case.
//AUTHOR           : Parul Sharma
//DEPENDANCY       : None
/* PRE-REQUISITES  : None
*/
...
DataIUT.forEach(data => {
 ...
 test('AssureClaims_IncludeCoverage_test_02', async t => {
  ...
  test('AssureClaims_PersonInvolved_Test_03', async t => {
    ...
    await Function_Utility.AssureClaims_PersonInvolvedAddNewEntity_Utility("Party", "NA", "NA","NA");
    console.log("Party is added as Person Involved on Created Claim ".green);
    firstname1 = await Verify_Utility.AssureClaims_AttributeFetch_Utility(Life_Claims.AssureClaims_PIParty_Txt_FirstName,"FirstName1 Value")
    lastname1 =await Verify_Utility.AssureClaims_AttributeFetch_Utility(Life_Claims.AssureClaims_PIParty_Txt_LastName,"LastName1 Value")
    console.log("FirstName Is fetched".firstname1+lastname1)
...
/* Steps performed by AssureClaims_AddDesignation_test_04 :
        ...
        2. add new record of designee for first beneficiary
        3. Add new record of 2nd beneficiary as child of first beneficiary.
    */
  test('AssureClaims_AddDesignation_test_04', async t => {
    ...
    await t.wait(5000)
    await In_Utility.AssureClaims_ElementWebListSelect_Utility(Life_Claims.AssureClaims_Lst_PartiesInvolved,firstname1+" "+lastname1+" - Beneficiary","Party Involved On Designee Screen")
    await In_Utility.AssureClaims_ElementWebListSelect_Utility(Life_Claims.AssureClaims_Lst_Policy,data.LifePolicyName,"Policies On Designee Screen")
    await Nav_Utility.AssureClaims_ElementClick_Utility(Life_Claims.AssureClaims_Designation_Btnn_AddChildDesignee,"Child Designee Added Successfully")
    ...
    await In_Utility.AssureClaims_SetValue_Utility(Life_Claims.AssureClaims_Designee_Name_Filter,firstname1,"Second Designee Name Entered In Filter")
    
    await Nav_Utility.AssureClaims_ElementClick_Utility(Life_Claims.AssureClaims_Designation_Txt_Designee_AmountPercent,"100","Amount Field Clicked Successfully") 
    await Nav_Utility.AssureClaims_ElementClick_Utility(Life_Claims.AssureClaims_Designation_Btn_Designee_RowSave,"Save Button Is Clicked Successfully") 
