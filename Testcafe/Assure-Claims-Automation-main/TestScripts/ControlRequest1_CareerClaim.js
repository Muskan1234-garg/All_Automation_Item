...
DataAutoReg.forEach((data) => {
  ...
  fixture`ControlRequest1_CareerClaim`.beforeEach(async (t) => {
    await t.setNativeDialogHandler(() => true).useRole(LoggedInUser);
  });

  /* Steps performed by AssureClaims_CarrierGCClaimCreation_ControlRequest_Test_01 :
    1. CarrierGCClaimCreation
    2. Reserve Creation
    3. Payment Creation
    4. Print Check
...
*/
  ...
  let StrClaimNumber;
  test("AssureClaims_CarrierGCClaimCreation_ControlRequest_Test_01", async (t) => {
    ...
    await t.wait(5000)
    await Nav_Utility.AssureClaims_WebCheckBoxSelect_Utility(Deductible_POM.AssureClaims_Utility_Chk_UseReserveTypeToFilterTransactionType, "UnCheck", "Use Reserve Type To Filter Transaction Type");
    await Nav_Utility.AssureClaims_ElementClick_Utility(Home_POM.AssureClaims_Generic_Img_Save, "Click on Utilities Save Button")
