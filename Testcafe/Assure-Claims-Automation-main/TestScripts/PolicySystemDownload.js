...
//*********************************************************************************************************************************************
//JIRA ID OF STORY : RMA-85404,RMA-85690
//Description : NONE
//AUTHOR : Maddula, Sai krishna
//DEPENDANCY : No
//PRE-REQUISITE : no
//*********************************************************************************************************************************************
...
DataIUT.forEach(data => {
    ...
    fixture `PolicySystemDownload`.beforeEach(async t => {
...
test('Policy System Download Test_01', async t => { 
  ...
  await t.wait(3000)
   ...
   // await Function_Utility.AssureClaims_CarrierReserveAddition_Utility(data.AmountType,data.PolicyCoverage,data.PolicyLossCode,data.PolicyUnit,data.ReserveStatus,data.ReserveType)
    await Function_Utility.AssureClaims_UpdatedCarrierReserveAddition_Utility(1, 1, 1, 1,  data.AmountType, data.ReserveStatus);
