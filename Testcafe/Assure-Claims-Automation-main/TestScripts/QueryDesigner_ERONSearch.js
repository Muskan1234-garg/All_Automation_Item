...
const DataIUT = require('../DataFiles/DataAutoRegDSN_EntityRoleON.json');

// *******************************************************************************************************************************
//JIRA ID OF STORY : RMA-109185
//Description      : Create query designer for Entity(ER-ON) search
//Create Entity
...
//DEPENDANCY       : None
//PRE-REQUISITES   : None
//Preferred Server : RM231REG_ERON
// *******************************************************************************************************************************
...
DataIUT.forEach(data => {
    ...
    fixture`QueryDesigner_ERONSearch`.beforeEach(async t => {
    ...
    */
    test('AssureClaims_QueryDesignerCreation_Test_01', async t => {
        ...
        var strFieldSelectionArray = {
                ...
                "Contact Info": [ "Email Type-Contact Info", "Contact Type-Contact Info"]
    ...
    */
    test('AssureClaims_EntityCreation_Test_02', async t => {
        ...
        await Maint_Utility.AssureClaims_MaintenanceAddNewEntity_ERON_Utility("Entity", data.EntityType_Individual,strEntityName,"NA","NA");
    ...
    */
    test('AssureClaims_SearchCreatedEntityWithCreatedQD_Test_03', async t => {
        ...
        var strArray=["Last Name","ID Type","Phone Number","Entity ID Type","Entity ID Number"]
        ...
        await Verify_Utility.AssureClaims_ElementExist_Utility(Search_POM.AssureClaims_Search_Label_VerifyTextOverGrid.withText(strArray[3]),"verify Entity ID Type")
        await Verify_Utility.AssureClaims_ElementExist_Utility(Search_POM.AssureClaims_Search_Label_VerifyTextOverGrid.withText(strArray[4]),"verify Entity ID Number")
