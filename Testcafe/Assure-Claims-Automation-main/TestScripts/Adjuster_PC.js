...
DataIUT.forEach(data => {
    ...
    fixture`Adjuster_ClaimPC`.beforeEach(async t => {
        await t.wait(3000)
        await t.setNativeDialogHandler(() => true).useRole(LoggedInUser);
    });

    test('AssureClaims_PC_ClaimLevel_Adjuster_Test_01', async t => {
        await t.wait(8000)
        var date = new Date();
    ...
    test('AssureClaims_PC_ClaimLevel_Adjuster_Test_02', async t => {
