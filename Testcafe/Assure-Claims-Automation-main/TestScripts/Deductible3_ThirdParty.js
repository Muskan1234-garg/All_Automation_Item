...
DataIUT.forEach(data => {
  ...
  fixture`Deductible3_ThirdParty`.beforeEach(async t => {
  ...
  test('CarrierGCClaimCreation_Test_01', async t => {
    ...
    //=====================================Third Party Deductible Creation started here===================================================================================================================================
    ...
    const ele1 = Deductible_POM.AssureClaims_Claims_Lnk_SelectDeductibleType.withText(data.DeductibleType_TP).with({ visibilityCheck: true })
    ...
    //=====================================Third Party Deductible Creation completed here===================================================================================================================================

    //=====================================Verify after creating Third party deductible-->No reserve is created,started here===================================================================================================================================
    await t.wait(2000)
    ...
    //=====================================Verify after creating Third party deductible-->No reserve is created,completed here===================================================================================================================================
  ...
  test('ThirdPartyDeductible_ReserveCreation_Test_02', async t => {
  ...
  test('ThirdPartyDeductible_PaymentAgainstClaimant_Test_03', async t => {
  ...
  test('ThirdPartyDeductible_PaymentAgainstOtherPayee_Test_04', async t => {
  ...
  test('ThirdPartyDeductible_PaymentwhenDeductibleAmountIsEroded_Test_05', async t => {
