...
DataIUT.forEach(data => {
    ...
    fixture`Smoke_ClaimVC`.beforeEach(async t => {
    ...
    test('ScheduleCheckCreation_Test_03', async t => {
        ...
        await Function_Utility.AssureClaims_ScheduleCheck_Creation(data.NumberOfPayments, data.PayInterval, data.BankAccount, data.DistributionType, data.AutoCheckPayeeType, data.LastName, data.AutoCheckTransactionTypeVC, data.PaymentAmount)
    ...
    test('CollectionCreation_Test_04', async t => {
        ...
        await Function_Utility.AssureClaims_CollectionCorpAddition_Utility(data.BankAccount, data.PayeeType, data.LastName, "NA", data.TransactionTypeVC, data.PaymentAmount)
    ...
    test('PaymentCreation_Test_05', async t => {
        ...
        await Function_Utility.AssureClaims_PaymentCorpAddition_Utility(data.BankAccount, data.PayeeType, data.LastName, data.TransactionTypeVC, data.PaymentAmount)
        //Payment created
        //===========================================================Payment Creation On Vehicle Claim Started Here========================================================================================================================================================================================================================================================================================================
