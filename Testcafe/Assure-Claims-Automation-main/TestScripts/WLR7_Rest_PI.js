...
//*********************************************************************************************************************************************
//JIRA ID OF STORY : RMA-87940, RMA-87829,RMA-96007	
//Description : NONE
...
DataIUT.forEach(data => {
    ...
    fixture`WLR7_Rest_PI`.beforeEach(async t => {
    ...
    test('AssureClaims_WorkLoss_TC_001', async t => {
        ...
        await Nav_Utility.AssureClaims_ElementClick_Utility(WorkLoss_POM.AssureClaims_PersonInv_Lnk_PersonInvolved, "PI link")
        await t.wait(5000);
        await t.switchToMainWindow();
