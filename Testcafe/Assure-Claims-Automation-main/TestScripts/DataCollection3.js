...
import {ReporterPowerView_Name} from './Datacollection_Exported_variable';
...
const AssureClaims_DataIUT = require('../DataFiles/DataIUT2.json');
...
//*************************************************************
    ...
    //Description      : Data Collection Test Script
    //AUTHOR           : Debasmita
    //Revision         : 1.0 Parul Sharma 01/12/2023
...
test('AssureClaims_DataCollection_Test_01', async t => {
    
    console.log("ReporterPowerView_Name is "+await ReporterPowerView_Name)
   ...
   //=====================================================Audience Creation Completed Here====================================================================
        ...
        await Nav_Utility.AssureClaims_ElementClick_Utility(Config_Manager_POM.AssureClaims_TestCafe_POM_Config_Manager_Menu,"View Configurstion Tab On Data Collection Configuration Screen")
        ...
        await In_Utility.AssureClaims_ElementWebListSelect_Utility(DataCollectionConfig_POM.AssureClaims_DataCollectionConfig_Lst_ReporterView,ReporterPowerView_Name,"Reporter View On Data Collection Configuration Screen")
        await In_Utility.AssureClaims_ElementWebListSelect_Utility(DataCollectionConfig_POM.AssureClaims_DataCollectionConfig_Lst_ApproverView,ReporterPowerView_Name,"Approver View On Data Collection Configuration Screen")
        ...
        // Code For Tab Added To Get Control On Themes Screen
    ...
    //=====================================================Audience Deletion Started Here====================================================================
     // Code From Line 153 - 160 Added To Open Utilites Screen And Remove Value Present In Filter
    await t.switchToMainWindow();
    await t.wait(2000);
