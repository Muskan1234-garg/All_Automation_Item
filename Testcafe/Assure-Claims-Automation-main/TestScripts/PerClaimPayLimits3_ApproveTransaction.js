...
// *******************************************************************************************************************************
//JIRA ID OF STORY : RMA-99682
//Description      : Approving Payment on hold which exceeded Per Claim Pay Limits
 ...
 */
  ...
  */
     ...
     /* Steps performed by AssureClaims_ManagerApproval_Test_03 :
      ...
      */
      test('AssureClaims_ManagerApproval_Test_03', async t => {
    ...
    /* Steps performed by AssureClaims_VerificationOfPaymentStatusAfterApproval_Test_04 :
          1. Login Into Application with Ground User
      ...
      */
      test('AssureClaims_VerificationOfPaymentStatusAfterApproval_Test_04', async t => {
