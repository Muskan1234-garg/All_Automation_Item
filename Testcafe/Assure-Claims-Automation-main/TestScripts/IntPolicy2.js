...
//*********************************************************************************************************************************************
//JIRA ID OF STORY : RMA-85404,RMA-85688
//Description : NONE
//AUTHOR : Maddula, Sai krishna , Modified by : Maddula, Sai krishna (RMA-97102)
//DEPENDANCY : No
//PRE-REQUISITE : Select the Env Which is having Policy download System
//Preferred Server : Burp(RMASCAN) Env, DSN2
//*********************************************************************************************************************************************
...
DataIUT.forEach(data => {
  ...
  fixture`IntPolicy2`.beforeEach(async t => {
    await t.setNativeDialogHandler(() => true).useRole(LoggedInUser);
  });
  //Search, Inquire And Download External Policy From Claim Screen And Verify Insured Is Downloaded As Claimant Is Validated
  // Verifying  Multiple Policies Can Be Downloaded To A Claim
  // Verifying  Persons Involved Node Available Is Showing All Entities Downloaded With Policy And Unit, Coverages & Loss Type Appears On Financials  Screen Of Claims With External Added Policy
  // Verifying Policy Symbol And Whether Units Downloaded From External Policy Is In ReadOnly Mode Is Validated
test('Multiple Policy Download And Verification of Policy Data Test_01', async t => {
  ...
  //   Search, Inquire And Download External Policy From Policy System Download
  // Verify User Is Able To Add Reserve, Payment And Collection On The Claim With Added Policy Is Validated
  test('Download External Policy From Policy Download System Test_02', async t => {
    await Nav_Utility.AssureClaims_MenuOptionClick_Utility("New:Policy System Download");
