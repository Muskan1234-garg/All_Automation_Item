...
DataIUT.forEach(data => {
    ...
    fixture`WLR4_WLFundTransaction`.beforeEach(async t => {
    ...
    test('AssureClaims_WorkLoss/RestrictionFromTodate_TC_001', async t => {
        ...
        StrControlNumber = await Function_Utility.AssureClaims_Funds_WorklossTransaction_Creation(StrWCClaimNumber, data.BankAccount, data.PayeeTypeClaimant, data.ReserveType, data.WorkTransactionType, data.Amount, '1', Worklossdate, Worklossdate)
    ...
    test('AssureClaims_WorkLoss/RestrictionFromTodate_TC_003', async t => {
        ...
        StrControlNumber1 = await Function_Utility.AssureClaims_Funds_WorklossTransaction_Creation(StrWCClaimNumber, data.BankAccount, data.PayeeTypeClaimant, data.ReserveType, data.WorkTransactionType, data.Amount, 'NA', Worklossdate, Worklossdate)
    ...
    test('AssureClaims_WorkLoss/RestrictionFromTodate_TC_004', async t => {
        ...
        StrControlNumber2 = await Function_Utility.AssureClaims_Funds_WorklossTransaction_Creation(StrWCClaimNumber, data.BankAccount, data.PayeeTypeClaimant, data.ReserveType, data.WorkTransactionType, data.Amount, 'NA', Worklossdate1, Worklossdate1)
        /*=========================================================== Funds->Transaction Creation with  Different Same From & To Date --> To verify new Workloss record gets Created  ================================================================================================================================================================================================================================================================================== */
