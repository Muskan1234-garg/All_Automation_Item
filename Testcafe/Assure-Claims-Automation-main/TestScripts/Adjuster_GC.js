...
DataIUT.forEach(data => {
    ...
    fixture`Adjuster_ClaimGC`.beforeEach(async t => {
        await t.wait(3000)
        await t.setNativeDialogHandler(() => true).useRole(LoggedInUser);
    });

    test('AssureClaims_GC_ClaimLevel_Adjuster_Test_01', async t => {
        await t.wait(5000)
        var date = new Date();
    ...
    test('AssureClaims_GC_ClaimLevel_Adjuster_Test_02', async t => {
