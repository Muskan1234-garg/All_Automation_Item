...
DataIUT.forEach(data => {
    ...
    fixture`WLR2_WLCaseMgmt`.beforeEach(async t => {
    ...
    test('AssureClaims_WorkLoss/RestrictionFromTodate_TC_001', async t => {
        ...
        /*=========================================================== Worker Compensation Payment with insert From & To Date functionality End================================================================================================================================================================================================================================================================================== */
        ...
        /*=========================================================== Verify that AWL record is created on Case Management Screen Started================================================================================================================================================================================================================================================================================== */
        await Nav_Utility.AssureClaims_ElementClick_Utility(WorkLoss_POM.AssureClaims_CaseMgmt_Tab_CaseMgtRtW, "Tab Case Mgt/RTW ")
        await Nav_Utility.AssureClaims_ElementClick_Utility(WorkLoss_POM.AssureClaims_CaseMgmt_Btn_Workloss, "Workloss Button")
        ...
        const ColHeader1 = ["Last Work Day", "Return To Work"]
        const ColValue1 = [LastWorkDay, ReturnToWork]
        await Verify_Utility.AssureClaims_VerifyUXGrid_Utility(LastWorkDay, "Work Loss List", ColHeader1, ColValue1)
        ...
        /*=========================================================== Verify that AWL record is created on Case Management Screen End================================================================================================================================================================================================================================================================================== */
        ...
        await Nav_Utility.AssureClaims_ElementClick_Utility(WorkLoss_POM.AssureClaims_EventScreen_Btn_Workloss, "Workloss on Event Screen")
        const ColHeader2 = ["Last Work Day", "Return To Work"]
        const ColValue2 = [LastWorkDay, ReturnToWork]
        await Verify_Utility.AssureClaims_VerifyUXGrid_Utility(LastWorkDay, "Work Loss List", ColHeader2, ColValue2)
        await Verify_Utility.AssureClaims_ElementExist_Utility(WorkLoss_POM.AssureClaims_CaseMgmt_VerifyText.withText('Total Items: 1'), "Only 1 record Exist")
        /*=========================================================== Verify that AWL record is visible on Employee Screen at Event Level ================================================================================================================================================================================================================================================================================== */
    })
    ...
    test('AssureClaims_VerifyDuplicateRecordIsNotONCaseMgmtScreen_TC_003', async t => {
        ...
        await Nav_Utility.AssureClaims_ElementClick_Utility(WorkLoss_POM.AssureClaims_CaseMgmt_Tab_CaseMgtRtW, "Tab Case Mgt/RTW ")
        await Nav_Utility.AssureClaims_ElementClick_Utility(WorkLoss_POM.AssureClaims_CaseMgmt_Btn_Workloss, "Workloss Button")
        const ColHeader5 = ["Last Work Day", "Return To Work"]
        const ColValue5 = [LastWorkDay, ReturnToWork]
        await Verify_Utility.AssureClaims_VerifyUXGrid_Utility(LastWorkDay, "Work Loss List", ColHeader5, ColValue5)
        await Verify_Utility.AssureClaims_ElementExist_Utility(WorkLoss_POM.AssureClaims_CaseMgmt_VerifyText.withText('Total Items: 1'), "Only 1 record Exist")
        await Nav_Utility.AssureClaims_ElementClick_Utility(WorkLoss_POM.AssureClaims_CaseMgmt_Btn_Close, "Close Button")
        /*===========================================================  Verify that duplicate AWL record is  NOT created  on Case Management Screen ================================================================================================================================================================================================================================================================================== */
