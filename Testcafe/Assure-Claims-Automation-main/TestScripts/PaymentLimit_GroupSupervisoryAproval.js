...
// *******************************************************************************************************************************
//JIRA ID OF STORY : RMA-102126
//Description      : Payment Limit for Group Supervisory Approval
...
var strSeniorManagerUserName;
var strMidManagerUserName;
...
DataIUT.forEach(data => {
    fixture`PaymentLimit_GroupSupervisoryAproval`.beforeEach(async t => {
        await t.wait(4000)
    ...
    */
    ...
    test('AssureClaims_UserCreation_Test_01', async t => {
        ...
        strSeniorManagerUserName = await Function_Utility.AssureClaims_SMSSuperUserAddEditDelete_Utility("Add", strSeniorManagerLastName, strSeniorManagerFirstName, "NA", "NA", data.DSN, data.ModuleName_Administrator)
        //==============================================================Creation of Senior Manager User ended==================================================================



        //==============================================================Creation of Mid Manager User started==================================================================
        strMidManagerUserName = await Function_Utility.AssureClaims_SMSSuperUserAddEditDelete_Utility("Add", strMidManagerLastName, strMidManagerFirstName, strSeniorManagerFirstName + " " + strSeniorManagerLastName, "NA", data.DSN, data.ModuleName_Administrator)
        ...
        strUserName = await Function_Utility.AssureClaims_SMSSuperUserAddEditDelete_Utility("Add", strUserLastName, strUserFirstName, "NA", "NA", data.DSN, data.ModuleName_Administrator)
        //==============================================================Creation of Ground User ended==================================================================
        await Function_Utility.AssureClaims_LogoutFromApplication_Utility();
    });

    /* Steps performed by AssureClaims_ConfigurationManager_SettingForSupervisory_Test_02 : 
    1)Check/Uncheck settings for supervisory reserve from Configuration manager
    */
    test('AssureClaims_ConfigurationManager_SettingForSupervisory_Test_02', async t => {
    ...
    /* Steps performed by AssureClaims_UserPrivilegeSetting_Test_03 :
       1. Log in With User
       2. Securities > user privilege setup
       3. Select LOB > General claim
       4. Select Limit type > payment > enable Payment Limits
       5. Select the ground user > amount and Click on add
       9. Logout
   */
    
    test('AssureClaims_UserPrivilegeSetting_Test_03', async t => {
        //==============================================================Login Into Application with User started==================================================================

        await t.wait(10000)
        console.log("AssureClaims_LoginIntoApplication_Utility Function is Called To Login Into Application".yellow);
        await Function_Utility.AssureClaims_LoginIntoApplication_Utility(strSeniorManagerUserName, "abkabk1", data.DSN, 'Security')
        await t.wait(5000)
        console.log("Login Into Application!!".green)
        //==============================================================Login Into Application with User ended==================================================================
        await t.wait(5000)
        ...
        await t.wait(7000);
        //==============================================================Select Limit type > payment limit > enable Payment Limits ended==================================================================
   ...
   */
    ...
    /* Steps performed by AssureClaims_SeniorManagerVerification_Test_05 :
         1. Login Into Application with with Manager
         2. Verify the claim no. with the payment having status hold
     */

    test('AssureClaims_SeniorManagerVerification_Test_05', async t => {

        //==============================================================Login Into Application with User started==================================================================
        await t.wait(10000)
        await Function_Utility.AssureClaims_LoginIntoApplication_Utility(strSeniorManagerUserName, "abkabk1", data.DSN, 'Claims')
        await t.wait(10000)
        //=============================================================Login Into Application with User ended=========================================================================
    ...
    /* Steps performed by AssureClaims_MidManagerVerification_Test_06 :
         1. Login Into Application with with Manager
         2. Verify the claim no. with the payment having status hold
     */

    test('AssureClaims_MidManagerVerification_Test_06', async t => {

        //==============================================================Login Into Application with User started==================================================================
        await t.wait(10000)
        await Function_Utility.AssureClaims_LoginIntoApplication_Utility(strMidManagerUserName, "abkabk1", data.DSN, 'Claims')
        await t.wait(10000)
        //=============================================================Login Into Application with User ended=========================================================================
        //=============================================================Approval of Payment on hold started=========================================================================
        await Nav_Utility.AssureClaims_MenuOptionClick_Utility("Funds:Supervisory Approval");
    ...
    /* Steps performed by AssureClaims_UserApproval_Test_07 :
         1. Login Into Application with with User
         2. Verify the claim no. with the payment having status hold
         3. Payment Approval for GroundUser by another User
     */

    test('AssureClaims_UserApproval_Test_07', async t => {
    ...
    /* Steps performed by AssureClaims_VerificationOfPaymentStatusAfterApproval_Test_08 :
          1. Login Into Application with Ground User
      ...
      */
    test('AssureClaims_VerificationOfPaymentStatusAfterApproval_Test_08', async t => {
