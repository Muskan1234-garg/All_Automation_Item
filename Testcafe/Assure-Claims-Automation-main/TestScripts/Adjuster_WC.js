...
DataIUT.forEach(data => {
    ...
    fixture`Adjuster_ClaimWC`.beforeEach(async t => {
        await t.wait(3000)
        await t.setNativeDialogHandler(() => true).useRole(LoggedInUser);
    });

    test('AssureClaims_ClaimLevel_Adjuster_Test_01', async t => {
        await t.wait(5000)
        var date = new Date();
    ...
    test('AssureClaims_ClaimLevel_Adjuster_Test_02', async t => {
        ...
        await t.wait(8000)
        await Nav_Utility.AssureClaims_ElementClick_Utility(WorkersComp_Claims.AssureClaims_WorkersComp_Claims_RightChild_Adjuster_Lookup, "WC Adjuster Lookup")
