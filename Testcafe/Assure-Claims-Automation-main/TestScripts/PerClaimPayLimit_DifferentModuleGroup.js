...
// *******************************************************************************************************************************
//JIRA ID OF STORY : RMA-104785
//Description      : 1. Create 4 user. 3 with same module group 1 with differnt module group and set Per Claim Pay Limit for ground user
//                   2. Turn on supervisory Approval settings
//                   3. Create GC and Reserve and transaction With exceeding limit
...
//                   6. Login with Senior manager and verify claim no . is visible and approve the payment.
//                   7. Login with Ground user and Verification of check status -> 'Release' in transaction History screen
//                   8. Revert settings
...
var strSeniorManagerLastName = "ySr_" + "" + faker.name.lastName();
var strSeniorManagerFirstName = "ySr_" + "" + faker.name.firstName();
var strMidManagerLastName = "yMid_" + "" + faker.name.lastName();
var strMidManagerFirstName = "yMid_" + "" + faker.name.firstName();
var strGroundUserLastName = "yGrd_" + "" + faker.name.lastName();
var strGroundUserFirstName = "yGrd_" + "" + faker.name.firstName();
var strUserLastName = "yUsr_" + "" + faker.name.lastName();
var strUserFirstName = "yUsr_" + "" + faker.name.firstName();
...
var strExceedPerClaimPaymentLimitsOnHold = "A hold requiring supervisory approval has been placed on this payment because Exceeded Per Claim Payment Limit.You do not have authority to pay more than $100.00 per claim.";


DataIUT.forEach(data => {
    fixture`PerClaimPayLimit_DifferentModuleGroup`.beforeEach(async t => {
        await t.wait(8000)
    ...
    /* Steps performed by AssureClaims_UserCreationAndUserPrivilegeSetting_Test_01 :
          ...
          7. Select Limit type > Per Claim Pay Limits > enable Per Claim Pay Limits
          8. Select the ground user > add amount and Click on add
          9. Logout
      */
    ...
    */
    ...
    /* Steps performed by AssureClaims_GCClaimCreationAndPaymentCreation_Test_03 :
           ...
           3. Payment Creation with transaction amount beyond Limit
    ...
    test('AssureClaims_GCClaimCreationAndPaymentCreation_Test_03', async t => {
        ...
        strControlNumber= await Function_Utility.AssureClaims_PaymentCorpAddition_Utility(data.BankAccount, data.PayeeType, data.LastName, data.TransactionType, "125")
        await t.wait(8000)
        console.log("Payment is Created : ".green);
        //================================================Payment Creation ends Here===================================================================================================================================
        // ===============================================Payment Hold verification starts here =================================================================================================================
        await Verify_Utility.AssureClaims_VerifyUXMessage_Utility(strExceedPerClaimPaymentLimitsOnHold, true, "Hold status as reserve limit exceed")
        // ===============================================Payment Hold verification ends here =================================================================================================================
    ...
    */
    ...
    /* Steps performed by AssureClaims_RevertSecuritySetting_Test_09
        1. Login to Security
        2. Cancel set limit for user
        3. UnCheck Payment limit 
        4. Logout
    */
        ...
        await In_Utility.AssureClaims_SetValue_Utility(UserPrevSetUp_POM.AssureClaims_UserPrevLimit_Txt_User, strGroundUserFirstName, "User TextBox")
        await t.pressKey('tab');
        await Nav_Utility.AssureClaims_ElementClick_Utility(UserPrevSetUp_POM.AssureClaims_UserPrevLimit_Btn_CancelLimit, "Closed")
