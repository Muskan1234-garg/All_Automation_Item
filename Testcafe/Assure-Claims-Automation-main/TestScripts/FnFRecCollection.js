...
// *******************************************************************************************************************************
//JIRA ID OF STORY : RMA-87830
//Description      : Automate the functionality of "First and Final Recovery collection" in Testcafe
//AUTHOR           : Nikhil Kumar Menaria
//DEPENDANCY       : None
//PRE-REQUISITE    : None
//Preferred Server : DataBurp, DSN2 : RMATest_2
// *******************************************************************************************************************************
...
DataIUT.forEach(data => {
    ...
    fixture`FnFRecCollection`.beforeEach(async t => {
    ...
    test('CarrierGCClaimCreation_Test_01', async t => {
        ...
        StrClaimNumber = await Function_Utility.AssureClaims_CarrierGCClaimCreation(d, d, data.GCCarrierClaimType1, data.ClaimStatus, data.Department, data.GCCarrierPolicyLOB, data.PolicySystem, data.PolicyNametest)
    ...
    test('GCFirstFinal_Test_02', async t => {
        ...
        await In_Utility.AssureClaims_ElementWebListSelectByIndex_Utility(Payment_POM.AssureClaims_FundsSplitDetails_Lst_FundCoverageType,1, "Fund Coverage Type")
        await In_Utility.AssureClaims_ElementWebListSelectByIndex_Utility(Payment_POM.AssureClaims_FundsSplitDetails_Lst_FundLossType,1, "Fund Loss Type")
        await In_Utility.AssureClaims_ElementWebListSelectByIndex_Utility(Payment_POM.AssureClaims_FundsSplitDetails_Lst_ReserveType,1, "Reserve Type List On Funds Split Detail Screen")
        await In_Utility.AssureClaims_ElementWebListSelectByIndex_Utility(Payment_POM.AssureClaims_FundsSplitDetails_Lst_TransactionType,1, "Transaction Type List On Funds Split Detail Screen")
