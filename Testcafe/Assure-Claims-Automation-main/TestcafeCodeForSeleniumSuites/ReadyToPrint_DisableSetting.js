...
//Description      :
// Payment Parameters > Payment > More Configuration > Prompt to Mark Transaction as ready to print > Disable
...
DataIUT.forEach(data => {
    fixture`ReadyToPrint_DisableSettings`.beforeEach(async t => {
        await t.wait(5000);
        await t.navigateTo(data.URL);
        await t.maximizeWindow();
    });

    test('AssueClaims_TurnOffSettingFromConfigManager_Test_01', async t => {
        ...
        await Nav_Utility.AssureClaims_WebCheckBoxSelectConfigMgnr_Utility(PayParaSetUp_POM.AssureClaims_PaymentParameters_Chk_PromptToMarkTransactionAsReadyToPrint, "UnCheck", "Disable Prompt to mark transaction as ready to print")
