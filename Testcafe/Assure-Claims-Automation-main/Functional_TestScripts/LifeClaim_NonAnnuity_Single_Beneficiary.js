...
//Description      : Automating Life Claim script for including coverage with Non Annuity amount for single beneficiary.
//AUTHOR           : Parul Sharma
//DEPENDANCY       : None
/* PRE-REQUISITES  : None
*/ 
//Rivision         : 0.0 Kiran Nandurkar 3/7/2024
...
DataIUT.forEach(data => {
  ...
  fixture`LifeClaim_NonAnnuity_Single_Beneficiary`.beforeEach(async t => {
...
/* Steps performed by AssureClaims_AddDesignation_test_04 :
  ...
  test('AssureClaims_AddDesignation_test_04', async t => {
    //==========================================================Adding Designee On Created LC Claim Started Here========================================================================================================================================================================================================================================================================================================
    await t.wait(5000)
     //======================================================Muskan's Code :RMA-97695 Claim search started here===================================================================================================================
    await Function_Utility.AssureClaims_GenericSearch_Utility('ClaimZone', 'Claim', StrLifeClaimNumber, "NA");
    //======================================================Muskan's Code :RMA-97695 Claim search started completed here=========================================================================================================
