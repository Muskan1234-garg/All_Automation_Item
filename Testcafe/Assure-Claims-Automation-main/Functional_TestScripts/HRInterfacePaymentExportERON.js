...
const DataAutoRegDSN_ERON = require('../DataFiles/DataAutoRegDSN_EntityRoleON.json');
...
//Description      : HR Interface Payment Export (ERON)
...
DataAutoRegDSN_ERON.forEach(data => {
    fixture`HR_InterfacePaymentExport_ERON`.beforeEach(async t => {
        await t.wait(4000)
