...
DataIUT.forEach(data => {
    fixture`POST OSHA 300A`.beforeEach(async t => {  
        await t.wait(4000)
...
test('AssureClaims_Create_PostOsha300A', async t => {
    ...
    //======================================To Create POST OSHA 300A Reports ==========================================================================
    await t.wait(1000)
    ...
    await Nav_Utility.AssureClaims_ElementClick_Utility(POM_OSHAcsv.AssureClaimsApp_OSHA_OshaReports.withText("Post OSHA 300A"), "Post OSHA 300A")
    await Claims_Osha.AssureClaims_FrameSwitch_OSHAQueue("postosha300a")
    await Inpt_Utility.AssureClaims_SetValue_Utility(POM_OSHAcsv.AssureClaimsApp_Post_OSHA_ReportName, data.OSHA_300A_ReportName, "Report Name")//Change Report name in DataFiles as per requirement
    ...
    await Nav_Utility.AssureClaims_VerifyAndClick_Utility(data.Report_Description,Selector('[class="code-table-list ng-scope"]').withText(data.OSHA_300A_ReportName), "Newly created OSHA 300A Report")//change report name & report description as per requirement
    await t.wait(5000)  
});
