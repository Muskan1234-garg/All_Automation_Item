...
DataIUT.forEach(data => {
    fixture`POST OSHA 300`.beforeEach(async t => {  
        await t.wait(4000)
...
test('AssureClaims_Create_PostOsha300', async t => {
    ...
    //======================================To Create POST OSHA 300 Reports ==========================================================================
    await t.wait(1000)
    ...
    await Nav_Utility.AssureClaims_ElementClick_Utility(POM_OSHAcsv.AssureClaimsApp_OSHA_OshaReports.withText("Post OSHA 300"), "Post OSHA 300")
    await Claims_Osha.AssureClaims_FrameSwitch_OSHAQueue("postosha300")
    await Inpt_Utility.AssureClaims_SetValue_Utility(POM_OSHAcsv.AssureClaimsApp_Post_OSHA_ReportName, data.OSHA_300_ReportName, "Report Name")//Change Report Name in DataFiles as per requirement
    ...
    await Nav_Utility.AssureClaims_VerifyAndClick_Utility(data.Report_Description,Selector('[class="code-table-list ng-scope"]').withText(data.OSHA_300_ReportName), "Newly created OSHA 300 Report")//change report name & report description as per requirement
    await t.wait(5000)  
});
